...
```bash
moon build --target native shapes_rlgl_color_wheel/
./_build/native/debug/build/shapes_rlgl_color_wheel/shapes_rlgl_color_wheel.exe
```
...
### Package `shapes_rlgl_color_wheel`
