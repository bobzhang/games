...
```bash
moon build --target native core_window_should_close/
./_build/native/debug/build/core_window_should_close/core_window_should_close.exe
```
...
### Package `core_window_should_close`
