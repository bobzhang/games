...
```bash
moon build --target native shapes_rectangle_advanced/
./_build/native/debug/build/shapes_rectangle_advanced/shapes_rectangle_advanced.exe
```
...
### Package `shapes_rectangle_advanced`
