...
```bash
moon build --target native raylib_shaders_custom_uniform/
./_build/native/debug/build/raylib_shaders_custom_uniform/raylib_shaders_custom_uniform.exe
```
...
### Package `raylib_shaders_custom_uniform`
