...
```bash
cd examples && moon build --target native sokoban_warehouse_master_2026/
cd examples && ./_build/native/debug/build/sokoban_warehouse_master_2026/sokoban_warehouse_master_2026.exe
```
