...
```bash
moon build --target native raylib_circuit_grid_operator_2026/
./_build/native/debug/build/raylib_circuit_grid_operator_2026/raylib_circuit_grid_operator_2026.exe
```
...
### Package `raylib_circuit_grid_operator_2026`
...
```
raylib_circuit_grid_operator_2026/
