...
```bash
moon build --target native neon_heist_extraction_2026/
./_build/native/debug/build/neon_heist_extraction_2026/neon_heist_extraction_2026.exe
```
...
### Package `neon_heist_extraction_2026`
