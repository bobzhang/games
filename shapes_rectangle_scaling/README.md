...
```bash
moon build --target native shapes_rectangle_scaling/
./_build/native/debug/build/shapes_rectangle_scaling/shapes_rectangle_scaling.exe
```
...
### Package `shapes_rectangle_scaling`
