...
```bash
moon build --target native urban_flood_evacuation_2026/
./_build/native/debug/build/urban_flood_evacuation_2026/urban_flood_evacuation_2026.exe
```
...
### Package `urban_flood_evacuation_2026`
