...
```bash
moon build --target native raylib_core_input_virtual_controls/
./_build/native/debug/build/raylib_core_input_virtual_controls/raylib_core_input_virtual_controls.exe
```
...
### Package `raylib_core_input_virtual_controls`
