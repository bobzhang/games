...
```bash
cd examples && moon build --target native warehouse_forklift_2026/
cd examples && ./_build/native/debug/build/warehouse_forklift_2026/warehouse_forklift_2026.exe
```
