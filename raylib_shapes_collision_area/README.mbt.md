...
```bash
moon build --target native raylib_shapes_collision_area/
./_build/native/debug/build/raylib_shapes_collision_area/raylib_shapes_collision_area.exe
```
...
### Package `raylib_shapes_collision_area`
