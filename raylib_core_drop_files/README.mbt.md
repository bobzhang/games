...
```bash
moon build --target native raylib_core_drop_files/
./_build/native/debug/build/raylib_core_drop_files/raylib_core_drop_files.exe
```
...
### Package `raylib_core_drop_files`
