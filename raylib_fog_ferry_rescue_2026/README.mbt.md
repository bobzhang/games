...
```bash
moon build --target native raylib_fog_ferry_rescue_2026/
./_build/native/debug/build/raylib_fog_ferry_rescue_2026/raylib_fog_ferry_rescue_2026.exe
```
...
### Package `tonyfettes/raylib-examples/raylib_fog_ferry_rescue_2026`
