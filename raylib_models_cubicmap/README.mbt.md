...
```bash
moon build --target native raylib_models_cubicmap/
./_build/native/debug/build/raylib_models_cubicmap/raylib_models_cubicmap.exe
```
...
### Package `raylib_models_cubicmap`
