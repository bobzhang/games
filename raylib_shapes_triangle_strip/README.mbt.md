...
```bash
moon build --target native raylib_shapes_triangle_strip/
./_build/native/debug/build/raylib_shapes_triangle_strip/raylib_shapes_triangle_strip.exe
```
...
### Package `raylib_shapes_triangle_strip`
