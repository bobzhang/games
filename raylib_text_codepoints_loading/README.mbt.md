...
```bash
moon build --target native raylib_text_codepoints_loading/
./_build/native/debug/build/raylib_text_codepoints_loading/raylib_text_codepoints_loading.exe
```
...
### Package `raylib_text_codepoints_loading`
