...
```bash
moon build --target native raylib_models_animation/
./_build/native/debug/build/raylib_models_animation/raylib_models_animation.exe
```
...
### Package `raylib_models_animation`
