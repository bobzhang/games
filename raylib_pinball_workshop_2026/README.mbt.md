...
```bash
moon build --target native raylib_pinball_workshop_2026/
./_build/native/debug/build/raylib_pinball_workshop_2026/raylib_pinball_workshop_2026.exe
```
...
### Package `raylib_pinball_workshop_2026`
