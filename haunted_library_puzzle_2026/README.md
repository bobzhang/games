...
```bash
cd examples && moon build --target native haunted_library_puzzle_2026/
cd examples && ./_build/native/debug/build/haunted_library_puzzle_2026/haunted_library_puzzle_2026.exe
```
...
### Package `haunted_library_puzzle_2026`
...
### Package `haunted_library_puzzle_2026/internal/types`
...
### Package `haunted_library_puzzle_2026/internal/game`
...
### Package `haunted_library_puzzle_2026/internal/render`
