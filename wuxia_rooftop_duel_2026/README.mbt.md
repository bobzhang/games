...
```bash
cd examples && moon build --target native wuxia_rooftop_duel_2026/
cd examples && ./_build/native/debug/build/wuxia_rooftop_duel_2026/wuxia_rooftop_duel_2026.exe
```
