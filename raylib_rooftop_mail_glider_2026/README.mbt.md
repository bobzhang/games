...
```bash
moon build --target native raylib_rooftop_mail_glider_2026/
./_build/native/debug/build/raylib_rooftop_mail_glider_2026/raylib_rooftop_mail_glider_2026.exe
```
...
### Package `raylib_rooftop_mail_glider_2026`
