...
```bash
moon build --target native core_3d_camera_first_person/
./_build/native/debug/build/core_3d_camera_first_person/core_3d_camera_first_person.exe
```
...
### Package `core_3d_camera_first_person`
