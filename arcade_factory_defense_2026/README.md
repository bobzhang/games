...
```bash
moon build --target native arcade_factory_defense_2026/
./_build/native/debug/build/arcade_factory_defense_2026/arcade_factory_defense_2026.exe
```
...
### Package `arcade_factory_defense_2026`
