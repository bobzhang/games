...
```bash
moon build --target native raylib_core_automation_events/
./_build/native/debug/build/raylib_core_automation_events/raylib_core_automation_events.exe
```
...
### Package `raylib_core_automation_events`
