...
```bash
moon build --target native street_basketball_duel_2026/
./_build/native/debug/build/street_basketball_duel_2026/street_basketball_duel_2026.exe
```
...
### Package `street_basketball_duel_2026`
