...
```bash
moon build --target native raylib_fighter_97_lite/
./_build/native/debug/build/raylib_fighter_97_lite/raylib_fighter_97_lite.exe
```
...
### Package `raylib_fighter_97_lite`
...
### Package `raylib_fighter_97_lite/internal/types`
...
### Package `raylib_fighter_97_lite/internal/game`
...
### Package `raylib_fighter_97_lite/internal/render`
...
### Package `raylib_fighter_97_lite/internal/effects`
