...
```bash
moon build --target native raylib_text_font_loading/
./_build/native/debug/build/raylib_text_font_loading/raylib_text_font_loading.exe
```
...
### Package `raylib_text_font_loading`
