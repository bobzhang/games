...
```bash
moon build --target native raylib_snowboard_slalom_2026/
./_build/native/debug/build/raylib_snowboard_slalom_2026/raylib_snowboard_slalom_2026.exe
```
...
### Package `raylib_snowboard_slalom_2026`
