...
```bash
moon build --target native raylib_audio_mixed_processor/
./_build/native/debug/build/raylib_audio_mixed_processor/raylib_audio_mixed_processor.exe
```
...
### Package `raylib_audio_mixed_processor`
