...
```bash
moon build --target native raylib_rhythm_street_beats_2026/
./_build/native/debug/build/raylib_rhythm_street_beats_2026/raylib_rhythm_street_beats_2026.exe
```
...
### Package `raylib_rhythm_street_beats_2026`
