...
```bash
moon build --target native raylib_shapes_kaleidoscope/
./_build/native/debug/build/raylib_shapes_kaleidoscope/raylib_shapes_kaleidoscope.exe
```
...
### Package `raylib_shapes_kaleidoscope`
