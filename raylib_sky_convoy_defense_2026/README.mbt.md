...
```bash
moon build --target native raylib_sky_convoy_defense_2026/
./_build/native/debug/build/raylib_sky_convoy_defense_2026/raylib_sky_convoy_defense_2026.exe
```
...
### Package `raylib_sky_convoy_defense_2026`
...
```
raylib_sky_convoy_defense_2026/
