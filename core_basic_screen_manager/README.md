...
```bash
moon build --target native core_basic_screen_manager/
./_build/native/debug/build/core_basic_screen_manager/core_basic_screen_manager.exe
```
...
### Package `core_basic_screen_manager`
