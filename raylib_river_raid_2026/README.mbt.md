...
```bash
moon build --target native raylib_river_raid_2026/
./_build/native/debug/build/raylib_river_raid_2026/raylib_river_raid_2026.exe
```
...
### Package `raylib_river_raid_2026`
