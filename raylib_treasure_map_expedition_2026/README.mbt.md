...
```bash
moon build --target native raylib_treasure_map_expedition_2026/
./_build/native/debug/build/raylib_treasure_map_expedition_2026/raylib_treasure_map_expedition_2026.exe
```
...
### Package `raylib_treasure_map_expedition_2026`
