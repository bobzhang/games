...
```bash
moon build --target native drift_police_chase_2026/
./_build/native/debug/build/drift_police_chase_2026/drift_police_chase_2026.exe
```
...
### Package `drift_police_chase_2026`
