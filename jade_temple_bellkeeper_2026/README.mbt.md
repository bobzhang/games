...
```bash
cd examples && moon build --target native jade_temple_bellkeeper_2026/
cd examples && ./_build/native/debug/build/jade_temple_bellkeeper_2026/jade_temple_bellkeeper_2026.exe
```
...
### Package `jade_temple_bellkeeper_2026/internal/game`
...
### Package `jade_temple_bellkeeper_2026/internal/render`
