...
```bash
moon build --target native shapes_easings_box_anim/
./_build/native/debug/build/shapes_easings_box_anim/shapes_easings_box_anim.exe
```
...
### Package `shapes_easings_box_anim`
