...
```bash
moon build --target native raylib_models_orthographic_projection/
./_build/native/debug/build/raylib_models_orthographic_projection/raylib_models_orthographic_projection.exe
```
...
### Package `raylib_models_orthographic_projection`
