...
```bash
moon build --target native minesweeper_neon_ops_2026/
./_build/native/debug/build/minesweeper_neon_ops_2026/minesweeper_neon_ops_2026.exe
```
...
### Package `minesweeper_neon_ops_2026`
...
### Package `minesweeper_neon_ops_2026/internal/types`
...
### Package `minesweeper_neon_ops_2026/internal/game`
...
### Package `minesweeper_neon_ops_2026/internal/render`
