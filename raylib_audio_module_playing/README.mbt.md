...
```bash
moon build --target native raylib_audio_module_playing/
./_build/native/debug/build/raylib_audio_module_playing/raylib_audio_module_playing.exe
```
...
### Package `raylib_audio_module_playing`
