...
```bash
moon build --target native raylib_ninja_rooftop_chase_2026/
./_build/native/debug/build/raylib_ninja_rooftop_chase_2026/raylib_ninja_rooftop_chase_2026.exe
```
...
### Package `raylib_ninja_rooftop_chase_2026`
...
```
raylib_ninja_rooftop_chase_2026/
