...
```bash
moon build --target native models_draw_cube_texture/
./_build/native/debug/build/models_draw_cube_texture/models_draw_cube_texture.exe
```
...
### Package `models_draw_cube_texture`
