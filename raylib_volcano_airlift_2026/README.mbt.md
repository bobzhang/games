...
```bash
moon build --target native raylib_volcano_airlift_2026/
./_build/native/debug/build/raylib_volcano_airlift_2026/raylib_volcano_airlift_2026.exe
```
...
### Package `raylib_volcano_airlift_2026`
