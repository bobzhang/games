...
```bash
moon build --target native textures_image_processing/
./_build/native/debug/build/textures_image_processing/textures_image_processing.exe
```
...
### Package `textures_image_processing`
