...
```bash
moon build --target native skyline_fire_rescue_2026/
./_build/native/debug/build/skyline_fire_rescue_2026/skyline_fire_rescue_2026.exe
```
...
### Package `skyline_fire_rescue_2026`
