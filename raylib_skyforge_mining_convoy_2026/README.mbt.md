...
```bash
moon build --target native raylib_skyforge_mining_convoy_2026/
./_build/native/debug/build/raylib_skyforge_mining_convoy_2026/raylib_skyforge_mining_convoy_2026.exe
```
...
### Package `raylib_skyforge_mining_convoy_2026`
...
```
raylib_skyforge_mining_convoy_2026/
