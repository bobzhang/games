...
```bash
moon build --target native raylib_temple_relic_run_2026/
./_build/native/debug/build/raylib_temple_relic_run_2026/raylib_temple_relic_run_2026.exe
```
...
### Package `raylib_temple_relic_run_2026`
