...
```bash
moon build --target native rocket_arena_soccer_2026/
./_build/native/debug/build/rocket_arena_soccer_2026/rocket_arena_soccer_2026.exe
```
...
### Package `rocket_arena_soccer_2026`
