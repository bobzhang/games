...
```bash
moon build --target native textures_particles_blending/
./_build/native/debug/build/textures_particles_blending/textures_particles_blending.exe
```
...
### Package `textures_particles_blending`
