...
```bash
moon build --target native raylib_shaders_spotlight/
./_build/native/debug/build/raylib_shaders_spotlight/raylib_shaders_spotlight.exe
```
...
### Package `raylib_shaders_spotlight`
