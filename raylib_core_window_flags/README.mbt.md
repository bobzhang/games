...
```bash
moon build --target native raylib_core_window_flags/
./_build/native/debug/build/raylib_core_window_flags/raylib_core_window_flags.exe
```
...
### Package `raylib_core_window_flags`
