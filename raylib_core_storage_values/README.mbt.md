...
```bash
moon build --target native raylib_core_storage_values/
./_build/native/debug/build/raylib_core_storage_values/raylib_core_storage_values.exe
```
...
### Package `raylib_core_storage_values`
