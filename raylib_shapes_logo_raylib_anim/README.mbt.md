...
```bash
moon build --target native raylib_shapes_logo_raylib_anim/
./_build/native/debug/build/raylib_shapes_logo_raylib_anim/raylib_shapes_logo_raylib_anim.exe
```
...
### Package `raylib_shapes_logo_raylib_anim`
