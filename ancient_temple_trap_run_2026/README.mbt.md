...
```bash
moon build --target native ancient_temple_trap_run_2026/
./_build/native/debug/build/ancient_temple_trap_run_2026/ancient_temple_trap_run_2026.exe
```
...
### Package `ancient_temple_trap_run_2026/internal/types`
...
### Package `ancient_temple_trap_run_2026/internal/game`
...
### Package `ancient_temple_trap_run_2026/internal/render`
...
### Package `ancient_temple_trap_run_2026` (root)
