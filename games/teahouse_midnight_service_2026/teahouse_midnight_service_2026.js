...
var ASM_CONSTS = {
 ...
 268926: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268994: () => { document.exitFullscreen(); },  
 269021: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269094: () => { if (document.fullscreenElement) return 1; },  
 269140: () => { return document.getElementById('canvas').width; },  
 269192: () => { return screen.width; },  
 269217: () => { document.exitFullscreen(); },  
 269244: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269377: () => { return window.innerWidth; },  
 269403: () => { return window.innerHeight; },  
 269430: () => { if (document.fullscreenElement) return 1; },  
 269476: () => { return document.getElementById('canvas').width; },  
 269528: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269719: () => { return window.innerWidth; },  
 269745: () => { return window.innerHeight; },  
