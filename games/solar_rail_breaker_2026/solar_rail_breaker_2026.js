...
var ASM_CONSTS = {
  268396: () => { if (document.fullscreenElement) return 1; },  
 268442: () => { return document.getElementById('canvas').width; },  
 268494: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268562: () => { document.exitFullscreen(); },  
 268589: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268662: () => { if (document.fullscreenElement) return 1; },  
 268708: () => { return document.getElementById('canvas').width; },  
 268760: () => { return screen.width; },  
 268785: () => { document.exitFullscreen(); },  
 268812: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268945: () => { return window.innerWidth; },  
 268971: () => { return window.innerHeight; },  
 268998: () => { if (document.fullscreenElement) return 1; },  
 269044: () => { return document.getElementById('canvas').width; },  
 269096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269287: () => { return window.innerWidth; },  
 269313: () => { return window.innerHeight; },  
 269340: () => { if (document.fullscreenElement) return 1; },  
 269386: () => { return document.getElementById('canvas').width; },  
 269438: () => { return screen.width; },  
 269463: () => { document.exitFullscreen(); },  
