...
function findWasmBinary() {
  return locateFile('raylib_textures_sprite_button.wasm');
}
...
var ASM_CONSTS = {
  244672: () => { if (document.fullscreenElement) return 1; },  
 244718: () => { return document.getElementById('canvas').width; },  
 244770: () => { return parseInt(document.getElementById('canvas').style.width); },  
 244838: () => { document.exitFullscreen(); },  
 244865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 244938: () => { if (document.fullscreenElement) return 1; },  
 244984: () => { return document.getElementById('canvas').width; },  
 245036: () => { return screen.width; },  
 245061: () => { document.exitFullscreen(); },  
 245088: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 245221: () => { return window.innerWidth; },  
 245247: () => { return window.innerHeight; },  
 245274: () => { if (document.fullscreenElement) return 1; },  
 245320: () => { return document.getElementById('canvas').width; },  
 245372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 245440: () => { if (document.fullscreenElement) return 1; },  
 245486: () => { return document.getElementById('canvas').width; },  
 245538: () => { return screen.width; },  
 245563: () => { return window.innerWidth; },  
 245589: () => { return window.innerHeight; },  
 245616: () => { if (document.fullscreenElement) return 1; },  
 245662: () => { return document.getElementById('canvas').width; },  
 245714: () => { return screen.width; },  
 245739: () => { document.exitFullscreen(); },  
 245766: () => { if (document.fullscreenElement) return 1; },  
 245812: () => { return document.getElementById('canvas').width; },  
 245864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 245932: () => { document.exitFullscreen(); },  
 245959: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 246017: () => { return screen.width; },  
 246042: () => { return screen.height; },  
 246068: () => { return window.screenX; },  
 246095: () => { return window.screenY; },  
 246122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 246175: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 246246: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 246303: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 246559: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 246630: () => { if (document.fullscreenElement) return 1; },  
 246676: () => { return window.innerWidth; },  
 246702: () => { return window.innerHeight; },  
 246729: () => { if (document.pointerLockElement) return 1; },  
