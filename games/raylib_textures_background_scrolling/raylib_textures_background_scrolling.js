...
function findWasmBinary() {
  return locateFile('raylib_textures_background_scrolling.wasm');
}
...
var ASM_CONSTS = {
  135088: () => { if (document.fullscreenElement) return 1; },  
 135134: () => { return document.getElementById('canvas').width; },  
 135186: () => { return parseInt(document.getElementById('canvas').style.width); },  
 135254: () => { document.exitFullscreen(); },  
 135281: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 135354: () => { if (document.fullscreenElement) return 1; },  
 135400: () => { return document.getElementById('canvas').width; },  
 135452: () => { return screen.width; },  
 135477: () => { document.exitFullscreen(); },  
 135504: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 135637: () => { return window.innerWidth; },  
 135663: () => { return window.innerHeight; },  
 135690: () => { if (document.fullscreenElement) return 1; },  
 135736: () => { return document.getElementById('canvas').width; },  
 135788: () => { return parseInt(document.getElementById('canvas').style.width); },  
 135856: () => { if (document.fullscreenElement) return 1; },  
 135902: () => { return document.getElementById('canvas').width; },  
 135954: () => { return screen.width; },  
 135979: () => { return window.innerWidth; },  
 136005: () => { return window.innerHeight; },  
 136032: () => { if (document.fullscreenElement) return 1; },  
 136078: () => { return document.getElementById('canvas').width; },  
 136130: () => { return screen.width; },  
 136155: () => { document.exitFullscreen(); },  
 136182: () => { if (document.fullscreenElement) return 1; },  
 136228: () => { return document.getElementById('canvas').width; },  
 136280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 136348: () => { document.exitFullscreen(); },  
 136375: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 136433: () => { return screen.width; },  
 136458: () => { return screen.height; },  
 136484: () => { return window.screenX; },  
 136511: () => { return window.screenY; },  
 136538: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 136591: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 136662: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 136719: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 136975: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 137046: () => { if (document.fullscreenElement) return 1; },  
 137092: () => { return window.innerWidth; },  
 137118: () => { return window.innerHeight; },  
 137145: () => { if (document.pointerLockElement) return 1; }
};
