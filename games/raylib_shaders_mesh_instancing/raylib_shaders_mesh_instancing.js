...
function findWasmBinary() {
  return locateFile('raylib_shaders_mesh_instancing.wasm');
}
...
var ASM_CONSTS = {
  101760: () => { if (document.fullscreenElement) return 1; },  
 101806: () => { return document.getElementById('canvas').width; },  
 101858: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101926: () => { document.exitFullscreen(); },  
 101953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 102026: () => { if (document.fullscreenElement) return 1; },  
 102072: () => { return document.getElementById('canvas').width; },  
 102124: () => { return screen.width; },  
 102149: () => { document.exitFullscreen(); },  
 102176: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102309: () => { return window.innerWidth; },  
 102335: () => { return window.innerHeight; },  
 102362: () => { if (document.fullscreenElement) return 1; },  
 102408: () => { return document.getElementById('canvas').width; },  
 102460: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102528: () => { if (document.fullscreenElement) return 1; },  
 102574: () => { return document.getElementById('canvas').width; },  
 102626: () => { return screen.width; },  
 102651: () => { return window.innerWidth; },  
 102677: () => { return window.innerHeight; },  
 102704: () => { if (document.fullscreenElement) return 1; },  
 102750: () => { return document.getElementById('canvas').width; },  
 102802: () => { return screen.width; },  
 102827: () => { document.exitFullscreen(); },  
 102854: () => { if (document.fullscreenElement) return 1; },  
 102900: () => { return document.getElementById('canvas').width; },  
 102952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103020: () => { document.exitFullscreen(); },  
 103047: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103105: () => { return screen.width; },  
 103130: () => { return screen.height; },  
 103156: () => { return window.screenX; },  
 103183: () => { return window.screenY; },  
 103210: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103263: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103334: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103391: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103647: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103718: () => { if (document.fullscreenElement) return 1; },  
 103764: () => { return window.innerWidth; },  
 103790: () => { return window.innerHeight; },  
 103817: () => { if (document.pointerLockElement) return 1; }
};
