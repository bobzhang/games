...
var ASM_CONSTS = {
 ...
 264454: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264522: () => { document.exitFullscreen(); },  
 264549: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264622: () => { if (document.fullscreenElement) return 1; },  
 264668: () => { return document.getElementById('canvas').width; },  
 264720: () => { return screen.width; },  
 264745: () => { document.exitFullscreen(); },  
 264772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264905: () => { return window.innerWidth; },  
 264931: () => { return window.innerHeight; },  
 264958: () => { if (document.fullscreenElement) return 1; },  
 265004: () => { return document.getElementById('canvas').width; },  
 265056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265124: () => { if (document.fullscreenElement) return 1; },  
 265170: () => { return document.getElementById('canvas').width; },  
 265222: () => { return screen.width; },  
 265247: () => { return window.innerWidth; },  
 265273: () => { return window.innerHeight; },  
 265300: () => { if (document.fullscreenElement) return 1; },  
 265346: () => { return document.getElementById('canvas').width; },  
 265398: () => { return screen.width; },  
 265423: () => { document.exitFullscreen(); },  
 265450: () => { if (document.fullscreenElement) return 1; },  
 265496: () => { return document.getElementById('canvas').width; },  
 265548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265616: () => { document.exitFullscreen(); },  
 265643: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265701: () => { return screen.width; },  
 265726: () => { return screen.height; },  
 265752: () => { return window.screenX; },  
 265779: () => { return window.screenY; },  
 265806: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265859: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265930: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265987: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266243: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266314: () => { if (document.fullscreenElement) return 1; },  
 266360: () => { return window.innerWidth; },  
 266386: () => { return window.innerHeight; },  
 266413: () => { if (document.pointerLockElement) return 1; }
};
