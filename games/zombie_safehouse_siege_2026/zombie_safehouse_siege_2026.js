...
var ASM_CONSTS = {
  262452: () => { if (document.fullscreenElement) return 1; },  
 262498: () => { return document.getElementById('canvas').width; },  
 262550: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262618: () => { document.exitFullscreen(); },  
 262645: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262718: () => { if (document.fullscreenElement) return 1; },  
 262764: () => { return document.getElementById('canvas').width; },  
 262816: () => { return screen.width; },  
 262841: () => { document.exitFullscreen(); },  
 262868: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263001: () => { return window.innerWidth; },  
 263027: () => { return window.innerHeight; },  
 263054: () => { if (document.fullscreenElement) return 1; },  
 263100: () => { return document.getElementById('canvas').width; },  
 263152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263220: () => { if (document.fullscreenElement) return 1; },  
 263266: () => { return document.getElementById('canvas').width; },  
 263318: () => { return screen.width; },  
 263343: () => { return window.innerWidth; },  
 263369: () => { return window.innerHeight; },  
 263396: () => { if (document.fullscreenElement) return 1; },  
 263442: () => { return document.getElementById('canvas').width; },  
 263494: () => { return screen.width; },  
 263519: () => { document.exitFullscreen(); },  
 263546: () => { if (document.fullscreenElement) return 1; },  
 263592: () => { return document.getElementById('canvas').width; },  
 263644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263712: () => { document.exitFullscreen(); },  
 263739: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263797: () => { return screen.width; },  
 263822: () => { return screen.height; },  
 263848: () => { return window.screenX; },  
 263875: () => { return window.screenY; },  
 263902: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263955: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264026: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264339: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264410: () => { if (document.fullscreenElement) return 1; },  
 264456: () => { return window.innerWidth; },  
 264482: () => { return window.innerHeight; },  
 264509: () => { if (document.pointerLockElement) return 1; }
};
