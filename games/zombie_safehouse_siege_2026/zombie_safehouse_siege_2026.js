...
var ASM_CONSTS = {
  262436: () => { if (document.fullscreenElement) return 1; },  
 262482: () => { return document.getElementById('canvas').width; },  
 262534: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262602: () => { document.exitFullscreen(); },  
 262629: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262702: () => { if (document.fullscreenElement) return 1; },  
 262748: () => { return document.getElementById('canvas').width; },  
 262800: () => { return screen.width; },  
 262825: () => { document.exitFullscreen(); },  
 262852: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262985: () => { return window.innerWidth; },  
 263011: () => { return window.innerHeight; },  
 263038: () => { if (document.fullscreenElement) return 1; },  
 263084: () => { return document.getElementById('canvas').width; },  
 263136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263204: () => { if (document.fullscreenElement) return 1; },  
 263250: () => { return document.getElementById('canvas').width; },  
 263302: () => { return screen.width; },  
 263327: () => { return window.innerWidth; },  
 263353: () => { return window.innerHeight; },  
 ...
 263503: () => { document.exitFullscreen(); },  
 263530: () => { if (document.fullscreenElement) return 1; },  
 263576: () => { return document.getElementById('canvas').width; },  
 263628: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263696: () => { document.exitFullscreen(); },  
 263723: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263781: () => { return screen.width; },  
 263806: () => { return screen.height; },  
 263832: () => { return window.screenX; },  
 263859: () => { return window.screenY; },  
 263886: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263939: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264010: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264067: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264323: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264394: () => { if (document.fullscreenElement) return 1; },  
 264440: () => { return window.innerWidth; },  
 264466: () => { return window.innerHeight; },  
 264493: () => { if (document.pointerLockElement) return 1; }
};
