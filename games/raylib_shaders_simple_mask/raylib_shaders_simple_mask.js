...
function findWasmBinary() {
  return locateFile('raylib_shaders_simple_mask.wasm');
}
...
var ASM_CONSTS = {
  758320: () => { if (document.fullscreenElement) return 1; },  
 758366: () => { return document.getElementById('canvas').width; },  
 758418: () => { return parseInt(document.getElementById('canvas').style.width); },  
 758486: () => { document.exitFullscreen(); },  
 758513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 758586: () => { if (document.fullscreenElement) return 1; },  
 758632: () => { return document.getElementById('canvas').width; },  
 758684: () => { return screen.width; },  
 758709: () => { document.exitFullscreen(); },  
 758736: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 758869: () => { return window.innerWidth; },  
 758895: () => { return window.innerHeight; },  
 758922: () => { if (document.fullscreenElement) return 1; },  
 758968: () => { return document.getElementById('canvas').width; },  
 759020: () => { return parseInt(document.getElementById('canvas').style.width); },  
 759088: () => { if (document.fullscreenElement) return 1; },  
 759134: () => { return document.getElementById('canvas').width; },  
 759186: () => { return screen.width; },  
 759211: () => { return window.innerWidth; },  
 759237: () => { return window.innerHeight; },  
 759264: () => { if (document.fullscreenElement) return 1; },  
 759310: () => { return document.getElementById('canvas').width; },  
 759362: () => { return screen.width; },  
 759387: () => { document.exitFullscreen(); },  
 759414: () => { if (document.fullscreenElement) return 1; },  
 759460: () => { return document.getElementById('canvas').width; },  
 759512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 759580: () => { document.exitFullscreen(); },  
 759607: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 759665: () => { return screen.width; },  
 759690: () => { return screen.height; },  
 759716: () => { return window.screenX; },  
 759743: () => { return window.screenY; },  
 759770: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 759823: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 759894: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 759951: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 760207: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 760278: () => { if (document.fullscreenElement) return 1; },  
 760324: () => { return window.innerWidth; },  
 760350: () => { return window.innerHeight; },  
 760377: () => { if (document.pointerLockElement) return 1; }
};
