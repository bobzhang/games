...
var ASM_CONSTS = {
  260868: () => { if (document.fullscreenElement) return 1; },  
 260914: () => { return document.getElementById('canvas').width; },  
 260966: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261034: () => { document.exitFullscreen(); },  
 261061: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261134: () => { if (document.fullscreenElement) return 1; },  
 261180: () => { return document.getElementById('canvas').width; },  
 261232: () => { return screen.width; },  
 261257: () => { document.exitFullscreen(); },  
 261284: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261417: () => { return window.innerWidth; },  
 261443: () => { return window.innerHeight; },  
 261470: () => { if (document.fullscreenElement) return 1; },  
 261516: () => { return document.getElementById('canvas').width; },  
 261568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261636: () => { if (document.fullscreenElement) return 1; },  
 261682: () => { return document.getElementById('canvas').width; },  
 261734: () => { return screen.width; },  
 261759: () => { return window.innerWidth; },  
 261785: () => { return window.innerHeight; },  
 ...
 261935: () => { document.exitFullscreen(); },  
 ...
 262128: () => { document.exitFullscreen(); },  
 262155: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262213: () => { return screen.width; },  
 262238: () => { return screen.height; },  
 262264: () => { return window.screenX; },  
 262291: () => { return window.screenY; },  
 262318: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262371: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262442: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262499: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262755: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262826: () => { if (document.fullscreenElement) return 1; },  
 262872: () => { return window.innerWidth; },  
 262898: () => { return window.innerHeight; },  
 262925: () => { if (document.pointerLockElement) return 1; }
};
