...
var ASM_CONSTS = {
 ...
 252598: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252666: () => { document.exitFullscreen(); },  
 252693: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252766: () => { if (document.fullscreenElement) return 1; },  
 252812: () => { return document.getElementById('canvas').width; },  
 252864: () => { return screen.width; },  
 252889: () => { document.exitFullscreen(); },  
 252916: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 253049: () => { return window.innerWidth; },  
 253075: () => { return window.innerHeight; },  
 253102: () => { if (document.fullscreenElement) return 1; },  
 253148: () => { return document.getElementById('canvas').width; },  
 253200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253268: () => { if (document.fullscreenElement) return 1; },  
 253314: () => { return document.getElementById('canvas').width; },  
 253366: () => { return screen.width; },  
 253391: () => { return window.innerWidth; },  
 253417: () => { return window.innerHeight; },  
 253444: () => { if (document.fullscreenElement) return 1; },  
 253490: () => { return document.getElementById('canvas').width; },  
 253542: () => { return screen.width; },  
 253567: () => { document.exitFullscreen(); },  
 253594: () => { if (document.fullscreenElement) return 1; },  
 253640: () => { return document.getElementById('canvas').width; },  
 253692: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253760: () => { document.exitFullscreen(); },  
 253787: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253845: () => { return screen.width; },  
 253870: () => { return screen.height; },  
 253896: () => { return window.screenX; },  
 253923: () => { return window.screenY; },  
 253950: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 254003: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 254074: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 254131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 254387: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254458: () => { if (document.fullscreenElement) return 1; },  
 254504: () => { return window.innerWidth; },  
 254530: () => { return window.innerHeight; },  
 254557: () => { if (document.pointerLockElement) return 1; }
};
