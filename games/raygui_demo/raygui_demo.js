...
function findWasmBinary() {
  return locateFile('raygui_demo.wasm');
}
...
var ASM_CONSTS = {
  252720: () => { if (document.fullscreenElement) return 1; },  
 252766: () => { return document.getElementById('canvas').width; },  
 252818: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252886: () => { document.exitFullscreen(); },  
 252913: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252986: () => { if (document.fullscreenElement) return 1; },  
 253032: () => { return document.getElementById('canvas').width; },  
 253084: () => { return screen.width; },  
 253109: () => { document.exitFullscreen(); },  
 253136: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 253269: () => { return window.innerWidth; },  
 253295: () => { return window.innerHeight; },  
 253322: () => { if (document.fullscreenElement) return 1; },  
 253368: () => { return document.getElementById('canvas').width; },  
 253420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253488: () => { if (document.fullscreenElement) return 1; },  
 253534: () => { return document.getElementById('canvas').width; },  
 253586: () => { return screen.width; },  
 253611: () => { return window.innerWidth; },  
 253637: () => { return window.innerHeight; },  
 253664: () => { if (document.fullscreenElement) return 1; },  
 253710: () => { return document.getElementById('canvas').width; },  
 253762: () => { return screen.width; },  
 253787: () => { document.exitFullscreen(); },  
 253814: () => { if (document.fullscreenElement) return 1; },  
 253860: () => { return document.getElementById('canvas').width; },  
 253912: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253980: () => { document.exitFullscreen(); },  
 254007: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 254065: () => { return screen.width; },  
 254090: () => { return screen.height; },  
 254116: () => { return window.screenX; },  
 254143: () => { return window.screenY; },  
 254170: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 254223: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 254294: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 254351: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 254607: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254678: () => { if (document.fullscreenElement) return 1; },  
 254724: () => { return window.innerWidth; },  
 254750: () => { return window.innerHeight; },  
 254777: () => { if (document.pointerLockElement) return 1; }
};
