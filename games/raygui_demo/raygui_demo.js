...
var ASM_CONSTS = {
  252724: () => { if (document.fullscreenElement) return 1; },  
 252770: () => { return document.getElementById('canvas').width; },  
 252822: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252890: () => { document.exitFullscreen(); },  
 252917: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252990: () => { if (document.fullscreenElement) return 1; },  
 253036: () => { return document.getElementById('canvas').width; },  
 253088: () => { return screen.width; },  
 253113: () => { document.exitFullscreen(); },  
 253140: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 253273: () => { return window.innerWidth; },  
 253299: () => { return window.innerHeight; },  
 253326: () => { if (document.fullscreenElement) return 1; },  
 253372: () => { return document.getElementById('canvas').width; },  
 253424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253492: () => { if (document.fullscreenElement) return 1; },  
 253538: () => { return document.getElementById('canvas').width; },  
 253590: () => { return screen.width; },  
 253615: () => { return window.innerWidth; },  
 253641: () => { return window.innerHeight; },  
 253668: () => { if (document.fullscreenElement) return 1; },  
 253714: () => { return document.getElementById('canvas').width; },  
 253766: () => { return screen.width; },  
 253791: () => { document.exitFullscreen(); },  
 253818: () => { if (document.fullscreenElement) return 1; },  
 253864: () => { return document.getElementById('canvas').width; },  
 253916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253984: () => { document.exitFullscreen(); },  
 254011: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 254069: () => { return screen.width; },  
 254094: () => { return screen.height; },  
 254120: () => { return window.screenX; },  
 254147: () => { return window.screenY; },  
 254174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 254227: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 254298: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 254355: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 254611: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254682: () => { if (document.fullscreenElement) return 1; },  
 254728: () => { return window.innerWidth; },  
 254754: () => { return window.innerHeight; },  
 254781: () => { if (document.pointerLockElement) return 1; }
};
