...
var ASM_CONSTS = {
 ...
 261750: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261818: () => { document.exitFullscreen(); },  
 261845: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261918: () => { if (document.fullscreenElement) return 1; },  
 261964: () => { return document.getElementById('canvas').width; },  
 262016: () => { return screen.width; },  
 262041: () => { document.exitFullscreen(); },  
 262068: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262201: () => { return window.innerWidth; },  
 262227: () => { return window.innerHeight; },  
 262254: () => { if (document.fullscreenElement) return 1; },  
 262300: () => { return document.getElementById('canvas').width; },  
 262352: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262543: () => { return window.innerWidth; },  
 262569: () => { return window.innerHeight; },  
 ...
 262719: () => { document.exitFullscreen(); },  
 ...
 262912: () => { document.exitFullscreen(); },  
 262939: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262997: () => { return screen.width; },  
 263022: () => { return screen.height; },  
 263048: () => { return window.screenX; },  
 263075: () => { return window.screenY; },  
 263102: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263155: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263226: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263283: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263539: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263610: () => { if (document.fullscreenElement) return 1; },  
 263656: () => { return window.innerWidth; },  
 263682: () => { return window.innerHeight; },  
 263709: () => { if (document.pointerLockElement) return 1; }
};
