...
var ASM_CONSTS = {
  263092: () => { if (document.fullscreenElement) return 1; },  
 263138: () => { return document.getElementById('canvas').width; },  
 263190: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263258: () => { document.exitFullscreen(); },  
 263285: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263358: () => { if (document.fullscreenElement) return 1; },  
 263404: () => { return document.getElementById('canvas').width; },  
 263456: () => { return screen.width; },  
 263481: () => { document.exitFullscreen(); },  
 263508: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263641: () => { return window.innerWidth; },  
 263667: () => { return window.innerHeight; },  
 263694: () => { if (document.fullscreenElement) return 1; },  
 263740: () => { return document.getElementById('canvas').width; },  
 263792: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263860: () => { if (document.fullscreenElement) return 1; },  
 263906: () => { return document.getElementById('canvas').width; },  
 263958: () => { return screen.width; },  
 263983: () => { return window.innerWidth; },  
 264009: () => { return window.innerHeight; },  
 ...
 264159: () => { document.exitFullscreen(); },  
 264186: () => { if (document.fullscreenElement) return 1; },  
 264232: () => { return document.getElementById('canvas').width; },  
 264284: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264352: () => { document.exitFullscreen(); },  
 264379: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264437: () => { return screen.width; },  
 264462: () => { return screen.height; },  
 264488: () => { return window.screenX; },  
 264515: () => { return window.screenY; },  
 264542: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264595: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264666: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264723: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264979: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265050: () => { if (document.fullscreenElement) return 1; },  
 265096: () => { return window.innerWidth; },  
 265122: () => { return window.innerHeight; },  
 265149: () => { if (document.pointerLockElement) return 1; }
};
