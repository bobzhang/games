...
function findWasmBinary() {
  return locateFile('raylib_models_yaw_pitch_roll.wasm');
}
...
var ASM_CONSTS = {
  109088: () => { if (document.fullscreenElement) return 1; },  
 109134: () => { return document.getElementById('canvas').width; },  
 109186: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109254: () => { document.exitFullscreen(); },  
 109281: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109354: () => { if (document.fullscreenElement) return 1; },  
 109400: () => { return document.getElementById('canvas').width; },  
 109452: () => { return screen.width; },  
 109477: () => { document.exitFullscreen(); },  
 109504: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 109637: () => { return window.innerWidth; },  
 109663: () => { return window.innerHeight; },  
 109690: () => { if (document.fullscreenElement) return 1; },  
 109736: () => { return document.getElementById('canvas').width; },  
 109788: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109856: () => { if (document.fullscreenElement) return 1; },  
 109902: () => { return document.getElementById('canvas').width; },  
 109954: () => { return screen.width; },  
 109979: () => { return window.innerWidth; },  
 110005: () => { return window.innerHeight; },  
 110032: () => { if (document.fullscreenElement) return 1; },  
 110078: () => { return document.getElementById('canvas').width; },  
 110130: () => { return screen.width; },  
 110155: () => { document.exitFullscreen(); },  
 110182: () => { if (document.fullscreenElement) return 1; },  
 110228: () => { return document.getElementById('canvas').width; },  
 110280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110348: () => { document.exitFullscreen(); },  
 110375: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 110433: () => { return screen.width; },  
 110458: () => { return screen.height; },  
 110484: () => { return window.screenX; },  
 110511: () => { return window.screenY; },  
 110538: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110591: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 110662: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 110719: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110975: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111046: () => { if (document.fullscreenElement) return 1; },  
 111092: () => { return window.innerWidth; },  
 111118: () => { return window.innerHeight; },  
 111145: () => { if (document.pointerLockElement) return 1; }
};
