...
var ASM_CONSTS = {
  260900: () => { if (document.fullscreenElement) return 1; },  
 260946: () => { return document.getElementById('canvas').width; },  
 260998: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261066: () => { document.exitFullscreen(); },  
 261093: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261166: () => { if (document.fullscreenElement) return 1; },  
 261212: () => { return document.getElementById('canvas').width; },  
 261264: () => { return screen.width; },  
 261289: () => { document.exitFullscreen(); },  
 261316: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261449: () => { return window.innerWidth; },  
 261475: () => { return window.innerHeight; },  
 261502: () => { if (document.fullscreenElement) return 1; },  
 261548: () => { return document.getElementById('canvas').width; },  
 261600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261791: () => { return window.innerWidth; },  
 261817: () => { return window.innerHeight; },  
 ...
 261967: () => { document.exitFullscreen(); },  
 ...
 262160: () => { document.exitFullscreen(); },  
 262187: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262245: () => { return screen.width; },  
 262270: () => { return screen.height; },  
 262296: () => { return window.screenX; },  
 262323: () => { return window.screenY; },  
 262350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262403: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262474: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262531: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262787: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262858: () => { if (document.fullscreenElement) return 1; },  
 262904: () => { return window.innerWidth; },  
 262930: () => { return window.innerHeight; },  
 262957: () => { if (document.pointerLockElement) return 1; }
};
