...
function findWasmBinary() {
  return locateFile('raylib_models_heightmap.wasm');
}
...
var ASM_CONSTS = {
  101408: () => { if (document.fullscreenElement) return 1; },  
 101454: () => { return document.getElementById('canvas').width; },  
 101506: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101574: () => { document.exitFullscreen(); },  
 101601: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101674: () => { if (document.fullscreenElement) return 1; },  
 101720: () => { return document.getElementById('canvas').width; },  
 101772: () => { return screen.width; },  
 101797: () => { document.exitFullscreen(); },  
 101824: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101957: () => { return window.innerWidth; },  
 101983: () => { return window.innerHeight; },  
 102010: () => { if (document.fullscreenElement) return 1; },  
 102056: () => { return document.getElementById('canvas').width; },  
 102108: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102176: () => { if (document.fullscreenElement) return 1; },  
 102222: () => { return document.getElementById('canvas').width; },  
 102274: () => { return screen.width; },  
 102299: () => { return window.innerWidth; },  
 102325: () => { return window.innerHeight; },  
 102352: () => { if (document.fullscreenElement) return 1; },  
 102398: () => { return document.getElementById('canvas').width; },  
 102450: () => { return screen.width; },  
 102475: () => { document.exitFullscreen(); },  
 102502: () => { if (document.fullscreenElement) return 1; },  
 102548: () => { return document.getElementById('canvas').width; },  
 102600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102668: () => { document.exitFullscreen(); },  
 102695: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102753: () => { return screen.width; },  
 102778: () => { return screen.height; },  
 102804: () => { return window.screenX; },  
 102831: () => { return window.screenY; },  
 102858: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102911: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102982: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103039: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103295: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103366: () => { if (document.fullscreenElement) return 1; },  
 103412: () => { return window.innerWidth; },  
 103438: () => { return window.innerHeight; },  
 103465: () => { if (document.pointerLockElement) return 1; }
};
