...
var ASM_CONSTS = {
 ...
 262278: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262346: () => { document.exitFullscreen(); },  
 262373: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262446: () => { if (document.fullscreenElement) return 1; },  
 262492: () => { return document.getElementById('canvas').width; },  
 262544: () => { return screen.width; },  
 262569: () => { document.exitFullscreen(); },  
 262596: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262729: () => { return window.innerWidth; },  
 262755: () => { return window.innerHeight; },  
 262782: () => { if (document.fullscreenElement) return 1; },  
 262828: () => { return document.getElementById('canvas').width; },  
 262880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263071: () => { return window.innerWidth; },  
 263097: () => { return window.innerHeight; },  
 ...
 263247: () => { document.exitFullscreen(); },  
 ...
 263440: () => { document.exitFullscreen(); },  
 263467: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263525: () => { return screen.width; },  
 263550: () => { return screen.height; },  
 263576: () => { return window.screenX; },  
 263603: () => { return window.screenY; },  
 263630: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263683: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263754: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264067: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264138: () => { if (document.fullscreenElement) return 1; },  
 264184: () => { return window.innerWidth; },  
 264210: () => { return window.innerHeight; },  
 264237: () => { if (document.pointerLockElement) return 1; }
};
