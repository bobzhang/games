...
var ASM_CONSTS = {
  261972: () => { if (document.fullscreenElement) return 1; },  
 262018: () => { return document.getElementById('canvas').width; },  
 262070: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262138: () => { document.exitFullscreen(); },  
 262165: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262238: () => { if (document.fullscreenElement) return 1; },  
 262284: () => { return document.getElementById('canvas').width; },  
 262336: () => { return screen.width; },  
 262361: () => { document.exitFullscreen(); },  
 262388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262521: () => { return window.innerWidth; },  
 262547: () => { return window.innerHeight; },  
 262574: () => { if (document.fullscreenElement) return 1; },  
 262620: () => { return document.getElementById('canvas').width; },  
 262672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262863: () => { return window.innerWidth; },  
 262889: () => { return window.innerHeight; },  
 262916: () => { if (document.fullscreenElement) return 1; },  
 262962: () => { return document.getElementById('canvas').width; },  
 263014: () => { return screen.width; },  
 263039: () => { document.exitFullscreen(); },  
 263066: () => { if (document.fullscreenElement) return 1; },  
 263112: () => { return document.getElementById('canvas').width; },  
 263164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263232: () => { document.exitFullscreen(); },  
 263259: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263317: () => { return screen.width; },  
 263342: () => { return screen.height; },  
 263368: () => { return window.screenX; },  
 263395: () => { return window.screenY; },  
 263422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263475: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263546: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263859: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263930: () => { if (document.fullscreenElement) return 1; },  
 263976: () => { return window.innerWidth; },  
 264002: () => { return window.innerHeight; },  
 264029: () => { if (document.pointerLockElement) return 1; }
};
