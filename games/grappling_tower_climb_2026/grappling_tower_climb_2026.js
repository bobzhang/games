...
var ASM_CONSTS = {
 ...
 261862: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261930: () => { document.exitFullscreen(); },  
 261957: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262030: () => { if (document.fullscreenElement) return 1; },  
 262076: () => { return document.getElementById('canvas').width; },  
 262128: () => { return screen.width; },  
 262153: () => { document.exitFullscreen(); },  
 262180: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262313: () => { return window.innerWidth; },  
 262339: () => { return window.innerHeight; },  
 262366: () => { if (document.fullscreenElement) return 1; },  
 262412: () => { return document.getElementById('canvas').width; },  
 262464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262532: () => { if (document.fullscreenElement) return 1; },  
 262578: () => { return document.getElementById('canvas').width; },  
 262630: () => { return screen.width; },  
 262655: () => { return window.innerWidth; },  
 262681: () => { return window.innerHeight; },  
 262708: () => { if (document.fullscreenElement) return 1; },  
 262754: () => { return document.getElementById('canvas').width; },  
 262806: () => { return screen.width; },  
 262831: () => { document.exitFullscreen(); },  
 ...
 263024: () => { document.exitFullscreen(); },  
 263051: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263109: () => { return screen.width; },  
 263134: () => { return screen.height; },  
 263160: () => { return window.screenX; },  
 263187: () => { return window.screenY; },  
 263214: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263267: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263338: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263395: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263651: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263722: () => { if (document.fullscreenElement) return 1; },  
 263768: () => { return window.innerWidth; },  
 263794: () => { return window.innerHeight; },  
 263821: () => { if (document.pointerLockElement) return 1; }
};
