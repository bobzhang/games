...
var ASM_CONSTS = {
 ...
 262054: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262122: () => { document.exitFullscreen(); },  
 262149: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262222: () => { if (document.fullscreenElement) return 1; },  
 262268: () => { return document.getElementById('canvas').width; },  
 262320: () => { return screen.width; },  
 262345: () => { document.exitFullscreen(); },  
 262372: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262505: () => { return window.innerWidth; },  
 262531: () => { return window.innerHeight; },  
 262558: () => { if (document.fullscreenElement) return 1; },  
 262604: () => { return document.getElementById('canvas').width; },  
 262656: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262724: () => { if (document.fullscreenElement) return 1; },  
 262770: () => { return document.getElementById('canvas').width; },  
 262822: () => { return screen.width; },  
 262847: () => { return window.innerWidth; },  
 262873: () => { return window.innerHeight; },  
 262900: () => { if (document.fullscreenElement) return 1; },  
 262946: () => { return document.getElementById('canvas').width; },  
 262998: () => { return screen.width; },  
 263023: () => { document.exitFullscreen(); },  
 ...
 263216: () => { document.exitFullscreen(); },  
 263243: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263301: () => { return screen.width; },  
 263326: () => { return screen.height; },  
 263352: () => { return window.screenX; },  
 263379: () => { return window.screenY; },  
 263406: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263459: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263530: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263587: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263843: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263914: () => { if (document.fullscreenElement) return 1; },  
 263960: () => { return window.innerWidth; },  
 263986: () => { return window.innerHeight; },  
 264013: () => { if (document.pointerLockElement) return 1; }
};
