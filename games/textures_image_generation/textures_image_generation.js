...
var ASM_CONSTS = {
 ...
 262422: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262490: () => { document.exitFullscreen(); },  
 262517: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262590: () => { if (document.fullscreenElement) return 1; },  
 262636: () => { return document.getElementById('canvas').width; },  
 262688: () => { return screen.width; },  
 262713: () => { document.exitFullscreen(); },  
 262740: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262873: () => { return window.innerWidth; },  
 262899: () => { return window.innerHeight; },  
 262926: () => { if (document.fullscreenElement) return 1; },  
 262972: () => { return document.getElementById('canvas').width; },  
 263024: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263092: () => { if (document.fullscreenElement) return 1; },  
 263138: () => { return document.getElementById('canvas').width; },  
 263190: () => { return screen.width; },  
 263215: () => { return window.innerWidth; },  
 263241: () => { return window.innerHeight; },  
 263268: () => { if (document.fullscreenElement) return 1; },  
 263314: () => { return document.getElementById('canvas').width; },  
 263366: () => { return screen.width; },  
 263391: () => { document.exitFullscreen(); },  
 ...
 263584: () => { document.exitFullscreen(); },  
 263611: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263669: () => { return screen.width; },  
 263694: () => { return screen.height; },  
 263720: () => { return window.screenX; },  
 263747: () => { return window.screenY; },  
 263774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263827: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263898: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263955: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264211: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264282: () => { if (document.fullscreenElement) return 1; },  
 264328: () => { return window.innerWidth; },  
 264354: () => { return window.innerHeight; },  
 264381: () => { if (document.pointerLockElement) return 1; }
};
