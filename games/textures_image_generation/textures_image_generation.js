...
var ASM_CONSTS = {
 ...
 262214: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262282: () => { document.exitFullscreen(); },  
 262309: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262382: () => { if (document.fullscreenElement) return 1; },  
 262428: () => { return document.getElementById('canvas').width; },  
 262480: () => { return screen.width; },  
 262505: () => { document.exitFullscreen(); },  
 262532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262665: () => { return window.innerWidth; },  
 262691: () => { return window.innerHeight; },  
 262718: () => { if (document.fullscreenElement) return 1; },  
 262764: () => { return document.getElementById('canvas').width; },  
 262816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263007: () => { return window.innerWidth; },  
 263033: () => { return window.innerHeight; },  
 ...
 263183: () => { document.exitFullscreen(); },  
 ...
 263376: () => { document.exitFullscreen(); },  
 263403: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263461: () => { return screen.width; },  
 263486: () => { return screen.height; },  
 263512: () => { return window.screenX; },  
 263539: () => { return window.screenY; },  
 263566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263619: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263690: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264003: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264074: () => { if (document.fullscreenElement) return 1; },  
 264120: () => { return window.innerWidth; },  
 264146: () => { return window.innerHeight; },  
 264173: () => { if (document.pointerLockElement) return 1; }
};
