...
var ASM_CONSTS = {
 ...
 263030: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263098: () => { document.exitFullscreen(); },  
 263125: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263198: () => { if (document.fullscreenElement) return 1; },  
 263244: () => { return document.getElementById('canvas').width; },  
 263296: () => { return screen.width; },  
 263321: () => { document.exitFullscreen(); },  
 263348: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263481: () => { return window.innerWidth; },  
 263507: () => { return window.innerHeight; },  
 263534: () => { if (document.fullscreenElement) return 1; },  
 263580: () => { return document.getElementById('canvas').width; },  
 263632: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263823: () => { return window.innerWidth; },  
 263849: () => { return window.innerHeight; },  
 ...
 263999: () => { document.exitFullscreen(); },  
 ...
 264192: () => { document.exitFullscreen(); },  
 264219: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264277: () => { return screen.width; },  
 264302: () => { return screen.height; },  
 264328: () => { return window.screenX; },  
 264355: () => { return window.screenY; },  
 264382: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264435: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264506: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264563: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264819: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264890: () => { if (document.fullscreenElement) return 1; },  
 264936: () => { return window.innerWidth; },  
 264962: () => { return window.innerHeight; },  
 264989: () => { if (document.pointerLockElement) return 1; }
};
