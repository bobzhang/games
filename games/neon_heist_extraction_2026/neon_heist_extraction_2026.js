...
var ASM_CONSTS = {
  262724: () => { if (document.fullscreenElement) return 1; },  
 262770: () => { return document.getElementById('canvas').width; },  
 262822: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262890: () => { document.exitFullscreen(); },  
 262917: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262990: () => { if (document.fullscreenElement) return 1; },  
 263036: () => { return document.getElementById('canvas').width; },  
 263088: () => { return screen.width; },  
 263113: () => { document.exitFullscreen(); },  
 263140: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263273: () => { return window.innerWidth; },  
 263299: () => { return window.innerHeight; },  
 263326: () => { if (document.fullscreenElement) return 1; },  
 263372: () => { return document.getElementById('canvas').width; },  
 263424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263615: () => { return window.innerWidth; },  
 263641: () => { return window.innerHeight; },  
 ...
 263791: () => { document.exitFullscreen(); },  
 263818: () => { if (document.fullscreenElement) return 1; },  
 263864: () => { return document.getElementById('canvas').width; },  
 263916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263984: () => { document.exitFullscreen(); },  
 264011: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264069: () => { return screen.width; },  
 264094: () => { return screen.height; },  
 264120: () => { return window.screenX; },  
 264147: () => { return window.screenY; },  
 264174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264227: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264298: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264355: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264611: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264682: () => { if (document.fullscreenElement) return 1; },  
 264728: () => { return window.innerWidth; },  
 264754: () => { return window.innerHeight; },  
 264781: () => { if (document.pointerLockElement) return 1; }
};
