...
var ASM_CONSTS = {
  484516: () => { if (document.fullscreenElement) return 1; },  
 484562: () => { return document.getElementById('canvas').width; },  
 484614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 484682: () => { document.exitFullscreen(); },  
 484709: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 484782: () => { if (document.fullscreenElement) return 1; },  
 484828: () => { return document.getElementById('canvas').width; },  
 484880: () => { return screen.width; },  
 484905: () => { document.exitFullscreen(); },  
 484932: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 485065: () => { return window.innerWidth; },  
 485091: () => { return window.innerHeight; },  
 485118: () => { if (document.fullscreenElement) return 1; },  
 485164: () => { return document.getElementById('canvas').width; },  
 485216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 485284: () => { if (document.fullscreenElement) return 1; },  
 485330: () => { return document.getElementById('canvas').width; },  
 485382: () => { return screen.width; },  
 485407: () => { return window.innerWidth; },  
 485433: () => { return window.innerHeight; },  
 485460: () => { if (document.fullscreenElement) return 1; },  
 485506: () => { return document.getElementById('canvas').width; },  
 485558: () => { return screen.width; },  
 485583: () => { document.exitFullscreen(); },  
 485610: () => { if (document.fullscreenElement) return 1; },  
 485656: () => { return document.getElementById('canvas').width; },  
 485708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 485776: () => { document.exitFullscreen(); },  
 485803: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 485861: () => { return screen.width; },  
 485886: () => { return screen.height; },  
 485912: () => { return window.screenX; },  
 485939: () => { return window.screenY; },  
 485966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 486019: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 486090: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 486147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 486403: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 486474: () => { if (document.fullscreenElement) return 1; },  
 486520: () => { return window.innerWidth; },  
 486546: () => { return window.innerHeight; },  
 486573: () => { if (document.pointerLockElement) return 1; }
};
