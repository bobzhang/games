...
var ASM_CONSTS = {
  484724: () => { if (document.fullscreenElement) return 1; },  
 484770: () => { return document.getElementById('canvas').width; },  
 484822: () => { return parseInt(document.getElementById('canvas').style.width); },  
 484890: () => { document.exitFullscreen(); },  
 484917: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 484990: () => { if (document.fullscreenElement) return 1; },  
 485036: () => { return document.getElementById('canvas').width; },  
 485088: () => { return screen.width; },  
 485113: () => { document.exitFullscreen(); },  
 485140: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 485273: () => { return window.innerWidth; },  
 485299: () => { return window.innerHeight; },  
 485326: () => { if (document.fullscreenElement) return 1; },  
 485372: () => { return document.getElementById('canvas').width; },  
 485424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 485492: () => { if (document.fullscreenElement) return 1; },  
 485538: () => { return document.getElementById('canvas').width; },  
 485590: () => { return screen.width; },  
 485615: () => { return window.innerWidth; },  
 485641: () => { return window.innerHeight; },  
 485668: () => { if (document.fullscreenElement) return 1; },  
 485714: () => { return document.getElementById('canvas').width; },  
 485766: () => { return screen.width; },  
 485791: () => { document.exitFullscreen(); },  
 485818: () => { if (document.fullscreenElement) return 1; },  
 485864: () => { return document.getElementById('canvas').width; },  
 485916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 485984: () => { document.exitFullscreen(); },  
 486011: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 486069: () => { return screen.width; },  
 486094: () => { return screen.height; },  
 486120: () => { return window.screenX; },  
 486147: () => { return window.screenY; },  
 486174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 486227: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 486298: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 486355: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 486611: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 486682: () => { if (document.fullscreenElement) return 1; },  
 486728: () => { return window.innerWidth; },  
 486754: () => { return window.innerHeight; },  
 486781: () => { if (document.pointerLockElement) return 1; }
};
