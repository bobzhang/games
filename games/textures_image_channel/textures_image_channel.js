...
var ASM_CONSTS = {
  484720: () => { if (document.fullscreenElement) return 1; },  
 484766: () => { return document.getElementById('canvas').width; },  
 484818: () => { return parseInt(document.getElementById('canvas').style.width); },  
 484886: () => { document.exitFullscreen(); },  
 484913: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 484986: () => { if (document.fullscreenElement) return 1; },  
 485032: () => { return document.getElementById('canvas').width; },  
 485084: () => { return screen.width; },  
 485109: () => { document.exitFullscreen(); },  
 485136: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 485269: () => { return window.innerWidth; },  
 485295: () => { return window.innerHeight; },  
 485322: () => { if (document.fullscreenElement) return 1; },  
 485368: () => { return document.getElementById('canvas').width; },  
 485420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 485488: () => { if (document.fullscreenElement) return 1; },  
 485534: () => { return document.getElementById('canvas').width; },  
 485586: () => { return screen.width; },  
 485611: () => { return window.innerWidth; },  
 485637: () => { return window.innerHeight; },  
 485664: () => { if (document.fullscreenElement) return 1; },  
 485710: () => { return document.getElementById('canvas').width; },  
 485762: () => { return screen.width; },  
 485787: () => { document.exitFullscreen(); },  
 485814: () => { if (document.fullscreenElement) return 1; },  
 485860: () => { return document.getElementById('canvas').width; },  
 485912: () => { return parseInt(document.getElementById('canvas').style.width); },  
 485980: () => { document.exitFullscreen(); },  
 486007: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 486065: () => { return screen.width; },  
 486090: () => { return screen.height; },  
 486116: () => { return window.screenX; },  
 486143: () => { return window.screenY; },  
 486170: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 486223: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 486294: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 486351: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 486607: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 486678: () => { if (document.fullscreenElement) return 1; },  
 486724: () => { return window.innerWidth; },  
 486750: () => { return window.innerHeight; },  
 486777: () => { if (document.pointerLockElement) return 1; }
};
