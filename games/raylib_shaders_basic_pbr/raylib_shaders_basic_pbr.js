...
function findWasmBinary() {
  return locateFile('raylib_shaders_basic_pbr.wasm');
}
...
var ASM_CONSTS = {
  6668752: () => { if (document.fullscreenElement) return 1; },  
 6668798: () => { return document.getElementById('canvas').width; },  
 6668850: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6668918: () => { document.exitFullscreen(); },  
 6668945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 6669018: () => { if (document.fullscreenElement) return 1; },  
 6669064: () => { return document.getElementById('canvas').width; },  
 6669116: () => { return screen.width; },  
 6669141: () => { document.exitFullscreen(); },  
 6669168: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 6669301: () => { return window.innerWidth; },  
 6669327: () => { return window.innerHeight; },  
 6669354: () => { if (document.fullscreenElement) return 1; },  
 6669400: () => { return document.getElementById('canvas').width; },  
 6669452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6669520: () => { if (document.fullscreenElement) return 1; },  
 6669566: () => { return document.getElementById('canvas').width; },  
 6669618: () => { return screen.width; },  
 6669643: () => { return window.innerWidth; },  
 6669669: () => { return window.innerHeight; },  
 6669696: () => { if (document.fullscreenElement) return 1; },  
 6669742: () => { return document.getElementById('canvas').width; },  
 6669794: () => { return screen.width; },  
 6669819: () => { document.exitFullscreen(); },  
 6669846: () => { if (document.fullscreenElement) return 1; },  
 6669892: () => { return document.getElementById('canvas').width; },  
 6669944: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6670012: () => { document.exitFullscreen(); },  
 6670039: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 6670097: () => { return screen.width; },  
 6670122: () => { return screen.height; },  
 6670148: () => { return window.screenX; },  
 6670175: () => { return window.screenY; },  
 6670202: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 6670255: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 6670326: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 6670383: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 6670639: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 6670710: () => { if (document.fullscreenElement) return 1; },  
 6670756: () => { return window.innerWidth; },  
 6670782: () => { return window.innerHeight; },  
 6670809: () => { if (document.pointerLockElement) return 1; }
};
