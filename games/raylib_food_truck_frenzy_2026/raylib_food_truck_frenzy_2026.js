...
var ASM_CONSTS = {
 ...
 99506: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99574: () => { document.exitFullscreen(); },  
 99601: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99674: () => { if (document.fullscreenElement) return 1; },  
 99720: () => { return document.getElementById('canvas').width; },  
 99772: () => { return screen.width; },  
 99797: () => { document.exitFullscreen(); },  
 99824: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99957: () => { return window.innerWidth; },  
 99983: () => { return window.innerHeight; },  
 100010: () => { if (document.fullscreenElement) return 1; },  
 100056: () => { return document.getElementById('canvas').width; },  
 100108: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100299: () => { return window.innerWidth; },  
 100325: () => { return window.innerHeight; },  
 ...
 100475: () => { document.exitFullscreen(); },  
 100502: () => { if (document.fullscreenElement) return 1; },  
 100548: () => { return document.getElementById('canvas').width; },  
 100600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100668: () => { document.exitFullscreen(); },  
 100695: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100753: () => { return screen.width; },  
 100778: () => { return screen.height; },  
 100804: () => { return window.screenX; },  
 100831: () => { return window.screenY; },  
 100858: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100911: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100982: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101039: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101295: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101366: () => { if (document.fullscreenElement) return 1; },  
 101412: () => { return window.innerWidth; },  
 101438: () => { return window.innerHeight; },  
 101465: () => { if (document.pointerLockElement) return 1; }
};
