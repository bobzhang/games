...
var ASM_CONSTS = {
 ...
 261798: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261866: () => { document.exitFullscreen(); },  
 261893: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261966: () => { if (document.fullscreenElement) return 1; },  
 262012: () => { return document.getElementById('canvas').width; },  
 262064: () => { return screen.width; },  
 262089: () => { document.exitFullscreen(); },  
 262116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262249: () => { return window.innerWidth; },  
 262275: () => { return window.innerHeight; },  
 262302: () => { if (document.fullscreenElement) return 1; },  
 262348: () => { return document.getElementById('canvas').width; },  
 262400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262591: () => { return window.innerWidth; },  
 262617: () => { return window.innerHeight; },  
 ...
 262767: () => { document.exitFullscreen(); },  
 ...
 262960: () => { document.exitFullscreen(); },  
 262987: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263045: () => { return screen.width; },  
 263070: () => { return screen.height; },  
 263096: () => { return window.screenX; },  
 263123: () => { return window.screenY; },  
 263150: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263203: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263274: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263587: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263658: () => { if (document.fullscreenElement) return 1; },  
 263704: () => { return window.innerWidth; },  
 263730: () => { return window.innerHeight; },  
 263757: () => { if (document.pointerLockElement) return 1; }
};
