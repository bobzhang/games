...
var ASM_CONSTS = {
 ...
 261238: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261306: () => { document.exitFullscreen(); },  
 261333: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261406: () => { if (document.fullscreenElement) return 1; },  
 261452: () => { return document.getElementById('canvas').width; },  
 261504: () => { return screen.width; },  
 261529: () => { document.exitFullscreen(); },  
 261556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261689: () => { return window.innerWidth; },  
 261715: () => { return window.innerHeight; },  
 261742: () => { if (document.fullscreenElement) return 1; },  
 261788: () => { return document.getElementById('canvas').width; },  
 261840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262031: () => { return window.innerWidth; },  
 262057: () => { return window.innerHeight; },  
 ...
 262207: () => { document.exitFullscreen(); },  
 ...
 262400: () => { document.exitFullscreen(); },  
 262427: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262485: () => { return screen.width; },  
 262510: () => { return screen.height; },  
 262536: () => { return window.screenX; },  
 262563: () => { return window.screenY; },  
 262590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262643: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262714: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263027: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263098: () => { if (document.fullscreenElement) return 1; },  
 263144: () => { return window.innerWidth; },  
 263170: () => { return window.innerHeight; },  
 263197: () => { if (document.pointerLockElement) return 1; }
};
