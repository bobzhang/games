...
var ASM_CONSTS = {
  263316: () => { if (document.fullscreenElement) return 1; },  
 263362: () => { return document.getElementById('canvas').width; },  
 263414: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263482: () => { document.exitFullscreen(); },  
 263509: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263582: () => { if (document.fullscreenElement) return 1; },  
 263628: () => { return document.getElementById('canvas').width; },  
 263680: () => { return screen.width; },  
 263705: () => { document.exitFullscreen(); },  
 263732: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263865: () => { return window.innerWidth; },  
 263891: () => { return window.innerHeight; },  
 263918: () => { if (document.fullscreenElement) return 1; },  
 263964: () => { return document.getElementById('canvas').width; },  
 264016: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264084: () => { if (document.fullscreenElement) return 1; },  
 264130: () => { return document.getElementById('canvas').width; },  
 264182: () => { return screen.width; },  
 264207: () => { return window.innerWidth; },  
 264233: () => { return window.innerHeight; },  
 ...
 264383: () => { document.exitFullscreen(); },  
 264410: () => { if (document.fullscreenElement) return 1; },  
 264456: () => { return document.getElementById('canvas').width; },  
 264508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264576: () => { document.exitFullscreen(); },  
 264603: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264661: () => { return screen.width; },  
 264686: () => { return screen.height; },  
 264712: () => { return window.screenX; },  
 264739: () => { return window.screenY; },  
 264766: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264819: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264890: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264947: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265203: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265274: () => { if (document.fullscreenElement) return 1; },  
 265320: () => { return window.innerWidth; },  
 265346: () => { return window.innerHeight; },  
 265373: () => { if (document.pointerLockElement) return 1; }
};
