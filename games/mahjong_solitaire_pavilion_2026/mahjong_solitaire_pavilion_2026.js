...
var ASM_CONSTS = {
  263524: () => { if (document.fullscreenElement) return 1; },  
 263570: () => { return document.getElementById('canvas').width; },  
 263622: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263690: () => { document.exitFullscreen(); },  
 263717: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263790: () => { if (document.fullscreenElement) return 1; },  
 263836: () => { return document.getElementById('canvas').width; },  
 263888: () => { return screen.width; },  
 263913: () => { document.exitFullscreen(); },  
 263940: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264073: () => { return window.innerWidth; },  
 264099: () => { return window.innerHeight; },  
 264126: () => { if (document.fullscreenElement) return 1; },  
 264172: () => { return document.getElementById('canvas').width; },  
 264224: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264292: () => { if (document.fullscreenElement) return 1; },  
 264338: () => { return document.getElementById('canvas').width; },  
 264390: () => { return screen.width; },  
 264415: () => { return window.innerWidth; },  
 264441: () => { return window.innerHeight; },  
 ...
 264591: () => { document.exitFullscreen(); },  
 264618: () => { if (document.fullscreenElement) return 1; },  
 264664: () => { return document.getElementById('canvas').width; },  
 264716: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264784: () => { document.exitFullscreen(); },  
 264811: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264869: () => { return screen.width; },  
 264894: () => { return screen.height; },  
 264920: () => { return window.screenX; },  
 264947: () => { return window.screenY; },  
 264974: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265027: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265098: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265155: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265411: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265482: () => { if (document.fullscreenElement) return 1; },  
 265528: () => { return window.innerWidth; },  
 265554: () => { return window.innerHeight; },  
 265581: () => { if (document.pointerLockElement) return 1; }
};
