...
var ASM_CONSTS = {
 ...
 107866: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107934: () => { document.exitFullscreen(); },  
 107961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108034: () => { if (document.fullscreenElement) return 1; },  
 108080: () => { return document.getElementById('canvas').width; },  
 108132: () => { return screen.width; },  
 108157: () => { document.exitFullscreen(); },  
 108184: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
