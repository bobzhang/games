...
var ASM_CONSTS = {
  265172: () => { if (document.fullscreenElement) return 1; },  
 265218: () => { return document.getElementById('canvas').width; },  
 265270: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265338: () => { document.exitFullscreen(); },  
 265365: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265438: () => { if (document.fullscreenElement) return 1; },  
 265484: () => { return document.getElementById('canvas').width; },  
 265536: () => { return screen.width; },  
 265561: () => { document.exitFullscreen(); },  
 265588: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265721: () => { return window.innerWidth; },  
 265747: () => { return window.innerHeight; },  
 265774: () => { if (document.fullscreenElement) return 1; },  
 265820: () => { return document.getElementById('canvas').width; },  
 265872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265940: () => { if (document.fullscreenElement) return 1; },  
 265986: () => { return document.getElementById('canvas').width; },  
 266038: () => { return screen.width; },  
 266063: () => { return window.innerWidth; },  
 266089: () => { return window.innerHeight; },  
 266116: () => { if (document.fullscreenElement) return 1; },  
 266162: () => { return document.getElementById('canvas').width; },  
 266214: () => { return screen.width; },  
 266239: () => { document.exitFullscreen(); },  
 266266: () => { if (document.fullscreenElement) return 1; },  
 266312: () => { return document.getElementById('canvas').width; },  
 266364: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266432: () => { document.exitFullscreen(); },  
 266459: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266517: () => { return screen.width; },  
 266542: () => { return screen.height; },  
 266568: () => { return window.screenX; },  
 266595: () => { return window.screenY; },  
 266622: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266675: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266746: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266803: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267059: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 267130: () => { if (document.fullscreenElement) return 1; },  
 267176: () => { return window.innerWidth; },  
 267202: () => { return window.innerHeight; },  
 267229: () => { if (document.pointerLockElement) return 1; }
};
