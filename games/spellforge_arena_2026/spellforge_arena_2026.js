...
var ASM_CONSTS = {
  261604: () => { if (document.fullscreenElement) return 1; },  
 261650: () => { return document.getElementById('canvas').width; },  
 261702: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261770: () => { document.exitFullscreen(); },  
 261797: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261870: () => { if (document.fullscreenElement) return 1; },  
 261916: () => { return document.getElementById('canvas').width; },  
 261968: () => { return screen.width; },  
 261993: () => { document.exitFullscreen(); },  
 262020: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262153: () => { return window.innerWidth; },  
 262179: () => { return window.innerHeight; },  
 262206: () => { if (document.fullscreenElement) return 1; },  
 262252: () => { return document.getElementById('canvas').width; },  
 262304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262372: () => { if (document.fullscreenElement) return 1; },  
 262418: () => { return document.getElementById('canvas').width; },  
 262470: () => { return screen.width; },  
 262495: () => { return window.innerWidth; },  
 262521: () => { return window.innerHeight; },  
 ...
 262671: () => { document.exitFullscreen(); },  
 262698: () => { if (document.fullscreenElement) return 1; },  
 262744: () => { return document.getElementById('canvas').width; },  
 262796: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262864: () => { document.exitFullscreen(); },  
 262891: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262949: () => { return screen.width; },  
 262974: () => { return screen.height; },  
 263000: () => { return window.screenX; },  
 263027: () => { return window.screenY; },  
 263054: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263107: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263178: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263235: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263491: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263562: () => { if (document.fullscreenElement) return 1; },  
 263608: () => { return window.innerWidth; },  
 263634: () => { return window.innerHeight; },  
 263661: () => { if (document.pointerLockElement) return 1; }
};
