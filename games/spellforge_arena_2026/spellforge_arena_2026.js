...
var ASM_CONSTS = {
 ...
 261910: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261978: () => { document.exitFullscreen(); },  
 262005: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262078: () => { if (document.fullscreenElement) return 1; },  
 262124: () => { return document.getElementById('canvas').width; },  
 262176: () => { return screen.width; },  
 262201: () => { document.exitFullscreen(); },  
 262228: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262361: () => { return window.innerWidth; },  
 262387: () => { return window.innerHeight; },  
 262414: () => { if (document.fullscreenElement) return 1; },  
 262460: () => { return document.getElementById('canvas').width; },  
 262512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262703: () => { return window.innerWidth; },  
 262729: () => { return window.innerHeight; },  
 ...
 262879: () => { document.exitFullscreen(); },  
 ...
 263072: () => { document.exitFullscreen(); },  
 263099: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263157: () => { return screen.width; },  
 263182: () => { return screen.height; },  
 263208: () => { return window.screenX; },  
 263235: () => { return window.screenY; },  
 263262: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263315: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263386: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263443: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263699: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263770: () => { if (document.fullscreenElement) return 1; },  
 263816: () => { return window.innerWidth; },  
 263842: () => { return window.innerHeight; },  
 263869: () => { if (document.pointerLockElement) return 1; }
};
