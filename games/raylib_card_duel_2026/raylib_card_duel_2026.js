...
var ASM_CONSTS = {
 ...
 98386: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98454: () => { document.exitFullscreen(); },  
 98481: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98554: () => { if (document.fullscreenElement) return 1; },  
 98600: () => { return document.getElementById('canvas').width; },  
 98652: () => { return screen.width; },  
 98677: () => { document.exitFullscreen(); },  
 98704: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98837: () => { return window.innerWidth; },  
 98863: () => { return window.innerHeight; },  
 98890: () => { if (document.fullscreenElement) return 1; },  
 98936: () => { return document.getElementById('canvas').width; },  
 98988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99056: () => { if (document.fullscreenElement) return 1; },  
 99102: () => { return document.getElementById('canvas').width; },  
 99154: () => { return screen.width; },  
 99179: () => { return window.innerWidth; },  
 99205: () => { return window.innerHeight; },  
 99232: () => { if (document.fullscreenElement) return 1; },  
 99278: () => { return document.getElementById('canvas').width; },  
 99330: () => { return screen.width; },  
 99355: () => { document.exitFullscreen(); },  
 99382: () => { if (document.fullscreenElement) return 1; },  
 99428: () => { return document.getElementById('canvas').width; },  
 99480: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99548: () => { document.exitFullscreen(); },  
 99575: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99633: () => { return screen.width; },  
 99658: () => { return screen.height; },  
 99684: () => { return window.screenX; },  
 99711: () => { return window.screenY; },  
 99738: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99791: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99862: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99919: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100175: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100246: () => { if (document.fullscreenElement) return 1; },  
 100292: () => { return window.innerWidth; },  
 100318: () => { return window.innerHeight; },  
 100345: () => { if (document.pointerLockElement) return 1; }
};
