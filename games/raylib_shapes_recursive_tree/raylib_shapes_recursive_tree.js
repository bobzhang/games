...
function findWasmBinary() {
  return locateFile('raylib_shapes_recursive_tree.wasm');
}
...
var ASM_CONSTS = {
 ...
 98450: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98518: () => { document.exitFullscreen(); },  
 98545: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98618: () => { if (document.fullscreenElement) return 1; },  
 98664: () => { return document.getElementById('canvas').width; },  
 98716: () => { return screen.width; },  
 98741: () => { document.exitFullscreen(); },  
 98768: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98901: () => { return window.innerWidth; },  
 98927: () => { return window.innerHeight; },  
 98954: () => { if (document.fullscreenElement) return 1; },  
 99000: () => { return document.getElementById('canvas').width; },  
 99052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99120: () => { if (document.fullscreenElement) return 1; },  
 99166: () => { return document.getElementById('canvas').width; },  
 99218: () => { return screen.width; },  
 99243: () => { return window.innerWidth; },  
 99269: () => { return window.innerHeight; },  
 99296: () => { if (document.fullscreenElement) return 1; },  
 99342: () => { return document.getElementById('canvas').width; },  
 99394: () => { return screen.width; },  
 99419: () => { document.exitFullscreen(); },  
 99446: () => { if (document.fullscreenElement) return 1; },  
 99492: () => { return document.getElementById('canvas').width; },  
 99544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99612: () => { document.exitFullscreen(); },  
 99639: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99697: () => { return screen.width; },  
 99722: () => { return screen.height; },  
 99748: () => { return window.screenX; },  
 99775: () => { return window.screenY; },  
 99802: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99855: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99926: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99983: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100239: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100310: () => { if (document.fullscreenElement) return 1; },  
 100356: () => { return window.innerWidth; },  
 100382: () => { return window.innerHeight; },  
 100409: () => { if (document.pointerLockElement) return 1; }
};
