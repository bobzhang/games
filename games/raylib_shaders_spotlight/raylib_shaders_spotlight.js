...
function findWasmBinary() {
  return locateFile('raylib_shaders_spotlight.wasm');
}
...
var ASM_CONSTS = {
  109104: () => { if (document.fullscreenElement) return 1; },  
 109150: () => { return document.getElementById('canvas').width; },  
 109202: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109270: () => { document.exitFullscreen(); },  
 109297: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109370: () => { if (document.fullscreenElement) return 1; },  
 109416: () => { return document.getElementById('canvas').width; },  
 109468: () => { return screen.width; },  
 109493: () => { document.exitFullscreen(); },  
 109520: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 109653: () => { return window.innerWidth; },  
 109679: () => { return window.innerHeight; },  
 109706: () => { if (document.fullscreenElement) return 1; },  
 109752: () => { return document.getElementById('canvas').width; },  
 109804: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109872: () => { if (document.fullscreenElement) return 1; },  
 109918: () => { return document.getElementById('canvas').width; },  
 109970: () => { return screen.width; },  
 109995: () => { return window.innerWidth; },  
 110021: () => { return window.innerHeight; },  
 110048: () => { if (document.fullscreenElement) return 1; },  
 110094: () => { return document.getElementById('canvas').width; },  
 110146: () => { return screen.width; },  
 110171: () => { document.exitFullscreen(); },  
 110198: () => { if (document.fullscreenElement) return 1; },  
 110244: () => { return document.getElementById('canvas').width; },  
 110296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110364: () => { document.exitFullscreen(); },  
 110391: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 110449: () => { return screen.width; },  
 110474: () => { return screen.height; },  
 110500: () => { return window.screenX; },  
 110527: () => { return window.screenY; },  
 110554: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110607: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 110678: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 110735: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110991: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111062: () => { if (document.fullscreenElement) return 1; },  
 111108: () => { return window.innerWidth; },  
 111134: () => { return window.innerHeight; },  
 111161: () => { if (document.pointerLockElement) return 1; }
};
