...
var ASM_CONSTS = {
  261028: () => { if (document.fullscreenElement) return 1; },  
 261074: () => { return document.getElementById('canvas').width; },  
 261126: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261194: () => { document.exitFullscreen(); },  
 261221: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261294: () => { if (document.fullscreenElement) return 1; },  
 261340: () => { return document.getElementById('canvas').width; },  
 261392: () => { return screen.width; },  
 261417: () => { document.exitFullscreen(); },  
 261444: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261577: () => { return window.innerWidth; },  
 261603: () => { return window.innerHeight; },  
 261630: () => { if (document.fullscreenElement) return 1; },  
 261676: () => { return document.getElementById('canvas').width; },  
 261728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261919: () => { return window.innerWidth; },  
 261945: () => { return window.innerHeight; },  
 ...
 262095: () => { document.exitFullscreen(); },  
 ...
 262288: () => { document.exitFullscreen(); },  
 262315: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262373: () => { return screen.width; },  
 262398: () => { return screen.height; },  
 262424: () => { return window.screenX; },  
 262451: () => { return window.screenY; },  
 262478: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262531: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262602: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262659: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262915: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262986: () => { if (document.fullscreenElement) return 1; },  
 263032: () => { return window.innerWidth; },  
 263058: () => { return window.innerHeight; },  
 263085: () => { if (document.pointerLockElement) return 1; }
};
