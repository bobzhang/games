...
var ASM_CONSTS = {
  261828: () => { if (document.fullscreenElement) return 1; },  
 261874: () => { return document.getElementById('canvas').width; },  
 261926: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261994: () => { document.exitFullscreen(); },  
 262021: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262094: () => { if (document.fullscreenElement) return 1; },  
 262140: () => { return document.getElementById('canvas').width; },  
 262192: () => { return screen.width; },  
 262217: () => { document.exitFullscreen(); },  
 262244: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262377: () => { return window.innerWidth; },  
 262403: () => { return window.innerHeight; },  
 262430: () => { if (document.fullscreenElement) return 1; },  
 262476: () => { return document.getElementById('canvas').width; },  
 262528: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262596: () => { if (document.fullscreenElement) return 1; },  
 262642: () => { return document.getElementById('canvas').width; },  
 262694: () => { return screen.width; },  
 262719: () => { return window.innerWidth; },  
 262745: () => { return window.innerHeight; },  
 ...
 262895: () => { document.exitFullscreen(); },  
 ...
 263088: () => { document.exitFullscreen(); },  
 263115: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263173: () => { return screen.width; },  
 263198: () => { return screen.height; },  
 263224: () => { return window.screenX; },  
 263251: () => { return window.screenY; },  
 263278: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263331: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263402: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263459: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263715: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263786: () => { if (document.fullscreenElement) return 1; },  
 263832: () => { return window.innerWidth; },  
 263858: () => { return window.innerHeight; },  
 263885: () => { if (document.pointerLockElement) return 1; }
};
