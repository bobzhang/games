...
var ASM_CONSTS = {
  255588: () => { if (document.fullscreenElement) return 1; },  
 255634: () => { return document.getElementById('canvas').width; },  
 255686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255754: () => { document.exitFullscreen(); },  
 255781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255854: () => { if (document.fullscreenElement) return 1; },  
 255900: () => { return document.getElementById('canvas').width; },  
 255952: () => { return screen.width; },  
 255977: () => { document.exitFullscreen(); },  
 256004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 256137: () => { return window.innerWidth; },  
 256163: () => { return window.innerHeight; },  
 256190: () => { if (document.fullscreenElement) return 1; },  
 256236: () => { return document.getElementById('canvas').width; },  
 256288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256356: () => { if (document.fullscreenElement) return 1; },  
 256402: () => { return document.getElementById('canvas').width; },  
 256454: () => { return screen.width; },  
 256479: () => { return window.innerWidth; },  
 256505: () => { return window.innerHeight; },  
 256532: () => { if (document.fullscreenElement) return 1; },  
 256578: () => { return document.getElementById('canvas').width; },  
 256630: () => { return screen.width; },  
 256655: () => { document.exitFullscreen(); },  
 256682: () => { if (document.fullscreenElement) return 1; },  
 256728: () => { return document.getElementById('canvas').width; },  
 256780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256848: () => { document.exitFullscreen(); },  
 256875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256933: () => { return screen.width; },  
 256958: () => { return screen.height; },  
 256984: () => { return window.screenX; },  
 257011: () => { return window.screenY; },  
 257038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 257091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 257162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 257219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 257475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 257546: () => { if (document.fullscreenElement) return 1; },  
 257592: () => { return window.innerWidth; },  
 257618: () => { return window.innerHeight; },  
 257645: () => { if (document.pointerLockElement) return 1; }
};
