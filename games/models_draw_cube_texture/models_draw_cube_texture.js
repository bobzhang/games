...
var ASM_CONSTS = {
  255796: () => { if (document.fullscreenElement) return 1; },  
 255842: () => { return document.getElementById('canvas').width; },  
 255894: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255962: () => { document.exitFullscreen(); },  
 255989: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 256062: () => { if (document.fullscreenElement) return 1; },  
 256108: () => { return document.getElementById('canvas').width; },  
 256160: () => { return screen.width; },  
 256185: () => { document.exitFullscreen(); },  
 256212: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 256345: () => { return window.innerWidth; },  
 256371: () => { return window.innerHeight; },  
 256398: () => { if (document.fullscreenElement) return 1; },  
 256444: () => { return document.getElementById('canvas').width; },  
 256496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256564: () => { if (document.fullscreenElement) return 1; },  
 256610: () => { return document.getElementById('canvas').width; },  
 256662: () => { return screen.width; },  
 256687: () => { return window.innerWidth; },  
 256713: () => { return window.innerHeight; },  
 256740: () => { if (document.fullscreenElement) return 1; },  
 256786: () => { return document.getElementById('canvas').width; },  
 256838: () => { return screen.width; },  
 256863: () => { document.exitFullscreen(); },  
 256890: () => { if (document.fullscreenElement) return 1; },  
 256936: () => { return document.getElementById('canvas').width; },  
 256988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257056: () => { document.exitFullscreen(); },  
 257083: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 257141: () => { return screen.width; },  
 257166: () => { return screen.height; },  
 257192: () => { return window.screenX; },  
 257219: () => { return window.screenY; },  
 257246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 257299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 257370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 257427: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 257683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 257754: () => { if (document.fullscreenElement) return 1; },  
 257800: () => { return window.innerWidth; },  
 257826: () => { return window.innerHeight; },  
 257853: () => { if (document.pointerLockElement) return 1; }
};
