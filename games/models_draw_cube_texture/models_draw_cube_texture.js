...
var ASM_CONSTS = {
  255792: () => { if (document.fullscreenElement) return 1; },  
 255838: () => { return document.getElementById('canvas').width; },  
 255890: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255958: () => { document.exitFullscreen(); },  
 255985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 256058: () => { if (document.fullscreenElement) return 1; },  
 256104: () => { return document.getElementById('canvas').width; },  
 256156: () => { return screen.width; },  
 256181: () => { document.exitFullscreen(); },  
 256208: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 256341: () => { return window.innerWidth; },  
 256367: () => { return window.innerHeight; },  
 256394: () => { if (document.fullscreenElement) return 1; },  
 256440: () => { return document.getElementById('canvas').width; },  
 256492: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256560: () => { if (document.fullscreenElement) return 1; },  
 256606: () => { return document.getElementById('canvas').width; },  
 256658: () => { return screen.width; },  
 256683: () => { return window.innerWidth; },  
 256709: () => { return window.innerHeight; },  
 256736: () => { if (document.fullscreenElement) return 1; },  
 256782: () => { return document.getElementById('canvas').width; },  
 256834: () => { return screen.width; },  
 256859: () => { document.exitFullscreen(); },  
 256886: () => { if (document.fullscreenElement) return 1; },  
 256932: () => { return document.getElementById('canvas').width; },  
 256984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257052: () => { document.exitFullscreen(); },  
 257079: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 257137: () => { return screen.width; },  
 257162: () => { return screen.height; },  
 257188: () => { return window.screenX; },  
 257215: () => { return window.screenY; },  
 257242: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 257295: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 257366: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 257423: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 257679: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 257750: () => { if (document.fullscreenElement) return 1; },  
 257796: () => { return window.innerWidth; },  
 257822: () => { return window.innerHeight; },  
 257849: () => { if (document.pointerLockElement) return 1; }
};
