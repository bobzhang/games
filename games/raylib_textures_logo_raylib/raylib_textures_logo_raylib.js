...
function findWasmBinary() {
  return locateFile('raylib_textures_logo_raylib.wasm');
}
...
var ASM_CONSTS = {
 ...
 104706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104774: () => { document.exitFullscreen(); },  
 104801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 104874: () => { if (document.fullscreenElement) return 1; },  
 104920: () => { return document.getElementById('canvas').width; },  
 104972: () => { return screen.width; },  
 104997: () => { document.exitFullscreen(); },  
 105024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 105157: () => { return window.innerWidth; },  
 105183: () => { return window.innerHeight; },  
 105210: () => { if (document.fullscreenElement) return 1; },  
 105256: () => { return document.getElementById('canvas').width; },  
 105308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105376: () => { if (document.fullscreenElement) return 1; },  
 105422: () => { return document.getElementById('canvas').width; },  
 105474: () => { return screen.width; },  
 105499: () => { return window.innerWidth; },  
 105525: () => { return window.innerHeight; },  
 105552: () => { if (document.fullscreenElement) return 1; },  
 105598: () => { return document.getElementById('canvas').width; },  
 105650: () => { return screen.width; },  
 105675: () => { document.exitFullscreen(); },  
 105702: () => { if (document.fullscreenElement) return 1; },  
 105748: () => { return document.getElementById('canvas').width; },  
 105800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105868: () => { document.exitFullscreen(); },  
 105895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105953: () => { return screen.width; },  
 105978: () => { return screen.height; },  
 106004: () => { return window.screenX; },  
 106031: () => { return window.screenY; },  
 106058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 106111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106495: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106566: () => { if (document.fullscreenElement) return 1; },  
 106612: () => { return window.innerWidth; },  
 106638: () => { return window.innerHeight; },  
 106665: () => { if (document.pointerLockElement) return 1; }
};
