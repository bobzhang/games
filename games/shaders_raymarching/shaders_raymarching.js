...
var ASM_CONSTS = {
  273956: () => { if (document.fullscreenElement) return 1; },  
 274002: () => { return document.getElementById('canvas').width; },  
 274054: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274122: () => { document.exitFullscreen(); },  
 274149: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 274222: () => { if (document.fullscreenElement) return 1; },  
 274268: () => { return document.getElementById('canvas').width; },  
 274320: () => { return screen.width; },  
 274345: () => { document.exitFullscreen(); },  
 274372: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 274505: () => { return window.innerWidth; },  
 274531: () => { return window.innerHeight; },  
 274558: () => { if (document.fullscreenElement) return 1; },  
 274604: () => { return document.getElementById('canvas').width; },  
 274656: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274724: () => { if (document.fullscreenElement) return 1; },  
 274770: () => { return document.getElementById('canvas').width; },  
 274822: () => { return screen.width; },  
 274847: () => { return window.innerWidth; },  
 274873: () => { return window.innerHeight; },  
 274900: () => { if (document.fullscreenElement) return 1; },  
 274946: () => { return document.getElementById('canvas').width; },  
 274998: () => { return screen.width; },  
 275023: () => { document.exitFullscreen(); },  
 275050: () => { if (document.fullscreenElement) return 1; },  
 275096: () => { return document.getElementById('canvas').width; },  
 275148: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275216: () => { document.exitFullscreen(); },  
 275243: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 275301: () => { return screen.width; },  
 275326: () => { return screen.height; },  
 275352: () => { return window.screenX; },  
 275379: () => { return window.screenY; },  
 275406: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 275459: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 275530: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 275587: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 275843: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 275914: () => { if (document.fullscreenElement) return 1; },  
 275960: () => { return window.innerWidth; },  
 275986: () => { return window.innerHeight; },  
 276013: () => { if (document.pointerLockElement) return 1; }
};
