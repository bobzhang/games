...
var ASM_CONSTS = {
  273748: () => { if (document.fullscreenElement) return 1; },  
 273794: () => { return document.getElementById('canvas').width; },  
 273846: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273914: () => { document.exitFullscreen(); },  
 273941: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 274014: () => { if (document.fullscreenElement) return 1; },  
 274060: () => { return document.getElementById('canvas').width; },  
 274112: () => { return screen.width; },  
 274137: () => { document.exitFullscreen(); },  
 274164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 274297: () => { return window.innerWidth; },  
 274323: () => { return window.innerHeight; },  
 274350: () => { if (document.fullscreenElement) return 1; },  
 274396: () => { return document.getElementById('canvas').width; },  
 274448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274516: () => { if (document.fullscreenElement) return 1; },  
 274562: () => { return document.getElementById('canvas').width; },  
 274614: () => { return screen.width; },  
 274639: () => { return window.innerWidth; },  
 274665: () => { return window.innerHeight; },  
 274692: () => { if (document.fullscreenElement) return 1; },  
 274738: () => { return document.getElementById('canvas').width; },  
 274790: () => { return screen.width; },  
 274815: () => { document.exitFullscreen(); },  
 274842: () => { if (document.fullscreenElement) return 1; },  
 274888: () => { return document.getElementById('canvas').width; },  
 274940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275008: () => { document.exitFullscreen(); },  
 275035: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 275093: () => { return screen.width; },  
 275118: () => { return screen.height; },  
 275144: () => { return window.screenX; },  
 275171: () => { return window.screenY; },  
 275198: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 275251: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 275322: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 275379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 275635: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 275706: () => { if (document.fullscreenElement) return 1; },  
 275752: () => { return window.innerWidth; },  
 275778: () => { return window.innerHeight; },  
 275805: () => { if (document.pointerLockElement) return 1; }
};
