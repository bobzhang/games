...
function findWasmBinary() {
  return locateFile('raylib_textures_polygon.wasm');
}
...
var ASM_CONSTS = {
  489312: () => { if (document.fullscreenElement) return 1; },  
 489358: () => { return document.getElementById('canvas').width; },  
 489410: () => { return parseInt(document.getElementById('canvas').style.width); },  
 489478: () => { document.exitFullscreen(); },  
 489505: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 489578: () => { if (document.fullscreenElement) return 1; },  
 489624: () => { return document.getElementById('canvas').width; },  
 489676: () => { return screen.width; },  
 489701: () => { document.exitFullscreen(); },  
 489728: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 489861: () => { return window.innerWidth; },  
 489887: () => { return window.innerHeight; },  
 489914: () => { if (document.fullscreenElement) return 1; },  
 489960: () => { return document.getElementById('canvas').width; },  
 490012: () => { return parseInt(document.getElementById('canvas').style.width); },  
 490080: () => { if (document.fullscreenElement) return 1; },  
 490126: () => { return document.getElementById('canvas').width; },  
 490178: () => { return screen.width; },  
 490203: () => { return window.innerWidth; },  
 490229: () => { return window.innerHeight; },  
 490256: () => { if (document.fullscreenElement) return 1; },  
 490302: () => { return document.getElementById('canvas').width; },  
 490354: () => { return screen.width; },  
 490379: () => { document.exitFullscreen(); },  
 490406: () => { if (document.fullscreenElement) return 1; },  
 490452: () => { return document.getElementById('canvas').width; },  
 490504: () => { return parseInt(document.getElementById('canvas').style.width); },  
 490572: () => { document.exitFullscreen(); },  
 490599: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 490657: () => { return screen.width; },  
 490682: () => { return screen.height; },  
 490708: () => { return window.screenX; },  
 490735: () => { return window.screenY; },  
 490762: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 490815: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 490886: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 490943: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 491199: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 491270: () => { if (document.fullscreenElement) return 1; },  
 491316: () => { return window.innerWidth; },  
 491342: () => { return window.innerHeight; },  
 491369: () => { if (document.pointerLockElement) return 1; }
};
