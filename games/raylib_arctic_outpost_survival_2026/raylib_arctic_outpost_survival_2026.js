...
var ASM_CONSTS = {
 ...
 107690: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107758: () => { document.exitFullscreen(); },  
 107785: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107858: () => { if (document.fullscreenElement) return 1; },  
 107904: () => { return document.getElementById('canvas').width; },  
 107956: () => { return screen.width; },  
 107981: () => { document.exitFullscreen(); },  
 108008: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108141: () => { return window.innerWidth; },  
 108167: () => { return window.innerHeight; },  
 108194: () => { if (document.fullscreenElement) return 1; },  
 108240: () => { return document.getElementById('canvas').width; },  
 108292: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 108483: () => { return window.innerWidth; },  
 108509: () => { return window.innerHeight; },  
