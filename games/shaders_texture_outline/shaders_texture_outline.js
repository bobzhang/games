...
var ASM_CONSTS = {
  266132: () => { if (document.fullscreenElement) return 1; },  
 266178: () => { return document.getElementById('canvas').width; },  
 266230: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266298: () => { document.exitFullscreen(); },  
 266325: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 266398: () => { if (document.fullscreenElement) return 1; },  
 266444: () => { return document.getElementById('canvas').width; },  
 266496: () => { return screen.width; },  
 266521: () => { document.exitFullscreen(); },  
 266548: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 266681: () => { return window.innerWidth; },  
 266707: () => { return window.innerHeight; },  
 266734: () => { if (document.fullscreenElement) return 1; },  
 266780: () => { return document.getElementById('canvas').width; },  
 266832: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266900: () => { if (document.fullscreenElement) return 1; },  
 266946: () => { return document.getElementById('canvas').width; },  
 266998: () => { return screen.width; },  
 267023: () => { return window.innerWidth; },  
 267049: () => { return window.innerHeight; },  
 267076: () => { if (document.fullscreenElement) return 1; },  
 267122: () => { return document.getElementById('canvas').width; },  
 267174: () => { return screen.width; },  
 267199: () => { document.exitFullscreen(); },  
 267226: () => { if (document.fullscreenElement) return 1; },  
 267272: () => { return document.getElementById('canvas').width; },  
 267324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267392: () => { document.exitFullscreen(); },  
 267419: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 267477: () => { return screen.width; },  
 267502: () => { return screen.height; },  
 267528: () => { return window.screenX; },  
 267555: () => { return window.screenY; },  
 267582: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 267635: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267706: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267763: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268019: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268090: () => { if (document.fullscreenElement) return 1; },  
 268136: () => { return window.innerWidth; },  
 268162: () => { return window.innerHeight; },  
 268189: () => { if (document.pointerLockElement) return 1; }
};
