...
var ASM_CONSTS = {
  266356: () => { if (document.fullscreenElement) return 1; },  
 266402: () => { return document.getElementById('canvas').width; },  
 266454: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266522: () => { document.exitFullscreen(); },  
 266549: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 266622: () => { if (document.fullscreenElement) return 1; },  
 266668: () => { return document.getElementById('canvas').width; },  
 266720: () => { return screen.width; },  
 266745: () => { document.exitFullscreen(); },  
 266772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 266905: () => { return window.innerWidth; },  
 266931: () => { return window.innerHeight; },  
 266958: () => { if (document.fullscreenElement) return 1; },  
 267004: () => { return document.getElementById('canvas').width; },  
 267056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267124: () => { if (document.fullscreenElement) return 1; },  
 267170: () => { return document.getElementById('canvas').width; },  
 267222: () => { return screen.width; },  
 267247: () => { return window.innerWidth; },  
 267273: () => { return window.innerHeight; },  
 267300: () => { if (document.fullscreenElement) return 1; },  
 267346: () => { return document.getElementById('canvas').width; },  
 267398: () => { return screen.width; },  
 267423: () => { document.exitFullscreen(); },  
 ...
 267616: () => { document.exitFullscreen(); },  
 267643: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 267701: () => { return screen.width; },  
 267726: () => { return screen.height; },  
 267752: () => { return window.screenX; },  
 267779: () => { return window.screenY; },  
 267806: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 267859: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267930: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267987: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268243: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268314: () => { if (document.fullscreenElement) return 1; },  
 268360: () => { return window.innerWidth; },  
 268386: () => { return window.innerHeight; },  
 268413: () => { if (document.pointerLockElement) return 1; }
};
