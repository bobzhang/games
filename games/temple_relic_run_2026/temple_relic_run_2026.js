...
var ASM_CONSTS = {
 ...
 262182: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262250: () => { document.exitFullscreen(); },  
 262277: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262350: () => { if (document.fullscreenElement) return 1; },  
 262396: () => { return document.getElementById('canvas').width; },  
 262448: () => { return screen.width; },  
 262473: () => { document.exitFullscreen(); },  
 262500: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262633: () => { return window.innerWidth; },  
 262659: () => { return window.innerHeight; },  
 262686: () => { if (document.fullscreenElement) return 1; },  
 262732: () => { return document.getElementById('canvas').width; },  
 262784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262852: () => { if (document.fullscreenElement) return 1; },  
 262898: () => { return document.getElementById('canvas').width; },  
 262950: () => { return screen.width; },  
 262975: () => { return window.innerWidth; },  
 263001: () => { return window.innerHeight; },  
 ...
 263151: () => { document.exitFullscreen(); },  
 263178: () => { if (document.fullscreenElement) return 1; },  
 263224: () => { return document.getElementById('canvas').width; },  
 263276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263344: () => { document.exitFullscreen(); },  
 263371: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263429: () => { return screen.width; },  
 263454: () => { return screen.height; },  
 263480: () => { return window.screenX; },  
 263507: () => { return window.screenY; },  
 263534: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263587: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263658: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263971: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264042: () => { if (document.fullscreenElement) return 1; },  
 264088: () => { return window.innerWidth; },  
 264114: () => { return window.innerHeight; },  
 264141: () => { if (document.pointerLockElement) return 1; }
};
