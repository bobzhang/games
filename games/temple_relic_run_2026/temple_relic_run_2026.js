...
var ASM_CONSTS = {
 ...
 262406: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262474: () => { document.exitFullscreen(); },  
 262501: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262574: () => { if (document.fullscreenElement) return 1; },  
 262620: () => { return document.getElementById('canvas').width; },  
 262672: () => { return screen.width; },  
 262697: () => { document.exitFullscreen(); },  
 262724: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262857: () => { return window.innerWidth; },  
 262883: () => { return window.innerHeight; },  
 262910: () => { if (document.fullscreenElement) return 1; },  
 262956: () => { return document.getElementById('canvas').width; },  
 263008: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263076: () => { if (document.fullscreenElement) return 1; },  
 263122: () => { return document.getElementById('canvas').width; },  
 263174: () => { return screen.width; },  
 263199: () => { return window.innerWidth; },  
 263225: () => { return window.innerHeight; },  
 ...
 263375: () => { document.exitFullscreen(); },  
 263402: () => { if (document.fullscreenElement) return 1; },  
 263448: () => { return document.getElementById('canvas').width; },  
 263500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263568: () => { document.exitFullscreen(); },  
 263595: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263653: () => { return screen.width; },  
 263678: () => { return screen.height; },  
 263704: () => { return window.screenX; },  
 263731: () => { return window.screenY; },  
 263758: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263811: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263882: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263939: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264195: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264266: () => { if (document.fullscreenElement) return 1; },  
 264312: () => { return window.innerWidth; },  
 264338: () => { return window.innerHeight; },  
 264365: () => { if (document.pointerLockElement) return 1; }
};
