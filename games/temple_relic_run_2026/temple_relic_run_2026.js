...
var ASM_CONSTS = {
 ...
 262390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262458: () => { document.exitFullscreen(); },  
 262485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262558: () => { if (document.fullscreenElement) return 1; },  
 262604: () => { return document.getElementById('canvas').width; },  
 262656: () => { return screen.width; },  
 262681: () => { document.exitFullscreen(); },  
 262708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262841: () => { return window.innerWidth; },  
 262867: () => { return window.innerHeight; },  
 262894: () => { if (document.fullscreenElement) return 1; },  
 262940: () => { return document.getElementById('canvas').width; },  
 262992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263060: () => { if (document.fullscreenElement) return 1; },  
 263106: () => { return document.getElementById('canvas').width; },  
 263158: () => { return screen.width; },  
 263183: () => { return window.innerWidth; },  
 263209: () => { return window.innerHeight; },  
 263236: () => { if (document.fullscreenElement) return 1; },  
 263282: () => { return document.getElementById('canvas').width; },  
 263334: () => { return screen.width; },  
 263359: () => { document.exitFullscreen(); },  
 263386: () => { if (document.fullscreenElement) return 1; },  
 263432: () => { return document.getElementById('canvas').width; },  
 263484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263552: () => { document.exitFullscreen(); },  
 263579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263637: () => { return screen.width; },  
 263662: () => { return screen.height; },  
 263688: () => { return window.screenX; },  
 263715: () => { return window.screenY; },  
 263742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264250: () => { if (document.fullscreenElement) return 1; },  
 264296: () => { return window.innerWidth; },  
 264322: () => { return window.innerHeight; },  
 264349: () => { if (document.pointerLockElement) return 1; }
};
