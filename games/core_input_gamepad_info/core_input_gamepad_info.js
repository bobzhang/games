...
var ASM_CONSTS = {
  260628: () => { if (document.fullscreenElement) return 1; },  
 260674: () => { return document.getElementById('canvas').width; },  
 260726: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260794: () => { document.exitFullscreen(); },  
 260821: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260894: () => { if (document.fullscreenElement) return 1; },  
 260940: () => { return document.getElementById('canvas').width; },  
 260992: () => { return screen.width; },  
 261017: () => { document.exitFullscreen(); },  
 261044: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261177: () => { return window.innerWidth; },  
 261203: () => { return window.innerHeight; },  
 261230: () => { if (document.fullscreenElement) return 1; },  
 261276: () => { return document.getElementById('canvas').width; },  
 261328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261396: () => { if (document.fullscreenElement) return 1; },  
 261442: () => { return document.getElementById('canvas').width; },  
 261494: () => { return screen.width; },  
 261519: () => { return window.innerWidth; },  
 261545: () => { return window.innerHeight; },  
 261572: () => { if (document.fullscreenElement) return 1; },  
 261618: () => { return document.getElementById('canvas').width; },  
 261670: () => { return screen.width; },  
 261695: () => { document.exitFullscreen(); },  
 261722: () => { if (document.fullscreenElement) return 1; },  
 261768: () => { return document.getElementById('canvas').width; },  
 261820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261888: () => { document.exitFullscreen(); },  
 261915: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261973: () => { return screen.width; },  
 261998: () => { return screen.height; },  
 262024: () => { return window.screenX; },  
 262051: () => { return window.screenY; },  
 262078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262131: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262202: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262515: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262586: () => { if (document.fullscreenElement) return 1; },  
 262632: () => { return window.innerWidth; },  
 262658: () => { return window.innerHeight; },  
 262685: () => { if (document.pointerLockElement) return 1; }
};
