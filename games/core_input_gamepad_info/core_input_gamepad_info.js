...
var ASM_CONSTS = {
  260544: () => { if (document.fullscreenElement) return 1; },  
 260590: () => { return document.getElementById('canvas').width; },  
 260642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260710: () => { document.exitFullscreen(); },  
 260737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260810: () => { if (document.fullscreenElement) return 1; },  
 260856: () => { return document.getElementById('canvas').width; },  
 260908: () => { return screen.width; },  
 260933: () => { document.exitFullscreen(); },  
 260960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261093: () => { return window.innerWidth; },  
 261119: () => { return window.innerHeight; },  
 261146: () => { if (document.fullscreenElement) return 1; },  
 261192: () => { return document.getElementById('canvas').width; },  
 261244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261312: () => { if (document.fullscreenElement) return 1; },  
 261358: () => { return document.getElementById('canvas').width; },  
 261410: () => { return screen.width; },  
 261435: () => { return window.innerWidth; },  
 261461: () => { return window.innerHeight; },  
 ...
 261611: () => { document.exitFullscreen(); },  
 261638: () => { if (document.fullscreenElement) return 1; },  
 261684: () => { return document.getElementById('canvas').width; },  
 261736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261804: () => { document.exitFullscreen(); },  
 261831: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261889: () => { return screen.width; },  
 261914: () => { return screen.height; },  
 261940: () => { return window.screenX; },  
 261967: () => { return window.screenY; },  
 261994: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262047: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262118: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262431: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262502: () => { if (document.fullscreenElement) return 1; },  
 262548: () => { return window.innerWidth; },  
 262574: () => { return window.innerHeight; },  
 262601: () => { if (document.pointerLockElement) return 1; }
};
