...
var ASM_CONSTS = {
  260772: () => { if (document.fullscreenElement) return 1; },  
 260818: () => { return document.getElementById('canvas').width; },  
 260870: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260938: () => { document.exitFullscreen(); },  
 260965: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261038: () => { if (document.fullscreenElement) return 1; },  
 261084: () => { return document.getElementById('canvas').width; },  
 261136: () => { return screen.width; },  
 261161: () => { document.exitFullscreen(); },  
 261188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261321: () => { return window.innerWidth; },  
 261347: () => { return window.innerHeight; },  
 261374: () => { if (document.fullscreenElement) return 1; },  
 261420: () => { return document.getElementById('canvas').width; },  
 261472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261540: () => { if (document.fullscreenElement) return 1; },  
 261586: () => { return document.getElementById('canvas').width; },  
 261638: () => { return screen.width; },  
 261663: () => { return window.innerWidth; },  
 261689: () => { return window.innerHeight; },  
 ...
 261839: () => { document.exitFullscreen(); },  
 ...
 262032: () => { document.exitFullscreen(); },  
 262059: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262117: () => { return screen.width; },  
 262142: () => { return screen.height; },  
 262168: () => { return window.screenX; },  
 262195: () => { return window.screenY; },  
 262222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262275: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262346: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262659: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262730: () => { if (document.fullscreenElement) return 1; },  
 262776: () => { return window.innerWidth; },  
 262802: () => { return window.innerHeight; },  
 262829: () => { if (document.pointerLockElement) return 1; }
};
