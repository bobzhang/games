...
var ASM_CONSTS = {
  260836: () => { if (document.fullscreenElement) return 1; },  
 260882: () => { return document.getElementById('canvas').width; },  
 260934: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261002: () => { document.exitFullscreen(); },  
 261029: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261102: () => { if (document.fullscreenElement) return 1; },  
 261148: () => { return document.getElementById('canvas').width; },  
 261200: () => { return screen.width; },  
 261225: () => { document.exitFullscreen(); },  
 261252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261385: () => { return window.innerWidth; },  
 261411: () => { return window.innerHeight; },  
 261438: () => { if (document.fullscreenElement) return 1; },  
 261484: () => { return document.getElementById('canvas').width; },  
 261536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261604: () => { if (document.fullscreenElement) return 1; },  
 261650: () => { return document.getElementById('canvas').width; },  
 261702: () => { return screen.width; },  
 261727: () => { return window.innerWidth; },  
 261753: () => { return window.innerHeight; },  
 ...
 261903: () => { document.exitFullscreen(); },  
 ...
 262096: () => { document.exitFullscreen(); },  
 262123: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262181: () => { return screen.width; },  
 262206: () => { return screen.height; },  
 262232: () => { return window.screenX; },  
 262259: () => { return window.screenY; },  
 262286: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262339: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262410: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262467: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262723: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262794: () => { if (document.fullscreenElement) return 1; },  
 262840: () => { return window.innerWidth; },  
 262866: () => { return window.innerHeight; },  
 262893: () => { if (document.pointerLockElement) return 1; }
};
