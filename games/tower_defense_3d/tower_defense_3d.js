...
var ASM_CONSTS = {
  269588: () => { if (document.fullscreenElement) return 1; },  
 269634: () => { return document.getElementById('canvas').width; },  
 269686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269754: () => { document.exitFullscreen(); },  
 269781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269854: () => { if (document.fullscreenElement) return 1; },  
 269900: () => { return document.getElementById('canvas').width; },  
 269952: () => { return screen.width; },  
 269977: () => { document.exitFullscreen(); },  
 270004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 270137: () => { return window.innerWidth; },  
 270163: () => { return window.innerHeight; },  
 270190: () => { if (document.fullscreenElement) return 1; },  
 270236: () => { return document.getElementById('canvas').width; },  
 270288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270356: () => { if (document.fullscreenElement) return 1; },  
 270402: () => { return document.getElementById('canvas').width; },  
 270454: () => { return screen.width; },  
 270479: () => { return window.innerWidth; },  
 270505: () => { return window.innerHeight; },  
 270532: () => { if (document.fullscreenElement) return 1; },  
 270578: () => { return document.getElementById('canvas').width; },  
 270630: () => { return screen.width; },  
 270655: () => { document.exitFullscreen(); },  
 270682: () => { if (document.fullscreenElement) return 1; },  
 270728: () => { return document.getElementById('canvas').width; },  
 270780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270848: () => { document.exitFullscreen(); },  
 270875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270933: () => { return screen.width; },  
 270958: () => { return screen.height; },  
 270984: () => { return window.screenX; },  
 271011: () => { return window.screenY; },  
 271038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 271091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 271162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 271219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271546: () => { if (document.fullscreenElement) return 1; },  
 271592: () => { return window.innerWidth; },  
 271618: () => { return window.innerHeight; },  
 271645: () => { if (document.pointerLockElement) return 1; }
};
