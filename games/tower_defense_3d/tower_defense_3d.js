...
var ASM_CONSTS = {
  269572: () => { if (document.fullscreenElement) return 1; },  
 269618: () => { return document.getElementById('canvas').width; },  
 269670: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269738: () => { document.exitFullscreen(); },  
 269765: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269838: () => { if (document.fullscreenElement) return 1; },  
 269884: () => { return document.getElementById('canvas').width; },  
 269936: () => { return screen.width; },  
 269961: () => { document.exitFullscreen(); },  
 269988: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 270121: () => { return window.innerWidth; },  
 270147: () => { return window.innerHeight; },  
 270174: () => { if (document.fullscreenElement) return 1; },  
 270220: () => { return document.getElementById('canvas').width; },  
 270272: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270340: () => { if (document.fullscreenElement) return 1; },  
 270386: () => { return document.getElementById('canvas').width; },  
 270438: () => { return screen.width; },  
 270463: () => { return window.innerWidth; },  
 270489: () => { return window.innerHeight; },  
 270516: () => { if (document.fullscreenElement) return 1; },  
 270562: () => { return document.getElementById('canvas').width; },  
 270614: () => { return screen.width; },  
 270639: () => { document.exitFullscreen(); },  
 270666: () => { if (document.fullscreenElement) return 1; },  
 270712: () => { return document.getElementById('canvas').width; },  
 270764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270832: () => { document.exitFullscreen(); },  
 270859: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270917: () => { return screen.width; },  
 270942: () => { return screen.height; },  
 270968: () => { return window.screenX; },  
 270995: () => { return window.screenY; },  
 271022: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 271075: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 271146: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 271203: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271459: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271530: () => { if (document.fullscreenElement) return 1; },  
 271576: () => { return window.innerWidth; },  
 271602: () => { return window.innerHeight; },  
 271629: () => { if (document.pointerLockElement) return 1; }
};
