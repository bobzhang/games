...
var ASM_CONSTS = {
  269364: () => { if (document.fullscreenElement) return 1; },  
 269410: () => { return document.getElementById('canvas').width; },  
 269462: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269530: () => { document.exitFullscreen(); },  
 269557: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269630: () => { if (document.fullscreenElement) return 1; },  
 269676: () => { return document.getElementById('canvas').width; },  
 269728: () => { return screen.width; },  
 269753: () => { document.exitFullscreen(); },  
 269780: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269913: () => { return window.innerWidth; },  
 269939: () => { return window.innerHeight; },  
 269966: () => { if (document.fullscreenElement) return 1; },  
 270012: () => { return document.getElementById('canvas').width; },  
 270064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270132: () => { if (document.fullscreenElement) return 1; },  
 270178: () => { return document.getElementById('canvas').width; },  
 270230: () => { return screen.width; },  
 270255: () => { return window.innerWidth; },  
 270281: () => { return window.innerHeight; },  
 270308: () => { if (document.fullscreenElement) return 1; },  
 270354: () => { return document.getElementById('canvas').width; },  
 270406: () => { return screen.width; },  
 270431: () => { document.exitFullscreen(); },  
 270458: () => { if (document.fullscreenElement) return 1; },  
 270504: () => { return document.getElementById('canvas').width; },  
 270556: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270624: () => { document.exitFullscreen(); },  
 270651: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270709: () => { return screen.width; },  
 270734: () => { return screen.height; },  
 270760: () => { return window.screenX; },  
 270787: () => { return window.screenY; },  
 270814: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270867: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270938: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270995: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271251: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271322: () => { if (document.fullscreenElement) return 1; },  
 271368: () => { return window.innerWidth; },  
 271394: () => { return window.innerHeight; },  
 271421: () => { if (document.pointerLockElement) return 1; }
};
