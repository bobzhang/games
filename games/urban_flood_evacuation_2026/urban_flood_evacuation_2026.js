...
var ASM_CONSTS = {
 ...
 263526: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263594: () => { document.exitFullscreen(); },  
 263621: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263694: () => { if (document.fullscreenElement) return 1; },  
 263740: () => { return document.getElementById('canvas').width; },  
 263792: () => { return screen.width; },  
 263817: () => { document.exitFullscreen(); },  
 263844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263977: () => { return window.innerWidth; },  
 264003: () => { return window.innerHeight; },  
 264030: () => { if (document.fullscreenElement) return 1; },  
 264076: () => { return document.getElementById('canvas').width; },  
 264128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264319: () => { return window.innerWidth; },  
 264345: () => { return window.innerHeight; },  
 264372: () => { if (document.fullscreenElement) return 1; },  
 264418: () => { return document.getElementById('canvas').width; },  
 264470: () => { return screen.width; },  
 264495: () => { document.exitFullscreen(); },  
 ...
 264688: () => { document.exitFullscreen(); },  
 264715: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264773: () => { return screen.width; },  
 264798: () => { return screen.height; },  
 264824: () => { return window.screenX; },  
 264851: () => { return window.screenY; },  
 264878: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264931: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265002: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265059: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265315: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265386: () => { if (document.fullscreenElement) return 1; },  
 265432: () => { return window.innerWidth; },  
 265458: () => { return window.innerHeight; },  
 265485: () => { if (document.pointerLockElement) return 1; }
};
