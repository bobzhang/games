...
var ASM_CONSTS = {
  263412: () => { if (document.fullscreenElement) return 1; },  
 263458: () => { return document.getElementById('canvas').width; },  
 263510: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263578: () => { document.exitFullscreen(); },  
 263605: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263678: () => { if (document.fullscreenElement) return 1; },  
 263724: () => { return document.getElementById('canvas').width; },  
 263776: () => { return screen.width; },  
 263801: () => { document.exitFullscreen(); },  
 263828: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263961: () => { return window.innerWidth; },  
 263987: () => { return window.innerHeight; },  
 264014: () => { if (document.fullscreenElement) return 1; },  
 264060: () => { return document.getElementById('canvas').width; },  
 264112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264180: () => { if (document.fullscreenElement) return 1; },  
 264226: () => { return document.getElementById('canvas').width; },  
 264278: () => { return screen.width; },  
 264303: () => { return window.innerWidth; },  
 264329: () => { return window.innerHeight; },  
 ...
 264479: () => { document.exitFullscreen(); },  
 264506: () => { if (document.fullscreenElement) return 1; },  
 264552: () => { return document.getElementById('canvas').width; },  
 264604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264672: () => { document.exitFullscreen(); },  
 264699: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264757: () => { return screen.width; },  
 264782: () => { return screen.height; },  
 264808: () => { return window.screenX; },  
 264835: () => { return window.screenY; },  
 264862: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264915: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264986: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265043: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265299: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265370: () => { if (document.fullscreenElement) return 1; },  
 265416: () => { return window.innerWidth; },  
 265442: () => { return window.innerHeight; },  
 265469: () => { if (document.pointerLockElement) return 1; }
};
