...
var ASM_CONSTS = {
 ...
 263302: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263370: () => { document.exitFullscreen(); },  
 263397: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263470: () => { if (document.fullscreenElement) return 1; },  
 263516: () => { return document.getElementById('canvas').width; },  
 263568: () => { return screen.width; },  
 263593: () => { document.exitFullscreen(); },  
 263620: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263753: () => { return window.innerWidth; },  
 263779: () => { return window.innerHeight; },  
 263806: () => { if (document.fullscreenElement) return 1; },  
 263852: () => { return document.getElementById('canvas').width; },  
 263904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264095: () => { return window.innerWidth; },  
 264121: () => { return window.innerHeight; },  
 ...
 264271: () => { document.exitFullscreen(); },  
 ...
 264464: () => { document.exitFullscreen(); },  
 264491: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264549: () => { return screen.width; },  
 264574: () => { return screen.height; },  
 264600: () => { return window.screenX; },  
 264627: () => { return window.screenY; },  
 264654: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264707: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264778: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264835: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 ...
 265234: () => { return window.innerHeight; },  
 265261: () => { if (document.pointerLockElement) return 1; }
};
