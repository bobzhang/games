...
var ASM_CONSTS = {
  1047444: () => { if (document.fullscreenElement) return 1; },  
 1047490: () => { return document.getElementById('canvas').width; },  
 1047542: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1047610: () => { document.exitFullscreen(); },  
 1047637: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1047710: () => { if (document.fullscreenElement) return 1; },  
 1047756: () => { return document.getElementById('canvas').width; },  
 1047808: () => { return screen.width; },  
 1047833: () => { document.exitFullscreen(); },  
 1047860: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1047993: () => { return window.innerWidth; },  
 1048019: () => { return window.innerHeight; },  
 1048046: () => { if (document.fullscreenElement) return 1; },  
 1048092: () => { return document.getElementById('canvas').width; },  
 1048144: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1048212: () => { if (document.fullscreenElement) return 1; },  
 1048258: () => { return document.getElementById('canvas').width; },  
 1048310: () => { return screen.width; },  
 1048335: () => { return window.innerWidth; },  
 1048361: () => { return window.innerHeight; },  
 1048388: () => { if (document.fullscreenElement) return 1; },  
 1048434: () => { return document.getElementById('canvas').width; },  
 1048486: () => { return screen.width; },  
 1048511: () => { document.exitFullscreen(); },  
 1048538: () => { if (document.fullscreenElement) return 1; },  
 1048584: () => { return document.getElementById('canvas').width; },  
 1048636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1048704: () => { document.exitFullscreen(); },  
 1048731: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1048789: () => { return screen.width; },  
 1048814: () => { return screen.height; },  
 1048840: () => { return window.screenX; },  
 1048867: () => { return window.screenY; },  
 1048894: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1048947: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1049018: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1049075: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1049331: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1049402: () => { if (document.fullscreenElement) return 1; },  
 1049448: () => { return window.innerWidth; },  
 1049474: () => { return window.innerHeight; },  
 1049501: () => { if (document.pointerLockElement) return 1; }
};
