...
var ASM_CONSTS = {
  1047428: () => { if (document.fullscreenElement) return 1; },  
 1047474: () => { return document.getElementById('canvas').width; },  
 1047526: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1047594: () => { document.exitFullscreen(); },  
 1047621: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1047694: () => { if (document.fullscreenElement) return 1; },  
 1047740: () => { return document.getElementById('canvas').width; },  
 1047792: () => { return screen.width; },  
 1047817: () => { document.exitFullscreen(); },  
 1047844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1047977: () => { return window.innerWidth; },  
 1048003: () => { return window.innerHeight; },  
 1048030: () => { if (document.fullscreenElement) return 1; },  
 1048076: () => { return document.getElementById('canvas').width; },  
 1048128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1048196: () => { if (document.fullscreenElement) return 1; },  
 1048242: () => { return document.getElementById('canvas').width; },  
 1048294: () => { return screen.width; },  
 1048319: () => { return window.innerWidth; },  
 1048345: () => { return window.innerHeight; },  
 1048372: () => { if (document.fullscreenElement) return 1; },  
 1048418: () => { return document.getElementById('canvas').width; },  
 1048470: () => { return screen.width; },  
 1048495: () => { document.exitFullscreen(); },  
 1048522: () => { if (document.fullscreenElement) return 1; },  
 1048568: () => { return document.getElementById('canvas').width; },  
 1048620: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1048688: () => { document.exitFullscreen(); },  
 1048715: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1048773: () => { return screen.width; },  
 1048798: () => { return screen.height; },  
 1048824: () => { return window.screenX; },  
 1048851: () => { return window.screenY; },  
 1048878: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1048931: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1049002: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1049059: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1049315: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1049386: () => { if (document.fullscreenElement) return 1; },  
 1049432: () => { return window.innerWidth; },  
 1049458: () => { return window.innerHeight; },  
 1049485: () => { if (document.pointerLockElement) return 1; }
};
