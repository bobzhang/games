...
var ASM_CONSTS = {
  1047220: () => { if (document.fullscreenElement) return 1; },  
 1047266: () => { return document.getElementById('canvas').width; },  
 1047318: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1047386: () => { document.exitFullscreen(); },  
 1047413: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1047486: () => { if (document.fullscreenElement) return 1; },  
 1047532: () => { return document.getElementById('canvas').width; },  
 1047584: () => { return screen.width; },  
 1047609: () => { document.exitFullscreen(); },  
 1047636: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1047769: () => { return window.innerWidth; },  
 1047795: () => { return window.innerHeight; },  
 1047822: () => { if (document.fullscreenElement) return 1; },  
 1047868: () => { return document.getElementById('canvas').width; },  
 1047920: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1047988: () => { if (document.fullscreenElement) return 1; },  
 1048034: () => { return document.getElementById('canvas').width; },  
 1048086: () => { return screen.width; },  
 1048111: () => { return window.innerWidth; },  
 1048137: () => { return window.innerHeight; },  
 1048164: () => { if (document.fullscreenElement) return 1; },  
 1048210: () => { return document.getElementById('canvas').width; },  
 1048262: () => { return screen.width; },  
 1048287: () => { document.exitFullscreen(); },  
 1048314: () => { if (document.fullscreenElement) return 1; },  
 1048360: () => { return document.getElementById('canvas').width; },  
 1048412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1048480: () => { document.exitFullscreen(); },  
 1048507: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1048565: () => { return screen.width; },  
 1048590: () => { return screen.height; },  
 1048616: () => { return window.screenX; },  
 1048643: () => { return window.screenY; },  
 1048670: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1048723: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1048794: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1048851: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1049107: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1049178: () => { if (document.fullscreenElement) return 1; },  
 1049224: () => { return window.innerWidth; },  
 1049250: () => { return window.innerHeight; },  
 1049277: () => { if (document.pointerLockElement) return 1; }
};
