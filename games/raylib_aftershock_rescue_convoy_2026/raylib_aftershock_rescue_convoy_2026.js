...
var ASM_CONSTS = {
 ...
 99922: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99990: () => { document.exitFullscreen(); },  
 100017: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100090: () => { if (document.fullscreenElement) return 1; },  
 100136: () => { return document.getElementById('canvas').width; },  
 100188: () => { return screen.width; },  
 100213: () => { document.exitFullscreen(); },  
 100240: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100373: () => { return window.innerWidth; },  
 100399: () => { return window.innerHeight; },  
 100426: () => { if (document.fullscreenElement) return 1; },  
 100472: () => { return document.getElementById('canvas').width; },  
 100524: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100592: () => { if (document.fullscreenElement) return 1; },  
 100638: () => { return document.getElementById('canvas').width; },  
 100690: () => { return screen.width; },  
 100715: () => { return window.innerWidth; },  
 100741: () => { return window.innerHeight; },  
 100768: () => { if (document.fullscreenElement) return 1; },  
 100814: () => { return document.getElementById('canvas').width; },  
 100866: () => { return screen.width; },  
 100891: () => { document.exitFullscreen(); },  
 100918: () => { if (document.fullscreenElement) return 1; },  
 100964: () => { return document.getElementById('canvas').width; },  
 101016: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101084: () => { document.exitFullscreen(); },  
 101111: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101169: () => { return screen.width; },  
 101194: () => { return screen.height; },  
 101220: () => { return window.screenX; },  
 101247: () => { return window.screenY; },  
 101274: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101327: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101398: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101455: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101711: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101782: () => { if (document.fullscreenElement) return 1; },  
 101828: () => { return window.innerWidth; },  
 101854: () => { return window.innerHeight; },  
 101881: () => { if (document.pointerLockElement) return 1; }
};
