...
var ASM_CONSTS = {
 ...
 262802: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262870: () => { document.exitFullscreen(); },  
 262897: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262970: () => { if (document.fullscreenElement) return 1; },  
 263016: () => { return document.getElementById('canvas').width; },  
 263068: () => { return screen.width; },  
 263093: () => { document.exitFullscreen(); },  
 263120: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263253: () => { return window.innerWidth; },  
 263279: () => { return window.innerHeight; },  
 263306: () => { if (document.fullscreenElement) return 1; },  
 263352: () => { return document.getElementById('canvas').width; },  
 263404: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263472: () => { if (document.fullscreenElement) return 1; },  
 263518: () => { return document.getElementById('canvas').width; },  
 263570: () => { return screen.width; },  
 263595: () => { return window.innerWidth; },  
 263621: () => { return window.innerHeight; },  
 ...
 263771: () => { document.exitFullscreen(); },  
 263798: () => { if (document.fullscreenElement) return 1; },  
 263844: () => { return document.getElementById('canvas').width; },  
 263896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263964: () => { document.exitFullscreen(); },  
 263991: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264049: () => { return screen.width; },  
 264074: () => { return screen.height; },  
 264100: () => { return window.screenX; },  
 264127: () => { return window.screenY; },  
 264154: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264207: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264278: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264335: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264591: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264662: () => { if (document.fullscreenElement) return 1; },  
 264708: () => { return window.innerWidth; },  
 264734: () => { return window.innerHeight; },  
 264761: () => { if (document.pointerLockElement) return 1; }
};
