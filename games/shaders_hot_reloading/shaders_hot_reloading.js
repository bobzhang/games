...
var ASM_CONSTS = {
 ...
 262598: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262666: () => { document.exitFullscreen(); },  
 262693: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262766: () => { if (document.fullscreenElement) return 1; },  
 262812: () => { return document.getElementById('canvas').width; },  
 262864: () => { return screen.width; },  
 262889: () => { document.exitFullscreen(); },  
 262916: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263049: () => { return window.innerWidth; },  
 263075: () => { return window.innerHeight; },  
 263102: () => { if (document.fullscreenElement) return 1; },  
 263148: () => { return document.getElementById('canvas').width; },  
 263200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263391: () => { return window.innerWidth; },  
 263417: () => { return window.innerHeight; },  
 ...
 263567: () => { document.exitFullscreen(); },  
 263594: () => { if (document.fullscreenElement) return 1; },  
 263640: () => { return document.getElementById('canvas').width; },  
 263692: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263760: () => { document.exitFullscreen(); },  
 263787: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263845: () => { return screen.width; },  
 263870: () => { return screen.height; },  
 263896: () => { return window.screenX; },  
 263923: () => { return window.screenY; },  
 263950: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264003: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264074: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264387: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264458: () => { if (document.fullscreenElement) return 1; },  
 264504: () => { return window.innerWidth; },  
 264530: () => { return window.innerHeight; },  
 264557: () => { if (document.pointerLockElement) return 1; }
};
