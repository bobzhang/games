...
var ASM_CONSTS = {
 ...
 262806: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262874: () => { document.exitFullscreen(); },  
 262901: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262974: () => { if (document.fullscreenElement) return 1; },  
 263020: () => { return document.getElementById('canvas').width; },  
 263072: () => { return screen.width; },  
 263097: () => { document.exitFullscreen(); },  
 263124: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263257: () => { return window.innerWidth; },  
 263283: () => { return window.innerHeight; },  
 263310: () => { if (document.fullscreenElement) return 1; },  
 263356: () => { return document.getElementById('canvas').width; },  
 263408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263476: () => { if (document.fullscreenElement) return 1; },  
 263522: () => { return document.getElementById('canvas').width; },  
 263574: () => { return screen.width; },  
 263599: () => { return window.innerWidth; },  
 263625: () => { return window.innerHeight; },  
 ...
 263775: () => { document.exitFullscreen(); },  
 ...
 263968: () => { document.exitFullscreen(); },  
 263995: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264053: () => { return screen.width; },  
 264078: () => { return screen.height; },  
 264104: () => { return window.screenX; },  
 264131: () => { return window.screenY; },  
 264158: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264211: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264282: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264339: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264595: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264666: () => { if (document.fullscreenElement) return 1; },  
 264712: () => { return window.innerWidth; },  
 264738: () => { return window.innerHeight; },  
 264765: () => { if (document.pointerLockElement) return 1; }
};
