...
function findWasmBinary() {
  return locateFile('raylib_core_custom_frame_control.wasm');
}
...
var ASM_CONSTS = {
  97328: () => { if (document.fullscreenElement) return 1; },  
 97374: () => { return document.getElementById('canvas').width; },  
 97426: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97494: () => { document.exitFullscreen(); },  
 97521: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97594: () => { if (document.fullscreenElement) return 1; },  
 97640: () => { return document.getElementById('canvas').width; },  
 97692: () => { return screen.width; },  
 97717: () => { document.exitFullscreen(); },  
 97744: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97877: () => { return window.innerWidth; },  
 97903: () => { return window.innerHeight; },  
 97930: () => { if (document.fullscreenElement) return 1; },  
 97976: () => { return document.getElementById('canvas').width; },  
 98028: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98096: () => { if (document.fullscreenElement) return 1; },  
 98142: () => { return document.getElementById('canvas').width; },  
 98194: () => { return screen.width; },  
 98219: () => { return window.innerWidth; },  
 98245: () => { return window.innerHeight; },  
 98272: () => { if (document.fullscreenElement) return 1; },  
 98318: () => { return document.getElementById('canvas').width; },  
 98370: () => { return screen.width; },  
 98395: () => { document.exitFullscreen(); },  
 98422: () => { if (document.fullscreenElement) return 1; },  
 98468: () => { return document.getElementById('canvas').width; },  
 98520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98588: () => { document.exitFullscreen(); },  
 98615: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98673: () => { return screen.width; },  
 98698: () => { return screen.height; },  
 98724: () => { return window.screenX; },  
 98751: () => { return window.screenY; },  
 98778: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98831: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98902: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98959: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99215: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99286: () => { if (document.fullscreenElement) return 1; },  
 99332: () => { return window.innerWidth; },  
 99358: () => { return window.innerHeight; },  
 99385: () => { if (document.pointerLockElement) return 1; }
};
