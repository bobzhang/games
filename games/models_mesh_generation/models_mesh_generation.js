...
var ASM_CONSTS = {
  262668: () => { if (document.fullscreenElement) return 1; },  
 262714: () => { return document.getElementById('canvas').width; },  
 262766: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262834: () => { document.exitFullscreen(); },  
 262861: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262934: () => { if (document.fullscreenElement) return 1; },  
 262980: () => { return document.getElementById('canvas').width; },  
 263032: () => { return screen.width; },  
 263057: () => { document.exitFullscreen(); },  
 263084: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263217: () => { return window.innerWidth; },  
 263243: () => { return window.innerHeight; },  
 263270: () => { if (document.fullscreenElement) return 1; },  
 263316: () => { return document.getElementById('canvas').width; },  
 263368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263436: () => { if (document.fullscreenElement) return 1; },  
 263482: () => { return document.getElementById('canvas').width; },  
 263534: () => { return screen.width; },  
 263559: () => { return window.innerWidth; },  
 263585: () => { return window.innerHeight; },  
 263612: () => { if (document.fullscreenElement) return 1; },  
 263658: () => { return document.getElementById('canvas').width; },  
 263710: () => { return screen.width; },  
 263735: () => { document.exitFullscreen(); },  
 263762: () => { if (document.fullscreenElement) return 1; },  
 263808: () => { return document.getElementById('canvas').width; },  
 263860: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263928: () => { document.exitFullscreen(); },  
 263955: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264013: () => { return screen.width; },  
 264038: () => { return screen.height; },  
 264064: () => { return window.screenX; },  
 264091: () => { return window.screenY; },  
 264118: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264171: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264242: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264299: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264555: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264626: () => { if (document.fullscreenElement) return 1; },  
 264672: () => { return window.innerWidth; },  
 264698: () => { return window.innerHeight; },  
 264725: () => { if (document.pointerLockElement) return 1; }
};
