...
var ASM_CONSTS = {
  262460: () => { if (document.fullscreenElement) return 1; },  
 262506: () => { return document.getElementById('canvas').width; },  
 262558: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262626: () => { document.exitFullscreen(); },  
 262653: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262726: () => { if (document.fullscreenElement) return 1; },  
 262772: () => { return document.getElementById('canvas').width; },  
 262824: () => { return screen.width; },  
 262849: () => { document.exitFullscreen(); },  
 262876: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263009: () => { return window.innerWidth; },  
 263035: () => { return window.innerHeight; },  
 ...
 263228: () => { if (document.fullscreenElement) return 1; },  
 263274: () => { return document.getElementById('canvas').width; },  
 263326: () => { return screen.width; },  
 263351: () => { return window.innerWidth; },  
 263377: () => { return window.innerHeight; },  
 263404: () => { if (document.fullscreenElement) return 1; },  
 263450: () => { return document.getElementById('canvas').width; },  
 263502: () => { return screen.width; },  
 263527: () => { document.exitFullscreen(); },  
 263554: () => { if (document.fullscreenElement) return 1; },  
 263600: () => { return document.getElementById('canvas').width; },  
 263652: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263720: () => { document.exitFullscreen(); },  
 263747: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263805: () => { return screen.width; },  
 263830: () => { return screen.height; },  
 263856: () => { return window.screenX; },  
 263883: () => { return window.screenY; },  
 263910: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263963: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264034: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264091: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264347: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264418: () => { if (document.fullscreenElement) return 1; },  
 264464: () => { return window.innerWidth; },  
 264490: () => { return window.innerHeight; },  
 264517: () => { if (document.pointerLockElement) return 1; }
};
