...
var ASM_CONSTS = {
  262684: () => { if (document.fullscreenElement) return 1; },  
 262730: () => { return document.getElementById('canvas').width; },  
 262782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262850: () => { document.exitFullscreen(); },  
 262877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262950: () => { if (document.fullscreenElement) return 1; },  
 262996: () => { return document.getElementById('canvas').width; },  
 263048: () => { return screen.width; },  
 263073: () => { document.exitFullscreen(); },  
 263100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263233: () => { return window.innerWidth; },  
 263259: () => { return window.innerHeight; },  
 ...
 263452: () => { if (document.fullscreenElement) return 1; },  
 263498: () => { return document.getElementById('canvas').width; },  
 263550: () => { return screen.width; },  
 263575: () => { return window.innerWidth; },  
 263601: () => { return window.innerHeight; },  
 263628: () => { if (document.fullscreenElement) return 1; },  
 263674: () => { return document.getElementById('canvas').width; },  
 263726: () => { return screen.width; },  
 263751: () => { document.exitFullscreen(); },  
 263778: () => { if (document.fullscreenElement) return 1; },  
 263824: () => { return document.getElementById('canvas').width; },  
 263876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263944: () => { document.exitFullscreen(); },  
 263971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264029: () => { return screen.width; },  
 264054: () => { return screen.height; },  
 264080: () => { return window.screenX; },  
 264107: () => { return window.screenY; },  
 264134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264642: () => { if (document.fullscreenElement) return 1; },  
 264688: () => { return window.innerWidth; },  
 264714: () => { return window.innerHeight; },  
 264741: () => { if (document.pointerLockElement) return 1; }
};
