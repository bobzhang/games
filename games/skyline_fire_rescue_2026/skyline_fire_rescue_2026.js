...
var ASM_CONSTS = {
 ...
 263078: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263146: () => { document.exitFullscreen(); },  
 263173: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263246: () => { if (document.fullscreenElement) return 1; },  
 263292: () => { return document.getElementById('canvas').width; },  
 263344: () => { return screen.width; },  
 263369: () => { document.exitFullscreen(); },  
 263396: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263529: () => { return window.innerWidth; },  
 263555: () => { return window.innerHeight; },  
 263582: () => { if (document.fullscreenElement) return 1; },  
 263628: () => { return document.getElementById('canvas').width; },  
 263680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263871: () => { return window.innerWidth; },  
 263897: () => { return window.innerHeight; },  
 263924: () => { if (document.fullscreenElement) return 1; },  
 263970: () => { return document.getElementById('canvas').width; },  
 264022: () => { return screen.width; },  
 264047: () => { document.exitFullscreen(); },  
 ...
 264240: () => { document.exitFullscreen(); },  
 264267: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264325: () => { return screen.width; },  
 264350: () => { return screen.height; },  
 264376: () => { return window.screenX; },  
 264403: () => { return window.screenY; },  
 264430: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264483: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264554: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264611: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264867: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264938: () => { if (document.fullscreenElement) return 1; },  
 264984: () => { return window.innerWidth; },  
 265010: () => { return window.innerHeight; },  
 265037: () => { if (document.pointerLockElement) return 1; }
};
