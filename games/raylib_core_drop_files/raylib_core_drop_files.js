...
function findWasmBinary() {
  return locateFile('raylib_core_drop_files.wasm');
}
...
var ASM_CONSTS = {
  97072: () => { if (document.fullscreenElement) return 1; },  
 97118: () => { return document.getElementById('canvas').width; },  
 97170: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97238: () => { document.exitFullscreen(); },  
 97265: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97338: () => { if (document.fullscreenElement) return 1; },  
 97384: () => { return document.getElementById('canvas').width; },  
 97436: () => { return screen.width; },  
 97461: () => { document.exitFullscreen(); },  
 97488: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97621: () => { return window.innerWidth; },  
 97647: () => { return window.innerHeight; },  
 97674: () => { if (document.fullscreenElement) return 1; },  
 97720: () => { return document.getElementById('canvas').width; },  
 97772: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97840: () => { if (document.fullscreenElement) return 1; },  
 97886: () => { return document.getElementById('canvas').width; },  
 97938: () => { return screen.width; },  
 97963: () => { return window.innerWidth; },  
 97989: () => { return window.innerHeight; },  
 98016: () => { if (document.fullscreenElement) return 1; },  
 98062: () => { return document.getElementById('canvas').width; },  
 98114: () => { return screen.width; },  
 98139: () => { document.exitFullscreen(); },  
 98166: () => { if (document.fullscreenElement) return 1; },  
 98212: () => { return document.getElementById('canvas').width; },  
 98264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98332: () => { document.exitFullscreen(); },  
 98359: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98417: () => { return screen.width; },  
 98442: () => { return screen.height; },  
 98468: () => { return window.screenX; },  
 98495: () => { return window.screenY; },  
 98522: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98575: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98646: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98703: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98959: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99030: () => { if (document.fullscreenElement) return 1; },  
 99076: () => { return window.innerWidth; },  
 99102: () => { return window.innerHeight; },  
 99129: () => { if (document.pointerLockElement) return 1; }
};
