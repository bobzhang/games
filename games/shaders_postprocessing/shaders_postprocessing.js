...
var ASM_CONSTS = {
 ...
 264598: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264666: () => { document.exitFullscreen(); },  
 264693: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264766: () => { if (document.fullscreenElement) return 1; },  
 264812: () => { return document.getElementById('canvas').width; },  
 264864: () => { return screen.width; },  
 264889: () => { document.exitFullscreen(); },  
 264916: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265049: () => { return window.innerWidth; },  
 265075: () => { return window.innerHeight; },  
 265102: () => { if (document.fullscreenElement) return 1; },  
 265148: () => { return document.getElementById('canvas').width; },  
 265200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 265391: () => { return window.innerWidth; },  
 265417: () => { return window.innerHeight; },  
 ...
 265567: () => { document.exitFullscreen(); },  
 265594: () => { if (document.fullscreenElement) return 1; },  
 265640: () => { return document.getElementById('canvas').width; },  
 265692: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265760: () => { document.exitFullscreen(); },  
 265787: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265845: () => { return screen.width; },  
 265870: () => { return screen.height; },  
 265896: () => { return window.screenX; },  
 265923: () => { return window.screenY; },  
 265950: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266003: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266074: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266387: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266458: () => { if (document.fullscreenElement) return 1; },  
 266504: () => { return window.innerWidth; },  
 266530: () => { return window.innerHeight; },  
 266557: () => { if (document.pointerLockElement) return 1; }
};
