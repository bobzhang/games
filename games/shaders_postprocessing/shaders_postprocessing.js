...
var ASM_CONSTS = {
 ...
 264790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264858: () => { document.exitFullscreen(); },  
 264885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264958: () => { if (document.fullscreenElement) return 1; },  
 265004: () => { return document.getElementById('canvas').width; },  
 265056: () => { return screen.width; },  
 265081: () => { document.exitFullscreen(); },  
 265108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265241: () => { return window.innerWidth; },  
 265267: () => { return window.innerHeight; },  
 265294: () => { if (document.fullscreenElement) return 1; },  
 265340: () => { return document.getElementById('canvas').width; },  
 265392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265460: () => { if (document.fullscreenElement) return 1; },  
 265506: () => { return document.getElementById('canvas').width; },  
 265558: () => { return screen.width; },  
 265583: () => { return window.innerWidth; },  
 265609: () => { return window.innerHeight; },  
 265636: () => { if (document.fullscreenElement) return 1; },  
 265682: () => { return document.getElementById('canvas').width; },  
 265734: () => { return screen.width; },  
 265759: () => { document.exitFullscreen(); },  
 265786: () => { if (document.fullscreenElement) return 1; },  
 265832: () => { return document.getElementById('canvas').width; },  
 265884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265952: () => { document.exitFullscreen(); },  
 265979: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266037: () => { return screen.width; },  
 266062: () => { return screen.height; },  
 266088: () => { return window.screenX; },  
 266115: () => { return window.screenY; },  
 266142: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266195: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266266: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266579: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266650: () => { if (document.fullscreenElement) return 1; },  
 266696: () => { return window.innerWidth; },  
 266722: () => { return window.innerHeight; },  
 266749: () => { if (document.pointerLockElement) return 1; }
};
