...
var ASM_CONSTS = {
  268984: () => { if (document.fullscreenElement) return 1; },  
 269030: () => { return document.getElementById('canvas').width; },  
 269082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269150: () => { document.exitFullscreen(); },  
 269177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269250: () => { if (document.fullscreenElement) return 1; },  
 269296: () => { return document.getElementById('canvas').width; },  
 269348: () => { return screen.width; },  
 269373: () => { document.exitFullscreen(); },  
 269400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269533: () => { return window.innerWidth; },  
 269559: () => { return window.innerHeight; },  
 ...
 269875: () => { return window.innerWidth; },  
 269901: () => { return window.innerHeight; },  
