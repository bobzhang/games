...
var ASM_CONSTS = {
  269196: () => { if (document.fullscreenElement) return 1; },  
 269242: () => { return document.getElementById('canvas').width; },  
 269294: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269362: () => { document.exitFullscreen(); },  
 269389: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269462: () => { if (document.fullscreenElement) return 1; },  
 269508: () => { return document.getElementById('canvas').width; },  
 269560: () => { return screen.width; },  
 269585: () => { document.exitFullscreen(); },  
 269612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269745: () => { return window.innerWidth; },  
 269771: () => { return window.innerHeight; },  
 269798: () => { if (document.fullscreenElement) return 1; },  
 269844: () => { return document.getElementById('canvas').width; },  
 269896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269964: () => { if (document.fullscreenElement) return 1; },  
 270010: () => { return document.getElementById('canvas').width; },  
 270062: () => { return screen.width; },  
 270087: () => { return window.innerWidth; },  
 270113: () => { return window.innerHeight; },  
 ...
 270263: () => { document.exitFullscreen(); },  
 270290: () => { if (document.fullscreenElement) return 1; },  
 270336: () => { return document.getElementById('canvas').width; },  
 270388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270456: () => { document.exitFullscreen(); },  
 270483: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270541: () => { return screen.width; },  
 270566: () => { return screen.height; },  
 270592: () => { return window.screenX; },  
 270619: () => { return window.screenY; },  
 270646: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270699: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270770: () => { document.getElementById('canvas').style.cursor = 'none'; },  
