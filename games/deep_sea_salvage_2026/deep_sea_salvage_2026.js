...
var ASM_CONSTS = {
  261588: () => { if (document.fullscreenElement) return 1; },  
 261634: () => { return document.getElementById('canvas').width; },  
 261686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261754: () => { document.exitFullscreen(); },  
 261781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261854: () => { if (document.fullscreenElement) return 1; },  
 261900: () => { return document.getElementById('canvas').width; },  
 261952: () => { return screen.width; },  
 261977: () => { document.exitFullscreen(); },  
 262004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262137: () => { return window.innerWidth; },  
 262163: () => { return window.innerHeight; },  
 262190: () => { if (document.fullscreenElement) return 1; },  
 262236: () => { return document.getElementById('canvas').width; },  
 262288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262479: () => { return window.innerWidth; },  
 262505: () => { return window.innerHeight; },  
 ...
 262655: () => { document.exitFullscreen(); },  
 ...
 262848: () => { document.exitFullscreen(); },  
 262875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262933: () => { return screen.width; },  
 262958: () => { return screen.height; },  
 262984: () => { return window.screenX; },  
 263011: () => { return window.screenY; },  
 263038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263546: () => { if (document.fullscreenElement) return 1; },  
 263592: () => { return window.innerWidth; },  
 263618: () => { return window.innerHeight; },  
 263645: () => { if (document.pointerLockElement) return 1; }
};
