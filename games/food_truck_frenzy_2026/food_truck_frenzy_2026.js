...
var ASM_CONSTS = {
 ...
 263094: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263162: () => { document.exitFullscreen(); },  
 263189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263262: () => { if (document.fullscreenElement) return 1; },  
 263308: () => { return document.getElementById('canvas').width; },  
 263360: () => { return screen.width; },  
 263385: () => { document.exitFullscreen(); },  
 263412: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263545: () => { return window.innerWidth; },  
 263571: () => { return window.innerHeight; },  
 263598: () => { if (document.fullscreenElement) return 1; },  
 263644: () => { return document.getElementById('canvas').width; },  
 263696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263887: () => { return window.innerWidth; },  
 263913: () => { return window.innerHeight; },  
 ...
 264063: () => { document.exitFullscreen(); },  
 ...
 264256: () => { document.exitFullscreen(); },  
 264283: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264341: () => { return screen.width; },  
 264366: () => { return screen.height; },  
 264392: () => { return window.screenX; },  
 264419: () => { return window.screenY; },  
 264446: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264499: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264570: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264883: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264954: () => { if (document.fullscreenElement) return 1; },  
 265000: () => { return window.innerWidth; },  
 265026: () => { return window.innerHeight; },  
 265053: () => { if (document.pointerLockElement) return 1; }
};
