...
var ASM_CONSTS = {
 ...
 107962: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108030: () => { document.exitFullscreen(); },  
 108057: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108130: () => { if (document.fullscreenElement) return 1; },  
 108176: () => { return document.getElementById('canvas').width; },  
 108228: () => { return screen.width; },  
 108253: () => { document.exitFullscreen(); },  
 108280: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108413: () => { return window.innerWidth; },  
 108439: () => { return window.innerHeight; },  
 108466: () => { if (document.fullscreenElement) return 1; },  
 108512: () => { return document.getElementById('canvas').width; },  
 108564: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108632: () => { if (document.fullscreenElement) return 1; },  
 108678: () => { return document.getElementById('canvas').width; },  
 108730: () => { return screen.width; },  
 108755: () => { return window.innerWidth; },  
 108781: () => { return window.innerHeight; },  
 108808: () => { if (document.fullscreenElement) return 1; },  
 108854: () => { return document.getElementById('canvas').width; },  
 108906: () => { return screen.width; },  
 108931: () => { document.exitFullscreen(); },  
 108958: () => { if (document.fullscreenElement) return 1; },  
 109004: () => { return document.getElementById('canvas').width; },  
 109056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109124: () => { document.exitFullscreen(); },  
 109151: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 109209: () => { return screen.width; },  
 109234: () => { return screen.height; },  
 109260: () => { return window.screenX; },  
 109287: () => { return window.screenY; },  
 109314: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109367: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 109438: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 109495: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109751: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 109822: () => { if (document.fullscreenElement) return 1; },  
 109868: () => { return window.innerWidth; },  
 109894: () => { return window.innerHeight; },  
 109921: () => { if (document.pointerLockElement) return 1; },  
