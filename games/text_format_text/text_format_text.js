...
var ASM_CONSTS = {
  260676: () => { if (document.fullscreenElement) return 1; },  
 260722: () => { return document.getElementById('canvas').width; },  
 260774: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260842: () => { document.exitFullscreen(); },  
 260869: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260942: () => { if (document.fullscreenElement) return 1; },  
 260988: () => { return document.getElementById('canvas').width; },  
 261040: () => { return screen.width; },  
 261065: () => { document.exitFullscreen(); },  
 261092: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261225: () => { return window.innerWidth; },  
 261251: () => { return window.innerHeight; },  
 261278: () => { if (document.fullscreenElement) return 1; },  
 261324: () => { return document.getElementById('canvas').width; },  
 261376: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261444: () => { if (document.fullscreenElement) return 1; },  
 261490: () => { return document.getElementById('canvas').width; },  
 261542: () => { return screen.width; },  
 261567: () => { return window.innerWidth; },  
 261593: () => { return window.innerHeight; },  
 ...
 261743: () => { document.exitFullscreen(); },  
 ...
 261936: () => { document.exitFullscreen(); },  
 261963: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262021: () => { return screen.width; },  
 262046: () => { return screen.height; },  
 262072: () => { return window.screenX; },  
 262099: () => { return window.screenY; },  
 262126: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262179: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262250: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262307: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262563: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262634: () => { if (document.fullscreenElement) return 1; },  
 262680: () => { return window.innerWidth; },  
 262706: () => { return window.innerHeight; },  
 262733: () => { if (document.pointerLockElement) return 1; }
};
