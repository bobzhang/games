...
function findWasmBinary() {
  return locateFile('raylib_platformer_3d.wasm');
}
...
var ASM_CONSTS = {
 ...
 100706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100774: () => { document.exitFullscreen(); },  
 100801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100874: () => { if (document.fullscreenElement) return 1; },  
 100920: () => { return document.getElementById('canvas').width; },  
 100972: () => { return screen.width; },  
 100997: () => { document.exitFullscreen(); },  
 101024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101157: () => { return window.innerWidth; },  
 101183: () => { return window.innerHeight; },  
 101210: () => { if (document.fullscreenElement) return 1; },  
 101256: () => { return document.getElementById('canvas').width; },  
 101308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101499: () => { return window.innerWidth; },  
 101525: () => { return window.innerHeight; },  
 101552: () => { if (document.fullscreenElement) return 1; },  
 101598: () => { return document.getElementById('canvas').width; },  
 101650: () => { return screen.width; },  
 101675: () => { document.exitFullscreen(); },  
 101702: () => { if (document.fullscreenElement) return 1; },  
 101748: () => { return document.getElementById('canvas').width; },  
 101800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101868: () => { document.exitFullscreen(); },  
 101895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101953: () => { return screen.width; },  
 101978: () => { return screen.height; },  
 102004: () => { return window.screenX; },  
 102031: () => { return window.screenY; },  
 102058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102495: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102566: () => { if (document.fullscreenElement) return 1; },  
 102612: () => { return window.innerWidth; },  
 102638: () => { return window.innerHeight; },  
 102665: () => { if (document.pointerLockElement) return 1; }
};
