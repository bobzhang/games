...
var ASM_CONSTS = {
  268444: () => { if (document.fullscreenElement) return 1; },  
 268490: () => { return document.getElementById('canvas').width; },  
 268542: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268610: () => { document.exitFullscreen(); },  
 268637: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268710: () => { if (document.fullscreenElement) return 1; },  
 268756: () => { return document.getElementById('canvas').width; },  
 268808: () => { return screen.width; },  
 268833: () => { document.exitFullscreen(); },  
 268860: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268993: () => { return window.innerWidth; },  
 269019: () => { return window.innerHeight; },  
 269046: () => { if (document.fullscreenElement) return 1; },  
 269092: () => { return document.getElementById('canvas').width; },  
 269144: () => { return parseInt(document.getElementById('canvas').style.width); },  
