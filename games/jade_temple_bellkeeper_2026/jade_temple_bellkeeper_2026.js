...
var ASM_CONSTS = {
  268424: () => { if (document.fullscreenElement) return 1; },  
 268470: () => { return document.getElementById('canvas').width; },  
 268522: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268590: () => { document.exitFullscreen(); },  
 268617: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268690: () => { if (document.fullscreenElement) return 1; },  
 268736: () => { return document.getElementById('canvas').width; },  
 268788: () => { return screen.width; },  
 268813: () => { document.exitFullscreen(); },  
 268840: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268973: () => { return window.innerWidth; },  
 268999: () => { return window.innerHeight; },  
 269026: () => { if (document.fullscreenElement) return 1; },  
 269072: () => { return document.getElementById('canvas').width; },  
 269124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269192: () => { if (document.fullscreenElement) return 1; },  
 269238: () => { return document.getElementById('canvas').width; },  
 269290: () => { return screen.width; },  
 269315: () => { return window.innerWidth; },  
 269341: () => { return window.innerHeight; },  
 269368: () => { if (document.fullscreenElement) return 1; },  
 269414: () => { return document.getElementById('canvas').width; },  
 269466: () => { return screen.width; },  
 269491: () => { document.exitFullscreen(); },  
 269518: () => { if (document.fullscreenElement) return 1; },  
 269564: () => { return document.getElementById('canvas').width; },  
 269616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269684: () => { document.exitFullscreen(); },  
 269711: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269769: () => { return screen.width; },  
 269794: () => { return screen.height; },  
 269820: () => { return window.screenX; },  
 269847: () => { return window.screenY; },  
 269874: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269927: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269998: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270055: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270311: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270382: () => { if (document.fullscreenElement) return 1; },  
 270428: () => { return window.innerWidth; },  
 270454: () => { return window.innerHeight; },  
 270481: () => { if (document.pointerLockElement) return 1; },  
