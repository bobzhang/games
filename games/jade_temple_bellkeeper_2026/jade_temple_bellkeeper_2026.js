...
function findWasmBinary() {
  return locateFile('jade_temple_bellkeeper_2026.wasm');
}
...
var ASM_CONSTS = {
  268648: () => { if (document.fullscreenElement) return 1; },  
 268694: () => { return document.getElementById('canvas').width; },  
 268746: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268814: () => { document.exitFullscreen(); },  
 268841: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268914: () => { if (document.fullscreenElement) return 1; },  
 268960: () => { return document.getElementById('canvas').width; },  
 269012: () => { return screen.width; },  
 269037: () => { document.exitFullscreen(); },  
 269064: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269197: () => { return window.innerWidth; },  
 269223: () => { return window.innerHeight; },  
 269250: () => { if (document.fullscreenElement) return 1; },  
 269296: () => { return document.getElementById('canvas').width; },  
 269348: () => { return parseInt(document.getElementById('canvas').style.width); },  
