...
var ASM_CONSTS = {
  268668: () => { if (document.fullscreenElement) return 1; },  
 268714: () => { return document.getElementById('canvas').width; },  
 268766: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268834: () => { document.exitFullscreen(); },  
 268861: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268934: () => { if (document.fullscreenElement) return 1; },  
 268980: () => { return document.getElementById('canvas').width; },  
 269032: () => { return screen.width; },  
 269057: () => { document.exitFullscreen(); },  
 269084: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269217: () => { return window.innerWidth; },  
 269243: () => { return window.innerHeight; },  
 269270: () => { if (document.fullscreenElement) return 1; },  
 269316: () => { return document.getElementById('canvas').width; },  
 269368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269559: () => { return window.innerWidth; },  
 269585: () => { return window.innerHeight; },  
 269612: () => { if (document.fullscreenElement) return 1; },  
 269658: () => { return document.getElementById('canvas').width; },  
 269710: () => { return screen.width; },  
 269735: () => { document.exitFullscreen(); },  
