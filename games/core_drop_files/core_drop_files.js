...
var ASM_CONSTS = {
  260660: () => { if (document.fullscreenElement) return 1; },  
 260706: () => { return document.getElementById('canvas').width; },  
 260758: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260826: () => { document.exitFullscreen(); },  
 260853: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260926: () => { if (document.fullscreenElement) return 1; },  
 260972: () => { return document.getElementById('canvas').width; },  
 261024: () => { return screen.width; },  
 261049: () => { document.exitFullscreen(); },  
 261076: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261209: () => { return window.innerWidth; },  
 261235: () => { return window.innerHeight; },  
 261262: () => { if (document.fullscreenElement) return 1; },  
 261308: () => { return document.getElementById('canvas').width; },  
 261360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261551: () => { return window.innerWidth; },  
 261577: () => { return window.innerHeight; },  
 ...
 261727: () => { document.exitFullscreen(); },  
 ...
 261920: () => { document.exitFullscreen(); },  
 261947: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262005: () => { return screen.width; },  
 262030: () => { return screen.height; },  
 262056: () => { return window.screenX; },  
 262083: () => { return window.screenY; },  
 262110: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262163: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262234: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262291: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262547: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262618: () => { if (document.fullscreenElement) return 1; },  
 262664: () => { return window.innerWidth; },  
 262690: () => { return window.innerHeight; },  
 262717: () => { if (document.pointerLockElement) return 1; }
};
