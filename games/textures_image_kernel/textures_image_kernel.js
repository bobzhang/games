...
var ASM_CONSTS = {
  650244: () => { if (document.fullscreenElement) return 1; },  
 650290: () => { return document.getElementById('canvas').width; },  
 650342: () => { return parseInt(document.getElementById('canvas').style.width); },  
 650410: () => { document.exitFullscreen(); },  
 650437: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 650510: () => { if (document.fullscreenElement) return 1; },  
 650556: () => { return document.getElementById('canvas').width; },  
 650608: () => { return screen.width; },  
 650633: () => { document.exitFullscreen(); },  
 650660: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 650793: () => { return window.innerWidth; },  
 650819: () => { return window.innerHeight; },  
 650846: () => { if (document.fullscreenElement) return 1; },  
 650892: () => { return document.getElementById('canvas').width; },  
 650944: () => { return parseInt(document.getElementById('canvas').style.width); },  
 651012: () => { if (document.fullscreenElement) return 1; },  
 651058: () => { return document.getElementById('canvas').width; },  
 651110: () => { return screen.width; },  
 651135: () => { return window.innerWidth; },  
 651161: () => { return window.innerHeight; },  
 651188: () => { if (document.fullscreenElement) return 1; },  
 651234: () => { return document.getElementById('canvas').width; },  
 651286: () => { return screen.width; },  
 651311: () => { document.exitFullscreen(); },  
 651338: () => { if (document.fullscreenElement) return 1; },  
 651384: () => { return document.getElementById('canvas').width; },  
 651436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 651504: () => { document.exitFullscreen(); },  
 651531: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 651589: () => { return screen.width; },  
 651614: () => { return screen.height; },  
 651640: () => { return window.screenX; },  
 651667: () => { return window.screenY; },  
 651694: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 651747: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 651818: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 651875: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 652131: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 652202: () => { if (document.fullscreenElement) return 1; },  
 652248: () => { return window.innerWidth; },  
 652274: () => { return window.innerHeight; },  
 652301: () => { if (document.pointerLockElement) return 1; }
};
