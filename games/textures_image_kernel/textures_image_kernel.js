...
var ASM_CONSTS = {
  650240: () => { if (document.fullscreenElement) return 1; },  
 650286: () => { return document.getElementById('canvas').width; },  
 650338: () => { return parseInt(document.getElementById('canvas').style.width); },  
 650406: () => { document.exitFullscreen(); },  
 650433: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 650506: () => { if (document.fullscreenElement) return 1; },  
 650552: () => { return document.getElementById('canvas').width; },  
 650604: () => { return screen.width; },  
 650629: () => { document.exitFullscreen(); },  
 650656: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 650789: () => { return window.innerWidth; },  
 650815: () => { return window.innerHeight; },  
 650842: () => { if (document.fullscreenElement) return 1; },  
 650888: () => { return document.getElementById('canvas').width; },  
 650940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 651008: () => { if (document.fullscreenElement) return 1; },  
 651054: () => { return document.getElementById('canvas').width; },  
 651106: () => { return screen.width; },  
 651131: () => { return window.innerWidth; },  
 651157: () => { return window.innerHeight; },  
 651184: () => { if (document.fullscreenElement) return 1; },  
 651230: () => { return document.getElementById('canvas').width; },  
 651282: () => { return screen.width; },  
 651307: () => { document.exitFullscreen(); },  
 651334: () => { if (document.fullscreenElement) return 1; },  
 651380: () => { return document.getElementById('canvas').width; },  
 651432: () => { return parseInt(document.getElementById('canvas').style.width); },  
 651500: () => { document.exitFullscreen(); },  
 651527: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 651585: () => { return screen.width; },  
 651610: () => { return screen.height; },  
 651636: () => { return window.screenX; },  
 651663: () => { return window.screenY; },  
 651690: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 651743: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 651814: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 651871: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 652127: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 652198: () => { if (document.fullscreenElement) return 1; },  
 652244: () => { return window.innerWidth; },  
 652270: () => { return window.innerHeight; },  
 652297: () => { if (document.pointerLockElement) return 1; }
};
