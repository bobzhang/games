...
var ASM_CONSTS = {
  650020: () => { if (document.fullscreenElement) return 1; },  
 650066: () => { return document.getElementById('canvas').width; },  
 650118: () => { return parseInt(document.getElementById('canvas').style.width); },  
 650186: () => { document.exitFullscreen(); },  
 650213: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 650286: () => { if (document.fullscreenElement) return 1; },  
 650332: () => { return document.getElementById('canvas').width; },  
 650384: () => { return screen.width; },  
 650409: () => { document.exitFullscreen(); },  
 650436: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 650569: () => { return window.innerWidth; },  
 650595: () => { return window.innerHeight; },  
 650622: () => { if (document.fullscreenElement) return 1; },  
 650668: () => { return document.getElementById('canvas').width; },  
 650720: () => { return parseInt(document.getElementById('canvas').style.width); },  
 650788: () => { if (document.fullscreenElement) return 1; },  
 650834: () => { return document.getElementById('canvas').width; },  
 650886: () => { return screen.width; },  
 650911: () => { return window.innerWidth; },  
 650937: () => { return window.innerHeight; },  
 650964: () => { if (document.fullscreenElement) return 1; },  
 651010: () => { return document.getElementById('canvas').width; },  
 651062: () => { return screen.width; },  
 651087: () => { document.exitFullscreen(); },  
 651114: () => { if (document.fullscreenElement) return 1; },  
 651160: () => { return document.getElementById('canvas').width; },  
 651212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 651280: () => { document.exitFullscreen(); },  
 651307: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 651365: () => { return screen.width; },  
 651390: () => { return screen.height; },  
 651416: () => { return window.screenX; },  
 651443: () => { return window.screenY; },  
 651470: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 651523: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 651594: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 651651: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 651907: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 651978: () => { if (document.fullscreenElement) return 1; },  
 652024: () => { return window.innerWidth; },  
 652050: () => { return window.innerHeight; },  
 652077: () => { if (document.pointerLockElement) return 1; }
};
