...
var ASM_CONSTS = {
 ...
 100594: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100662: () => { document.exitFullscreen(); },  
 100689: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100762: () => { if (document.fullscreenElement) return 1; },  
 100808: () => { return document.getElementById('canvas').width; },  
 100860: () => { return screen.width; },  
 100885: () => { document.exitFullscreen(); },  
 100912: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101045: () => { return window.innerWidth; },  
 101071: () => { return window.innerHeight; },  
 101098: () => { if (document.fullscreenElement) return 1; },  
 101144: () => { return document.getElementById('canvas').width; },  
 101196: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101387: () => { return window.innerWidth; },  
 101413: () => { return window.innerHeight; },  
 101440: () => { if (document.fullscreenElement) return 1; },  
 101486: () => { return document.getElementById('canvas').width; },  
 101538: () => { return screen.width; },  
 101563: () => { document.exitFullscreen(); },  
 101590: () => { if (document.fullscreenElement) return 1; },  
 101636: () => { return document.getElementById('canvas').width; },  
 101688: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101756: () => { document.exitFullscreen(); },  
 101783: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101841: () => { return screen.width; },  
 101866: () => { return screen.height; },  
 101892: () => { return window.screenX; },  
 101919: () => { return window.screenY; },  
 101946: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101999: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102070: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102127: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102383: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102454: () => { if (document.fullscreenElement) return 1; },  
 102500: () => { return window.innerWidth; },  
 102526: () => { return window.innerHeight; },  
 102553: () => { if (document.pointerLockElement) return 1; }
};
