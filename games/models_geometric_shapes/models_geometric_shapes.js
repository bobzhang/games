...
var ASM_CONSTS = {
  251972: () => { if (document.fullscreenElement) return 1; },  
 252018: () => { return document.getElementById('canvas').width; },  
 252070: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252138: () => { document.exitFullscreen(); },  
 252165: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252238: () => { if (document.fullscreenElement) return 1; },  
 252284: () => { return document.getElementById('canvas').width; },  
 252336: () => { return screen.width; },  
 252361: () => { document.exitFullscreen(); },  
 252388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252521: () => { return window.innerWidth; },  
 252547: () => { return window.innerHeight; },  
 252574: () => { if (document.fullscreenElement) return 1; },  
 252620: () => { return document.getElementById('canvas').width; },  
 252672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252740: () => { if (document.fullscreenElement) return 1; },  
 252786: () => { return document.getElementById('canvas').width; },  
 252838: () => { return screen.width; },  
 252863: () => { return window.innerWidth; },  
 252889: () => { return window.innerHeight; },  
 252916: () => { if (document.fullscreenElement) return 1; },  
 252962: () => { return document.getElementById('canvas').width; },  
 253014: () => { return screen.width; },  
 253039: () => { document.exitFullscreen(); },  
 253066: () => { if (document.fullscreenElement) return 1; },  
 253112: () => { return document.getElementById('canvas').width; },  
 253164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253232: () => { document.exitFullscreen(); },  
 253259: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253317: () => { return screen.width; },  
 253342: () => { return screen.height; },  
 253368: () => { return window.screenX; },  
 253395: () => { return window.screenY; },  
 253422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253475: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253546: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253859: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253930: () => { if (document.fullscreenElement) return 1; },  
 253976: () => { return window.innerWidth; },  
 254002: () => { return window.innerHeight; },  
 254029: () => { if (document.pointerLockElement) return 1; }
};
