...
var ASM_CONSTS = {
  252196: () => { if (document.fullscreenElement) return 1; },  
 252242: () => { return document.getElementById('canvas').width; },  
 252294: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252362: () => { document.exitFullscreen(); },  
 252389: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252462: () => { if (document.fullscreenElement) return 1; },  
 252508: () => { return document.getElementById('canvas').width; },  
 252560: () => { return screen.width; },  
 252585: () => { document.exitFullscreen(); },  
 252612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252745: () => { return window.innerWidth; },  
 252771: () => { return window.innerHeight; },  
 252798: () => { if (document.fullscreenElement) return 1; },  
 252844: () => { return document.getElementById('canvas').width; },  
 252896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 253087: () => { return window.innerWidth; },  
 253113: () => { return window.innerHeight; },  
 253140: () => { if (document.fullscreenElement) return 1; },  
 253186: () => { return document.getElementById('canvas').width; },  
 253238: () => { return screen.width; },  
 253263: () => { document.exitFullscreen(); },  
 253290: () => { if (document.fullscreenElement) return 1; },  
 253336: () => { return document.getElementById('canvas').width; },  
 253388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253456: () => { document.exitFullscreen(); },  
 253483: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253541: () => { return screen.width; },  
 253566: () => { return screen.height; },  
 253592: () => { return window.screenX; },  
 253619: () => { return window.screenY; },  
 253646: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253699: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253770: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253827: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 254083: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254154: () => { if (document.fullscreenElement) return 1; },  
 254200: () => { return window.innerWidth; },  
 254226: () => { return window.innerHeight; },  
 254253: () => { if (document.pointerLockElement) return 1; }
};
