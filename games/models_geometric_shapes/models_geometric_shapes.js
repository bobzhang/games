...
var ASM_CONSTS = {
  252192: () => { if (document.fullscreenElement) return 1; },  
 252238: () => { return document.getElementById('canvas').width; },  
 252290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252358: () => { document.exitFullscreen(); },  
 252385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252458: () => { if (document.fullscreenElement) return 1; },  
 252504: () => { return document.getElementById('canvas').width; },  
 252556: () => { return screen.width; },  
 252581: () => { document.exitFullscreen(); },  
 252608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252741: () => { return window.innerWidth; },  
 252767: () => { return window.innerHeight; },  
 ...
 253083: () => { return window.innerWidth; },  
 253109: () => { return window.innerHeight; },  
 253136: () => { if (document.fullscreenElement) return 1; },  
 253182: () => { return document.getElementById('canvas').width; },  
 253234: () => { return screen.width; },  
 253259: () => { document.exitFullscreen(); },  
 253286: () => { if (document.fullscreenElement) return 1; },  
 253332: () => { return document.getElementById('canvas').width; },  
 253384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253452: () => { document.exitFullscreen(); },  
 253479: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253537: () => { return screen.width; },  
 253562: () => { return screen.height; },  
 253588: () => { return window.screenX; },  
 253615: () => { return window.screenY; },  
 253642: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253695: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253766: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253823: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 254079: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
