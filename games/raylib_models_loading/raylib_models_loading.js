...
function findWasmBinary() {
  return locateFile('raylib_models_loading.wasm');
}
...
var ASM_CONSTS = {
 ...
 109038: () => { return document.getElementById('canvas').width; },  
 109090: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109158: () => { document.exitFullscreen(); },  
 109185: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109258: () => { if (document.fullscreenElement) return 1; },  
 109304: () => { return document.getElementById('canvas').width; },  
 109356: () => { return screen.width; },  
 109381: () => { document.exitFullscreen(); },  
 109408: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 109541: () => { return window.innerWidth; },  
 109567: () => { return window.innerHeight; },  
 109594: () => { if (document.fullscreenElement) return 1; },  
 109640: () => { return document.getElementById('canvas').width; },  
 109692: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109760: () => { if (document.fullscreenElement) return 1; },  
 109806: () => { return document.getElementById('canvas').width; },  
 109858: () => { return screen.width; },  
 109883: () => { return window.innerWidth; },  
 109909: () => { return window.innerHeight; },  
 109936: () => { if (document.fullscreenElement) return 1; },  
 109982: () => { return document.getElementById('canvas').width; },  
 110034: () => { return screen.width; },  
 110059: () => { document.exitFullscreen(); },  
 110086: () => { if (document.fullscreenElement) return 1; },  
 110132: () => { return document.getElementById('canvas').width; },  
 110184: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110252: () => { document.exitFullscreen(); },  
 110279: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 110337: () => { return screen.width; },  
 110362: () => { return screen.height; },  
 110388: () => { return window.screenX; },  
 110415: () => { return window.screenY; },  
 110442: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110495: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 110566: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 110623: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110879: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 110950: () => { if (document.fullscreenElement) return 1; },  
 110996: () => { return window.innerWidth; },  
 111022: () => { return window.innerHeight; },  
 111049: () => { if (document.pointerLockElement) return 1; }
};
