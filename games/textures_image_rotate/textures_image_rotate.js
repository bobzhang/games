...
var ASM_CONSTS = {
 ...
 268326: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268394: () => { document.exitFullscreen(); },  
 268421: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268494: () => { if (document.fullscreenElement) return 1; },  
 268540: () => { return document.getElementById('canvas').width; },  
 268592: () => { return screen.width; },  
 268617: () => { document.exitFullscreen(); },  
 268644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268777: () => { return window.innerWidth; },  
 268803: () => { return window.innerHeight; },  
 268830: () => { if (document.fullscreenElement) return 1; },  
 268876: () => { return document.getElementById('canvas').width; },  
 268928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268996: () => { if (document.fullscreenElement) return 1; },  
 269042: () => { return document.getElementById('canvas').width; },  
 269094: () => { return screen.width; },  
 269119: () => { return window.innerWidth; },  
 269145: () => { return window.innerHeight; },  
 269172: () => { if (document.fullscreenElement) return 1; },  
 269218: () => { return document.getElementById('canvas').width; },  
 269270: () => { return screen.width; },  
 269295: () => { document.exitFullscreen(); },  
 269322: () => { if (document.fullscreenElement) return 1; },  
 269368: () => { return document.getElementById('canvas').width; },  
 269420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269488: () => { document.exitFullscreen(); },  
 269515: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269573: () => { return screen.width; },  
 269598: () => { return screen.height; },  
 269624: () => { return window.screenX; },  
 269651: () => { return window.screenY; },  
 269678: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269731: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269802: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270115: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270186: () => { if (document.fullscreenElement) return 1; },  
 270232: () => { return window.innerWidth; },  
 270258: () => { return window.innerHeight; },  
 270285: () => { if (document.pointerLockElement) return 1; }
};
