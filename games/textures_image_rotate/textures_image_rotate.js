...
var ASM_CONSTS = {
  268260: () => { if (document.fullscreenElement) return 1; },  
 268306: () => { return document.getElementById('canvas').width; },  
 268358: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268426: () => { document.exitFullscreen(); },  
 268453: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268526: () => { if (document.fullscreenElement) return 1; },  
 268572: () => { return document.getElementById('canvas').width; },  
 268624: () => { return screen.width; },  
 268649: () => { document.exitFullscreen(); },  
 268676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268809: () => { return window.innerWidth; },  
 268835: () => { return window.innerHeight; },  
 268862: () => { if (document.fullscreenElement) return 1; },  
 268908: () => { return document.getElementById('canvas').width; },  
 268960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269151: () => { return window.innerWidth; },  
 269177: () => { return window.innerHeight; },  
 269204: () => { if (document.fullscreenElement) return 1; },  
 269250: () => { return document.getElementById('canvas').width; },  
 269302: () => { return screen.width; },  
 269327: () => { document.exitFullscreen(); },  
 269354: () => { if (document.fullscreenElement) return 1; },  
 269400: () => { return document.getElementById('canvas').width; },  
 269452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269520: () => { document.exitFullscreen(); },  
 269547: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269605: () => { return screen.width; },  
 269630: () => { return screen.height; },  
 269656: () => { return window.screenX; },  
 269683: () => { return window.screenY; },  
 269710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269763: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269834: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270147: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270218: () => { if (document.fullscreenElement) return 1; },  
 270264: () => { return window.innerWidth; },  
 270290: () => { return window.innerHeight; },  
 270317: () => { if (document.pointerLockElement) return 1; }
};
