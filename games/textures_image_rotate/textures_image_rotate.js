...
var ASM_CONSTS = {
  268036: () => { if (document.fullscreenElement) return 1; },  
 268082: () => { return document.getElementById('canvas').width; },  
 268134: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268202: () => { document.exitFullscreen(); },  
 268229: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268302: () => { if (document.fullscreenElement) return 1; },  
 268348: () => { return document.getElementById('canvas').width; },  
 268400: () => { return screen.width; },  
 268425: () => { document.exitFullscreen(); },  
 268452: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268585: () => { return window.innerWidth; },  
 268611: () => { return window.innerHeight; },  
 268638: () => { if (document.fullscreenElement) return 1; },  
 268684: () => { return document.getElementById('canvas').width; },  
 268736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 268927: () => { return window.innerWidth; },  
 268953: () => { return window.innerHeight; },  
 268980: () => { if (document.fullscreenElement) return 1; },  
 269026: () => { return document.getElementById('canvas').width; },  
 269078: () => { return screen.width; },  
 269103: () => { document.exitFullscreen(); },  
 269130: () => { if (document.fullscreenElement) return 1; },  
 269176: () => { return document.getElementById('canvas').width; },  
 269228: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269296: () => { document.exitFullscreen(); },  
 269323: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269381: () => { return screen.width; },  
 269406: () => { return screen.height; },  
 269432: () => { return window.screenX; },  
 269459: () => { return window.screenY; },  
 269486: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269539: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269610: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269667: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269923: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269994: () => { if (document.fullscreenElement) return 1; },  
 270040: () => { return window.innerWidth; },  
 270066: () => { return window.innerHeight; },  
 270093: () => { if (document.pointerLockElement) return 1; }
};
