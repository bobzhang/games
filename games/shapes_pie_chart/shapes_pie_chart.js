...
var ASM_CONSTS = {
  261012: () => { if (document.fullscreenElement) return 1; },  
 261058: () => { return document.getElementById('canvas').width; },  
 261110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261178: () => { document.exitFullscreen(); },  
 261205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261278: () => { if (document.fullscreenElement) return 1; },  
 261324: () => { return document.getElementById('canvas').width; },  
 261376: () => { return screen.width; },  
 261401: () => { document.exitFullscreen(); },  
 261428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261561: () => { return window.innerWidth; },  
 261587: () => { return window.innerHeight; },  
 261614: () => { if (document.fullscreenElement) return 1; },  
 261660: () => { return document.getElementById('canvas').width; },  
 261712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261780: () => { if (document.fullscreenElement) return 1; },  
 261826: () => { return document.getElementById('canvas').width; },  
 261878: () => { return screen.width; },  
 261903: () => { return window.innerWidth; },  
 261929: () => { return window.innerHeight; },  
 ...
 262079: () => { document.exitFullscreen(); },  
 ...
 262272: () => { document.exitFullscreen(); },  
 262299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262357: () => { return screen.width; },  
 262382: () => { return screen.height; },  
 262408: () => { return window.screenX; },  
 262435: () => { return window.screenY; },  
 262462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262970: () => { if (document.fullscreenElement) return 1; },  
 263016: () => { return window.innerWidth; },  
 263042: () => { return window.innerHeight; },  
 263069: () => { if (document.pointerLockElement) return 1; }
};
