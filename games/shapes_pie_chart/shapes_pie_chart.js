...
var ASM_CONSTS = {
  260820: () => { if (document.fullscreenElement) return 1; },  
 260866: () => { return document.getElementById('canvas').width; },  
 260918: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260986: () => { document.exitFullscreen(); },  
 261013: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261086: () => { if (document.fullscreenElement) return 1; },  
 261132: () => { return document.getElementById('canvas').width; },  
 261184: () => { return screen.width; },  
 261209: () => { document.exitFullscreen(); },  
 261236: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261369: () => { return window.innerWidth; },  
 261395: () => { return window.innerHeight; },  
 261422: () => { if (document.fullscreenElement) return 1; },  
 261468: () => { return document.getElementById('canvas').width; },  
 261520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261588: () => { if (document.fullscreenElement) return 1; },  
 261634: () => { return document.getElementById('canvas').width; },  
 261686: () => { return screen.width; },  
 261711: () => { return window.innerWidth; },  
 261737: () => { return window.innerHeight; },  
 ...
 261887: () => { document.exitFullscreen(); },  
 261914: () => { if (document.fullscreenElement) return 1; },  
 261960: () => { return document.getElementById('canvas').width; },  
 262012: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262080: () => { document.exitFullscreen(); },  
 262107: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262165: () => { return screen.width; },  
 262190: () => { return screen.height; },  
 262216: () => { return window.screenX; },  
 262243: () => { return window.screenY; },  
 262270: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262323: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262394: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262451: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262707: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262778: () => { if (document.fullscreenElement) return 1; },  
 262824: () => { return window.innerWidth; },  
 262850: () => { return window.innerHeight; },  
 262877: () => { if (document.pointerLockElement) return 1; }
};
