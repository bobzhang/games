...
function findWasmBinary() {
  return locateFile('radio_station_manager_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 262034: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262102: () => { document.exitFullscreen(); },  
 262129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262202: () => { if (document.fullscreenElement) return 1; },  
 262248: () => { return document.getElementById('canvas').width; },  
 262300: () => { return screen.width; },  
 262325: () => { document.exitFullscreen(); },  
 262352: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262485: () => { return window.innerWidth; },  
 262511: () => { return window.innerHeight; },  
 262538: () => { if (document.fullscreenElement) return 1; },  
 262584: () => { return document.getElementById('canvas').width; },  
 262636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262704: () => { if (document.fullscreenElement) return 1; },  
 262750: () => { return document.getElementById('canvas').width; },  
 262802: () => { return screen.width; },  
 262827: () => { return window.innerWidth; },  
 262853: () => { return window.innerHeight; },  
 262880: () => { if (document.fullscreenElement) return 1; },  
 262926: () => { return document.getElementById('canvas').width; },  
 262978: () => { return screen.width; },  
 263003: () => { document.exitFullscreen(); },  
 263030: () => { if (document.fullscreenElement) return 1; },  
 263076: () => { return document.getElementById('canvas').width; },  
 263128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263196: () => { document.exitFullscreen(); },  
 263223: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263281: () => { return screen.width; },  
 263306: () => { return screen.height; },  
 263332: () => { return window.screenX; },  
 263359: () => { return window.screenY; },  
 263386: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263439: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263510: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263567: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263823: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263894: () => { if (document.fullscreenElement) return 1; },  
 263940: () => { return window.innerWidth; },  
 263966: () => { return window.innerHeight; },  
 263993: () => { if (document.pointerLockElement) return 1; }
};
