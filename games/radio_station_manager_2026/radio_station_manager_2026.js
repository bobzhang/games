...
var ASM_CONSTS = {
 ...
 261814: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261882: () => { document.exitFullscreen(); },  
 261909: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261982: () => { if (document.fullscreenElement) return 1; },  
 262028: () => { return document.getElementById('canvas').width; },  
 262080: () => { return screen.width; },  
 262105: () => { document.exitFullscreen(); },  
 262132: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262265: () => { return window.innerWidth; },  
 262291: () => { return window.innerHeight; },  
 262318: () => { if (document.fullscreenElement) return 1; },  
 262364: () => { return document.getElementById('canvas').width; },  
 262416: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262484: () => { if (document.fullscreenElement) return 1; },  
 262530: () => { return document.getElementById('canvas').width; },  
 262582: () => { return screen.width; },  
 262607: () => { return window.innerWidth; },  
 262633: () => { return window.innerHeight; },  
 262660: () => { if (document.fullscreenElement) return 1; },  
 262706: () => { return document.getElementById('canvas').width; },  
 262758: () => { return screen.width; },  
 262783: () => { document.exitFullscreen(); },  
 262810: () => { if (document.fullscreenElement) return 1; },  
 262856: () => { return document.getElementById('canvas').width; },  
 262908: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262976: () => { document.exitFullscreen(); },  
 263003: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263061: () => { return screen.width; },  
 263086: () => { return screen.height; },  
 263112: () => { return window.screenX; },  
 263139: () => { return window.screenY; },  
 263166: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263219: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263290: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263347: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263603: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263674: () => { if (document.fullscreenElement) return 1; },  
 263720: () => { return window.innerWidth; },  
 263746: () => { return window.innerHeight; },  
 263773: () => { if (document.pointerLockElement) return 1; }
};
