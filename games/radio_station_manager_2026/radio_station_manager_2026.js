...
var ASM_CONSTS = {
  261924: () => { if (document.fullscreenElement) return 1; },  
 261970: () => { return document.getElementById('canvas').width; },  
 262022: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262090: () => { document.exitFullscreen(); },  
 262117: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262190: () => { if (document.fullscreenElement) return 1; },  
 262236: () => { return document.getElementById('canvas').width; },  
 262288: () => { return screen.width; },  
 262313: () => { document.exitFullscreen(); },  
 262340: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262473: () => { return window.innerWidth; },  
 262499: () => { return window.innerHeight; },  
 262526: () => { if (document.fullscreenElement) return 1; },  
 262572: () => { return document.getElementById('canvas').width; },  
 262624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262692: () => { if (document.fullscreenElement) return 1; },  
 262738: () => { return document.getElementById('canvas').width; },  
 262790: () => { return screen.width; },  
 262815: () => { return window.innerWidth; },  
 262841: () => { return window.innerHeight; },  
 262868: () => { if (document.fullscreenElement) return 1; },  
 262914: () => { return document.getElementById('canvas').width; },  
 262966: () => { return screen.width; },  
 262991: () => { document.exitFullscreen(); },  
 263018: () => { if (document.fullscreenElement) return 1; },  
 263064: () => { return document.getElementById('canvas').width; },  
 263116: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263184: () => { document.exitFullscreen(); },  
 263211: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263269: () => { return screen.width; },  
 263294: () => { return screen.height; },  
 263320: () => { return window.screenX; },  
 263347: () => { return window.screenY; },  
 263374: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263427: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263498: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263555: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263811: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263882: () => { if (document.fullscreenElement) return 1; },  
 263928: () => { return window.innerWidth; },  
 263954: () => { return window.innerHeight; },  
 263981: () => { if (document.pointerLockElement) return 1; }
};
