...
var ASM_CONSTS = {
 ...
 262038: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262106: () => { document.exitFullscreen(); },  
 262133: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262206: () => { if (document.fullscreenElement) return 1; },  
 262252: () => { return document.getElementById('canvas').width; },  
 262304: () => { return screen.width; },  
 262329: () => { document.exitFullscreen(); },  
 262356: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262489: () => { return window.innerWidth; },  
 262515: () => { return window.innerHeight; },  
 262542: () => { if (document.fullscreenElement) return 1; },  
 262588: () => { return document.getElementById('canvas').width; },  
 262640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262831: () => { return window.innerWidth; },  
 262857: () => { return window.innerHeight; },  
 262884: () => { if (document.fullscreenElement) return 1; },  
 262930: () => { return document.getElementById('canvas').width; },  
 262982: () => { return screen.width; },  
 263007: () => { document.exitFullscreen(); },  
 263034: () => { if (document.fullscreenElement) return 1; },  
 263080: () => { return document.getElementById('canvas').width; },  
 263132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263200: () => { document.exitFullscreen(); },  
 263227: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263285: () => { return screen.width; },  
 263310: () => { return screen.height; },  
 263336: () => { return window.screenX; },  
 263363: () => { return window.screenY; },  
 263390: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263443: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263514: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263571: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263827: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263898: () => { if (document.fullscreenElement) return 1; },  
 263944: () => { return window.innerWidth; },  
 263970: () => { return window.innerHeight; },  
 263997: () => { if (document.pointerLockElement) return 1; }
};
