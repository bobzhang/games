...
var ASM_CONSTS = {
  270260: () => { if (document.fullscreenElement) return 1; },  
 270306: () => { return document.getElementById('canvas').width; },  
 270358: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270426: () => { document.exitFullscreen(); },  
 270453: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 270526: () => { if (document.fullscreenElement) return 1; },  
 270572: () => { return document.getElementById('canvas').width; },  
 270624: () => { return screen.width; },  
 270649: () => { document.exitFullscreen(); },  
 270676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 270809: () => { return window.innerWidth; },  
 270835: () => { return window.innerHeight; },  
 270862: () => { if (document.fullscreenElement) return 1; },  
 270908: () => { return document.getElementById('canvas').width; },  
 270960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271028: () => { if (document.fullscreenElement) return 1; },  
 271074: () => { return document.getElementById('canvas').width; },  
 271126: () => { return screen.width; },  
 271151: () => { return window.innerWidth; },  
 271177: () => { return window.innerHeight; },  
 271204: () => { if (document.fullscreenElement) return 1; },  
 271250: () => { return document.getElementById('canvas').width; },  
 271302: () => { return screen.width; },  
 271327: () => { document.exitFullscreen(); },  
 271354: () => { if (document.fullscreenElement) return 1; },  
 271400: () => { return document.getElementById('canvas').width; },  
 271452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271520: () => { document.exitFullscreen(); },  
 271547: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 271605: () => { return screen.width; },  
 271630: () => { return screen.height; },  
 271656: () => { return window.screenX; },  
 271683: () => { return window.screenY; },  
 271710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 271763: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 271834: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 271891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 272147: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 272218: () => { if (document.fullscreenElement) return 1; },  
 272264: () => { return window.innerWidth; },  
 272290: () => { return window.innerHeight; },  
 272317: () => { if (document.pointerLockElement) return 1; }
};
