...
var ASM_CONSTS = {
  270484: () => { if (document.fullscreenElement) return 1; },  
 270530: () => { return document.getElementById('canvas').width; },  
 270582: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270650: () => { document.exitFullscreen(); },  
 270677: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 270750: () => { if (document.fullscreenElement) return 1; },  
 270796: () => { return document.getElementById('canvas').width; },  
 270848: () => { return screen.width; },  
 270873: () => { document.exitFullscreen(); },  
 270900: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 271033: () => { return window.innerWidth; },  
 271059: () => { return window.innerHeight; },  
 271086: () => { if (document.fullscreenElement) return 1; },  
 271132: () => { return document.getElementById('canvas').width; },  
 271184: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271252: () => { if (document.fullscreenElement) return 1; },  
 271298: () => { return document.getElementById('canvas').width; },  
 271350: () => { return screen.width; },  
 271375: () => { return window.innerWidth; },  
 271401: () => { return window.innerHeight; },  
 271428: () => { if (document.fullscreenElement) return 1; },  
 271474: () => { return document.getElementById('canvas').width; },  
 271526: () => { return screen.width; },  
 271551: () => { document.exitFullscreen(); },  
 271578: () => { if (document.fullscreenElement) return 1; },  
 271624: () => { return document.getElementById('canvas').width; },  
 271676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271744: () => { document.exitFullscreen(); },  
 271771: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 271829: () => { return screen.width; },  
 271854: () => { return screen.height; },  
 271880: () => { return window.screenX; },  
 271907: () => { return window.screenY; },  
 271934: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 271987: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 272058: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 272115: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 272371: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 272442: () => { if (document.fullscreenElement) return 1; },  
 272488: () => { return window.innerWidth; },  
 272514: () => { return window.innerHeight; },  
 272541: () => { if (document.pointerLockElement) return 1; }
};
