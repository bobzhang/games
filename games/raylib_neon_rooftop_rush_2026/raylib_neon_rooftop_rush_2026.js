...
var ASM_CONSTS = {
  106584: () => { if (document.fullscreenElement) return 1; },  
 106630: () => { return document.getElementById('canvas').width; },  
 106682: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106750: () => { document.exitFullscreen(); },  
 106777: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106850: () => { if (document.fullscreenElement) return 1; },  
 106896: () => { return document.getElementById('canvas').width; },  
 106948: () => { return screen.width; },  
 106973: () => { document.exitFullscreen(); },  
 107000: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107133: () => { return window.innerWidth; },  
 107159: () => { return window.innerHeight; },  
 107186: () => { if (document.fullscreenElement) return 1; },  
 107232: () => { return document.getElementById('canvas').width; },  
 107284: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107352: () => { if (document.fullscreenElement) return 1; },  
 107398: () => { return document.getElementById('canvas').width; },  
 107450: () => { return screen.width; },  
 107475: () => { return window.innerWidth; },  
 107501: () => { return window.innerHeight; },  
 ...
 114113: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 114179: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 114572: ($0) => { miniaudio.untrack_device_by_index($0); },  
 114615: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 114740: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
