...
var ASM_CONSTS = {
  251844: () => { if (document.fullscreenElement) return 1; },  
 251890: () => { return document.getElementById('canvas').width; },  
 251942: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252010: () => { document.exitFullscreen(); },  
 252037: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252110: () => { if (document.fullscreenElement) return 1; },  
 252156: () => { return document.getElementById('canvas').width; },  
 252208: () => { return screen.width; },  
 252233: () => { document.exitFullscreen(); },  
 252260: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252393: () => { return window.innerWidth; },  
 252419: () => { return window.innerHeight; },  
 252446: () => { if (document.fullscreenElement) return 1; },  
 252492: () => { return document.getElementById('canvas').width; },  
 252544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252612: () => { if (document.fullscreenElement) return 1; },  
 252658: () => { return document.getElementById('canvas').width; },  
 252710: () => { return screen.width; },  
 252735: () => { return window.innerWidth; },  
 252761: () => { return window.innerHeight; },  
 ...
 252911: () => { document.exitFullscreen(); },  
 252938: () => { if (document.fullscreenElement) return 1; },  
 252984: () => { return document.getElementById('canvas').width; },  
 253036: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253104: () => { document.exitFullscreen(); },  
 253131: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253189: () => { return screen.width; },  
 253214: () => { return screen.height; },  
 253240: () => { return window.screenX; },  
 253267: () => { return window.screenY; },  
 253294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253347: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253418: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253475: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253731: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253802: () => { if (document.fullscreenElement) return 1; },  
 253848: () => { return window.innerWidth; },  
 253874: () => { return window.innerHeight; },  
 253901: () => { if (document.pointerLockElement) return 1; }
};
