...
var ASM_CONSTS = {
  252068: () => { if (document.fullscreenElement) return 1; },  
 252114: () => { return document.getElementById('canvas').width; },  
 252166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252234: () => { document.exitFullscreen(); },  
 252261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252334: () => { if (document.fullscreenElement) return 1; },  
 252380: () => { return document.getElementById('canvas').width; },  
 252432: () => { return screen.width; },  
 252457: () => { document.exitFullscreen(); },  
 252484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252617: () => { return window.innerWidth; },  
 252643: () => { return window.innerHeight; },  
 252670: () => { if (document.fullscreenElement) return 1; },  
 252716: () => { return document.getElementById('canvas').width; },  
 252768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252836: () => { if (document.fullscreenElement) return 1; },  
 252882: () => { return document.getElementById('canvas').width; },  
 252934: () => { return screen.width; },  
 252959: () => { return window.innerWidth; },  
 252985: () => { return window.innerHeight; },  
 253012: () => { if (document.fullscreenElement) return 1; },  
 253058: () => { return document.getElementById('canvas').width; },  
 253110: () => { return screen.width; },  
 253135: () => { document.exitFullscreen(); },  
 253162: () => { if (document.fullscreenElement) return 1; },  
 253208: () => { return document.getElementById('canvas').width; },  
 253260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253328: () => { document.exitFullscreen(); },  
 253355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253413: () => { return screen.width; },  
 253438: () => { return screen.height; },  
 253464: () => { return window.screenX; },  
 253491: () => { return window.screenY; },  
 253518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254026: () => { if (document.fullscreenElement) return 1; },  
 254072: () => { return window.innerWidth; },  
 254098: () => { return window.innerHeight; },  
 254125: () => { if (document.pointerLockElement) return 1; }
};
