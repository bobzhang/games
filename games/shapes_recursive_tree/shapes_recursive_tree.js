...
function findWasmBinary() {
  return locateFile('shapes_recursive_tree.wasm');
}
...
var ASM_CONSTS = {
  252064: () => { if (document.fullscreenElement) return 1; },  
 252110: () => { return document.getElementById('canvas').width; },  
 252162: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252230: () => { document.exitFullscreen(); },  
 252257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252330: () => { if (document.fullscreenElement) return 1; },  
 252376: () => { return document.getElementById('canvas').width; },  
 252428: () => { return screen.width; },  
 252453: () => { document.exitFullscreen(); },  
 252480: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252613: () => { return window.innerWidth; },  
 252639: () => { return window.innerHeight; },  
 252666: () => { if (document.fullscreenElement) return 1; },  
 252712: () => { return document.getElementById('canvas').width; },  
 252764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252832: () => { if (document.fullscreenElement) return 1; },  
 252878: () => { return document.getElementById('canvas').width; },  
 252930: () => { return screen.width; },  
 252955: () => { return window.innerWidth; },  
 252981: () => { return window.innerHeight; },  
 253008: () => { if (document.fullscreenElement) return 1; },  
 253054: () => { return document.getElementById('canvas').width; },  
 253106: () => { return screen.width; },  
 253131: () => { document.exitFullscreen(); },  
 253158: () => { if (document.fullscreenElement) return 1; },  
 253204: () => { return document.getElementById('canvas').width; },  
 253256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253324: () => { document.exitFullscreen(); },  
 253351: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253409: () => { return screen.width; },  
 253434: () => { return screen.height; },  
 253460: () => { return window.screenX; },  
 253487: () => { return window.screenY; },  
 253514: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253567: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253638: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253695: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253951: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254022: () => { if (document.fullscreenElement) return 1; },  
 254068: () => { return window.innerWidth; },  
 254094: () => { return window.innerHeight; },  
 254121: () => { if (document.pointerLockElement) return 1; }
};
