...
var ASM_CONSTS = {
  261076: () => { if (document.fullscreenElement) return 1; },  
 261122: () => { return document.getElementById('canvas').width; },  
 261174: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261242: () => { document.exitFullscreen(); },  
 261269: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261342: () => { if (document.fullscreenElement) return 1; },  
 261388: () => { return document.getElementById('canvas').width; },  
 261440: () => { return screen.width; },  
 261465: () => { document.exitFullscreen(); },  
 261492: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261625: () => { return window.innerWidth; },  
 261651: () => { return window.innerHeight; },  
 261678: () => { if (document.fullscreenElement) return 1; },  
 261724: () => { return document.getElementById('canvas').width; },  
 261776: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261844: () => { if (document.fullscreenElement) return 1; },  
 261890: () => { return document.getElementById('canvas').width; },  
 261942: () => { return screen.width; },  
 261967: () => { return window.innerWidth; },  
 261993: () => { return window.innerHeight; },  
 262020: () => { if (document.fullscreenElement) return 1; },  
 262066: () => { return document.getElementById('canvas').width; },  
 262118: () => { return screen.width; },  
 262143: () => { document.exitFullscreen(); },  
 ...
 262336: () => { document.exitFullscreen(); },  
 262363: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262421: () => { return screen.width; },  
 262446: () => { return screen.height; },  
 262472: () => { return window.screenX; },  
 262499: () => { return window.screenY; },  
 262526: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262579: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262650: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262707: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262963: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263034: () => { if (document.fullscreenElement) return 1; },  
 263080: () => { return window.innerWidth; },  
 263106: () => { return window.innerHeight; },  
 263133: () => { if (document.pointerLockElement) return 1; }
};
