...
var ASM_CONSTS = {
  260852: () => { if (document.fullscreenElement) return 1; },  
 260898: () => { return document.getElementById('canvas').width; },  
 260950: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261018: () => { document.exitFullscreen(); },  
 261045: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261118: () => { if (document.fullscreenElement) return 1; },  
 261164: () => { return document.getElementById('canvas').width; },  
 261216: () => { return screen.width; },  
 261241: () => { document.exitFullscreen(); },  
 261268: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261401: () => { return window.innerWidth; },  
 261427: () => { return window.innerHeight; },  
 261454: () => { if (document.fullscreenElement) return 1; },  
 261500: () => { return document.getElementById('canvas').width; },  
 261552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261620: () => { if (document.fullscreenElement) return 1; },  
 261666: () => { return document.getElementById('canvas').width; },  
 261718: () => { return screen.width; },  
 261743: () => { return window.innerWidth; },  
 261769: () => { return window.innerHeight; },  
 261796: () => { if (document.fullscreenElement) return 1; },  
 261842: () => { return document.getElementById('canvas').width; },  
 261894: () => { return screen.width; },  
 261919: () => { document.exitFullscreen(); },  
 ...
 262112: () => { document.exitFullscreen(); },  
 262139: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262197: () => { return screen.width; },  
 262222: () => { return screen.height; },  
 262248: () => { return window.screenX; },  
 262275: () => { return window.screenY; },  
 262302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262483: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262739: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262810: () => { if (document.fullscreenElement) return 1; },  
 262856: () => { return window.innerWidth; },  
 262882: () => { return window.innerHeight; },  
 262909: () => { if (document.pointerLockElement) return 1; }
};
