...
var ASM_CONSTS = {
 ...
 268874: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268942: () => { document.exitFullscreen(); },  
 268969: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269042: () => { if (document.fullscreenElement) return 1; },  
 269088: () => { return document.getElementById('canvas').width; },  
 269140: () => { return screen.width; },  
 269165: () => { document.exitFullscreen(); },  
 269192: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269325: () => { return window.innerWidth; },  
 269351: () => { return window.innerHeight; },  
