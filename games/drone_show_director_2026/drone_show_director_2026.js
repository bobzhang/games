...
var ASM_CONSTS = {
  263476: () => { if (document.fullscreenElement) return 1; },  
 263522: () => { return document.getElementById('canvas').width; },  
 263574: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263642: () => { document.exitFullscreen(); },  
 263669: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263742: () => { if (document.fullscreenElement) return 1; },  
 263788: () => { return document.getElementById('canvas').width; },  
 263840: () => { return screen.width; },  
 263865: () => { document.exitFullscreen(); },  
 263892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264025: () => { return window.innerWidth; },  
 264051: () => { return window.innerHeight; },  
 264078: () => { if (document.fullscreenElement) return 1; },  
 264124: () => { return document.getElementById('canvas').width; },  
 264176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264367: () => { return window.innerWidth; },  
 264393: () => { return window.innerHeight; },  
 264420: () => { if (document.fullscreenElement) return 1; },  
 264466: () => { return document.getElementById('canvas').width; },  
 264518: () => { return screen.width; },  
 264543: () => { document.exitFullscreen(); },  
 264570: () => { if (document.fullscreenElement) return 1; },  
 264616: () => { return document.getElementById('canvas').width; },  
 264668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264736: () => { document.exitFullscreen(); },  
 264763: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264821: () => { return screen.width; },  
 264846: () => { return screen.height; },  
 264872: () => { return window.screenX; },  
 264899: () => { return window.screenY; },  
 264926: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264979: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265050: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265107: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265363: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265434: () => { if (document.fullscreenElement) return 1; },  
 265480: () => { return window.innerWidth; },  
 265506: () => { return window.innerHeight; },  
 265533: () => { if (document.pointerLockElement) return 1; }
};
