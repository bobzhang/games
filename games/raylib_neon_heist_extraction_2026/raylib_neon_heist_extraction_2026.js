...
var ASM_CONSTS = {
 ...
 99250: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99318: () => { document.exitFullscreen(); },  
 99345: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99418: () => { if (document.fullscreenElement) return 1; },  
 99464: () => { return document.getElementById('canvas').width; },  
 99516: () => { return screen.width; },  
 99541: () => { document.exitFullscreen(); },  
 99568: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99701: () => { return window.innerWidth; },  
 99727: () => { return window.innerHeight; },  
 99754: () => { if (document.fullscreenElement) return 1; },  
 99800: () => { return document.getElementById('canvas').width; },  
 99852: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99920: () => { if (document.fullscreenElement) return 1; },  
 99966: () => { return document.getElementById('canvas').width; },  
 100018: () => { return screen.width; },  
 100043: () => { return window.innerWidth; },  
 100069: () => { return window.innerHeight; },  
 ...
 100219: () => { document.exitFullscreen(); },  
 100246: () => { if (document.fullscreenElement) return 1; },  
 100292: () => { return document.getElementById('canvas').width; },  
 100344: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100412: () => { document.exitFullscreen(); },  
 100439: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100497: () => { return screen.width; },  
 100522: () => { return screen.height; },  
 100548: () => { return window.screenX; },  
 100575: () => { return window.screenY; },  
 100602: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100655: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100726: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100783: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101039: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101110: () => { if (document.fullscreenElement) return 1; },  
 101156: () => { return window.innerWidth; },  
 101182: () => { return window.innerHeight; },  
 101209: () => { if (document.pointerLockElement) return 1; }
};
