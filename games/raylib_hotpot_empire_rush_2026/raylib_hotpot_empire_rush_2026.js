...
var ASM_CONSTS = {
 ...
 104546: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104614: () => { document.exitFullscreen(); },  
 104641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 104714: () => { if (document.fullscreenElement) return 1; },  
 104760: () => { return document.getElementById('canvas').width; },  
 104812: () => { return screen.width; },  
 104837: () => { document.exitFullscreen(); },  
 104864: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104997: () => { return window.innerWidth; },  
 105023: () => { return window.innerHeight; },  
 105050: () => { if (document.fullscreenElement) return 1; },  
 105096: () => { return document.getElementById('canvas').width; },  
 105148: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105216: () => { if (document.fullscreenElement) return 1; },  
 105262: () => { return document.getElementById('canvas').width; },  
 105314: () => { return screen.width; },  
 105339: () => { return window.innerWidth; },  
 105365: () => { return window.innerHeight; },  
 ...
 105515: () => { document.exitFullscreen(); },  
 105542: () => { if (document.fullscreenElement) return 1; },  
 105588: () => { return document.getElementById('canvas').width; },  
 105640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105708: () => { document.exitFullscreen(); },  
 105735: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105793: () => { return screen.width; },  
 105818: () => { return screen.height; },  
 105844: () => { return window.screenX; },  
 105871: () => { return window.screenY; },  
 105898: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105951: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106022: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106079: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106335: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106406: () => { if (document.fullscreenElement) return 1; },  
 106452: () => { return window.innerWidth; },  
 106478: () => { return window.innerHeight; },  
 106505: () => { if (document.pointerLockElement) return 1; }
};
