...
var ASM_CONSTS = {
 ...
 266998: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267066: () => { document.exitFullscreen(); },  
 267093: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267166: () => { if (document.fullscreenElement) return 1; },  
 267212: () => { return document.getElementById('canvas').width; },  
 267264: () => { return screen.width; },  
 267289: () => { document.exitFullscreen(); },  
 267316: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267449: () => { return window.innerWidth; },  
 267475: () => { return window.innerHeight; },  
 267502: () => { if (document.fullscreenElement) return 1; },  
 267548: () => { return document.getElementById('canvas').width; },  
 267600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267668: () => { if (document.fullscreenElement) return 1; },  
 267714: () => { return document.getElementById('canvas').width; },  
 267766: () => { return screen.width; },  
 267791: () => { return window.innerWidth; },  
 267817: () => { return window.innerHeight; },  
 ...
 267967: () => { document.exitFullscreen(); },  
 267994: () => { if (document.fullscreenElement) return 1; },  
 268040: () => { return document.getElementById('canvas').width; },  
 268092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268160: () => { document.exitFullscreen(); },  
 268187: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268245: () => { return screen.width; },  
 268270: () => { return screen.height; },  
 268296: () => { return window.screenX; },  
 268323: () => { return window.screenY; },  
 268350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268403: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268474: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268531: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268787: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268858: () => { if (document.fullscreenElement) return 1; },  
 268904: () => { return window.innerWidth; },  
 268930: () => { return window.innerHeight; },  
 268957: () => { if (document.pointerLockElement) return 1; }
};
