...
var ASM_CONSTS = {
 ...
 267222: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267290: () => { document.exitFullscreen(); },  
 267317: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267390: () => { if (document.fullscreenElement) return 1; },  
 267436: () => { return document.getElementById('canvas').width; },  
 267488: () => { return screen.width; },  
 267513: () => { document.exitFullscreen(); },  
 267540: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267673: () => { return window.innerWidth; },  
 267699: () => { return window.innerHeight; },  
 267726: () => { if (document.fullscreenElement) return 1; },  
 267772: () => { return document.getElementById('canvas').width; },  
 267824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267892: () => { if (document.fullscreenElement) return 1; },  
 267938: () => { return document.getElementById('canvas').width; },  
 267990: () => { return screen.width; },  
 268015: () => { return window.innerWidth; },  
 268041: () => { return window.innerHeight; },  
 268068: () => { if (document.fullscreenElement) return 1; },  
 268114: () => { return document.getElementById('canvas').width; },  
 268166: () => { return screen.width; },  
 268191: () => { document.exitFullscreen(); },  
 268218: () => { if (document.fullscreenElement) return 1; },  
 268264: () => { return document.getElementById('canvas').width; },  
 268316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268384: () => { document.exitFullscreen(); },  
 268411: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268469: () => { return screen.width; },  
 268494: () => { return screen.height; },  
 268520: () => { return window.screenX; },  
 268547: () => { return window.screenY; },  
 268574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268627: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268698: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268755: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269011: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269082: () => { if (document.fullscreenElement) return 1; },  
 269128: () => { return window.innerWidth; },  
 269154: () => { return window.innerHeight; },  
 269181: () => { if (document.pointerLockElement) return 1; }
};
