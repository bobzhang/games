...
var ASM_CONSTS = {
  267108: () => { if (document.fullscreenElement) return 1; },  
 267154: () => { return document.getElementById('canvas').width; },  
 267206: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267274: () => { document.exitFullscreen(); },  
 267301: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267374: () => { if (document.fullscreenElement) return 1; },  
 267420: () => { return document.getElementById('canvas').width; },  
 267472: () => { return screen.width; },  
 267497: () => { document.exitFullscreen(); },  
 267524: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267657: () => { return window.innerWidth; },  
 267683: () => { return window.innerHeight; },  
 267710: () => { if (document.fullscreenElement) return 1; },  
 267756: () => { return document.getElementById('canvas').width; },  
 267808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267876: () => { if (document.fullscreenElement) return 1; },  
 267922: () => { return document.getElementById('canvas').width; },  
 267974: () => { return screen.width; },  
 267999: () => { return window.innerWidth; },  
 268025: () => { return window.innerHeight; },  
 ...
 268175: () => { document.exitFullscreen(); },  
 268202: () => { if (document.fullscreenElement) return 1; },  
 268248: () => { return document.getElementById('canvas').width; },  
 268300: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268368: () => { document.exitFullscreen(); },  
 268395: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268453: () => { return screen.width; },  
 268478: () => { return screen.height; },  
 268504: () => { return window.screenX; },  
 268531: () => { return window.screenY; },  
 268558: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268611: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268682: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268739: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268995: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269066: () => { if (document.fullscreenElement) return 1; },  
 269112: () => { return window.innerWidth; },  
 269138: () => { return window.innerHeight; },  
 269165: () => { if (document.pointerLockElement) return 1; }
};
