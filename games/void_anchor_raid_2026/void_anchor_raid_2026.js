...
var ASM_CONSTS = {
 ...
 262502: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262570: () => { document.exitFullscreen(); },  
 262597: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262670: () => { if (document.fullscreenElement) return 1; },  
 262716: () => { return document.getElementById('canvas').width; },  
 262768: () => { return screen.width; },  
 262793: () => { document.exitFullscreen(); },  
 262820: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262953: () => { return window.innerWidth; },  
 262979: () => { return window.innerHeight; },  
 263006: () => { if (document.fullscreenElement) return 1; },  
 263052: () => { return document.getElementById('canvas').width; },  
 263104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263295: () => { return window.innerWidth; },  
 263321: () => { return window.innerHeight; },  
 263348: () => { if (document.fullscreenElement) return 1; },  
 263394: () => { return document.getElementById('canvas').width; },  
 263446: () => { return screen.width; },  
 263471: () => { document.exitFullscreen(); },  
 263498: () => { if (document.fullscreenElement) return 1; },  
 263544: () => { return document.getElementById('canvas').width; },  
 263596: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263664: () => { document.exitFullscreen(); },  
 263691: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263749: () => { return screen.width; },  
 263774: () => { return screen.height; },  
 263800: () => { return window.screenX; },  
 263827: () => { return window.screenY; },  
 263854: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263907: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263978: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264035: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264291: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264362: () => { if (document.fullscreenElement) return 1; },  
 264408: () => { return window.innerWidth; },  
 264434: () => { return window.innerHeight; },  
 264461: () => { if (document.pointerLockElement) return 1; }
};
