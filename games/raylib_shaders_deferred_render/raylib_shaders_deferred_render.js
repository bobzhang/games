...
function findWasmBinary() {
  return locateFile('raylib_shaders_deferred_render.wasm');
}
...
var ASM_CONSTS = {
  103472: () => { if (document.fullscreenElement) return 1; },  
 103518: () => { return document.getElementById('canvas').width; },  
 103570: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103638: () => { document.exitFullscreen(); },  
 103665: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103738: () => { if (document.fullscreenElement) return 1; },  
 103784: () => { return document.getElementById('canvas').width; },  
 103836: () => { return screen.width; },  
 103861: () => { document.exitFullscreen(); },  
 103888: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104021: () => { return window.innerWidth; },  
 104047: () => { return window.innerHeight; },  
 104074: () => { if (document.fullscreenElement) return 1; },  
 104120: () => { return document.getElementById('canvas').width; },  
 104172: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104240: () => { if (document.fullscreenElement) return 1; },  
 104286: () => { return document.getElementById('canvas').width; },  
 104338: () => { return screen.width; },  
 104363: () => { return window.innerWidth; },  
 104389: () => { return window.innerHeight; },  
 104416: () => { if (document.fullscreenElement) return 1; },  
 104462: () => { return document.getElementById('canvas').width; },  
 104514: () => { return screen.width; },  
 104539: () => { document.exitFullscreen(); },  
 104566: () => { if (document.fullscreenElement) return 1; },  
 104612: () => { return document.getElementById('canvas').width; },  
 104664: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104732: () => { document.exitFullscreen(); },  
 104759: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104817: () => { return screen.width; },  
 104842: () => { return screen.height; },  
 104868: () => { return window.screenX; },  
 104895: () => { return window.screenY; },  
 104922: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104975: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105046: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105103: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105359: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105430: () => { if (document.fullscreenElement) return 1; },  
 105476: () => { return window.innerWidth; },  
 105502: () => { return window.innerHeight; },  
 105529: () => { if (document.pointerLockElement) return 1; }
};
