...
var ASM_CONSTS = {
 ...
 262678: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262746: () => { document.exitFullscreen(); },  
 262773: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262846: () => { if (document.fullscreenElement) return 1; },  
 262892: () => { return document.getElementById('canvas').width; },  
 262944: () => { return screen.width; },  
 262969: () => { document.exitFullscreen(); },  
 262996: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263129: () => { return window.innerWidth; },  
 263155: () => { return window.innerHeight; },  
 263182: () => { if (document.fullscreenElement) return 1; },  
 263228: () => { return document.getElementById('canvas').width; },  
 263280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263471: () => { return window.innerWidth; },  
 263497: () => { return window.innerHeight; },  
 ...
 263647: () => { document.exitFullscreen(); },  
 ...
 263840: () => { document.exitFullscreen(); },  
 263867: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263925: () => { return screen.width; },  
 263950: () => { return screen.height; },  
 263976: () => { return window.screenX; },  
 264003: () => { return window.screenY; },  
 264030: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264083: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264154: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264211: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264467: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264538: () => { if (document.fullscreenElement) return 1; },  
 264584: () => { return window.innerWidth; },  
 264610: () => { return window.innerHeight; },  
 264637: () => { if (document.pointerLockElement) return 1; }
};
