...
var ASM_CONSTS = {
  264004: () => { if (document.fullscreenElement) return 1; },  
 264050: () => { return document.getElementById('canvas').width; },  
 264102: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264170: () => { document.exitFullscreen(); },  
 264197: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264270: () => { if (document.fullscreenElement) return 1; },  
 264316: () => { return document.getElementById('canvas').width; },  
 264368: () => { return screen.width; },  
 264393: () => { document.exitFullscreen(); },  
 264420: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264553: () => { return window.innerWidth; },  
 264579: () => { return window.innerHeight; },  
 264606: () => { if (document.fullscreenElement) return 1; },  
 264652: () => { return document.getElementById('canvas').width; },  
 264704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264772: () => { if (document.fullscreenElement) return 1; },  
 264818: () => { return document.getElementById('canvas').width; },  
 264870: () => { return screen.width; },  
 264895: () => { return window.innerWidth; },  
 264921: () => { return window.innerHeight; },  
 264948: () => { if (document.fullscreenElement) return 1; },  
 264994: () => { return document.getElementById('canvas').width; },  
 265046: () => { return screen.width; },  
 265071: () => { document.exitFullscreen(); },  
 265098: () => { if (document.fullscreenElement) return 1; },  
 265144: () => { return document.getElementById('canvas').width; },  
 265196: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265264: () => { document.exitFullscreen(); },  
 265291: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265349: () => { return screen.width; },  
 265374: () => { return screen.height; },  
 265400: () => { return window.screenX; },  
 265427: () => { return window.screenY; },  
 265454: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265507: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265578: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265635: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265891: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265962: () => { if (document.fullscreenElement) return 1; },  
 266008: () => { return window.innerWidth; },  
 266034: () => { return window.innerHeight; },  
 266061: () => { if (document.pointerLockElement) return 1; }
};
