...
var ASM_CONSTS = {
 ...
 264118: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264186: () => { document.exitFullscreen(); },  
 264213: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264286: () => { if (document.fullscreenElement) return 1; },  
 264332: () => { return document.getElementById('canvas').width; },  
 264384: () => { return screen.width; },  
 264409: () => { document.exitFullscreen(); },  
 264436: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264569: () => { return window.innerWidth; },  
 264595: () => { return window.innerHeight; },  
 264622: () => { if (document.fullscreenElement) return 1; },  
 264668: () => { return document.getElementById('canvas').width; },  
 264720: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264788: () => { if (document.fullscreenElement) return 1; },  
 264834: () => { return document.getElementById('canvas').width; },  
 264886: () => { return screen.width; },  
 264911: () => { return window.innerWidth; },  
 264937: () => { return window.innerHeight; },  
 264964: () => { if (document.fullscreenElement) return 1; },  
 265010: () => { return document.getElementById('canvas').width; },  
 265062: () => { return screen.width; },  
 265087: () => { document.exitFullscreen(); },  
 265114: () => { if (document.fullscreenElement) return 1; },  
 265160: () => { return document.getElementById('canvas').width; },  
 265212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265280: () => { document.exitFullscreen(); },  
 265307: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265365: () => { return screen.width; },  
 265390: () => { return screen.height; },  
 265416: () => { return window.screenX; },  
 265443: () => { return window.screenY; },  
 265470: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265523: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265594: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265651: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265907: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265978: () => { if (document.fullscreenElement) return 1; },  
 266024: () => { return window.innerWidth; },  
 266050: () => { return window.innerHeight; },  
 266077: () => { if (document.pointerLockElement) return 1; }
};
