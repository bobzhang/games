...
var ASM_CONSTS = {
 ...
 263894: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263962: () => { document.exitFullscreen(); },  
 263989: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264062: () => { if (document.fullscreenElement) return 1; },  
 264108: () => { return document.getElementById('canvas').width; },  
 264160: () => { return screen.width; },  
 264185: () => { document.exitFullscreen(); },  
 264212: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264345: () => { return window.innerWidth; },  
 264371: () => { return window.innerHeight; },  
 264398: () => { if (document.fullscreenElement) return 1; },  
 264444: () => { return document.getElementById('canvas').width; },  
 264496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264564: () => { if (document.fullscreenElement) return 1; },  
 264610: () => { return document.getElementById('canvas').width; },  
 264662: () => { return screen.width; },  
 264687: () => { return window.innerWidth; },  
 264713: () => { return window.innerHeight; },  
 264740: () => { if (document.fullscreenElement) return 1; },  
 264786: () => { return document.getElementById('canvas').width; },  
 264838: () => { return screen.width; },  
 264863: () => { document.exitFullscreen(); },  
 264890: () => { if (document.fullscreenElement) return 1; },  
 264936: () => { return document.getElementById('canvas').width; },  
 264988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265056: () => { document.exitFullscreen(); },  
 265083: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265141: () => { return screen.width; },  
 265166: () => { return screen.height; },  
 265192: () => { return window.screenX; },  
 265219: () => { return window.screenY; },  
 265246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265427: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265754: () => { if (document.fullscreenElement) return 1; },  
 265800: () => { return window.innerWidth; },  
 265826: () => { return window.innerHeight; },  
 265853: () => { if (document.pointerLockElement) return 1; }
};
