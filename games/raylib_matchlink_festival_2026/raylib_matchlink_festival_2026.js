...
var ASM_CONSTS = {
 ...
 99714: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99782: () => { document.exitFullscreen(); },  
 99809: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99882: () => { if (document.fullscreenElement) return 1; },  
 99928: () => { return document.getElementById('canvas').width; },  
 99980: () => { return screen.width; },  
 100005: () => { document.exitFullscreen(); },  
 100032: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100165: () => { return window.innerWidth; },  
 100191: () => { return window.innerHeight; },  
 100218: () => { if (document.fullscreenElement) return 1; },  
 100264: () => { return document.getElementById('canvas').width; },  
 100316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100507: () => { return window.innerWidth; },  
 100533: () => { return window.innerHeight; },  
 ...
 100683: () => { document.exitFullscreen(); },  
 100710: () => { if (document.fullscreenElement) return 1; },  
 100756: () => { return document.getElementById('canvas').width; },  
 100808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100876: () => { document.exitFullscreen(); },  
 100903: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100961: () => { return screen.width; },  
 100986: () => { return screen.height; },  
 101012: () => { return window.screenX; },  
 101039: () => { return window.screenY; },  
 101066: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101119: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101190: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101247: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101503: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101574: () => { if (document.fullscreenElement) return 1; },  
 101620: () => { return window.innerWidth; },  
 101646: () => { return window.innerHeight; },  
 101673: () => { if (document.pointerLockElement) return 1; }
};
