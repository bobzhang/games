...
function findWasmBinary() {
  return locateFile('raylib_models_waving_cubes.wasm');
}
...
var ASM_CONSTS = {
  96848: () => { if (document.fullscreenElement) return 1; },  
 96894: () => { return document.getElementById('canvas').width; },  
 96946: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97014: () => { document.exitFullscreen(); },  
 97041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97114: () => { if (document.fullscreenElement) return 1; },  
 97160: () => { return document.getElementById('canvas').width; },  
 97212: () => { return screen.width; },  
 97237: () => { document.exitFullscreen(); },  
 97264: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97397: () => { return window.innerWidth; },  
 97423: () => { return window.innerHeight; },  
 97450: () => { if (document.fullscreenElement) return 1; },  
 97496: () => { return document.getElementById('canvas').width; },  
 97548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97616: () => { if (document.fullscreenElement) return 1; },  
 97662: () => { return document.getElementById('canvas').width; },  
 97714: () => { return screen.width; },  
 97739: () => { return window.innerWidth; },  
 97765: () => { return window.innerHeight; },  
 97792: () => { if (document.fullscreenElement) return 1; },  
 97838: () => { return document.getElementById('canvas').width; },  
 97890: () => { return screen.width; },  
 97915: () => { document.exitFullscreen(); },  
 97942: () => { if (document.fullscreenElement) return 1; },  
 97988: () => { return document.getElementById('canvas').width; },  
 98040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98108: () => { document.exitFullscreen(); },  
 98135: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98193: () => { return screen.width; },  
 98218: () => { return screen.height; },  
 98244: () => { return window.screenX; },  
 98271: () => { return window.screenY; },  
 98298: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98351: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98422: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98479: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98735: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98806: () => { if (document.fullscreenElement) return 1; },  
 98852: () => { return window.innerWidth; },  
 98878: () => { return window.innerHeight; },  
 98905: () => { if (document.pointerLockElement) return 1; }
};
