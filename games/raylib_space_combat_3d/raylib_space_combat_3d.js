...
function findWasmBinary() {
  return locateFile('raylib_space_combat_3d.wasm');
}
...
var ASM_CONSTS = {
  106320: () => { if (document.fullscreenElement) return 1; },  
 106366: () => { return document.getElementById('canvas').width; },  
 106418: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106486: () => { document.exitFullscreen(); },  
 106513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106586: () => { if (document.fullscreenElement) return 1; },  
 106632: () => { return document.getElementById('canvas').width; },  
 106684: () => { return screen.width; },  
 106709: () => { document.exitFullscreen(); },  
 106736: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106869: () => { return window.innerWidth; },  
 106895: () => { return window.innerHeight; },  
 106922: () => { if (document.fullscreenElement) return 1; },  
 106968: () => { return document.getElementById('canvas').width; },  
 107020: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107088: () => { if (document.fullscreenElement) return 1; },  
 107134: () => { return document.getElementById('canvas').width; },  
 107186: () => { return screen.width; },  
 107211: () => { return window.innerWidth; },  
 107237: () => { return window.innerHeight; },  
 107264: () => { if (document.fullscreenElement) return 1; },  
 107310: () => { return document.getElementById('canvas').width; },  
 107362: () => { return screen.width; },  
 107387: () => { document.exitFullscreen(); },  
 107414: () => { if (document.fullscreenElement) return 1; },  
 107460: () => { return document.getElementById('canvas').width; },  
 107512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107580: () => { document.exitFullscreen(); },  
 107607: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107665: () => { return screen.width; },  
 107690: () => { return screen.height; },  
 107716: () => { return window.screenX; },  
 107743: () => { return window.screenY; },  
 107770: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107823: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107894: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107951: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108207: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108278: () => { if (document.fullscreenElement) return 1; },  
 108324: () => { return window.innerWidth; },  
 108350: () => { return window.innerHeight; },  
 108377: () => { if (document.pointerLockElement) return 1; }
};
