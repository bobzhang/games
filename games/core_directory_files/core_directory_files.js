...
function findWasmBinary() {
  return locateFile('core_directory_files.wasm');
}
...
var ASM_CONSTS = {
  252176: () => { if (document.fullscreenElement) return 1; },  
 252222: () => { return document.getElementById('canvas').width; },  
 252274: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252342: () => { document.exitFullscreen(); },  
 252369: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252442: () => { if (document.fullscreenElement) return 1; },  
 252488: () => { return document.getElementById('canvas').width; },  
 252540: () => { return screen.width; },  
 252565: () => { document.exitFullscreen(); },  
 252592: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252725: () => { return window.innerWidth; },  
 252751: () => { return window.innerHeight; },  
 252778: () => { if (document.fullscreenElement) return 1; },  
 252824: () => { return document.getElementById('canvas').width; },  
 252876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252944: () => { if (document.fullscreenElement) return 1; },  
 252990: () => { return document.getElementById('canvas').width; },  
 253042: () => { return screen.width; },  
 253067: () => { return window.innerWidth; },  
 253093: () => { return window.innerHeight; },  
 253120: () => { if (document.fullscreenElement) return 1; },  
 253166: () => { return document.getElementById('canvas').width; },  
 253218: () => { return screen.width; },  
 253243: () => { document.exitFullscreen(); },  
 253270: () => { if (document.fullscreenElement) return 1; },  
 253316: () => { return document.getElementById('canvas').width; },  
 253368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253436: () => { document.exitFullscreen(); },  
 253463: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253521: () => { return screen.width; },  
 253546: () => { return screen.height; },  
 253572: () => { return window.screenX; },  
 253599: () => { return window.screenY; },  
 253626: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253679: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253750: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253807: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 254063: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 254134: () => { if (document.fullscreenElement) return 1; },  
 254180: () => { return window.innerWidth; },  
 254206: () => { return window.innerHeight; },  
 254233: () => { if (document.pointerLockElement) return 1; }
};
