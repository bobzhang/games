...
var ASM_CONSTS = {
 ...
 261958: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262026: () => { document.exitFullscreen(); },  
 262053: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262126: () => { if (document.fullscreenElement) return 1; },  
 262172: () => { return document.getElementById('canvas').width; },  
 262224: () => { return screen.width; },  
 262249: () => { document.exitFullscreen(); },  
 262276: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262409: () => { return window.innerWidth; },  
 262435: () => { return window.innerHeight; },  
 262462: () => { if (document.fullscreenElement) return 1; },  
 262508: () => { return document.getElementById('canvas').width; },  
 262560: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262751: () => { return window.innerWidth; },  
 262777: () => { return window.innerHeight; },  
 ...
 262927: () => { document.exitFullscreen(); },  
 262954: () => { if (document.fullscreenElement) return 1; },  
 263000: () => { return document.getElementById('canvas').width; },  
 263052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263120: () => { document.exitFullscreen(); },  
 263147: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263205: () => { return screen.width; },  
 263230: () => { return screen.height; },  
 263256: () => { return window.screenX; },  
 263283: () => { return window.screenY; },  
 263310: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263363: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263434: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263491: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263747: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263818: () => { if (document.fullscreenElement) return 1; },  
 263864: () => { return window.innerWidth; },  
 263890: () => { return window.innerHeight; },  
 263917: () => { if (document.pointerLockElement) return 1; }
};
