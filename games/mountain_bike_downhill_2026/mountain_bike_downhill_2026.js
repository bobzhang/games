...
var ASM_CONSTS = {
  262068: () => { if (document.fullscreenElement) return 1; },  
 262114: () => { return document.getElementById('canvas').width; },  
 262166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262234: () => { document.exitFullscreen(); },  
 262261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262334: () => { if (document.fullscreenElement) return 1; },  
 262380: () => { return document.getElementById('canvas').width; },  
 262432: () => { return screen.width; },  
 262457: () => { document.exitFullscreen(); },  
 262484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262617: () => { return window.innerWidth; },  
 262643: () => { return window.innerHeight; },  
 262670: () => { if (document.fullscreenElement) return 1; },  
 262716: () => { return document.getElementById('canvas').width; },  
 262768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262836: () => { if (document.fullscreenElement) return 1; },  
 262882: () => { return document.getElementById('canvas').width; },  
 262934: () => { return screen.width; },  
 262959: () => { return window.innerWidth; },  
 262985: () => { return window.innerHeight; },  
 263012: () => { if (document.fullscreenElement) return 1; },  
 263058: () => { return document.getElementById('canvas').width; },  
 263110: () => { return screen.width; },  
 263135: () => { document.exitFullscreen(); },  
 ...
 263328: () => { document.exitFullscreen(); },  
 263355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263413: () => { return screen.width; },  
 263438: () => { return screen.height; },  
 263464: () => { return window.screenX; },  
 263491: () => { return window.screenY; },  
 263518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264026: () => { if (document.fullscreenElement) return 1; },  
 264072: () => { return window.innerWidth; },  
 264098: () => { return window.innerHeight; },  
 264125: () => { if (document.pointerLockElement) return 1; }
};
