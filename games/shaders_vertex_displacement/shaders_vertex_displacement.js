...
var ASM_CONSTS = {
 ...
 265110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265178: () => { document.exitFullscreen(); },  
 265205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265278: () => { if (document.fullscreenElement) return 1; },  
 265324: () => { return document.getElementById('canvas').width; },  
 265376: () => { return screen.width; },  
 265401: () => { document.exitFullscreen(); },  
 265428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265561: () => { return window.innerWidth; },  
 265587: () => { return window.innerHeight; },  
 265614: () => { if (document.fullscreenElement) return 1; },  
 265660: () => { return document.getElementById('canvas').width; },  
 265712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265780: () => { if (document.fullscreenElement) return 1; },  
 265826: () => { return document.getElementById('canvas').width; },  
 265878: () => { return screen.width; },  
 265903: () => { return window.innerWidth; },  
 265929: () => { return window.innerHeight; },  
 265956: () => { if (document.fullscreenElement) return 1; },  
 266002: () => { return document.getElementById('canvas').width; },  
 266054: () => { return screen.width; },  
 266079: () => { document.exitFullscreen(); },  
 266106: () => { if (document.fullscreenElement) return 1; },  
 266152: () => { return document.getElementById('canvas').width; },  
 266204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266272: () => { document.exitFullscreen(); },  
 266299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266357: () => { return screen.width; },  
 266382: () => { return screen.height; },  
 266408: () => { return window.screenX; },  
 266435: () => { return window.screenY; },  
 266462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266970: () => { if (document.fullscreenElement) return 1; },  
 267016: () => { return window.innerWidth; },  
 267042: () => { return window.innerHeight; },  
 267069: () => { if (document.pointerLockElement) return 1; }
};
