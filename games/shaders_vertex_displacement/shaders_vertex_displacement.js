...
var ASM_CONSTS = {
 ...
 264886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264954: () => { document.exitFullscreen(); },  
 264981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265054: () => { if (document.fullscreenElement) return 1; },  
 265100: () => { return document.getElementById('canvas').width; },  
 265152: () => { return screen.width; },  
 265177: () => { document.exitFullscreen(); },  
 265204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265337: () => { return window.innerWidth; },  
 265363: () => { return window.innerHeight; },  
 265390: () => { if (document.fullscreenElement) return 1; },  
 265436: () => { return document.getElementById('canvas').width; },  
 265488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265556: () => { if (document.fullscreenElement) return 1; },  
 265602: () => { return document.getElementById('canvas').width; },  
 265654: () => { return screen.width; },  
 265679: () => { return window.innerWidth; },  
 265705: () => { return window.innerHeight; },  
 265732: () => { if (document.fullscreenElement) return 1; },  
 265778: () => { return document.getElementById('canvas').width; },  
 265830: () => { return screen.width; },  
 265855: () => { document.exitFullscreen(); },  
 265882: () => { if (document.fullscreenElement) return 1; },  
 265928: () => { return document.getElementById('canvas').width; },  
 265980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266048: () => { document.exitFullscreen(); },  
 266075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266133: () => { return screen.width; },  
 266158: () => { return screen.height; },  
 266184: () => { return window.screenX; },  
 266211: () => { return window.screenY; },  
 266238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266746: () => { if (document.fullscreenElement) return 1; },  
 266792: () => { return window.innerWidth; },  
 266818: () => { return window.innerHeight; },  
 266845: () => { if (document.pointerLockElement) return 1; }
};
