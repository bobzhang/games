...
var ASM_CONSTS = {
  346996: () => { if (document.fullscreenElement) return 1; },  
 347042: () => { return document.getElementById('canvas').width; },  
 347094: () => { return parseInt(document.getElementById('canvas').style.width); },  
 347162: () => { document.exitFullscreen(); },  
 347189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 347262: () => { if (document.fullscreenElement) return 1; },  
 347308: () => { return document.getElementById('canvas').width; },  
 347360: () => { return screen.width; },  
 347385: () => { document.exitFullscreen(); },  
 347412: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 347545: () => { return window.innerWidth; },  
 347571: () => { return window.innerHeight; },  
 347598: () => { if (document.fullscreenElement) return 1; },  
 347644: () => { return document.getElementById('canvas').width; },  
 347696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 347764: () => { if (document.fullscreenElement) return 1; },  
 347810: () => { return document.getElementById('canvas').width; },  
 347862: () => { return screen.width; },  
 347887: () => { return window.innerWidth; },  
 347913: () => { return window.innerHeight; },  
 347940: () => { if (document.fullscreenElement) return 1; },  
 347986: () => { return document.getElementById('canvas').width; },  
 348038: () => { return screen.width; },  
 348063: () => { document.exitFullscreen(); },  
 348090: () => { if (document.fullscreenElement) return 1; },  
 348136: () => { return document.getElementById('canvas').width; },  
 348188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 348256: () => { document.exitFullscreen(); },  
 348283: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 348341: () => { return screen.width; },  
 348366: () => { return screen.height; },  
 348392: () => { return window.screenX; },  
 348419: () => { return window.screenY; },  
 348446: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 348499: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 348570: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 348627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 348883: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 348954: () => { if (document.fullscreenElement) return 1; },  
 349000: () => { return window.innerWidth; },  
 349026: () => { return window.innerHeight; },  
 349053: () => { if (document.pointerLockElement) return 1; }
};
