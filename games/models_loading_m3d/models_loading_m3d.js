...
var ASM_CONSTS = {
  347204: () => { if (document.fullscreenElement) return 1; },  
 347250: () => { return document.getElementById('canvas').width; },  
 347302: () => { return parseInt(document.getElementById('canvas').style.width); },  
 347370: () => { document.exitFullscreen(); },  
 347397: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 347470: () => { if (document.fullscreenElement) return 1; },  
 347516: () => { return document.getElementById('canvas').width; },  
 347568: () => { return screen.width; },  
 347593: () => { document.exitFullscreen(); },  
 347620: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 347753: () => { return window.innerWidth; },  
 347779: () => { return window.innerHeight; },  
 347806: () => { if (document.fullscreenElement) return 1; },  
 347852: () => { return document.getElementById('canvas').width; },  
 347904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 347972: () => { if (document.fullscreenElement) return 1; },  
 348018: () => { return document.getElementById('canvas').width; },  
 348070: () => { return screen.width; },  
 348095: () => { return window.innerWidth; },  
 348121: () => { return window.innerHeight; },  
 348148: () => { if (document.fullscreenElement) return 1; },  
 348194: () => { return document.getElementById('canvas').width; },  
 348246: () => { return screen.width; },  
 348271: () => { document.exitFullscreen(); },  
 348298: () => { if (document.fullscreenElement) return 1; },  
 348344: () => { return document.getElementById('canvas').width; },  
 348396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 348464: () => { document.exitFullscreen(); },  
 348491: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 348549: () => { return screen.width; },  
 348574: () => { return screen.height; },  
 348600: () => { return window.screenX; },  
 348627: () => { return window.screenY; },  
 348654: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 348707: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 348778: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 348835: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 349091: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 349162: () => { if (document.fullscreenElement) return 1; },  
 349208: () => { return window.innerWidth; },  
 349234: () => { return window.innerHeight; },  
 349261: () => { if (document.pointerLockElement) return 1; }
};
