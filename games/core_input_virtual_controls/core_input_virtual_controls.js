...
var ASM_CONSTS = {
  260452: () => { if (document.fullscreenElement) return 1; },  
 260498: () => { return document.getElementById('canvas').width; },  
 260550: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260618: () => { document.exitFullscreen(); },  
 260645: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260718: () => { if (document.fullscreenElement) return 1; },  
 260764: () => { return document.getElementById('canvas').width; },  
 260816: () => { return screen.width; },  
 260841: () => { document.exitFullscreen(); },  
 260868: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261001: () => { return window.innerWidth; },  
 261027: () => { return window.innerHeight; },  
 261054: () => { if (document.fullscreenElement) return 1; },  
 261100: () => { return document.getElementById('canvas').width; },  
 261152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261220: () => { if (document.fullscreenElement) return 1; },  
 261266: () => { return document.getElementById('canvas').width; },  
 261318: () => { return screen.width; },  
 261343: () => { return window.innerWidth; },  
 261369: () => { return window.innerHeight; },  
 ...
 261519: () => { document.exitFullscreen(); },  
 ...
 261712: () => { document.exitFullscreen(); },  
 261739: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261797: () => { return screen.width; },  
 261822: () => { return screen.height; },  
 261848: () => { return window.screenX; },  
 261875: () => { return window.screenY; },  
 261902: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261955: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262026: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262339: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262410: () => { if (document.fullscreenElement) return 1; },  
 262456: () => { return window.innerWidth; },  
 262482: () => { return window.innerHeight; },  
 262509: () => { if (document.pointerLockElement) return 1; }
};
