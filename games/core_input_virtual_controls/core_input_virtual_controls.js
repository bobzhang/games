...
var ASM_CONSTS = {
  260432: () => { if (document.fullscreenElement) return 1; },  
 260478: () => { return document.getElementById('canvas').width; },  
 260530: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260598: () => { document.exitFullscreen(); },  
 260625: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260698: () => { if (document.fullscreenElement) return 1; },  
 260744: () => { return document.getElementById('canvas').width; },  
 260796: () => { return screen.width; },  
 260821: () => { document.exitFullscreen(); },  
 260848: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260981: () => { return window.innerWidth; },  
 261007: () => { return window.innerHeight; },  
 261034: () => { if (document.fullscreenElement) return 1; },  
 261080: () => { return document.getElementById('canvas').width; },  
 261132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261200: () => { if (document.fullscreenElement) return 1; },  
 261246: () => { return document.getElementById('canvas').width; },  
 261298: () => { return screen.width; },  
 261323: () => { return window.innerWidth; },  
 261349: () => { return window.innerHeight; },  
 261376: () => { if (document.fullscreenElement) return 1; },  
 261422: () => { return document.getElementById('canvas').width; },  
 261474: () => { return screen.width; },  
 261499: () => { document.exitFullscreen(); },  
 261526: () => { if (document.fullscreenElement) return 1; },  
 261572: () => { return document.getElementById('canvas').width; },  
 261624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261692: () => { document.exitFullscreen(); },  
 261719: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261777: () => { return screen.width; },  
 261802: () => { return screen.height; },  
 261828: () => { return window.screenX; },  
 261855: () => { return window.screenY; },  
 261882: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261935: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262006: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262063: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262319: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262390: () => { if (document.fullscreenElement) return 1; },  
 262436: () => { return window.innerWidth; },  
 262462: () => { return window.innerHeight; },  
 262489: () => { if (document.pointerLockElement) return 1; }
};
