...
var ASM_CONSTS = {
  272400: () => { if (document.fullscreenElement) return 1; },  
 272446: () => { return document.getElementById('canvas').width; },  
 272498: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272566: () => { document.exitFullscreen(); },  
 272593: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272666: () => { if (document.fullscreenElement) return 1; },  
 272712: () => { return document.getElementById('canvas').width; },  
 272764: () => { return screen.width; },  
 272789: () => { document.exitFullscreen(); },  
 272816: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272949: () => { return window.innerWidth; },  
 272975: () => { return window.innerHeight; },  
 273002: () => { if (document.fullscreenElement) return 1; },  
 273048: () => { return document.getElementById('canvas').width; },  
 273100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273168: () => { if (document.fullscreenElement) return 1; },  
 273214: () => { return document.getElementById('canvas').width; },  
 273266: () => { return screen.width; },  
 273291: () => { return window.innerWidth; },  
 273317: () => { return window.innerHeight; },  
 273344: () => { if (document.fullscreenElement) return 1; },  
 273390: () => { return document.getElementById('canvas').width; },  
 273442: () => { return screen.width; },  
 273467: () => { document.exitFullscreen(); },  
 273494: () => { if (document.fullscreenElement) return 1; },  
 273540: () => { return document.getElementById('canvas').width; },  
 273592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273660: () => { document.exitFullscreen(); },  
 273687: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273745: () => { return screen.width; },  
 273770: () => { return screen.height; },  
 273796: () => { return window.screenX; },  
 273823: () => { return window.screenY; },  
 273850: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273903: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273974: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274031: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274287: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274358: () => { if (document.fullscreenElement) return 1; },  
 274404: () => { return window.innerWidth; },  
 274430: () => { return window.innerHeight; },  
 274457: () => { if (document.pointerLockElement) return 1; }
};
