...
var ASM_CONSTS = {
  272372: () => { if (document.fullscreenElement) return 1; },  
 272418: () => { return document.getElementById('canvas').width; },  
 272470: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272538: () => { document.exitFullscreen(); },  
 272565: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272638: () => { if (document.fullscreenElement) return 1; },  
 272684: () => { return document.getElementById('canvas').width; },  
 272736: () => { return screen.width; },  
 272761: () => { document.exitFullscreen(); },  
 272788: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272921: () => { return window.innerWidth; },  
 272947: () => { return window.innerHeight; },  
 272974: () => { if (document.fullscreenElement) return 1; },  
 273020: () => { return document.getElementById('canvas').width; },  
 273072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273140: () => { if (document.fullscreenElement) return 1; },  
 273186: () => { return document.getElementById('canvas').width; },  
 273238: () => { return screen.width; },  
 273263: () => { return window.innerWidth; },  
 273289: () => { return window.innerHeight; },  
 ...
 273439: () => { document.exitFullscreen(); },  
 273466: () => { if (document.fullscreenElement) return 1; },  
 273512: () => { return document.getElementById('canvas').width; },  
 273564: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273632: () => { document.exitFullscreen(); },  
 273659: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273717: () => { return screen.width; },  
 273742: () => { return screen.height; },  
 273768: () => { return window.screenX; },  
 273795: () => { return window.screenY; },  
 273822: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273875: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273946: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274003: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274259: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274330: () => { if (document.fullscreenElement) return 1; },  
 274376: () => { return window.innerWidth; },  
 274402: () => { return window.innerHeight; },  
 274429: () => { if (document.pointerLockElement) return 1; }
};
