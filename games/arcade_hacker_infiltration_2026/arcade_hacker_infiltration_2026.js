...
var ASM_CONSTS = {
  262868: () => { if (document.fullscreenElement) return 1; },  
 262914: () => { return document.getElementById('canvas').width; },  
 262966: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263034: () => { document.exitFullscreen(); },  
 263061: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263134: () => { if (document.fullscreenElement) return 1; },  
 263180: () => { return document.getElementById('canvas').width; },  
 263232: () => { return screen.width; },  
 263257: () => { document.exitFullscreen(); },  
 263284: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263417: () => { return window.innerWidth; },  
 263443: () => { return window.innerHeight; },  
 263470: () => { if (document.fullscreenElement) return 1; },  
 263516: () => { return document.getElementById('canvas').width; },  
 263568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263636: () => { if (document.fullscreenElement) return 1; },  
 263682: () => { return document.getElementById('canvas').width; },  
 263734: () => { return screen.width; },  
 263759: () => { return window.innerWidth; },  
 263785: () => { return window.innerHeight; },  
 263812: () => { if (document.fullscreenElement) return 1; },  
 263858: () => { return document.getElementById('canvas').width; },  
 263910: () => { return screen.width; },  
 263935: () => { document.exitFullscreen(); },  
 263962: () => { if (document.fullscreenElement) return 1; },  
 264008: () => { return document.getElementById('canvas').width; },  
 264060: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264128: () => { document.exitFullscreen(); },  
 264155: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264213: () => { return screen.width; },  
 264238: () => { return screen.height; },  
 264264: () => { return window.screenX; },  
 264291: () => { return window.screenY; },  
 264318: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264371: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264442: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264499: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264755: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264826: () => { if (document.fullscreenElement) return 1; },  
 264872: () => { return window.innerWidth; },  
 264898: () => { return window.innerHeight; },  
 264925: () => { if (document.pointerLockElement) return 1; }
};
