...
var ASM_CONSTS = {
  262884: () => { if (document.fullscreenElement) return 1; },  
 262930: () => { return document.getElementById('canvas').width; },  
 262982: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263050: () => { document.exitFullscreen(); },  
 263077: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263150: () => { if (document.fullscreenElement) return 1; },  
 263196: () => { return document.getElementById('canvas').width; },  
 263248: () => { return screen.width; },  
 263273: () => { document.exitFullscreen(); },  
 263300: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263433: () => { return window.innerWidth; },  
 263459: () => { return window.innerHeight; },  
 263486: () => { if (document.fullscreenElement) return 1; },  
 263532: () => { return document.getElementById('canvas').width; },  
 263584: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263652: () => { if (document.fullscreenElement) return 1; },  
 263698: () => { return document.getElementById('canvas').width; },  
 263750: () => { return screen.width; },  
 263775: () => { return window.innerWidth; },  
 263801: () => { return window.innerHeight; },  
 263828: () => { if (document.fullscreenElement) return 1; },  
 263874: () => { return document.getElementById('canvas').width; },  
 263926: () => { return screen.width; },  
 263951: () => { document.exitFullscreen(); },  
 263978: () => { if (document.fullscreenElement) return 1; },  
 264024: () => { return document.getElementById('canvas').width; },  
 264076: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264144: () => { document.exitFullscreen(); },  
 264171: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264229: () => { return screen.width; },  
 264254: () => { return screen.height; },  
 264280: () => { return window.screenX; },  
 264307: () => { return window.screenY; },  
 264334: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264387: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264458: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264515: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264771: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264842: () => { if (document.fullscreenElement) return 1; },  
 264888: () => { return window.innerWidth; },  
 264914: () => { return window.innerHeight; },  
 264941: () => { if (document.pointerLockElement) return 1; }
};
