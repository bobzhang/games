...
var ASM_CONSTS = {
  262660: () => { if (document.fullscreenElement) return 1; },  
 262706: () => { return document.getElementById('canvas').width; },  
 262758: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262826: () => { document.exitFullscreen(); },  
 262853: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262926: () => { if (document.fullscreenElement) return 1; },  
 262972: () => { return document.getElementById('canvas').width; },  
 263024: () => { return screen.width; },  
 263049: () => { document.exitFullscreen(); },  
 263076: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263209: () => { return window.innerWidth; },  
 263235: () => { return window.innerHeight; },  
 263262: () => { if (document.fullscreenElement) return 1; },  
 263308: () => { return document.getElementById('canvas').width; },  
 263360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263428: () => { if (document.fullscreenElement) return 1; },  
 263474: () => { return document.getElementById('canvas').width; },  
 263526: () => { return screen.width; },  
 263551: () => { return window.innerWidth; },  
 263577: () => { return window.innerHeight; },  
 263604: () => { if (document.fullscreenElement) return 1; },  
 263650: () => { return document.getElementById('canvas').width; },  
 263702: () => { return screen.width; },  
 263727: () => { document.exitFullscreen(); },  
 263754: () => { if (document.fullscreenElement) return 1; },  
 263800: () => { return document.getElementById('canvas').width; },  
 263852: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263920: () => { document.exitFullscreen(); },  
 263947: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264005: () => { return screen.width; },  
 264030: () => { return screen.height; },  
 264056: () => { return window.screenX; },  
 264083: () => { return window.screenY; },  
 264110: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264163: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264234: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264291: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264547: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264618: () => { if (document.fullscreenElement) return 1; },  
 264664: () => { return window.innerWidth; },  
 264690: () => { return window.innerHeight; },  
 264717: () => { if (document.pointerLockElement) return 1; }
};
