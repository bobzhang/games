...
function findWasmBinary() {
  return locateFile('raylib_textures_raw_data.wasm');
}
...
var ASM_CONSTS = {
  883984: () => { if (document.fullscreenElement) return 1; },  
 884030: () => { return document.getElementById('canvas').width; },  
 884082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 884150: () => { document.exitFullscreen(); },  
 884177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 884250: () => { if (document.fullscreenElement) return 1; },  
 884296: () => { return document.getElementById('canvas').width; },  
 884348: () => { return screen.width; },  
 884373: () => { document.exitFullscreen(); },  
 884400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 884533: () => { return window.innerWidth; },  
 884559: () => { return window.innerHeight; },  
 884586: () => { if (document.fullscreenElement) return 1; },  
 884632: () => { return document.getElementById('canvas').width; },  
 884684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 884752: () => { if (document.fullscreenElement) return 1; },  
 884798: () => { return document.getElementById('canvas').width; },  
 884850: () => { return screen.width; },  
 884875: () => { return window.innerWidth; },  
 884901: () => { return window.innerHeight; },  
 884928: () => { if (document.fullscreenElement) return 1; },  
 884974: () => { return document.getElementById('canvas').width; },  
 885026: () => { return screen.width; },  
 885051: () => { document.exitFullscreen(); },  
 885078: () => { if (document.fullscreenElement) return 1; },  
 885124: () => { return document.getElementById('canvas').width; },  
 885176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 885244: () => { document.exitFullscreen(); },  
 885271: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 885329: () => { return screen.width; },  
 885354: () => { return screen.height; },  
 885380: () => { return window.screenX; },  
 885407: () => { return window.screenY; },  
 885434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 885487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 885558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 885615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 885871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 885942: () => { if (document.fullscreenElement) return 1; },  
 885988: () => { return window.innerWidth; },  
 886014: () => { return window.innerHeight; },  
 886041: () => { if (document.pointerLockElement) return 1; }
};
