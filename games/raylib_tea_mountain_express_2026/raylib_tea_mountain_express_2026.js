...
var ASM_CONSTS = {
 ...
 99906: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99974: () => { document.exitFullscreen(); },  
 100001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100074: () => { if (document.fullscreenElement) return 1; },  
 100120: () => { return document.getElementById('canvas').width; },  
 100172: () => { return screen.width; },  
 100197: () => { document.exitFullscreen(); },  
 100224: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100357: () => { return window.innerWidth; },  
 100383: () => { return window.innerHeight; },  
 100410: () => { if (document.fullscreenElement) return 1; },  
 100456: () => { return document.getElementById('canvas').width; },  
 100508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100850: () => { return screen.width; },  
 100875: () => { document.exitFullscreen(); },  
 100902: () => { if (document.fullscreenElement) return 1; },  
 100948: () => { return document.getElementById('canvas').width; },  
 101000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101068: () => { document.exitFullscreen(); },  
 101095: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101153: () => { return screen.width; },  
 101178: () => { return screen.height; },  
 101204: () => { return window.screenX; },  
 101231: () => { return window.screenY; },  
 101258: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101311: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101382: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101439: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101695: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101766: () => { if (document.fullscreenElement) return 1; },  
 101812: () => { return window.innerWidth; },  
 101838: () => { return window.innerHeight; },  
 101865: () => { if (document.pointerLockElement) return 1; }
};
