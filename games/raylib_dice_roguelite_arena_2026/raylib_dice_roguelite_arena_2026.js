...
var ASM_CONSTS = {
  100960: () => { if (document.fullscreenElement) return 1; },  
 101006: () => { return document.getElementById('canvas').width; },  
 101058: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101126: () => { document.exitFullscreen(); },  
 101153: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101226: () => { if (document.fullscreenElement) return 1; },  
 101272: () => { return document.getElementById('canvas').width; },  
 101324: () => { return screen.width; },  
 101349: () => { document.exitFullscreen(); },  
 101376: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101509: () => { return window.innerWidth; },  
 101535: () => { return window.innerHeight; },  
 101562: () => { if (document.fullscreenElement) return 1; },  
 101608: () => { return document.getElementById('canvas').width; },  
 101660: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101728: () => { if (document.fullscreenElement) return 1; },  
 101774: () => { return document.getElementById('canvas').width; },  
 101826: () => { return screen.width; },  
 101851: () => { return window.innerWidth; },  
 101877: () => { return window.innerHeight; },  
 101904: () => { if (document.fullscreenElement) return 1; },  
 101950: () => { return document.getElementById('canvas').width; },  
 102002: () => { return screen.width; },  
 102027: () => { document.exitFullscreen(); },  
 102054: () => { if (document.fullscreenElement) return 1; },  
 102100: () => { return document.getElementById('canvas').width; },  
 102152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102220: () => { document.exitFullscreen(); },  
 102247: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102305: () => { return screen.width; },  
 102330: () => { return screen.height; },  
 102356: () => { return window.screenX; },  
 102383: () => { return window.screenY; },  
 102410: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102463: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102534: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102591: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102847: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102918: () => { if (document.fullscreenElement) return 1; },  
 102964: () => { return window.innerWidth; },  
 102990: () => { return window.innerHeight; },  
 103017: () => { if (document.pointerLockElement) return 1; }
};
