...
var ASM_CONSTS = {
 ...
 263990: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264058: () => { document.exitFullscreen(); },  
 264085: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264158: () => { if (document.fullscreenElement) return 1; },  
 264204: () => { return document.getElementById('canvas').width; },  
 264256: () => { return screen.width; },  
 264281: () => { document.exitFullscreen(); },  
 264308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264441: () => { return window.innerWidth; },  
 264467: () => { return window.innerHeight; },  
 264494: () => { if (document.fullscreenElement) return 1; },  
 264540: () => { return document.getElementById('canvas').width; },  
 264592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264660: () => { if (document.fullscreenElement) return 1; },  
 264706: () => { return document.getElementById('canvas').width; },  
 264758: () => { return screen.width; },  
 264783: () => { return window.innerWidth; },  
 264809: () => { return window.innerHeight; },  
 264836: () => { if (document.fullscreenElement) return 1; },  
 264882: () => { return document.getElementById('canvas').width; },  
 264934: () => { return screen.width; },  
 264959: () => { document.exitFullscreen(); },  
 264986: () => { if (document.fullscreenElement) return 1; },  
 265032: () => { return document.getElementById('canvas').width; },  
 265084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265152: () => { document.exitFullscreen(); },  
 265179: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265237: () => { return screen.width; },  
 265262: () => { return screen.height; },  
 265288: () => { return window.screenX; },  
 265315: () => { return window.screenY; },  
 265342: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265395: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265466: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265523: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265779: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265850: () => { if (document.fullscreenElement) return 1; },  
 265896: () => { return window.innerWidth; },  
 265922: () => { return window.innerHeight; },  
 265949: () => { if (document.pointerLockElement) return 1; }
};
