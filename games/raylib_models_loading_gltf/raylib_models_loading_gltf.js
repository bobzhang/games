...
function findWasmBinary() {
  return locateFile('raylib_models_loading_gltf.wasm');
}
...
var ASM_CONSTS = {
  109488: () => { if (document.fullscreenElement) return 1; },  
 109534: () => { return document.getElementById('canvas').width; },  
 109586: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109654: () => { document.exitFullscreen(); },  
 109681: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109754: () => { if (document.fullscreenElement) return 1; },  
 109800: () => { return document.getElementById('canvas').width; },  
 109852: () => { return screen.width; },  
 109877: () => { document.exitFullscreen(); },  
 109904: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 110037: () => { return window.innerWidth; },  
 110063: () => { return window.innerHeight; },  
 110090: () => { if (document.fullscreenElement) return 1; },  
 110136: () => { return document.getElementById('canvas').width; },  
 110188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110256: () => { if (document.fullscreenElement) return 1; },  
 110302: () => { return document.getElementById('canvas').width; },  
 110354: () => { return screen.width; },  
 110379: () => { return window.innerWidth; },  
 110405: () => { return window.innerHeight; },  
 110432: () => { if (document.fullscreenElement) return 1; },  
 110478: () => { return document.getElementById('canvas').width; },  
 110530: () => { return screen.width; },  
 110555: () => { document.exitFullscreen(); },  
 110582: () => { if (document.fullscreenElement) return 1; },  
 110628: () => { return document.getElementById('canvas').width; },  
 110680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110748: () => { document.exitFullscreen(); },  
 110775: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 110833: () => { return screen.width; },  
 110858: () => { return screen.height; },  
 110884: () => { return window.screenX; },  
 110911: () => { return window.screenY; },  
 110938: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110991: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111062: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111119: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 111375: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111446: () => { if (document.fullscreenElement) return 1; },  
 111492: () => { return window.innerWidth; },  
 111518: () => { return window.innerHeight; },  
 111545: () => { if (document.pointerLockElement) return 1; }
};
