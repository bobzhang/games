...
function findWasmBinary() {
  return locateFile('raylib_models_loading_vox.wasm');
}
...
var ASM_CONSTS = {
  1462192: () => { if (document.fullscreenElement) return 1; },  
 1462238: () => { return document.getElementById('canvas').width; },  
 1462290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1462358: () => { document.exitFullscreen(); },  
 1462385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1462458: () => { if (document.fullscreenElement) return 1; },  
 1462504: () => { return document.getElementById('canvas').width; },  
 1462556: () => { return screen.width; },  
 1462581: () => { document.exitFullscreen(); },  
 1462608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1462741: () => { return window.innerWidth; },  
 1462767: () => { return window.innerHeight; },  
 1462794: () => { if (document.fullscreenElement) return 1; },  
 1462840: () => { return document.getElementById('canvas').width; },  
 1462892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1462960: () => { if (document.fullscreenElement) return 1; },  
 1463006: () => { return document.getElementById('canvas').width; },  
 1463058: () => { return screen.width; },  
 1463083: () => { return window.innerWidth; },  
 1463109: () => { return window.innerHeight; },  
 1463136: () => { if (document.fullscreenElement) return 1; },  
 1463182: () => { return document.getElementById('canvas').width; },  
 1463234: () => { return screen.width; },  
 1463259: () => { document.exitFullscreen(); },  
 1463286: () => { if (document.fullscreenElement) return 1; },  
 1463332: () => { return document.getElementById('canvas').width; },  
 1463384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1463452: () => { document.exitFullscreen(); },  
 1463479: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1463537: () => { return screen.width; },  
 1463562: () => { return screen.height; },  
 1463588: () => { return window.screenX; },  
 1463615: () => { return window.screenY; },  
 1463642: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1463695: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1463766: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1463823: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1464079: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1464150: () => { if (document.fullscreenElement) return 1; },  
 1464196: () => { return window.innerWidth; },  
 1464222: () => { return window.innerHeight; },  
 1464249: () => { if (document.pointerLockElement) return 1; }
};
