...
var ASM_CONSTS = {
  262804: () => { if (document.fullscreenElement) return 1; },  
 262850: () => { return document.getElementById('canvas').width; },  
 262902: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262970: () => { document.exitFullscreen(); },  
 262997: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263070: () => { if (document.fullscreenElement) return 1; },  
 263116: () => { return document.getElementById('canvas').width; },  
 263168: () => { return screen.width; },  
 263193: () => { document.exitFullscreen(); },  
 263220: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263353: () => { return window.innerWidth; },  
 263379: () => { return window.innerHeight; },  
 263406: () => { if (document.fullscreenElement) return 1; },  
 263452: () => { return document.getElementById('canvas').width; },  
 263504: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263572: () => { if (document.fullscreenElement) return 1; },  
 263618: () => { return document.getElementById('canvas').width; },  
 263670: () => { return screen.width; },  
 263695: () => { return window.innerWidth; },  
 263721: () => { return window.innerHeight; },  
 263748: () => { if (document.fullscreenElement) return 1; },  
 263794: () => { return document.getElementById('canvas').width; },  
 263846: () => { return screen.width; },  
 263871: () => { document.exitFullscreen(); },  
 ...
 264064: () => { document.exitFullscreen(); },  
 264091: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264149: () => { return screen.width; },  
 264174: () => { return screen.height; },  
 264200: () => { return window.screenX; },  
 264227: () => { return window.screenY; },  
 264254: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264307: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264378: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264691: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264762: () => { if (document.fullscreenElement) return 1; },  
 264808: () => { return window.innerWidth; },  
 264834: () => { return window.innerHeight; },  
 264861: () => { if (document.pointerLockElement) return 1; }
};
