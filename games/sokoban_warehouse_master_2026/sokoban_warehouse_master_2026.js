...
var ASM_CONSTS = {
  262612: () => { if (document.fullscreenElement) return 1; },  
 262658: () => { return document.getElementById('canvas').width; },  
 262710: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262778: () => { document.exitFullscreen(); },  
 262805: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262878: () => { if (document.fullscreenElement) return 1; },  
 262924: () => { return document.getElementById('canvas').width; },  
 262976: () => { return screen.width; },  
 263001: () => { document.exitFullscreen(); },  
 263028: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263161: () => { return window.innerWidth; },  
 263187: () => { return window.innerHeight; },  
 263214: () => { if (document.fullscreenElement) return 1; },  
 263260: () => { return document.getElementById('canvas').width; },  
 263312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263380: () => { if (document.fullscreenElement) return 1; },  
 263426: () => { return document.getElementById('canvas').width; },  
 263478: () => { return screen.width; },  
 263503: () => { return window.innerWidth; },  
 263529: () => { return window.innerHeight; },  
 263556: () => { if (document.fullscreenElement) return 1; },  
 263602: () => { return document.getElementById('canvas').width; },  
 263654: () => { return screen.width; },  
 263679: () => { document.exitFullscreen(); },  
 263706: () => { if (document.fullscreenElement) return 1; },  
 263752: () => { return document.getElementById('canvas').width; },  
 263804: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263872: () => { document.exitFullscreen(); },  
 263899: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263957: () => { return screen.width; },  
 263982: () => { return screen.height; },  
 264008: () => { return window.screenX; },  
 264035: () => { return window.screenY; },  
 264062: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264115: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264186: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264243: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264499: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264570: () => { if (document.fullscreenElement) return 1; },  
 264616: () => { return window.innerWidth; },  
 264642: () => { return window.innerHeight; },  
 264669: () => { if (document.pointerLockElement) return 1; }
};
