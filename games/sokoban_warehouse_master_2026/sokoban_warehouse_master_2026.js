...
var ASM_CONSTS = {
  262820: () => { if (document.fullscreenElement) return 1; },  
 262866: () => { return document.getElementById('canvas').width; },  
 262918: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262986: () => { document.exitFullscreen(); },  
 263013: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263086: () => { if (document.fullscreenElement) return 1; },  
 263132: () => { return document.getElementById('canvas').width; },  
 263184: () => { return screen.width; },  
 263209: () => { document.exitFullscreen(); },  
 263236: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263369: () => { return window.innerWidth; },  
 263395: () => { return window.innerHeight; },  
 263422: () => { if (document.fullscreenElement) return 1; },  
 263468: () => { return document.getElementById('canvas').width; },  
 263520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263588: () => { if (document.fullscreenElement) return 1; },  
 263634: () => { return document.getElementById('canvas').width; },  
 263686: () => { return screen.width; },  
 263711: () => { return window.innerWidth; },  
 263737: () => { return window.innerHeight; },  
 263764: () => { if (document.fullscreenElement) return 1; },  
 263810: () => { return document.getElementById('canvas').width; },  
 263862: () => { return screen.width; },  
 263887: () => { document.exitFullscreen(); },  
 263914: () => { if (document.fullscreenElement) return 1; },  
 263960: () => { return document.getElementById('canvas').width; },  
 264012: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264080: () => { document.exitFullscreen(); },  
 264107: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264165: () => { return screen.width; },  
 264190: () => { return screen.height; },  
 264216: () => { return window.screenX; },  
 264243: () => { return window.screenY; },  
 264270: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264323: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264394: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264451: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264707: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264778: () => { if (document.fullscreenElement) return 1; },  
 264824: () => { return window.innerWidth; },  
 264850: () => { return window.innerHeight; },  
 264877: () => { if (document.pointerLockElement) return 1; }
};
