...
var ASM_CONSTS = {
  268524: () => { if (document.fullscreenElement) return 1; },  
 268570: () => { return document.getElementById('canvas').width; },  
 268622: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268690: () => { document.exitFullscreen(); },  
 268717: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268790: () => { if (document.fullscreenElement) return 1; },  
 268836: () => { return document.getElementById('canvas').width; },  
 268888: () => { return screen.width; },  
 268913: () => { document.exitFullscreen(); },  
 268940: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269073: () => { return window.innerWidth; },  
 269099: () => { return window.innerHeight; },  
 269126: () => { if (document.fullscreenElement) return 1; },  
 269172: () => { return document.getElementById('canvas').width; },  
 269224: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269292: () => { if (document.fullscreenElement) return 1; },  
 269338: () => { return document.getElementById('canvas').width; },  
 269390: () => { return screen.width; },  
 269415: () => { return window.innerWidth; },  
 269441: () => { return window.innerHeight; },  
