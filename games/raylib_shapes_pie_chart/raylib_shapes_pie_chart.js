...
function findWasmBinary() {
  return locateFile('raylib_shapes_pie_chart.wasm');
}
...
var ASM_CONSTS = {
 ...
 98690: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98758: () => { document.exitFullscreen(); },  
 98785: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98858: () => { if (document.fullscreenElement) return 1; },  
 98904: () => { return document.getElementById('canvas').width; },  
 98956: () => { return screen.width; },  
 98981: () => { document.exitFullscreen(); },  
 99008: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99141: () => { return window.innerWidth; },  
 99167: () => { return window.innerHeight; },  
 99194: () => { if (document.fullscreenElement) return 1; },  
 99240: () => { return document.getElementById('canvas').width; },  
 99292: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99360: () => { if (document.fullscreenElement) return 1; },  
 99406: () => { return document.getElementById('canvas').width; },  
 99458: () => { return screen.width; },  
 99483: () => { return window.innerWidth; },  
 99509: () => { return window.innerHeight; },  
 99536: () => { if (document.fullscreenElement) return 1; },  
 99582: () => { return document.getElementById('canvas').width; },  
 99634: () => { return screen.width; },  
 99659: () => { document.exitFullscreen(); },  
 99686: () => { if (document.fullscreenElement) return 1; },  
 99732: () => { return document.getElementById('canvas').width; },  
 99784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99852: () => { document.exitFullscreen(); },  
 99879: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99937: () => { return screen.width; },  
 99962: () => { return screen.height; },  
 99988: () => { return window.screenX; },  
 100015: () => { return window.screenY; },  
 100042: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100095: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100166: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100223: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100479: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100550: () => { if (document.fullscreenElement) return 1; },  
 100596: () => { return window.innerWidth; },  
 100622: () => { return window.innerHeight; },  
 100649: () => { if (document.pointerLockElement) return 1; }
};
