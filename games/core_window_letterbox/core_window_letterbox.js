...
var ASM_CONSTS = {
 ...
 261430: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261498: () => { document.exitFullscreen(); },  
 261525: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261598: () => { if (document.fullscreenElement) return 1; },  
 261644: () => { return document.getElementById('canvas').width; },  
 261696: () => { return screen.width; },  
 261721: () => { document.exitFullscreen(); },  
 261748: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261881: () => { return window.innerWidth; },  
 261907: () => { return window.innerHeight; },  
 261934: () => { if (document.fullscreenElement) return 1; },  
 261980: () => { return document.getElementById('canvas').width; },  
 262032: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262223: () => { return window.innerWidth; },  
 262249: () => { return window.innerHeight; },  
 ...
 262399: () => { document.exitFullscreen(); },  
 ...
 262592: () => { document.exitFullscreen(); },  
 262619: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262677: () => { return screen.width; },  
 262702: () => { return screen.height; },  
 262728: () => { return window.screenX; },  
 262755: () => { return window.screenY; },  
 262782: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262835: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262906: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262963: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263219: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263290: () => { if (document.fullscreenElement) return 1; },  
 263336: () => { return window.innerWidth; },  
 263362: () => { return window.innerHeight; },  
 263389: () => { if (document.pointerLockElement) return 1; }
};
