...
var ASM_CONSTS = {
  984292: () => { if (document.fullscreenElement) return 1; },  
 984338: () => { return document.getElementById('canvas').width; },  
 984390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 984458: () => { document.exitFullscreen(); },  
 984485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 984558: () => { if (document.fullscreenElement) return 1; },  
 984604: () => { return document.getElementById('canvas').width; },  
 984656: () => { return screen.width; },  
 984681: () => { document.exitFullscreen(); },  
 984708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 984841: () => { return window.innerWidth; },  
 984867: () => { return window.innerHeight; },  
 984894: () => { if (document.fullscreenElement) return 1; },  
 984940: () => { return document.getElementById('canvas').width; },  
 984992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 985060: () => { if (document.fullscreenElement) return 1; },  
 985106: () => { return document.getElementById('canvas').width; },  
 985158: () => { return screen.width; },  
 985183: () => { return window.innerWidth; },  
 985209: () => { return window.innerHeight; },  
 985236: () => { if (document.fullscreenElement) return 1; },  
 985282: () => { return document.getElementById('canvas').width; },  
 985334: () => { return screen.width; },  
 985359: () => { document.exitFullscreen(); },  
 985386: () => { if (document.fullscreenElement) return 1; },  
 985432: () => { return document.getElementById('canvas').width; },  
 985484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 985552: () => { document.exitFullscreen(); },  
 985579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 985637: () => { return screen.width; },  
 985662: () => { return screen.height; },  
 985688: () => { return window.screenX; },  
 985715: () => { return window.screenY; },  
 985742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 985795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 985866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 985923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 986179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 986250: () => { if (document.fullscreenElement) return 1; },  
 986296: () => { return window.innerWidth; },  
 986322: () => { return window.innerHeight; },  
 986349: () => { if (document.pointerLockElement) return 1; }
};
