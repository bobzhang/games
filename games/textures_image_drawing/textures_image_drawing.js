...
var ASM_CONSTS = {
  984512: () => { if (document.fullscreenElement) return 1; },  
 984558: () => { return document.getElementById('canvas').width; },  
 984610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 984678: () => { document.exitFullscreen(); },  
 984705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 984778: () => { if (document.fullscreenElement) return 1; },  
 984824: () => { return document.getElementById('canvas').width; },  
 984876: () => { return screen.width; },  
 984901: () => { document.exitFullscreen(); },  
 984928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 985061: () => { return window.innerWidth; },  
 985087: () => { return window.innerHeight; },  
 985114: () => { if (document.fullscreenElement) return 1; },  
 985160: () => { return document.getElementById('canvas').width; },  
 985212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 985280: () => { if (document.fullscreenElement) return 1; },  
 985326: () => { return document.getElementById('canvas').width; },  
 985378: () => { return screen.width; },  
 985403: () => { return window.innerWidth; },  
 985429: () => { return window.innerHeight; },  
 985456: () => { if (document.fullscreenElement) return 1; },  
 985502: () => { return document.getElementById('canvas').width; },  
 985554: () => { return screen.width; },  
 985579: () => { document.exitFullscreen(); },  
 985606: () => { if (document.fullscreenElement) return 1; },  
 985652: () => { return document.getElementById('canvas').width; },  
 985704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 985772: () => { document.exitFullscreen(); },  
 985799: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 985857: () => { return screen.width; },  
 985882: () => { return screen.height; },  
 985908: () => { return window.screenX; },  
 985935: () => { return window.screenY; },  
 985962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 986015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 986086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 986143: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 986399: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 986470: () => { if (document.fullscreenElement) return 1; },  
 986516: () => { return window.innerWidth; },  
 986542: () => { return window.innerHeight; },  
 986569: () => { if (document.pointerLockElement) return 1; }
};
