...
var ASM_CONSTS = {
  984516: () => { if (document.fullscreenElement) return 1; },  
 984562: () => { return document.getElementById('canvas').width; },  
 984614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 984682: () => { document.exitFullscreen(); },  
 984709: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 984782: () => { if (document.fullscreenElement) return 1; },  
 984828: () => { return document.getElementById('canvas').width; },  
 984880: () => { return screen.width; },  
 984905: () => { document.exitFullscreen(); },  
 984932: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 985065: () => { return window.innerWidth; },  
 985091: () => { return window.innerHeight; },  
 985118: () => { if (document.fullscreenElement) return 1; },  
 985164: () => { return document.getElementById('canvas').width; },  
 985216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 985284: () => { if (document.fullscreenElement) return 1; },  
 985330: () => { return document.getElementById('canvas').width; },  
 985382: () => { return screen.width; },  
 985407: () => { return window.innerWidth; },  
 985433: () => { return window.innerHeight; },  
 985460: () => { if (document.fullscreenElement) return 1; },  
 985506: () => { return document.getElementById('canvas').width; },  
 985558: () => { return screen.width; },  
 985583: () => { document.exitFullscreen(); },  
 985610: () => { if (document.fullscreenElement) return 1; },  
 985656: () => { return document.getElementById('canvas').width; },  
 985708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 985776: () => { document.exitFullscreen(); },  
 985803: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 985861: () => { return screen.width; },  
 985886: () => { return screen.height; },  
 985912: () => { return window.screenX; },  
 985939: () => { return window.screenY; },  
 985966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 986019: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 986090: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 986147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 986403: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 986474: () => { if (document.fullscreenElement) return 1; },  
 986520: () => { return window.innerWidth; },  
 986546: () => { return window.innerHeight; },  
 986573: () => { if (document.pointerLockElement) return 1; }
};
