...
var ASM_CONSTS = {
  261284: () => { if (document.fullscreenElement) return 1; },  
 261330: () => { return document.getElementById('canvas').width; },  
 261382: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261450: () => { document.exitFullscreen(); },  
 261477: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261550: () => { if (document.fullscreenElement) return 1; },  
 261596: () => { return document.getElementById('canvas').width; },  
 261648: () => { return screen.width; },  
 261673: () => { document.exitFullscreen(); },  
 261700: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261833: () => { return window.innerWidth; },  
 261859: () => { return window.innerHeight; },  
 261886: () => { if (document.fullscreenElement) return 1; },  
 261932: () => { return document.getElementById('canvas').width; },  
 261984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262052: () => { if (document.fullscreenElement) return 1; },  
 262098: () => { return document.getElementById('canvas').width; },  
 262150: () => { return screen.width; },  
 262175: () => { return window.innerWidth; },  
 262201: () => { return window.innerHeight; },  
 262228: () => { if (document.fullscreenElement) return 1; },  
 262274: () => { return document.getElementById('canvas').width; },  
 262326: () => { return screen.width; },  
 262351: () => { document.exitFullscreen(); },  
 ...
 262544: () => { document.exitFullscreen(); },  
 262571: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262629: () => { return screen.width; },  
 262654: () => { return screen.height; },  
 262680: () => { return window.screenX; },  
 262707: () => { return window.screenY; },  
 262734: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262787: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262858: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263171: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263242: () => { if (document.fullscreenElement) return 1; },  
 263288: () => { return window.innerWidth; },  
 263314: () => { return window.innerHeight; },  
 263341: () => { if (document.pointerLockElement) return 1; }
};
