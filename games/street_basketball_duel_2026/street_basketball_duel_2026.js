...
var ASM_CONSTS = {
  261476: () => { if (document.fullscreenElement) return 1; },  
 261522: () => { return document.getElementById('canvas').width; },  
 261574: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261642: () => { document.exitFullscreen(); },  
 261669: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261742: () => { if (document.fullscreenElement) return 1; },  
 261788: () => { return document.getElementById('canvas').width; },  
 261840: () => { return screen.width; },  
 261865: () => { document.exitFullscreen(); },  
 261892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262025: () => { return window.innerWidth; },  
 262051: () => { return window.innerHeight; },  
 262078: () => { if (document.fullscreenElement) return 1; },  
 262124: () => { return document.getElementById('canvas').width; },  
 262176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262244: () => { if (document.fullscreenElement) return 1; },  
 262290: () => { return document.getElementById('canvas').width; },  
 262342: () => { return screen.width; },  
 262367: () => { return window.innerWidth; },  
 262393: () => { return window.innerHeight; },  
 262420: () => { if (document.fullscreenElement) return 1; },  
 262466: () => { return document.getElementById('canvas').width; },  
 262518: () => { return screen.width; },  
 262543: () => { document.exitFullscreen(); },  
 262570: () => { if (document.fullscreenElement) return 1; },  
 262616: () => { return document.getElementById('canvas').width; },  
 262668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262736: () => { document.exitFullscreen(); },  
 262763: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262821: () => { return screen.width; },  
 262846: () => { return screen.height; },  
 262872: () => { return window.screenX; },  
 262899: () => { return window.screenY; },  
 262926: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262979: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263050: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263107: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263363: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263434: () => { if (document.fullscreenElement) return 1; },  
 263480: () => { return window.innerWidth; },  
 263506: () => { return window.innerHeight; },  
 263533: () => { if (document.pointerLockElement) return 1; }
};
