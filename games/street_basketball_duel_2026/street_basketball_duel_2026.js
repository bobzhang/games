...
var ASM_CONSTS = {
  261508: () => { if (document.fullscreenElement) return 1; },  
 261554: () => { return document.getElementById('canvas').width; },  
 261606: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261674: () => { document.exitFullscreen(); },  
 261701: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261774: () => { if (document.fullscreenElement) return 1; },  
 261820: () => { return document.getElementById('canvas').width; },  
 261872: () => { return screen.width; },  
 261897: () => { document.exitFullscreen(); },  
 261924: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262057: () => { return window.innerWidth; },  
 262083: () => { return window.innerHeight; },  
 262110: () => { if (document.fullscreenElement) return 1; },  
 262156: () => { return document.getElementById('canvas').width; },  
 262208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262276: () => { if (document.fullscreenElement) return 1; },  
 262322: () => { return document.getElementById('canvas').width; },  
 262374: () => { return screen.width; },  
 262399: () => { return window.innerWidth; },  
 262425: () => { return window.innerHeight; },  
 262452: () => { if (document.fullscreenElement) return 1; },  
 262498: () => { return document.getElementById('canvas').width; },  
 262550: () => { return screen.width; },  
 262575: () => { document.exitFullscreen(); },  
 262602: () => { if (document.fullscreenElement) return 1; },  
 262648: () => { return document.getElementById('canvas').width; },  
 262700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262768: () => { document.exitFullscreen(); },  
 262795: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262853: () => { return screen.width; },  
 262878: () => { return screen.height; },  
 262904: () => { return window.screenX; },  
 262931: () => { return window.screenY; },  
 262958: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263011: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263082: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263139: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263395: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263466: () => { if (document.fullscreenElement) return 1; },  
 263512: () => { return window.innerWidth; },  
 263538: () => { return window.innerHeight; },  
 263565: () => { if (document.pointerLockElement) return 1; }
};
