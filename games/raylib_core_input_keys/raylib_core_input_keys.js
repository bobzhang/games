...
function findWasmBinary() {
  return locateFile('raylib_core_input_keys.wasm');
}
...
var ASM_CONSTS = {
  96832: () => { if (document.fullscreenElement) return 1; },  
 96878: () => { return document.getElementById('canvas').width; },  
 96930: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96998: () => { document.exitFullscreen(); },  
 97025: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97098: () => { if (document.fullscreenElement) return 1; },  
 97144: () => { return document.getElementById('canvas').width; },  
 97196: () => { return screen.width; },  
 97221: () => { document.exitFullscreen(); },  
 97248: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97381: () => { return window.innerWidth; },  
 97407: () => { return window.innerHeight; },  
 97434: () => { if (document.fullscreenElement) return 1; },  
 97480: () => { return document.getElementById('canvas').width; },  
 97532: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97600: () => { if (document.fullscreenElement) return 1; },  
 97646: () => { return document.getElementById('canvas').width; },  
 97698: () => { return screen.width; },  
 97723: () => { return window.innerWidth; },  
 97749: () => { return window.innerHeight; },  
 97776: () => { if (document.fullscreenElement) return 1; },  
 97822: () => { return document.getElementById('canvas').width; },  
 97874: () => { return screen.width; },  
 97899: () => { document.exitFullscreen(); },  
 97926: () => { if (document.fullscreenElement) return 1; },  
 97972: () => { return document.getElementById('canvas').width; },  
 98024: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98092: () => { document.exitFullscreen(); },  
 98119: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98177: () => { return screen.width; },  
 98202: () => { return screen.height; },  
 98228: () => { return window.screenX; },  
 98255: () => { return window.screenY; },  
 98282: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98335: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98406: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98463: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98719: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98790: () => { if (document.fullscreenElement) return 1; },  
 98836: () => { return window.innerWidth; },  
 98862: () => { return window.innerHeight; },  
 98889: () => { if (document.pointerLockElement) return 1; }
};
