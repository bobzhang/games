...
function findWasmBinary() {
  return locateFile('raylib_flight_sim_3d.wasm');
}
...
var ASM_CONSTS = {
 ...
 112546: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112614: () => { document.exitFullscreen(); },  
 112641: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 112714: () => { if (document.fullscreenElement) return 1; },  
 112760: () => { return document.getElementById('canvas').width; },  
 112812: () => { return screen.width; },  
 112837: () => { document.exitFullscreen(); },  
 112864: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 112997: () => { return window.innerWidth; },  
 113023: () => { return window.innerHeight; },  
 113050: () => { if (document.fullscreenElement) return 1; },  
 113096: () => { return document.getElementById('canvas').width; },  
 113148: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113216: () => { if (document.fullscreenElement) return 1; },  
 113262: () => { return document.getElementById('canvas').width; },  
 113314: () => { return screen.width; },  
 113339: () => { return window.innerWidth; },  
 113365: () => { return window.innerHeight; },  
 ...
 113515: () => { document.exitFullscreen(); },  
 113542: () => { if (document.fullscreenElement) return 1; },  
 113588: () => { return document.getElementById('canvas').width; },  
 113640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 113708: () => { document.exitFullscreen(); },  
 113735: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 113793: () => { return screen.width; },  
 113818: () => { return screen.height; },  
 113844: () => { return window.screenX; },  
 113871: () => { return window.screenY; },  
 113898: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 113951: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 114022: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 114079: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114335: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 114406: () => { if (document.fullscreenElement) return 1; },  
 114452: () => { return window.innerWidth; },  
 114478: () => { return window.innerHeight; },  
 114505: () => { if (document.pointerLockElement) return 1; }
};
