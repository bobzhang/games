...
var ASM_CONSTS = {
 ...
 261350: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261418: () => { document.exitFullscreen(); },  
 261445: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261518: () => { if (document.fullscreenElement) return 1; },  
 261564: () => { return document.getElementById('canvas').width; },  
 261616: () => { return screen.width; },  
 261641: () => { document.exitFullscreen(); },  
 261668: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261801: () => { return window.innerWidth; },  
 261827: () => { return window.innerHeight; },  
 261854: () => { if (document.fullscreenElement) return 1; },  
 261900: () => { return document.getElementById('canvas').width; },  
 261952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262143: () => { return window.innerWidth; },  
 262169: () => { return window.innerHeight; },  
 262196: () => { if (document.fullscreenElement) return 1; },  
 262242: () => { return document.getElementById('canvas').width; },  
 262294: () => { return screen.width; },  
 262319: () => { document.exitFullscreen(); },  
 ...
 262512: () => { document.exitFullscreen(); },  
 262539: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262597: () => { return screen.width; },  
 262622: () => { return screen.height; },  
 262648: () => { return window.screenX; },  
 262675: () => { return window.screenY; },  
 262702: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262755: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262826: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262883: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263139: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263210: () => { if (document.fullscreenElement) return 1; },  
 263256: () => { return window.innerWidth; },  
 263282: () => { return window.innerHeight; },  
 263309: () => { if (document.pointerLockElement) return 1; }
};
