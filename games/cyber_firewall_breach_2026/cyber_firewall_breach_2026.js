...
var ASM_CONSTS = {
  261460: () => { if (document.fullscreenElement) return 1; },  
 261506: () => { return document.getElementById('canvas').width; },  
 261558: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261626: () => { document.exitFullscreen(); },  
 261653: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261726: () => { if (document.fullscreenElement) return 1; },  
 261772: () => { return document.getElementById('canvas').width; },  
 261824: () => { return screen.width; },  
 261849: () => { document.exitFullscreen(); },  
 261876: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262009: () => { return window.innerWidth; },  
 262035: () => { return window.innerHeight; },  
 262062: () => { if (document.fullscreenElement) return 1; },  
 262108: () => { return document.getElementById('canvas').width; },  
 262160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262351: () => { return window.innerWidth; },  
 262377: () => { return window.innerHeight; },  
 ...
 262527: () => { document.exitFullscreen(); },  
 262554: () => { if (document.fullscreenElement) return 1; },  
 262600: () => { return document.getElementById('canvas').width; },  
 262652: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262720: () => { document.exitFullscreen(); },  
 262747: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262805: () => { return screen.width; },  
 262830: () => { return screen.height; },  
 262856: () => { return window.screenX; },  
 262883: () => { return window.screenY; },  
 262910: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262963: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263034: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263091: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263347: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263418: () => { if (document.fullscreenElement) return 1; },  
 263464: () => { return window.innerWidth; },  
 263490: () => { return window.innerHeight; },  
 263517: () => { if (document.pointerLockElement) return 1; }
};
