...
var ASM_CONSTS = {
  6832308: () => { if (document.fullscreenElement) return 1; },  
 6832354: () => { return document.getElementById('canvas').width; },  
 6832406: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6832474: () => { document.exitFullscreen(); },  
 6832501: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 6832574: () => { if (document.fullscreenElement) return 1; },  
 6832620: () => { return document.getElementById('canvas').width; },  
 6832672: () => { return screen.width; },  
 6832697: () => { document.exitFullscreen(); },  
 6832724: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 6832857: () => { return window.innerWidth; },  
 6832883: () => { return window.innerHeight; },  
 6832910: () => { if (document.fullscreenElement) return 1; },  
 6832956: () => { return document.getElementById('canvas').width; },  
 6833008: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6833076: () => { if (document.fullscreenElement) return 1; },  
 6833122: () => { return document.getElementById('canvas').width; },  
 6833174: () => { return screen.width; },  
 6833199: () => { return window.innerWidth; },  
 6833225: () => { return window.innerHeight; },  
 6833252: () => { if (document.fullscreenElement) return 1; },  
 6833298: () => { return document.getElementById('canvas').width; },  
 6833350: () => { return screen.width; },  
 6833375: () => { document.exitFullscreen(); },  
 6833402: () => { if (document.fullscreenElement) return 1; },  
 6833448: () => { return document.getElementById('canvas').width; },  
 6833500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6833568: () => { document.exitFullscreen(); },  
 6833595: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 6833653: () => { return screen.width; },  
 6833678: () => { return screen.height; },  
 6833704: () => { return window.screenX; },  
 6833731: () => { return window.screenY; },  
 6833758: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 6833811: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 6833882: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 6833939: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 6834195: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 6834266: () => { if (document.fullscreenElement) return 1; },  
 6834312: () => { return window.innerWidth; },  
 6834338: () => { return window.innerHeight; },  
 6834365: () => { if (document.pointerLockElement) return 1; }
};
