...
var ASM_CONSTS = {
  6832084: () => { if (document.fullscreenElement) return 1; },  
 6832130: () => { return document.getElementById('canvas').width; },  
 6832182: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6832250: () => { document.exitFullscreen(); },  
 6832277: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 6832350: () => { if (document.fullscreenElement) return 1; },  
 6832396: () => { return document.getElementById('canvas').width; },  
 6832448: () => { return screen.width; },  
 6832473: () => { document.exitFullscreen(); },  
 6832500: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 6832633: () => { return window.innerWidth; },  
 6832659: () => { return window.innerHeight; },  
 6832686: () => { if (document.fullscreenElement) return 1; },  
 6832732: () => { return document.getElementById('canvas').width; },  
 6832784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6832852: () => { if (document.fullscreenElement) return 1; },  
 6832898: () => { return document.getElementById('canvas').width; },  
 6832950: () => { return screen.width; },  
 6832975: () => { return window.innerWidth; },  
 6833001: () => { return window.innerHeight; },  
 6833028: () => { if (document.fullscreenElement) return 1; },  
 6833074: () => { return document.getElementById('canvas').width; },  
 6833126: () => { return screen.width; },  
 6833151: () => { document.exitFullscreen(); },  
 6833178: () => { if (document.fullscreenElement) return 1; },  
 6833224: () => { return document.getElementById('canvas').width; },  
 6833276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6833344: () => { document.exitFullscreen(); },  
 6833371: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 6833429: () => { return screen.width; },  
 6833454: () => { return screen.height; },  
 6833480: () => { return window.screenX; },  
 6833507: () => { return window.screenY; },  
 6833534: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 6833587: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 6833658: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 6833715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 6833971: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 6834042: () => { if (document.fullscreenElement) return 1; },  
 6834088: () => { return window.innerWidth; },  
 6834114: () => { return window.innerHeight; },  
 6834141: () => { if (document.pointerLockElement) return 1; }
};
