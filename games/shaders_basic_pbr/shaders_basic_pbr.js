...
var ASM_CONSTS = {
  6832292: () => { if (document.fullscreenElement) return 1; },  
 6832338: () => { return document.getElementById('canvas').width; },  
 6832390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6832458: () => { document.exitFullscreen(); },  
 6832485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 6832558: () => { if (document.fullscreenElement) return 1; },  
 6832604: () => { return document.getElementById('canvas').width; },  
 6832656: () => { return screen.width; },  
 6832681: () => { document.exitFullscreen(); },  
 6832708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 6832841: () => { return window.innerWidth; },  
 6832867: () => { return window.innerHeight; },  
 6832894: () => { if (document.fullscreenElement) return 1; },  
 6832940: () => { return document.getElementById('canvas').width; },  
 6832992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6833060: () => { if (document.fullscreenElement) return 1; },  
 6833106: () => { return document.getElementById('canvas').width; },  
 6833158: () => { return screen.width; },  
 6833183: () => { return window.innerWidth; },  
 6833209: () => { return window.innerHeight; },  
 6833236: () => { if (document.fullscreenElement) return 1; },  
 6833282: () => { return document.getElementById('canvas').width; },  
 6833334: () => { return screen.width; },  
 6833359: () => { document.exitFullscreen(); },  
 6833386: () => { if (document.fullscreenElement) return 1; },  
 6833432: () => { return document.getElementById('canvas').width; },  
 6833484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 6833552: () => { document.exitFullscreen(); },  
 6833579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 6833637: () => { return screen.width; },  
 6833662: () => { return screen.height; },  
 6833688: () => { return window.screenX; },  
 6833715: () => { return window.screenY; },  
 6833742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 6833795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 6833866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 6833923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 6834179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 6834250: () => { if (document.fullscreenElement) return 1; },  
 6834296: () => { return window.innerWidth; },  
 6834322: () => { return window.innerHeight; },  
 6834349: () => { if (document.pointerLockElement) return 1; }
};
