...
function findWasmBinary() {
  return locateFile('raylib_models_loading_m3d.wasm');
}
...
var ASM_CONSTS = {
  183744: () => { if (document.fullscreenElement) return 1; },  
 183790: () => { return document.getElementById('canvas').width; },  
 183842: () => { return parseInt(document.getElementById('canvas').style.width); },  
 183910: () => { document.exitFullscreen(); },  
 183937: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 184010: () => { if (document.fullscreenElement) return 1; },  
 184056: () => { return document.getElementById('canvas').width; },  
 184108: () => { return screen.width; },  
 184133: () => { document.exitFullscreen(); },  
 184160: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 184293: () => { return window.innerWidth; },  
 184319: () => { return window.innerHeight; },  
 184346: () => { if (document.fullscreenElement) return 1; },  
 184392: () => { return document.getElementById('canvas').width; },  
 184444: () => { return parseInt(document.getElementById('canvas').style.width); },  
 184512: () => { if (document.fullscreenElement) return 1; },  
 184558: () => { return document.getElementById('canvas').width; },  
 184610: () => { return screen.width; },  
 184635: () => { return window.innerWidth; },  
 184661: () => { return window.innerHeight; },  
 184688: () => { if (document.fullscreenElement) return 1; },  
 184734: () => { return document.getElementById('canvas').width; },  
 184786: () => { return screen.width; },  
 184811: () => { document.exitFullscreen(); },  
 184838: () => { if (document.fullscreenElement) return 1; },  
 184884: () => { return document.getElementById('canvas').width; },  
 184936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 185004: () => { document.exitFullscreen(); },  
 185031: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 185089: () => { return screen.width; },  
 185114: () => { return screen.height; },  
 185140: () => { return window.screenX; },  
 185167: () => { return window.screenY; },  
 185194: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 185247: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 185318: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 185375: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 185631: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 185702: () => { if (document.fullscreenElement) return 1; },  
 185748: () => { return window.innerWidth; },  
 185774: () => { return window.innerHeight; },  
 185801: () => { if (document.pointerLockElement) return 1; }
};
