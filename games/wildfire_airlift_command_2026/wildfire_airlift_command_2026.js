...
var ASM_CONSTS = {
 ...
 263702: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263770: () => { document.exitFullscreen(); },  
 263797: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263870: () => { if (document.fullscreenElement) return 1; },  
 263916: () => { return document.getElementById('canvas').width; },  
 263968: () => { return screen.width; },  
 263993: () => { document.exitFullscreen(); },  
 264020: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264153: () => { return window.innerWidth; },  
 264179: () => { return window.innerHeight; },  
 264206: () => { if (document.fullscreenElement) return 1; },  
 264252: () => { return document.getElementById('canvas').width; },  
 264304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264495: () => { return window.innerWidth; },  
 264521: () => { return window.innerHeight; },  
 264548: () => { if (document.fullscreenElement) return 1; },  
 264594: () => { return document.getElementById('canvas').width; },  
 264646: () => { return screen.width; },  
 264671: () => { document.exitFullscreen(); },  
 264698: () => { if (document.fullscreenElement) return 1; },  
 264744: () => { return document.getElementById('canvas').width; },  
 264796: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264864: () => { document.exitFullscreen(); },  
 264891: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264949: () => { return screen.width; },  
 264974: () => { return screen.height; },  
 265000: () => { return window.screenX; },  
 265027: () => { return window.screenY; },  
 265054: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265107: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265178: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265235: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265491: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265562: () => { if (document.fullscreenElement) return 1; },  
 265608: () => { return window.innerWidth; },  
 265634: () => { return window.innerHeight; },  
 265661: () => { if (document.pointerLockElement) return 1; }
};
