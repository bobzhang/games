...
var ASM_CONSTS = {
 ...
 263670: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263738: () => { document.exitFullscreen(); },  
 263765: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263838: () => { if (document.fullscreenElement) return 1; },  
 263884: () => { return document.getElementById('canvas').width; },  
 263936: () => { return screen.width; },  
 263961: () => { document.exitFullscreen(); },  
 263988: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264121: () => { return window.innerWidth; },  
 264147: () => { return window.innerHeight; },  
 264174: () => { if (document.fullscreenElement) return 1; },  
 264220: () => { return document.getElementById('canvas').width; },  
 264272: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264340: () => { if (document.fullscreenElement) return 1; },  
 264386: () => { return document.getElementById('canvas').width; },  
 264438: () => { return screen.width; },  
 264463: () => { return window.innerWidth; },  
 264489: () => { return window.innerHeight; },  
 264516: () => { if (document.fullscreenElement) return 1; },  
 264562: () => { return document.getElementById('canvas').width; },  
 264614: () => { return screen.width; },  
 264639: () => { document.exitFullscreen(); },  
 264666: () => { if (document.fullscreenElement) return 1; },  
 264712: () => { return document.getElementById('canvas').width; },  
 264764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264832: () => { document.exitFullscreen(); },  
 264859: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264917: () => { return screen.width; },  
 264942: () => { return screen.height; },  
 264968: () => { return window.screenX; },  
 264995: () => { return window.screenY; },  
 265022: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265075: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265146: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265203: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265459: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265530: () => { if (document.fullscreenElement) return 1; },  
 265576: () => { return window.innerWidth; },  
 265602: () => { return window.innerHeight; },  
 265629: () => { if (document.pointerLockElement) return 1; }
};
