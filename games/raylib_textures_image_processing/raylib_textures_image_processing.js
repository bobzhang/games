...
function findWasmBinary() {
  return locateFile('raylib_textures_image_processing.wasm');
}
...
var ASM_CONSTS = {
  402320: () => { if (document.fullscreenElement) return 1; },  
 402366: () => { return document.getElementById('canvas').width; },  
 402418: () => { return parseInt(document.getElementById('canvas').style.width); },  
 402486: () => { document.exitFullscreen(); },  
 402513: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 402586: () => { if (document.fullscreenElement) return 1; },  
 402632: () => { return document.getElementById('canvas').width; },  
 402684: () => { return screen.width; },  
 402709: () => { document.exitFullscreen(); },  
 402736: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 402869: () => { return window.innerWidth; },  
 402895: () => { return window.innerHeight; },  
 402922: () => { if (document.fullscreenElement) return 1; },  
 402968: () => { return document.getElementById('canvas').width; },  
 403020: () => { return parseInt(document.getElementById('canvas').style.width); },  
 403088: () => { if (document.fullscreenElement) return 1; },  
 403134: () => { return document.getElementById('canvas').width; },  
 403186: () => { return screen.width; },  
 403211: () => { return window.innerWidth; },  
 403237: () => { return window.innerHeight; },  
 403264: () => { if (document.fullscreenElement) return 1; },  
 403310: () => { return document.getElementById('canvas').width; },  
 403362: () => { return screen.width; },  
 403387: () => { document.exitFullscreen(); },  
 403414: () => { if (document.fullscreenElement) return 1; },  
 403460: () => { return document.getElementById('canvas').width; },  
 403512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 403580: () => { document.exitFullscreen(); },  
 403607: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 403665: () => { return screen.width; },  
 403690: () => { return screen.height; },  
 403716: () => { return window.screenX; },  
 403743: () => { return window.screenY; },  
 403770: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 403823: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 403894: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 403951: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 404207: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 404278: () => { if (document.fullscreenElement) return 1; },  
 404324: () => { return window.innerWidth; },  
 404350: () => { return window.innerHeight; },  
 404377: () => { if (document.pointerLockElement) return 1; }
};
