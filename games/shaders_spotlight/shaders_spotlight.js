...
var ASM_CONSTS = {
  272516: () => { if (document.fullscreenElement) return 1; },  
 272562: () => { return document.getElementById('canvas').width; },  
 272614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272682: () => { document.exitFullscreen(); },  
 272709: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272782: () => { if (document.fullscreenElement) return 1; },  
 272828: () => { return document.getElementById('canvas').width; },  
 272880: () => { return screen.width; },  
 272905: () => { document.exitFullscreen(); },  
 272932: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273065: () => { return window.innerWidth; },  
 273091: () => { return window.innerHeight; },  
 273118: () => { if (document.fullscreenElement) return 1; },  
 273164: () => { return document.getElementById('canvas').width; },  
 273216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273284: () => { if (document.fullscreenElement) return 1; },  
 273330: () => { return document.getElementById('canvas').width; },  
 273382: () => { return screen.width; },  
 273407: () => { return window.innerWidth; },  
 273433: () => { return window.innerHeight; },  
 273460: () => { if (document.fullscreenElement) return 1; },  
 273506: () => { return document.getElementById('canvas').width; },  
 273558: () => { return screen.width; },  
 273583: () => { document.exitFullscreen(); },  
 273610: () => { if (document.fullscreenElement) return 1; },  
 273656: () => { return document.getElementById('canvas').width; },  
 273708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273776: () => { document.exitFullscreen(); },  
 273803: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273861: () => { return screen.width; },  
 273886: () => { return screen.height; },  
 273912: () => { return window.screenX; },  
 273939: () => { return window.screenY; },  
 273966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274019: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274090: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274403: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274474: () => { if (document.fullscreenElement) return 1; },  
 274520: () => { return window.innerWidth; },  
 274546: () => { return window.innerHeight; },  
 274573: () => { if (document.pointerLockElement) return 1; }
};
