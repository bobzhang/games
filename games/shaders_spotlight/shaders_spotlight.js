...
var ASM_CONSTS = {
  272532: () => { if (document.fullscreenElement) return 1; },  
 272578: () => { return document.getElementById('canvas').width; },  
 272630: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272698: () => { document.exitFullscreen(); },  
 272725: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272798: () => { if (document.fullscreenElement) return 1; },  
 272844: () => { return document.getElementById('canvas').width; },  
 272896: () => { return screen.width; },  
 272921: () => { document.exitFullscreen(); },  
 272948: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273081: () => { return window.innerWidth; },  
 273107: () => { return window.innerHeight; },  
 273134: () => { if (document.fullscreenElement) return 1; },  
 273180: () => { return document.getElementById('canvas').width; },  
 273232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273300: () => { if (document.fullscreenElement) return 1; },  
 273346: () => { return document.getElementById('canvas').width; },  
 273398: () => { return screen.width; },  
 273423: () => { return window.innerWidth; },  
 273449: () => { return window.innerHeight; },  
 ...
 273599: () => { document.exitFullscreen(); },  
 273626: () => { if (document.fullscreenElement) return 1; },  
 273672: () => { return document.getElementById('canvas').width; },  
 273724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273792: () => { document.exitFullscreen(); },  
 273819: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273877: () => { return screen.width; },  
 273902: () => { return screen.height; },  
 273928: () => { return window.screenX; },  
 273955: () => { return window.screenY; },  
 273982: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274035: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274106: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274163: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274419: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274490: () => { if (document.fullscreenElement) return 1; },  
 274536: () => { return window.innerWidth; },  
 274562: () => { return window.innerHeight; },  
 274589: () => { if (document.pointerLockElement) return 1; }
};
