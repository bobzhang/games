...
var ASM_CONSTS = {
  272308: () => { if (document.fullscreenElement) return 1; },  
 272354: () => { return document.getElementById('canvas').width; },  
 272406: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272474: () => { document.exitFullscreen(); },  
 272501: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272574: () => { if (document.fullscreenElement) return 1; },  
 272620: () => { return document.getElementById('canvas').width; },  
 272672: () => { return screen.width; },  
 272697: () => { document.exitFullscreen(); },  
 272724: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272857: () => { return window.innerWidth; },  
 272883: () => { return window.innerHeight; },  
 272910: () => { if (document.fullscreenElement) return 1; },  
 272956: () => { return document.getElementById('canvas').width; },  
 273008: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273076: () => { if (document.fullscreenElement) return 1; },  
 273122: () => { return document.getElementById('canvas').width; },  
 273174: () => { return screen.width; },  
 273199: () => { return window.innerWidth; },  
 273225: () => { return window.innerHeight; },  
 273252: () => { if (document.fullscreenElement) return 1; },  
 273298: () => { return document.getElementById('canvas').width; },  
 273350: () => { return screen.width; },  
 273375: () => { document.exitFullscreen(); },  
 273402: () => { if (document.fullscreenElement) return 1; },  
 273448: () => { return document.getElementById('canvas').width; },  
 273500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273568: () => { document.exitFullscreen(); },  
 273595: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273653: () => { return screen.width; },  
 273678: () => { return screen.height; },  
 273704: () => { return window.screenX; },  
 273731: () => { return window.screenY; },  
 273758: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273811: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273882: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 273939: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274195: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274266: () => { if (document.fullscreenElement) return 1; },  
 274312: () => { return window.innerWidth; },  
 274338: () => { return window.innerHeight; },  
 274365: () => { if (document.pointerLockElement) return 1; }
};
