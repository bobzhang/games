...
var ASM_CONSTS = {
  268764: () => { if (document.fullscreenElement) return 1; },  
 268810: () => { return document.getElementById('canvas').width; },  
 268862: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268930: () => { document.exitFullscreen(); },  
 268957: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269030: () => { if (document.fullscreenElement) return 1; },  
 269076: () => { return document.getElementById('canvas').width; },  
 269128: () => { return screen.width; },  
 269153: () => { document.exitFullscreen(); },  
 269180: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269313: () => { return window.innerWidth; },  
 269339: () => { return window.innerHeight; },  
 269366: () => { if (document.fullscreenElement) return 1; },  
 269412: () => { return document.getElementById('canvas').width; },  
 269464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269655: () => { return window.innerWidth; },  
 269681: () => { return window.innerHeight; },  
 269708: () => { if (document.fullscreenElement) return 1; },  
 269754: () => { return document.getElementById('canvas').width; },  
 269806: () => { return screen.width; },  
 269831: () => { document.exitFullscreen(); },  
