...
var ASM_CONSTS = {
 ...
 264198: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264266: () => { document.exitFullscreen(); },  
 264293: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264366: () => { if (document.fullscreenElement) return 1; },  
 264412: () => { return document.getElementById('canvas').width; },  
 264464: () => { return screen.width; },  
 264489: () => { document.exitFullscreen(); },  
 264516: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264649: () => { return window.innerWidth; },  
 264675: () => { return window.innerHeight; },  
 264702: () => { if (document.fullscreenElement) return 1; },  
 264748: () => { return document.getElementById('canvas').width; },  
 264800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264868: () => { if (document.fullscreenElement) return 1; },  
 264914: () => { return document.getElementById('canvas').width; },  
 264966: () => { return screen.width; },  
 264991: () => { return window.innerWidth; },  
 265017: () => { return window.innerHeight; },  
 ...
 265167: () => { document.exitFullscreen(); },  
 265194: () => { if (document.fullscreenElement) return 1; },  
 265240: () => { return document.getElementById('canvas').width; },  
 265292: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265360: () => { document.exitFullscreen(); },  
 265387: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265445: () => { return screen.width; },  
 265470: () => { return screen.height; },  
 265496: () => { return window.screenX; },  
 265523: () => { return window.screenY; },  
 265550: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265603: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265674: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265731: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265987: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266058: () => { if (document.fullscreenElement) return 1; },  
 266104: () => { return window.innerWidth; },  
 266130: () => { return window.innerHeight; },  
 266157: () => { if (document.pointerLockElement) return 1; }
};
