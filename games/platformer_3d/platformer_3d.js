...
var ASM_CONSTS = {
 ...
 264422: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264490: () => { document.exitFullscreen(); },  
 264517: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264590: () => { if (document.fullscreenElement) return 1; },  
 264636: () => { return document.getElementById('canvas').width; },  
 264688: () => { return screen.width; },  
 264713: () => { document.exitFullscreen(); },  
 264740: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264873: () => { return window.innerWidth; },  
 264899: () => { return window.innerHeight; },  
 264926: () => { if (document.fullscreenElement) return 1; },  
 264972: () => { return document.getElementById('canvas').width; },  
 265024: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 265215: () => { return window.innerWidth; },  
 265241: () => { return window.innerHeight; },  
 265268: () => { if (document.fullscreenElement) return 1; },  
 265314: () => { return document.getElementById('canvas').width; },  
 265366: () => { return screen.width; },  
 265391: () => { document.exitFullscreen(); },  
 265418: () => { if (document.fullscreenElement) return 1; },  
 265464: () => { return document.getElementById('canvas').width; },  
 265516: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265584: () => { document.exitFullscreen(); },  
 265611: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265669: () => { return screen.width; },  
 265694: () => { return screen.height; },  
 265720: () => { return window.screenX; },  
 265747: () => { return window.screenY; },  
 265774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265827: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265898: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265955: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266211: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266282: () => { if (document.fullscreenElement) return 1; },  
 266328: () => { return window.innerWidth; },  
 266354: () => { return window.innerHeight; },  
 266381: () => { if (document.pointerLockElement) return 1; }
};
