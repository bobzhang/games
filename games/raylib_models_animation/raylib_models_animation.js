...
function findWasmBinary() {
  return locateFile('raylib_models_animation.wasm');
}
...
var ASM_CONSTS = {
  109632: () => { if (document.fullscreenElement) return 1; },  
 109678: () => { return document.getElementById('canvas').width; },  
 109730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109798: () => { document.exitFullscreen(); },  
 109825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109898: () => { if (document.fullscreenElement) return 1; },  
 109944: () => { return document.getElementById('canvas').width; },  
 109996: () => { return screen.width; },  
 110021: () => { document.exitFullscreen(); },  
 110048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 110181: () => { return window.innerWidth; },  
 110207: () => { return window.innerHeight; },  
 110234: () => { if (document.fullscreenElement) return 1; },  
 110280: () => { return document.getElementById('canvas').width; },  
 110332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110400: () => { if (document.fullscreenElement) return 1; },  
 110446: () => { return document.getElementById('canvas').width; },  
 110498: () => { return screen.width; },  
 110523: () => { return window.innerWidth; },  
 110549: () => { return window.innerHeight; },  
 110576: () => { if (document.fullscreenElement) return 1; },  
 110622: () => { return document.getElementById('canvas').width; },  
 110674: () => { return screen.width; },  
 110699: () => { document.exitFullscreen(); },  
 110726: () => { if (document.fullscreenElement) return 1; },  
 110772: () => { return document.getElementById('canvas').width; },  
 110824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110892: () => { document.exitFullscreen(); },  
 110919: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 110977: () => { return screen.width; },  
 111002: () => { return screen.height; },  
 111028: () => { return window.screenX; },  
 111055: () => { return window.screenY; },  
 111082: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 111135: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111206: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111263: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 111519: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111590: () => { if (document.fullscreenElement) return 1; },  
 111636: () => { return window.innerWidth; },  
 111662: () => { return window.innerHeight; },  
 111689: () => { if (document.pointerLockElement) return 1; }
};
