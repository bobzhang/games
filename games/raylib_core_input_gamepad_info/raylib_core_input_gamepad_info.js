...
function findWasmBinary() {
  return locateFile('raylib_core_input_gamepad_info.wasm');
}
...
var ASM_CONSTS = {
 ...
 98434: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98502: () => { document.exitFullscreen(); },  
 98529: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98602: () => { if (document.fullscreenElement) return 1; },  
 98648: () => { return document.getElementById('canvas').width; },  
 98700: () => { return screen.width; },  
 98725: () => { document.exitFullscreen(); },  
 98752: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98885: () => { return window.innerWidth; },  
 98911: () => { return window.innerHeight; },  
 98938: () => { if (document.fullscreenElement) return 1; },  
 98984: () => { return document.getElementById('canvas').width; },  
 99036: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99104: () => { if (document.fullscreenElement) return 1; },  
 99150: () => { return document.getElementById('canvas').width; },  
 99202: () => { return screen.width; },  
 99227: () => { return window.innerWidth; },  
 99253: () => { return window.innerHeight; },  
 99280: () => { if (document.fullscreenElement) return 1; },  
 99326: () => { return document.getElementById('canvas').width; },  
 99378: () => { return screen.width; },  
 99403: () => { document.exitFullscreen(); },  
 99430: () => { if (document.fullscreenElement) return 1; },  
 99476: () => { return document.getElementById('canvas').width; },  
 99528: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99596: () => { document.exitFullscreen(); },  
 99623: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99681: () => { return screen.width; },  
 99706: () => { return screen.height; },  
 99732: () => { return window.screenX; },  
 99759: () => { return window.screenY; },  
 99786: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99839: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99910: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99967: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100223: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100294: () => { if (document.fullscreenElement) return 1; },  
 100340: () => { return window.innerWidth; },  
 100366: () => { return window.innerHeight; },  
 100393: () => { if (document.pointerLockElement) return 1; }
};
