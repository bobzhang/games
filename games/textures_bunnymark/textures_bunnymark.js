...
var ASM_CONSTS = {
 ...
 265046: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265114: () => { document.exitFullscreen(); },  
 265141: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265214: () => { if (document.fullscreenElement) return 1; },  
 265260: () => { return document.getElementById('canvas').width; },  
 265312: () => { return screen.width; },  
 265337: () => { document.exitFullscreen(); },  
 265364: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265497: () => { return window.innerWidth; },  
 265523: () => { return window.innerHeight; },  
 265550: () => { if (document.fullscreenElement) return 1; },  
 265596: () => { return document.getElementById('canvas').width; },  
 265648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265716: () => { if (document.fullscreenElement) return 1; },  
 265762: () => { return document.getElementById('canvas').width; },  
 265814: () => { return screen.width; },  
 265839: () => { return window.innerWidth; },  
 265865: () => { return window.innerHeight; },  
 265892: () => { if (document.fullscreenElement) return 1; },  
 265938: () => { return document.getElementById('canvas').width; },  
 265990: () => { return screen.width; },  
 266015: () => { document.exitFullscreen(); },  
 266042: () => { if (document.fullscreenElement) return 1; },  
 266088: () => { return document.getElementById('canvas').width; },  
 266140: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266208: () => { document.exitFullscreen(); },  
 266235: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266293: () => { return screen.width; },  
 266318: () => { return screen.height; },  
 266344: () => { return window.screenX; },  
 266371: () => { return window.screenY; },  
 266398: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266451: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266522: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266579: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266835: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266906: () => { if (document.fullscreenElement) return 1; },  
 266952: () => { return window.innerWidth; },  
 266978: () => { return window.innerHeight; },  
 267005: () => { if (document.pointerLockElement) return 1; }
};
