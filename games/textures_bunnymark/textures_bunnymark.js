...
var ASM_CONSTS = {
 ...
 264838: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264906: () => { document.exitFullscreen(); },  
 264933: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265006: () => { if (document.fullscreenElement) return 1; },  
 265052: () => { return document.getElementById('canvas').width; },  
 265104: () => { return screen.width; },  
 265129: () => { document.exitFullscreen(); },  
 265156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265289: () => { return window.innerWidth; },  
 265315: () => { return window.innerHeight; },  
 265342: () => { if (document.fullscreenElement) return 1; },  
 265388: () => { return document.getElementById('canvas').width; },  
 265440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265508: () => { if (document.fullscreenElement) return 1; },  
 265554: () => { return document.getElementById('canvas').width; },  
 265606: () => { return screen.width; },  
 265631: () => { return window.innerWidth; },  
 265657: () => { return window.innerHeight; },  
 265684: () => { if (document.fullscreenElement) return 1; },  
 265730: () => { return document.getElementById('canvas').width; },  
 265782: () => { return screen.width; },  
 265807: () => { document.exitFullscreen(); },  
 265834: () => { if (document.fullscreenElement) return 1; },  
 265880: () => { return document.getElementById('canvas').width; },  
 265932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266000: () => { document.exitFullscreen(); },  
 266027: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266085: () => { return screen.width; },  
 266110: () => { return screen.height; },  
 266136: () => { return window.screenX; },  
 266163: () => { return window.screenY; },  
 266190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266371: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266627: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266698: () => { if (document.fullscreenElement) return 1; },  
 266744: () => { return window.innerWidth; },  
 266770: () => { return window.innerHeight; },  
 266797: () => { if (document.pointerLockElement) return 1; }
};
