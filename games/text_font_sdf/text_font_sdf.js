...
var ASM_CONSTS = {
  415780: () => { if (document.fullscreenElement) return 1; },  
 415826: () => { return document.getElementById('canvas').width; },  
 415878: () => { return parseInt(document.getElementById('canvas').style.width); },  
 415946: () => { document.exitFullscreen(); },  
 415973: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 416046: () => { if (document.fullscreenElement) return 1; },  
 416092: () => { return document.getElementById('canvas').width; },  
 416144: () => { return screen.width; },  
 416169: () => { document.exitFullscreen(); },  
 416196: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 416329: () => { return window.innerWidth; },  
 416355: () => { return window.innerHeight; },  
 416382: () => { if (document.fullscreenElement) return 1; },  
 416428: () => { return document.getElementById('canvas').width; },  
 416480: () => { return parseInt(document.getElementById('canvas').style.width); },  
 416548: () => { if (document.fullscreenElement) return 1; },  
 416594: () => { return document.getElementById('canvas').width; },  
 416646: () => { return screen.width; },  
 416671: () => { return window.innerWidth; },  
 416697: () => { return window.innerHeight; },  
 416724: () => { if (document.fullscreenElement) return 1; },  
 416770: () => { return document.getElementById('canvas').width; },  
 416822: () => { return screen.width; },  
 416847: () => { document.exitFullscreen(); },  
 416874: () => { if (document.fullscreenElement) return 1; },  
 416920: () => { return document.getElementById('canvas').width; },  
 416972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 417040: () => { document.exitFullscreen(); },  
 417067: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 417125: () => { return screen.width; },  
 417150: () => { return screen.height; },  
 417176: () => { return window.screenX; },  
 417203: () => { return window.screenY; },  
 417230: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 417283: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 417354: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 417411: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 417667: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 417738: () => { if (document.fullscreenElement) return 1; },  
 417784: () => { return window.innerWidth; },  
 417810: () => { return window.innerHeight; },  
 417837: () => { if (document.pointerLockElement) return 1; }
};
