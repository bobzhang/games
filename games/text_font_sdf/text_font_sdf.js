...
var ASM_CONSTS = {
  415972: () => { if (document.fullscreenElement) return 1; },  
 416018: () => { return document.getElementById('canvas').width; },  
 416070: () => { return parseInt(document.getElementById('canvas').style.width); },  
 416138: () => { document.exitFullscreen(); },  
 416165: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 416238: () => { if (document.fullscreenElement) return 1; },  
 416284: () => { return document.getElementById('canvas').width; },  
 416336: () => { return screen.width; },  
 416361: () => { document.exitFullscreen(); },  
 416388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 416521: () => { return window.innerWidth; },  
 416547: () => { return window.innerHeight; },  
 416574: () => { if (document.fullscreenElement) return 1; },  
 416620: () => { return document.getElementById('canvas').width; },  
 416672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 416740: () => { if (document.fullscreenElement) return 1; },  
 416786: () => { return document.getElementById('canvas').width; },  
 416838: () => { return screen.width; },  
 416863: () => { return window.innerWidth; },  
 416889: () => { return window.innerHeight; },  
 416916: () => { if (document.fullscreenElement) return 1; },  
 416962: () => { return document.getElementById('canvas').width; },  
 417014: () => { return screen.width; },  
 417039: () => { document.exitFullscreen(); },  
 417066: () => { if (document.fullscreenElement) return 1; },  
 417112: () => { return document.getElementById('canvas').width; },  
 417164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 417232: () => { document.exitFullscreen(); },  
 417259: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 417317: () => { return screen.width; },  
 417342: () => { return screen.height; },  
 417368: () => { return window.screenX; },  
 417395: () => { return window.screenY; },  
 417422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 417475: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 417546: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 417603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 417859: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 417930: () => { if (document.fullscreenElement) return 1; },  
 417976: () => { return window.innerWidth; },  
 418002: () => { return window.innerHeight; },  
 418029: () => { if (document.pointerLockElement) return 1; }
};
