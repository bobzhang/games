...
var ASM_CONSTS = {
 ...
 262150: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262218: () => { document.exitFullscreen(); },  
 262245: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262318: () => { if (document.fullscreenElement) return 1; },  
 262364: () => { return document.getElementById('canvas').width; },  
 262416: () => { return screen.width; },  
 262441: () => { document.exitFullscreen(); },  
 262468: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262601: () => { return window.innerWidth; },  
 262627: () => { return window.innerHeight; },  
 262654: () => { if (document.fullscreenElement) return 1; },  
 262700: () => { return document.getElementById('canvas').width; },  
 262752: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262820: () => { if (document.fullscreenElement) return 1; },  
 262866: () => { return document.getElementById('canvas').width; },  
 262918: () => { return screen.width; },  
 262943: () => { return window.innerWidth; },  
 262969: () => { return window.innerHeight; },  
 ...
 263119: () => { document.exitFullscreen(); },  
 ...
 263312: () => { document.exitFullscreen(); },  
 263339: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263397: () => { return screen.width; },  
 263422: () => { return screen.height; },  
 263448: () => { return window.screenX; },  
 263475: () => { return window.screenY; },  
 263502: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263555: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263626: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263683: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263939: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264010: () => { if (document.fullscreenElement) return 1; },  
 264056: () => { return window.innerWidth; },  
 264082: () => { return window.innerHeight; },  
 264109: () => { if (document.pointerLockElement) return 1; }
};
