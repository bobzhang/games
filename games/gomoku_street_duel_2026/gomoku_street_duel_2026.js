...
var ASM_CONSTS = {
 ...
 261942: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262010: () => { document.exitFullscreen(); },  
 262037: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262110: () => { if (document.fullscreenElement) return 1; },  
 262156: () => { return document.getElementById('canvas').width; },  
 262208: () => { return screen.width; },  
 262233: () => { document.exitFullscreen(); },  
 262260: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262393: () => { return window.innerWidth; },  
 262419: () => { return window.innerHeight; },  
 262446: () => { if (document.fullscreenElement) return 1; },  
 262492: () => { return document.getElementById('canvas').width; },  
 262544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262612: () => { if (document.fullscreenElement) return 1; },  
 262658: () => { return document.getElementById('canvas').width; },  
 262710: () => { return screen.width; },  
 262735: () => { return window.innerWidth; },  
 262761: () => { return window.innerHeight; },  
 262788: () => { if (document.fullscreenElement) return 1; },  
 262834: () => { return document.getElementById('canvas').width; },  
 262886: () => { return screen.width; },  
 262911: () => { document.exitFullscreen(); },  
 ...
 263104: () => { document.exitFullscreen(); },  
 263131: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263189: () => { return screen.width; },  
 263214: () => { return screen.height; },  
 263240: () => { return window.screenX; },  
 263267: () => { return window.screenY; },  
 263294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263347: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263418: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263475: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263731: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263802: () => { if (document.fullscreenElement) return 1; },  
 263848: () => { return window.innerWidth; },  
 263874: () => { return window.innerHeight; },  
 263901: () => { if (document.pointerLockElement) return 1; }
};
