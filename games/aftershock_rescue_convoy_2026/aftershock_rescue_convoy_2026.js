...
var ASM_CONSTS = {
  263588: () => { if (document.fullscreenElement) return 1; },  
 263634: () => { return document.getElementById('canvas').width; },  
 263686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263754: () => { document.exitFullscreen(); },  
 263781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263854: () => { if (document.fullscreenElement) return 1; },  
 263900: () => { return document.getElementById('canvas').width; },  
 263952: () => { return screen.width; },  
 263977: () => { document.exitFullscreen(); },  
 264004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264137: () => { return window.innerWidth; },  
 264163: () => { return window.innerHeight; },  
 264190: () => { if (document.fullscreenElement) return 1; },  
 264236: () => { return document.getElementById('canvas').width; },  
 264288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264356: () => { if (document.fullscreenElement) return 1; },  
 264402: () => { return document.getElementById('canvas').width; },  
 264454: () => { return screen.width; },  
 264479: () => { return window.innerWidth; },  
 264505: () => { return window.innerHeight; },  
 264532: () => { if (document.fullscreenElement) return 1; },  
 264578: () => { return document.getElementById('canvas').width; },  
 264630: () => { return screen.width; },  
 264655: () => { document.exitFullscreen(); },  
 264682: () => { if (document.fullscreenElement) return 1; },  
 264728: () => { return document.getElementById('canvas').width; },  
 264780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264848: () => { document.exitFullscreen(); },  
 264875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264933: () => { return screen.width; },  
 264958: () => { return screen.height; },  
 264984: () => { return window.screenX; },  
 265011: () => { return window.screenY; },  
 265038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265546: () => { if (document.fullscreenElement) return 1; },  
 265592: () => { return window.innerWidth; },  
 265618: () => { return window.innerHeight; },  
 265645: () => { if (document.pointerLockElement) return 1; }
};
