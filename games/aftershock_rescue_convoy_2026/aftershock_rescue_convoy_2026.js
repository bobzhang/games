...
var ASM_CONSTS = {
  263380: () => { if (document.fullscreenElement) return 1; },  
 263426: () => { return document.getElementById('canvas').width; },  
 263478: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263546: () => { document.exitFullscreen(); },  
 263573: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263646: () => { if (document.fullscreenElement) return 1; },  
 263692: () => { return document.getElementById('canvas').width; },  
 263744: () => { return screen.width; },  
 263769: () => { document.exitFullscreen(); },  
 263796: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263929: () => { return window.innerWidth; },  
 263955: () => { return window.innerHeight; },  
 263982: () => { if (document.fullscreenElement) return 1; },  
 264028: () => { return document.getElementById('canvas').width; },  
 264080: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264148: () => { if (document.fullscreenElement) return 1; },  
 264194: () => { return document.getElementById('canvas').width; },  
 264246: () => { return screen.width; },  
 264271: () => { return window.innerWidth; },  
 264297: () => { return window.innerHeight; },  
 264324: () => { if (document.fullscreenElement) return 1; },  
 264370: () => { return document.getElementById('canvas').width; },  
 264422: () => { return screen.width; },  
 264447: () => { document.exitFullscreen(); },  
 264474: () => { if (document.fullscreenElement) return 1; },  
 264520: () => { return document.getElementById('canvas').width; },  
 264572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264640: () => { document.exitFullscreen(); },  
 264667: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264725: () => { return screen.width; },  
 264750: () => { return screen.height; },  
 264776: () => { return window.screenX; },  
 264803: () => { return window.screenY; },  
 264830: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264883: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264954: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265011: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265267: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265338: () => { if (document.fullscreenElement) return 1; },  
 265384: () => { return window.innerWidth; },  
 265410: () => { return window.innerHeight; },  
 265437: () => { if (document.pointerLockElement) return 1; }
};
