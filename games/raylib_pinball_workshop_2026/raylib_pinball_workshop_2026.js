...
var ASM_CONSTS = {
  97248: () => { if (document.fullscreenElement) return 1; },  
 97294: () => { return document.getElementById('canvas').width; },  
 97346: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97414: () => { document.exitFullscreen(); },  
 97441: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97514: () => { if (document.fullscreenElement) return 1; },  
 97560: () => { return document.getElementById('canvas').width; },  
 97612: () => { return screen.width; },  
 97637: () => { document.exitFullscreen(); },  
 97664: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97797: () => { return window.innerWidth; },  
 97823: () => { return window.innerHeight; },  
 97850: () => { if (document.fullscreenElement) return 1; },  
 97896: () => { return document.getElementById('canvas').width; },  
 97948: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98016: () => { if (document.fullscreenElement) return 1; },  
 98062: () => { return document.getElementById('canvas').width; },  
 98114: () => { return screen.width; },  
 98139: () => { return window.innerWidth; },  
 98165: () => { return window.innerHeight; },  
 98192: () => { if (document.fullscreenElement) return 1; },  
 98238: () => { return document.getElementById('canvas').width; },  
 98290: () => { return screen.width; },  
 98315: () => { document.exitFullscreen(); },  
 98342: () => { if (document.fullscreenElement) return 1; },  
 98388: () => { return document.getElementById('canvas').width; },  
 98440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98508: () => { document.exitFullscreen(); },  
 98535: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98593: () => { return screen.width; },  
 98618: () => { return screen.height; },  
 98644: () => { return window.screenX; },  
 98671: () => { return window.screenY; },  
 98698: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98751: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98822: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98879: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99135: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99206: () => { if (document.fullscreenElement) return 1; },  
 99252: () => { return window.innerWidth; },  
 99278: () => { return window.innerHeight; },  
 99305: () => { if (document.pointerLockElement) return 1; }
};
