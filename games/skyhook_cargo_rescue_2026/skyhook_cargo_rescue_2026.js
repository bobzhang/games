...
var ASM_CONSTS = {
 ...
 269278: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269346: () => { document.exitFullscreen(); },  
 269373: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269446: () => { if (document.fullscreenElement) return 1; },  
 269492: () => { return document.getElementById('canvas').width; },  
 269544: () => { return screen.width; },  
 269569: () => { document.exitFullscreen(); },  
 269596: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269729: () => { return window.innerWidth; },  
 269755: () => { return window.innerHeight; },  
 269782: () => { if (document.fullscreenElement) return 1; },  
 269828: () => { return document.getElementById('canvas').width; },  
 269880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 270071: () => { return window.innerWidth; },  
 270097: () => { return window.innerHeight; },  
 270124: () => { if (document.fullscreenElement) return 1; },  
 270170: () => { return document.getElementById('canvas').width; },  
 270222: () => { return screen.width; },  
 270247: () => { document.exitFullscreen(); },  
 270274: () => { if (document.fullscreenElement) return 1; },  
 270320: () => { return document.getElementById('canvas').width; },  
 270372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270440: () => { document.exitFullscreen(); },  
 270467: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270525: () => { return screen.width; },  
 270550: () => { return screen.height; },  
 270576: () => { return window.screenX; },  
 270603: () => { return window.screenY; },  
 270630: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270683: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270754: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271067: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271138: () => { if (document.fullscreenElement) return 1; },  
 271184: () => { return window.innerWidth; },  
 271210: () => { return window.innerHeight; },  
 271237: () => { if (document.pointerLockElement) return 1; },  
