...
var ASM_CONSTS = {
 ...
 269274: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269342: () => { document.exitFullscreen(); },  
 269369: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269442: () => { if (document.fullscreenElement) return 1; },  
 269488: () => { return document.getElementById('canvas').width; },  
 269540: () => { return screen.width; },  
 269565: () => { document.exitFullscreen(); },  
 269592: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269725: () => { return window.innerWidth; },  
 269751: () => { return window.innerHeight; },  
 269778: () => { if (document.fullscreenElement) return 1; },  
 269824: () => { return document.getElementById('canvas').width; },  
 269876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 270067: () => { return window.innerWidth; },  
 270093: () => { return window.innerHeight; },  
 270120: () => { if (document.fullscreenElement) return 1; },  
 270166: () => { return document.getElementById('canvas').width; },  
 270218: () => { return screen.width; },  
 270243: () => { document.exitFullscreen(); },  
 270270: () => { if (document.fullscreenElement) return 1; },  
 270316: () => { return document.getElementById('canvas').width; },  
 270368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270436: () => { document.exitFullscreen(); },  
 270463: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270521: () => { return screen.width; },  
 270546: () => { return screen.height; },  
 270572: () => { return window.screenX; },  
 270599: () => { return window.screenY; },  
 270626: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270679: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270750: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270807: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271063: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 ...
 277164: ($0) => { miniaudio.untrack_device_by_index($0); },  
 277207: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 277332: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
