...
var ASM_CONSTS = {
  272548: () => { if (document.fullscreenElement) return 1; },  
 272594: () => { return document.getElementById('canvas').width; },  
 272646: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272714: () => { document.exitFullscreen(); },  
 272741: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272814: () => { if (document.fullscreenElement) return 1; },  
 272860: () => { return document.getElementById('canvas').width; },  
 272912: () => { return screen.width; },  
 272937: () => { document.exitFullscreen(); },  
 272964: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273097: () => { return window.innerWidth; },  
 273123: () => { return window.innerHeight; },  
 273150: () => { if (document.fullscreenElement) return 1; },  
 273196: () => { return document.getElementById('canvas').width; },  
 273248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273316: () => { if (document.fullscreenElement) return 1; },  
 273362: () => { return document.getElementById('canvas').width; },  
 273414: () => { return screen.width; },  
 273439: () => { return window.innerWidth; },  
 273465: () => { return window.innerHeight; },  
 273492: () => { if (document.fullscreenElement) return 1; },  
 273538: () => { return document.getElementById('canvas').width; },  
 273590: () => { return screen.width; },  
 273615: () => { document.exitFullscreen(); },  
 273642: () => { if (document.fullscreenElement) return 1; },  
 273688: () => { return document.getElementById('canvas').width; },  
 273740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273808: () => { document.exitFullscreen(); },  
 273835: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273893: () => { return screen.width; },  
 273918: () => { return screen.height; },  
 273944: () => { return window.screenX; },  
 273971: () => { return window.screenY; },  
 273998: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274051: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274122: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274179: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274435: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274506: () => { if (document.fullscreenElement) return 1; },  
 274552: () => { return window.innerWidth; },  
 274578: () => { return window.innerHeight; },  
 274605: () => { if (document.pointerLockElement) return 1; }
};
