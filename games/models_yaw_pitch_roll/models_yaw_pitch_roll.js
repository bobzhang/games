...
var ASM_CONSTS = {
  272564: () => { if (document.fullscreenElement) return 1; },  
 272610: () => { return document.getElementById('canvas').width; },  
 272662: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272730: () => { document.exitFullscreen(); },  
 272757: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272830: () => { if (document.fullscreenElement) return 1; },  
 272876: () => { return document.getElementById('canvas').width; },  
 272928: () => { return screen.width; },  
 272953: () => { document.exitFullscreen(); },  
 272980: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273113: () => { return window.innerWidth; },  
 273139: () => { return window.innerHeight; },  
 273166: () => { if (document.fullscreenElement) return 1; },  
 273212: () => { return document.getElementById('canvas').width; },  
 273264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273332: () => { if (document.fullscreenElement) return 1; },  
 273378: () => { return document.getElementById('canvas').width; },  
 273430: () => { return screen.width; },  
 273455: () => { return window.innerWidth; },  
 273481: () => { return window.innerHeight; },  
 273508: () => { if (document.fullscreenElement) return 1; },  
 273554: () => { return document.getElementById('canvas').width; },  
 273606: () => { return screen.width; },  
 273631: () => { document.exitFullscreen(); },  
 273658: () => { if (document.fullscreenElement) return 1; },  
 273704: () => { return document.getElementById('canvas').width; },  
 273756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273824: () => { document.exitFullscreen(); },  
 273851: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273909: () => { return screen.width; },  
 273934: () => { return screen.height; },  
 273960: () => { return window.screenX; },  
 273987: () => { return window.screenY; },  
 274014: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274067: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274138: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274195: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274451: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274522: () => { if (document.fullscreenElement) return 1; },  
 274568: () => { return window.innerWidth; },  
 274594: () => { return window.innerHeight; },  
 274621: () => { if (document.pointerLockElement) return 1; }
};
