...
var ASM_CONSTS = {
  272340: () => { if (document.fullscreenElement) return 1; },  
 272386: () => { return document.getElementById('canvas').width; },  
 272438: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272506: () => { document.exitFullscreen(); },  
 272533: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272606: () => { if (document.fullscreenElement) return 1; },  
 272652: () => { return document.getElementById('canvas').width; },  
 272704: () => { return screen.width; },  
 272729: () => { document.exitFullscreen(); },  
 272756: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272889: () => { return window.innerWidth; },  
 272915: () => { return window.innerHeight; },  
 272942: () => { if (document.fullscreenElement) return 1; },  
 272988: () => { return document.getElementById('canvas').width; },  
 273040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273108: () => { if (document.fullscreenElement) return 1; },  
 273154: () => { return document.getElementById('canvas').width; },  
 273206: () => { return screen.width; },  
 273231: () => { return window.innerWidth; },  
 273257: () => { return window.innerHeight; },  
 ...
 273407: () => { document.exitFullscreen(); },  
 273434: () => { if (document.fullscreenElement) return 1; },  
 273480: () => { return document.getElementById('canvas').width; },  
 273532: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273600: () => { document.exitFullscreen(); },  
 273627: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273685: () => { return screen.width; },  
 273710: () => { return screen.height; },  
 273736: () => { return window.screenX; },  
 273763: () => { return window.screenY; },  
 273790: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273843: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273914: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 273971: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274227: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274298: () => { if (document.fullscreenElement) return 1; },  
 274344: () => { return window.innerWidth; },  
 274370: () => { return window.innerHeight; },  
 274397: () => { if (document.pointerLockElement) return 1; }
};
