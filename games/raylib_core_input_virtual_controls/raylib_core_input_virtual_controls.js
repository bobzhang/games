...
function findWasmBinary() {
  return locateFile('raylib_core_input_virtual_controls.wasm');
}
...
var ASM_CONSTS = {
  96928: () => { if (document.fullscreenElement) return 1; },  
 96974: () => { return document.getElementById('canvas').width; },  
 97026: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97094: () => { document.exitFullscreen(); },  
 97121: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97194: () => { if (document.fullscreenElement) return 1; },  
 97240: () => { return document.getElementById('canvas').width; },  
 97292: () => { return screen.width; },  
 97317: () => { document.exitFullscreen(); },  
 97344: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97477: () => { return window.innerWidth; },  
 97503: () => { return window.innerHeight; },  
 97530: () => { if (document.fullscreenElement) return 1; },  
 97576: () => { return document.getElementById('canvas').width; },  
 97628: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97696: () => { if (document.fullscreenElement) return 1; },  
 97742: () => { return document.getElementById('canvas').width; },  
 97794: () => { return screen.width; },  
 97819: () => { return window.innerWidth; },  
 97845: () => { return window.innerHeight; },  
 97872: () => { if (document.fullscreenElement) return 1; },  
 97918: () => { return document.getElementById('canvas').width; },  
 97970: () => { return screen.width; },  
 97995: () => { document.exitFullscreen(); },  
 98022: () => { if (document.fullscreenElement) return 1; },  
 98068: () => { return document.getElementById('canvas').width; },  
 98120: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98188: () => { document.exitFullscreen(); },  
 98215: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98273: () => { return screen.width; },  
 98298: () => { return screen.height; },  
 98324: () => { return window.screenX; },  
 98351: () => { return window.screenY; },  
 98378: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98431: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98502: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98559: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98815: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98886: () => { if (document.fullscreenElement) return 1; },  
 98932: () => { return window.innerWidth; },  
 98958: () => { return window.innerHeight; },  
 98985: () => { if (document.pointerLockElement) return 1; }
};
