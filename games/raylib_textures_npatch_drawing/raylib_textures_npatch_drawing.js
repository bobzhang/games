...
function findWasmBinary() {
  return locateFile('raylib_textures_npatch_drawing.wasm');
}
...
var ASM_CONSTS = {
  107024: () => { if (document.fullscreenElement) return 1; },  
 107070: () => { return document.getElementById('canvas').width; },  
 107122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107190: () => { document.exitFullscreen(); },  
 107217: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107290: () => { if (document.fullscreenElement) return 1; },  
 107336: () => { return document.getElementById('canvas').width; },  
 107388: () => { return screen.width; },  
 107413: () => { document.exitFullscreen(); },  
 107440: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107573: () => { return window.innerWidth; },  
 107599: () => { return window.innerHeight; },  
 107626: () => { if (document.fullscreenElement) return 1; },  
 107672: () => { return document.getElementById('canvas').width; },  
 107724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107792: () => { if (document.fullscreenElement) return 1; },  
 107838: () => { return document.getElementById('canvas').width; },  
 107890: () => { return screen.width; },  
 107915: () => { return window.innerWidth; },  
 107941: () => { return window.innerHeight; },  
 107968: () => { if (document.fullscreenElement) return 1; },  
 108014: () => { return document.getElementById('canvas').width; },  
 108066: () => { return screen.width; },  
 108091: () => { document.exitFullscreen(); },  
 108118: () => { if (document.fullscreenElement) return 1; },  
 108164: () => { return document.getElementById('canvas').width; },  
 108216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108284: () => { document.exitFullscreen(); },  
 108311: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108369: () => { return screen.width; },  
 108394: () => { return screen.height; },  
 108420: () => { return window.screenX; },  
 108447: () => { return window.screenY; },  
 108474: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108527: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108598: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108655: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108911: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108982: () => { if (document.fullscreenElement) return 1; },  
 109028: () => { return window.innerWidth; },  
 109054: () => { return window.innerHeight; },  
 109081: () => { if (document.pointerLockElement) return 1; }
};
