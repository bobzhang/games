...
var ASM_CONSTS = {
  260564: () => { if (document.fullscreenElement) return 1; },  
 260610: () => { return document.getElementById('canvas').width; },  
 260662: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260730: () => { document.exitFullscreen(); },  
 260757: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260830: () => { if (document.fullscreenElement) return 1; },  
 260876: () => { return document.getElementById('canvas').width; },  
 260928: () => { return screen.width; },  
 260953: () => { document.exitFullscreen(); },  
 260980: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261113: () => { return window.innerWidth; },  
 261139: () => { return window.innerHeight; },  
 261166: () => { if (document.fullscreenElement) return 1; },  
 261212: () => { return document.getElementById('canvas').width; },  
 261264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261332: () => { if (document.fullscreenElement) return 1; },  
 261378: () => { return document.getElementById('canvas').width; },  
 261430: () => { return screen.width; },  
 261455: () => { return window.innerWidth; },  
 261481: () => { return window.innerHeight; },  
 ...
 261631: () => { document.exitFullscreen(); },  
 ...
 261824: () => { document.exitFullscreen(); },  
 261851: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261909: () => { return screen.width; },  
 261934: () => { return screen.height; },  
 261960: () => { return window.screenX; },  
 261987: () => { return window.screenY; },  
 262014: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262067: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262138: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262195: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262451: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262522: () => { if (document.fullscreenElement) return 1; },  
 262568: () => { return window.innerWidth; },  
 262594: () => { return window.innerHeight; },  
 262621: () => { if (document.pointerLockElement) return 1; }
};
