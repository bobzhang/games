...
var ASM_CONSTS = {
  260372: () => { if (document.fullscreenElement) return 1; },  
 260418: () => { return document.getElementById('canvas').width; },  
 260470: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260538: () => { document.exitFullscreen(); },  
 260565: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260638: () => { if (document.fullscreenElement) return 1; },  
 260684: () => { return document.getElementById('canvas').width; },  
 260736: () => { return screen.width; },  
 260761: () => { document.exitFullscreen(); },  
 260788: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260921: () => { return window.innerWidth; },  
 260947: () => { return window.innerHeight; },  
 260974: () => { if (document.fullscreenElement) return 1; },  
 261020: () => { return document.getElementById('canvas').width; },  
 261072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261140: () => { if (document.fullscreenElement) return 1; },  
 261186: () => { return document.getElementById('canvas').width; },  
 261238: () => { return screen.width; },  
 261263: () => { return window.innerWidth; },  
 261289: () => { return window.innerHeight; },  
 261316: () => { if (document.fullscreenElement) return 1; },  
 261362: () => { return document.getElementById('canvas').width; },  
 261414: () => { return screen.width; },  
 261439: () => { document.exitFullscreen(); },  
 261466: () => { if (document.fullscreenElement) return 1; },  
 261512: () => { return document.getElementById('canvas').width; },  
 261564: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261632: () => { document.exitFullscreen(); },  
 261659: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261717: () => { return screen.width; },  
 261742: () => { return screen.height; },  
 261768: () => { return window.screenX; },  
 261795: () => { return window.screenY; },  
 261822: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261875: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 261946: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262003: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262259: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262330: () => { if (document.fullscreenElement) return 1; },  
 262376: () => { return window.innerWidth; },  
 262402: () => { return window.innerHeight; },  
 262429: () => { if (document.pointerLockElement) return 1; }
};
