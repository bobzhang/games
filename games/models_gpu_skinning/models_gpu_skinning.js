...
var ASM_CONSTS = {
  438692: () => { if (document.fullscreenElement) return 1; },  
 438738: () => { return document.getElementById('canvas').width; },  
 438790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 438858: () => { document.exitFullscreen(); },  
 438885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 438958: () => { if (document.fullscreenElement) return 1; },  
 439004: () => { return document.getElementById('canvas').width; },  
 439056: () => { return screen.width; },  
 439081: () => { document.exitFullscreen(); },  
 439108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 439241: () => { return window.innerWidth; },  
 439267: () => { return window.innerHeight; },  
 439294: () => { if (document.fullscreenElement) return 1; },  
 439340: () => { return document.getElementById('canvas').width; },  
 439392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 439460: () => { if (document.fullscreenElement) return 1; },  
 439506: () => { return document.getElementById('canvas').width; },  
 439558: () => { return screen.width; },  
 439583: () => { return window.innerWidth; },  
 439609: () => { return window.innerHeight; },  
 439636: () => { if (document.fullscreenElement) return 1; },  
 439682: () => { return document.getElementById('canvas').width; },  
 439734: () => { return screen.width; },  
 439759: () => { document.exitFullscreen(); },  
 439786: () => { if (document.fullscreenElement) return 1; },  
 439832: () => { return document.getElementById('canvas').width; },  
 439884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 439952: () => { document.exitFullscreen(); },  
 439979: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 440037: () => { return screen.width; },  
 440062: () => { return screen.height; },  
 440088: () => { return window.screenX; },  
 440115: () => { return window.screenY; },  
 440142: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 440195: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 440266: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 440323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 440579: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 440650: () => { if (document.fullscreenElement) return 1; },  
 440696: () => { return window.innerWidth; },  
 440722: () => { return window.innerHeight; },  
 440749: () => { if (document.pointerLockElement) return 1; }
};
