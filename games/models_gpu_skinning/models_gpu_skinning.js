...
var ASM_CONSTS = {
  438900: () => { if (document.fullscreenElement) return 1; },  
 438946: () => { return document.getElementById('canvas').width; },  
 438998: () => { return parseInt(document.getElementById('canvas').style.width); },  
 439066: () => { document.exitFullscreen(); },  
 439093: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 439166: () => { if (document.fullscreenElement) return 1; },  
 439212: () => { return document.getElementById('canvas').width; },  
 439264: () => { return screen.width; },  
 439289: () => { document.exitFullscreen(); },  
 439316: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 439449: () => { return window.innerWidth; },  
 439475: () => { return window.innerHeight; },  
 439502: () => { if (document.fullscreenElement) return 1; },  
 439548: () => { return document.getElementById('canvas').width; },  
 439600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 439668: () => { if (document.fullscreenElement) return 1; },  
 439714: () => { return document.getElementById('canvas').width; },  
 439766: () => { return screen.width; },  
 439791: () => { return window.innerWidth; },  
 439817: () => { return window.innerHeight; },  
 439844: () => { if (document.fullscreenElement) return 1; },  
 439890: () => { return document.getElementById('canvas').width; },  
 439942: () => { return screen.width; },  
 439967: () => { document.exitFullscreen(); },  
 439994: () => { if (document.fullscreenElement) return 1; },  
 440040: () => { return document.getElementById('canvas').width; },  
 440092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 440160: () => { document.exitFullscreen(); },  
 440187: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 440245: () => { return screen.width; },  
 440270: () => { return screen.height; },  
 440296: () => { return window.screenX; },  
 440323: () => { return window.screenY; },  
 440350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 440403: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 440474: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 440531: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 440787: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 440858: () => { if (document.fullscreenElement) return 1; },  
 440904: () => { return window.innerWidth; },  
 440930: () => { return window.innerHeight; },  
 440957: () => { if (document.pointerLockElement) return 1; }
};
