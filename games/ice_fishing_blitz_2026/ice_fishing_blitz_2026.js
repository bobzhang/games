...
var ASM_CONSTS = {
 ...
 269374: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269442: () => { document.exitFullscreen(); },  
 269469: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269542: () => { if (document.fullscreenElement) return 1; },  
 269588: () => { return document.getElementById('canvas').width; },  
 269640: () => { return screen.width; },  
 269665: () => { document.exitFullscreen(); },  
 269692: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269825: () => { return window.innerWidth; },  
 269851: () => { return window.innerHeight; },  
 269878: () => { if (document.fullscreenElement) return 1; },  
 269924: () => { return document.getElementById('canvas').width; },  
 269976: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270044: () => { if (document.fullscreenElement) return 1; },  
 270090: () => { return document.getElementById('canvas').width; },  
 270142: () => { return screen.width; },  
 270167: () => { return window.innerWidth; },  
 270193: () => { return window.innerHeight; },  
