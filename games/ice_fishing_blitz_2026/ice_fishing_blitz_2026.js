...
var ASM_CONSTS = {
  269288: () => { if (document.fullscreenElement) return 1; },  
 269334: () => { return document.getElementById('canvas').width; },  
 269386: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269454: () => { document.exitFullscreen(); },  
 269481: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269554: () => { if (document.fullscreenElement) return 1; },  
 269600: () => { return document.getElementById('canvas').width; },  
 269652: () => { return screen.width; },  
 269677: () => { document.exitFullscreen(); },  
 269704: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269837: () => { return window.innerWidth; },  
 269863: () => { return window.innerHeight; },  
