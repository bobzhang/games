...
var ASM_CONSTS = {
 ...
 269166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269234: () => { document.exitFullscreen(); },  
 269261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269334: () => { if (document.fullscreenElement) return 1; },  
 269380: () => { return document.getElementById('canvas').width; },  
 269432: () => { return screen.width; },  
 269457: () => { document.exitFullscreen(); },  
 269484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269617: () => { return window.innerWidth; },  
 269643: () => { return window.innerHeight; },  
 269670: () => { if (document.fullscreenElement) return 1; },  
 269716: () => { return document.getElementById('canvas').width; },  
 269768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269959: () => { return window.innerWidth; },  
 269985: () => { return window.innerHeight; },  
 270012: () => { if (document.fullscreenElement) return 1; },  
 270058: () => { return document.getElementById('canvas').width; },  
 270110: () => { return screen.width; },  
 270135: () => { document.exitFullscreen(); },  
 270162: () => { if (document.fullscreenElement) return 1; },  
 270208: () => { return document.getElementById('canvas').width; },  
 270260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270328: () => { document.exitFullscreen(); },  
 270355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270413: () => { return screen.width; },  
 270438: () => { return screen.height; },  
 270464: () => { return window.screenX; },  
 270491: () => { return window.screenY; },  
 270518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271026: () => { if (document.fullscreenElement) return 1; },  
 271072: () => { return window.innerWidth; },  
 271098: () => { return window.innerHeight; },  
 271125: () => { if (document.pointerLockElement) return 1; },  
 271172: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 273330: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 273494: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 273598: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 276597: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 276663: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 277056: ($0) => { miniaudio.untrack_device_by_index($0); },  
 277099: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 277224: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
