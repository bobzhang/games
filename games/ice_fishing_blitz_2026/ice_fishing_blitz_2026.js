...
function findWasmBinary() {
  return locateFile('ice_fishing_blitz_2026.wasm');
}
...
var ASM_CONSTS = {
  269064: () => { if (document.fullscreenElement) return 1; },  
 269110: () => { return document.getElementById('canvas').width; },  
 269162: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269230: () => { document.exitFullscreen(); },  
 269257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269330: () => { if (document.fullscreenElement) return 1; },  
 269376: () => { return document.getElementById('canvas').width; },  
 269428: () => { return screen.width; },  
 269453: () => { document.exitFullscreen(); },  
 269480: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269613: () => { return window.innerWidth; },  
 269639: () => { return window.innerHeight; },  
 269666: () => { if (document.fullscreenElement) return 1; },  
 269712: () => { return document.getElementById('canvas').width; },  
 269764: () => { return parseInt(document.getElementById('canvas').style.width); },  
