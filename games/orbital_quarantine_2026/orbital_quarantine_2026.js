...
var ASM_CONSTS = {
 ...
 262582: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262650: () => { document.exitFullscreen(); },  
 262677: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262750: () => { if (document.fullscreenElement) return 1; },  
 262796: () => { return document.getElementById('canvas').width; },  
 262848: () => { return screen.width; },  
 262873: () => { document.exitFullscreen(); },  
 262900: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263033: () => { return window.innerWidth; },  
 263059: () => { return window.innerHeight; },  
 263086: () => { if (document.fullscreenElement) return 1; },  
 263132: () => { return document.getElementById('canvas').width; },  
 263184: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263252: () => { if (document.fullscreenElement) return 1; },  
 263298: () => { return document.getElementById('canvas').width; },  
 263350: () => { return screen.width; },  
 263375: () => { return window.innerWidth; },  
 263401: () => { return window.innerHeight; },  
 ...
 263551: () => { document.exitFullscreen(); },  
 263578: () => { if (document.fullscreenElement) return 1; },  
 263624: () => { return document.getElementById('canvas').width; },  
 263676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263744: () => { document.exitFullscreen(); },  
 263771: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263829: () => { return screen.width; },  
 263854: () => { return screen.height; },  
 263880: () => { return window.screenX; },  
 263907: () => { return window.screenY; },  
 263934: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263987: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264058: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264115: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264371: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264442: () => { if (document.fullscreenElement) return 1; },  
 264488: () => { return window.innerWidth; },  
 264514: () => { return window.innerHeight; },  
 264541: () => { if (document.pointerLockElement) return 1; }
};
