...
var ASM_CONSTS = {
 ...
 262374: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262442: () => { document.exitFullscreen(); },  
 262469: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262542: () => { if (document.fullscreenElement) return 1; },  
 262588: () => { return document.getElementById('canvas').width; },  
 262640: () => { return screen.width; },  
 262665: () => { document.exitFullscreen(); },  
 262692: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262825: () => { return window.innerWidth; },  
 262851: () => { return window.innerHeight; },  
 262878: () => { if (document.fullscreenElement) return 1; },  
 262924: () => { return document.getElementById('canvas').width; },  
 262976: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263044: () => { if (document.fullscreenElement) return 1; },  
 263090: () => { return document.getElementById('canvas').width; },  
 263142: () => { return screen.width; },  
 263167: () => { return window.innerWidth; },  
 263193: () => { return window.innerHeight; },  
 ...
 263343: () => { document.exitFullscreen(); },  
 263370: () => { if (document.fullscreenElement) return 1; },  
 263416: () => { return document.getElementById('canvas').width; },  
 263468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263536: () => { document.exitFullscreen(); },  
 263563: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263621: () => { return screen.width; },  
 263646: () => { return screen.height; },  
 263672: () => { return window.screenX; },  
 263699: () => { return window.screenY; },  
 263726: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263779: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263850: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263907: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264163: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264234: () => { if (document.fullscreenElement) return 1; },  
 264280: () => { return window.innerWidth; },  
 264306: () => { return window.innerHeight; },  
 264333: () => { if (document.pointerLockElement) return 1; }
};
