...
function findWasmBinary() {
  return locateFile('firefighting_command_2026.wasm');
}
...
var ASM_CONSTS = {
  261104: () => { if (document.fullscreenElement) return 1; },  
 261150: () => { return document.getElementById('canvas').width; },  
 261202: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261270: () => { document.exitFullscreen(); },  
 261297: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261370: () => { if (document.fullscreenElement) return 1; },  
 261416: () => { return document.getElementById('canvas').width; },  
 261468: () => { return screen.width; },  
 261493: () => { document.exitFullscreen(); },  
 261520: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261653: () => { return window.innerWidth; },  
 261679: () => { return window.innerHeight; },  
 261706: () => { if (document.fullscreenElement) return 1; },  
 261752: () => { return document.getElementById('canvas').width; },  
 261804: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261872: () => { if (document.fullscreenElement) return 1; },  
 261918: () => { return document.getElementById('canvas').width; },  
 261970: () => { return screen.width; },  
 261995: () => { return window.innerWidth; },  
 262021: () => { return window.innerHeight; },  
 262048: () => { if (document.fullscreenElement) return 1; },  
 262094: () => { return document.getElementById('canvas').width; },  
 262146: () => { return screen.width; },  
 262171: () => { document.exitFullscreen(); },  
 262198: () => { if (document.fullscreenElement) return 1; },  
 262244: () => { return document.getElementById('canvas').width; },  
 262296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262364: () => { document.exitFullscreen(); },  
 262391: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262449: () => { return screen.width; },  
 262474: () => { return screen.height; },  
 262500: () => { return window.screenX; },  
 262527: () => { return window.screenY; },  
 262554: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262607: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262678: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262735: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262991: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263062: () => { if (document.fullscreenElement) return 1; },  
 263108: () => { return window.innerWidth; },  
 263134: () => { return window.innerHeight; },  
 263161: () => { if (document.pointerLockElement) return 1; }
};
