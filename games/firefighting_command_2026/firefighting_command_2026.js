...
var ASM_CONSTS = {
  261316: () => { if (document.fullscreenElement) return 1; },  
 261362: () => { return document.getElementById('canvas').width; },  
 261414: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261482: () => { document.exitFullscreen(); },  
 261509: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261582: () => { if (document.fullscreenElement) return 1; },  
 261628: () => { return document.getElementById('canvas').width; },  
 261680: () => { return screen.width; },  
 261705: () => { document.exitFullscreen(); },  
 261732: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261865: () => { return window.innerWidth; },  
 261891: () => { return window.innerHeight; },  
 261918: () => { if (document.fullscreenElement) return 1; },  
 261964: () => { return document.getElementById('canvas').width; },  
 262016: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262084: () => { if (document.fullscreenElement) return 1; },  
 262130: () => { return document.getElementById('canvas').width; },  
 262182: () => { return screen.width; },  
 262207: () => { return window.innerWidth; },  
 262233: () => { return window.innerHeight; },  
 262260: () => { if (document.fullscreenElement) return 1; },  
 262306: () => { return document.getElementById('canvas').width; },  
 262358: () => { return screen.width; },  
 262383: () => { document.exitFullscreen(); },  
 262410: () => { if (document.fullscreenElement) return 1; },  
 262456: () => { return document.getElementById('canvas').width; },  
 262508: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262576: () => { document.exitFullscreen(); },  
 262603: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262661: () => { return screen.width; },  
 262686: () => { return screen.height; },  
 262712: () => { return window.screenX; },  
 262739: () => { return window.screenY; },  
 262766: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262819: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262890: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262947: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263203: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263274: () => { if (document.fullscreenElement) return 1; },  
 263320: () => { return window.innerWidth; },  
 263346: () => { return window.innerHeight; },  
 263373: () => { if (document.pointerLockElement) return 1; }
};
