...
var ASM_CONSTS = {
  261124: () => { if (document.fullscreenElement) return 1; },  
 261170: () => { return document.getElementById('canvas').width; },  
 261222: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261290: () => { document.exitFullscreen(); },  
 261317: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261390: () => { if (document.fullscreenElement) return 1; },  
 261436: () => { return document.getElementById('canvas').width; },  
 261488: () => { return screen.width; },  
 261513: () => { document.exitFullscreen(); },  
 261540: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261673: () => { return window.innerWidth; },  
 261699: () => { return window.innerHeight; },  
 261726: () => { if (document.fullscreenElement) return 1; },  
 261772: () => { return document.getElementById('canvas').width; },  
 261824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262015: () => { return window.innerWidth; },  
 262041: () => { return window.innerHeight; },  
 262068: () => { if (document.fullscreenElement) return 1; },  
 262114: () => { return document.getElementById('canvas').width; },  
 262166: () => { return screen.width; },  
 262191: () => { document.exitFullscreen(); },  
 262218: () => { if (document.fullscreenElement) return 1; },  
 262264: () => { return document.getElementById('canvas').width; },  
 262316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262384: () => { document.exitFullscreen(); },  
 262411: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262469: () => { return screen.width; },  
 262494: () => { return screen.height; },  
 262520: () => { return window.screenX; },  
 262547: () => { return window.screenY; },  
 262574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262627: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262698: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262755: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263011: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263082: () => { if (document.fullscreenElement) return 1; },  
 263128: () => { return window.innerWidth; },  
 263154: () => { return window.innerHeight; },  
 263181: () => { if (document.pointerLockElement) return 1; }
};
