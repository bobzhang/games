...
var ASM_CONSTS = {
  294452: () => { if (document.fullscreenElement) return 1; },  
 294498: () => { return document.getElementById('canvas').width; },  
 294550: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294618: () => { document.exitFullscreen(); },  
 294645: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 294718: () => { if (document.fullscreenElement) return 1; },  
 294764: () => { return document.getElementById('canvas').width; },  
 294816: () => { return screen.width; },  
 294841: () => { document.exitFullscreen(); },  
 294868: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 295001: () => { return window.innerWidth; },  
 295027: () => { return window.innerHeight; },  
 295054: () => { if (document.fullscreenElement) return 1; },  
 295100: () => { return document.getElementById('canvas').width; },  
 295152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295220: () => { if (document.fullscreenElement) return 1; },  
 295266: () => { return document.getElementById('canvas').width; },  
 295318: () => { return screen.width; },  
 295343: () => { return window.innerWidth; },  
 295369: () => { return window.innerHeight; },  
 295396: () => { if (document.fullscreenElement) return 1; },  
 295442: () => { return document.getElementById('canvas').width; },  
 295494: () => { return screen.width; },  
 295519: () => { document.exitFullscreen(); },  
 295546: () => { if (document.fullscreenElement) return 1; },  
 295592: () => { return document.getElementById('canvas').width; },  
 295644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295712: () => { document.exitFullscreen(); },  
 295739: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 295797: () => { return screen.width; },  
 295822: () => { return screen.height; },  
 295848: () => { return window.screenX; },  
 295875: () => { return window.screenY; },  
 295902: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 295955: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 296026: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 296083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 296339: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 296410: () => { if (document.fullscreenElement) return 1; },  
 296456: () => { return window.innerWidth; },  
 296482: () => { return window.innerHeight; },  
 296509: () => { if (document.pointerLockElement) return 1; }
};
