...
var ASM_CONSTS = {
  294228: () => { if (document.fullscreenElement) return 1; },  
 294274: () => { return document.getElementById('canvas').width; },  
 294326: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294394: () => { document.exitFullscreen(); },  
 294421: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 294494: () => { if (document.fullscreenElement) return 1; },  
 294540: () => { return document.getElementById('canvas').width; },  
 294592: () => { return screen.width; },  
 294617: () => { document.exitFullscreen(); },  
 294644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 294777: () => { return window.innerWidth; },  
 294803: () => { return window.innerHeight; },  
 294830: () => { if (document.fullscreenElement) return 1; },  
 294876: () => { return document.getElementById('canvas').width; },  
 294928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294996: () => { if (document.fullscreenElement) return 1; },  
 295042: () => { return document.getElementById('canvas').width; },  
 295094: () => { return screen.width; },  
 295119: () => { return window.innerWidth; },  
 295145: () => { return window.innerHeight; },  
 295172: () => { if (document.fullscreenElement) return 1; },  
 295218: () => { return document.getElementById('canvas').width; },  
 295270: () => { return screen.width; },  
 295295: () => { document.exitFullscreen(); },  
 295322: () => { if (document.fullscreenElement) return 1; },  
 295368: () => { return document.getElementById('canvas').width; },  
 295420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295488: () => { document.exitFullscreen(); },  
 295515: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 295573: () => { return screen.width; },  
 295598: () => { return screen.height; },  
 295624: () => { return window.screenX; },  
 295651: () => { return window.screenY; },  
 295678: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 295731: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 295802: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 295859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 296115: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 296186: () => { if (document.fullscreenElement) return 1; },  
 296232: () => { return window.innerWidth; },  
 296258: () => { return window.innerHeight; },  
 296285: () => { if (document.pointerLockElement) return 1; }
};
