...
var ASM_CONSTS = {
  295156: () => { if (document.fullscreenElement) return 1; },  
 295202: () => { return document.getElementById('canvas').width; },  
 295254: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295322: () => { document.exitFullscreen(); },  
 295349: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 295422: () => { if (document.fullscreenElement) return 1; },  
 295468: () => { return document.getElementById('canvas').width; },  
 295520: () => { return screen.width; },  
 295545: () => { document.exitFullscreen(); },  
 295572: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 295705: () => { return window.innerWidth; },  
 295731: () => { return window.innerHeight; },  
 295758: () => { if (document.fullscreenElement) return 1; },  
 295804: () => { return document.getElementById('canvas').width; },  
 295856: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295924: () => { if (document.fullscreenElement) return 1; },  
 295970: () => { return document.getElementById('canvas').width; },  
 296022: () => { return screen.width; },  
 296047: () => { return window.innerWidth; },  
 296073: () => { return window.innerHeight; },  
 296100: () => { if (document.fullscreenElement) return 1; },  
 296146: () => { return document.getElementById('canvas').width; },  
 296198: () => { return screen.width; },  
 296223: () => { document.exitFullscreen(); },  
 296250: () => { if (document.fullscreenElement) return 1; },  
 296296: () => { return document.getElementById('canvas').width; },  
 296348: () => { return parseInt(document.getElementById('canvas').style.width); },  
 296416: () => { document.exitFullscreen(); },  
 296443: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 296501: () => { return screen.width; },  
 296526: () => { return screen.height; },  
 296552: () => { return window.screenX; },  
 296579: () => { return window.screenY; },  
 296606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 296659: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 296730: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 296787: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 297043: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 297114: () => { if (document.fullscreenElement) return 1; },  
 297160: () => { return window.innerWidth; },  
 297186: () => { return window.innerHeight; },  
 297213: () => { if (document.pointerLockElement) return 1; }
};
