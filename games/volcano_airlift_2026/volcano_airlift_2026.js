...
function findWasmBinary() {
  return locateFile('volcano_airlift_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 261890: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261958: () => { document.exitFullscreen(); },  
 261985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262058: () => { if (document.fullscreenElement) return 1; },  
 262104: () => { return document.getElementById('canvas').width; },  
 262156: () => { return screen.width; },  
 262181: () => { document.exitFullscreen(); },  
 262208: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262341: () => { return window.innerWidth; },  
 262367: () => { return window.innerHeight; },  
 ...
 262683: () => { return window.innerWidth; },  
 262709: () => { return window.innerHeight; },  
 ...
 262859: () => { document.exitFullscreen(); },  
 262886: () => { if (document.fullscreenElement) return 1; },  
 262932: () => { return document.getElementById('canvas').width; },  
 262984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263052: () => { document.exitFullscreen(); },  
 263079: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263137: () => { return screen.width; },  
 263162: () => { return screen.height; },  
 263188: () => { return window.screenX; },  
 263215: () => { return window.screenY; },  
 263242: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263295: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263366: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263423: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263679: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263750: () => { if (document.fullscreenElement) return 1; },  
 263796: () => { return window.innerWidth; },  
 263822: () => { return window.innerHeight; },  
 263849: () => { if (document.pointerLockElement) return 1; }
};
