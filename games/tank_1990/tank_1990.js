...
var ASM_CONSTS = {
  291092: () => { if (document.fullscreenElement) return 1; },  
 291138: () => { return document.getElementById('canvas').width; },  
 291190: () => { return parseInt(document.getElementById('canvas').style.width); },  
 291258: () => { document.exitFullscreen(); },  
 291285: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 291358: () => { if (document.fullscreenElement) return 1; },  
 291404: () => { return document.getElementById('canvas').width; },  
 291456: () => { return screen.width; },  
 291481: () => { document.exitFullscreen(); },  
 291508: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 291641: () => { return window.innerWidth; },  
 291667: () => { return window.innerHeight; },  
 291694: () => { if (document.fullscreenElement) return 1; },  
 291740: () => { return document.getElementById('canvas').width; },  
 291792: () => { return parseInt(document.getElementById('canvas').style.width); },  
 291860: () => { if (document.fullscreenElement) return 1; },  
 291906: () => { return document.getElementById('canvas').width; },  
 291958: () => { return screen.width; },  
 291983: () => { return window.innerWidth; },  
 292009: () => { return window.innerHeight; },  
 292036: () => { if (document.fullscreenElement) return 1; },  
 292082: () => { return document.getElementById('canvas').width; },  
 292134: () => { return screen.width; },  
 292159: () => { document.exitFullscreen(); },  
 292186: () => { if (document.fullscreenElement) return 1; },  
 292232: () => { return document.getElementById('canvas').width; },  
 292284: () => { return parseInt(document.getElementById('canvas').style.width); },  
 292352: () => { document.exitFullscreen(); },  
 292379: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 292437: () => { return screen.width; },  
 292462: () => { return screen.height; },  
 292488: () => { return window.screenX; },  
 292515: () => { return window.screenY; },  
 292542: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 292595: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 292666: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 292723: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 292979: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 293050: () => { if (document.fullscreenElement) return 1; },  
 293096: () => { return window.innerWidth; },  
 293122: () => { return window.innerHeight; },  
 293149: () => { if (document.pointerLockElement) return 1; }
};
