...
var ASM_CONSTS = {
 ...
 262854: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262922: () => { document.exitFullscreen(); },  
 262949: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263022: () => { if (document.fullscreenElement) return 1; },  
 263068: () => { return document.getElementById('canvas').width; },  
 263120: () => { return screen.width; },  
 263145: () => { document.exitFullscreen(); },  
 263172: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263305: () => { return window.innerWidth; },  
 263331: () => { return window.innerHeight; },  
 263358: () => { if (document.fullscreenElement) return 1; },  
 263404: () => { return document.getElementById('canvas').width; },  
 263456: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263524: () => { if (document.fullscreenElement) return 1; },  
 263570: () => { return document.getElementById('canvas').width; },  
 263622: () => { return screen.width; },  
 263647: () => { return window.innerWidth; },  
 263673: () => { return window.innerHeight; },  
 263700: () => { if (document.fullscreenElement) return 1; },  
 263746: () => { return document.getElementById('canvas').width; },  
 263798: () => { return screen.width; },  
 263823: () => { document.exitFullscreen(); },  
 ...
 264016: () => { document.exitFullscreen(); },  
 264043: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264101: () => { return screen.width; },  
 264126: () => { return screen.height; },  
 264152: () => { return window.screenX; },  
 264179: () => { return window.screenY; },  
 264206: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264259: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264330: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264387: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264643: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264714: () => { if (document.fullscreenElement) return 1; },  
 264760: () => { return window.innerWidth; },  
 264786: () => { return window.innerHeight; },  
 264813: () => { if (document.pointerLockElement) return 1; }
};
