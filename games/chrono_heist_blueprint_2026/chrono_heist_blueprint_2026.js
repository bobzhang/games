...
var ASM_CONSTS = {
 ...
 263062: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263130: () => { document.exitFullscreen(); },  
 263157: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263230: () => { if (document.fullscreenElement) return 1; },  
 263276: () => { return document.getElementById('canvas').width; },  
 263328: () => { return screen.width; },  
 263353: () => { document.exitFullscreen(); },  
 263380: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263513: () => { return window.innerWidth; },  
 263539: () => { return window.innerHeight; },  
 263566: () => { if (document.fullscreenElement) return 1; },  
 263612: () => { return document.getElementById('canvas').width; },  
 263664: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263855: () => { return window.innerWidth; },  
 ...
 264031: () => { document.exitFullscreen(); },  
 264058: () => { if (document.fullscreenElement) return 1; },  
 264104: () => { return document.getElementById('canvas').width; },  
 264156: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264224: () => { document.exitFullscreen(); },  
 264251: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264309: () => { return screen.width; },  
 264334: () => { return screen.height; },  
 264360: () => { return window.screenX; },  
 264387: () => { return window.screenY; },  
 264414: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264467: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264538: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264595: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264851: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264922: () => { if (document.fullscreenElement) return 1; },  
 264968: () => { return window.innerWidth; },  
 264994: () => { return window.innerHeight; },  
 265021: () => { if (document.pointerLockElement) return 1; }
};
