...
var ASM_CONSTS = {
  262948: () => { if (document.fullscreenElement) return 1; },  
 262994: () => { return document.getElementById('canvas').width; },  
 263046: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263114: () => { document.exitFullscreen(); },  
 263141: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263214: () => { if (document.fullscreenElement) return 1; },  
 263260: () => { return document.getElementById('canvas').width; },  
 263312: () => { return screen.width; },  
 263337: () => { document.exitFullscreen(); },  
 263364: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263497: () => { return window.innerWidth; },  
 263523: () => { return window.innerHeight; },  
 263550: () => { if (document.fullscreenElement) return 1; },  
 263596: () => { return document.getElementById('canvas').width; },  
 263648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263716: () => { if (document.fullscreenElement) return 1; },  
 263762: () => { return document.getElementById('canvas').width; },  
 263814: () => { return screen.width; },  
 263839: () => { return window.innerWidth; },  
 263865: () => { return window.innerHeight; },  
 263892: () => { if (document.fullscreenElement) return 1; },  
 263938: () => { return document.getElementById('canvas').width; },  
 263990: () => { return screen.width; },  
 264015: () => { document.exitFullscreen(); },  
 264042: () => { if (document.fullscreenElement) return 1; },  
 264088: () => { return document.getElementById('canvas').width; },  
 264140: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264208: () => { document.exitFullscreen(); },  
 264235: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264293: () => { return screen.width; },  
 264318: () => { return screen.height; },  
 264344: () => { return window.screenX; },  
 264371: () => { return window.screenY; },  
 264398: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264451: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264522: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264579: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264835: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264906: () => { if (document.fullscreenElement) return 1; },  
 264952: () => { return window.innerWidth; },  
 264978: () => { return window.innerHeight; },  
 265005: () => { if (document.pointerLockElement) return 1; }
};
