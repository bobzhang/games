...
var ASM_CONSTS = {
  251920: () => { if (document.fullscreenElement) return 1; },  
 251966: () => { return document.getElementById('canvas').width; },  
 252018: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252086: () => { document.exitFullscreen(); },  
 252113: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252186: () => { if (document.fullscreenElement) return 1; },  
 252232: () => { return document.getElementById('canvas').width; },  
 252284: () => { return screen.width; },  
 252309: () => { document.exitFullscreen(); },  
 252336: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252469: () => { return window.innerWidth; },  
 252495: () => { return window.innerHeight; },  
 252522: () => { if (document.fullscreenElement) return 1; },  
 252568: () => { return document.getElementById('canvas').width; },  
 252620: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252688: () => { if (document.fullscreenElement) return 1; },  
 252734: () => { return document.getElementById('canvas').width; },  
 252786: () => { return screen.width; },  
 252811: () => { return window.innerWidth; },  
 252837: () => { return window.innerHeight; },  
 252864: () => { if (document.fullscreenElement) return 1; },  
 252910: () => { return document.getElementById('canvas').width; },  
 252962: () => { return screen.width; },  
 252987: () => { document.exitFullscreen(); },  
 253014: () => { if (document.fullscreenElement) return 1; },  
 253060: () => { return document.getElementById('canvas').width; },  
 253112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253180: () => { document.exitFullscreen(); },  
 253207: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253265: () => { return screen.width; },  
 253290: () => { return screen.height; },  
 253316: () => { return window.screenX; },  
 253343: () => { return window.screenY; },  
 253370: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253423: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253494: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253551: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253807: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253878: () => { if (document.fullscreenElement) return 1; },  
 253924: () => { return window.innerWidth; },  
 253950: () => { return window.innerHeight; },  
 253977: () => { if (document.pointerLockElement) return 1; }
};
