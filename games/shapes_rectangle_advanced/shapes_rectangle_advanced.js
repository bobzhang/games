...
var ASM_CONSTS = {
  251924: () => { if (document.fullscreenElement) return 1; },  
 251970: () => { return document.getElementById('canvas').width; },  
 252022: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252090: () => { document.exitFullscreen(); },  
 252117: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252190: () => { if (document.fullscreenElement) return 1; },  
 252236: () => { return document.getElementById('canvas').width; },  
 252288: () => { return screen.width; },  
 252313: () => { document.exitFullscreen(); },  
 252340: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252473: () => { return window.innerWidth; },  
 252499: () => { return window.innerHeight; },  
 252526: () => { if (document.fullscreenElement) return 1; },  
 252572: () => { return document.getElementById('canvas').width; },  
 252624: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252692: () => { if (document.fullscreenElement) return 1; },  
 252738: () => { return document.getElementById('canvas').width; },  
 252790: () => { return screen.width; },  
 252815: () => { return window.innerWidth; },  
 252841: () => { return window.innerHeight; },  
 252868: () => { if (document.fullscreenElement) return 1; },  
 252914: () => { return document.getElementById('canvas').width; },  
 252966: () => { return screen.width; },  
 252991: () => { document.exitFullscreen(); },  
 253018: () => { if (document.fullscreenElement) return 1; },  
 253064: () => { return document.getElementById('canvas').width; },  
 253116: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253184: () => { document.exitFullscreen(); },  
 253211: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253269: () => { return screen.width; },  
 253294: () => { return screen.height; },  
 253320: () => { return window.screenX; },  
 253347: () => { return window.screenY; },  
 253374: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253427: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253498: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253555: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253811: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253882: () => { if (document.fullscreenElement) return 1; },  
 253928: () => { return window.innerWidth; },  
 253954: () => { return window.innerHeight; },  
 253981: () => { if (document.pointerLockElement) return 1; }
};
