...
var ASM_CONSTS = {
  251700: () => { if (document.fullscreenElement) return 1; },  
 251746: () => { return document.getElementById('canvas').width; },  
 251798: () => { return parseInt(document.getElementById('canvas').style.width); },  
 251866: () => { document.exitFullscreen(); },  
 251893: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 251966: () => { if (document.fullscreenElement) return 1; },  
 252012: () => { return document.getElementById('canvas').width; },  
 252064: () => { return screen.width; },  
 252089: () => { document.exitFullscreen(); },  
 252116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252249: () => { return window.innerWidth; },  
 252275: () => { return window.innerHeight; },  
 252302: () => { if (document.fullscreenElement) return 1; },  
 252348: () => { return document.getElementById('canvas').width; },  
 252400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252468: () => { if (document.fullscreenElement) return 1; },  
 252514: () => { return document.getElementById('canvas').width; },  
 252566: () => { return screen.width; },  
 252591: () => { return window.innerWidth; },  
 252617: () => { return window.innerHeight; },  
 252644: () => { if (document.fullscreenElement) return 1; },  
 252690: () => { return document.getElementById('canvas').width; },  
 252742: () => { return screen.width; },  
 252767: () => { document.exitFullscreen(); },  
 252794: () => { if (document.fullscreenElement) return 1; },  
 252840: () => { return document.getElementById('canvas').width; },  
 252892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252960: () => { document.exitFullscreen(); },  
 252987: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253045: () => { return screen.width; },  
 253070: () => { return screen.height; },  
 253096: () => { return window.screenX; },  
 253123: () => { return window.screenY; },  
 253150: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253203: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253274: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253587: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253658: () => { if (document.fullscreenElement) return 1; },  
 253704: () => { return window.innerWidth; },  
 253730: () => { return window.innerHeight; },  
 253757: () => { if (document.pointerLockElement) return 1; }
};
