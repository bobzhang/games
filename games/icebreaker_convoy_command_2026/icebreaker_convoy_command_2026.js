...
var ASM_CONSTS = {
  263040: () => { if (document.fullscreenElement) return 1; },  
 263086: () => { return document.getElementById('canvas').width; },  
 263138: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263206: () => { document.exitFullscreen(); },  
 263233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263306: () => { if (document.fullscreenElement) return 1; },  
 263352: () => { return document.getElementById('canvas').width; },  
 263404: () => { return screen.width; },  
 263429: () => { document.exitFullscreen(); },  
 263456: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263589: () => { return window.innerWidth; },  
 263615: () => { return window.innerHeight; },  
 263642: () => { if (document.fullscreenElement) return 1; },  
 263688: () => { return document.getElementById('canvas').width; },  
 263740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263808: () => { if (document.fullscreenElement) return 1; },  
 263854: () => { return document.getElementById('canvas').width; },  
 263906: () => { return screen.width; },  
 263931: () => { return window.innerWidth; },  
 263957: () => { return window.innerHeight; },  
 263984: () => { if (document.fullscreenElement) return 1; },  
 264030: () => { return document.getElementById('canvas').width; },  
 264082: () => { return screen.width; },  
 264107: () => { document.exitFullscreen(); },  
 264134: () => { if (document.fullscreenElement) return 1; },  
 264180: () => { return document.getElementById('canvas').width; },  
 264232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264300: () => { document.exitFullscreen(); },  
 264327: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264385: () => { return screen.width; },  
 264410: () => { return screen.height; },  
 264436: () => { return window.screenX; },  
 264463: () => { return window.screenY; },  
 264490: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264543: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264614: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264671: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264927: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264998: () => { if (document.fullscreenElement) return 1; },  
 265044: () => { return window.innerWidth; },  
 265070: () => { return window.innerHeight; },  
 265097: () => { if (document.pointerLockElement) return 1; }
};
