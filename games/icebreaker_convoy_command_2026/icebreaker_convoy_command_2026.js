...
var ASM_CONSTS = {
  263252: () => { if (document.fullscreenElement) return 1; },  
 263298: () => { return document.getElementById('canvas').width; },  
 263350: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263418: () => { document.exitFullscreen(); },  
 263445: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263518: () => { if (document.fullscreenElement) return 1; },  
 263564: () => { return document.getElementById('canvas').width; },  
 263616: () => { return screen.width; },  
 263641: () => { document.exitFullscreen(); },  
 263668: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263801: () => { return window.innerWidth; },  
 263827: () => { return window.innerHeight; },  
 263854: () => { if (document.fullscreenElement) return 1; },  
 263900: () => { return document.getElementById('canvas').width; },  
 263952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264020: () => { if (document.fullscreenElement) return 1; },  
 264066: () => { return document.getElementById('canvas').width; },  
 264118: () => { return screen.width; },  
 264143: () => { return window.innerWidth; },  
 264169: () => { return window.innerHeight; },  
 264196: () => { if (document.fullscreenElement) return 1; },  
 264242: () => { return document.getElementById('canvas').width; },  
 264294: () => { return screen.width; },  
 264319: () => { document.exitFullscreen(); },  
 264346: () => { if (document.fullscreenElement) return 1; },  
 264392: () => { return document.getElementById('canvas').width; },  
 264444: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264512: () => { document.exitFullscreen(); },  
 264539: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264597: () => { return screen.width; },  
 264622: () => { return screen.height; },  
 264648: () => { return window.screenX; },  
 264675: () => { return window.screenY; },  
 264702: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264755: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264826: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264883: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265139: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265210: () => { if (document.fullscreenElement) return 1; },  
 265256: () => { return window.innerWidth; },  
 265282: () => { return window.innerHeight; },  
 265309: () => { if (document.pointerLockElement) return 1; }
};
