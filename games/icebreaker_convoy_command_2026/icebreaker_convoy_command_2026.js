...
var ASM_CONSTS = {
 ...
 263158: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263226: () => { document.exitFullscreen(); },  
 263253: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263326: () => { if (document.fullscreenElement) return 1; },  
 263372: () => { return document.getElementById('canvas').width; },  
 263424: () => { return screen.width; },  
 263449: () => { document.exitFullscreen(); },  
 263476: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263609: () => { return window.innerWidth; },  
 263635: () => { return window.innerHeight; },  
 263662: () => { if (document.fullscreenElement) return 1; },  
 263708: () => { return document.getElementById('canvas').width; },  
 263760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263951: () => { return window.innerWidth; },  
 263977: () => { return window.innerHeight; },  
 ...
 264127: () => { document.exitFullscreen(); },  
 264154: () => { if (document.fullscreenElement) return 1; },  
 264200: () => { return document.getElementById('canvas').width; },  
 264252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264320: () => { document.exitFullscreen(); },  
 264347: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264405: () => { return screen.width; },  
 264430: () => { return screen.height; },  
 264456: () => { return window.screenX; },  
 264483: () => { return window.screenY; },  
 264510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264691: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264947: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265018: () => { if (document.fullscreenElement) return 1; },  
 265064: () => { return window.innerWidth; },  
 265090: () => { return window.innerHeight; },  
 265117: () => { if (document.pointerLockElement) return 1; }
};
