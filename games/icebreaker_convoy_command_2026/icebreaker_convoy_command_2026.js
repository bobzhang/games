...
var ASM_CONSTS = {
  263268: () => { if (document.fullscreenElement) return 1; },  
 263314: () => { return document.getElementById('canvas').width; },  
 263366: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263434: () => { document.exitFullscreen(); },  
 263461: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263534: () => { if (document.fullscreenElement) return 1; },  
 263580: () => { return document.getElementById('canvas').width; },  
 263632: () => { return screen.width; },  
 263657: () => { document.exitFullscreen(); },  
 263684: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263817: () => { return window.innerWidth; },  
 263843: () => { return window.innerHeight; },  
 263870: () => { if (document.fullscreenElement) return 1; },  
 263916: () => { return document.getElementById('canvas').width; },  
 263968: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264036: () => { if (document.fullscreenElement) return 1; },  
 264082: () => { return document.getElementById('canvas').width; },  
 264134: () => { return screen.width; },  
 264159: () => { return window.innerWidth; },  
 264185: () => { return window.innerHeight; },  
 264212: () => { if (document.fullscreenElement) return 1; },  
 264258: () => { return document.getElementById('canvas').width; },  
 264310: () => { return screen.width; },  
 264335: () => { document.exitFullscreen(); },  
 264362: () => { if (document.fullscreenElement) return 1; },  
 264408: () => { return document.getElementById('canvas').width; },  
 264460: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264528: () => { document.exitFullscreen(); },  
 264555: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264613: () => { return screen.width; },  
 264638: () => { return screen.height; },  
 264664: () => { return window.screenX; },  
 264691: () => { return window.screenY; },  
 264718: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264771: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264842: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264899: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265155: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265226: () => { if (document.fullscreenElement) return 1; },  
 265272: () => { return window.innerWidth; },  
 265298: () => { return window.innerHeight; },  
 265325: () => { if (document.pointerLockElement) return 1; }
};
