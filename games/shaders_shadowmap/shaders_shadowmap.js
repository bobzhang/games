...
var ASM_CONSTS = {
  1880996: () => { if (document.fullscreenElement) return 1; },  
 1881042: () => { return document.getElementById('canvas').width; },  
 1881094: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1881162: () => { document.exitFullscreen(); },  
 1881189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1881262: () => { if (document.fullscreenElement) return 1; },  
 1881308: () => { return document.getElementById('canvas').width; },  
 1881360: () => { return screen.width; },  
 1881385: () => { document.exitFullscreen(); },  
 1881412: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1881545: () => { return window.innerWidth; },  
 1881571: () => { return window.innerHeight; },  
 1881598: () => { if (document.fullscreenElement) return 1; },  
 1881644: () => { return document.getElementById('canvas').width; },  
 1881696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1881764: () => { if (document.fullscreenElement) return 1; },  
 1881810: () => { return document.getElementById('canvas').width; },  
 1881862: () => { return screen.width; },  
 1881887: () => { return window.innerWidth; },  
 1881913: () => { return window.innerHeight; },  
 1881940: () => { if (document.fullscreenElement) return 1; },  
 1881986: () => { return document.getElementById('canvas').width; },  
 1882038: () => { return screen.width; },  
 1882063: () => { document.exitFullscreen(); },  
 1882090: () => { if (document.fullscreenElement) return 1; },  
 1882136: () => { return document.getElementById('canvas').width; },  
 1882188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1882256: () => { document.exitFullscreen(); },  
 1882283: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1882341: () => { return screen.width; },  
 1882366: () => { return screen.height; },  
 1882392: () => { return window.screenX; },  
 1882419: () => { return window.screenY; },  
 1882446: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1882499: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1882570: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1882627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1882883: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1882954: () => { if (document.fullscreenElement) return 1; },  
 1883000: () => { return window.innerWidth; },  
 1883026: () => { return window.innerHeight; },  
 1883053: () => { if (document.pointerLockElement) return 1; }
};
