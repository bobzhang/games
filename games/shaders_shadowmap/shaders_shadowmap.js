...
var ASM_CONSTS = {
  1880788: () => { if (document.fullscreenElement) return 1; },  
 1880834: () => { return document.getElementById('canvas').width; },  
 1880886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1880954: () => { document.exitFullscreen(); },  
 1880981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1881054: () => { if (document.fullscreenElement) return 1; },  
 1881100: () => { return document.getElementById('canvas').width; },  
 1881152: () => { return screen.width; },  
 1881177: () => { document.exitFullscreen(); },  
 1881204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1881337: () => { return window.innerWidth; },  
 1881363: () => { return window.innerHeight; },  
 1881390: () => { if (document.fullscreenElement) return 1; },  
 1881436: () => { return document.getElementById('canvas').width; },  
 1881488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1881556: () => { if (document.fullscreenElement) return 1; },  
 1881602: () => { return document.getElementById('canvas').width; },  
 1881654: () => { return screen.width; },  
 1881679: () => { return window.innerWidth; },  
 1881705: () => { return window.innerHeight; },  
 1881732: () => { if (document.fullscreenElement) return 1; },  
 1881778: () => { return document.getElementById('canvas').width; },  
 1881830: () => { return screen.width; },  
 1881855: () => { document.exitFullscreen(); },  
 1881882: () => { if (document.fullscreenElement) return 1; },  
 1881928: () => { return document.getElementById('canvas').width; },  
 1881980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1882048: () => { document.exitFullscreen(); },  
 1882075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1882133: () => { return screen.width; },  
 1882158: () => { return screen.height; },  
 1882184: () => { return window.screenX; },  
 1882211: () => { return window.screenY; },  
 1882238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1882291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1882362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1882419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1882675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1882746: () => { if (document.fullscreenElement) return 1; },  
 1882792: () => { return window.innerWidth; },  
 1882818: () => { return window.innerHeight; },  
 1882845: () => { if (document.pointerLockElement) return 1; }
};
