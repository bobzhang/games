...
var ASM_CONSTS = {
  1881012: () => { if (document.fullscreenElement) return 1; },  
 1881058: () => { return document.getElementById('canvas').width; },  
 1881110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1881178: () => { document.exitFullscreen(); },  
 1881205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1881278: () => { if (document.fullscreenElement) return 1; },  
 1881324: () => { return document.getElementById('canvas').width; },  
 1881376: () => { return screen.width; },  
 1881401: () => { document.exitFullscreen(); },  
 1881428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1881561: () => { return window.innerWidth; },  
 1881587: () => { return window.innerHeight; },  
 1881614: () => { if (document.fullscreenElement) return 1; },  
 1881660: () => { return document.getElementById('canvas').width; },  
 1881712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1881780: () => { if (document.fullscreenElement) return 1; },  
 1881826: () => { return document.getElementById('canvas').width; },  
 1881878: () => { return screen.width; },  
 1881903: () => { return window.innerWidth; },  
 1881929: () => { return window.innerHeight; },  
 1881956: () => { if (document.fullscreenElement) return 1; },  
 1882002: () => { return document.getElementById('canvas').width; },  
 1882054: () => { return screen.width; },  
 1882079: () => { document.exitFullscreen(); },  
 1882106: () => { if (document.fullscreenElement) return 1; },  
 1882152: () => { return document.getElementById('canvas').width; },  
 1882204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1882272: () => { document.exitFullscreen(); },  
 1882299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1882357: () => { return screen.width; },  
 1882382: () => { return screen.height; },  
 1882408: () => { return window.screenX; },  
 1882435: () => { return window.screenY; },  
 1882462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1882515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1882586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1882643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1882899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1882970: () => { if (document.fullscreenElement) return 1; },  
 1883016: () => { return window.innerWidth; },  
 1883042: () => { return window.innerHeight; },  
 1883069: () => { if (document.pointerLockElement) return 1; }
};
