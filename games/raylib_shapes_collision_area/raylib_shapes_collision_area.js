...
function findWasmBinary() {
  return locateFile('raylib_shapes_collision_area.wasm');
}
...
var ASM_CONSTS = {
  97040: () => { if (document.fullscreenElement) return 1; },  
 97086: () => { return document.getElementById('canvas').width; },  
 97138: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97206: () => { document.exitFullscreen(); },  
 97233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97306: () => { if (document.fullscreenElement) return 1; },  
 97352: () => { return document.getElementById('canvas').width; },  
 97404: () => { return screen.width; },  
 97429: () => { document.exitFullscreen(); },  
 97456: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97589: () => { return window.innerWidth; },  
 97615: () => { return window.innerHeight; },  
 97642: () => { if (document.fullscreenElement) return 1; },  
 97688: () => { return document.getElementById('canvas').width; },  
 97740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97808: () => { if (document.fullscreenElement) return 1; },  
 97854: () => { return document.getElementById('canvas').width; },  
 97906: () => { return screen.width; },  
 97931: () => { return window.innerWidth; },  
 97957: () => { return window.innerHeight; },  
 97984: () => { if (document.fullscreenElement) return 1; },  
 98030: () => { return document.getElementById('canvas').width; },  
 98082: () => { return screen.width; },  
 98107: () => { document.exitFullscreen(); },  
 98134: () => { if (document.fullscreenElement) return 1; },  
 98180: () => { return document.getElementById('canvas').width; },  
 98232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98300: () => { document.exitFullscreen(); },  
 98327: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98385: () => { return screen.width; },  
 98410: () => { return screen.height; },  
 98436: () => { return window.screenX; },  
 98463: () => { return window.screenY; },  
 98490: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98543: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98614: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98671: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98927: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98998: () => { if (document.fullscreenElement) return 1; },  
 99044: () => { return window.innerWidth; },  
 99070: () => { return window.innerHeight; },  
 99097: () => { if (document.pointerLockElement) return 1; }
};
