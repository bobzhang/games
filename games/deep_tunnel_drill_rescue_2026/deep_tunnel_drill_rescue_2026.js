...
var ASM_CONSTS = {
  263044: () => { if (document.fullscreenElement) return 1; },  
 263090: () => { return document.getElementById('canvas').width; },  
 263142: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263210: () => { document.exitFullscreen(); },  
 263237: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263310: () => { if (document.fullscreenElement) return 1; },  
 263356: () => { return document.getElementById('canvas').width; },  
 263408: () => { return screen.width; },  
 263433: () => { document.exitFullscreen(); },  
 263460: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263593: () => { return window.innerWidth; },  
 263619: () => { return window.innerHeight; },  
 263646: () => { if (document.fullscreenElement) return 1; },  
 263692: () => { return document.getElementById('canvas').width; },  
 263744: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263935: () => { return window.innerWidth; },  
 263961: () => { return window.innerHeight; },  
 263988: () => { if (document.fullscreenElement) return 1; },  
 264034: () => { return document.getElementById('canvas').width; },  
 264086: () => { return screen.width; },  
 264111: () => { document.exitFullscreen(); },  
 264138: () => { if (document.fullscreenElement) return 1; },  
 264184: () => { return document.getElementById('canvas').width; },  
 264236: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264304: () => { document.exitFullscreen(); },  
 264331: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264389: () => { return screen.width; },  
 264414: () => { return screen.height; },  
 264440: () => { return window.screenX; },  
 264467: () => { return window.screenY; },  
 264494: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264547: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264618: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264675: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264931: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265002: () => { if (document.fullscreenElement) return 1; },  
 265048: () => { return window.innerWidth; },  
 265074: () => { return window.innerHeight; },  
 265101: () => { if (document.pointerLockElement) return 1; }
};
