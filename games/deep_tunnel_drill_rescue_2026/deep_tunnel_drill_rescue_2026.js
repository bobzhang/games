...
var ASM_CONSTS = {
  262852: () => { if (document.fullscreenElement) return 1; },  
 262898: () => { return document.getElementById('canvas').width; },  
 262950: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263018: () => { document.exitFullscreen(); },  
 263045: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263118: () => { if (document.fullscreenElement) return 1; },  
 263164: () => { return document.getElementById('canvas').width; },  
 263216: () => { return screen.width; },  
 263241: () => { document.exitFullscreen(); },  
 263268: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263401: () => { return window.innerWidth; },  
 263427: () => { return window.innerHeight; },  
 263454: () => { if (document.fullscreenElement) return 1; },  
 263500: () => { return document.getElementById('canvas').width; },  
 263552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263620: () => { if (document.fullscreenElement) return 1; },  
 263666: () => { return document.getElementById('canvas').width; },  
 263718: () => { return screen.width; },  
 263743: () => { return window.innerWidth; },  
 263769: () => { return window.innerHeight; },  
 263796: () => { if (document.fullscreenElement) return 1; },  
 263842: () => { return document.getElementById('canvas').width; },  
 263894: () => { return screen.width; },  
 263919: () => { document.exitFullscreen(); },  
 263946: () => { if (document.fullscreenElement) return 1; },  
 263992: () => { return document.getElementById('canvas').width; },  
 264044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264112: () => { document.exitFullscreen(); },  
 264139: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264197: () => { return screen.width; },  
 264222: () => { return screen.height; },  
 264248: () => { return window.screenX; },  
 264275: () => { return window.screenY; },  
 264302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264483: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264739: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264810: () => { if (document.fullscreenElement) return 1; },  
 264856: () => { return window.innerWidth; },  
 264882: () => { return window.innerHeight; },  
 264909: () => { if (document.pointerLockElement) return 1; }
};
