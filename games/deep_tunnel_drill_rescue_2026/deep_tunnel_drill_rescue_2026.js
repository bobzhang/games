...
var ASM_CONSTS = {
 ...
 263174: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263242: () => { document.exitFullscreen(); },  
 263269: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263342: () => { if (document.fullscreenElement) return 1; },  
 263388: () => { return document.getElementById('canvas').width; },  
 263440: () => { return screen.width; },  
 263465: () => { document.exitFullscreen(); },  
 263492: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263625: () => { return window.innerWidth; },  
 263651: () => { return window.innerHeight; },  
 263678: () => { if (document.fullscreenElement) return 1; },  
 263724: () => { return document.getElementById('canvas').width; },  
 263776: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263967: () => { return window.innerWidth; },  
 ...
 264143: () => { document.exitFullscreen(); },  
 264170: () => { if (document.fullscreenElement) return 1; },  
 264216: () => { return document.getElementById('canvas').width; },  
 264268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264336: () => { document.exitFullscreen(); },  
 264363: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264421: () => { return screen.width; },  
 264446: () => { return screen.height; },  
 264472: () => { return window.screenX; },  
 264499: () => { return window.screenY; },  
 264526: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264579: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264650: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264707: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264963: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265034: () => { if (document.fullscreenElement) return 1; },  
 265080: () => { return window.innerWidth; },  
 265106: () => { return window.innerHeight; },  
 265133: () => { if (document.pointerLockElement) return 1; }
};
