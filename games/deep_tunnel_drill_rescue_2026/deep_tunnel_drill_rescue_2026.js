...
var ASM_CONSTS = {
 ...
 263170: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263238: () => { document.exitFullscreen(); },  
 263265: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263338: () => { if (document.fullscreenElement) return 1; },  
 263384: () => { return document.getElementById('canvas').width; },  
 263436: () => { return screen.width; },  
 263461: () => { document.exitFullscreen(); },  
 263488: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263621: () => { return window.innerWidth; },  
 263647: () => { return window.innerHeight; },  
 263674: () => { if (document.fullscreenElement) return 1; },  
 263720: () => { return document.getElementById('canvas').width; },  
 263772: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263840: () => { if (document.fullscreenElement) return 1; },  
 263886: () => { return document.getElementById('canvas').width; },  
 263938: () => { return screen.width; },  
 263963: () => { return window.innerWidth; },  
 263989: () => { return window.innerHeight; },  
 ...
 264139: () => { document.exitFullscreen(); },  
 264166: () => { if (document.fullscreenElement) return 1; },  
 264212: () => { return document.getElementById('canvas').width; },  
 264264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264332: () => { document.exitFullscreen(); },  
 264359: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264417: () => { return screen.width; },  
 264442: () => { return screen.height; },  
 264468: () => { return window.screenX; },  
 264495: () => { return window.screenY; },  
 264522: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264575: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264646: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264703: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264959: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265030: () => { if (document.fullscreenElement) return 1; },  
 265076: () => { return window.innerWidth; },  
 265102: () => { return window.innerHeight; },  
 265129: () => { if (document.pointerLockElement) return 1; }
};
