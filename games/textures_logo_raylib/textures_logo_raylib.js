...
var ASM_CONSTS = {
  268068: () => { if (document.fullscreenElement) return 1; },  
 268114: () => { return document.getElementById('canvas').width; },  
 268166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268234: () => { document.exitFullscreen(); },  
 268261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268334: () => { if (document.fullscreenElement) return 1; },  
 268380: () => { return document.getElementById('canvas').width; },  
 268432: () => { return screen.width; },  
 268457: () => { document.exitFullscreen(); },  
 268484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268617: () => { return window.innerWidth; },  
 268643: () => { return window.innerHeight; },  
 268670: () => { if (document.fullscreenElement) return 1; },  
 268716: () => { return document.getElementById('canvas').width; },  
 268768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 268959: () => { return window.innerWidth; },  
 268985: () => { return window.innerHeight; },  
 269012: () => { if (document.fullscreenElement) return 1; },  
 269058: () => { return document.getElementById('canvas').width; },  
 269110: () => { return screen.width; },  
 269135: () => { document.exitFullscreen(); },  
 269162: () => { if (document.fullscreenElement) return 1; },  
 269208: () => { return document.getElementById('canvas').width; },  
 269260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269328: () => { document.exitFullscreen(); },  
 269355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269413: () => { return screen.width; },  
 269438: () => { return screen.height; },  
 269464: () => { return window.screenX; },  
 269491: () => { return window.screenY; },  
 269518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270026: () => { if (document.fullscreenElement) return 1; },  
 270072: () => { return window.innerWidth; },  
 270098: () => { return window.innerHeight; },  
 270125: () => { if (document.pointerLockElement) return 1; }
};
