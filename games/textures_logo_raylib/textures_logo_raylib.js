...
var ASM_CONSTS = {
  267860: () => { if (document.fullscreenElement) return 1; },  
 267906: () => { return document.getElementById('canvas').width; },  
 267958: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268026: () => { document.exitFullscreen(); },  
 268053: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268126: () => { if (document.fullscreenElement) return 1; },  
 268172: () => { return document.getElementById('canvas').width; },  
 268224: () => { return screen.width; },  
 268249: () => { document.exitFullscreen(); },  
 268276: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268409: () => { return window.innerWidth; },  
 268435: () => { return window.innerHeight; },  
 268462: () => { if (document.fullscreenElement) return 1; },  
 268508: () => { return document.getElementById('canvas').width; },  
 268560: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 268751: () => { return window.innerWidth; },  
 268777: () => { return window.innerHeight; },  
 268804: () => { if (document.fullscreenElement) return 1; },  
 268850: () => { return document.getElementById('canvas').width; },  
 268902: () => { return screen.width; },  
 268927: () => { document.exitFullscreen(); },  
 268954: () => { if (document.fullscreenElement) return 1; },  
 269000: () => { return document.getElementById('canvas').width; },  
 269052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269120: () => { document.exitFullscreen(); },  
 269147: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269205: () => { return screen.width; },  
 269230: () => { return screen.height; },  
 269256: () => { return window.screenX; },  
 269283: () => { return window.screenY; },  
 269310: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269363: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269434: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269491: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269747: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269818: () => { if (document.fullscreenElement) return 1; },  
 269864: () => { return window.innerWidth; },  
 269890: () => { return window.innerHeight; },  
 269917: () => { if (document.pointerLockElement) return 1; }
};
