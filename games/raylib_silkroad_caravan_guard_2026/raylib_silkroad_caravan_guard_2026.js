...
var ASM_CONSTS = {
 ...
 99442: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99510: () => { document.exitFullscreen(); },  
 99537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99610: () => { if (document.fullscreenElement) return 1; },  
 99656: () => { return document.getElementById('canvas').width; },  
 99708: () => { return screen.width; },  
 99733: () => { document.exitFullscreen(); },  
 99760: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99893: () => { return window.innerWidth; },  
 99919: () => { return window.innerHeight; },  
 99946: () => { if (document.fullscreenElement) return 1; },  
 99992: () => { return document.getElementById('canvas').width; },  
 100044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100112: () => { if (document.fullscreenElement) return 1; },  
 100158: () => { return document.getElementById('canvas').width; },  
 100210: () => { return screen.width; },  
 100235: () => { return window.innerWidth; },  
 100261: () => { return window.innerHeight; },  
 ...
 100411: () => { document.exitFullscreen(); },  
 100438: () => { if (document.fullscreenElement) return 1; },  
 100484: () => { return document.getElementById('canvas').width; },  
 100536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100604: () => { document.exitFullscreen(); },  
 100631: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100689: () => { return screen.width; },  
 100714: () => { return screen.height; },  
 100740: () => { return window.screenX; },  
 100767: () => { return window.screenY; },  
 100794: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100847: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100918: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100975: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101231: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101302: () => { if (document.fullscreenElement) return 1; },  
 101348: () => { return window.innerWidth; },  
 101374: () => { return window.innerHeight; },  
 101401: () => { if (document.pointerLockElement) return 1; }
};
