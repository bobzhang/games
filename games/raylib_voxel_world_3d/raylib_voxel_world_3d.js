...
function findWasmBinary() {
  return locateFile('raylib_voxel_world_3d.wasm');
}
...
var ASM_CONSTS = {
  103376: () => { if (document.fullscreenElement) return 1; },  
 103422: () => { return document.getElementById('canvas').width; },  
 103474: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103542: () => { document.exitFullscreen(); },  
 103569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103642: () => { if (document.fullscreenElement) return 1; },  
 103688: () => { return document.getElementById('canvas').width; },  
 103740: () => { return screen.width; },  
 103765: () => { document.exitFullscreen(); },  
 103792: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103925: () => { return window.innerWidth; },  
 103951: () => { return window.innerHeight; },  
 103978: () => { if (document.fullscreenElement) return 1; },  
 104024: () => { return document.getElementById('canvas').width; },  
 104076: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104144: () => { if (document.fullscreenElement) return 1; },  
 104190: () => { return document.getElementById('canvas').width; },  
 104242: () => { return screen.width; },  
 104267: () => { return window.innerWidth; },  
 104293: () => { return window.innerHeight; },  
 104320: () => { if (document.fullscreenElement) return 1; },  
 104366: () => { return document.getElementById('canvas').width; },  
 104418: () => { return screen.width; },  
 104443: () => { document.exitFullscreen(); },  
 104470: () => { if (document.fullscreenElement) return 1; },  
 104516: () => { return document.getElementById('canvas').width; },  
 104568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104636: () => { document.exitFullscreen(); },  
 104663: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104721: () => { return screen.width; },  
 104746: () => { return screen.height; },  
 104772: () => { return window.screenX; },  
 104799: () => { return window.screenY; },  
 104826: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104879: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104950: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105007: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105263: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105334: () => { if (document.fullscreenElement) return 1; },  
 105380: () => { return window.innerWidth; },  
 105406: () => { return window.innerHeight; },  
 105433: () => { if (document.pointerLockElement) return 1; }
};
