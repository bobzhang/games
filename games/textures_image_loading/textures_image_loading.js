...
var ASM_CONSTS = {
  268084: () => { if (document.fullscreenElement) return 1; },  
 268130: () => { return document.getElementById('canvas').width; },  
 268182: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268250: () => { document.exitFullscreen(); },  
 268277: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268350: () => { if (document.fullscreenElement) return 1; },  
 268396: () => { return document.getElementById('canvas').width; },  
 268448: () => { return screen.width; },  
 268473: () => { document.exitFullscreen(); },  
 268500: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268633: () => { return window.innerWidth; },  
 268659: () => { return window.innerHeight; },  
 268686: () => { if (document.fullscreenElement) return 1; },  
 268732: () => { return document.getElementById('canvas').width; },  
 268784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 268975: () => { return window.innerWidth; },  
 269001: () => { return window.innerHeight; },  
 269028: () => { if (document.fullscreenElement) return 1; },  
 269074: () => { return document.getElementById('canvas').width; },  
 269126: () => { return screen.width; },  
 269151: () => { document.exitFullscreen(); },  
 269178: () => { if (document.fullscreenElement) return 1; },  
 269224: () => { return document.getElementById('canvas').width; },  
 269276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269344: () => { document.exitFullscreen(); },  
 269371: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269429: () => { return screen.width; },  
 269454: () => { return screen.height; },  
 269480: () => { return window.screenX; },  
 269507: () => { return window.screenY; },  
 269534: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269587: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269658: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269971: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270042: () => { if (document.fullscreenElement) return 1; },  
 270088: () => { return window.innerWidth; },  
 270114: () => { return window.innerHeight; },  
 270141: () => { if (document.pointerLockElement) return 1; }
};
