...
var ASM_CONSTS = {
  260420: () => { if (document.fullscreenElement) return 1; },  
 260466: () => { return document.getElementById('canvas').width; },  
 260518: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260586: () => { document.exitFullscreen(); },  
 260613: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260686: () => { if (document.fullscreenElement) return 1; },  
 260732: () => { return document.getElementById('canvas').width; },  
 260784: () => { return screen.width; },  
 260809: () => { document.exitFullscreen(); },  
 260836: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260969: () => { return window.innerWidth; },  
 260995: () => { return window.innerHeight; },  
 261022: () => { if (document.fullscreenElement) return 1; },  
 261068: () => { return document.getElementById('canvas').width; },  
 261120: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261188: () => { if (document.fullscreenElement) return 1; },  
 261234: () => { return document.getElementById('canvas').width; },  
 261286: () => { return screen.width; },  
 261311: () => { return window.innerWidth; },  
 261337: () => { return window.innerHeight; },  
 ...
 261487: () => { document.exitFullscreen(); },  
 261514: () => { if (document.fullscreenElement) return 1; },  
 261560: () => { return document.getElementById('canvas').width; },  
 261612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261680: () => { document.exitFullscreen(); },  
 261707: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261765: () => { return screen.width; },  
 261790: () => { return screen.height; },  
 261816: () => { return window.screenX; },  
 261843: () => { return window.screenY; },  
 261870: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261923: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 261994: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262051: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262307: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262378: () => { if (document.fullscreenElement) return 1; },  
 262424: () => { return window.innerWidth; },  
 262450: () => { return window.innerHeight; },  
 262477: () => { if (document.pointerLockElement) return 1; }
};
