...
var ASM_CONSTS = {
  107512: () => { if (document.fullscreenElement) return 1; },  
 107558: () => { return document.getElementById('canvas').width; },  
 107610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107678: () => { document.exitFullscreen(); },  
 107705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107778: () => { if (document.fullscreenElement) return 1; },  
 107824: () => { return document.getElementById('canvas').width; },  
 107876: () => { return screen.width; },  
 107901: () => { document.exitFullscreen(); },  
 107928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108061: () => { return window.innerWidth; },  
 108087: () => { return window.innerHeight; },  
 108114: () => { if (document.fullscreenElement) return 1; },  
 108160: () => { return document.getElementById('canvas').width; },  
 108212: () => { return parseInt(document.getElementById('canvas').style.width); },  
