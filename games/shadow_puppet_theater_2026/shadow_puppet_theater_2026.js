...
var ASM_CONSTS = {
  263124: () => { if (document.fullscreenElement) return 1; },  
 263170: () => { return document.getElementById('canvas').width; },  
 263222: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263290: () => { document.exitFullscreen(); },  
 263317: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263390: () => { if (document.fullscreenElement) return 1; },  
 263436: () => { return document.getElementById('canvas').width; },  
 263488: () => { return screen.width; },  
 263513: () => { document.exitFullscreen(); },  
 263540: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263673: () => { return window.innerWidth; },  
 263699: () => { return window.innerHeight; },  
 263726: () => { if (document.fullscreenElement) return 1; },  
 263772: () => { return document.getElementById('canvas').width; },  
 263824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264015: () => { return window.innerWidth; },  
 264041: () => { return window.innerHeight; },  
 264068: () => { if (document.fullscreenElement) return 1; },  
 264114: () => { return document.getElementById('canvas').width; },  
 264166: () => { return screen.width; },  
 264191: () => { document.exitFullscreen(); },  
 264218: () => { if (document.fullscreenElement) return 1; },  
 264264: () => { return document.getElementById('canvas').width; },  
 264316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264384: () => { document.exitFullscreen(); },  
 264411: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264469: () => { return screen.width; },  
 264494: () => { return screen.height; },  
 264520: () => { return window.screenX; },  
 264547: () => { return window.screenY; },  
 264574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264627: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264698: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264755: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265011: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265082: () => { if (document.fullscreenElement) return 1; },  
 265128: () => { return window.innerWidth; },  
 265154: () => { return window.innerHeight; },  
 265181: () => { if (document.pointerLockElement) return 1; }
};
