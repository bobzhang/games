...
var ASM_CONSTS = {
 ...
 261462: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261530: () => { document.exitFullscreen(); },  
 261557: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261630: () => { if (document.fullscreenElement) return 1; },  
 261676: () => { return document.getElementById('canvas').width; },  
 261728: () => { return screen.width; },  
 261753: () => { document.exitFullscreen(); },  
 261780: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261913: () => { return window.innerWidth; },  
 261939: () => { return window.innerHeight; },  
 261966: () => { if (document.fullscreenElement) return 1; },  
 262012: () => { return document.getElementById('canvas').width; },  
 262064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262255: () => { return window.innerWidth; },  
 262281: () => { return window.innerHeight; },  
 ...
 262431: () => { document.exitFullscreen(); },  
 262458: () => { if (document.fullscreenElement) return 1; },  
 262504: () => { return document.getElementById('canvas').width; },  
 262556: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262624: () => { document.exitFullscreen(); },  
 262651: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262709: () => { return screen.width; },  
 262734: () => { return screen.height; },  
 262760: () => { return window.screenX; },  
 262787: () => { return window.screenY; },  
 262814: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262867: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262938: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262995: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263251: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263322: () => { if (document.fullscreenElement) return 1; },  
 263368: () => { return window.innerWidth; },  
 263394: () => { return window.innerHeight; },  
 263421: () => { if (document.pointerLockElement) return 1; }
};
