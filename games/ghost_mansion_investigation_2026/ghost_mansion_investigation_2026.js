...
var ASM_CONSTS = {
  261572: () => { if (document.fullscreenElement) return 1; },  
 261618: () => { return document.getElementById('canvas').width; },  
 261670: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261738: () => { document.exitFullscreen(); },  
 261765: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261838: () => { if (document.fullscreenElement) return 1; },  
 261884: () => { return document.getElementById('canvas').width; },  
 261936: () => { return screen.width; },  
 261961: () => { document.exitFullscreen(); },  
 261988: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262121: () => { return window.innerWidth; },  
 262147: () => { return window.innerHeight; },  
 262174: () => { if (document.fullscreenElement) return 1; },  
 262220: () => { return document.getElementById('canvas').width; },  
 262272: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262340: () => { if (document.fullscreenElement) return 1; },  
 262386: () => { return document.getElementById('canvas').width; },  
 262438: () => { return screen.width; },  
 262463: () => { return window.innerWidth; },  
 262489: () => { return window.innerHeight; },  
 262516: () => { if (document.fullscreenElement) return 1; },  
 262562: () => { return document.getElementById('canvas').width; },  
 262614: () => { return screen.width; },  
 262639: () => { document.exitFullscreen(); },  
 262666: () => { if (document.fullscreenElement) return 1; },  
 262712: () => { return document.getElementById('canvas').width; },  
 262764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262832: () => { document.exitFullscreen(); },  
 262859: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262917: () => { return screen.width; },  
 262942: () => { return screen.height; },  
 262968: () => { return window.screenX; },  
 262995: () => { return window.screenY; },  
 263022: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263075: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263146: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263203: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263459: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263530: () => { if (document.fullscreenElement) return 1; },  
 263576: () => { return window.innerWidth; },  
 263602: () => { return window.innerHeight; },  
 263629: () => { if (document.pointerLockElement) return 1; }
};
