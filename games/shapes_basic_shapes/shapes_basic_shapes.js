...
var ASM_CONSTS = {
  260884: () => { if (document.fullscreenElement) return 1; },  
 260930: () => { return document.getElementById('canvas').width; },  
 260982: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261050: () => { document.exitFullscreen(); },  
 261077: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261150: () => { if (document.fullscreenElement) return 1; },  
 261196: () => { return document.getElementById('canvas').width; },  
 261248: () => { return screen.width; },  
 261273: () => { document.exitFullscreen(); },  
 261300: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261433: () => { return window.innerWidth; },  
 261459: () => { return window.innerHeight; },  
 261486: () => { if (document.fullscreenElement) return 1; },  
 261532: () => { return document.getElementById('canvas').width; },  
 261584: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261775: () => { return window.innerWidth; },  
 261801: () => { return window.innerHeight; },  
 ...
 261951: () => { document.exitFullscreen(); },  
 ...
 262144: () => { document.exitFullscreen(); },  
 262171: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262229: () => { return screen.width; },  
 262254: () => { return screen.height; },  
 262280: () => { return window.screenX; },  
 262307: () => { return window.screenY; },  
 262334: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262387: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262458: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262515: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262771: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262842: () => { if (document.fullscreenElement) return 1; },  
 262888: () => { return window.innerWidth; },  
 262914: () => { return window.innerHeight; },  
 262941: () => { if (document.pointerLockElement) return 1; }
};
