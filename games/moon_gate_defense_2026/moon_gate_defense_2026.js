...
var ASM_CONSTS = {
 ...
 262694: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262762: () => { document.exitFullscreen(); },  
 262789: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262862: () => { if (document.fullscreenElement) return 1; },  
 262908: () => { return document.getElementById('canvas').width; },  
 262960: () => { return screen.width; },  
 262985: () => { document.exitFullscreen(); },  
 263012: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263145: () => { return window.innerWidth; },  
 263171: () => { return window.innerHeight; },  
 263198: () => { if (document.fullscreenElement) return 1; },  
 263244: () => { return document.getElementById('canvas').width; },  
 263296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263487: () => { return window.innerWidth; },  
 263513: () => { return window.innerHeight; },  
 263540: () => { if (document.fullscreenElement) return 1; },  
 263586: () => { return document.getElementById('canvas').width; },  
 263638: () => { return screen.width; },  
 263663: () => { document.exitFullscreen(); },  
 ...
 263856: () => { document.exitFullscreen(); },  
 263883: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263941: () => { return screen.width; },  
 263966: () => { return screen.height; },  
 263992: () => { return window.screenX; },  
 264019: () => { return window.screenY; },  
 264046: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264099: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264170: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264227: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264483: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264554: () => { if (document.fullscreenElement) return 1; },  
 264600: () => { return window.innerWidth; },  
 264626: () => { return window.innerHeight; },  
 264653: () => { if (document.pointerLockElement) return 1; }
};
