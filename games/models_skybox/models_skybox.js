...
var ASM_CONSTS = {
  285700: () => { if (document.fullscreenElement) return 1; },  
 285746: () => { return document.getElementById('canvas').width; },  
 285798: () => { return parseInt(document.getElementById('canvas').style.width); },  
 285866: () => { document.exitFullscreen(); },  
 285893: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 285966: () => { if (document.fullscreenElement) return 1; },  
 286012: () => { return document.getElementById('canvas').width; },  
 286064: () => { return screen.width; },  
 286089: () => { document.exitFullscreen(); },  
 286116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 286249: () => { return window.innerWidth; },  
 286275: () => { return window.innerHeight; },  
 286302: () => { if (document.fullscreenElement) return 1; },  
 286348: () => { return document.getElementById('canvas').width; },  
 286400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286468: () => { if (document.fullscreenElement) return 1; },  
 286514: () => { return document.getElementById('canvas').width; },  
 286566: () => { return screen.width; },  
 286591: () => { return window.innerWidth; },  
 286617: () => { return window.innerHeight; },  
 286644: () => { if (document.fullscreenElement) return 1; },  
 286690: () => { return document.getElementById('canvas').width; },  
 286742: () => { return screen.width; },  
 286767: () => { document.exitFullscreen(); },  
 286794: () => { if (document.fullscreenElement) return 1; },  
 286840: () => { return document.getElementById('canvas').width; },  
 286892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286960: () => { document.exitFullscreen(); },  
 286987: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 287045: () => { return screen.width; },  
 287070: () => { return screen.height; },  
 287096: () => { return window.screenX; },  
 287123: () => { return window.screenY; },  
 287150: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 287203: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 287274: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 287331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 287587: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 287658: () => { if (document.fullscreenElement) return 1; },  
 287704: () => { return window.innerWidth; },  
 287730: () => { return window.innerHeight; },  
 287757: () => { if (document.pointerLockElement) return 1; }
};
