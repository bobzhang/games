...
var ASM_CONSTS = {
  285524: () => { if (document.fullscreenElement) return 1; },  
 285570: () => { return document.getElementById('canvas').width; },  
 285622: () => { return parseInt(document.getElementById('canvas').style.width); },  
 285690: () => { document.exitFullscreen(); },  
 285717: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 285790: () => { if (document.fullscreenElement) return 1; },  
 285836: () => { return document.getElementById('canvas').width; },  
 285888: () => { return screen.width; },  
 285913: () => { document.exitFullscreen(); },  
 285940: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 286073: () => { return window.innerWidth; },  
 286099: () => { return window.innerHeight; },  
 286126: () => { if (document.fullscreenElement) return 1; },  
 286172: () => { return document.getElementById('canvas').width; },  
 286224: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286292: () => { if (document.fullscreenElement) return 1; },  
 286338: () => { return document.getElementById('canvas').width; },  
 286390: () => { return screen.width; },  
 286415: () => { return window.innerWidth; },  
 286441: () => { return window.innerHeight; },  
 ...
 286591: () => { document.exitFullscreen(); },  
 286618: () => { if (document.fullscreenElement) return 1; },  
 286664: () => { return document.getElementById('canvas').width; },  
 286716: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286784: () => { document.exitFullscreen(); },  
 286811: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 286869: () => { return screen.width; },  
 286894: () => { return screen.height; },  
 286920: () => { return window.screenX; },  
 286947: () => { return window.screenY; },  
 286974: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 287027: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 287098: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 287155: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 287411: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 287482: () => { if (document.fullscreenElement) return 1; },  
 287528: () => { return window.innerWidth; },  
 287554: () => { return window.innerHeight; },  
 287581: () => { if (document.pointerLockElement) return 1; }
};
