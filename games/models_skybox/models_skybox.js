...
var ASM_CONSTS = {
  285748: () => { if (document.fullscreenElement) return 1; },  
 285794: () => { return document.getElementById('canvas').width; },  
 285846: () => { return parseInt(document.getElementById('canvas').style.width); },  
 285914: () => { document.exitFullscreen(); },  
 285941: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 286014: () => { if (document.fullscreenElement) return 1; },  
 286060: () => { return document.getElementById('canvas').width; },  
 286112: () => { return screen.width; },  
 286137: () => { document.exitFullscreen(); },  
 286164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 286297: () => { return window.innerWidth; },  
 286323: () => { return window.innerHeight; },  
 286350: () => { if (document.fullscreenElement) return 1; },  
 286396: () => { return document.getElementById('canvas').width; },  
 286448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286516: () => { if (document.fullscreenElement) return 1; },  
 286562: () => { return document.getElementById('canvas').width; },  
 286614: () => { return screen.width; },  
 286639: () => { return window.innerWidth; },  
 286665: () => { return window.innerHeight; },  
 286692: () => { if (document.fullscreenElement) return 1; },  
 286738: () => { return document.getElementById('canvas').width; },  
 286790: () => { return screen.width; },  
 286815: () => { document.exitFullscreen(); },  
 286842: () => { if (document.fullscreenElement) return 1; },  
 286888: () => { return document.getElementById('canvas').width; },  
 286940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 287008: () => { document.exitFullscreen(); },  
 287035: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 287093: () => { return screen.width; },  
 287118: () => { return screen.height; },  
 287144: () => { return window.screenX; },  
 287171: () => { return window.screenY; },  
 287198: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 287251: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 287322: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 287379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 287635: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 287706: () => { if (document.fullscreenElement) return 1; },  
 287752: () => { return window.innerWidth; },  
 287778: () => { return window.innerHeight; },  
 287805: () => { if (document.pointerLockElement) return 1; }
};
