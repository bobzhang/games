...
function findWasmBinary() {
  return locateFile('raylib_models_cubicmap.wasm');
}
...
var ASM_CONSTS = {
 ...
 101778: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101992: () => { return document.getElementById('canvas').width; },  
 102044: () => { return screen.width; },  
 102069: () => { document.exitFullscreen(); },  
 102096: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102229: () => { return window.innerWidth; },  
 102255: () => { return window.innerHeight; },  
 102282: () => { if (document.fullscreenElement) return 1; },  
 102328: () => { return document.getElementById('canvas').width; },  
 102380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102448: () => { if (document.fullscreenElement) return 1; },  
 102494: () => { return document.getElementById('canvas').width; },  
 102546: () => { return screen.width; },  
 102571: () => { return window.innerWidth; },  
 102597: () => { return window.innerHeight; },  
 102624: () => { if (document.fullscreenElement) return 1; },  
 102670: () => { return document.getElementById('canvas').width; },  
 102722: () => { return screen.width; },  
 102747: () => { document.exitFullscreen(); },  
 102774: () => { if (document.fullscreenElement) return 1; },  
 102820: () => { return document.getElementById('canvas').width; },  
 102872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102940: () => { document.exitFullscreen(); },  
 102967: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103025: () => { return screen.width; },  
 103050: () => { return screen.height; },  
 103076: () => { return window.screenX; },  
 103103: () => { return window.screenY; },  
 103130: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103183: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103254: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103311: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103567: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103638: () => { if (document.fullscreenElement) return 1; },  
 103684: () => { return window.innerWidth; },  
 103710: () => { return window.innerHeight; },  
 103737: () => { if (document.pointerLockElement) return 1; }
};
