...
function findWasmBinary() {
  return locateFile('raylib_tower_defense_3d.wasm');
}
...
var ASM_CONSTS = {
  105680: () => { if (document.fullscreenElement) return 1; },  
 105726: () => { return document.getElementById('canvas').width; },  
 105778: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105846: () => { document.exitFullscreen(); },  
 105873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 105946: () => { if (document.fullscreenElement) return 1; },  
 105992: () => { return document.getElementById('canvas').width; },  
 106044: () => { return screen.width; },  
 106069: () => { document.exitFullscreen(); },  
 106096: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 106229: () => { return window.innerWidth; },  
 106255: () => { return window.innerHeight; },  
 106282: () => { if (document.fullscreenElement) return 1; },  
 106328: () => { return document.getElementById('canvas').width; },  
 106380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106448: () => { if (document.fullscreenElement) return 1; },  
 106494: () => { return document.getElementById('canvas').width; },  
 106546: () => { return screen.width; },  
 106571: () => { return window.innerWidth; },  
 106597: () => { return window.innerHeight; },  
 106624: () => { if (document.fullscreenElement) return 1; },  
 106670: () => { return document.getElementById('canvas').width; },  
 106722: () => { return screen.width; },  
 106747: () => { document.exitFullscreen(); },  
 106774: () => { if (document.fullscreenElement) return 1; },  
 106820: () => { return document.getElementById('canvas').width; },  
 106872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106940: () => { document.exitFullscreen(); },  
 106967: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107025: () => { return screen.width; },  
 107050: () => { return screen.height; },  
 107076: () => { return window.screenX; },  
 107103: () => { return window.screenY; },  
 107130: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107183: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 107254: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 107311: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 107567: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 107638: () => { if (document.fullscreenElement) return 1; },  
 107684: () => { return window.innerWidth; },  
 107710: () => { return window.innerHeight; },  
 107737: () => { if (document.pointerLockElement) return 1; }
};
