...
var ASM_CONSTS = {
  1369940: () => { if (document.fullscreenElement) return 1; },  
 1369986: () => { return document.getElementById('canvas').width; },  
 1370038: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1370106: () => { document.exitFullscreen(); },  
 1370133: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1370206: () => { if (document.fullscreenElement) return 1; },  
 1370252: () => { return document.getElementById('canvas').width; },  
 1370304: () => { return screen.width; },  
 1370329: () => { document.exitFullscreen(); },  
 1370356: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1370489: () => { return window.innerWidth; },  
 1370515: () => { return window.innerHeight; },  
 1370542: () => { if (document.fullscreenElement) return 1; },  
 1370588: () => { return document.getElementById('canvas').width; },  
 1370640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1370708: () => { if (document.fullscreenElement) return 1; },  
 1370754: () => { return document.getElementById('canvas').width; },  
 1370806: () => { return screen.width; },  
 1370831: () => { return window.innerWidth; },  
 1370857: () => { return window.innerHeight; },  
 1370884: () => { if (document.fullscreenElement) return 1; },  
 1370930: () => { return document.getElementById('canvas').width; },  
 1370982: () => { return screen.width; },  
 1371007: () => { document.exitFullscreen(); },  
 1371034: () => { if (document.fullscreenElement) return 1; },  
 1371080: () => { return document.getElementById('canvas').width; },  
 1371132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1371200: () => { document.exitFullscreen(); },  
 1371227: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1371285: () => { return screen.width; },  
 1371310: () => { return screen.height; },  
 1371336: () => { return window.screenX; },  
 1371363: () => { return window.screenY; },  
 1371390: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1371443: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1371514: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1371571: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1371827: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1371898: () => { if (document.fullscreenElement) return 1; },  
 1371944: () => { return window.innerWidth; },  
 1371970: () => { return window.innerHeight; },  
 1371997: () => { if (document.pointerLockElement) return 1; }
};
