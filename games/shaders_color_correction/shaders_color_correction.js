...
var ASM_CONSTS = {
  1370132: () => { if (document.fullscreenElement) return 1; },  
 1370178: () => { return document.getElementById('canvas').width; },  
 1370230: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1370298: () => { document.exitFullscreen(); },  
 1370325: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1370398: () => { if (document.fullscreenElement) return 1; },  
 1370444: () => { return document.getElementById('canvas').width; },  
 1370496: () => { return screen.width; },  
 1370521: () => { document.exitFullscreen(); },  
 1370548: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1370681: () => { return window.innerWidth; },  
 1370707: () => { return window.innerHeight; },  
 1370734: () => { if (document.fullscreenElement) return 1; },  
 1370780: () => { return document.getElementById('canvas').width; },  
 1370832: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1370900: () => { if (document.fullscreenElement) return 1; },  
 1370946: () => { return document.getElementById('canvas').width; },  
 1370998: () => { return screen.width; },  
 1371023: () => { return window.innerWidth; },  
 1371049: () => { return window.innerHeight; },  
 1371076: () => { if (document.fullscreenElement) return 1; },  
 1371122: () => { return document.getElementById('canvas').width; },  
 1371174: () => { return screen.width; },  
 1371199: () => { document.exitFullscreen(); },  
 1371226: () => { if (document.fullscreenElement) return 1; },  
 1371272: () => { return document.getElementById('canvas').width; },  
 1371324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1371392: () => { document.exitFullscreen(); },  
 1371419: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1371477: () => { return screen.width; },  
 1371502: () => { return screen.height; },  
 1371528: () => { return window.screenX; },  
 1371555: () => { return window.screenY; },  
 1371582: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1371635: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1371706: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1371763: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1372019: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1372090: () => { if (document.fullscreenElement) return 1; },  
 1372136: () => { return window.innerWidth; },  
 1372162: () => { return window.innerHeight; },  
 1372189: () => { if (document.pointerLockElement) return 1; }
};
