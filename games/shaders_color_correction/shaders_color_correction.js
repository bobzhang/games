...
var ASM_CONSTS = {
  1370148: () => { if (document.fullscreenElement) return 1; },  
 1370194: () => { return document.getElementById('canvas').width; },  
 1370246: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1370314: () => { document.exitFullscreen(); },  
 1370341: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1370414: () => { if (document.fullscreenElement) return 1; },  
 1370460: () => { return document.getElementById('canvas').width; },  
 1370512: () => { return screen.width; },  
 1370537: () => { document.exitFullscreen(); },  
 1370564: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1370697: () => { return window.innerWidth; },  
 1370723: () => { return window.innerHeight; },  
 1370750: () => { if (document.fullscreenElement) return 1; },  
 1370796: () => { return document.getElementById('canvas').width; },  
 1370848: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1370916: () => { if (document.fullscreenElement) return 1; },  
 1370962: () => { return document.getElementById('canvas').width; },  
 1371014: () => { return screen.width; },  
 1371039: () => { return window.innerWidth; },  
 1371065: () => { return window.innerHeight; },  
 1371092: () => { if (document.fullscreenElement) return 1; },  
 1371138: () => { return document.getElementById('canvas').width; },  
 1371190: () => { return screen.width; },  
 1371215: () => { document.exitFullscreen(); },  
 1371242: () => { if (document.fullscreenElement) return 1; },  
 1371288: () => { return document.getElementById('canvas').width; },  
 1371340: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1371408: () => { document.exitFullscreen(); },  
 1371435: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1371493: () => { return screen.width; },  
 1371518: () => { return screen.height; },  
 1371544: () => { return window.screenX; },  
 1371571: () => { return window.screenY; },  
 1371598: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1371651: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1371722: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1371779: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1372035: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1372106: () => { if (document.fullscreenElement) return 1; },  
 1372152: () => { return window.innerWidth; },  
 1372178: () => { return window.innerHeight; },  
 1372205: () => { if (document.pointerLockElement) return 1; }
};
