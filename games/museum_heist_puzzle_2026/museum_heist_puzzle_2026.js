...
var ASM_CONSTS = {
 ...
 262838: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262906: () => { document.exitFullscreen(); },  
 262933: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263006: () => { if (document.fullscreenElement) return 1; },  
 263052: () => { return document.getElementById('canvas').width; },  
 263104: () => { return screen.width; },  
 263129: () => { document.exitFullscreen(); },  
 263156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263289: () => { return window.innerWidth; },  
 263315: () => { return window.innerHeight; },  
 263342: () => { if (document.fullscreenElement) return 1; },  
 263388: () => { return document.getElementById('canvas').width; },  
 263440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263631: () => { return window.innerWidth; },  
 263657: () => { return window.innerHeight; },  
 263684: () => { if (document.fullscreenElement) return 1; },  
 263730: () => { return document.getElementById('canvas').width; },  
 263782: () => { return screen.width; },  
 263807: () => { document.exitFullscreen(); },  
 ...
 264000: () => { document.exitFullscreen(); },  
 264027: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264085: () => { return screen.width; },  
 264110: () => { return screen.height; },  
 264136: () => { return window.screenX; },  
 264163: () => { return window.screenY; },  
 264190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264371: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264627: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264698: () => { if (document.fullscreenElement) return 1; },  
 264744: () => { return window.innerWidth; },  
 264770: () => { return window.innerHeight; },  
 264797: () => { if (document.pointerLockElement) return 1; }
};
