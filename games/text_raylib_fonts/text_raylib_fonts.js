...
var ASM_CONSTS = {
  294804: () => { if (document.fullscreenElement) return 1; },  
 294850: () => { return document.getElementById('canvas').width; },  
 294902: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294970: () => { document.exitFullscreen(); },  
 294997: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 295070: () => { if (document.fullscreenElement) return 1; },  
 295116: () => { return document.getElementById('canvas').width; },  
 295168: () => { return screen.width; },  
 295193: () => { document.exitFullscreen(); },  
 295220: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 295353: () => { return window.innerWidth; },  
 295379: () => { return window.innerHeight; },  
 295406: () => { if (document.fullscreenElement) return 1; },  
 295452: () => { return document.getElementById('canvas').width; },  
 295504: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295572: () => { if (document.fullscreenElement) return 1; },  
 295618: () => { return document.getElementById('canvas').width; },  
 295670: () => { return screen.width; },  
 295695: () => { return window.innerWidth; },  
 295721: () => { return window.innerHeight; },  
 295748: () => { if (document.fullscreenElement) return 1; },  
 295794: () => { return document.getElementById('canvas').width; },  
 295846: () => { return screen.width; },  
 295871: () => { document.exitFullscreen(); },  
 295898: () => { if (document.fullscreenElement) return 1; },  
 295944: () => { return document.getElementById('canvas').width; },  
 295996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 296064: () => { document.exitFullscreen(); },  
 296091: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 296149: () => { return screen.width; },  
 296174: () => { return screen.height; },  
 296200: () => { return window.screenX; },  
 296227: () => { return window.screenY; },  
 296254: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 296307: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 296378: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 296435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 296691: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 296762: () => { if (document.fullscreenElement) return 1; },  
 296808: () => { return window.innerWidth; },  
 296834: () => { return window.innerHeight; },  
 296861: () => { if (document.pointerLockElement) return 1; }
};
