...
var ASM_CONSTS = {
  294788: () => { if (document.fullscreenElement) return 1; },  
 294834: () => { return document.getElementById('canvas').width; },  
 294886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294954: () => { document.exitFullscreen(); },  
 294981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 295054: () => { if (document.fullscreenElement) return 1; },  
 295100: () => { return document.getElementById('canvas').width; },  
 295152: () => { return screen.width; },  
 295177: () => { document.exitFullscreen(); },  
 295204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 295337: () => { return window.innerWidth; },  
 295363: () => { return window.innerHeight; },  
 295390: () => { if (document.fullscreenElement) return 1; },  
 295436: () => { return document.getElementById('canvas').width; },  
 295488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295556: () => { if (document.fullscreenElement) return 1; },  
 295602: () => { return document.getElementById('canvas').width; },  
 295654: () => { return screen.width; },  
 295679: () => { return window.innerWidth; },  
 295705: () => { return window.innerHeight; },  
 295732: () => { if (document.fullscreenElement) return 1; },  
 295778: () => { return document.getElementById('canvas').width; },  
 295830: () => { return screen.width; },  
 295855: () => { document.exitFullscreen(); },  
 295882: () => { if (document.fullscreenElement) return 1; },  
 295928: () => { return document.getElementById('canvas').width; },  
 295980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 296048: () => { document.exitFullscreen(); },  
 296075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 296133: () => { return screen.width; },  
 296158: () => { return screen.height; },  
 296184: () => { return window.screenX; },  
 296211: () => { return window.screenY; },  
 296238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 296291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 296362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 296419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 296675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 296746: () => { if (document.fullscreenElement) return 1; },  
 296792: () => { return window.innerWidth; },  
 296818: () => { return window.innerHeight; },  
 296845: () => { if (document.pointerLockElement) return 1; }
};
