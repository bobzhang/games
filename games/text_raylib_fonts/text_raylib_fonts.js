...
var ASM_CONSTS = {
  294800: () => { if (document.fullscreenElement) return 1; },  
 294846: () => { return document.getElementById('canvas').width; },  
 294898: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294966: () => { document.exitFullscreen(); },  
 294993: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 295066: () => { if (document.fullscreenElement) return 1; },  
 295112: () => { return document.getElementById('canvas').width; },  
 295164: () => { return screen.width; },  
 295189: () => { document.exitFullscreen(); },  
 295216: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 295349: () => { return window.innerWidth; },  
 295375: () => { return window.innerHeight; },  
 295402: () => { if (document.fullscreenElement) return 1; },  
 295448: () => { return document.getElementById('canvas').width; },  
 295500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295568: () => { if (document.fullscreenElement) return 1; },  
 295614: () => { return document.getElementById('canvas').width; },  
 295666: () => { return screen.width; },  
 295691: () => { return window.innerWidth; },  
 295717: () => { return window.innerHeight; },  
 295744: () => { if (document.fullscreenElement) return 1; },  
 295790: () => { return document.getElementById('canvas').width; },  
 295842: () => { return screen.width; },  
 295867: () => { document.exitFullscreen(); },  
 295894: () => { if (document.fullscreenElement) return 1; },  
 295940: () => { return document.getElementById('canvas').width; },  
 295992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 296060: () => { document.exitFullscreen(); },  
 296087: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 296145: () => { return screen.width; },  
 296170: () => { return screen.height; },  
 296196: () => { return window.screenX; },  
 296223: () => { return window.screenY; },  
 296250: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 296303: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 296374: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 296431: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 296687: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 296758: () => { if (document.fullscreenElement) return 1; },  
 296804: () => { return window.innerWidth; },  
 296830: () => { return window.innerHeight; },  
 296857: () => { if (document.pointerLockElement) return 1; }
};
