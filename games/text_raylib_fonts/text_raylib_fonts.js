...
var ASM_CONSTS = {
  294596: () => { if (document.fullscreenElement) return 1; },  
 294642: () => { return document.getElementById('canvas').width; },  
 294694: () => { return parseInt(document.getElementById('canvas').style.width); },  
 294762: () => { document.exitFullscreen(); },  
 294789: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 294862: () => { if (document.fullscreenElement) return 1; },  
 294908: () => { return document.getElementById('canvas').width; },  
 294960: () => { return screen.width; },  
 294985: () => { document.exitFullscreen(); },  
 295012: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 295145: () => { return window.innerWidth; },  
 295171: () => { return window.innerHeight; },  
 295198: () => { if (document.fullscreenElement) return 1; },  
 295244: () => { return document.getElementById('canvas').width; },  
 295296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295364: () => { if (document.fullscreenElement) return 1; },  
 295410: () => { return document.getElementById('canvas').width; },  
 295462: () => { return screen.width; },  
 295487: () => { return window.innerWidth; },  
 295513: () => { return window.innerHeight; },  
 295540: () => { if (document.fullscreenElement) return 1; },  
 295586: () => { return document.getElementById('canvas').width; },  
 295638: () => { return screen.width; },  
 295663: () => { document.exitFullscreen(); },  
 295690: () => { if (document.fullscreenElement) return 1; },  
 295736: () => { return document.getElementById('canvas').width; },  
 295788: () => { return parseInt(document.getElementById('canvas').style.width); },  
 295856: () => { document.exitFullscreen(); },  
 295883: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 295941: () => { return screen.width; },  
 295966: () => { return screen.height; },  
 295992: () => { return window.screenX; },  
 296019: () => { return window.screenY; },  
 296046: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 296099: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 296170: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 296227: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 296483: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 296554: () => { if (document.fullscreenElement) return 1; },  
 296600: () => { return window.innerWidth; },  
 296626: () => { return window.innerHeight; },  
 296653: () => { if (document.pointerLockElement) return 1; }
};
