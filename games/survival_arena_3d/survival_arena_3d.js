...
var ASM_CONSTS = {
 ...
 265334: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265402: () => { document.exitFullscreen(); },  
 265429: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265502: () => { if (document.fullscreenElement) return 1; },  
 265548: () => { return document.getElementById('canvas').width; },  
 265600: () => { return screen.width; },  
 265625: () => { document.exitFullscreen(); },  
 265652: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265785: () => { return window.innerWidth; },  
 265811: () => { return window.innerHeight; },  
 265838: () => { if (document.fullscreenElement) return 1; },  
 265884: () => { return document.getElementById('canvas').width; },  
 265936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266004: () => { if (document.fullscreenElement) return 1; },  
 266050: () => { return document.getElementById('canvas').width; },  
 266102: () => { return screen.width; },  
 266127: () => { return window.innerWidth; },  
 266153: () => { return window.innerHeight; },  
 266180: () => { if (document.fullscreenElement) return 1; },  
 266226: () => { return document.getElementById('canvas').width; },  
 266278: () => { return screen.width; },  
 266303: () => { document.exitFullscreen(); },  
 266330: () => { if (document.fullscreenElement) return 1; },  
 266376: () => { return document.getElementById('canvas').width; },  
 266428: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266496: () => { document.exitFullscreen(); },  
 266523: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266581: () => { return screen.width; },  
 266606: () => { return screen.height; },  
 266632: () => { return window.screenX; },  
 266659: () => { return window.screenY; },  
 266686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266739: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266810: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266867: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267123: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 267194: () => { if (document.fullscreenElement) return 1; },  
 267240: () => { return window.innerWidth; },  
 267266: () => { return window.innerHeight; },  
 267293: () => { if (document.pointerLockElement) return 1; }
};
