...
var ASM_CONSTS = {
  265460: () => { if (document.fullscreenElement) return 1; },  
 265506: () => { return document.getElementById('canvas').width; },  
 265558: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265626: () => { document.exitFullscreen(); },  
 265653: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265726: () => { if (document.fullscreenElement) return 1; },  
 265772: () => { return document.getElementById('canvas').width; },  
 265824: () => { return screen.width; },  
 265849: () => { document.exitFullscreen(); },  
 265876: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 266009: () => { return window.innerWidth; },  
 266035: () => { return window.innerHeight; },  
 266062: () => { if (document.fullscreenElement) return 1; },  
 266108: () => { return document.getElementById('canvas').width; },  
 266160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266228: () => { if (document.fullscreenElement) return 1; },  
 266274: () => { return document.getElementById('canvas').width; },  
 266326: () => { return screen.width; },  
 266351: () => { return window.innerWidth; },  
 266377: () => { return window.innerHeight; },  
 266404: () => { if (document.fullscreenElement) return 1; },  
 266450: () => { return document.getElementById('canvas').width; },  
 266502: () => { return screen.width; },  
 266527: () => { document.exitFullscreen(); },  
 266554: () => { if (document.fullscreenElement) return 1; },  
 266600: () => { return document.getElementById('canvas').width; },  
 266652: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266720: () => { document.exitFullscreen(); },  
 266747: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266805: () => { return screen.width; },  
 266830: () => { return screen.height; },  
 266856: () => { return window.screenX; },  
 266883: () => { return window.screenY; },  
 266910: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266963: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267034: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267091: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267347: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 267418: () => { if (document.fullscreenElement) return 1; },  
 267464: () => { return window.innerWidth; },  
 267490: () => { return window.innerHeight; },  
 267517: () => { if (document.pointerLockElement) return 1; }
};
