...
var ASM_CONSTS = {
 ...
 265526: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265594: () => { document.exitFullscreen(); },  
 265621: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265694: () => { if (document.fullscreenElement) return 1; },  
 265740: () => { return document.getElementById('canvas').width; },  
 265792: () => { return screen.width; },  
 265817: () => { document.exitFullscreen(); },  
 265844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265977: () => { return window.innerWidth; },  
 266003: () => { return window.innerHeight; },  
 266030: () => { if (document.fullscreenElement) return 1; },  
 266076: () => { return document.getElementById('canvas').width; },  
 266128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266196: () => { if (document.fullscreenElement) return 1; },  
 266242: () => { return document.getElementById('canvas').width; },  
 266294: () => { return screen.width; },  
 266319: () => { return window.innerWidth; },  
 266345: () => { return window.innerHeight; },  
 266372: () => { if (document.fullscreenElement) return 1; },  
 266418: () => { return document.getElementById('canvas').width; },  
 266470: () => { return screen.width; },  
 266495: () => { document.exitFullscreen(); },  
 266522: () => { if (document.fullscreenElement) return 1; },  
 266568: () => { return document.getElementById('canvas').width; },  
 266620: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266688: () => { document.exitFullscreen(); },  
 266715: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266773: () => { return screen.width; },  
 266798: () => { return screen.height; },  
 266824: () => { return window.screenX; },  
 266851: () => { return window.screenY; },  
 266878: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266931: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267002: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267059: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267315: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 267386: () => { if (document.fullscreenElement) return 1; },  
 267432: () => { return window.innerWidth; },  
 267458: () => { return window.innerHeight; },  
 267485: () => { if (document.pointerLockElement) return 1; }
};
