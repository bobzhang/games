...
var ASM_CONSTS = {
  260788: () => { if (document.fullscreenElement) return 1; },  
 260834: () => { return document.getElementById('canvas').width; },  
 260886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260954: () => { document.exitFullscreen(); },  
 260981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261054: () => { if (document.fullscreenElement) return 1; },  
 261100: () => { return document.getElementById('canvas').width; },  
 261152: () => { return screen.width; },  
 261177: () => { document.exitFullscreen(); },  
 261204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261337: () => { return window.innerWidth; },  
 261363: () => { return window.innerHeight; },  
 261390: () => { if (document.fullscreenElement) return 1; },  
 261436: () => { return document.getElementById('canvas').width; },  
 261488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261556: () => { if (document.fullscreenElement) return 1; },  
 261602: () => { return document.getElementById('canvas').width; },  
 261654: () => { return screen.width; },  
 261679: () => { return window.innerWidth; },  
 261705: () => { return window.innerHeight; },  
 261732: () => { if (document.fullscreenElement) return 1; },  
 261778: () => { return document.getElementById('canvas').width; },  
 261830: () => { return screen.width; },  
 261855: () => { document.exitFullscreen(); },  
 261882: () => { if (document.fullscreenElement) return 1; },  
 261928: () => { return document.getElementById('canvas').width; },  
 261980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262048: () => { document.exitFullscreen(); },  
 262075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262133: () => { return screen.width; },  
 262158: () => { return screen.height; },  
 262184: () => { return window.screenX; },  
 262211: () => { return window.screenY; },  
 262238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262746: () => { if (document.fullscreenElement) return 1; },  
 262792: () => { return window.innerWidth; },  
 262818: () => { return window.innerHeight; },  
 262845: () => { if (document.pointerLockElement) return 1; }
};
