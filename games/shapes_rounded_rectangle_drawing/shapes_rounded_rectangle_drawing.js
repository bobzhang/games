...
var ASM_CONSTS = {
  260996: () => { if (document.fullscreenElement) return 1; },  
 261042: () => { return document.getElementById('canvas').width; },  
 261094: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261162: () => { document.exitFullscreen(); },  
 261189: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261262: () => { if (document.fullscreenElement) return 1; },  
 261308: () => { return document.getElementById('canvas').width; },  
 261360: () => { return screen.width; },  
 261385: () => { document.exitFullscreen(); },  
 261412: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261545: () => { return window.innerWidth; },  
 261571: () => { return window.innerHeight; },  
 261598: () => { if (document.fullscreenElement) return 1; },  
 261644: () => { return document.getElementById('canvas').width; },  
 261696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261764: () => { if (document.fullscreenElement) return 1; },  
 261810: () => { return document.getElementById('canvas').width; },  
 261862: () => { return screen.width; },  
 261887: () => { return window.innerWidth; },  
 261913: () => { return window.innerHeight; },  
 261940: () => { if (document.fullscreenElement) return 1; },  
 261986: () => { return document.getElementById('canvas').width; },  
 262038: () => { return screen.width; },  
 262063: () => { document.exitFullscreen(); },  
 262090: () => { if (document.fullscreenElement) return 1; },  
 262136: () => { return document.getElementById('canvas').width; },  
 262188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262256: () => { document.exitFullscreen(); },  
 262283: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262341: () => { return screen.width; },  
 262366: () => { return screen.height; },  
 262392: () => { return window.screenX; },  
 262419: () => { return window.screenY; },  
 262446: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262499: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262570: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262627: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262883: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262954: () => { if (document.fullscreenElement) return 1; },  
 263000: () => { return window.innerWidth; },  
 263026: () => { return window.innerHeight; },  
 263053: () => { if (document.pointerLockElement) return 1; }
};
