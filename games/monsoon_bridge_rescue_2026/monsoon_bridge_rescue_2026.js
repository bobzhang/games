...
var ASM_CONSTS = {
  263364: () => { if (document.fullscreenElement) return 1; },  
 263410: () => { return document.getElementById('canvas').width; },  
 263462: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263530: () => { document.exitFullscreen(); },  
 263557: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263630: () => { if (document.fullscreenElement) return 1; },  
 263676: () => { return document.getElementById('canvas').width; },  
 263728: () => { return screen.width; },  
 263753: () => { document.exitFullscreen(); },  
 263780: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263913: () => { return window.innerWidth; },  
 263939: () => { return window.innerHeight; },  
 263966: () => { if (document.fullscreenElement) return 1; },  
 264012: () => { return document.getElementById('canvas').width; },  
 264064: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264132: () => { if (document.fullscreenElement) return 1; },  
 264178: () => { return document.getElementById('canvas').width; },  
 264230: () => { return screen.width; },  
 264255: () => { return window.innerWidth; },  
 264281: () => { return window.innerHeight; },  
 ...
 264431: () => { document.exitFullscreen(); },  
 264458: () => { if (document.fullscreenElement) return 1; },  
 264504: () => { return document.getElementById('canvas').width; },  
 264556: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264624: () => { document.exitFullscreen(); },  
 264651: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264709: () => { return screen.width; },  
 264734: () => { return screen.height; },  
 264760: () => { return window.screenX; },  
 264787: () => { return window.screenY; },  
 264814: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264867: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264938: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264995: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265251: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265322: () => { if (document.fullscreenElement) return 1; },  
 265368: () => { return window.innerWidth; },  
 265394: () => { return window.innerHeight; },  
 265421: () => { if (document.pointerLockElement) return 1; }
};
