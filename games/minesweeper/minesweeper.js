...
var ASM_CONSTS = {
  260436: () => { if (document.fullscreenElement) return 1; },  
 260482: () => { return document.getElementById('canvas').width; },  
 260534: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260602: () => { document.exitFullscreen(); },  
 260629: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260702: () => { if (document.fullscreenElement) return 1; },  
 260748: () => { return document.getElementById('canvas').width; },  
 260800: () => { return screen.width; },  
 260825: () => { document.exitFullscreen(); },  
 260852: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260985: () => { return window.innerWidth; },  
 261011: () => { return window.innerHeight; },  
 261038: () => { if (document.fullscreenElement) return 1; },  
 261084: () => { return document.getElementById('canvas').width; },  
 261136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261204: () => { if (document.fullscreenElement) return 1; },  
 261250: () => { return document.getElementById('canvas').width; },  
 261302: () => { return screen.width; },  
 261327: () => { return window.innerWidth; },  
 261353: () => { return window.innerHeight; },  
 ...
 261503: () => { document.exitFullscreen(); },  
 ...
 261696: () => { document.exitFullscreen(); },  
 261723: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261781: () => { return screen.width; },  
 261806: () => { return screen.height; },  
 261832: () => { return window.screenX; },  
 261859: () => { return window.screenY; },  
 261886: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261939: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262010: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262067: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262323: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262394: () => { if (document.fullscreenElement) return 1; },  
 262440: () => { return window.innerWidth; },  
 262466: () => { return window.innerHeight; },  
 262493: () => { if (document.pointerLockElement) return 1; }
};
