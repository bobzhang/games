...
function findWasmBinary() {
  return locateFile('raylib_shaders_vertex_displacement.wasm');
}
...
var ASM_CONSTS = {
  101328: () => { if (document.fullscreenElement) return 1; },  
 101374: () => { return document.getElementById('canvas').width; },  
 101426: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101494: () => { document.exitFullscreen(); },  
 101521: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101594: () => { if (document.fullscreenElement) return 1; },  
 101640: () => { return document.getElementById('canvas').width; },  
 101692: () => { return screen.width; },  
 101717: () => { document.exitFullscreen(); },  
 101744: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101877: () => { return window.innerWidth; },  
 101903: () => { return window.innerHeight; },  
 101930: () => { if (document.fullscreenElement) return 1; },  
 101976: () => { return document.getElementById('canvas').width; },  
 102028: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102096: () => { if (document.fullscreenElement) return 1; },  
 102142: () => { return document.getElementById('canvas').width; },  
 102194: () => { return screen.width; },  
 102219: () => { return window.innerWidth; },  
 102245: () => { return window.innerHeight; },  
 102272: () => { if (document.fullscreenElement) return 1; },  
 102318: () => { return document.getElementById('canvas').width; },  
 102370: () => { return screen.width; },  
 102395: () => { document.exitFullscreen(); },  
 102422: () => { if (document.fullscreenElement) return 1; },  
 102468: () => { return document.getElementById('canvas').width; },  
 102520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102588: () => { document.exitFullscreen(); },  
 102615: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102673: () => { return screen.width; },  
 102698: () => { return screen.height; },  
 102724: () => { return window.screenX; },  
 102751: () => { return window.screenY; },  
 102778: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102831: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102902: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102959: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103215: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103286: () => { if (document.fullscreenElement) return 1; },  
 103332: () => { return window.innerWidth; },  
 103358: () => { return window.innerHeight; },  
 103385: () => { if (document.pointerLockElement) return 1; }
};
