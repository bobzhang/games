...
var ASM_CONSTS = {
 ...
 264166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264234: () => { document.exitFullscreen(); },  
 264261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264334: () => { if (document.fullscreenElement) return 1; },  
 264380: () => { return document.getElementById('canvas').width; },  
 264432: () => { return screen.width; },  
 264457: () => { document.exitFullscreen(); },  
 264484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264617: () => { return window.innerWidth; },  
 264643: () => { return window.innerHeight; },  
 264670: () => { if (document.fullscreenElement) return 1; },  
 264716: () => { return document.getElementById('canvas').width; },  
 264768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264959: () => { return window.innerWidth; },  
 264985: () => { return window.innerHeight; },  
 265012: () => { if (document.fullscreenElement) return 1; },  
 265058: () => { return document.getElementById('canvas').width; },  
 265110: () => { return screen.width; },  
 265135: () => { document.exitFullscreen(); },  
 265162: () => { if (document.fullscreenElement) return 1; },  
 265208: () => { return document.getElementById('canvas').width; },  
 265260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265328: () => { document.exitFullscreen(); },  
 265355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265413: () => { return screen.width; },  
 265438: () => { return screen.height; },  
 265464: () => { return window.screenX; },  
 265491: () => { return window.screenY; },  
 265518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266026: () => { if (document.fullscreenElement) return 1; },  
 266072: () => { return window.innerWidth; },  
 266098: () => { return window.innerHeight; },  
 266125: () => { if (document.pointerLockElement) return 1; }
};
