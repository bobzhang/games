...
var ASM_CONSTS = {
 ...
 264374: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264442: () => { document.exitFullscreen(); },  
 264469: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264542: () => { if (document.fullscreenElement) return 1; },  
 264588: () => { return document.getElementById('canvas').width; },  
 264640: () => { return screen.width; },  
 264665: () => { document.exitFullscreen(); },  
 264692: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264825: () => { return window.innerWidth; },  
 264851: () => { return window.innerHeight; },  
 264878: () => { if (document.fullscreenElement) return 1; },  
 264924: () => { return document.getElementById('canvas').width; },  
 264976: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265044: () => { if (document.fullscreenElement) return 1; },  
 265090: () => { return document.getElementById('canvas').width; },  
 265142: () => { return screen.width; },  
 265167: () => { return window.innerWidth; },  
 265193: () => { return window.innerHeight; },  
 265220: () => { if (document.fullscreenElement) return 1; },  
 265266: () => { return document.getElementById('canvas').width; },  
 265318: () => { return screen.width; },  
 265343: () => { document.exitFullscreen(); },  
 265370: () => { if (document.fullscreenElement) return 1; },  
 265416: () => { return document.getElementById('canvas').width; },  
 265468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265536: () => { document.exitFullscreen(); },  
 265563: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265621: () => { return screen.width; },  
 265646: () => { return screen.height; },  
 265672: () => { return window.screenX; },  
 265699: () => { return window.screenY; },  
 265726: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265779: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265850: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265907: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266163: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266234: () => { if (document.fullscreenElement) return 1; },  
 266280: () => { return window.innerWidth; },  
 266306: () => { return window.innerHeight; },  
 266333: () => { if (document.pointerLockElement) return 1; }
};
