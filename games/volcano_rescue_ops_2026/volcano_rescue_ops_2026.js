...
var ASM_CONSTS = {
 ...
 264358: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264426: () => { document.exitFullscreen(); },  
 264453: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264526: () => { if (document.fullscreenElement) return 1; },  
 264572: () => { return document.getElementById('canvas').width; },  
 264624: () => { return screen.width; },  
 264649: () => { document.exitFullscreen(); },  
 264676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264809: () => { return window.innerWidth; },  
 264835: () => { return window.innerHeight; },  
 264862: () => { if (document.fullscreenElement) return 1; },  
 264908: () => { return document.getElementById('canvas').width; },  
 264960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 265151: () => { return window.innerWidth; },  
 265177: () => { return window.innerHeight; },  
 265204: () => { if (document.fullscreenElement) return 1; },  
 265250: () => { return document.getElementById('canvas').width; },  
 265302: () => { return screen.width; },  
 265327: () => { document.exitFullscreen(); },  
 265354: () => { if (document.fullscreenElement) return 1; },  
 265400: () => { return document.getElementById('canvas').width; },  
 265452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265520: () => { document.exitFullscreen(); },  
 265547: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265605: () => { return screen.width; },  
 265630: () => { return screen.height; },  
 265656: () => { return window.screenX; },  
 265683: () => { return window.screenY; },  
 265710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265763: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265834: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266147: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266218: () => { if (document.fullscreenElement) return 1; },  
 266264: () => { return window.innerWidth; },  
 266290: () => { return window.innerHeight; },  
 266317: () => { if (document.pointerLockElement) return 1; }
};
