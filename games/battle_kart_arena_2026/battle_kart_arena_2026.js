...
var ASM_CONSTS = {
  261300: () => { if (document.fullscreenElement) return 1; },  
 261346: () => { return document.getElementById('canvas').width; },  
 261398: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261466: () => { document.exitFullscreen(); },  
 261493: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261566: () => { if (document.fullscreenElement) return 1; },  
 261612: () => { return document.getElementById('canvas').width; },  
 261664: () => { return screen.width; },  
 261689: () => { document.exitFullscreen(); },  
 261716: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261849: () => { return window.innerWidth; },  
 261875: () => { return window.innerHeight; },  
 261902: () => { if (document.fullscreenElement) return 1; },  
 261948: () => { return document.getElementById('canvas').width; },  
 262000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262191: () => { return window.innerWidth; },  
 262217: () => { return window.innerHeight; },  
 ...
 262367: () => { document.exitFullscreen(); },  
 262394: () => { if (document.fullscreenElement) return 1; },  
 262440: () => { return document.getElementById('canvas').width; },  
 262492: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262560: () => { document.exitFullscreen(); },  
 262587: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262645: () => { return screen.width; },  
 262670: () => { return screen.height; },  
 262696: () => { return window.screenX; },  
 262723: () => { return window.screenY; },  
 262750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262803: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262874: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262931: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263187: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263258: () => { if (document.fullscreenElement) return 1; },  
 263304: () => { return window.innerWidth; },  
 263330: () => { return window.innerHeight; },  
 263357: () => { if (document.pointerLockElement) return 1; }
};
