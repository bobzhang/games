...
var ASM_CONSTS = {
 ...
 261622: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261690: () => { document.exitFullscreen(); },  
 261717: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261790: () => { if (document.fullscreenElement) return 1; },  
 261836: () => { return document.getElementById('canvas').width; },  
 261888: () => { return screen.width; },  
 261913: () => { document.exitFullscreen(); },  
 261940: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262073: () => { return window.innerWidth; },  
 262099: () => { return window.innerHeight; },  
 262126: () => { if (document.fullscreenElement) return 1; },  
 262172: () => { return document.getElementById('canvas').width; },  
 262224: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262415: () => { return window.innerWidth; },  
 262441: () => { return window.innerHeight; },  
 262468: () => { if (document.fullscreenElement) return 1; },  
 262514: () => { return document.getElementById('canvas').width; },  
 262566: () => { return screen.width; },  
 262591: () => { document.exitFullscreen(); },  
 262618: () => { if (document.fullscreenElement) return 1; },  
 262664: () => { return document.getElementById('canvas').width; },  
 262716: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262784: () => { document.exitFullscreen(); },  
 262811: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262869: () => { return screen.width; },  
 262894: () => { return screen.height; },  
 262920: () => { return window.screenX; },  
 262947: () => { return window.screenY; },  
 262974: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263027: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263098: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263155: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263411: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263482: () => { if (document.fullscreenElement) return 1; },  
 263528: () => { return window.innerWidth; },  
 263554: () => { return window.innerHeight; },  
 263581: () => { if (document.pointerLockElement) return 1; }
};
