...
function findWasmBinary() {
  return locateFile('raylib_naval_combat_3d.wasm');
}
...
var ASM_CONSTS = {
  102368: () => { if (document.fullscreenElement) return 1; },  
 102414: () => { return document.getElementById('canvas').width; },  
 102466: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102534: () => { document.exitFullscreen(); },  
 102561: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 102634: () => { if (document.fullscreenElement) return 1; },  
 102680: () => { return document.getElementById('canvas').width; },  
 102732: () => { return screen.width; },  
 102757: () => { document.exitFullscreen(); },  
 102784: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102917: () => { return window.innerWidth; },  
 102943: () => { return window.innerHeight; },  
 102970: () => { if (document.fullscreenElement) return 1; },  
 103016: () => { return document.getElementById('canvas').width; },  
 103068: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103136: () => { if (document.fullscreenElement) return 1; },  
 103182: () => { return document.getElementById('canvas').width; },  
 103234: () => { return screen.width; },  
 103259: () => { return window.innerWidth; },  
 103285: () => { return window.innerHeight; },  
 ...
 103435: () => { document.exitFullscreen(); },  
 103462: () => { if (document.fullscreenElement) return 1; },  
 103508: () => { return document.getElementById('canvas').width; },  
 103560: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103628: () => { document.exitFullscreen(); },  
 103655: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103713: () => { return screen.width; },  
 103738: () => { return screen.height; },  
 103764: () => { return window.screenX; },  
 103791: () => { return window.screenY; },  
 103818: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103871: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103942: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103999: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104255: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104326: () => { if (document.fullscreenElement) return 1; },  
 104372: () => { return window.innerWidth; },  
 104398: () => { return window.innerHeight; },  
 104425: () => { if (document.pointerLockElement) return 1; }
};
