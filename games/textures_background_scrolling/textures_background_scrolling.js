...
var ASM_CONSTS = {
  298532: () => { if (document.fullscreenElement) return 1; },  
 298578: () => { return document.getElementById('canvas').width; },  
 298630: () => { return parseInt(document.getElementById('canvas').style.width); },  
 298698: () => { document.exitFullscreen(); },  
 298725: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 298798: () => { if (document.fullscreenElement) return 1; },  
 298844: () => { return document.getElementById('canvas').width; },  
 298896: () => { return screen.width; },  
 298921: () => { document.exitFullscreen(); },  
 298948: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 299081: () => { return window.innerWidth; },  
 299107: () => { return window.innerHeight; },  
 299134: () => { if (document.fullscreenElement) return 1; },  
 299180: () => { return document.getElementById('canvas').width; },  
 299232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 299300: () => { if (document.fullscreenElement) return 1; },  
 299346: () => { return document.getElementById('canvas').width; },  
 299398: () => { return screen.width; },  
 299423: () => { return window.innerWidth; },  
 299449: () => { return window.innerHeight; },  
 299476: () => { if (document.fullscreenElement) return 1; },  
 299522: () => { return document.getElementById('canvas').width; },  
 299574: () => { return screen.width; },  
 299599: () => { document.exitFullscreen(); },  
 299626: () => { if (document.fullscreenElement) return 1; },  
 299672: () => { return document.getElementById('canvas').width; },  
 299724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 299792: () => { document.exitFullscreen(); },  
 299819: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 299877: () => { return screen.width; },  
 299902: () => { return screen.height; },  
 299928: () => { return window.screenX; },  
 299955: () => { return window.screenY; },  
 299982: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 300035: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 300106: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 300163: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 300419: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 300490: () => { if (document.fullscreenElement) return 1; },  
 300536: () => { return window.innerWidth; },  
 300562: () => { return window.innerHeight; },  
 300589: () => { if (document.pointerLockElement) return 1; }
};
