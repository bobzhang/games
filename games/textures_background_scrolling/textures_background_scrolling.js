...
var ASM_CONSTS = {
  298324: () => { if (document.fullscreenElement) return 1; },  
 298370: () => { return document.getElementById('canvas').width; },  
 298422: () => { return parseInt(document.getElementById('canvas').style.width); },  
 298490: () => { document.exitFullscreen(); },  
 298517: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 298590: () => { if (document.fullscreenElement) return 1; },  
 298636: () => { return document.getElementById('canvas').width; },  
 298688: () => { return screen.width; },  
 298713: () => { document.exitFullscreen(); },  
 298740: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 298873: () => { return window.innerWidth; },  
 298899: () => { return window.innerHeight; },  
 298926: () => { if (document.fullscreenElement) return 1; },  
 298972: () => { return document.getElementById('canvas').width; },  
 299024: () => { return parseInt(document.getElementById('canvas').style.width); },  
 299092: () => { if (document.fullscreenElement) return 1; },  
 299138: () => { return document.getElementById('canvas').width; },  
 299190: () => { return screen.width; },  
 299215: () => { return window.innerWidth; },  
 299241: () => { return window.innerHeight; },  
 299268: () => { if (document.fullscreenElement) return 1; },  
 299314: () => { return document.getElementById('canvas').width; },  
 299366: () => { return screen.width; },  
 299391: () => { document.exitFullscreen(); },  
 299418: () => { if (document.fullscreenElement) return 1; },  
 299464: () => { return document.getElementById('canvas').width; },  
 299516: () => { return parseInt(document.getElementById('canvas').style.width); },  
 299584: () => { document.exitFullscreen(); },  
 299611: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 299669: () => { return screen.width; },  
 299694: () => { return screen.height; },  
 299720: () => { return window.screenX; },  
 299747: () => { return window.screenY; },  
 299774: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 299827: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 299898: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 299955: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 300211: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 300282: () => { if (document.fullscreenElement) return 1; },  
 300328: () => { return window.innerWidth; },  
 300354: () => { return window.innerHeight; },  
 300381: () => { if (document.pointerLockElement) return 1; }
};
