...
var ASM_CONSTS = {
  268092: () => { if (document.fullscreenElement) return 1; },  
 268138: () => { return document.getElementById('canvas').width; },  
 268190: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268258: () => { document.exitFullscreen(); },  
 268285: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268358: () => { if (document.fullscreenElement) return 1; },  
 268404: () => { return document.getElementById('canvas').width; },  
 268456: () => { return screen.width; },  
 268481: () => { document.exitFullscreen(); },  
 268508: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268641: () => { return window.innerWidth; },  
 268667: () => { return window.innerHeight; },  
 268694: () => { if (document.fullscreenElement) return 1; },  
 268740: () => { return document.getElementById('canvas').width; },  
 268792: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268860: () => { if (document.fullscreenElement) return 1; },  
 268906: () => { return document.getElementById('canvas').width; },  
 268958: () => { return screen.width; },  
 268983: () => { return window.innerWidth; },  
 269009: () => { return window.innerHeight; },  
 ...
 269159: () => { document.exitFullscreen(); },  
