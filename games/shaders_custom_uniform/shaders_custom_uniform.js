...
var ASM_CONSTS = {
 ...
 262870: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262938: () => { document.exitFullscreen(); },  
 262965: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263038: () => { if (document.fullscreenElement) return 1; },  
 263084: () => { return document.getElementById('canvas').width; },  
 263136: () => { return screen.width; },  
 263161: () => { document.exitFullscreen(); },  
 263188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263321: () => { return window.innerWidth; },  
 263347: () => { return window.innerHeight; },  
 263374: () => { if (document.fullscreenElement) return 1; },  
 263420: () => { return document.getElementById('canvas').width; },  
 263472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263663: () => { return window.innerWidth; },  
 263689: () => { return window.innerHeight; },  
 ...
 263839: () => { document.exitFullscreen(); },  
 ...
 264032: () => { document.exitFullscreen(); },  
 264059: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264117: () => { return screen.width; },  
 264142: () => { return screen.height; },  
 264168: () => { return window.screenX; },  
 264195: () => { return window.screenY; },  
 264222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264275: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264346: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264659: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264730: () => { if (document.fullscreenElement) return 1; },  
 264776: () => { return window.innerWidth; },  
 264802: () => { return window.innerHeight; },  
 264829: () => { if (document.pointerLockElement) return 1; }
};
