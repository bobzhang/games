...
var ASM_CONSTS = {
 ...
 260978: () => { return document.getElementById('canvas').width; },  
 261030: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261098: () => { document.exitFullscreen(); },  
 261125: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261198: () => { if (document.fullscreenElement) return 1; },  
 261244: () => { return document.getElementById('canvas').width; },  
 261296: () => { return screen.width; },  
 261321: () => { document.exitFullscreen(); },  
 261348: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261481: () => { return window.innerWidth; },  
 261507: () => { return window.innerHeight; },  
 261534: () => { if (document.fullscreenElement) return 1; },  
 261580: () => { return document.getElementById('canvas').width; },  
 261632: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261823: () => { return window.innerWidth; },  
 261849: () => { return window.innerHeight; },  
 ...
 261999: () => { document.exitFullscreen(); },  
 262026: () => { if (document.fullscreenElement) return 1; },  
 262072: () => { return document.getElementById('canvas').width; },  
 262124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262192: () => { document.exitFullscreen(); },  
 262219: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262277: () => { return screen.width; },  
 262302: () => { return screen.height; },  
 262328: () => { return window.screenX; },  
 262355: () => { return window.screenY; },  
 262382: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262435: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262506: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262563: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262819: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262890: () => { if (document.fullscreenElement) return 1; },  
 262936: () => { return window.innerWidth; },  
 262962: () => { return window.innerHeight; },  
 262989: () => { if (document.pointerLockElement) return 1; }
};
