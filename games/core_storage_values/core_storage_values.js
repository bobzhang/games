...
var ASM_CONSTS = {
  260916: () => { if (document.fullscreenElement) return 1; },  
 260962: () => { return document.getElementById('canvas').width; },  
 261014: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261082: () => { document.exitFullscreen(); },  
 261109: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261182: () => { if (document.fullscreenElement) return 1; },  
 261228: () => { return document.getElementById('canvas').width; },  
 261280: () => { return screen.width; },  
 261305: () => { document.exitFullscreen(); },  
 261332: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261465: () => { return window.innerWidth; },  
 261491: () => { return window.innerHeight; },  
 261518: () => { if (document.fullscreenElement) return 1; },  
 261564: () => { return document.getElementById('canvas').width; },  
 261616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261807: () => { return window.innerWidth; },  
 261833: () => { return window.innerHeight; },  
 261860: () => { if (document.fullscreenElement) return 1; },  
 261906: () => { return document.getElementById('canvas').width; },  
 261958: () => { return screen.width; },  
 261983: () => { document.exitFullscreen(); },  
 ...
 262176: () => { document.exitFullscreen(); },  
 262203: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262261: () => { return screen.width; },  
 262286: () => { return screen.height; },  
 262312: () => { return window.screenX; },  
 262339: () => { return window.screenY; },  
 262366: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262419: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262490: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262547: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262803: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262874: () => { if (document.fullscreenElement) return 1; },  
 262920: () => { return window.innerWidth; },  
 262946: () => { return window.innerHeight; },  
 262973: () => { if (document.pointerLockElement) return 1; }
};
