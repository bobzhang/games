...
var ASM_CONSTS = {
 ...
 100482: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100550: () => { document.exitFullscreen(); },  
 100577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100650: () => { if (document.fullscreenElement) return 1; },  
 100696: () => { return document.getElementById('canvas').width; },  
 100748: () => { return screen.width; },  
 100773: () => { document.exitFullscreen(); },  
 100800: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100933: () => { return window.innerWidth; },  
 100959: () => { return window.innerHeight; },  
 100986: () => { if (document.fullscreenElement) return 1; },  
 101032: () => { return document.getElementById('canvas').width; },  
 101084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101152: () => { if (document.fullscreenElement) return 1; },  
 101198: () => { return document.getElementById('canvas').width; },  
 101250: () => { return screen.width; },  
 101275: () => { return window.innerWidth; },  
 101301: () => { return window.innerHeight; },  
 ...
 101451: () => { document.exitFullscreen(); },  
 101478: () => { if (document.fullscreenElement) return 1; },  
 101524: () => { return document.getElementById('canvas').width; },  
 101576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101644: () => { document.exitFullscreen(); },  
 101671: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101729: () => { return screen.width; },  
 101754: () => { return screen.height; },  
 101780: () => { return window.screenX; },  
 101807: () => { return window.screenY; },  
 101834: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101887: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101958: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102015: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102271: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102342: () => { if (document.fullscreenElement) return 1; },  
 102388: () => { return window.innerWidth; },  
 102414: () => { return window.innerHeight; },  
 102441: () => { if (document.pointerLockElement) return 1; }
};
