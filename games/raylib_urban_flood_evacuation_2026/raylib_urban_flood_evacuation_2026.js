...
var ASM_CONSTS = {
 ...
 99746: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99814: () => { document.exitFullscreen(); },  
 99841: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99914: () => { if (document.fullscreenElement) return 1; },  
 99960: () => { return document.getElementById('canvas').width; },  
 100012: () => { return screen.width; },  
 100037: () => { document.exitFullscreen(); },  
 100064: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100197: () => { return window.innerWidth; },  
 100223: () => { return window.innerHeight; },  
 100250: () => { if (document.fullscreenElement) return 1; },  
 100296: () => { return document.getElementById('canvas').width; },  
 100348: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100539: () => { return window.innerWidth; },  
 100565: () => { return window.innerHeight; },  
 ...
 100715: () => { document.exitFullscreen(); },  
 100742: () => { if (document.fullscreenElement) return 1; },  
 100788: () => { return document.getElementById('canvas').width; },  
 100840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100908: () => { document.exitFullscreen(); },  
 100935: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100993: () => { return screen.width; },  
 101018: () => { return screen.height; },  
 101044: () => { return window.screenX; },  
 101071: () => { return window.screenY; },  
 101098: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101151: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101222: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101279: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101535: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101606: () => { if (document.fullscreenElement) return 1; },  
 101652: () => { return window.innerWidth; },  
 101678: () => { return window.innerHeight; },  
 101705: () => { if (document.pointerLockElement) return 1; }
};
