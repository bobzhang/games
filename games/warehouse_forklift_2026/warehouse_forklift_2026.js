...
var ASM_CONSTS = {
  261220: () => { if (document.fullscreenElement) return 1; },  
 261266: () => { return document.getElementById('canvas').width; },  
 261318: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261386: () => { document.exitFullscreen(); },  
 261413: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261486: () => { if (document.fullscreenElement) return 1; },  
 261532: () => { return document.getElementById('canvas').width; },  
 261584: () => { return screen.width; },  
 261609: () => { document.exitFullscreen(); },  
 261636: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261769: () => { return window.innerWidth; },  
 261795: () => { return window.innerHeight; },  
 261822: () => { if (document.fullscreenElement) return 1; },  
 261868: () => { return document.getElementById('canvas').width; },  
 261920: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261988: () => { if (document.fullscreenElement) return 1; },  
 262034: () => { return document.getElementById('canvas').width; },  
 262086: () => { return screen.width; },  
 262111: () => { return window.innerWidth; },  
 262137: () => { return window.innerHeight; },  
 262164: () => { if (document.fullscreenElement) return 1; },  
 262210: () => { return document.getElementById('canvas').width; },  
 262262: () => { return screen.width; },  
 262287: () => { document.exitFullscreen(); },  
 ...
 262480: () => { document.exitFullscreen(); },  
 262507: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262565: () => { return screen.width; },  
 262590: () => { return screen.height; },  
 262616: () => { return window.screenX; },  
 262643: () => { return window.screenY; },  
 262670: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262723: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262794: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262851: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263107: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263178: () => { if (document.fullscreenElement) return 1; },  
 263224: () => { return window.innerWidth; },  
 263250: () => { return window.innerHeight; },  
 263277: () => { if (document.pointerLockElement) return 1; }
};
