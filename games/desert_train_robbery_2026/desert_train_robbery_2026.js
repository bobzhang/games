...
var ASM_CONSTS = {
  261348: () => { if (document.fullscreenElement) return 1; },  
 261394: () => { return document.getElementById('canvas').width; },  
 261446: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261514: () => { document.exitFullscreen(); },  
 261541: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261614: () => { if (document.fullscreenElement) return 1; },  
 261660: () => { return document.getElementById('canvas').width; },  
 261712: () => { return screen.width; },  
 261737: () => { document.exitFullscreen(); },  
 261764: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261897: () => { return window.innerWidth; },  
 261923: () => { return window.innerHeight; },  
 261950: () => { if (document.fullscreenElement) return 1; },  
 261996: () => { return document.getElementById('canvas').width; },  
 262048: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262239: () => { return window.innerWidth; },  
 262265: () => { return window.innerHeight; },  
 262292: () => { if (document.fullscreenElement) return 1; },  
 262338: () => { return document.getElementById('canvas').width; },  
 262390: () => { return screen.width; },  
 262415: () => { document.exitFullscreen(); },  
 ...
 262608: () => { document.exitFullscreen(); },  
 262635: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262693: () => { return screen.width; },  
 262718: () => { return screen.height; },  
 262744: () => { return window.screenX; },  
 262771: () => { return window.screenY; },  
 262798: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262851: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262922: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262979: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263235: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263306: () => { if (document.fullscreenElement) return 1; },  
 263352: () => { return window.innerWidth; },  
 263378: () => { return window.innerHeight; },  
 263405: () => { if (document.pointerLockElement) return 1; }
};
