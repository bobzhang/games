...
var ASM_CONSTS = {
 ...
 261654: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261722: () => { document.exitFullscreen(); },  
 261749: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261822: () => { if (document.fullscreenElement) return 1; },  
 261868: () => { return document.getElementById('canvas').width; },  
 261920: () => { return screen.width; },  
 261945: () => { document.exitFullscreen(); },  
 261972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262105: () => { return window.innerWidth; },  
 262131: () => { return window.innerHeight; },  
 262158: () => { if (document.fullscreenElement) return 1; },  
 262204: () => { return document.getElementById('canvas').width; },  
 262256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262447: () => { return window.innerWidth; },  
 262473: () => { return window.innerHeight; },  
 262500: () => { if (document.fullscreenElement) return 1; },  
 262546: () => { return document.getElementById('canvas').width; },  
 262598: () => { return screen.width; },  
 262623: () => { document.exitFullscreen(); },  
 262650: () => { if (document.fullscreenElement) return 1; },  
 262696: () => { return document.getElementById('canvas').width; },  
 262748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262816: () => { document.exitFullscreen(); },  
 262843: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262901: () => { return screen.width; },  
 262926: () => { return screen.height; },  
 262952: () => { return window.screenX; },  
 262979: () => { return window.screenY; },  
 263006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263059: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263130: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263443: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263514: () => { if (document.fullscreenElement) return 1; },  
 263560: () => { return window.innerWidth; },  
 263586: () => { return window.innerHeight; },  
 263613: () => { if (document.pointerLockElement) return 1; }
};
