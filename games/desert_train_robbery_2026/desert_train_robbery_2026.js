...
var ASM_CONSTS = {
  261540: () => { if (document.fullscreenElement) return 1; },  
 261586: () => { return document.getElementById('canvas').width; },  
 261638: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261706: () => { document.exitFullscreen(); },  
 261733: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261806: () => { if (document.fullscreenElement) return 1; },  
 261852: () => { return document.getElementById('canvas').width; },  
 261904: () => { return screen.width; },  
 261929: () => { document.exitFullscreen(); },  
 261956: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262089: () => { return window.innerWidth; },  
 262115: () => { return window.innerHeight; },  
 262142: () => { if (document.fullscreenElement) return 1; },  
 262188: () => { return document.getElementById('canvas').width; },  
 262240: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262308: () => { if (document.fullscreenElement) return 1; },  
 262354: () => { return document.getElementById('canvas').width; },  
 262406: () => { return screen.width; },  
 262431: () => { return window.innerWidth; },  
 262457: () => { return window.innerHeight; },  
 ...
 262607: () => { document.exitFullscreen(); },  
 ...
 262800: () => { document.exitFullscreen(); },  
 262827: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262885: () => { return screen.width; },  
 262910: () => { return screen.height; },  
 262936: () => { return window.screenX; },  
 262963: () => { return window.screenY; },  
 262990: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263043: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263114: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263171: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263427: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263498: () => { if (document.fullscreenElement) return 1; },  
 263544: () => { return window.innerWidth; },  
 263570: () => { return window.innerHeight; },  
 263597: () => { if (document.pointerLockElement) return 1; }
};
