...
function findWasmBinary() {
  return locateFile('raylib_core_vr_simulator.wasm');
}
...
var ASM_CONSTS = {
 ...
 100402: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100470: () => { document.exitFullscreen(); },  
 100497: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100570: () => { if (document.fullscreenElement) return 1; },  
 100616: () => { return document.getElementById('canvas').width; },  
 100668: () => { return screen.width; },  
 100693: () => { document.exitFullscreen(); },  
 100720: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100853: () => { return window.innerWidth; },  
 100879: () => { return window.innerHeight; },  
 100906: () => { if (document.fullscreenElement) return 1; },  
 100952: () => { return document.getElementById('canvas').width; },  
 101004: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101072: () => { if (document.fullscreenElement) return 1; },  
 101118: () => { return document.getElementById('canvas').width; },  
 101170: () => { return screen.width; },  
 101195: () => { return window.innerWidth; },  
 101221: () => { return window.innerHeight; },  
 101248: () => { if (document.fullscreenElement) return 1; },  
 101294: () => { return document.getElementById('canvas').width; },  
 101346: () => { return screen.width; },  
 101371: () => { document.exitFullscreen(); },  
 101398: () => { if (document.fullscreenElement) return 1; },  
 101444: () => { return document.getElementById('canvas').width; },  
 101496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101564: () => { document.exitFullscreen(); },  
 101591: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101649: () => { return screen.width; },  
 101674: () => { return screen.height; },  
 101700: () => { return window.screenX; },  
 101727: () => { return window.screenY; },  
 101754: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101807: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101878: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101935: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102191: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102262: () => { if (document.fullscreenElement) return 1; },  
 102308: () => { return window.innerWidth; },  
 102334: () => { return window.innerHeight; },  
 102361: () => { if (document.pointerLockElement) return 1; }
};
