...
var ASM_CONSTS = {
  260980: () => { if (document.fullscreenElement) return 1; },  
 261026: () => { return document.getElementById('canvas').width; },  
 261078: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261146: () => { document.exitFullscreen(); },  
 261173: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261246: () => { if (document.fullscreenElement) return 1; },  
 261292: () => { return document.getElementById('canvas').width; },  
 261344: () => { return screen.width; },  
 261369: () => { document.exitFullscreen(); },  
 261396: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261529: () => { return window.innerWidth; },  
 261555: () => { return window.innerHeight; },  
 261582: () => { if (document.fullscreenElement) return 1; },  
 261628: () => { return document.getElementById('canvas').width; },  
 261680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261748: () => { if (document.fullscreenElement) return 1; },  
 261794: () => { return document.getElementById('canvas').width; },  
 261846: () => { return screen.width; },  
 261871: () => { return window.innerWidth; },  
 261897: () => { return window.innerHeight; },  
 261924: () => { if (document.fullscreenElement) return 1; },  
 261970: () => { return document.getElementById('canvas').width; },  
 262022: () => { return screen.width; },  
 262047: () => { document.exitFullscreen(); },  
 ...
 262240: () => { document.exitFullscreen(); },  
 262267: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262325: () => { return screen.width; },  
 262350: () => { return screen.height; },  
 262376: () => { return window.screenX; },  
 262403: () => { return window.screenY; },  
 262430: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262483: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262554: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262611: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262867: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262938: () => { if (document.fullscreenElement) return 1; },  
 262984: () => { return window.innerWidth; },  
 263010: () => { return window.innerHeight; },  
 263037: () => { if (document.pointerLockElement) return 1; }
};
