...
function findWasmBinary() {
  return locateFile('raylib_shapes_easings_ball_anim.wasm');
}
...
var ASM_CONSTS = {
  97008: () => { if (document.fullscreenElement) return 1; },  
 97054: () => { return document.getElementById('canvas').width; },  
 97106: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97174: () => { document.exitFullscreen(); },  
 97201: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97274: () => { if (document.fullscreenElement) return 1; },  
 97320: () => { return document.getElementById('canvas').width; },  
 97372: () => { return screen.width; },  
 97397: () => { document.exitFullscreen(); },  
 97424: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97557: () => { return window.innerWidth; },  
 97583: () => { return window.innerHeight; },  
 97610: () => { if (document.fullscreenElement) return 1; },  
 97656: () => { return document.getElementById('canvas').width; },  
 97708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97776: () => { if (document.fullscreenElement) return 1; },  
 97822: () => { return document.getElementById('canvas').width; },  
 97874: () => { return screen.width; },  
 97899: () => { return window.innerWidth; },  
 97925: () => { return window.innerHeight; },  
 97952: () => { if (document.fullscreenElement) return 1; },  
 97998: () => { return document.getElementById('canvas').width; },  
 98050: () => { return screen.width; },  
 98075: () => { document.exitFullscreen(); },  
 98102: () => { if (document.fullscreenElement) return 1; },  
 98148: () => { return document.getElementById('canvas').width; },  
 98200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98268: () => { document.exitFullscreen(); },  
 98295: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98353: () => { return screen.width; },  
 98378: () => { return screen.height; },  
 98404: () => { return window.screenX; },  
 98431: () => { return window.screenY; },  
 98458: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98511: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98582: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98639: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98895: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98966: () => { if (document.fullscreenElement) return 1; },  
 99012: () => { return window.innerWidth; },  
 99038: () => { return window.innerHeight; },  
 99065: () => { if (document.pointerLockElement) return 1; }
};
