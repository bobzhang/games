...
var ASM_CONSTS = {
 ...
 99586: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99654: () => { document.exitFullscreen(); },  
 99681: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99754: () => { if (document.fullscreenElement) return 1; },  
 99800: () => { return document.getElementById('canvas').width; },  
 99852: () => { return screen.width; },  
 99877: () => { document.exitFullscreen(); },  
 99904: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100037: () => { return window.innerWidth; },  
 100063: () => { return window.innerHeight; },  
 100090: () => { if (document.fullscreenElement) return 1; },  
 100136: () => { return document.getElementById('canvas').width; },  
 100188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100256: () => { if (document.fullscreenElement) return 1; },  
 100302: () => { return document.getElementById('canvas').width; },  
 100354: () => { return screen.width; },  
 100379: () => { return window.innerWidth; },  
 100405: () => { return window.innerHeight; },  
 ...
 100555: () => { document.exitFullscreen(); },  
 100582: () => { if (document.fullscreenElement) return 1; },  
 100628: () => { return document.getElementById('canvas').width; },  
 100680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100748: () => { document.exitFullscreen(); },  
 100775: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100833: () => { return screen.width; },  
 100858: () => { return screen.height; },  
 100884: () => { return window.screenX; },  
 100911: () => { return window.screenY; },  
 100938: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100991: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101062: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101119: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101375: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101446: () => { if (document.fullscreenElement) return 1; },  
 101492: () => { return window.innerWidth; },  
 101518: () => { return window.innerHeight; },  
 101545: () => { if (document.pointerLockElement) return 1; }
};
