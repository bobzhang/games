...
function findWasmBinary() {
  return locateFile('raylib_shaders_shadowmap.wasm');
}
...
var ASM_CONSTS = {
  1717696: () => { if (document.fullscreenElement) return 1; },  
 1717742: () => { return document.getElementById('canvas').width; },  
 1717794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1717862: () => { document.exitFullscreen(); },  
 1717889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1717962: () => { if (document.fullscreenElement) return 1; },  
 1718008: () => { return document.getElementById('canvas').width; },  
 1718060: () => { return screen.width; },  
 1718085: () => { document.exitFullscreen(); },  
 1718112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1718245: () => { return window.innerWidth; },  
 1718271: () => { return window.innerHeight; },  
 1718298: () => { if (document.fullscreenElement) return 1; },  
 1718344: () => { return document.getElementById('canvas').width; },  
 1718396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1718464: () => { if (document.fullscreenElement) return 1; },  
 1718510: () => { return document.getElementById('canvas').width; },  
 1718562: () => { return screen.width; },  
 1718587: () => { return window.innerWidth; },  
 1718613: () => { return window.innerHeight; },  
 1718640: () => { if (document.fullscreenElement) return 1; },  
 1718686: () => { return document.getElementById('canvas').width; },  
 1718738: () => { return screen.width; },  
 1718763: () => { document.exitFullscreen(); },  
 1718790: () => { if (document.fullscreenElement) return 1; },  
 1718836: () => { return document.getElementById('canvas').width; },  
 1718888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1718956: () => { document.exitFullscreen(); },  
 1718983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1719041: () => { return screen.width; },  
 1719066: () => { return screen.height; },  
 1719092: () => { return window.screenX; },  
 1719119: () => { return window.screenY; },  
 1719146: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1719199: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1719270: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1719327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1719583: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1719654: () => { if (document.fullscreenElement) return 1; },  
 1719700: () => { return window.innerWidth; },  
 1719726: () => { return window.innerHeight; },  
 1719753: () => { if (document.pointerLockElement) return 1; }
};
