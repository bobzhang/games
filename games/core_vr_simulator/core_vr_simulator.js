...
var ASM_CONSTS = {
  255284: () => { if (document.fullscreenElement) return 1; },  
 255330: () => { return document.getElementById('canvas').width; },  
 255382: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255450: () => { document.exitFullscreen(); },  
 255477: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255550: () => { if (document.fullscreenElement) return 1; },  
 255596: () => { return document.getElementById('canvas').width; },  
 255648: () => { return screen.width; },  
 255673: () => { document.exitFullscreen(); },  
 255700: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255833: () => { return window.innerWidth; },  
 255859: () => { return window.innerHeight; },  
 255886: () => { if (document.fullscreenElement) return 1; },  
 255932: () => { return document.getElementById('canvas').width; },  
 255984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256052: () => { if (document.fullscreenElement) return 1; },  
 256098: () => { return document.getElementById('canvas').width; },  
 256150: () => { return screen.width; },  
 256175: () => { return window.innerWidth; },  
 256201: () => { return window.innerHeight; },  
 256228: () => { if (document.fullscreenElement) return 1; },  
 256274: () => { return document.getElementById('canvas').width; },  
 256326: () => { return screen.width; },  
 256351: () => { document.exitFullscreen(); },  
 256378: () => { if (document.fullscreenElement) return 1; },  
 256424: () => { return document.getElementById('canvas').width; },  
 256476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256544: () => { document.exitFullscreen(); },  
 256571: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256629: () => { return screen.width; },  
 256654: () => { return screen.height; },  
 256680: () => { return window.screenX; },  
 256707: () => { return window.screenY; },  
 256734: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256787: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 256858: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 256915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 257171: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 257242: () => { if (document.fullscreenElement) return 1; },  
 257288: () => { return window.innerWidth; },  
 257314: () => { return window.innerHeight; },  
 257341: () => { if (document.pointerLockElement) return 1; }
};
