...
var ASM_CONSTS = {
  255280: () => { if (document.fullscreenElement) return 1; },  
 255326: () => { return document.getElementById('canvas').width; },  
 255378: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255446: () => { document.exitFullscreen(); },  
 255473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255546: () => { if (document.fullscreenElement) return 1; },  
 255592: () => { return document.getElementById('canvas').width; },  
 255644: () => { return screen.width; },  
 255669: () => { document.exitFullscreen(); },  
 255696: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255829: () => { return window.innerWidth; },  
 255855: () => { return window.innerHeight; },  
 255882: () => { if (document.fullscreenElement) return 1; },  
 255928: () => { return document.getElementById('canvas').width; },  
 255980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256048: () => { if (document.fullscreenElement) return 1; },  
 256094: () => { return document.getElementById('canvas').width; },  
 256146: () => { return screen.width; },  
 256171: () => { return window.innerWidth; },  
 256197: () => { return window.innerHeight; },  
 256224: () => { if (document.fullscreenElement) return 1; },  
 256270: () => { return document.getElementById('canvas').width; },  
 256322: () => { return screen.width; },  
 256347: () => { document.exitFullscreen(); },  
 256374: () => { if (document.fullscreenElement) return 1; },  
 256420: () => { return document.getElementById('canvas').width; },  
 256472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256540: () => { document.exitFullscreen(); },  
 256567: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256625: () => { return screen.width; },  
 256650: () => { return screen.height; },  
 256676: () => { return window.screenX; },  
 256703: () => { return window.screenY; },  
 256730: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256783: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 256854: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 256911: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 257167: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 257238: () => { if (document.fullscreenElement) return 1; },  
 257284: () => { return window.innerWidth; },  
 257310: () => { return window.innerHeight; },  
 257337: () => { if (document.pointerLockElement) return 1; }
};
