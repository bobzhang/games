...
var ASM_CONSTS = {
  255060: () => { if (document.fullscreenElement) return 1; },  
 255106: () => { return document.getElementById('canvas').width; },  
 255158: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255226: () => { document.exitFullscreen(); },  
 255253: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255326: () => { if (document.fullscreenElement) return 1; },  
 255372: () => { return document.getElementById('canvas').width; },  
 255424: () => { return screen.width; },  
 255449: () => { document.exitFullscreen(); },  
 255476: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255609: () => { return window.innerWidth; },  
 255635: () => { return window.innerHeight; },  
 255662: () => { if (document.fullscreenElement) return 1; },  
 255708: () => { return document.getElementById('canvas').width; },  
 255760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255828: () => { if (document.fullscreenElement) return 1; },  
 255874: () => { return document.getElementById('canvas').width; },  
 255926: () => { return screen.width; },  
 255951: () => { return window.innerWidth; },  
 255977: () => { return window.innerHeight; },  
 256004: () => { if (document.fullscreenElement) return 1; },  
 256050: () => { return document.getElementById('canvas').width; },  
 256102: () => { return screen.width; },  
 256127: () => { document.exitFullscreen(); },  
 256154: () => { if (document.fullscreenElement) return 1; },  
 256200: () => { return document.getElementById('canvas').width; },  
 256252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256320: () => { document.exitFullscreen(); },  
 256347: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256405: () => { return screen.width; },  
 256430: () => { return screen.height; },  
 256456: () => { return window.screenX; },  
 256483: () => { return window.screenY; },  
 256510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 256634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 256691: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 256947: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 257018: () => { if (document.fullscreenElement) return 1; },  
 257064: () => { return window.innerWidth; },  
 257090: () => { return window.innerHeight; },  
 257117: () => { if (document.pointerLockElement) return 1; }
};
