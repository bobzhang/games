...
function findWasmBinary() {
  return locateFile('raylib_textures_blend_modes.wasm');
}
...
var ASM_CONSTS = {
  127296: () => { if (document.fullscreenElement) return 1; },  
 127342: () => { return document.getElementById('canvas').width; },  
 127394: () => { return parseInt(document.getElementById('canvas').style.width); },  
 127462: () => { document.exitFullscreen(); },  
 127489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 127562: () => { if (document.fullscreenElement) return 1; },  
 127608: () => { return document.getElementById('canvas').width; },  
 127660: () => { return screen.width; },  
 127685: () => { document.exitFullscreen(); },  
 127712: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 127845: () => { return window.innerWidth; },  
 127871: () => { return window.innerHeight; },  
 127898: () => { if (document.fullscreenElement) return 1; },  
 127944: () => { return document.getElementById('canvas').width; },  
 127996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 128064: () => { if (document.fullscreenElement) return 1; },  
 128110: () => { return document.getElementById('canvas').width; },  
 128162: () => { return screen.width; },  
 128187: () => { return window.innerWidth; },  
 128213: () => { return window.innerHeight; },  
 128240: () => { if (document.fullscreenElement) return 1; },  
 128286: () => { return document.getElementById('canvas').width; },  
 128338: () => { return screen.width; },  
 128363: () => { document.exitFullscreen(); },  
 128390: () => { if (document.fullscreenElement) return 1; },  
 128436: () => { return document.getElementById('canvas').width; },  
 128488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 128556: () => { document.exitFullscreen(); },  
 128583: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 128641: () => { return screen.width; },  
 128666: () => { return screen.height; },  
 128692: () => { return window.screenX; },  
 128719: () => { return window.screenY; },  
 128746: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 128799: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 128870: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 128927: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 129183: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 129254: () => { if (document.fullscreenElement) return 1; },  
 129300: () => { return window.innerWidth; },  
 129326: () => { return window.innerHeight; },  
 129353: () => { if (document.pointerLockElement) return 1; }
};
