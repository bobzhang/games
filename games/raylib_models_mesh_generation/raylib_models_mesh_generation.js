...
function findWasmBinary() {
  return locateFile('raylib_models_mesh_generation.wasm');
}
...
var ASM_CONSTS = {
  98936: () => { if (document.fullscreenElement) return 1; },  
 98982: () => { return document.getElementById('canvas').width; },  
 99034: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99102: () => { document.exitFullscreen(); },  
 99129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99202: () => { if (document.fullscreenElement) return 1; },  
 99248: () => { return document.getElementById('canvas').width; },  
 99300: () => { return screen.width; },  
 99325: () => { document.exitFullscreen(); },  
 99352: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99485: () => { return window.innerWidth; },  
 99511: () => { return window.innerHeight; },  
 99538: () => { if (document.fullscreenElement) return 1; },  
 99584: () => { return document.getElementById('canvas').width; },  
 99636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99704: () => { if (document.fullscreenElement) return 1; },  
 99750: () => { return document.getElementById('canvas').width; },  
 99802: () => { return screen.width; },  
 99827: () => { return window.innerWidth; },  
 99853: () => { return window.innerHeight; },  
 99880: () => { if (document.fullscreenElement) return 1; },  
 99926: () => { return document.getElementById('canvas').width; },  
 99978: () => { return screen.width; },  
 100003: () => { document.exitFullscreen(); },  
 100030: () => { if (document.fullscreenElement) return 1; },  
 100076: () => { return document.getElementById('canvas').width; },  
 100128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100196: () => { document.exitFullscreen(); },  
 100223: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100281: () => { return screen.width; },  
 100306: () => { return screen.height; },  
 100332: () => { return window.screenX; },  
 100359: () => { return window.screenY; },  
 100386: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100439: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100510: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100567: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100823: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100894: () => { if (document.fullscreenElement) return 1; },  
 100940: () => { return window.innerWidth; },  
 100966: () => { return window.innerHeight; },  
 100993: () => { if (document.pointerLockElement) return 1; }
};
