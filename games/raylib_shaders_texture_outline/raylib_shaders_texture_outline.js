...
function findWasmBinary() {
  return locateFile('raylib_shaders_texture_outline.wasm');
}
...
var ASM_CONSTS = {
  102912: () => { if (document.fullscreenElement) return 1; },  
 102958: () => { return document.getElementById('canvas').width; },  
 103010: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103078: () => { document.exitFullscreen(); },  
 103105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103178: () => { if (document.fullscreenElement) return 1; },  
 103224: () => { return document.getElementById('canvas').width; },  
 103276: () => { return screen.width; },  
 103301: () => { document.exitFullscreen(); },  
 103328: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103461: () => { return window.innerWidth; },  
 103487: () => { return window.innerHeight; },  
 103514: () => { if (document.fullscreenElement) return 1; },  
 103560: () => { return document.getElementById('canvas').width; },  
 103612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103680: () => { if (document.fullscreenElement) return 1; },  
 103726: () => { return document.getElementById('canvas').width; },  
 103778: () => { return screen.width; },  
 103803: () => { return window.innerWidth; },  
 103829: () => { return window.innerHeight; },  
 103856: () => { if (document.fullscreenElement) return 1; },  
 103902: () => { return document.getElementById('canvas').width; },  
 103954: () => { return screen.width; },  
 103979: () => { document.exitFullscreen(); },  
 104006: () => { if (document.fullscreenElement) return 1; },  
 104052: () => { return document.getElementById('canvas').width; },  
 104104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104172: () => { document.exitFullscreen(); },  
 104199: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104257: () => { return screen.width; },  
 104282: () => { return screen.height; },  
 104308: () => { return window.screenX; },  
 104335: () => { return window.screenY; },  
 104362: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104415: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104486: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 104543: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104799: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104870: () => { if (document.fullscreenElement) return 1; },  
 104916: () => { return window.innerWidth; },  
 104942: () => { return window.innerHeight; },  
 104969: () => { if (document.pointerLockElement) return 1; }
};
