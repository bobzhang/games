...
function findWasmBinary() {
  return locateFile('raylib_textures_draw_tiled.wasm');
}
...
var ASM_CONSTS = {
 ...
 110562: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110630: () => { document.exitFullscreen(); },  
 110657: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 110730: () => { if (document.fullscreenElement) return 1; },  
 110776: () => { return document.getElementById('canvas').width; },  
 110828: () => { return screen.width; },  
 110853: () => { document.exitFullscreen(); },  
 110880: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 111013: () => { return window.innerWidth; },  
 111039: () => { return window.innerHeight; },  
 111066: () => { if (document.fullscreenElement) return 1; },  
 111112: () => { return document.getElementById('canvas').width; },  
 111164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 111355: () => { return window.innerWidth; },  
 111381: () => { return window.innerHeight; },  
 111408: () => { if (document.fullscreenElement) return 1; },  
 111454: () => { return document.getElementById('canvas').width; },  
 111506: () => { return screen.width; },  
 111531: () => { document.exitFullscreen(); },  
 111558: () => { if (document.fullscreenElement) return 1; },  
 111604: () => { return document.getElementById('canvas').width; },  
 111656: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111724: () => { document.exitFullscreen(); },  
 111751: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 111809: () => { return screen.width; },  
 111834: () => { return screen.height; },  
 111860: () => { return window.screenX; },  
 111887: () => { return window.screenY; },  
 111914: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 111967: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 112038: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 112095: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 112351: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 112422: () => { if (document.fullscreenElement) return 1; },  
 112468: () => { return window.innerWidth; },  
 112494: () => { return window.innerHeight; },  
 112521: () => { if (document.pointerLockElement) return 1; }
};
