...
var ASM_CONSTS = {
 ...
 264998: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265066: () => { document.exitFullscreen(); },  
 265093: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 265166: () => { if (document.fullscreenElement) return 1; },  
 265212: () => { return document.getElementById('canvas').width; },  
 265264: () => { return screen.width; },  
 265289: () => { document.exitFullscreen(); },  
 265316: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265449: () => { return window.innerWidth; },  
 265475: () => { return window.innerHeight; },  
 265502: () => { if (document.fullscreenElement) return 1; },  
 265548: () => { return document.getElementById('canvas').width; },  
 265600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265668: () => { if (document.fullscreenElement) return 1; },  
 265714: () => { return document.getElementById('canvas').width; },  
 265766: () => { return screen.width; },  
 265791: () => { return window.innerWidth; },  
 265817: () => { return window.innerHeight; },  
 265844: () => { if (document.fullscreenElement) return 1; },  
 265890: () => { return document.getElementById('canvas').width; },  
 265942: () => { return screen.width; },  
 265967: () => { document.exitFullscreen(); },  
 265994: () => { if (document.fullscreenElement) return 1; },  
 266040: () => { return document.getElementById('canvas').width; },  
 266092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266160: () => { document.exitFullscreen(); },  
 266187: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266245: () => { return screen.width; },  
 266270: () => { return screen.height; },  
 266296: () => { return window.screenX; },  
 266323: () => { return window.screenY; },  
 266350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266403: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266474: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266531: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266787: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266858: () => { if (document.fullscreenElement) return 1; },  
 266904: () => { return window.innerWidth; },  
 266930: () => { return window.innerHeight; },  
 266957: () => { if (document.pointerLockElement) return 1; }
};
