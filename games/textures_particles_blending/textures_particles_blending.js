...
var ASM_CONSTS = {
  272084: () => { if (document.fullscreenElement) return 1; },  
 272130: () => { return document.getElementById('canvas').width; },  
 272182: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272250: () => { document.exitFullscreen(); },  
 272277: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272350: () => { if (document.fullscreenElement) return 1; },  
 272396: () => { return document.getElementById('canvas').width; },  
 272448: () => { return screen.width; },  
 272473: () => { document.exitFullscreen(); },  
 272500: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272633: () => { return window.innerWidth; },  
 272659: () => { return window.innerHeight; },  
 272686: () => { if (document.fullscreenElement) return 1; },  
 272732: () => { return document.getElementById('canvas').width; },  
 272784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272852: () => { if (document.fullscreenElement) return 1; },  
 272898: () => { return document.getElementById('canvas').width; },  
 272950: () => { return screen.width; },  
 272975: () => { return window.innerWidth; },  
 273001: () => { return window.innerHeight; },  
 273028: () => { if (document.fullscreenElement) return 1; },  
 273074: () => { return document.getElementById('canvas').width; },  
 273126: () => { return screen.width; },  
 273151: () => { document.exitFullscreen(); },  
 273178: () => { if (document.fullscreenElement) return 1; },  
 273224: () => { return document.getElementById('canvas').width; },  
 273276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273344: () => { document.exitFullscreen(); },  
 273371: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273429: () => { return screen.width; },  
 273454: () => { return screen.height; },  
 273480: () => { return window.screenX; },  
 273507: () => { return window.screenY; },  
 273534: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273587: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273658: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 273715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 273971: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274042: () => { if (document.fullscreenElement) return 1; },  
 274088: () => { return window.innerWidth; },  
 274114: () => { return window.innerHeight; },  
 274141: () => { if (document.pointerLockElement) return 1; }
};
