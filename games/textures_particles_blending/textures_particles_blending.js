...
var ASM_CONSTS = {
  271860: () => { if (document.fullscreenElement) return 1; },  
 271906: () => { return document.getElementById('canvas').width; },  
 271958: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272026: () => { document.exitFullscreen(); },  
 272053: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272126: () => { if (document.fullscreenElement) return 1; },  
 272172: () => { return document.getElementById('canvas').width; },  
 272224: () => { return screen.width; },  
 272249: () => { document.exitFullscreen(); },  
 272276: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272409: () => { return window.innerWidth; },  
 272435: () => { return window.innerHeight; },  
 272462: () => { if (document.fullscreenElement) return 1; },  
 272508: () => { return document.getElementById('canvas').width; },  
 272560: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272628: () => { if (document.fullscreenElement) return 1; },  
 272674: () => { return document.getElementById('canvas').width; },  
 272726: () => { return screen.width; },  
 272751: () => { return window.innerWidth; },  
 272777: () => { return window.innerHeight; },  
 272804: () => { if (document.fullscreenElement) return 1; },  
 272850: () => { return document.getElementById('canvas').width; },  
 272902: () => { return screen.width; },  
 272927: () => { document.exitFullscreen(); },  
 272954: () => { if (document.fullscreenElement) return 1; },  
 273000: () => { return document.getElementById('canvas').width; },  
 273052: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273120: () => { document.exitFullscreen(); },  
 273147: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273205: () => { return screen.width; },  
 273230: () => { return screen.height; },  
 273256: () => { return window.screenX; },  
 273283: () => { return window.screenY; },  
 273310: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273363: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273434: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 273491: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 273747: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 273818: () => { if (document.fullscreenElement) return 1; },  
 273864: () => { return window.innerWidth; },  
 273890: () => { return window.innerHeight; },  
 273917: () => { if (document.pointerLockElement) return 1; }
};
