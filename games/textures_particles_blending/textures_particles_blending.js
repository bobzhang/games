...
var ASM_CONSTS = {
  272052: () => { if (document.fullscreenElement) return 1; },  
 272098: () => { return document.getElementById('canvas').width; },  
 272150: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272218: () => { document.exitFullscreen(); },  
 272245: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272318: () => { if (document.fullscreenElement) return 1; },  
 272364: () => { return document.getElementById('canvas').width; },  
 272416: () => { return screen.width; },  
 272441: () => { document.exitFullscreen(); },  
 272468: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272601: () => { return window.innerWidth; },  
 272627: () => { return window.innerHeight; },  
 272654: () => { if (document.fullscreenElement) return 1; },  
 272700: () => { return document.getElementById('canvas').width; },  
 272752: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272820: () => { if (document.fullscreenElement) return 1; },  
 272866: () => { return document.getElementById('canvas').width; },  
 272918: () => { return screen.width; },  
 272943: () => { return window.innerWidth; },  
 272969: () => { return window.innerHeight; },  
 272996: () => { if (document.fullscreenElement) return 1; },  
 273042: () => { return document.getElementById('canvas').width; },  
 273094: () => { return screen.width; },  
 273119: () => { document.exitFullscreen(); },  
 273146: () => { if (document.fullscreenElement) return 1; },  
 273192: () => { return document.getElementById('canvas').width; },  
 273244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273312: () => { document.exitFullscreen(); },  
 273339: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273397: () => { return screen.width; },  
 273422: () => { return screen.height; },  
 273448: () => { return window.screenX; },  
 273475: () => { return window.screenY; },  
 273502: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273555: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273626: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 273683: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 273939: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274010: () => { if (document.fullscreenElement) return 1; },  
 274056: () => { return window.innerWidth; },  
 274082: () => { return window.innerHeight; },  
 274109: () => { if (document.pointerLockElement) return 1; }
};
