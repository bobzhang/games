...
var ASM_CONSTS = {
  345380: () => { if (document.fullscreenElement) return 1; },  
 345426: () => { return document.getElementById('canvas').width; },  
 345478: () => { return parseInt(document.getElementById('canvas').style.width); },  
 345546: () => { document.exitFullscreen(); },  
 345573: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 345646: () => { if (document.fullscreenElement) return 1; },  
 345692: () => { return document.getElementById('canvas').width; },  
 345744: () => { return screen.width; },  
 345769: () => { document.exitFullscreen(); },  
 345796: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 345929: () => { return window.innerWidth; },  
 345955: () => { return window.innerHeight; },  
 345982: () => { if (document.fullscreenElement) return 1; },  
 346028: () => { return document.getElementById('canvas').width; },  
 346080: () => { return parseInt(document.getElementById('canvas').style.width); },  
 346148: () => { if (document.fullscreenElement) return 1; },  
 346194: () => { return document.getElementById('canvas').width; },  
 346246: () => { return screen.width; },  
 346271: () => { return window.innerWidth; },  
 346297: () => { return window.innerHeight; },  
 346324: () => { if (document.fullscreenElement) return 1; },  
 346370: () => { return document.getElementById('canvas').width; },  
 346422: () => { return screen.width; },  
 346447: () => { document.exitFullscreen(); },  
 346474: () => { if (document.fullscreenElement) return 1; },  
 346520: () => { return document.getElementById('canvas').width; },  
 346572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 346640: () => { document.exitFullscreen(); },  
 346667: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 346725: () => { return screen.width; },  
 346750: () => { return screen.height; },  
 346776: () => { return window.screenX; },  
 346803: () => { return window.screenY; },  
 346830: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 346883: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 346954: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 347011: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 347267: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 347338: () => { if (document.fullscreenElement) return 1; },  
 347384: () => { return window.innerWidth; },  
 347410: () => { return window.innerHeight; },  
 347437: () => { if (document.pointerLockElement) return 1; }
};
