...
var ASM_CONSTS = {
  345588: () => { if (document.fullscreenElement) return 1; },  
 345634: () => { return document.getElementById('canvas').width; },  
 345686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 345754: () => { document.exitFullscreen(); },  
 345781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 345854: () => { if (document.fullscreenElement) return 1; },  
 345900: () => { return document.getElementById('canvas').width; },  
 345952: () => { return screen.width; },  
 345977: () => { document.exitFullscreen(); },  
 346004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 346137: () => { return window.innerWidth; },  
 346163: () => { return window.innerHeight; },  
 346190: () => { if (document.fullscreenElement) return 1; },  
 346236: () => { return document.getElementById('canvas').width; },  
 346288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 346356: () => { if (document.fullscreenElement) return 1; },  
 346402: () => { return document.getElementById('canvas').width; },  
 346454: () => { return screen.width; },  
 346479: () => { return window.innerWidth; },  
 346505: () => { return window.innerHeight; },  
 346532: () => { if (document.fullscreenElement) return 1; },  
 346578: () => { return document.getElementById('canvas').width; },  
 346630: () => { return screen.width; },  
 346655: () => { document.exitFullscreen(); },  
 346682: () => { if (document.fullscreenElement) return 1; },  
 346728: () => { return document.getElementById('canvas').width; },  
 346780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 346848: () => { document.exitFullscreen(); },  
 346875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 346933: () => { return screen.width; },  
 346958: () => { return screen.height; },  
 346984: () => { return window.screenX; },  
 347011: () => { return window.screenY; },  
 347038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 347091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 347162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 347219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 347475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 347546: () => { if (document.fullscreenElement) return 1; },  
 347592: () => { return window.innerWidth; },  
 347618: () => { return window.innerHeight; },  
 347645: () => { if (document.pointerLockElement) return 1; }
};
