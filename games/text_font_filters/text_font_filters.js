...
var ASM_CONSTS = {
  345604: () => { if (document.fullscreenElement) return 1; },  
 345650: () => { return document.getElementById('canvas').width; },  
 345702: () => { return parseInt(document.getElementById('canvas').style.width); },  
 345770: () => { document.exitFullscreen(); },  
 345797: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 345870: () => { if (document.fullscreenElement) return 1; },  
 345916: () => { return document.getElementById('canvas').width; },  
 345968: () => { return screen.width; },  
 345993: () => { document.exitFullscreen(); },  
 346020: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 346153: () => { return window.innerWidth; },  
 346179: () => { return window.innerHeight; },  
 346206: () => { if (document.fullscreenElement) return 1; },  
 346252: () => { return document.getElementById('canvas').width; },  
 346304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 346372: () => { if (document.fullscreenElement) return 1; },  
 346418: () => { return document.getElementById('canvas').width; },  
 346470: () => { return screen.width; },  
 346495: () => { return window.innerWidth; },  
 346521: () => { return window.innerHeight; },  
 346548: () => { if (document.fullscreenElement) return 1; },  
 346594: () => { return document.getElementById('canvas').width; },  
 346646: () => { return screen.width; },  
 346671: () => { document.exitFullscreen(); },  
 346698: () => { if (document.fullscreenElement) return 1; },  
 346744: () => { return document.getElementById('canvas').width; },  
 346796: () => { return parseInt(document.getElementById('canvas').style.width); },  
 346864: () => { document.exitFullscreen(); },  
 346891: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 346949: () => { return screen.width; },  
 346974: () => { return screen.height; },  
 347000: () => { return window.screenX; },  
 347027: () => { return window.screenY; },  
 347054: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 347107: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 347178: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 347235: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 347491: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 347562: () => { if (document.fullscreenElement) return 1; },  
 347608: () => { return window.innerWidth; },  
 347634: () => { return window.innerHeight; },  
 347661: () => { if (document.pointerLockElement) return 1; }
};
