...
function findWasmBinary() {
  return locateFile('raylib_textures_sprite_anim.wasm');
}
...
var ASM_CONSTS = {
  111568: () => { if (document.fullscreenElement) return 1; },  
 111614: () => { return document.getElementById('canvas').width; },  
 111666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111734: () => { document.exitFullscreen(); },  
 111761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 111834: () => { if (document.fullscreenElement) return 1; },  
 111880: () => { return document.getElementById('canvas').width; },  
 111932: () => { return screen.width; },  
 111957: () => { document.exitFullscreen(); },  
 111984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 112117: () => { return window.innerWidth; },  
 112143: () => { return window.innerHeight; },  
 112170: () => { if (document.fullscreenElement) return 1; },  
 112216: () => { return document.getElementById('canvas').width; },  
 112268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 112459: () => { return window.innerWidth; },  
 112485: () => { return window.innerHeight; },  
 112512: () => { if (document.fullscreenElement) return 1; },  
 112558: () => { return document.getElementById('canvas').width; },  
 112610: () => { return screen.width; },  
 112635: () => { document.exitFullscreen(); },  
 112662: () => { if (document.fullscreenElement) return 1; },  
 112708: () => { return document.getElementById('canvas').width; },  
 112760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112828: () => { document.exitFullscreen(); },  
 112855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 112913: () => { return screen.width; },  
 112938: () => { return screen.height; },  
 112964: () => { return window.screenX; },  
 112991: () => { return window.screenY; },  
 113018: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 113071: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 113142: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 113199: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 113455: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 113526: () => { if (document.fullscreenElement) return 1; },  
 113572: () => { return window.innerWidth; },  
 113598: () => { return window.innerHeight; },  
 113625: () => { if (document.pointerLockElement) return 1; }
};
