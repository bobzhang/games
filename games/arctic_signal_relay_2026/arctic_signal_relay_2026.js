...
function findWasmBinary() {
  return locateFile('arctic_signal_relay_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 263266: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263334: () => { document.exitFullscreen(); },  
 263361: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263434: () => { if (document.fullscreenElement) return 1; },  
 263480: () => { return document.getElementById('canvas').width; },  
 263532: () => { return screen.width; },  
 263557: () => { document.exitFullscreen(); },  
 263584: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263717: () => { return window.innerWidth; },  
 263743: () => { return window.innerHeight; },  
 ...
 263936: () => { if (document.fullscreenElement) return 1; },  
 263982: () => { return document.getElementById('canvas').width; },  
 264034: () => { return screen.width; },  
 264059: () => { return window.innerWidth; },  
 264085: () => { return window.innerHeight; },  
 264112: () => { if (document.fullscreenElement) return 1; },  
 264158: () => { return document.getElementById('canvas').width; },  
 264210: () => { return screen.width; },  
 264235: () => { document.exitFullscreen(); },  
 264262: () => { if (document.fullscreenElement) return 1; },  
 264308: () => { return document.getElementById('canvas').width; },  
 264360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264428: () => { document.exitFullscreen(); },  
 264455: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264513: () => { return screen.width; },  
 264538: () => { return screen.height; },  
 264564: () => { return window.screenX; },  
 264591: () => { return window.screenY; },  
 264618: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264671: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264742: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264799: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265055: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265126: () => { if (document.fullscreenElement) return 1; },  
 265172: () => { return window.innerWidth; },  
 265198: () => { return window.innerHeight; },  
 265225: () => { if (document.pointerLockElement) return 1; }
};
