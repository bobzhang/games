...
var ASM_CONSTS = {
  263172: () => { if (document.fullscreenElement) return 1; },  
 263218: () => { return document.getElementById('canvas').width; },  
 263270: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263338: () => { document.exitFullscreen(); },  
 263365: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263438: () => { if (document.fullscreenElement) return 1; },  
 263484: () => { return document.getElementById('canvas').width; },  
 263536: () => { return screen.width; },  
 263561: () => { document.exitFullscreen(); },  
 263588: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263721: () => { return window.innerWidth; },  
 263747: () => { return window.innerHeight; },  
 263774: () => { if (document.fullscreenElement) return 1; },  
 263820: () => { return document.getElementById('canvas').width; },  
 263872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263940: () => { if (document.fullscreenElement) return 1; },  
 263986: () => { return document.getElementById('canvas').width; },  
 264038: () => { return screen.width; },  
 264063: () => { return window.innerWidth; },  
 264089: () => { return window.innerHeight; },  
 264116: () => { if (document.fullscreenElement) return 1; },  
 264162: () => { return document.getElementById('canvas').width; },  
 264214: () => { return screen.width; },  
 264239: () => { document.exitFullscreen(); },  
 264266: () => { if (document.fullscreenElement) return 1; },  
 264312: () => { return document.getElementById('canvas').width; },  
 264364: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264432: () => { document.exitFullscreen(); },  
 264459: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264517: () => { return screen.width; },  
 264542: () => { return screen.height; },  
 264568: () => { return window.screenX; },  
 264595: () => { return window.screenY; },  
 264622: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264675: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264746: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264803: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265059: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265130: () => { if (document.fullscreenElement) return 1; },  
 265176: () => { return window.innerWidth; },  
 265202: () => { return window.innerHeight; },  
 265229: () => { if (document.pointerLockElement) return 1; }
};
