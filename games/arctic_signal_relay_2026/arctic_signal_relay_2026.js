...
var ASM_CONSTS = {
  263156: () => { if (document.fullscreenElement) return 1; },  
 263202: () => { return document.getElementById('canvas').width; },  
 263254: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263322: () => { document.exitFullscreen(); },  
 263349: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263422: () => { if (document.fullscreenElement) return 1; },  
 263468: () => { return document.getElementById('canvas').width; },  
 263520: () => { return screen.width; },  
 263545: () => { document.exitFullscreen(); },  
 263572: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263705: () => { return window.innerWidth; },  
 263731: () => { return window.innerHeight; },  
 263758: () => { if (document.fullscreenElement) return 1; },  
 263804: () => { return document.getElementById('canvas').width; },  
 263856: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264047: () => { return window.innerWidth; },  
 ...
 264223: () => { document.exitFullscreen(); },  
 264250: () => { if (document.fullscreenElement) return 1; },  
 264296: () => { return document.getElementById('canvas').width; },  
 264348: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264416: () => { document.exitFullscreen(); },  
 264443: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264501: () => { return screen.width; },  
 264526: () => { return screen.height; },  
 264552: () => { return window.screenX; },  
 264579: () => { return window.screenY; },  
 264606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264659: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264730: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264787: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265043: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265114: () => { if (document.fullscreenElement) return 1; },  
 265160: () => { return window.innerWidth; },  
 265186: () => { return window.innerHeight; },  
 265213: () => { if (document.pointerLockElement) return 1; }
};
