...
function findWasmBinary() {
  return locateFile('polar_train_heist_2026.wasm');
}
...
var ASM_CONSTS = {
  268508: () => { if (document.fullscreenElement) return 1; },  
 268554: () => { return document.getElementById('canvas').width; },  
 268606: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268674: () => { document.exitFullscreen(); },  
 268701: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268774: () => { if (document.fullscreenElement) return 1; },  
 268820: () => { return document.getElementById('canvas').width; },  
 268872: () => { return screen.width; },  
 268897: () => { document.exitFullscreen(); },  
 268924: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269057: () => { return window.innerWidth; },  
 269083: () => { return window.innerHeight; },  
 269110: () => { if (document.fullscreenElement) return 1; },  
 269156: () => { return document.getElementById('canvas').width; },  
 269208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269276: () => { if (document.fullscreenElement) return 1; },  
 269322: () => { return document.getElementById('canvas').width; },  
 269374: () => { return screen.width; },  
 269399: () => { return window.innerWidth; },  
 269425: () => { return window.innerHeight; },  
 269452: () => { if (document.fullscreenElement) return 1; },  
 269498: () => { return document.getElementById('canvas').width; },  
 269550: () => { return screen.width; },  
 269575: () => { document.exitFullscreen(); },  
