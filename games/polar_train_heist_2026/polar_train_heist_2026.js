...
var ASM_CONSTS = {
  268264: () => { if (document.fullscreenElement) return 1; },  
 268310: () => { return document.getElementById('canvas').width; },  
 268362: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268430: () => { document.exitFullscreen(); },  
 268457: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268530: () => { if (document.fullscreenElement) return 1; },  
 268576: () => { return document.getElementById('canvas').width; },  
 268628: () => { return screen.width; },  
 268653: () => { document.exitFullscreen(); },  
 268680: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268813: () => { return window.innerWidth; },  
 268839: () => { return window.innerHeight; },  
 268866: () => { if (document.fullscreenElement) return 1; },  
 268912: () => { return document.getElementById('canvas').width; },  
 268964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 276252: ($0) => { miniaudio.untrack_device_by_index($0); },  
 276295: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 276420: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
