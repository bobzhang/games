...
var ASM_CONSTS = {
  378384: () => { if (document.fullscreenElement) return 1; },  
 378430: () => { return document.getElementById('canvas').width; },  
 378482: () => { return parseInt(document.getElementById('canvas').style.width); },  
 378550: () => { document.exitFullscreen(); },  
 378577: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 378650: () => { if (document.fullscreenElement) return 1; },  
 378696: () => { return document.getElementById('canvas').width; },  
 378748: () => { return screen.width; },  
 378773: () => { document.exitFullscreen(); },  
 378800: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 378933: () => { return window.innerWidth; },  
 378959: () => { return window.innerHeight; },  
 378986: () => { if (document.fullscreenElement) return 1; },  
 379032: () => { return document.getElementById('canvas').width; },  
 379084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 379152: () => { if (document.fullscreenElement) return 1; },  
 379198: () => { return document.getElementById('canvas').width; },  
 379250: () => { return screen.width; },  
 379275: () => { return window.innerWidth; },  
 379301: () => { return window.innerHeight; },  
 379328: () => { if (document.fullscreenElement) return 1; },  
 379374: () => { return document.getElementById('canvas').width; },  
 379426: () => { return screen.width; },  
 379451: () => { document.exitFullscreen(); },  
 379478: () => { if (document.fullscreenElement) return 1; },  
 379524: () => { return document.getElementById('canvas').width; },  
 379576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 379644: () => { document.exitFullscreen(); },  
 379671: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 379729: () => { return screen.width; },  
 379754: () => { return screen.height; },  
 379780: () => { return window.screenX; },  
 379807: () => { return window.screenY; },  
 379834: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 379887: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 379958: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 380015: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 380271: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 380342: () => { if (document.fullscreenElement) return 1; },  
 380388: () => { return window.innerWidth; },  
 380414: () => { return window.innerHeight; },  
 380441: () => { if (document.pointerLockElement) return 1; }
};
