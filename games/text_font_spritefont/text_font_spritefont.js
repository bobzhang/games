...
var ASM_CONSTS = {
  378180: () => { if (document.fullscreenElement) return 1; },  
 378226: () => { return document.getElementById('canvas').width; },  
 378278: () => { return parseInt(document.getElementById('canvas').style.width); },  
 378346: () => { document.exitFullscreen(); },  
 378373: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 378446: () => { if (document.fullscreenElement) return 1; },  
 378492: () => { return document.getElementById('canvas').width; },  
 378544: () => { return screen.width; },  
 378569: () => { document.exitFullscreen(); },  
 378596: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 378729: () => { return window.innerWidth; },  
 378755: () => { return window.innerHeight; },  
 378782: () => { if (document.fullscreenElement) return 1; },  
 378828: () => { return document.getElementById('canvas').width; },  
 378880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 378948: () => { if (document.fullscreenElement) return 1; },  
 378994: () => { return document.getElementById('canvas').width; },  
 379046: () => { return screen.width; },  
 379071: () => { return window.innerWidth; },  
 379097: () => { return window.innerHeight; },  
 379124: () => { if (document.fullscreenElement) return 1; },  
 379170: () => { return document.getElementById('canvas').width; },  
 379222: () => { return screen.width; },  
 379247: () => { document.exitFullscreen(); },  
 379274: () => { if (document.fullscreenElement) return 1; },  
 379320: () => { return document.getElementById('canvas').width; },  
 379372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 379440: () => { document.exitFullscreen(); },  
 379467: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 379525: () => { return screen.width; },  
 379550: () => { return screen.height; },  
 379576: () => { return window.screenX; },  
 379603: () => { return window.screenY; },  
 379630: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 379683: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 379754: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 379811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 380067: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 380138: () => { if (document.fullscreenElement) return 1; },  
 380184: () => { return window.innerWidth; },  
 380210: () => { return window.innerHeight; },  
 380237: () => { if (document.pointerLockElement) return 1; }
};
