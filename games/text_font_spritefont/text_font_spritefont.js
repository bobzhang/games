...
var ASM_CONSTS = {
  378388: () => { if (document.fullscreenElement) return 1; },  
 378434: () => { return document.getElementById('canvas').width; },  
 378486: () => { return parseInt(document.getElementById('canvas').style.width); },  
 378554: () => { document.exitFullscreen(); },  
 378581: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 378654: () => { if (document.fullscreenElement) return 1; },  
 378700: () => { return document.getElementById('canvas').width; },  
 378752: () => { return screen.width; },  
 378777: () => { document.exitFullscreen(); },  
 378804: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 378937: () => { return window.innerWidth; },  
 378963: () => { return window.innerHeight; },  
 378990: () => { if (document.fullscreenElement) return 1; },  
 379036: () => { return document.getElementById('canvas').width; },  
 379088: () => { return parseInt(document.getElementById('canvas').style.width); },  
 379156: () => { if (document.fullscreenElement) return 1; },  
 379202: () => { return document.getElementById('canvas').width; },  
 379254: () => { return screen.width; },  
 379279: () => { return window.innerWidth; },  
 379305: () => { return window.innerHeight; },  
 379332: () => { if (document.fullscreenElement) return 1; },  
 379378: () => { return document.getElementById('canvas').width; },  
 379430: () => { return screen.width; },  
 379455: () => { document.exitFullscreen(); },  
 379482: () => { if (document.fullscreenElement) return 1; },  
 379528: () => { return document.getElementById('canvas').width; },  
 379580: () => { return parseInt(document.getElementById('canvas').style.width); },  
 379648: () => { document.exitFullscreen(); },  
 379675: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 379733: () => { return screen.width; },  
 379758: () => { return screen.height; },  
 379784: () => { return window.screenX; },  
 379811: () => { return window.screenY; },  
 379838: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 379891: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 379962: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 380019: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 380275: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 380346: () => { if (document.fullscreenElement) return 1; },  
 380392: () => { return window.innerWidth; },  
 380418: () => { return window.innerHeight; },  
 380445: () => { if (document.pointerLockElement) return 1; }
};
