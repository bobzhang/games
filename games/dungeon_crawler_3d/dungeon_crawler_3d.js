...
var ASM_CONSTS = {
  269140: () => { if (document.fullscreenElement) return 1; },  
 269186: () => { return document.getElementById('canvas').width; },  
 269238: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269306: () => { document.exitFullscreen(); },  
 269333: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269406: () => { if (document.fullscreenElement) return 1; },  
 269452: () => { return document.getElementById('canvas').width; },  
 269504: () => { return screen.width; },  
 269529: () => { document.exitFullscreen(); },  
 269556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269689: () => { return window.innerWidth; },  
 269715: () => { return window.innerHeight; },  
 ...
 269908: () => { if (document.fullscreenElement) return 1; },  
 269954: () => { return document.getElementById('canvas').width; },  
 270006: () => { return screen.width; },  
 270031: () => { return window.innerWidth; },  
 270057: () => { return window.innerHeight; },  
 270084: () => { if (document.fullscreenElement) return 1; },  
 270130: () => { return document.getElementById('canvas').width; },  
 270182: () => { return screen.width; },  
 270207: () => { document.exitFullscreen(); },  
 270234: () => { if (document.fullscreenElement) return 1; },  
 270280: () => { return document.getElementById('canvas').width; },  
 270332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270400: () => { document.exitFullscreen(); },  
 270427: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270485: () => { return screen.width; },  
 270510: () => { return screen.height; },  
 270536: () => { return window.screenX; },  
 270563: () => { return window.screenY; },  
 270590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270643: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270714: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271027: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271098: () => { if (document.fullscreenElement) return 1; },  
 271144: () => { return window.innerWidth; },  
 271170: () => { return window.innerHeight; },  
 271197: () => { if (document.pointerLockElement) return 1; }
};
