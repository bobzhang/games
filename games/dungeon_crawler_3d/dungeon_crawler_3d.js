...
var ASM_CONSTS = {
  270836: () => { if (document.fullscreenElement) return 1; },  
 270882: () => { return document.getElementById('canvas').width; },  
 270934: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271002: () => { document.exitFullscreen(); },  
 271029: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 271102: () => { if (document.fullscreenElement) return 1; },  
 271148: () => { return document.getElementById('canvas').width; },  
 271200: () => { return screen.width; },  
 271225: () => { document.exitFullscreen(); },  
 271252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 271385: () => { return window.innerWidth; },  
 271411: () => { return window.innerHeight; },  
 271438: () => { if (document.fullscreenElement) return 1; },  
 271484: () => { return document.getElementById('canvas').width; },  
 271536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271604: () => { if (document.fullscreenElement) return 1; },  
 271650: () => { return document.getElementById('canvas').width; },  
 271702: () => { return screen.width; },  
 271727: () => { return window.innerWidth; },  
 271753: () => { return window.innerHeight; },  
 271780: () => { if (document.fullscreenElement) return 1; },  
 271826: () => { return document.getElementById('canvas').width; },  
 271878: () => { return screen.width; },  
 271903: () => { document.exitFullscreen(); },  
 271930: () => { if (document.fullscreenElement) return 1; },  
 271976: () => { return document.getElementById('canvas').width; },  
 272028: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272096: () => { document.exitFullscreen(); },  
 272123: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 272181: () => { return screen.width; },  
 272206: () => { return screen.height; },  
 272232: () => { return window.screenX; },  
 272259: () => { return window.screenY; },  
 272286: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 272339: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 272410: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 272467: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 272723: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 272794: () => { if (document.fullscreenElement) return 1; },  
 272840: () => { return window.innerWidth; },  
 272866: () => { return window.innerHeight; },  
 272893: () => { if (document.pointerLockElement) return 1; }
};
