...
var ASM_CONSTS = {
  268932: () => { if (document.fullscreenElement) return 1; },  
 268978: () => { return document.getElementById('canvas').width; },  
 269030: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269098: () => { document.exitFullscreen(); },  
 269125: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269198: () => { if (document.fullscreenElement) return 1; },  
 269244: () => { return document.getElementById('canvas').width; },  
 269296: () => { return screen.width; },  
 269321: () => { document.exitFullscreen(); },  
 269348: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269481: () => { return window.innerWidth; },  
 269507: () => { return window.innerHeight; },  
 269534: () => { if (document.fullscreenElement) return 1; },  
 269580: () => { return document.getElementById('canvas').width; },  
 269632: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269700: () => { if (document.fullscreenElement) return 1; },  
 269746: () => { return document.getElementById('canvas').width; },  
 269798: () => { return screen.width; },  
 269823: () => { return window.innerWidth; },  
 269849: () => { return window.innerHeight; },  
 269876: () => { if (document.fullscreenElement) return 1; },  
 269922: () => { return document.getElementById('canvas').width; },  
 269974: () => { return screen.width; },  
 269999: () => { document.exitFullscreen(); },  
 270026: () => { if (document.fullscreenElement) return 1; },  
 270072: () => { return document.getElementById('canvas').width; },  
 270124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270192: () => { document.exitFullscreen(); },  
 270219: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270277: () => { return screen.width; },  
 270302: () => { return screen.height; },  
 270328: () => { return window.screenX; },  
 270355: () => { return window.screenY; },  
 270382: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270435: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270506: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270563: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270819: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270890: () => { if (document.fullscreenElement) return 1; },  
 270936: () => { return window.innerWidth; },  
 270962: () => { return window.innerHeight; },  
 270989: () => { if (document.pointerLockElement) return 1; }
};
