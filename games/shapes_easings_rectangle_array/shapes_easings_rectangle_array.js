...
var ASM_CONSTS = {
  260596: () => { if (document.fullscreenElement) return 1; },  
 260642: () => { return document.getElementById('canvas').width; },  
 260694: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260762: () => { document.exitFullscreen(); },  
 260789: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260862: () => { if (document.fullscreenElement) return 1; },  
 260908: () => { return document.getElementById('canvas').width; },  
 260960: () => { return screen.width; },  
 260985: () => { document.exitFullscreen(); },  
 261012: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261145: () => { return window.innerWidth; },  
 261171: () => { return window.innerHeight; },  
 261198: () => { if (document.fullscreenElement) return 1; },  
 261244: () => { return document.getElementById('canvas').width; },  
 261296: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261364: () => { if (document.fullscreenElement) return 1; },  
 261410: () => { return document.getElementById('canvas').width; },  
 261462: () => { return screen.width; },  
 261487: () => { return window.innerWidth; },  
 261513: () => { return window.innerHeight; },  
 ...
 261663: () => { document.exitFullscreen(); },  
 261690: () => { if (document.fullscreenElement) return 1; },  
 261736: () => { return document.getElementById('canvas').width; },  
 261788: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261856: () => { document.exitFullscreen(); },  
 261883: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261941: () => { return screen.width; },  
 261966: () => { return screen.height; },  
 261992: () => { return window.screenX; },  
 262019: () => { return window.screenY; },  
 262046: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262099: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262170: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262227: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262483: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262554: () => { if (document.fullscreenElement) return 1; },  
 262600: () => { return window.innerWidth; },  
 262626: () => { return window.innerHeight; },  
 262653: () => { if (document.pointerLockElement) return 1; }
};
