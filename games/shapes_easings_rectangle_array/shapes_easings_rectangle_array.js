...
var ASM_CONSTS = {
  260388: () => { if (document.fullscreenElement) return 1; },  
 260434: () => { return document.getElementById('canvas').width; },  
 260486: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260554: () => { document.exitFullscreen(); },  
 260581: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260654: () => { if (document.fullscreenElement) return 1; },  
 260700: () => { return document.getElementById('canvas').width; },  
 260752: () => { return screen.width; },  
 260777: () => { document.exitFullscreen(); },  
 260804: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260937: () => { return window.innerWidth; },  
 260963: () => { return window.innerHeight; },  
 260990: () => { if (document.fullscreenElement) return 1; },  
 261036: () => { return document.getElementById('canvas').width; },  
 261088: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261156: () => { if (document.fullscreenElement) return 1; },  
 261202: () => { return document.getElementById('canvas').width; },  
 261254: () => { return screen.width; },  
 261279: () => { return window.innerWidth; },  
 261305: () => { return window.innerHeight; },  
 ...
 261455: () => { document.exitFullscreen(); },  
 261482: () => { if (document.fullscreenElement) return 1; },  
 261528: () => { return document.getElementById('canvas').width; },  
 261580: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261648: () => { document.exitFullscreen(); },  
 261675: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261733: () => { return screen.width; },  
 261758: () => { return screen.height; },  
 261784: () => { return window.screenX; },  
 261811: () => { return window.screenY; },  
 261838: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261891: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 261962: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262019: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262275: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262346: () => { if (document.fullscreenElement) return 1; },  
 262392: () => { return window.innerWidth; },  
 262418: () => { return window.innerHeight; },  
 262445: () => { if (document.pointerLockElement) return 1; }
};
