...
var ASM_CONSTS = {
  268892: () => { if (document.fullscreenElement) return 1; },  
 268938: () => { return document.getElementById('canvas').width; },  
 268990: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269058: () => { document.exitFullscreen(); },  
 269085: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269158: () => { if (document.fullscreenElement) return 1; },  
 269204: () => { return document.getElementById('canvas').width; },  
 269256: () => { return screen.width; },  
 269281: () => { document.exitFullscreen(); },  
 269308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269441: () => { return window.innerWidth; },  
 269467: () => { return window.innerHeight; },  
 269494: () => { if (document.fullscreenElement) return 1; },  
 269540: () => { return document.getElementById('canvas').width; },  
 269592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269660: () => { if (document.fullscreenElement) return 1; },  
 269706: () => { return document.getElementById('canvas').width; },  
 269758: () => { return screen.width; },  
 269783: () => { return window.innerWidth; },  
 269809: () => { return window.innerHeight; },  
 269836: () => { if (document.fullscreenElement) return 1; },  
 269882: () => { return document.getElementById('canvas').width; },  
 269934: () => { return screen.width; },  
 269959: () => { document.exitFullscreen(); },  
