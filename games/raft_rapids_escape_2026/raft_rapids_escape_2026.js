...
var ASM_CONSTS = {
  269112: () => { if (document.fullscreenElement) return 1; },  
 269158: () => { return document.getElementById('canvas').width; },  
 269210: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269278: () => { document.exitFullscreen(); },  
 269305: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269378: () => { if (document.fullscreenElement) return 1; },  
 269424: () => { return document.getElementById('canvas').width; },  
 269476: () => { return screen.width; },  
 269501: () => { document.exitFullscreen(); },  
 269528: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269661: () => { return window.innerWidth; },  
 269687: () => { return window.innerHeight; },  
 269714: () => { if (document.fullscreenElement) return 1; },  
 269760: () => { return document.getElementById('canvas').width; },  
 269812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269880: () => { if (document.fullscreenElement) return 1; },  
 269926: () => { return document.getElementById('canvas').width; },  
 269978: () => { return screen.width; },  
 270003: () => { return window.innerWidth; },  
 270029: () => { return window.innerHeight; },  
