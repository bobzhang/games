...
var ASM_CONSTS = {
  269116: () => { if (document.fullscreenElement) return 1; },  
 269162: () => { return document.getElementById('canvas').width; },  
 269214: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269282: () => { document.exitFullscreen(); },  
 269309: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269382: () => { if (document.fullscreenElement) return 1; },  
 269428: () => { return document.getElementById('canvas').width; },  
 269480: () => { return screen.width; },  
 269505: () => { document.exitFullscreen(); },  
 269532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269665: () => { return window.innerWidth; },  
 269691: () => { return window.innerHeight; },  
 269718: () => { if (document.fullscreenElement) return 1; },  
 269764: () => { return document.getElementById('canvas').width; },  
 269816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269884: () => { if (document.fullscreenElement) return 1; },  
 269930: () => { return document.getElementById('canvas').width; },  
 269982: () => { return screen.width; },  
 270007: () => { return window.innerWidth; },  
 270033: () => { return window.innerHeight; },  
 ...
 270183: () => { document.exitFullscreen(); },  
 270210: () => { if (document.fullscreenElement) return 1; },  
 270256: () => { return document.getElementById('canvas').width; },  
 270308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270376: () => { document.exitFullscreen(); },  
 270403: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270461: () => { return screen.width; },  
 270486: () => { return screen.height; },  
 270512: () => { return window.screenX; },  
 270539: () => { return window.screenY; },  
 270566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270619: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270690: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271003: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271074: () => { if (document.fullscreenElement) return 1; },  
 271120: () => { return window.innerWidth; },  
 271146: () => { return window.innerHeight; },  
 271173: () => { if (document.pointerLockElement) return 1; },  
