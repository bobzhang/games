...
var ASM_CONSTS = {
  285844: () => { if (document.fullscreenElement) return 1; },  
 285890: () => { return document.getElementById('canvas').width; },  
 285942: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286010: () => { document.exitFullscreen(); },  
 286037: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 286110: () => { if (document.fullscreenElement) return 1; },  
 286156: () => { return document.getElementById('canvas').width; },  
 286208: () => { return screen.width; },  
 286233: () => { document.exitFullscreen(); },  
 286260: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 286393: () => { return window.innerWidth; },  
 286419: () => { return window.innerHeight; },  
 286446: () => { if (document.fullscreenElement) return 1; },  
 286492: () => { return document.getElementById('canvas').width; },  
 286544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286612: () => { if (document.fullscreenElement) return 1; },  
 286658: () => { return document.getElementById('canvas').width; },  
 286710: () => { return screen.width; },  
 286735: () => { return window.innerWidth; },  
 286761: () => { return window.innerHeight; },  
 286788: () => { if (document.fullscreenElement) return 1; },  
 286834: () => { return document.getElementById('canvas').width; },  
 286886: () => { return screen.width; },  
 286911: () => { document.exitFullscreen(); },  
 286938: () => { if (document.fullscreenElement) return 1; },  
 286984: () => { return document.getElementById('canvas').width; },  
 287036: () => { return parseInt(document.getElementById('canvas').style.width); },  
 287104: () => { document.exitFullscreen(); },  
 287131: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 287189: () => { return screen.width; },  
 287214: () => { return screen.height; },  
 287240: () => { return window.screenX; },  
 287267: () => { return window.screenY; },  
 287294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 287347: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 287418: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 287475: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 287731: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 287802: () => { if (document.fullscreenElement) return 1; },  
 287848: () => { return window.innerWidth; },  
 287874: () => { return window.innerHeight; },  
 287901: () => { if (document.pointerLockElement) return 1; }
};
