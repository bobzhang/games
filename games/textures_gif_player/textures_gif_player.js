...
var ASM_CONSTS = {
  286068: () => { if (document.fullscreenElement) return 1; },  
 286114: () => { return document.getElementById('canvas').width; },  
 286166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286234: () => { document.exitFullscreen(); },  
 286261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 286334: () => { if (document.fullscreenElement) return 1; },  
 286380: () => { return document.getElementById('canvas').width; },  
 286432: () => { return screen.width; },  
 286457: () => { document.exitFullscreen(); },  
 286484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 286617: () => { return window.innerWidth; },  
 286643: () => { return window.innerHeight; },  
 286670: () => { if (document.fullscreenElement) return 1; },  
 286716: () => { return document.getElementById('canvas').width; },  
 286768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 286836: () => { if (document.fullscreenElement) return 1; },  
 286882: () => { return document.getElementById('canvas').width; },  
 286934: () => { return screen.width; },  
 286959: () => { return window.innerWidth; },  
 286985: () => { return window.innerHeight; },  
 287012: () => { if (document.fullscreenElement) return 1; },  
 287058: () => { return document.getElementById('canvas').width; },  
 287110: () => { return screen.width; },  
 287135: () => { document.exitFullscreen(); },  
 287162: () => { if (document.fullscreenElement) return 1; },  
 287208: () => { return document.getElementById('canvas').width; },  
 287260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 287328: () => { document.exitFullscreen(); },  
 287355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 287413: () => { return screen.width; },  
 287438: () => { return screen.height; },  
 287464: () => { return window.screenX; },  
 287491: () => { return window.screenY; },  
 287518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 287571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 287642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 287699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 287955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 288026: () => { if (document.fullscreenElement) return 1; },  
 288072: () => { return window.innerWidth; },  
 288098: () => { return window.innerHeight; },  
 288125: () => { if (document.pointerLockElement) return 1; }
};
