...
var ASM_CONSTS = {
 ...
 262934: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263002: () => { document.exitFullscreen(); },  
 263029: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263102: () => { if (document.fullscreenElement) return 1; },  
 263148: () => { return document.getElementById('canvas').width; },  
 263200: () => { return screen.width; },  
 263225: () => { document.exitFullscreen(); },  
 263252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263385: () => { return window.innerWidth; },  
 263411: () => { return window.innerHeight; },  
 263438: () => { if (document.fullscreenElement) return 1; },  
 263484: () => { return document.getElementById('canvas').width; },  
 263536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263727: () => { return window.innerWidth; },  
 263753: () => { return window.innerHeight; },  
 ...
 263903: () => { document.exitFullscreen(); },  
 ...
 264096: () => { document.exitFullscreen(); },  
 264123: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264181: () => { return screen.width; },  
 264206: () => { return screen.height; },  
 264232: () => { return window.screenX; },  
 264259: () => { return window.screenY; },  
 264286: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264339: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264410: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264467: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264723: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264794: () => { if (document.fullscreenElement) return 1; },  
 264840: () => { return window.innerWidth; },  
 264866: () => { return window.innerHeight; },  
 264893: () => { if (document.pointerLockElement) return 1; }
};
