...
var ASM_CONSTS = {
  262628: () => { if (document.fullscreenElement) return 1; },  
 262674: () => { return document.getElementById('canvas').width; },  
 262726: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262794: () => { document.exitFullscreen(); },  
 262821: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262894: () => { if (document.fullscreenElement) return 1; },  
 262940: () => { return document.getElementById('canvas').width; },  
 262992: () => { return screen.width; },  
 263017: () => { document.exitFullscreen(); },  
 263044: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263177: () => { return window.innerWidth; },  
 263203: () => { return window.innerHeight; },  
 263230: () => { if (document.fullscreenElement) return 1; },  
 263276: () => { return document.getElementById('canvas').width; },  
 263328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263519: () => { return window.innerWidth; },  
 263545: () => { return window.innerHeight; },  
 ...
 263695: () => { document.exitFullscreen(); },  
 ...
 263888: () => { document.exitFullscreen(); },  
 263915: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263973: () => { return screen.width; },  
 263998: () => { return screen.height; },  
 264024: () => { return window.screenX; },  
 264051: () => { return window.screenY; },  
 264078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264131: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264202: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264515: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264586: () => { if (document.fullscreenElement) return 1; },  
 264632: () => { return window.innerWidth; },  
 264658: () => { return window.innerHeight; },  
 264685: () => { if (document.pointerLockElement) return 1; }
};
