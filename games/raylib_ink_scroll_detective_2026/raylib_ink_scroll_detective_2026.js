...
var ASM_CONSTS = {
  100112: () => { if (document.fullscreenElement) return 1; },  
 100158: () => { return document.getElementById('canvas').width; },  
 100210: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100278: () => { document.exitFullscreen(); },  
 100305: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100378: () => { if (document.fullscreenElement) return 1; },  
 100424: () => { return document.getElementById('canvas').width; },  
 100476: () => { return screen.width; },  
 100501: () => { document.exitFullscreen(); },  
 100528: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100661: () => { return window.innerWidth; },  
 100687: () => { return window.innerHeight; },  
 100714: () => { if (document.fullscreenElement) return 1; },  
 100760: () => { return document.getElementById('canvas').width; },  
 100812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 101003: () => { return window.innerWidth; },  
 101029: () => { return window.innerHeight; },  
 101056: () => { if (document.fullscreenElement) return 1; },  
 101102: () => { return document.getElementById('canvas').width; },  
 101154: () => { return screen.width; },  
 101179: () => { document.exitFullscreen(); },  
 101206: () => { if (document.fullscreenElement) return 1; },  
 101252: () => { return document.getElementById('canvas').width; },  
 101304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101372: () => { document.exitFullscreen(); },  
 101399: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101457: () => { return screen.width; },  
 101482: () => { return screen.height; },  
 101508: () => { return window.screenX; },  
 101535: () => { return window.screenY; },  
 101562: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101615: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101686: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101743: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101999: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102070: () => { if (document.fullscreenElement) return 1; },  
 102116: () => { return window.innerWidth; },  
 102142: () => { return window.innerHeight; },  
 102169: () => { if (document.pointerLockElement) return 1; }
};
