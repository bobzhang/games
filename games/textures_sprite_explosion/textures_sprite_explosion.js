...
var ASM_CONSTS = {
  1132144: () => { if (document.fullscreenElement) return 1; },  
 1132190: () => { return document.getElementById('canvas').width; },  
 1132242: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1132310: () => { document.exitFullscreen(); },  
 1132337: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1132410: () => { if (document.fullscreenElement) return 1; },  
 1132456: () => { return document.getElementById('canvas').width; },  
 1132508: () => { return screen.width; },  
 1132533: () => { document.exitFullscreen(); },  
 1132560: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1132693: () => { return window.innerWidth; },  
 1132719: () => { return window.innerHeight; },  
 1132746: () => { if (document.fullscreenElement) return 1; },  
 1132792: () => { return document.getElementById('canvas').width; },  
 1132844: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1132912: () => { if (document.fullscreenElement) return 1; },  
 1132958: () => { return document.getElementById('canvas').width; },  
 1133010: () => { return screen.width; },  
 1133035: () => { return window.innerWidth; },  
 1133061: () => { return window.innerHeight; },  
 1133088: () => { if (document.fullscreenElement) return 1; },  
 1133134: () => { return document.getElementById('canvas').width; },  
 1133186: () => { return screen.width; },  
 1133211: () => { document.exitFullscreen(); },  
 1133238: () => { if (document.fullscreenElement) return 1; },  
 1133284: () => { return document.getElementById('canvas').width; },  
 1133336: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1133404: () => { document.exitFullscreen(); },  
 1133431: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1133489: () => { return screen.width; },  
 1133514: () => { return screen.height; },  
 1133540: () => { return window.screenX; },  
 1133567: () => { return window.screenY; },  
 1133594: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1133647: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1133718: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1133775: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1134031: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1134102: () => { if (document.fullscreenElement) return 1; },  
 1134148: () => { return window.innerWidth; },  
 1134174: () => { return window.innerHeight; },  
 1134201: () => { if (document.pointerLockElement) return 1; },  
