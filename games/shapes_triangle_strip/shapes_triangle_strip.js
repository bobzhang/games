...
var ASM_CONSTS = {
  251940: () => { if (document.fullscreenElement) return 1; },  
 251986: () => { return document.getElementById('canvas').width; },  
 252038: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252106: () => { document.exitFullscreen(); },  
 252133: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252206: () => { if (document.fullscreenElement) return 1; },  
 252252: () => { return document.getElementById('canvas').width; },  
 252304: () => { return screen.width; },  
 252329: () => { document.exitFullscreen(); },  
 252356: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252489: () => { return window.innerWidth; },  
 252515: () => { return window.innerHeight; },  
 252542: () => { if (document.fullscreenElement) return 1; },  
 252588: () => { return document.getElementById('canvas').width; },  
 252640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252708: () => { if (document.fullscreenElement) return 1; },  
 252754: () => { return document.getElementById('canvas').width; },  
 252806: () => { return screen.width; },  
 252831: () => { return window.innerWidth; },  
 252857: () => { return window.innerHeight; },  
 252884: () => { if (document.fullscreenElement) return 1; },  
 252930: () => { return document.getElementById('canvas').width; },  
 252982: () => { return screen.width; },  
 253007: () => { document.exitFullscreen(); },  
 253034: () => { if (document.fullscreenElement) return 1; },  
 253080: () => { return document.getElementById('canvas').width; },  
 253132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253200: () => { document.exitFullscreen(); },  
 253227: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253285: () => { return screen.width; },  
 253310: () => { return screen.height; },  
 253336: () => { return window.screenX; },  
 253363: () => { return window.screenY; },  
 253390: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253443: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253514: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253571: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253827: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253898: () => { if (document.fullscreenElement) return 1; },  
 253944: () => { return window.innerWidth; },  
 253970: () => { return window.innerHeight; },  
 253997: () => { if (document.pointerLockElement) return 1; }
};
