...
var ASM_CONSTS = {
  251732: () => { if (document.fullscreenElement) return 1; },  
 251778: () => { return document.getElementById('canvas').width; },  
 251830: () => { return parseInt(document.getElementById('canvas').style.width); },  
 251898: () => { document.exitFullscreen(); },  
 251925: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 251998: () => { if (document.fullscreenElement) return 1; },  
 252044: () => { return document.getElementById('canvas').width; },  
 252096: () => { return screen.width; },  
 252121: () => { document.exitFullscreen(); },  
 252148: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252281: () => { return window.innerWidth; },  
 252307: () => { return window.innerHeight; },  
 252334: () => { if (document.fullscreenElement) return 1; },  
 252380: () => { return document.getElementById('canvas').width; },  
 252432: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252500: () => { if (document.fullscreenElement) return 1; },  
 252546: () => { return document.getElementById('canvas').width; },  
 252598: () => { return screen.width; },  
 252623: () => { return window.innerWidth; },  
 252649: () => { return window.innerHeight; },  
 252676: () => { if (document.fullscreenElement) return 1; },  
 252722: () => { return document.getElementById('canvas').width; },  
 252774: () => { return screen.width; },  
 252799: () => { document.exitFullscreen(); },  
 252826: () => { if (document.fullscreenElement) return 1; },  
 252872: () => { return document.getElementById('canvas').width; },  
 252924: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252992: () => { document.exitFullscreen(); },  
 253019: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253077: () => { return screen.width; },  
 253102: () => { return screen.height; },  
 253128: () => { return window.screenX; },  
 253155: () => { return window.screenY; },  
 253182: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253235: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253306: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253363: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253619: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253690: () => { if (document.fullscreenElement) return 1; },  
 253736: () => { return window.innerWidth; },  
 253762: () => { return window.innerHeight; },  
 253789: () => { if (document.pointerLockElement) return 1; }
};
