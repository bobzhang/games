...
function findWasmBinary() {
  return locateFile('shapes_triangle_strip.wasm');
}
...
var ASM_CONSTS = {
  251936: () => { if (document.fullscreenElement) return 1; },  
 251982: () => { return document.getElementById('canvas').width; },  
 252034: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252102: () => { document.exitFullscreen(); },  
 252129: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252202: () => { if (document.fullscreenElement) return 1; },  
 252248: () => { return document.getElementById('canvas').width; },  
 252300: () => { return screen.width; },  
 252325: () => { document.exitFullscreen(); },  
 252352: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252485: () => { return window.innerWidth; },  
 252511: () => { return window.innerHeight; },  
 252538: () => { if (document.fullscreenElement) return 1; },  
 252584: () => { return document.getElementById('canvas').width; },  
 252636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252704: () => { if (document.fullscreenElement) return 1; },  
 252750: () => { return document.getElementById('canvas').width; },  
 252802: () => { return screen.width; },  
 252827: () => { return window.innerWidth; },  
 252853: () => { return window.innerHeight; },  
 252880: () => { if (document.fullscreenElement) return 1; },  
 252926: () => { return document.getElementById('canvas').width; },  
 252978: () => { return screen.width; },  
 253003: () => { document.exitFullscreen(); },  
 253030: () => { if (document.fullscreenElement) return 1; },  
 253076: () => { return document.getElementById('canvas').width; },  
 253128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253196: () => { document.exitFullscreen(); },  
 253223: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253281: () => { return screen.width; },  
 253306: () => { return screen.height; },  
 253332: () => { return window.screenX; },  
 253359: () => { return window.screenY; },  
 253386: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253439: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253510: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253567: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253823: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253894: () => { if (document.fullscreenElement) return 1; },  
 253940: () => { return window.innerWidth; },  
 253966: () => { return window.innerHeight; },  
 253993: () => { if (document.pointerLockElement) return 1; }
};
