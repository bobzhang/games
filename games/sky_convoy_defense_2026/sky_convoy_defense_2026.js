...
var ASM_CONSTS = {
  261444: () => { if (document.fullscreenElement) return 1; },  
 261490: () => { return document.getElementById('canvas').width; },  
 261542: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261610: () => { document.exitFullscreen(); },  
 261637: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261710: () => { if (document.fullscreenElement) return 1; },  
 261756: () => { return document.getElementById('canvas').width; },  
 261808: () => { return screen.width; },  
 261833: () => { document.exitFullscreen(); },  
 261860: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261993: () => { return window.innerWidth; },  
 262019: () => { return window.innerHeight; },  
 262046: () => { if (document.fullscreenElement) return 1; },  
 262092: () => { return document.getElementById('canvas').width; },  
 262144: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262335: () => { return window.innerWidth; },  
 262361: () => { return window.innerHeight; },  
 ...
 262511: () => { document.exitFullscreen(); },  
 ...
 262704: () => { document.exitFullscreen(); },  
 262731: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262789: () => { return screen.width; },  
 262814: () => { return screen.height; },  
 262840: () => { return window.screenX; },  
 262867: () => { return window.screenY; },  
 262894: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262947: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263018: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263075: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263331: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263402: () => { if (document.fullscreenElement) return 1; },  
 263448: () => { return window.innerWidth; },  
 263474: () => { return window.innerHeight; },  
 263501: () => { if (document.pointerLockElement) return 1; }
};
