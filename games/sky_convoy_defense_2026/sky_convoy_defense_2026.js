...
var ASM_CONSTS = {
  261236: () => { if (document.fullscreenElement) return 1; },  
 261282: () => { return document.getElementById('canvas').width; },  
 261334: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261402: () => { document.exitFullscreen(); },  
 261429: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261502: () => { if (document.fullscreenElement) return 1; },  
 261548: () => { return document.getElementById('canvas').width; },  
 261600: () => { return screen.width; },  
 261625: () => { document.exitFullscreen(); },  
 261652: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261785: () => { return window.innerWidth; },  
 261811: () => { return window.innerHeight; },  
 261838: () => { if (document.fullscreenElement) return 1; },  
 261884: () => { return document.getElementById('canvas').width; },  
 261936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262127: () => { return window.innerWidth; },  
 262153: () => { return window.innerHeight; },  
 ...
 262303: () => { document.exitFullscreen(); },  
 262330: () => { if (document.fullscreenElement) return 1; },  
 262376: () => { return document.getElementById('canvas').width; },  
 262428: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262496: () => { document.exitFullscreen(); },  
 262523: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262581: () => { return screen.width; },  
 262606: () => { return screen.height; },  
 262632: () => { return window.screenX; },  
 262659: () => { return window.screenY; },  
 262686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262739: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262810: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262867: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263123: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263194: () => { if (document.fullscreenElement) return 1; },  
 263240: () => { return window.innerWidth; },  
 263266: () => { return window.innerHeight; },  
 263293: () => { if (document.pointerLockElement) return 1; }
};
