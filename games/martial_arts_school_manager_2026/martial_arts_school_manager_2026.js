...
var ASM_CONSTS = {
  264148: () => { if (document.fullscreenElement) return 1; },  
 264194: () => { return document.getElementById('canvas').width; },  
 264246: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264314: () => { document.exitFullscreen(); },  
 264341: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264414: () => { if (document.fullscreenElement) return 1; },  
 264460: () => { return document.getElementById('canvas').width; },  
 264512: () => { return screen.width; },  
 264537: () => { document.exitFullscreen(); },  
 264564: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264697: () => { return window.innerWidth; },  
 264723: () => { return window.innerHeight; },  
 264750: () => { if (document.fullscreenElement) return 1; },  
 264796: () => { return document.getElementById('canvas').width; },  
 264848: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264916: () => { if (document.fullscreenElement) return 1; },  
 264962: () => { return document.getElementById('canvas').width; },  
 265014: () => { return screen.width; },  
 265039: () => { return window.innerWidth; },  
 265065: () => { return window.innerHeight; },  
 265092: () => { if (document.fullscreenElement) return 1; },  
 265138: () => { return document.getElementById('canvas').width; },  
 265190: () => { return screen.width; },  
 265215: () => { document.exitFullscreen(); },  
 265242: () => { if (document.fullscreenElement) return 1; },  
 265288: () => { return document.getElementById('canvas').width; },  
 265340: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265408: () => { document.exitFullscreen(); },  
 265435: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265493: () => { return screen.width; },  
 265518: () => { return screen.height; },  
 265544: () => { return window.screenX; },  
 265571: () => { return window.screenY; },  
 265598: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265651: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265722: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265779: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266035: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266106: () => { if (document.fullscreenElement) return 1; },  
 266152: () => { return window.innerWidth; },  
 266178: () => { return window.innerHeight; },  
 266205: () => { if (document.pointerLockElement) return 1; }
};
