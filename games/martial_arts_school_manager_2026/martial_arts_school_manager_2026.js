...
var ASM_CONSTS = {
  264132: () => { if (document.fullscreenElement) return 1; },  
 264178: () => { return document.getElementById('canvas').width; },  
 264230: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264298: () => { document.exitFullscreen(); },  
 264325: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264398: () => { if (document.fullscreenElement) return 1; },  
 264444: () => { return document.getElementById('canvas').width; },  
 264496: () => { return screen.width; },  
 264521: () => { document.exitFullscreen(); },  
 264548: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264681: () => { return window.innerWidth; },  
 264707: () => { return window.innerHeight; },  
 264734: () => { if (document.fullscreenElement) return 1; },  
 264780: () => { return document.getElementById('canvas').width; },  
 264832: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264900: () => { if (document.fullscreenElement) return 1; },  
 264946: () => { return document.getElementById('canvas').width; },  
 264998: () => { return screen.width; },  
 265023: () => { return window.innerWidth; },  
 265049: () => { return window.innerHeight; },  
 265076: () => { if (document.fullscreenElement) return 1; },  
 265122: () => { return document.getElementById('canvas').width; },  
 265174: () => { return screen.width; },  
 265199: () => { document.exitFullscreen(); },  
 265226: () => { if (document.fullscreenElement) return 1; },  
 265272: () => { return document.getElementById('canvas').width; },  
 265324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265392: () => { document.exitFullscreen(); },  
 265419: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265477: () => { return screen.width; },  
 265502: () => { return screen.height; },  
 265528: () => { return window.screenX; },  
 265555: () => { return window.screenY; },  
 265582: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265635: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265706: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265763: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266019: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266090: () => { if (document.fullscreenElement) return 1; },  
 266136: () => { return window.innerWidth; },  
 266162: () => { return window.innerHeight; },  
 266189: () => { if (document.pointerLockElement) return 1; }
};
