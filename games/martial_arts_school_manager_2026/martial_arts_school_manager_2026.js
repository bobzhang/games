...
var ASM_CONSTS = {
  263940: () => { if (document.fullscreenElement) return 1; },  
 263986: () => { return document.getElementById('canvas').width; },  
 264038: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264106: () => { document.exitFullscreen(); },  
 264133: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264206: () => { if (document.fullscreenElement) return 1; },  
 264252: () => { return document.getElementById('canvas').width; },  
 264304: () => { return screen.width; },  
 264329: () => { document.exitFullscreen(); },  
 264356: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264489: () => { return window.innerWidth; },  
 264515: () => { return window.innerHeight; },  
 264542: () => { if (document.fullscreenElement) return 1; },  
 264588: () => { return document.getElementById('canvas').width; },  
 264640: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264708: () => { if (document.fullscreenElement) return 1; },  
 264754: () => { return document.getElementById('canvas').width; },  
 264806: () => { return screen.width; },  
 264831: () => { return window.innerWidth; },  
 264857: () => { return window.innerHeight; },  
 264884: () => { if (document.fullscreenElement) return 1; },  
 264930: () => { return document.getElementById('canvas').width; },  
 264982: () => { return screen.width; },  
 265007: () => { document.exitFullscreen(); },  
 265034: () => { if (document.fullscreenElement) return 1; },  
 265080: () => { return document.getElementById('canvas').width; },  
 265132: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265200: () => { document.exitFullscreen(); },  
 265227: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265285: () => { return screen.width; },  
 265310: () => { return screen.height; },  
 265336: () => { return window.screenX; },  
 265363: () => { return window.screenY; },  
 265390: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265443: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265514: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265571: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265827: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265898: () => { if (document.fullscreenElement) return 1; },  
 265944: () => { return window.innerWidth; },  
 265970: () => { return window.innerHeight; },  
 265997: () => { if (document.pointerLockElement) return 1; }
};
