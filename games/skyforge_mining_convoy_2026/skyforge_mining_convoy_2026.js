...
var ASM_CONSTS = {
  261796: () => { if (document.fullscreenElement) return 1; },  
 261842: () => { return document.getElementById('canvas').width; },  
 261894: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261962: () => { document.exitFullscreen(); },  
 261989: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262062: () => { if (document.fullscreenElement) return 1; },  
 262108: () => { return document.getElementById('canvas').width; },  
 262160: () => { return screen.width; },  
 262185: () => { document.exitFullscreen(); },  
 262212: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262345: () => { return window.innerWidth; },  
 262371: () => { return window.innerHeight; },  
 262398: () => { if (document.fullscreenElement) return 1; },  
 262444: () => { return document.getElementById('canvas').width; },  
 262496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262687: () => { return window.innerWidth; },  
 262713: () => { return window.innerHeight; },  
 262740: () => { if (document.fullscreenElement) return 1; },  
 262786: () => { return document.getElementById('canvas').width; },  
 262838: () => { return screen.width; },  
 262863: () => { document.exitFullscreen(); },  
 262890: () => { if (document.fullscreenElement) return 1; },  
 262936: () => { return document.getElementById('canvas').width; },  
 262988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263056: () => { document.exitFullscreen(); },  
 263083: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263141: () => { return screen.width; },  
 263166: () => { return screen.height; },  
 263192: () => { return window.screenX; },  
 263219: () => { return window.screenY; },  
 263246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263427: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263754: () => { if (document.fullscreenElement) return 1; },  
 263800: () => { return window.innerWidth; },  
 263826: () => { return window.innerHeight; },  
 263853: () => { if (document.pointerLockElement) return 1; }
};
