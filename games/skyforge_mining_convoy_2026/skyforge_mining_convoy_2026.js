...
var ASM_CONSTS = {
  261988: () => { if (document.fullscreenElement) return 1; },  
 262034: () => { return document.getElementById('canvas').width; },  
 262086: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262154: () => { document.exitFullscreen(); },  
 262181: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262254: () => { if (document.fullscreenElement) return 1; },  
 262300: () => { return document.getElementById('canvas').width; },  
 262352: () => { return screen.width; },  
 262377: () => { document.exitFullscreen(); },  
 262404: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262537: () => { return window.innerWidth; },  
 262563: () => { return window.innerHeight; },  
 262590: () => { if (document.fullscreenElement) return 1; },  
 262636: () => { return document.getElementById('canvas').width; },  
 262688: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262756: () => { if (document.fullscreenElement) return 1; },  
 262802: () => { return document.getElementById('canvas').width; },  
 262854: () => { return screen.width; },  
 262879: () => { return window.innerWidth; },  
 262905: () => { return window.innerHeight; },  
 262932: () => { if (document.fullscreenElement) return 1; },  
 262978: () => { return document.getElementById('canvas').width; },  
 263030: () => { return screen.width; },  
 263055: () => { document.exitFullscreen(); },  
 263082: () => { if (document.fullscreenElement) return 1; },  
 263128: () => { return document.getElementById('canvas').width; },  
 263180: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263248: () => { document.exitFullscreen(); },  
 263275: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263333: () => { return screen.width; },  
 263358: () => { return screen.height; },  
 263384: () => { return window.screenX; },  
 263411: () => { return window.screenY; },  
 263438: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263491: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263562: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263619: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263875: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263946: () => { if (document.fullscreenElement) return 1; },  
 263992: () => { return window.innerWidth; },  
 264018: () => { return window.innerHeight; },  
 264045: () => { if (document.pointerLockElement) return 1; }
};
