...
var ASM_CONSTS = {
 ...
 262118: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262186: () => { document.exitFullscreen(); },  
 262213: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262286: () => { if (document.fullscreenElement) return 1; },  
 262332: () => { return document.getElementById('canvas').width; },  
 262384: () => { return screen.width; },  
 262409: () => { document.exitFullscreen(); },  
 262436: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262569: () => { return window.innerWidth; },  
 262595: () => { return window.innerHeight; },  
 262622: () => { if (document.fullscreenElement) return 1; },  
 262668: () => { return document.getElementById('canvas').width; },  
 262720: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262911: () => { return window.innerWidth; },  
 262937: () => { return window.innerHeight; },  
 ...
 263087: () => { document.exitFullscreen(); },  
 263114: () => { if (document.fullscreenElement) return 1; },  
 263160: () => { return document.getElementById('canvas').width; },  
 263212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263280: () => { document.exitFullscreen(); },  
 263307: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263365: () => { return screen.width; },  
 263390: () => { return screen.height; },  
 263416: () => { return window.screenX; },  
 263443: () => { return window.screenY; },  
 263470: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263523: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263594: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263651: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263907: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263978: () => { if (document.fullscreenElement) return 1; },  
 264024: () => { return window.innerWidth; },  
 264050: () => { return window.innerHeight; },  
 264077: () => { if (document.pointerLockElement) return 1; }
};
