...
var ASM_CONSTS = {
  263108: () => { if (document.fullscreenElement) return 1; },  
 263154: () => { return document.getElementById('canvas').width; },  
 263206: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263274: () => { document.exitFullscreen(); },  
 263301: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263374: () => { if (document.fullscreenElement) return 1; },  
 263420: () => { return document.getElementById('canvas').width; },  
 263472: () => { return screen.width; },  
 263497: () => { document.exitFullscreen(); },  
 263524: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263657: () => { return window.innerWidth; },  
 263683: () => { return window.innerHeight; },  
 263710: () => { if (document.fullscreenElement) return 1; },  
 263756: () => { return document.getElementById('canvas').width; },  
 263808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263876: () => { if (document.fullscreenElement) return 1; },  
 263922: () => { return document.getElementById('canvas').width; },  
 263974: () => { return screen.width; },  
 263999: () => { return window.innerWidth; },  
 264025: () => { return window.innerHeight; },  
 264052: () => { if (document.fullscreenElement) return 1; },  
 264098: () => { return document.getElementById('canvas').width; },  
 264150: () => { return screen.width; },  
 264175: () => { document.exitFullscreen(); },  
 264202: () => { if (document.fullscreenElement) return 1; },  
 264248: () => { return document.getElementById('canvas').width; },  
 264300: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264368: () => { document.exitFullscreen(); },  
 264395: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264453: () => { return screen.width; },  
 264478: () => { return screen.height; },  
 264504: () => { return window.screenX; },  
 264531: () => { return window.screenY; },  
 264558: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264611: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264682: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264739: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264995: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265066: () => { if (document.fullscreenElement) return 1; },  
 265112: () => { return window.innerWidth; },  
 265138: () => { return window.innerHeight; },  
 265165: () => { if (document.pointerLockElement) return 1; }
};
