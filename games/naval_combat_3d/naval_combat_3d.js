...
var ASM_CONSTS = {
  266052: () => { if (document.fullscreenElement) return 1; },  
 266098: () => { return document.getElementById('canvas').width; },  
 266150: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266218: () => { document.exitFullscreen(); },  
 266245: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 266318: () => { if (document.fullscreenElement) return 1; },  
 266364: () => { return document.getElementById('canvas').width; },  
 266416: () => { return screen.width; },  
 266441: () => { document.exitFullscreen(); },  
 266468: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 266601: () => { return window.innerWidth; },  
 266627: () => { return window.innerHeight; },  
 266654: () => { if (document.fullscreenElement) return 1; },  
 266700: () => { return document.getElementById('canvas').width; },  
 266752: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266820: () => { if (document.fullscreenElement) return 1; },  
 266866: () => { return document.getElementById('canvas').width; },  
 266918: () => { return screen.width; },  
 266943: () => { return window.innerWidth; },  
 266969: () => { return window.innerHeight; },  
 266996: () => { if (document.fullscreenElement) return 1; },  
 267042: () => { return document.getElementById('canvas').width; },  
 267094: () => { return screen.width; },  
 267119: () => { document.exitFullscreen(); },  
 267146: () => { if (document.fullscreenElement) return 1; },  
 267192: () => { return document.getElementById('canvas').width; },  
 267244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267312: () => { document.exitFullscreen(); },  
 267339: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 267397: () => { return screen.width; },  
 267422: () => { return screen.height; },  
 267448: () => { return window.screenX; },  
 267475: () => { return window.screenY; },  
 267502: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 267555: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267626: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267683: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267939: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268010: () => { if (document.fullscreenElement) return 1; },  
 268056: () => { return window.innerWidth; },  
 268082: () => { return window.innerHeight; },  
 268109: () => { if (document.pointerLockElement) return 1; }
};
