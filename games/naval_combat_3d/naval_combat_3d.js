...
var ASM_CONSTS = {
  265844: () => { if (document.fullscreenElement) return 1; },  
 265890: () => { return document.getElementById('canvas').width; },  
 265942: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266010: () => { document.exitFullscreen(); },  
 266037: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 266110: () => { if (document.fullscreenElement) return 1; },  
 266156: () => { return document.getElementById('canvas').width; },  
 266208: () => { return screen.width; },  
 266233: () => { document.exitFullscreen(); },  
 266260: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 266393: () => { return window.innerWidth; },  
 266419: () => { return window.innerHeight; },  
 266446: () => { if (document.fullscreenElement) return 1; },  
 266492: () => { return document.getElementById('canvas').width; },  
 266544: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266612: () => { if (document.fullscreenElement) return 1; },  
 266658: () => { return document.getElementById('canvas').width; },  
 266710: () => { return screen.width; },  
 266735: () => { return window.innerWidth; },  
 266761: () => { return window.innerHeight; },  
 266788: () => { if (document.fullscreenElement) return 1; },  
 266834: () => { return document.getElementById('canvas').width; },  
 266886: () => { return screen.width; },  
 266911: () => { document.exitFullscreen(); },  
 266938: () => { if (document.fullscreenElement) return 1; },  
 266984: () => { return document.getElementById('canvas').width; },  
 267036: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267104: () => { document.exitFullscreen(); },  
 267131: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 267189: () => { return screen.width; },  
 267214: () => { return screen.height; },  
 267240: () => { return window.screenX; },  
 267267: () => { return window.screenY; },  
 267294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 267347: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267418: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267475: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267731: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 267802: () => { if (document.fullscreenElement) return 1; },  
 267848: () => { return window.innerWidth; },  
 267874: () => { return window.innerHeight; },  
 267901: () => { if (document.pointerLockElement) return 1; }
};
