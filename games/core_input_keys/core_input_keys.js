...
var ASM_CONSTS = {
  260356: () => { if (document.fullscreenElement) return 1; },  
 260402: () => { return document.getElementById('canvas').width; },  
 260454: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260522: () => { document.exitFullscreen(); },  
 260549: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260622: () => { if (document.fullscreenElement) return 1; },  
 260668: () => { return document.getElementById('canvas').width; },  
 260720: () => { return screen.width; },  
 260745: () => { document.exitFullscreen(); },  
 260772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260905: () => { return window.innerWidth; },  
 260931: () => { return window.innerHeight; },  
 260958: () => { if (document.fullscreenElement) return 1; },  
 261004: () => { return document.getElementById('canvas').width; },  
 261056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261124: () => { if (document.fullscreenElement) return 1; },  
 261170: () => { return document.getElementById('canvas').width; },  
 261222: () => { return screen.width; },  
 261247: () => { return window.innerWidth; },  
 261273: () => { return window.innerHeight; },  
 261300: () => { if (document.fullscreenElement) return 1; },  
 261346: () => { return document.getElementById('canvas').width; },  
 261398: () => { return screen.width; },  
 261423: () => { document.exitFullscreen(); },  
 ...
 261616: () => { document.exitFullscreen(); },  
 261643: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261701: () => { return screen.width; },  
 261726: () => { return screen.height; },  
 261752: () => { return window.screenX; },  
 261779: () => { return window.screenY; },  
 261806: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261859: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 261930: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 261987: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262243: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262314: () => { if (document.fullscreenElement) return 1; },  
 262360: () => { return window.innerWidth; },  
 262386: () => { return window.innerHeight; },  
 262413: () => { if (document.pointerLockElement) return 1; }
};
