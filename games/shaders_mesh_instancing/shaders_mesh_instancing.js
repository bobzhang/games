...
var ASM_CONSTS = {
  256468: () => { if (document.fullscreenElement) return 1; },  
 256514: () => { return document.getElementById('canvas').width; },  
 256566: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256634: () => { document.exitFullscreen(); },  
 256661: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 256734: () => { if (document.fullscreenElement) return 1; },  
 256780: () => { return document.getElementById('canvas').width; },  
 256832: () => { return screen.width; },  
 256857: () => { document.exitFullscreen(); },  
 256884: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 257017: () => { return window.innerWidth; },  
 257043: () => { return window.innerHeight; },  
 257070: () => { if (document.fullscreenElement) return 1; },  
 257116: () => { return document.getElementById('canvas').width; },  
 257168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257236: () => { if (document.fullscreenElement) return 1; },  
 257282: () => { return document.getElementById('canvas').width; },  
 257334: () => { return screen.width; },  
 257359: () => { return window.innerWidth; },  
 257385: () => { return window.innerHeight; },  
 257412: () => { if (document.fullscreenElement) return 1; },  
 257458: () => { return document.getElementById('canvas').width; },  
 257510: () => { return screen.width; },  
 257535: () => { document.exitFullscreen(); },  
 257562: () => { if (document.fullscreenElement) return 1; },  
 257608: () => { return document.getElementById('canvas').width; },  
 257660: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257728: () => { document.exitFullscreen(); },  
 257755: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 257813: () => { return screen.width; },  
 257838: () => { return screen.height; },  
 257864: () => { return window.screenX; },  
 257891: () => { return window.screenY; },  
 257918: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 257971: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 258042: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 258099: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 258355: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 258426: () => { if (document.fullscreenElement) return 1; },  
 258472: () => { return window.innerWidth; },  
 258498: () => { return window.innerHeight; },  
 258525: () => { if (document.pointerLockElement) return 1; }
};
