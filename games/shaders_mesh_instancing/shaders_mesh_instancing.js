...
var ASM_CONSTS = {
  256692: () => { if (document.fullscreenElement) return 1; },  
 256738: () => { return document.getElementById('canvas').width; },  
 256790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256858: () => { document.exitFullscreen(); },  
 256885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 256958: () => { if (document.fullscreenElement) return 1; },  
 257004: () => { return document.getElementById('canvas').width; },  
 257056: () => { return screen.width; },  
 257081: () => { document.exitFullscreen(); },  
 257108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 257241: () => { return window.innerWidth; },  
 257267: () => { return window.innerHeight; },  
 257294: () => { if (document.fullscreenElement) return 1; },  
 257340: () => { return document.getElementById('canvas').width; },  
 257392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257460: () => { if (document.fullscreenElement) return 1; },  
 257506: () => { return document.getElementById('canvas').width; },  
 257558: () => { return screen.width; },  
 257583: () => { return window.innerWidth; },  
 257609: () => { return window.innerHeight; },  
 257636: () => { if (document.fullscreenElement) return 1; },  
 257682: () => { return document.getElementById('canvas').width; },  
 257734: () => { return screen.width; },  
 257759: () => { document.exitFullscreen(); },  
 257786: () => { if (document.fullscreenElement) return 1; },  
 257832: () => { return document.getElementById('canvas').width; },  
 257884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257952: () => { document.exitFullscreen(); },  
 257979: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 258037: () => { return screen.width; },  
 258062: () => { return screen.height; },  
 258088: () => { return window.screenX; },  
 258115: () => { return window.screenY; },  
 258142: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 258195: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 258266: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 258323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 258579: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 258650: () => { if (document.fullscreenElement) return 1; },  
 258696: () => { return window.innerWidth; },  
 258722: () => { return window.innerHeight; },  
 258749: () => { if (document.pointerLockElement) return 1; }
};
