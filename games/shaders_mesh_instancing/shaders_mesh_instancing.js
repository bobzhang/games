...
var ASM_CONSTS = {
  256736: () => { if (document.fullscreenElement) return 1; },  
 256782: () => { return document.getElementById('canvas').width; },  
 256834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256902: () => { document.exitFullscreen(); },  
 256929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 257002: () => { if (document.fullscreenElement) return 1; },  
 257048: () => { return document.getElementById('canvas').width; },  
 257100: () => { return screen.width; },  
 257125: () => { document.exitFullscreen(); },  
 257152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 257285: () => { return window.innerWidth; },  
 257311: () => { return window.innerHeight; },  
 257338: () => { if (document.fullscreenElement) return 1; },  
 257384: () => { return document.getElementById('canvas').width; },  
 257436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257504: () => { if (document.fullscreenElement) return 1; },  
 257550: () => { return document.getElementById('canvas').width; },  
 257602: () => { return screen.width; },  
 257627: () => { return window.innerWidth; },  
 257653: () => { return window.innerHeight; },  
 257680: () => { if (document.fullscreenElement) return 1; },  
 257726: () => { return document.getElementById('canvas').width; },  
 257778: () => { return screen.width; },  
 257803: () => { document.exitFullscreen(); },  
 257830: () => { if (document.fullscreenElement) return 1; },  
 257876: () => { return document.getElementById('canvas').width; },  
 257928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257996: () => { document.exitFullscreen(); },  
 258023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 258081: () => { return screen.width; },  
 258106: () => { return screen.height; },  
 258132: () => { return window.screenX; },  
 258159: () => { return window.screenY; },  
 258186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 258239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 258310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 258367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 258623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 258694: () => { if (document.fullscreenElement) return 1; },  
 258740: () => { return window.innerWidth; },  
 258766: () => { return window.innerHeight; },  
 258793: () => { if (document.pointerLockElement) return 1; }
};
