...
var ASM_CONSTS = {
  261380: () => { if (document.fullscreenElement) return 1; },  
 261426: () => { return document.getElementById('canvas').width; },  
 261478: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261546: () => { document.exitFullscreen(); },  
 261573: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261646: () => { if (document.fullscreenElement) return 1; },  
 261692: () => { return document.getElementById('canvas').width; },  
 261744: () => { return screen.width; },  
 261769: () => { document.exitFullscreen(); },  
 261796: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261929: () => { return window.innerWidth; },  
 261955: () => { return window.innerHeight; },  
 261982: () => { if (document.fullscreenElement) return 1; },  
 262028: () => { return document.getElementById('canvas').width; },  
 262080: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262297: () => { return window.innerHeight; },  
 262324: () => { if (document.fullscreenElement) return 1; },  
 262370: () => { return document.getElementById('canvas').width; },  
 262422: () => { return screen.width; },  
 262447: () => { document.exitFullscreen(); },  
 262474: () => { if (document.fullscreenElement) return 1; },  
 262520: () => { return document.getElementById('canvas').width; },  
 262572: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262640: () => { document.exitFullscreen(); },  
 262667: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262725: () => { return screen.width; },  
 262750: () => { return screen.height; },  
 262776: () => { return window.screenX; },  
 262803: () => { return window.screenY; },  
 262830: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262883: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262954: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263011: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263267: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263338: () => { if (document.fullscreenElement) return 1; },  
 263384: () => { return window.innerWidth; },  
 263410: () => { return window.innerHeight; },  
 263437: () => { if (document.pointerLockElement) return 1; }
};
