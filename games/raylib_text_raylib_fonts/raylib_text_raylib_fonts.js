...
function findWasmBinary() {
  return locateFile('raylib_text_raylib_fonts.wasm');
}
...
var ASM_CONSTS = {
  139760: () => { if (document.fullscreenElement) return 1; },  
 139806: () => { return document.getElementById('canvas').width; },  
 139858: () => { return parseInt(document.getElementById('canvas').style.width); },  
 139926: () => { document.exitFullscreen(); },  
 139953: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 140026: () => { if (document.fullscreenElement) return 1; },  
 140072: () => { return document.getElementById('canvas').width; },  
 140124: () => { return screen.width; },  
 140149: () => { document.exitFullscreen(); },  
 140176: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 140309: () => { return window.innerWidth; },  
 140335: () => { return window.innerHeight; },  
 140362: () => { if (document.fullscreenElement) return 1; },  
 140408: () => { return document.getElementById('canvas').width; },  
 140460: () => { return parseInt(document.getElementById('canvas').style.width); },  
 140528: () => { if (document.fullscreenElement) return 1; },  
 140574: () => { return document.getElementById('canvas').width; },  
 140626: () => { return screen.width; },  
 140651: () => { return window.innerWidth; },  
 140677: () => { return window.innerHeight; },  
 140704: () => { if (document.fullscreenElement) return 1; },  
 140750: () => { return document.getElementById('canvas').width; },  
 140802: () => { return screen.width; },  
 140827: () => { document.exitFullscreen(); },  
 140854: () => { if (document.fullscreenElement) return 1; },  
 140900: () => { return document.getElementById('canvas').width; },  
 140952: () => { return parseInt(document.getElementById('canvas').style.width); },  
 141020: () => { document.exitFullscreen(); },  
 141047: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 141105: () => { return screen.width; },  
 141130: () => { return screen.height; },  
 141156: () => { return window.screenX; },  
 141183: () => { return window.screenY; },  
 141210: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 141263: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 141334: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 141391: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 141647: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 141718: () => { if (document.fullscreenElement) return 1; },  
 141764: () => { return window.innerWidth; },  
 141790: () => { return window.innerHeight; },  
 141817: () => { if (document.pointerLockElement) return 1; }
};
