...
function findWasmBinary() {
  return locateFile('raylib_audio_sound_multi.wasm');
}
...
var ASM_CONSTS = {
 ...
 234852: ($0) => { miniaudio.untrack_device_by_index($0); },  
 234895: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 235020: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
