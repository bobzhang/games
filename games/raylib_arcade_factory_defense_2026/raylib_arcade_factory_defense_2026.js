...
var ASM_CONSTS = {
 ...
 99234: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99302: () => { document.exitFullscreen(); },  
 99329: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99402: () => { if (document.fullscreenElement) return 1; },  
 99448: () => { return document.getElementById('canvas').width; },  
 99500: () => { return screen.width; },  
 99525: () => { document.exitFullscreen(); },  
 99552: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99685: () => { return window.innerWidth; },  
 99711: () => { return window.innerHeight; },  
 99738: () => { if (document.fullscreenElement) return 1; },  
 99784: () => { return document.getElementById('canvas').width; },  
 99836: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99904: () => { if (document.fullscreenElement) return 1; },  
 99950: () => { return document.getElementById('canvas').width; },  
 100002: () => { return screen.width; },  
 100027: () => { return window.innerWidth; },  
 100053: () => { return window.innerHeight; },  
 100080: () => { if (document.fullscreenElement) return 1; },  
 100126: () => { return document.getElementById('canvas').width; },  
 100178: () => { return screen.width; },  
 100203: () => { document.exitFullscreen(); },  
 100230: () => { if (document.fullscreenElement) return 1; },  
 100276: () => { return document.getElementById('canvas').width; },  
 100328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100396: () => { document.exitFullscreen(); },  
 100423: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100481: () => { return screen.width; },  
 100506: () => { return screen.height; },  
 100532: () => { return window.screenX; },  
 100559: () => { return window.screenY; },  
 100586: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100639: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100710: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100767: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101023: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101094: () => { if (document.fullscreenElement) return 1; },  
 101140: () => { return window.innerWidth; },  
 101166: () => { return window.innerHeight; },  
 101193: () => { if (document.pointerLockElement) return 1; }
};
