...
var ASM_CONSTS = {
  251904: () => { if (document.fullscreenElement) return 1; },  
 251950: () => { return document.getElementById('canvas').width; },  
 252002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252070: () => { document.exitFullscreen(); },  
 252097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252170: () => { if (document.fullscreenElement) return 1; },  
 252216: () => { return document.getElementById('canvas').width; },  
 252268: () => { return screen.width; },  
 252293: () => { document.exitFullscreen(); },  
 252320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252453: () => { return window.innerWidth; },  
 252479: () => { return window.innerHeight; },  
 252506: () => { if (document.fullscreenElement) return 1; },  
 252552: () => { return document.getElementById('canvas').width; },  
 252604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252672: () => { if (document.fullscreenElement) return 1; },  
 252718: () => { return document.getElementById('canvas').width; },  
 252770: () => { return screen.width; },  
 252795: () => { return window.innerWidth; },  
 252821: () => { return window.innerHeight; },  
 252848: () => { if (document.fullscreenElement) return 1; },  
 252894: () => { return document.getElementById('canvas').width; },  
 252946: () => { return screen.width; },  
 252971: () => { document.exitFullscreen(); },  
 252998: () => { if (document.fullscreenElement) return 1; },  
 253044: () => { return document.getElementById('canvas').width; },  
 253096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253164: () => { document.exitFullscreen(); },  
 253191: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253249: () => { return screen.width; },  
 253274: () => { return screen.height; },  
 253300: () => { return window.screenX; },  
 253327: () => { return window.screenY; },  
 253354: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253478: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253535: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253791: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253862: () => { if (document.fullscreenElement) return 1; },  
 253908: () => { return window.innerWidth; },  
 253934: () => { return window.innerHeight; },  
 253961: () => { if (document.pointerLockElement) return 1; }
};
