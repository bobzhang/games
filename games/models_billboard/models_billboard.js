...
var ASM_CONSTS = {
  251908: () => { if (document.fullscreenElement) return 1; },  
 251954: () => { return document.getElementById('canvas').width; },  
 252006: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252074: () => { document.exitFullscreen(); },  
 252101: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252174: () => { if (document.fullscreenElement) return 1; },  
 252220: () => { return document.getElementById('canvas').width; },  
 252272: () => { return screen.width; },  
 252297: () => { document.exitFullscreen(); },  
 252324: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252457: () => { return window.innerWidth; },  
 252483: () => { return window.innerHeight; },  
 252510: () => { if (document.fullscreenElement) return 1; },  
 252556: () => { return document.getElementById('canvas').width; },  
 252608: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 252799: () => { return window.innerWidth; },  
 252825: () => { return window.innerHeight; },  
 252852: () => { if (document.fullscreenElement) return 1; },  
 252898: () => { return document.getElementById('canvas').width; },  
 252950: () => { return screen.width; },  
 252975: () => { document.exitFullscreen(); },  
 253002: () => { if (document.fullscreenElement) return 1; },  
 253048: () => { return document.getElementById('canvas').width; },  
 253100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253168: () => { document.exitFullscreen(); },  
 253195: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253253: () => { return screen.width; },  
 253278: () => { return screen.height; },  
 253304: () => { return window.screenX; },  
 253331: () => { return window.screenY; },  
 253358: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253411: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253482: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253539: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253795: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253866: () => { if (document.fullscreenElement) return 1; },  
 253912: () => { return window.innerWidth; },  
 253938: () => { return window.innerHeight; },  
 253965: () => { if (document.pointerLockElement) return 1; }
};
