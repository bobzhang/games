...
var ASM_CONSTS = {
  251684: () => { if (document.fullscreenElement) return 1; },  
 251730: () => { return document.getElementById('canvas').width; },  
 251782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 251850: () => { document.exitFullscreen(); },  
 251877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 251950: () => { if (document.fullscreenElement) return 1; },  
 251996: () => { return document.getElementById('canvas').width; },  
 252048: () => { return screen.width; },  
 252073: () => { document.exitFullscreen(); },  
 252100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252233: () => { return window.innerWidth; },  
 252259: () => { return window.innerHeight; },  
 252286: () => { if (document.fullscreenElement) return 1; },  
 252332: () => { return document.getElementById('canvas').width; },  
 252384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252452: () => { if (document.fullscreenElement) return 1; },  
 252498: () => { return document.getElementById('canvas').width; },  
 252550: () => { return screen.width; },  
 252575: () => { return window.innerWidth; },  
 252601: () => { return window.innerHeight; },  
 252628: () => { if (document.fullscreenElement) return 1; },  
 252674: () => { return document.getElementById('canvas').width; },  
 252726: () => { return screen.width; },  
 252751: () => { document.exitFullscreen(); },  
 ...
 252944: () => { document.exitFullscreen(); },  
 252971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253029: () => { return screen.width; },  
 253054: () => { return screen.height; },  
 253080: () => { return window.screenX; },  
 253107: () => { return window.screenY; },  
 253134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253642: () => { if (document.fullscreenElement) return 1; },  
 253688: () => { return window.innerWidth; },  
 253714: () => { return window.innerHeight; },  
 253741: () => { if (document.pointerLockElement) return 1; }
};
