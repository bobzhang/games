...
var ASM_CONSTS = {
  262548: () => { if (document.fullscreenElement) return 1; },  
 262594: () => { return document.getElementById('canvas').width; },  
 262646: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262714: () => { document.exitFullscreen(); },  
 262741: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262814: () => { if (document.fullscreenElement) return 1; },  
 262860: () => { return document.getElementById('canvas').width; },  
 262912: () => { return screen.width; },  
 262937: () => { document.exitFullscreen(); },  
 262964: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263097: () => { return window.innerWidth; },  
 263123: () => { return window.innerHeight; },  
 263150: () => { if (document.fullscreenElement) return 1; },  
 263196: () => { return document.getElementById('canvas').width; },  
 263248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263316: () => { if (document.fullscreenElement) return 1; },  
 263362: () => { return document.getElementById('canvas').width; },  
 263414: () => { return screen.width; },  
 263439: () => { return window.innerWidth; },  
 263465: () => { return window.innerHeight; },  
 263492: () => { if (document.fullscreenElement) return 1; },  
 263538: () => { return document.getElementById('canvas').width; },  
 263590: () => { return screen.width; },  
 263615: () => { document.exitFullscreen(); },  
 ...
 263808: () => { document.exitFullscreen(); },  
 263835: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263893: () => { return screen.width; },  
 263918: () => { return screen.height; },  
 263944: () => { return window.screenX; },  
 263971: () => { return window.screenY; },  
 263998: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264051: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264122: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264179: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264435: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264506: () => { if (document.fullscreenElement) return 1; },  
 264552: () => { return window.innerWidth; },  
 264578: () => { return window.innerHeight; },  
 264605: () => { if (document.pointerLockElement) return 1; }
};
