...
var ASM_CONSTS = {
 ...
 262662: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262730: () => { document.exitFullscreen(); },  
 262757: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262830: () => { if (document.fullscreenElement) return 1; },  
 262876: () => { return document.getElementById('canvas').width; },  
 262928: () => { return screen.width; },  
 262953: () => { document.exitFullscreen(); },  
 262980: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263113: () => { return window.innerWidth; },  
 263139: () => { return window.innerHeight; },  
 263166: () => { if (document.fullscreenElement) return 1; },  
 263212: () => { return document.getElementById('canvas').width; },  
 263264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263332: () => { if (document.fullscreenElement) return 1; },  
 263378: () => { return document.getElementById('canvas').width; },  
 263430: () => { return screen.width; },  
 263455: () => { return window.innerWidth; },  
 263481: () => { return window.innerHeight; },  
 263508: () => { if (document.fullscreenElement) return 1; },  
 263554: () => { return document.getElementById('canvas').width; },  
 263606: () => { return screen.width; },  
 263631: () => { document.exitFullscreen(); },  
 263658: () => { if (document.fullscreenElement) return 1; },  
 263704: () => { return document.getElementById('canvas').width; },  
 263756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263824: () => { document.exitFullscreen(); },  
 263851: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263909: () => { return screen.width; },  
 263934: () => { return screen.height; },  
 263960: () => { return window.screenX; },  
 263987: () => { return window.screenY; },  
 264014: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264067: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264138: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264195: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264451: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264522: () => { if (document.fullscreenElement) return 1; },  
 264568: () => { return window.innerWidth; },  
 264594: () => { return window.innerHeight; },  
 264621: () => { if (document.pointerLockElement) return 1; }
};
