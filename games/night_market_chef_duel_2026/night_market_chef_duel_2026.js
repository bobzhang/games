...
var ASM_CONSTS = {
 ...
 262438: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262506: () => { document.exitFullscreen(); },  
 262533: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262606: () => { if (document.fullscreenElement) return 1; },  
 262652: () => { return document.getElementById('canvas').width; },  
 262704: () => { return screen.width; },  
 262729: () => { document.exitFullscreen(); },  
 262756: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262889: () => { return window.innerWidth; },  
 262915: () => { return window.innerHeight; },  
 262942: () => { if (document.fullscreenElement) return 1; },  
 262988: () => { return document.getElementById('canvas').width; },  
 263040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263108: () => { if (document.fullscreenElement) return 1; },  
 263154: () => { return document.getElementById('canvas').width; },  
 263206: () => { return screen.width; },  
 263231: () => { return window.innerWidth; },  
 263257: () => { return window.innerHeight; },  
 263284: () => { if (document.fullscreenElement) return 1; },  
 263330: () => { return document.getElementById('canvas').width; },  
 263382: () => { return screen.width; },  
 263407: () => { document.exitFullscreen(); },  
 ...
 263600: () => { document.exitFullscreen(); },  
 263627: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263685: () => { return screen.width; },  
 263710: () => { return screen.height; },  
 263736: () => { return window.screenX; },  
 263763: () => { return window.screenY; },  
 263790: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263843: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263914: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263971: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264227: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264298: () => { if (document.fullscreenElement) return 1; },  
 264344: () => { return window.innerWidth; },  
 264370: () => { return window.innerHeight; },  
 264397: () => { if (document.pointerLockElement) return 1; }
};
