...
var ASM_CONSTS = {
  267476: () => { if (document.fullscreenElement) return 1; },  
 267522: () => { return document.getElementById('canvas').width; },  
 267574: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267642: () => { document.exitFullscreen(); },  
 267669: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267742: () => { if (document.fullscreenElement) return 1; },  
 267788: () => { return document.getElementById('canvas').width; },  
 267840: () => { return screen.width; },  
 267865: () => { document.exitFullscreen(); },  
 267892: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268025: () => { return window.innerWidth; },  
 268051: () => { return window.innerHeight; },  
 268078: () => { if (document.fullscreenElement) return 1; },  
 268124: () => { return document.getElementById('canvas').width; },  
 268176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268244: () => { if (document.fullscreenElement) return 1; },  
 268290: () => { return document.getElementById('canvas').width; },  
 268342: () => { return screen.width; },  
 268367: () => { return window.innerWidth; },  
 268393: () => { return window.innerHeight; },  
 268420: () => { if (document.fullscreenElement) return 1; },  
 268466: () => { return document.getElementById('canvas').width; },  
 268518: () => { return screen.width; },  
 268543: () => { document.exitFullscreen(); },  
 268570: () => { if (document.fullscreenElement) return 1; },  
 268616: () => { return document.getElementById('canvas').width; },  
 268668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268736: () => { document.exitFullscreen(); },  
 268763: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268821: () => { return screen.width; },  
 268846: () => { return screen.height; },  
 268872: () => { return window.screenX; },  
 268899: () => { return window.screenY; },  
 268926: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268979: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269050: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269107: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269363: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269434: () => { if (document.fullscreenElement) return 1; },  
 269480: () => { return window.innerWidth; },  
 269506: () => { return window.innerHeight; },  
 269533: () => { if (document.pointerLockElement) return 1; }
};
