...
var ASM_CONSTS = {
  267444: () => { if (document.fullscreenElement) return 1; },  
 267490: () => { return document.getElementById('canvas').width; },  
 267542: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267610: () => { document.exitFullscreen(); },  
 267637: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267710: () => { if (document.fullscreenElement) return 1; },  
 267756: () => { return document.getElementById('canvas').width; },  
 267808: () => { return screen.width; },  
 267833: () => { document.exitFullscreen(); },  
 267860: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267993: () => { return window.innerWidth; },  
 268019: () => { return window.innerHeight; },  
 268046: () => { if (document.fullscreenElement) return 1; },  
 268092: () => { return document.getElementById('canvas').width; },  
 268144: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268212: () => { if (document.fullscreenElement) return 1; },  
 268258: () => { return document.getElementById('canvas').width; },  
 268310: () => { return screen.width; },  
 268335: () => { return window.innerWidth; },  
 268361: () => { return window.innerHeight; },  
 268388: () => { if (document.fullscreenElement) return 1; },  
 268434: () => { return document.getElementById('canvas').width; },  
 268486: () => { return screen.width; },  
 268511: () => { document.exitFullscreen(); },  
 268538: () => { if (document.fullscreenElement) return 1; },  
 268584: () => { return document.getElementById('canvas').width; },  
 268636: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268704: () => { document.exitFullscreen(); },  
 268731: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268789: () => { return screen.width; },  
 268814: () => { return screen.height; },  
 268840: () => { return window.screenX; },  
 268867: () => { return window.screenY; },  
 268894: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268947: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269018: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269075: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269331: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269402: () => { if (document.fullscreenElement) return 1; },  
 269448: () => { return window.innerWidth; },  
 269474: () => { return window.innerHeight; },  
 269501: () => { if (document.pointerLockElement) return 1; }
};
