...
var ASM_CONSTS = {
  267508: () => { if (document.fullscreenElement) return 1; },  
 267554: () => { return document.getElementById('canvas').width; },  
 267606: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267674: () => { document.exitFullscreen(); },  
 267701: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267774: () => { if (document.fullscreenElement) return 1; },  
 267820: () => { return document.getElementById('canvas').width; },  
 267872: () => { return screen.width; },  
 267897: () => { document.exitFullscreen(); },  
 267924: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268057: () => { return window.innerWidth; },  
 268083: () => { return window.innerHeight; },  
 268110: () => { if (document.fullscreenElement) return 1; },  
 268156: () => { return document.getElementById('canvas').width; },  
 268208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268276: () => { if (document.fullscreenElement) return 1; },  
 268322: () => { return document.getElementById('canvas').width; },  
 268374: () => { return screen.width; },  
 268399: () => { return window.innerWidth; },  
 268425: () => { return window.innerHeight; },  
 ...
 268575: () => { document.exitFullscreen(); },  
 268602: () => { if (document.fullscreenElement) return 1; },  
 268648: () => { return document.getElementById('canvas').width; },  
 268700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268768: () => { document.exitFullscreen(); },  
 268795: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268853: () => { return screen.width; },  
 268878: () => { return screen.height; },  
 268904: () => { return window.screenX; },  
 268931: () => { return window.screenY; },  
 268958: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269011: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269082: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269139: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269395: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269466: () => { if (document.fullscreenElement) return 1; },  
 269512: () => { return window.innerWidth; },  
 269538: () => { return window.innerHeight; },  
 269565: () => { if (document.pointerLockElement) return 1; }
};
