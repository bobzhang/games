...
var ASM_CONSTS = {
  267284: () => { if (document.fullscreenElement) return 1; },  
 267330: () => { return document.getElementById('canvas').width; },  
 267382: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267450: () => { document.exitFullscreen(); },  
 267477: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267550: () => { if (document.fullscreenElement) return 1; },  
 267596: () => { return document.getElementById('canvas').width; },  
 267648: () => { return screen.width; },  
 267673: () => { document.exitFullscreen(); },  
 267700: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267833: () => { return window.innerWidth; },  
 267859: () => { return window.innerHeight; },  
 267886: () => { if (document.fullscreenElement) return 1; },  
 267932: () => { return document.getElementById('canvas').width; },  
 267984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268052: () => { if (document.fullscreenElement) return 1; },  
 268098: () => { return document.getElementById('canvas').width; },  
 268150: () => { return screen.width; },  
 268175: () => { return window.innerWidth; },  
 268201: () => { return window.innerHeight; },  
 268228: () => { if (document.fullscreenElement) return 1; },  
 268274: () => { return document.getElementById('canvas').width; },  
 268326: () => { return screen.width; },  
 268351: () => { document.exitFullscreen(); },  
 268378: () => { if (document.fullscreenElement) return 1; },  
 268424: () => { return document.getElementById('canvas').width; },  
 268476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268544: () => { document.exitFullscreen(); },  
 268571: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268629: () => { return screen.width; },  
 268654: () => { return screen.height; },  
 268680: () => { return window.screenX; },  
 268707: () => { return window.screenY; },  
 268734: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268787: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268858: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269171: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269242: () => { if (document.fullscreenElement) return 1; },  
 269288: () => { return window.innerWidth; },  
 269314: () => { return window.innerHeight; },  
 269341: () => { if (document.pointerLockElement) return 1; }
};
