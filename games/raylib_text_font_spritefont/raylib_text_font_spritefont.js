...
function findWasmBinary() {
  return locateFile('raylib_text_font_spritefont.wasm');
}
...
var ASM_CONSTS = {
  223376: () => { if (document.fullscreenElement) return 1; },  
 223422: () => { return document.getElementById('canvas').width; },  
 223474: () => { return parseInt(document.getElementById('canvas').style.width); },  
 223542: () => { document.exitFullscreen(); },  
 223569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 223642: () => { if (document.fullscreenElement) return 1; },  
 223688: () => { return document.getElementById('canvas').width; },  
 223740: () => { return screen.width; },  
 223765: () => { document.exitFullscreen(); },  
 223792: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 223925: () => { return window.innerWidth; },  
 223951: () => { return window.innerHeight; },  
 223978: () => { if (document.fullscreenElement) return 1; },  
 224024: () => { return document.getElementById('canvas').width; },  
 224076: () => { return parseInt(document.getElementById('canvas').style.width); },  
 224144: () => { if (document.fullscreenElement) return 1; },  
 224190: () => { return document.getElementById('canvas').width; },  
 224242: () => { return screen.width; },  
 224267: () => { return window.innerWidth; },  
 224293: () => { return window.innerHeight; },  
 224320: () => { if (document.fullscreenElement) return 1; },  
 224366: () => { return document.getElementById('canvas').width; },  
 224418: () => { return screen.width; },  
 224443: () => { document.exitFullscreen(); },  
 224470: () => { if (document.fullscreenElement) return 1; },  
 224516: () => { return document.getElementById('canvas').width; },  
 224568: () => { return parseInt(document.getElementById('canvas').style.width); },  
 224636: () => { document.exitFullscreen(); },  
 224663: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 224721: () => { return screen.width; },  
 224746: () => { return screen.height; },  
 224772: () => { return window.screenX; },  
 224799: () => { return window.screenY; },  
 224826: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 224879: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 224950: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 225007: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 225263: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 225334: () => { if (document.fullscreenElement) return 1; },  
 225380: () => { return window.innerWidth; },  
 225406: () => { return window.innerHeight; },  
 225433: () => { if (document.pointerLockElement) return 1; }
};
