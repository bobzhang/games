...
function findWasmBinary() {
  return locateFile('raylib_textures_srcrec_dstrec.wasm');
}
...
var ASM_CONSTS = {
  111392: () => { if (document.fullscreenElement) return 1; },  
 111438: () => { return document.getElementById('canvas').width; },  
 111490: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111558: () => { document.exitFullscreen(); },  
 111585: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 111658: () => { if (document.fullscreenElement) return 1; },  
 111704: () => { return document.getElementById('canvas').width; },  
 111756: () => { return screen.width; },  
 111781: () => { document.exitFullscreen(); },  
 111808: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 111941: () => { return window.innerWidth; },  
 111967: () => { return window.innerHeight; },  
 111994: () => { if (document.fullscreenElement) return 1; },  
 112040: () => { return document.getElementById('canvas').width; },  
 112092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112160: () => { if (document.fullscreenElement) return 1; },  
 112206: () => { return document.getElementById('canvas').width; },  
 112258: () => { return screen.width; },  
 112283: () => { return window.innerWidth; },  
 112309: () => { return window.innerHeight; },  
 112336: () => { if (document.fullscreenElement) return 1; },  
 112382: () => { return document.getElementById('canvas').width; },  
 112434: () => { return screen.width; },  
 112459: () => { document.exitFullscreen(); },  
 112486: () => { if (document.fullscreenElement) return 1; },  
 112532: () => { return document.getElementById('canvas').width; },  
 112584: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112652: () => { document.exitFullscreen(); },  
 112679: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 112737: () => { return screen.width; },  
 112762: () => { return screen.height; },  
 112788: () => { return window.screenX; },  
 112815: () => { return window.screenY; },  
 112842: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 112895: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 112966: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 113023: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 113279: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 113350: () => { if (document.fullscreenElement) return 1; },  
 113396: () => { return window.innerWidth; },  
 113422: () => { return window.innerHeight; },  
 113449: () => { if (document.pointerLockElement) return 1; }
};
