...
var ASM_CONSTS = {
 ...
 263014: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263082: () => { document.exitFullscreen(); },  
 263109: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263182: () => { if (document.fullscreenElement) return 1; },  
 263228: () => { return document.getElementById('canvas').width; },  
 263280: () => { return screen.width; },  
 263305: () => { document.exitFullscreen(); },  
 263332: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263465: () => { return window.innerWidth; },  
 263491: () => { return window.innerHeight; },  
 263518: () => { if (document.fullscreenElement) return 1; },  
 263564: () => { return document.getElementById('canvas').width; },  
 263616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263807: () => { return window.innerWidth; },  
 263833: () => { return window.innerHeight; },  
 ...
 263983: () => { document.exitFullscreen(); },  
 ...
 264176: () => { document.exitFullscreen(); },  
 264203: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264261: () => { return screen.width; },  
 264286: () => { return screen.height; },  
 264312: () => { return window.screenX; },  
 264339: () => { return window.screenY; },  
 264366: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264419: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264490: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264547: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264803: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264874: () => { if (document.fullscreenElement) return 1; },  
 264920: () => { return window.innerWidth; },  
 264946: () => { return window.innerHeight; },  
 264973: () => { if (document.pointerLockElement) return 1; }
};
