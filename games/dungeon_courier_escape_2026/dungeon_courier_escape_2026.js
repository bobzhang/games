...
var ASM_CONSTS = {
  263028: () => { if (document.fullscreenElement) return 1; },  
 263074: () => { return document.getElementById('canvas').width; },  
 263126: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263194: () => { document.exitFullscreen(); },  
 263221: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263294: () => { if (document.fullscreenElement) return 1; },  
 263340: () => { return document.getElementById('canvas').width; },  
 263392: () => { return screen.width; },  
 263417: () => { document.exitFullscreen(); },  
 263444: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263577: () => { return window.innerWidth; },  
 263603: () => { return window.innerHeight; },  
 263630: () => { if (document.fullscreenElement) return 1; },  
 263676: () => { return document.getElementById('canvas').width; },  
 263728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263919: () => { return window.innerWidth; },  
 263945: () => { return window.innerHeight; },  
 263972: () => { if (document.fullscreenElement) return 1; },  
 264018: () => { return document.getElementById('canvas').width; },  
 264070: () => { return screen.width; },  
 264095: () => { document.exitFullscreen(); },  
 ...
 264288: () => { document.exitFullscreen(); },  
 264315: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264373: () => { return screen.width; },  
 264398: () => { return screen.height; },  
 264424: () => { return window.screenX; },  
 264451: () => { return window.screenY; },  
 264478: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264531: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264602: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264659: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264915: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264986: () => { if (document.fullscreenElement) return 1; },  
 265032: () => { return window.innerWidth; },  
 265058: () => { return window.innerHeight; },  
 265085: () => { if (document.pointerLockElement) return 1; }
};
