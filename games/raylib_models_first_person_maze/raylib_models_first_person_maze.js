...
function findWasmBinary() {
  return locateFile('raylib_models_first_person_maze.wasm');
}
...
var ASM_CONSTS = {
  101712: () => { if (document.fullscreenElement) return 1; },  
 101758: () => { return document.getElementById('canvas').width; },  
 101810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 102024: () => { return document.getElementById('canvas').width; },  
 102076: () => { return screen.width; },  
 102101: () => { document.exitFullscreen(); },  
 102128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102261: () => { return window.innerWidth; },  
 102287: () => { return window.innerHeight; },  
 102314: () => { if (document.fullscreenElement) return 1; },  
 102360: () => { return document.getElementById('canvas').width; },  
 102412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102480: () => { if (document.fullscreenElement) return 1; },  
 102526: () => { return document.getElementById('canvas').width; },  
 102578: () => { return screen.width; },  
 102603: () => { return window.innerWidth; },  
 102629: () => { return window.innerHeight; },  
 102656: () => { if (document.fullscreenElement) return 1; },  
 102702: () => { return document.getElementById('canvas').width; },  
 102754: () => { return screen.width; },  
 102779: () => { document.exitFullscreen(); },  
 102806: () => { if (document.fullscreenElement) return 1; },  
 102852: () => { return document.getElementById('canvas').width; },  
 102904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102972: () => { document.exitFullscreen(); },  
 102999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103057: () => { return screen.width; },  
 103082: () => { return screen.height; },  
 103108: () => { return window.screenX; },  
 103135: () => { return window.screenY; },  
 103162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103670: () => { if (document.fullscreenElement) return 1; },  
 103716: () => { return window.innerWidth; },  
 103742: () => { return window.innerHeight; },  
 103769: () => { if (document.pointerLockElement) return 1; }
};
