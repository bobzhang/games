...
var ASM_CONSTS = {
  262644: () => { if (document.fullscreenElement) return 1; },  
 262690: () => { return document.getElementById('canvas').width; },  
 262742: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262810: () => { document.exitFullscreen(); },  
 262837: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262910: () => { if (document.fullscreenElement) return 1; },  
 262956: () => { return document.getElementById('canvas').width; },  
 263008: () => { return screen.width; },  
 263033: () => { document.exitFullscreen(); },  
 263060: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263193: () => { return window.innerWidth; },  
 263219: () => { return window.innerHeight; },  
 263246: () => { if (document.fullscreenElement) return 1; },  
 263292: () => { return document.getElementById('canvas').width; },  
 263344: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263412: () => { if (document.fullscreenElement) return 1; },  
 263458: () => { return document.getElementById('canvas').width; },  
 263510: () => { return screen.width; },  
 263535: () => { return window.innerWidth; },  
 263561: () => { return window.innerHeight; },  
 ...
 263711: () => { document.exitFullscreen(); },  
 263738: () => { if (document.fullscreenElement) return 1; },  
 263784: () => { return document.getElementById('canvas').width; },  
 263836: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263904: () => { document.exitFullscreen(); },  
 263931: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263989: () => { return screen.width; },  
 264014: () => { return screen.height; },  
 264040: () => { return window.screenX; },  
 264067: () => { return window.screenY; },  
 264094: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264147: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264218: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264275: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264531: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264602: () => { if (document.fullscreenElement) return 1; },  
 264648: () => { return window.innerWidth; },  
 264674: () => { return window.innerHeight; },  
 264701: () => { if (document.pointerLockElement) return 1; }
};
