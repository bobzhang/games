...
function findWasmBinary() {
  return locateFile('raylib_core_3d_camera_mode.wasm');
}
...
var ASM_CONSTS = {
  96960: () => { if (document.fullscreenElement) return 1; },  
 97006: () => { return document.getElementById('canvas').width; },  
 97058: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97126: () => { document.exitFullscreen(); },  
 97153: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97226: () => { if (document.fullscreenElement) return 1; },  
 97272: () => { return document.getElementById('canvas').width; },  
 97324: () => { return screen.width; },  
 97349: () => { document.exitFullscreen(); },  
 97376: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97509: () => { return window.innerWidth; },  
 97535: () => { return window.innerHeight; },  
 97562: () => { if (document.fullscreenElement) return 1; },  
 97608: () => { return document.getElementById('canvas').width; },  
 97660: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97728: () => { if (document.fullscreenElement) return 1; },  
 97774: () => { return document.getElementById('canvas').width; },  
 97826: () => { return screen.width; },  
 97851: () => { return window.innerWidth; },  
 97877: () => { return window.innerHeight; },  
 97904: () => { if (document.fullscreenElement) return 1; },  
 97950: () => { return document.getElementById('canvas').width; },  
 98002: () => { return screen.width; },  
 98027: () => { document.exitFullscreen(); },  
 98054: () => { if (document.fullscreenElement) return 1; },  
 98100: () => { return document.getElementById('canvas').width; },  
 98152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98220: () => { document.exitFullscreen(); },  
 98247: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98305: () => { return screen.width; },  
 98330: () => { return screen.height; },  
 98356: () => { return window.screenX; },  
 98383: () => { return window.screenY; },  
 98410: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98463: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98534: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98591: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98847: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98918: () => { if (document.fullscreenElement) return 1; },  
 98964: () => { return window.innerWidth; },  
 98990: () => { return window.innerHeight; },  
 99017: () => { if (document.pointerLockElement) return 1; }
};
