...
function findWasmBinary() {
  return locateFile('raylib_textures_image_generation.wasm');
}
...
var ASM_CONSTS = {
 ...
 98674: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98742: () => { document.exitFullscreen(); },  
 98769: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98842: () => { if (document.fullscreenElement) return 1; },  
 98888: () => { return document.getElementById('canvas').width; },  
 98940: () => { return screen.width; },  
 98965: () => { document.exitFullscreen(); },  
 98992: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99125: () => { return window.innerWidth; },  
 99151: () => { return window.innerHeight; },  
 99178: () => { if (document.fullscreenElement) return 1; },  
 99224: () => { return document.getElementById('canvas').width; },  
 99276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99344: () => { if (document.fullscreenElement) return 1; },  
 99390: () => { return document.getElementById('canvas').width; },  
 99442: () => { return screen.width; },  
 99467: () => { return window.innerWidth; },  
 99493: () => { return window.innerHeight; },  
 99520: () => { if (document.fullscreenElement) return 1; },  
 99566: () => { return document.getElementById('canvas').width; },  
 99618: () => { return screen.width; },  
 99643: () => { document.exitFullscreen(); },  
 99670: () => { if (document.fullscreenElement) return 1; },  
 99716: () => { return document.getElementById('canvas').width; },  
 99768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99836: () => { document.exitFullscreen(); },  
 99863: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99921: () => { return screen.width; },  
 99946: () => { return screen.height; },  
 99972: () => { return window.screenX; },  
 99999: () => { return window.screenY; },  
 100026: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100079: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100150: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100207: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100463: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100534: () => { if (document.fullscreenElement) return 1; },  
 100580: () => { return window.innerWidth; },  
 100606: () => { return window.innerHeight; },  
 100633: () => { if (document.pointerLockElement) return 1; }
};
