...
var ASM_CONSTS = {
  274852: () => { if (document.fullscreenElement) return 1; },  
 274898: () => { return document.getElementById('canvas').width; },  
 274950: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275018: () => { document.exitFullscreen(); },  
 275045: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 275118: () => { if (document.fullscreenElement) return 1; },  
 275164: () => { return document.getElementById('canvas').width; },  
 275216: () => { return screen.width; },  
 275241: () => { document.exitFullscreen(); },  
 275268: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 275401: () => { return window.innerWidth; },  
 275427: () => { return window.innerHeight; },  
 275454: () => { if (document.fullscreenElement) return 1; },  
 275500: () => { return document.getElementById('canvas').width; },  
 275552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275620: () => { if (document.fullscreenElement) return 1; },  
 275666: () => { return document.getElementById('canvas').width; },  
 275718: () => { return screen.width; },  
 275743: () => { return window.innerWidth; },  
 275769: () => { return window.innerHeight; },  
 275796: () => { if (document.fullscreenElement) return 1; },  
 275842: () => { return document.getElementById('canvas').width; },  
 275894: () => { return screen.width; },  
 275919: () => { document.exitFullscreen(); },  
 275946: () => { if (document.fullscreenElement) return 1; },  
 275992: () => { return document.getElementById('canvas').width; },  
 276044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276112: () => { document.exitFullscreen(); },  
 276139: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 276197: () => { return screen.width; },  
 276222: () => { return screen.height; },  
 276248: () => { return window.screenX; },  
 276275: () => { return window.screenY; },  
 276302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 276355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 276426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 276483: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 276739: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 276810: () => { if (document.fullscreenElement) return 1; },  
 276856: () => { return window.innerWidth; },  
 276882: () => { return window.innerHeight; },  
 276909: () => { if (document.pointerLockElement) return 1; }
};
