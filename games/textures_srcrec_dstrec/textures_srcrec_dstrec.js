...
var ASM_CONSTS = {
  274628: () => { if (document.fullscreenElement) return 1; },  
 274674: () => { return document.getElementById('canvas').width; },  
 274726: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274794: () => { document.exitFullscreen(); },  
 274821: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 274894: () => { if (document.fullscreenElement) return 1; },  
 274940: () => { return document.getElementById('canvas').width; },  
 274992: () => { return screen.width; },  
 275017: () => { document.exitFullscreen(); },  
 275044: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 275177: () => { return window.innerWidth; },  
 275203: () => { return window.innerHeight; },  
 275230: () => { if (document.fullscreenElement) return 1; },  
 275276: () => { return document.getElementById('canvas').width; },  
 275328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275396: () => { if (document.fullscreenElement) return 1; },  
 275442: () => { return document.getElementById('canvas').width; },  
 275494: () => { return screen.width; },  
 275519: () => { return window.innerWidth; },  
 275545: () => { return window.innerHeight; },  
 275572: () => { if (document.fullscreenElement) return 1; },  
 275618: () => { return document.getElementById('canvas').width; },  
 275670: () => { return screen.width; },  
 275695: () => { document.exitFullscreen(); },  
 275722: () => { if (document.fullscreenElement) return 1; },  
 275768: () => { return document.getElementById('canvas').width; },  
 275820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275888: () => { document.exitFullscreen(); },  
 275915: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 275973: () => { return screen.width; },  
 275998: () => { return screen.height; },  
 276024: () => { return window.screenX; },  
 276051: () => { return window.screenY; },  
 276078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 276131: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 276202: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 276259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 276515: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 276586: () => { if (document.fullscreenElement) return 1; },  
 276632: () => { return window.innerWidth; },  
 276658: () => { return window.innerHeight; },  
 276685: () => { if (document.pointerLockElement) return 1; }
};
