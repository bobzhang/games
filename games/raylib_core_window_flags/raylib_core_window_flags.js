...
function findWasmBinary() {
  return locateFile('raylib_core_window_flags.wasm');
}
...
var ASM_CONSTS = {
 ...
 100674: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100742: () => { document.exitFullscreen(); },  
 100769: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100842: () => { if (document.fullscreenElement) return 1; },  
 100888: () => { return document.getElementById('canvas').width; },  
 100940: () => { return screen.width; },  
 100965: () => { document.exitFullscreen(); },  
 100992: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101125: () => { return window.innerWidth; },  
 101151: () => { return window.innerHeight; },  
 101178: () => { if (document.fullscreenElement) return 1; },  
 101224: () => { return document.getElementById('canvas').width; },  
 101276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101344: () => { if (document.fullscreenElement) return 1; },  
 101390: () => { return document.getElementById('canvas').width; },  
 101442: () => { return screen.width; },  
 101467: () => { return window.innerWidth; },  
 101493: () => { return window.innerHeight; },  
 ...
 101643: () => { document.exitFullscreen(); },  
 101670: () => { if (document.fullscreenElement) return 1; },  
 101716: () => { return document.getElementById('canvas').width; },  
 101768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101836: () => { document.exitFullscreen(); },  
 101863: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101921: () => { return screen.width; },  
 101946: () => { return screen.height; },  
 101972: () => { return window.screenX; },  
 101999: () => { return window.screenY; },  
 102026: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102079: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102150: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102207: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102463: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102534: () => { if (document.fullscreenElement) return 1; },  
 102580: () => { return window.innerWidth; },  
 102606: () => { return window.innerHeight; },  
 102633: () => { if (document.pointerLockElement) return 1; }
};
