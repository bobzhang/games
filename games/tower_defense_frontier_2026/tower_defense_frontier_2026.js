...
var ASM_CONSTS = {
  261172: () => { if (document.fullscreenElement) return 1; },  
 261218: () => { return document.getElementById('canvas').width; },  
 261270: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261338: () => { document.exitFullscreen(); },  
 261365: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261438: () => { if (document.fullscreenElement) return 1; },  
 261484: () => { return document.getElementById('canvas').width; },  
 261536: () => { return screen.width; },  
 261561: () => { document.exitFullscreen(); },  
 261588: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261721: () => { return window.innerWidth; },  
 261747: () => { return window.innerHeight; },  
 261774: () => { if (document.fullscreenElement) return 1; },  
 261820: () => { return document.getElementById('canvas').width; },  
 261872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262063: () => { return window.innerWidth; },  
 262089: () => { return window.innerHeight; },  
 262116: () => { if (document.fullscreenElement) return 1; },  
 262162: () => { return document.getElementById('canvas').width; },  
 262214: () => { return screen.width; },  
 262239: () => { document.exitFullscreen(); },  
 262266: () => { if (document.fullscreenElement) return 1; },  
 262312: () => { return document.getElementById('canvas').width; },  
 262364: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262432: () => { document.exitFullscreen(); },  
 262459: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262517: () => { return screen.width; },  
 262542: () => { return screen.height; },  
 262568: () => { return window.screenX; },  
 262595: () => { return window.screenY; },  
 262622: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262675: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262746: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262803: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263059: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263130: () => { if (document.fullscreenElement) return 1; },  
 263176: () => { return window.innerWidth; },  
 263202: () => { return window.innerHeight; },  
 263229: () => { if (document.pointerLockElement) return 1; }
};
