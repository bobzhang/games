...
var ASM_CONSTS = {
 ...
 261254: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261322: () => { document.exitFullscreen(); },  
 261349: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261422: () => { if (document.fullscreenElement) return 1; },  
 261468: () => { return document.getElementById('canvas').width; },  
 261520: () => { return screen.width; },  
 261545: () => { document.exitFullscreen(); },  
 261572: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261705: () => { return window.innerWidth; },  
 261731: () => { return window.innerHeight; },  
 ...
 262047: () => { return window.innerWidth; },  
 262073: () => { return window.innerHeight; },  
 262100: () => { if (document.fullscreenElement) return 1; },  
 262146: () => { return document.getElementById('canvas').width; },  
 262198: () => { return screen.width; },  
 262223: () => { document.exitFullscreen(); },  
 ...
 262416: () => { document.exitFullscreen(); },  
 262443: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262501: () => { return screen.width; },  
 262526: () => { return screen.height; },  
 262552: () => { return window.screenX; },  
 262579: () => { return window.screenY; },  
 262606: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262659: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262730: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262787: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263043: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263114: () => { if (document.fullscreenElement) return 1; },  
 263160: () => { return window.innerWidth; },  
 263186: () => { return window.innerHeight; },  
 263213: () => { if (document.pointerLockElement) return 1; }
};
