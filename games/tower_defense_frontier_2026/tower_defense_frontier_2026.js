...
var ASM_CONSTS = {
  260948: () => { if (document.fullscreenElement) return 1; },  
 260994: () => { return document.getElementById('canvas').width; },  
 261046: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261114: () => { document.exitFullscreen(); },  
 261141: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261214: () => { if (document.fullscreenElement) return 1; },  
 261260: () => { return document.getElementById('canvas').width; },  
 261312: () => { return screen.width; },  
 261337: () => { document.exitFullscreen(); },  
 261364: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261497: () => { return window.innerWidth; },  
 261523: () => { return window.innerHeight; },  
 261550: () => { if (document.fullscreenElement) return 1; },  
 261596: () => { return document.getElementById('canvas').width; },  
 261648: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261716: () => { if (document.fullscreenElement) return 1; },  
 261762: () => { return document.getElementById('canvas').width; },  
 261814: () => { return screen.width; },  
 261839: () => { return window.innerWidth; },  
 261865: () => { return window.innerHeight; },  
 261892: () => { if (document.fullscreenElement) return 1; },  
 261938: () => { return document.getElementById('canvas').width; },  
 261990: () => { return screen.width; },  
 262015: () => { document.exitFullscreen(); },  
 262042: () => { if (document.fullscreenElement) return 1; },  
 262088: () => { return document.getElementById('canvas').width; },  
 262140: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262208: () => { document.exitFullscreen(); },  
 262235: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262293: () => { return screen.width; },  
 262318: () => { return screen.height; },  
 262344: () => { return window.screenX; },  
 262371: () => { return window.screenY; },  
 262398: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262451: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262522: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262579: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262835: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262906: () => { if (document.fullscreenElement) return 1; },  
 262952: () => { return window.innerWidth; },  
 262978: () => { return window.innerHeight; },  
 263005: () => { if (document.pointerLockElement) return 1; }
};
