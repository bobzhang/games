...
var ASM_CONSTS = {
 ...
 99106: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99174: () => { document.exitFullscreen(); },  
 99201: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99274: () => { if (document.fullscreenElement) return 1; },  
 99320: () => { return document.getElementById('canvas').width; },  
 99372: () => { return screen.width; },  
 99397: () => { document.exitFullscreen(); },  
 99424: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99557: () => { return window.innerWidth; },  
 99583: () => { return window.innerHeight; },  
 99610: () => { if (document.fullscreenElement) return 1; },  
 99656: () => { return document.getElementById('canvas').width; },  
 99708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99776: () => { if (document.fullscreenElement) return 1; },  
 99822: () => { return document.getElementById('canvas').width; },  
 99874: () => { return screen.width; },  
 99899: () => { return window.innerWidth; },  
 99925: () => { return window.innerHeight; },  
 99952: () => { if (document.fullscreenElement) return 1; },  
 99998: () => { return document.getElementById('canvas').width; },  
 100050: () => { return screen.width; },  
 100075: () => { document.exitFullscreen(); },  
 100102: () => { if (document.fullscreenElement) return 1; },  
 100148: () => { return document.getElementById('canvas').width; },  
 100200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100268: () => { document.exitFullscreen(); },  
 100295: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100353: () => { return screen.width; },  
 100378: () => { return screen.height; },  
 100404: () => { return window.screenX; },  
 100431: () => { return window.screenY; },  
 100458: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100511: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100582: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100639: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100895: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100966: () => { if (document.fullscreenElement) return 1; },  
 101012: () => { return window.innerWidth; },  
 101038: () => { return window.innerHeight; },  
 101065: () => { if (document.pointerLockElement) return 1; }
};
