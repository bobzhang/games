...
var ASM_CONSTS = {
  263472: () => { if (document.fullscreenElement) return 1; },  
 263518: () => { return document.getElementById('canvas').width; },  
 263570: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263638: () => { document.exitFullscreen(); },  
 263665: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263738: () => { if (document.fullscreenElement) return 1; },  
 263784: () => { return document.getElementById('canvas').width; },  
 263836: () => { return screen.width; },  
 263861: () => { document.exitFullscreen(); },  
 263888: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264021: () => { return window.innerWidth; },  
 264047: () => { return window.innerHeight; },  
 264074: () => { if (document.fullscreenElement) return 1; },  
 264120: () => { return document.getElementById('canvas').width; },  
 264172: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264240: () => { if (document.fullscreenElement) return 1; },  
 264286: () => { return document.getElementById('canvas').width; },  
 264338: () => { return screen.width; },  
 264363: () => { return window.innerWidth; },  
 264389: () => { return window.innerHeight; },  
 264416: () => { if (document.fullscreenElement) return 1; },  
 264462: () => { return document.getElementById('canvas').width; },  
 264514: () => { return screen.width; },  
 264539: () => { document.exitFullscreen(); },  
 264566: () => { if (document.fullscreenElement) return 1; },  
 264612: () => { return document.getElementById('canvas').width; },  
 264664: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264732: () => { document.exitFullscreen(); },  
 264759: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264817: () => { return screen.width; },  
 264842: () => { return screen.height; },  
 264868: () => { return window.screenX; },  
 264895: () => { return window.screenY; },  
 264922: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264975: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265046: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265103: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265359: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265430: () => { if (document.fullscreenElement) return 1; },  
 265476: () => { return window.innerWidth; },  
 265502: () => { return window.innerHeight; },  
 265529: () => { if (document.pointerLockElement) return 1; }
};
