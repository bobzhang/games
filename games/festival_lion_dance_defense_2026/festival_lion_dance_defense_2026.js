...
function findWasmBinary() {
  return locateFile('festival_lion_dance_defense_2026.wasm');
}
...
var ASM_CONSTS = {
  263696: () => { if (document.fullscreenElement) return 1; },  
 263742: () => { return document.getElementById('canvas').width; },  
 263794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263862: () => { document.exitFullscreen(); },  
 263889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263962: () => { if (document.fullscreenElement) return 1; },  
 264008: () => { return document.getElementById('canvas').width; },  
 264060: () => { return screen.width; },  
 264085: () => { document.exitFullscreen(); },  
 264112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264245: () => { return window.innerWidth; },  
 264271: () => { return window.innerHeight; },  
 264298: () => { if (document.fullscreenElement) return 1; },  
 264344: () => { return document.getElementById('canvas').width; },  
 264396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264464: () => { if (document.fullscreenElement) return 1; },  
 264510: () => { return document.getElementById('canvas').width; },  
 264562: () => { return screen.width; },  
 264587: () => { return window.innerWidth; },  
 264613: () => { return window.innerHeight; },  
 264640: () => { if (document.fullscreenElement) return 1; },  
 264686: () => { return document.getElementById('canvas').width; },  
 264738: () => { return screen.width; },  
 264763: () => { document.exitFullscreen(); },  
 264790: () => { if (document.fullscreenElement) return 1; },  
 264836: () => { return document.getElementById('canvas').width; },  
 264888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264956: () => { document.exitFullscreen(); },  
 264983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265041: () => { return screen.width; },  
 265066: () => { return screen.height; },  
 265092: () => { return window.screenX; },  
 265119: () => { return window.screenY; },  
 265146: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265199: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265270: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265583: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265654: () => { if (document.fullscreenElement) return 1; },  
 265700: () => { return window.innerWidth; },  
 265726: () => { return window.innerHeight; },  
 265753: () => { if (document.pointerLockElement) return 1; }
};
