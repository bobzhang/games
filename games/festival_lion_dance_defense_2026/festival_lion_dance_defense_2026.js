...
var ASM_CONSTS = {
  263492: () => { if (document.fullscreenElement) return 1; },  
 263538: () => { return document.getElementById('canvas').width; },  
 263590: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263658: () => { document.exitFullscreen(); },  
 263685: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263758: () => { if (document.fullscreenElement) return 1; },  
 263804: () => { return document.getElementById('canvas').width; },  
 263856: () => { return screen.width; },  
 263881: () => { document.exitFullscreen(); },  
 263908: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264041: () => { return window.innerWidth; },  
 264067: () => { return window.innerHeight; },  
 264094: () => { if (document.fullscreenElement) return 1; },  
 264140: () => { return document.getElementById('canvas').width; },  
 264192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264260: () => { if (document.fullscreenElement) return 1; },  
 264306: () => { return document.getElementById('canvas').width; },  
 264358: () => { return screen.width; },  
 264383: () => { return window.innerWidth; },  
 264409: () => { return window.innerHeight; },  
 264436: () => { if (document.fullscreenElement) return 1; },  
 264482: () => { return document.getElementById('canvas').width; },  
 264534: () => { return screen.width; },  
 264559: () => { document.exitFullscreen(); },  
 264586: () => { if (document.fullscreenElement) return 1; },  
 264632: () => { return document.getElementById('canvas').width; },  
 264684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264752: () => { document.exitFullscreen(); },  
 264779: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264837: () => { return screen.width; },  
 264862: () => { return screen.height; },  
 264888: () => { return window.screenX; },  
 264915: () => { return window.screenY; },  
 264942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264995: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265066: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265123: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265379: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265450: () => { if (document.fullscreenElement) return 1; },  
 265496: () => { return window.innerWidth; },  
 265522: () => { return window.innerHeight; },  
 265549: () => { if (document.pointerLockElement) return 1; }
};
