...
var ASM_CONSTS = {
  263700: () => { if (document.fullscreenElement) return 1; },  
 263746: () => { return document.getElementById('canvas').width; },  
 263798: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263866: () => { document.exitFullscreen(); },  
 263893: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263966: () => { if (document.fullscreenElement) return 1; },  
 264012: () => { return document.getElementById('canvas').width; },  
 264064: () => { return screen.width; },  
 264089: () => { document.exitFullscreen(); },  
 264116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264249: () => { return window.innerWidth; },  
 264275: () => { return window.innerHeight; },  
 264302: () => { if (document.fullscreenElement) return 1; },  
 264348: () => { return document.getElementById('canvas').width; },  
 264400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264468: () => { if (document.fullscreenElement) return 1; },  
 264514: () => { return document.getElementById('canvas').width; },  
 264566: () => { return screen.width; },  
 264591: () => { return window.innerWidth; },  
 264617: () => { return window.innerHeight; },  
 264644: () => { if (document.fullscreenElement) return 1; },  
 264690: () => { return document.getElementById('canvas').width; },  
 264742: () => { return screen.width; },  
 264767: () => { document.exitFullscreen(); },  
 264794: () => { if (document.fullscreenElement) return 1; },  
 264840: () => { return document.getElementById('canvas').width; },  
 264892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264960: () => { document.exitFullscreen(); },  
 264987: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265045: () => { return screen.width; },  
 265070: () => { return screen.height; },  
 265096: () => { return window.screenX; },  
 265123: () => { return window.screenY; },  
 265150: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265203: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265274: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265587: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265658: () => { if (document.fullscreenElement) return 1; },  
 265704: () => { return window.innerWidth; },  
 265730: () => { return window.innerHeight; },  
 265757: () => { if (document.pointerLockElement) return 1; }
};
