...
var ASM_CONSTS = {
  263684: () => { if (document.fullscreenElement) return 1; },  
 263730: () => { return document.getElementById('canvas').width; },  
 263782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263850: () => { document.exitFullscreen(); },  
 263877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263950: () => { if (document.fullscreenElement) return 1; },  
 263996: () => { return document.getElementById('canvas').width; },  
 264048: () => { return screen.width; },  
 264073: () => { document.exitFullscreen(); },  
 264100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264233: () => { return window.innerWidth; },  
 264259: () => { return window.innerHeight; },  
 264286: () => { if (document.fullscreenElement) return 1; },  
 264332: () => { return document.getElementById('canvas').width; },  
 264384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264452: () => { if (document.fullscreenElement) return 1; },  
 264498: () => { return document.getElementById('canvas').width; },  
 264550: () => { return screen.width; },  
 264575: () => { return window.innerWidth; },  
 264601: () => { return window.innerHeight; },  
 264628: () => { if (document.fullscreenElement) return 1; },  
 264674: () => { return document.getElementById('canvas').width; },  
 264726: () => { return screen.width; },  
 264751: () => { document.exitFullscreen(); },  
 264778: () => { if (document.fullscreenElement) return 1; },  
 264824: () => { return document.getElementById('canvas').width; },  
 264876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264944: () => { document.exitFullscreen(); },  
 264971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265029: () => { return screen.width; },  
 265054: () => { return screen.height; },  
 265080: () => { return window.screenX; },  
 265107: () => { return window.screenY; },  
 265134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265642: () => { if (document.fullscreenElement) return 1; },  
 265688: () => { return window.innerWidth; },  
 265714: () => { return window.innerHeight; },  
 265741: () => { if (document.pointerLockElement) return 1; }
};
