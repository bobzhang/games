...
var ASM_CONSTS = {
  266068: () => { if (document.fullscreenElement) return 1; },  
 266114: () => { return document.getElementById('canvas').width; },  
 266166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266234: () => { document.exitFullscreen(); },  
 266261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 266334: () => { if (document.fullscreenElement) return 1; },  
 266380: () => { return document.getElementById('canvas').width; },  
 266432: () => { return screen.width; },  
 266457: () => { document.exitFullscreen(); },  
 266484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 266617: () => { return window.innerWidth; },  
 266643: () => { return window.innerHeight; },  
 266670: () => { if (document.fullscreenElement) return 1; },  
 266716: () => { return document.getElementById('canvas').width; },  
 266768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266836: () => { if (document.fullscreenElement) return 1; },  
 266882: () => { return document.getElementById('canvas').width; },  
 266934: () => { return screen.width; },  
 266959: () => { return window.innerWidth; },  
 266985: () => { return window.innerHeight; },  
 267012: () => { if (document.fullscreenElement) return 1; },  
 267058: () => { return document.getElementById('canvas').width; },  
 267110: () => { return screen.width; },  
 267135: () => { document.exitFullscreen(); },  
 267162: () => { if (document.fullscreenElement) return 1; },  
 267208: () => { return document.getElementById('canvas').width; },  
 267260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267328: () => { document.exitFullscreen(); },  
 267355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 267413: () => { return screen.width; },  
 267438: () => { return screen.height; },  
 267464: () => { return window.screenX; },  
 267491: () => { return window.screenY; },  
 267518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 267571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 267642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 267699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 267955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268026: () => { if (document.fullscreenElement) return 1; },  
 268072: () => { return window.innerWidth; },  
 268098: () => { return window.innerHeight; },  
 268125: () => { if (document.pointerLockElement) return 1; }
};
