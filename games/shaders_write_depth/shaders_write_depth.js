...
var ASM_CONSTS = {
  253348: () => { if (document.fullscreenElement) return 1; },  
 253394: () => { return document.getElementById('canvas').width; },  
 253446: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253514: () => { document.exitFullscreen(); },  
 253541: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 253614: () => { if (document.fullscreenElement) return 1; },  
 253660: () => { return document.getElementById('canvas').width; },  
 253712: () => { return screen.width; },  
 253737: () => { document.exitFullscreen(); },  
 253764: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 253897: () => { return window.innerWidth; },  
 253923: () => { return window.innerHeight; },  
 253950: () => { if (document.fullscreenElement) return 1; },  
 253996: () => { return document.getElementById('canvas').width; },  
 254048: () => { return parseInt(document.getElementById('canvas').style.width); },  
 254116: () => { if (document.fullscreenElement) return 1; },  
 254162: () => { return document.getElementById('canvas').width; },  
 254214: () => { return screen.width; },  
 254239: () => { return window.innerWidth; },  
 254265: () => { return window.innerHeight; },  
 254292: () => { if (document.fullscreenElement) return 1; },  
 254338: () => { return document.getElementById('canvas').width; },  
 254390: () => { return screen.width; },  
 254415: () => { document.exitFullscreen(); },  
 254442: () => { if (document.fullscreenElement) return 1; },  
 254488: () => { return document.getElementById('canvas').width; },  
 254540: () => { return parseInt(document.getElementById('canvas').style.width); },  
 254608: () => { document.exitFullscreen(); },  
 254635: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 254693: () => { return screen.width; },  
 254718: () => { return screen.height; },  
 254744: () => { return window.screenX; },  
 254771: () => { return window.screenY; },  
 254798: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 254851: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 254922: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 254979: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 255235: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 255306: () => { if (document.fullscreenElement) return 1; },  
 255352: () => { return window.innerWidth; },  
 255378: () => { return window.innerHeight; },  
 255405: () => { if (document.pointerLockElement) return 1; }
};
