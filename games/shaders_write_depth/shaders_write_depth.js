...
var ASM_CONSTS = {
  253140: () => { if (document.fullscreenElement) return 1; },  
 253186: () => { return document.getElementById('canvas').width; },  
 253238: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253306: () => { document.exitFullscreen(); },  
 253333: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 253406: () => { if (document.fullscreenElement) return 1; },  
 253452: () => { return document.getElementById('canvas').width; },  
 253504: () => { return screen.width; },  
 253529: () => { document.exitFullscreen(); },  
 253556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 253689: () => { return window.innerWidth; },  
 253715: () => { return window.innerHeight; },  
 253742: () => { if (document.fullscreenElement) return 1; },  
 253788: () => { return document.getElementById('canvas').width; },  
 253840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253908: () => { if (document.fullscreenElement) return 1; },  
 253954: () => { return document.getElementById('canvas').width; },  
 254006: () => { return screen.width; },  
 254031: () => { return window.innerWidth; },  
 254057: () => { return window.innerHeight; },  
 254084: () => { if (document.fullscreenElement) return 1; },  
 254130: () => { return document.getElementById('canvas').width; },  
 254182: () => { return screen.width; },  
 254207: () => { document.exitFullscreen(); },  
 254234: () => { if (document.fullscreenElement) return 1; },  
 254280: () => { return document.getElementById('canvas').width; },  
 254332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 254400: () => { document.exitFullscreen(); },  
 254427: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 254485: () => { return screen.width; },  
 254510: () => { return screen.height; },  
 254536: () => { return window.screenX; },  
 254563: () => { return window.screenY; },  
 254590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 254643: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 254714: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 254771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 255027: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 255098: () => { if (document.fullscreenElement) return 1; },  
 255144: () => { return window.innerWidth; },  
 255170: () => { return window.innerHeight; },  
 255197: () => { if (document.pointerLockElement) return 1; }
};
