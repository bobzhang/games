...
var ASM_CONSTS = {
  253344: () => { if (document.fullscreenElement) return 1; },  
 253390: () => { return document.getElementById('canvas').width; },  
 253442: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253510: () => { document.exitFullscreen(); },  
 253537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 253610: () => { if (document.fullscreenElement) return 1; },  
 253656: () => { return document.getElementById('canvas').width; },  
 253708: () => { return screen.width; },  
 253733: () => { document.exitFullscreen(); },  
 253760: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 253893: () => { return window.innerWidth; },  
 253919: () => { return window.innerHeight; },  
 253946: () => { if (document.fullscreenElement) return 1; },  
 253992: () => { return document.getElementById('canvas').width; },  
 254044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 254112: () => { if (document.fullscreenElement) return 1; },  
 254158: () => { return document.getElementById('canvas').width; },  
 254210: () => { return screen.width; },  
 254235: () => { return window.innerWidth; },  
 254261: () => { return window.innerHeight; },  
 254288: () => { if (document.fullscreenElement) return 1; },  
 254334: () => { return document.getElementById('canvas').width; },  
 254386: () => { return screen.width; },  
 254411: () => { document.exitFullscreen(); },  
 254438: () => { if (document.fullscreenElement) return 1; },  
 254484: () => { return document.getElementById('canvas').width; },  
 254536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 254604: () => { document.exitFullscreen(); },  
 254631: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 254689: () => { return screen.width; },  
 254714: () => { return screen.height; },  
 254740: () => { return window.screenX; },  
 254767: () => { return window.screenY; },  
 254794: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 254847: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 254918: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 254975: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 255231: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 255302: () => { if (document.fullscreenElement) return 1; },  
 255348: () => { return window.innerWidth; },  
 255374: () => { return window.innerHeight; },  
 255401: () => { if (document.pointerLockElement) return 1; }
};
