...
var ASM_CONSTS = {
  272452: () => { if (document.fullscreenElement) return 1; },  
 272498: () => { return document.getElementById('canvas').width; },  
 272550: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272618: () => { document.exitFullscreen(); },  
 272645: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272718: () => { if (document.fullscreenElement) return 1; },  
 272764: () => { return document.getElementById('canvas').width; },  
 272816: () => { return screen.width; },  
 272841: () => { document.exitFullscreen(); },  
 272868: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273001: () => { return window.innerWidth; },  
 273027: () => { return window.innerHeight; },  
 273054: () => { if (document.fullscreenElement) return 1; },  
 273100: () => { return document.getElementById('canvas').width; },  
 273152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273220: () => { if (document.fullscreenElement) return 1; },  
 273266: () => { return document.getElementById('canvas').width; },  
 273318: () => { return screen.width; },  
 273343: () => { return window.innerWidth; },  
 273369: () => { return window.innerHeight; },  
 273396: () => { if (document.fullscreenElement) return 1; },  
 273442: () => { return document.getElementById('canvas').width; },  
 273494: () => { return screen.width; },  
 273519: () => { document.exitFullscreen(); },  
 273546: () => { if (document.fullscreenElement) return 1; },  
 273592: () => { return document.getElementById('canvas').width; },  
 273644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273712: () => { document.exitFullscreen(); },  
 273739: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273797: () => { return screen.width; },  
 273822: () => { return screen.height; },  
 273848: () => { return window.screenX; },  
 273875: () => { return window.screenY; },  
 273902: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273955: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274026: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274083: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274339: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274410: () => { if (document.fullscreenElement) return 1; },  
 274456: () => { return window.innerWidth; },  
 274482: () => { return window.innerHeight; },  
 274509: () => { if (document.pointerLockElement) return 1; }
};
