...
var ASM_CONSTS = {
  272292: () => { if (document.fullscreenElement) return 1; },  
 272338: () => { return document.getElementById('canvas').width; },  
 272390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272458: () => { document.exitFullscreen(); },  
 272485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272558: () => { if (document.fullscreenElement) return 1; },  
 272604: () => { return document.getElementById('canvas').width; },  
 272656: () => { return screen.width; },  
 272681: () => { document.exitFullscreen(); },  
 272708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 272841: () => { return window.innerWidth; },  
 272867: () => { return window.innerHeight; },  
 272894: () => { if (document.fullscreenElement) return 1; },  
 272940: () => { return document.getElementById('canvas').width; },  
 272992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273060: () => { if (document.fullscreenElement) return 1; },  
 273106: () => { return document.getElementById('canvas').width; },  
 273158: () => { return screen.width; },  
 273183: () => { return window.innerWidth; },  
 273209: () => { return window.innerHeight; },  
 273236: () => { if (document.fullscreenElement) return 1; },  
 273282: () => { return document.getElementById('canvas').width; },  
 273334: () => { return screen.width; },  
 273359: () => { document.exitFullscreen(); },  
 273386: () => { if (document.fullscreenElement) return 1; },  
 273432: () => { return document.getElementById('canvas').width; },  
 273484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273552: () => { document.exitFullscreen(); },  
 273579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 273637: () => { return screen.width; },  
 273662: () => { return screen.height; },  
 273688: () => { return window.screenX; },  
 273715: () => { return window.screenY; },  
 273742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 273795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 273866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 273923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274250: () => { if (document.fullscreenElement) return 1; },  
 274296: () => { return window.innerWidth; },  
 274322: () => { return window.innerHeight; },  
 274349: () => { if (document.pointerLockElement) return 1; }
};
