...
var ASM_CONSTS = {
 ...
 264806: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264874: () => { document.exitFullscreen(); },  
 264901: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264974: () => { if (document.fullscreenElement) return 1; },  
 265020: () => { return document.getElementById('canvas').width; },  
 265072: () => { return screen.width; },  
 265097: () => { document.exitFullscreen(); },  
 265124: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265257: () => { return window.innerWidth; },  
 265283: () => { return window.innerHeight; },  
 265310: () => { if (document.fullscreenElement) return 1; },  
 265356: () => { return document.getElementById('canvas').width; },  
 265408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265476: () => { if (document.fullscreenElement) return 1; },  
 265522: () => { return document.getElementById('canvas').width; },  
 265574: () => { return screen.width; },  
 265599: () => { return window.innerWidth; },  
 265625: () => { return window.innerHeight; },  
 265652: () => { if (document.fullscreenElement) return 1; },  
 265698: () => { return document.getElementById('canvas').width; },  
 265750: () => { return screen.width; },  
 265775: () => { document.exitFullscreen(); },  
 265802: () => { if (document.fullscreenElement) return 1; },  
 265848: () => { return document.getElementById('canvas').width; },  
 265900: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265968: () => { document.exitFullscreen(); },  
 265995: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266053: () => { return screen.width; },  
 266078: () => { return screen.height; },  
 266104: () => { return window.screenX; },  
 266131: () => { return window.screenY; },  
 266158: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266211: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266282: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266339: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266595: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266666: () => { if (document.fullscreenElement) return 1; },  
 266712: () => { return window.innerWidth; },  
 266738: () => { return window.innerHeight; },  
 266765: () => { if (document.pointerLockElement) return 1; }
};
