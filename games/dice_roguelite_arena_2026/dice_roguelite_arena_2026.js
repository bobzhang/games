...
var ASM_CONSTS = {
 ...
 264582: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264650: () => { document.exitFullscreen(); },  
 264677: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264750: () => { if (document.fullscreenElement) return 1; },  
 264796: () => { return document.getElementById('canvas').width; },  
 264848: () => { return screen.width; },  
 264873: () => { document.exitFullscreen(); },  
 264900: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265033: () => { return window.innerWidth; },  
 265059: () => { return window.innerHeight; },  
 265086: () => { if (document.fullscreenElement) return 1; },  
 265132: () => { return document.getElementById('canvas').width; },  
 265184: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265252: () => { if (document.fullscreenElement) return 1; },  
 265298: () => { return document.getElementById('canvas').width; },  
 265350: () => { return screen.width; },  
 265375: () => { return window.innerWidth; },  
 265401: () => { return window.innerHeight; },  
 265428: () => { if (document.fullscreenElement) return 1; },  
 265474: () => { return document.getElementById('canvas').width; },  
 265526: () => { return screen.width; },  
 265551: () => { document.exitFullscreen(); },  
 265578: () => { if (document.fullscreenElement) return 1; },  
 265624: () => { return document.getElementById('canvas').width; },  
 265676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265744: () => { document.exitFullscreen(); },  
 265771: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265829: () => { return screen.width; },  
 265854: () => { return screen.height; },  
 265880: () => { return window.screenX; },  
 265907: () => { return window.screenY; },  
 265934: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265987: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266058: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266115: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266371: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266442: () => { if (document.fullscreenElement) return 1; },  
 266488: () => { return window.innerWidth; },  
 266514: () => { return window.innerHeight; },  
 266541: () => { if (document.pointerLockElement) return 1; }
};
