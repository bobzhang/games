...
var ASM_CONSTS = {
 ...
 264774: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264842: () => { document.exitFullscreen(); },  
 264869: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264942: () => { if (document.fullscreenElement) return 1; },  
 264988: () => { return document.getElementById('canvas').width; },  
 265040: () => { return screen.width; },  
 265065: () => { document.exitFullscreen(); },  
 265092: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 265225: () => { return window.innerWidth; },  
 265251: () => { return window.innerHeight; },  
 265278: () => { if (document.fullscreenElement) return 1; },  
 265324: () => { return document.getElementById('canvas').width; },  
 265376: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265444: () => { if (document.fullscreenElement) return 1; },  
 265490: () => { return document.getElementById('canvas').width; },  
 265542: () => { return screen.width; },  
 265567: () => { return window.innerWidth; },  
 265593: () => { return window.innerHeight; },  
 265620: () => { if (document.fullscreenElement) return 1; },  
 265666: () => { return document.getElementById('canvas').width; },  
 265718: () => { return screen.width; },  
 265743: () => { document.exitFullscreen(); },  
 265770: () => { if (document.fullscreenElement) return 1; },  
 265816: () => { return document.getElementById('canvas').width; },  
 265868: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265936: () => { document.exitFullscreen(); },  
 265963: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 266021: () => { return screen.width; },  
 266046: () => { return screen.height; },  
 266072: () => { return window.screenX; },  
 266099: () => { return window.screenY; },  
 266126: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 266179: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 266250: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 266307: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266563: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266634: () => { if (document.fullscreenElement) return 1; },  
 266680: () => { return window.innerWidth; },  
 266706: () => { return window.innerHeight; },  
 266733: () => { if (document.pointerLockElement) return 1; }
};
