...
function findWasmBinary() {
  return locateFile('raylib_shapes_rectangle_advanced.wasm');
}
...
var ASM_CONSTS = {
  96880: () => { if (document.fullscreenElement) return 1; },  
 96926: () => { return document.getElementById('canvas').width; },  
 96978: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97046: () => { document.exitFullscreen(); },  
 97073: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97146: () => { if (document.fullscreenElement) return 1; },  
 97192: () => { return document.getElementById('canvas').width; },  
 97244: () => { return screen.width; },  
 97269: () => { document.exitFullscreen(); },  
 97296: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97429: () => { return window.innerWidth; },  
 97455: () => { return window.innerHeight; },  
 97482: () => { if (document.fullscreenElement) return 1; },  
 97528: () => { return document.getElementById('canvas').width; },  
 97580: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97648: () => { if (document.fullscreenElement) return 1; },  
 97694: () => { return document.getElementById('canvas').width; },  
 97746: () => { return screen.width; },  
 97771: () => { return window.innerWidth; },  
 97797: () => { return window.innerHeight; },  
 97824: () => { if (document.fullscreenElement) return 1; },  
 97870: () => { return document.getElementById('canvas').width; },  
 97922: () => { return screen.width; },  
 97947: () => { document.exitFullscreen(); },  
 97974: () => { if (document.fullscreenElement) return 1; },  
 98020: () => { return document.getElementById('canvas').width; },  
 98072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98140: () => { document.exitFullscreen(); },  
 98167: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98225: () => { return screen.width; },  
 98250: () => { return screen.height; },  
 98276: () => { return window.screenX; },  
 98303: () => { return window.screenY; },  
 98330: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98383: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98454: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98511: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98767: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98838: () => { if (document.fullscreenElement) return 1; },  
 98884: () => { return window.innerWidth; },  
 98910: () => { return window.innerHeight; },  
 98937: () => { if (document.pointerLockElement) return 1; }
};
