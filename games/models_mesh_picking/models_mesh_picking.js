...
var ASM_CONSTS = {
  272708: () => { if (document.fullscreenElement) return 1; },  
 272754: () => { return document.getElementById('canvas').width; },  
 272806: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272874: () => { document.exitFullscreen(); },  
 272901: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 272974: () => { if (document.fullscreenElement) return 1; },  
 273020: () => { return document.getElementById('canvas').width; },  
 273072: () => { return screen.width; },  
 273097: () => { document.exitFullscreen(); },  
 273124: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273257: () => { return window.innerWidth; },  
 273283: () => { return window.innerHeight; },  
 273310: () => { if (document.fullscreenElement) return 1; },  
 273356: () => { return document.getElementById('canvas').width; },  
 273408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273476: () => { if (document.fullscreenElement) return 1; },  
 273522: () => { return document.getElementById('canvas').width; },  
 273574: () => { return screen.width; },  
 273599: () => { return window.innerWidth; },  
 273625: () => { return window.innerHeight; },  
 273652: () => { if (document.fullscreenElement) return 1; },  
 273698: () => { return document.getElementById('canvas').width; },  
 273750: () => { return screen.width; },  
 273775: () => { document.exitFullscreen(); },  
 273802: () => { if (document.fullscreenElement) return 1; },  
 273848: () => { return document.getElementById('canvas').width; },  
 273900: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273968: () => { document.exitFullscreen(); },  
 273995: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274053: () => { return screen.width; },  
 274078: () => { return screen.height; },  
 274104: () => { return window.screenX; },  
 274131: () => { return window.screenY; },  
 274158: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274211: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274282: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274339: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274595: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274666: () => { if (document.fullscreenElement) return 1; },  
 274712: () => { return window.innerWidth; },  
 274738: () => { return window.innerHeight; },  
 274765: () => { if (document.pointerLockElement) return 1; }
};
