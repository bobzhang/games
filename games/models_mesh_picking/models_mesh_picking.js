...
var ASM_CONSTS = {
  272916: () => { if (document.fullscreenElement) return 1; },  
 272962: () => { return document.getElementById('canvas').width; },  
 273014: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273082: () => { document.exitFullscreen(); },  
 273109: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273182: () => { if (document.fullscreenElement) return 1; },  
 273228: () => { return document.getElementById('canvas').width; },  
 273280: () => { return screen.width; },  
 273305: () => { document.exitFullscreen(); },  
 273332: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273465: () => { return window.innerWidth; },  
 273491: () => { return window.innerHeight; },  
 273518: () => { if (document.fullscreenElement) return 1; },  
 273564: () => { return document.getElementById('canvas').width; },  
 273616: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 273807: () => { return window.innerWidth; },  
 273833: () => { return window.innerHeight; },  
 273860: () => { if (document.fullscreenElement) return 1; },  
 273906: () => { return document.getElementById('canvas').width; },  
 273958: () => { return screen.width; },  
 273983: () => { document.exitFullscreen(); },  
 274010: () => { if (document.fullscreenElement) return 1; },  
 274056: () => { return document.getElementById('canvas').width; },  
 274108: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274176: () => { document.exitFullscreen(); },  
 274203: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274261: () => { return screen.width; },  
 274286: () => { return screen.height; },  
 274312: () => { return window.screenX; },  
 274339: () => { return window.screenY; },  
 274366: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274419: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274490: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274547: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274803: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274874: () => { if (document.fullscreenElement) return 1; },  
 274920: () => { return window.innerWidth; },  
 274946: () => { return window.innerHeight; },  
 274973: () => { if (document.pointerLockElement) return 1; }
};
