...
var ASM_CONSTS = {
  272932: () => { if (document.fullscreenElement) return 1; },  
 272978: () => { return document.getElementById('canvas').width; },  
 273030: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273098: () => { document.exitFullscreen(); },  
 273125: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273198: () => { if (document.fullscreenElement) return 1; },  
 273244: () => { return document.getElementById('canvas').width; },  
 273296: () => { return screen.width; },  
 273321: () => { document.exitFullscreen(); },  
 273348: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273481: () => { return window.innerWidth; },  
 273507: () => { return window.innerHeight; },  
 273534: () => { if (document.fullscreenElement) return 1; },  
 273580: () => { return document.getElementById('canvas').width; },  
 273632: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273700: () => { if (document.fullscreenElement) return 1; },  
 273746: () => { return document.getElementById('canvas').width; },  
 273798: () => { return screen.width; },  
 273823: () => { return window.innerWidth; },  
 273849: () => { return window.innerHeight; },  
 ...
 273999: () => { document.exitFullscreen(); },  
 274026: () => { if (document.fullscreenElement) return 1; },  
 274072: () => { return document.getElementById('canvas').width; },  
 274124: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274192: () => { document.exitFullscreen(); },  
 274219: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274277: () => { return screen.width; },  
 274302: () => { return screen.height; },  
 274328: () => { return window.screenX; },  
 274355: () => { return window.screenY; },  
 274382: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274435: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274506: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274563: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274819: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274890: () => { if (document.fullscreenElement) return 1; },  
 274936: () => { return window.innerWidth; },  
 274962: () => { return window.innerHeight; },  
 274989: () => { if (document.pointerLockElement) return 1; }
};
