...
var ASM_CONSTS = {
  263540: () => { if (document.fullscreenElement) return 1; },  
 263586: () => { return document.getElementById('canvas').width; },  
 263638: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263706: () => { document.exitFullscreen(); },  
 263733: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263806: () => { if (document.fullscreenElement) return 1; },  
 263852: () => { return document.getElementById('canvas').width; },  
 263904: () => { return screen.width; },  
 263929: () => { document.exitFullscreen(); },  
 263956: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264089: () => { return window.innerWidth; },  
 264115: () => { return window.innerHeight; },  
 264142: () => { if (document.fullscreenElement) return 1; },  
 264188: () => { return document.getElementById('canvas').width; },  
 264240: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264308: () => { if (document.fullscreenElement) return 1; },  
 264354: () => { return document.getElementById('canvas').width; },  
 264406: () => { return screen.width; },  
 264431: () => { return window.innerWidth; },  
 264457: () => { return window.innerHeight; },  
 264484: () => { if (document.fullscreenElement) return 1; },  
 264530: () => { return document.getElementById('canvas').width; },  
 264582: () => { return screen.width; },  
 264607: () => { document.exitFullscreen(); },  
 264634: () => { if (document.fullscreenElement) return 1; },  
 264680: () => { return document.getElementById('canvas').width; },  
 264732: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264800: () => { document.exitFullscreen(); },  
 264827: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264885: () => { return screen.width; },  
 264910: () => { return screen.height; },  
 264936: () => { return window.screenX; },  
 264963: () => { return window.screenY; },  
 264990: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265043: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265114: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265171: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265427: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265498: () => { if (document.fullscreenElement) return 1; },  
 265544: () => { return window.innerWidth; },  
 265570: () => { return window.innerHeight; },  
 265597: () => { if (document.pointerLockElement) return 1; }
};
