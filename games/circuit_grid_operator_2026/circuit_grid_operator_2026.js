...
var ASM_CONSTS = {
 ...
 263862: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263930: () => { document.exitFullscreen(); },  
 263957: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264030: () => { if (document.fullscreenElement) return 1; },  
 264076: () => { return document.getElementById('canvas').width; },  
 264128: () => { return screen.width; },  
 264153: () => { document.exitFullscreen(); },  
 264180: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264313: () => { return window.innerWidth; },  
 264339: () => { return window.innerHeight; },  
 264366: () => { if (document.fullscreenElement) return 1; },  
 264412: () => { return document.getElementById('canvas').width; },  
 264464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264655: () => { return window.innerWidth; },  
 264681: () => { return window.innerHeight; },  
 ...
 264831: () => { document.exitFullscreen(); },  
 264858: () => { if (document.fullscreenElement) return 1; },  
 264904: () => { return document.getElementById('canvas').width; },  
 264956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265024: () => { document.exitFullscreen(); },  
 265051: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265109: () => { return screen.width; },  
 265134: () => { return screen.height; },  
 265160: () => { return window.screenX; },  
 265187: () => { return window.screenY; },  
 265214: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265267: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265338: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265395: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265651: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265722: () => { if (document.fullscreenElement) return 1; },  
 265768: () => { return window.innerWidth; },  
 265794: () => { return window.innerHeight; },  
 265821: () => { if (document.pointerLockElement) return 1; }
};
