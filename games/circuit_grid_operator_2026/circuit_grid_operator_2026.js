...
var ASM_CONSTS = {
 ...
 263846: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263914: () => { document.exitFullscreen(); },  
 263941: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264014: () => { if (document.fullscreenElement) return 1; },  
 264060: () => { return document.getElementById('canvas').width; },  
 264112: () => { return screen.width; },  
 264137: () => { document.exitFullscreen(); },  
 264164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264297: () => { return window.innerWidth; },  
 264323: () => { return window.innerHeight; },  
 264350: () => { if (document.fullscreenElement) return 1; },  
 264396: () => { return document.getElementById('canvas').width; },  
 264448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264639: () => { return window.innerWidth; },  
 264665: () => { return window.innerHeight; },  
 264692: () => { if (document.fullscreenElement) return 1; },  
 264738: () => { return document.getElementById('canvas').width; },  
 264790: () => { return screen.width; },  
 264815: () => { document.exitFullscreen(); },  
 264842: () => { if (document.fullscreenElement) return 1; },  
 264888: () => { return document.getElementById('canvas').width; },  
 264940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265008: () => { document.exitFullscreen(); },  
 265035: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265093: () => { return screen.width; },  
 265118: () => { return screen.height; },  
 265144: () => { return window.screenX; },  
 265171: () => { return window.screenY; },  
 265198: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265251: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265322: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265635: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265706: () => { if (document.fullscreenElement) return 1; },  
 265752: () => { return window.innerWidth; },  
 265778: () => { return window.innerHeight; },  
 265805: () => { if (document.pointerLockElement) return 1; }
};
