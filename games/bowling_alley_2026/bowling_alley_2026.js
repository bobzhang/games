...
var ASM_CONSTS = {
  269100: () => { if (document.fullscreenElement) return 1; },  
 269146: () => { return document.getElementById('canvas').width; },  
 269198: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269266: () => { document.exitFullscreen(); },  
 269293: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269366: () => { if (document.fullscreenElement) return 1; },  
 269412: () => { return document.getElementById('canvas').width; },  
 269464: () => { return screen.width; },  
 269489: () => { document.exitFullscreen(); },  
 269516: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269649: () => { return window.innerWidth; },  
 269675: () => { return window.innerHeight; },  
 269702: () => { if (document.fullscreenElement) return 1; },  
 269748: () => { return document.getElementById('canvas').width; },  
 269800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269868: () => { if (document.fullscreenElement) return 1; },  
 269914: () => { return document.getElementById('canvas').width; },  
 269966: () => { return screen.width; },  
 269991: () => { return window.innerWidth; },  
 270017: () => { return window.innerHeight; },  
 ...
 270167: () => { document.exitFullscreen(); },  
