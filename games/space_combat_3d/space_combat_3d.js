...
var ASM_CONSTS = {
  270580: () => { if (document.fullscreenElement) return 1; },  
 270626: () => { return document.getElementById('canvas').width; },  
 270678: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270746: () => { document.exitFullscreen(); },  
 270773: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 270846: () => { if (document.fullscreenElement) return 1; },  
 270892: () => { return document.getElementById('canvas').width; },  
 270944: () => { return screen.width; },  
 270969: () => { document.exitFullscreen(); },  
 270996: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 271129: () => { return window.innerWidth; },  
 271155: () => { return window.innerHeight; },  
 271182: () => { if (document.fullscreenElement) return 1; },  
 271228: () => { return document.getElementById('canvas').width; },  
 271280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271348: () => { if (document.fullscreenElement) return 1; },  
 271394: () => { return document.getElementById('canvas').width; },  
 271446: () => { return screen.width; },  
 271471: () => { return window.innerWidth; },  
 271497: () => { return window.innerHeight; },  
 271524: () => { if (document.fullscreenElement) return 1; },  
 271570: () => { return document.getElementById('canvas').width; },  
 271622: () => { return screen.width; },  
 271647: () => { document.exitFullscreen(); },  
 271674: () => { if (document.fullscreenElement) return 1; },  
 271720: () => { return document.getElementById('canvas').width; },  
 271772: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271840: () => { document.exitFullscreen(); },  
 271867: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 271925: () => { return screen.width; },  
 271950: () => { return screen.height; },  
 271976: () => { return window.screenX; },  
 272003: () => { return window.screenY; },  
 272030: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 272083: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 272154: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 272211: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 272467: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 272538: () => { if (document.fullscreenElement) return 1; },  
 272584: () => { return window.innerWidth; },  
 272610: () => { return window.innerHeight; },  
 272637: () => { if (document.pointerLockElement) return 1; }
};
