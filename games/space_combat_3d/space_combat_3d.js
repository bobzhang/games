...
var ASM_CONSTS = {
  271124: () => { if (document.fullscreenElement) return 1; },  
 271170: () => { return document.getElementById('canvas').width; },  
 271222: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271290: () => { document.exitFullscreen(); },  
 271317: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 271390: () => { if (document.fullscreenElement) return 1; },  
 271436: () => { return document.getElementById('canvas').width; },  
 271488: () => { return screen.width; },  
 271513: () => { document.exitFullscreen(); },  
 271540: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 271673: () => { return window.innerWidth; },  
 271699: () => { return window.innerHeight; },  
 271726: () => { if (document.fullscreenElement) return 1; },  
 271772: () => { return document.getElementById('canvas').width; },  
 271824: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271892: () => { if (document.fullscreenElement) return 1; },  
 271938: () => { return document.getElementById('canvas').width; },  
 271990: () => { return screen.width; },  
 272015: () => { return window.innerWidth; },  
 272041: () => { return window.innerHeight; },  
 272068: () => { if (document.fullscreenElement) return 1; },  
 272114: () => { return document.getElementById('canvas').width; },  
 272166: () => { return screen.width; },  
 272191: () => { document.exitFullscreen(); },  
 272218: () => { if (document.fullscreenElement) return 1; },  
 272264: () => { return document.getElementById('canvas').width; },  
 272316: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272384: () => { document.exitFullscreen(); },  
 272411: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 272469: () => { return screen.width; },  
 272494: () => { return screen.height; },  
 272520: () => { return window.screenX; },  
 272547: () => { return window.screenY; },  
 272574: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 272627: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 272698: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 272755: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 273011: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 273082: () => { if (document.fullscreenElement) return 1; },  
 273128: () => { return window.innerWidth; },  
 273154: () => { return window.innerHeight; },  
 273181: () => { if (document.pointerLockElement) return 1; }
};
