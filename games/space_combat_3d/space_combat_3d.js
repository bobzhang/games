...
var ASM_CONSTS = {
  270772: () => { if (document.fullscreenElement) return 1; },  
 270818: () => { return document.getElementById('canvas').width; },  
 270870: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270938: () => { document.exitFullscreen(); },  
 270965: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 271038: () => { if (document.fullscreenElement) return 1; },  
 271084: () => { return document.getElementById('canvas').width; },  
 271136: () => { return screen.width; },  
 271161: () => { document.exitFullscreen(); },  
 271188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 271321: () => { return window.innerWidth; },  
 271347: () => { return window.innerHeight; },  
 271374: () => { if (document.fullscreenElement) return 1; },  
 271420: () => { return document.getElementById('canvas').width; },  
 271472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271540: () => { if (document.fullscreenElement) return 1; },  
 271586: () => { return document.getElementById('canvas').width; },  
 271638: () => { return screen.width; },  
 271663: () => { return window.innerWidth; },  
 271689: () => { return window.innerHeight; },  
 271716: () => { if (document.fullscreenElement) return 1; },  
 271762: () => { return document.getElementById('canvas').width; },  
 271814: () => { return screen.width; },  
 271839: () => { document.exitFullscreen(); },  
 271866: () => { if (document.fullscreenElement) return 1; },  
 271912: () => { return document.getElementById('canvas').width; },  
 271964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272032: () => { document.exitFullscreen(); },  
 272059: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 272117: () => { return screen.width; },  
 272142: () => { return screen.height; },  
 272168: () => { return window.screenX; },  
 272195: () => { return window.screenY; },  
 272222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 272275: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 272346: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 272403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 272659: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 272730: () => { if (document.fullscreenElement) return 1; },  
 272776: () => { return window.innerWidth; },  
 272802: () => { return window.innerHeight; },  
 272829: () => { if (document.pointerLockElement) return 1; }
};
