...
var ASM_CONSTS = {
 ...
 263382: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263450: () => { document.exitFullscreen(); },  
 263477: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263550: () => { if (document.fullscreenElement) return 1; },  
 263596: () => { return document.getElementById('canvas').width; },  
 263648: () => { return screen.width; },  
 263673: () => { document.exitFullscreen(); },  
 263700: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263833: () => { return window.innerWidth; },  
 263859: () => { return window.innerHeight; },  
 263886: () => { if (document.fullscreenElement) return 1; },  
 263932: () => { return document.getElementById('canvas').width; },  
 263984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264175: () => { return window.innerWidth; },  
 264201: () => { return window.innerHeight; },  
 264228: () => { if (document.fullscreenElement) return 1; },  
 264274: () => { return document.getElementById('canvas').width; },  
 264326: () => { return screen.width; },  
 264351: () => { document.exitFullscreen(); },  
 264378: () => { if (document.fullscreenElement) return 1; },  
 264424: () => { return document.getElementById('canvas').width; },  
 264476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264544: () => { document.exitFullscreen(); },  
 264571: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264629: () => { return screen.width; },  
 264654: () => { return screen.height; },  
 264680: () => { return window.screenX; },  
 264707: () => { return window.screenY; },  
 264734: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264787: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264858: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265171: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265242: () => { if (document.fullscreenElement) return 1; },  
 265288: () => { return window.innerWidth; },  
 265314: () => { return window.innerHeight; },  
 265341: () => { if (document.pointerLockElement) return 1; }
};
