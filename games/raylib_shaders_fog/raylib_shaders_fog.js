...
function findWasmBinary() {
  return locateFile('raylib_shaders_fog.wasm');
}
...
var ASM_CONSTS = {
  199768: () => { if (document.fullscreenElement) return 1; },  
 199814: () => { return document.getElementById('canvas').width; },  
 199866: () => { return parseInt(document.getElementById('canvas').style.width); },  
 199934: () => { document.exitFullscreen(); },  
 199961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 200034: () => { if (document.fullscreenElement) return 1; },  
 200080: () => { return document.getElementById('canvas').width; },  
 200132: () => { return screen.width; },  
 200157: () => { document.exitFullscreen(); },  
 200184: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 200317: () => { return window.innerWidth; },  
 200343: () => { return window.innerHeight; },  
 200370: () => { if (document.fullscreenElement) return 1; },  
 200416: () => { return document.getElementById('canvas').width; },  
 200468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 200536: () => { if (document.fullscreenElement) return 1; },  
 200582: () => { return document.getElementById('canvas').width; },  
 200634: () => { return screen.width; },  
 200659: () => { return window.innerWidth; },  
 200685: () => { return window.innerHeight; },  
 200712: () => { if (document.fullscreenElement) return 1; },  
 200758: () => { return document.getElementById('canvas').width; },  
 200810: () => { return screen.width; },  
 200835: () => { document.exitFullscreen(); },  
 200862: () => { if (document.fullscreenElement) return 1; },  
 200908: () => { return document.getElementById('canvas').width; },  
 200960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 201028: () => { document.exitFullscreen(); },  
 201055: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 201113: () => { return screen.width; },  
 201138: () => { return screen.height; },  
 201164: () => { return window.screenX; },  
 201191: () => { return window.screenY; },  
 201218: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 201271: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 201342: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 201399: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 201655: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 201726: () => { if (document.fullscreenElement) return 1; },  
 201772: () => { return window.innerWidth; },  
 201798: () => { return window.innerHeight; },  
 201825: () => { if (document.pointerLockElement) return 1; }
};
