...
var ASM_CONSTS = {
 ...
 264086: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264154: () => { document.exitFullscreen(); },  
 264181: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264254: () => { if (document.fullscreenElement) return 1; },  
 264300: () => { return document.getElementById('canvas').width; },  
 264352: () => { return screen.width; },  
 264377: () => { document.exitFullscreen(); },  
 264404: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264537: () => { return window.innerWidth; },  
 264563: () => { return window.innerHeight; },  
 264590: () => { if (document.fullscreenElement) return 1; },  
 264636: () => { return document.getElementById('canvas').width; },  
 264688: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264879: () => { return window.innerWidth; },  
 264905: () => { return window.innerHeight; },  
 264932: () => { if (document.fullscreenElement) return 1; },  
 264978: () => { return document.getElementById('canvas').width; },  
 265030: () => { return screen.width; },  
 265055: () => { document.exitFullscreen(); },  
 ...
 265248: () => { document.exitFullscreen(); },  
 265275: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265333: () => { return screen.width; },  
 265358: () => { return screen.height; },  
 265384: () => { return window.screenX; },  
 265411: () => { return window.screenY; },  
 265438: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265491: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265562: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265619: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265875: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265946: () => { if (document.fullscreenElement) return 1; },  
 265992: () => { return window.innerWidth; },  
 266018: () => { return window.innerHeight; },  
 266045: () => { if (document.pointerLockElement) return 1; }
};
