...
var ASM_CONSTS = {
 ...
 264070: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264138: () => { document.exitFullscreen(); },  
 264165: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264238: () => { if (document.fullscreenElement) return 1; },  
 264284: () => { return document.getElementById('canvas').width; },  
 264336: () => { return screen.width; },  
 264361: () => { document.exitFullscreen(); },  
 264388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264521: () => { return window.innerWidth; },  
 264547: () => { return window.innerHeight; },  
 264574: () => { if (document.fullscreenElement) return 1; },  
 264620: () => { return document.getElementById('canvas').width; },  
 264672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264863: () => { return window.innerWidth; },  
 264889: () => { return window.innerHeight; },  
 ...
 265039: () => { document.exitFullscreen(); },  
 ...
 265232: () => { document.exitFullscreen(); },  
 265259: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265317: () => { return screen.width; },  
 265342: () => { return screen.height; },  
 265368: () => { return window.screenX; },  
 265395: () => { return window.screenY; },  
 265422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265475: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265546: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265859: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265930: () => { if (document.fullscreenElement) return 1; },  
 265976: () => { return window.innerWidth; },  
 266002: () => { return window.innerHeight; },  
 266029: () => { if (document.pointerLockElement) return 1; }
};
