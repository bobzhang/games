...
var ASM_CONSTS = {
  290740: () => { if (document.fullscreenElement) return 1; },  
 290786: () => { return document.getElementById('canvas').width; },  
 290838: () => { return parseInt(document.getElementById('canvas').style.width); },  
 290906: () => { document.exitFullscreen(); },  
 290933: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 291006: () => { if (document.fullscreenElement) return 1; },  
 291052: () => { return document.getElementById('canvas').width; },  
 291104: () => { return screen.width; },  
 291129: () => { document.exitFullscreen(); },  
 291156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 291289: () => { return window.innerWidth; },  
 291315: () => { return window.innerHeight; },  
 291342: () => { if (document.fullscreenElement) return 1; },  
 291388: () => { return document.getElementById('canvas').width; },  
 291440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 291508: () => { if (document.fullscreenElement) return 1; },  
 291554: () => { return document.getElementById('canvas').width; },  
 291606: () => { return screen.width; },  
 291631: () => { return window.innerWidth; },  
 291657: () => { return window.innerHeight; },  
 291684: () => { if (document.fullscreenElement) return 1; },  
 291730: () => { return document.getElementById('canvas').width; },  
 291782: () => { return screen.width; },  
 291807: () => { document.exitFullscreen(); },  
 291834: () => { if (document.fullscreenElement) return 1; },  
 291880: () => { return document.getElementById('canvas').width; },  
 291932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 292000: () => { document.exitFullscreen(); },  
 292027: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 292085: () => { return screen.width; },  
 292110: () => { return screen.height; },  
 292136: () => { return window.screenX; },  
 292163: () => { return window.screenY; },  
 292190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 292243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 292314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 292371: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 292627: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 292698: () => { if (document.fullscreenElement) return 1; },  
 292744: () => { return window.innerWidth; },  
 292770: () => { return window.innerHeight; },  
 292797: () => { if (document.pointerLockElement) return 1; }
};
