...
var ASM_CONSTS = {
  290516: () => { if (document.fullscreenElement) return 1; },  
 290562: () => { return document.getElementById('canvas').width; },  
 290614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 290682: () => { document.exitFullscreen(); },  
 290709: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 290782: () => { if (document.fullscreenElement) return 1; },  
 290828: () => { return document.getElementById('canvas').width; },  
 290880: () => { return screen.width; },  
 290905: () => { document.exitFullscreen(); },  
 290932: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 291065: () => { return window.innerWidth; },  
 291091: () => { return window.innerHeight; },  
 291118: () => { if (document.fullscreenElement) return 1; },  
 291164: () => { return document.getElementById('canvas').width; },  
 291216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 291284: () => { if (document.fullscreenElement) return 1; },  
 291330: () => { return document.getElementById('canvas').width; },  
 291382: () => { return screen.width; },  
 291407: () => { return window.innerWidth; },  
 291433: () => { return window.innerHeight; },  
 291460: () => { if (document.fullscreenElement) return 1; },  
 291506: () => { return document.getElementById('canvas').width; },  
 291558: () => { return screen.width; },  
 291583: () => { document.exitFullscreen(); },  
 291610: () => { if (document.fullscreenElement) return 1; },  
 291656: () => { return document.getElementById('canvas').width; },  
 291708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 291776: () => { document.exitFullscreen(); },  
 291803: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 291861: () => { return screen.width; },  
 291886: () => { return screen.height; },  
 291912: () => { return window.screenX; },  
 291939: () => { return window.screenY; },  
 291966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 292019: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 292090: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 292147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 292403: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 292474: () => { if (document.fullscreenElement) return 1; },  
 292520: () => { return window.innerWidth; },  
 292546: () => { return window.innerHeight; },  
 292573: () => { if (document.pointerLockElement) return 1; }
};
