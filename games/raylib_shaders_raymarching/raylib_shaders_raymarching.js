...
function findWasmBinary() {
  return locateFile('raylib_shaders_raymarching.wasm');
}
...
var ASM_CONSTS = {
  110288: () => { if (document.fullscreenElement) return 1; },  
 110334: () => { return document.getElementById('canvas').width; },  
 110386: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110454: () => { document.exitFullscreen(); },  
 110481: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 110554: () => { if (document.fullscreenElement) return 1; },  
 110600: () => { return document.getElementById('canvas').width; },  
 110652: () => { return screen.width; },  
 110677: () => { document.exitFullscreen(); },  
 110704: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 110837: () => { return window.innerWidth; },  
 110863: () => { return window.innerHeight; },  
 110890: () => { if (document.fullscreenElement) return 1; },  
 110936: () => { return document.getElementById('canvas').width; },  
 110988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111056: () => { if (document.fullscreenElement) return 1; },  
 111102: () => { return document.getElementById('canvas').width; },  
 111154: () => { return screen.width; },  
 111179: () => { return window.innerWidth; },  
 111205: () => { return window.innerHeight; },  
 111232: () => { if (document.fullscreenElement) return 1; },  
 111278: () => { return document.getElementById('canvas').width; },  
 111330: () => { return screen.width; },  
 111355: () => { document.exitFullscreen(); },  
 111382: () => { if (document.fullscreenElement) return 1; },  
 111428: () => { return document.getElementById('canvas').width; },  
 111480: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111548: () => { document.exitFullscreen(); },  
 111575: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 111633: () => { return screen.width; },  
 111658: () => { return screen.height; },  
 111684: () => { return window.screenX; },  
 111711: () => { return window.screenY; },  
 111738: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 111791: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111862: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111919: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 112175: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 112246: () => { if (document.fullscreenElement) return 1; },  
 112292: () => { return window.innerWidth; },  
 112318: () => { return window.innerHeight; },  
 112345: () => { if (document.pointerLockElement) return 1; }
};
