...
var ASM_CONSTS = {
  261748: () => { if (document.fullscreenElement) return 1; },  
 261794: () => { return document.getElementById('canvas').width; },  
 261846: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261914: () => { document.exitFullscreen(); },  
 261941: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262014: () => { if (document.fullscreenElement) return 1; },  
 262060: () => { return document.getElementById('canvas').width; },  
 262112: () => { return screen.width; },  
 262137: () => { document.exitFullscreen(); },  
 262164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262297: () => { return window.innerWidth; },  
 262323: () => { return window.innerHeight; },  
 262350: () => { if (document.fullscreenElement) return 1; },  
 262396: () => { return document.getElementById('canvas').width; },  
 262448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262639: () => { return window.innerWidth; },  
 262665: () => { return window.innerHeight; },  
 ...
 262815: () => { document.exitFullscreen(); },  
 262842: () => { if (document.fullscreenElement) return 1; },  
 262888: () => { return document.getElementById('canvas').width; },  
 262940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263008: () => { document.exitFullscreen(); },  
 263035: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263093: () => { return screen.width; },  
 263118: () => { return screen.height; },  
 263144: () => { return window.screenX; },  
 263171: () => { return window.screenY; },  
 263198: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263251: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263322: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263635: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263706: () => { if (document.fullscreenElement) return 1; },  
 263752: () => { return window.innerWidth; },  
 263778: () => { return window.innerHeight; },  
 263805: () => { if (document.pointerLockElement) return 1; }
};
