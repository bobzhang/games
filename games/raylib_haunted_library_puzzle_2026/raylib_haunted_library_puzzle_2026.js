...
var ASM_CONSTS = {
  107848: () => { if (document.fullscreenElement) return 1; },  
 107894: () => { return document.getElementById('canvas').width; },  
 107946: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108014: () => { document.exitFullscreen(); },  
 108041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108114: () => { if (document.fullscreenElement) return 1; },  
 108160: () => { return document.getElementById('canvas').width; },  
 108212: () => { return screen.width; },  
 108237: () => { document.exitFullscreen(); },  
 108264: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108397: () => { return window.innerWidth; },  
 108423: () => { return window.innerHeight; },  
 108450: () => { if (document.fullscreenElement) return 1; },  
 108496: () => { return document.getElementById('canvas').width; },  
 108548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 115836: ($0) => { miniaudio.untrack_device_by_index($0); },  
 115879: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 116004: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
