...
function findWasmBinary() {
  return locateFile('raylib_models_skybox.wasm');
}
...
var ASM_CONSTS = {
  122256: () => { if (document.fullscreenElement) return 1; },  
 122302: () => { return document.getElementById('canvas').width; },  
 122354: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122422: () => { document.exitFullscreen(); },  
 122449: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 122522: () => { if (document.fullscreenElement) return 1; },  
 122568: () => { return document.getElementById('canvas').width; },  
 122620: () => { return screen.width; },  
 122645: () => { document.exitFullscreen(); },  
 122672: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 122805: () => { return window.innerWidth; },  
 122831: () => { return window.innerHeight; },  
 122858: () => { if (document.fullscreenElement) return 1; },  
 122904: () => { return document.getElementById('canvas').width; },  
 122956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123024: () => { if (document.fullscreenElement) return 1; },  
 123070: () => { return document.getElementById('canvas').width; },  
 123122: () => { return screen.width; },  
 123147: () => { return window.innerWidth; },  
 123173: () => { return window.innerHeight; },  
 123200: () => { if (document.fullscreenElement) return 1; },  
 123246: () => { return document.getElementById('canvas').width; },  
 123298: () => { return screen.width; },  
 123323: () => { document.exitFullscreen(); },  
 123350: () => { if (document.fullscreenElement) return 1; },  
 123396: () => { return document.getElementById('canvas').width; },  
 123448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123516: () => { document.exitFullscreen(); },  
 123543: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 123601: () => { return screen.width; },  
 123626: () => { return screen.height; },  
 123652: () => { return window.screenX; },  
 123679: () => { return window.screenY; },  
 123706: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 123759: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 123830: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 123887: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 124143: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 124214: () => { if (document.fullscreenElement) return 1; },  
 124260: () => { return window.innerWidth; },  
 124286: () => { return window.innerHeight; },  
 124313: () => { if (document.pointerLockElement) return 1; }
};
