...
var ASM_CONSTS = {
 ...
 98146: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98214: () => { document.exitFullscreen(); },  
 98241: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98314: () => { if (document.fullscreenElement) return 1; },  
 98360: () => { return document.getElementById('canvas').width; },  
 98412: () => { return screen.width; },  
 98437: () => { document.exitFullscreen(); },  
 98464: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98597: () => { return window.innerWidth; },  
 98623: () => { return window.innerHeight; },  
 98650: () => { if (document.fullscreenElement) return 1; },  
 98696: () => { return document.getElementById('canvas').width; },  
 98748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98816: () => { if (document.fullscreenElement) return 1; },  
 98862: () => { return document.getElementById('canvas').width; },  
 98914: () => { return screen.width; },  
 98939: () => { return window.innerWidth; },  
 98965: () => { return window.innerHeight; },  
 98992: () => { if (document.fullscreenElement) return 1; },  
 99038: () => { return document.getElementById('canvas').width; },  
 99090: () => { return screen.width; },  
 99115: () => { document.exitFullscreen(); },  
 99142: () => { if (document.fullscreenElement) return 1; },  
 99188: () => { return document.getElementById('canvas').width; },  
 99240: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99308: () => { document.exitFullscreen(); },  
 99335: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99393: () => { return screen.width; },  
 99418: () => { return screen.height; },  
 99444: () => { return window.screenX; },  
 99471: () => { return window.screenY; },  
 99498: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99551: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99622: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99679: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99935: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100006: () => { if (document.fullscreenElement) return 1; },  
 100052: () => { return window.innerWidth; },  
 100078: () => { return window.innerHeight; },  
 100105: () => { if (document.pointerLockElement) return 1; }
};
