...
var ASM_CONSTS = {
  520228: () => { if (document.fullscreenElement) return 1; },  
 520274: () => { return document.getElementById('canvas').width; },  
 520326: () => { return parseInt(document.getElementById('canvas').style.width); },  
 520394: () => { document.exitFullscreen(); },  
 520421: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 520494: () => { if (document.fullscreenElement) return 1; },  
 520540: () => { return document.getElementById('canvas').width; },  
 520592: () => { return screen.width; },  
 520617: () => { document.exitFullscreen(); },  
 520644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 520777: () => { return window.innerWidth; },  
 520803: () => { return window.innerHeight; },  
 520830: () => { if (document.fullscreenElement) return 1; },  
 520876: () => { return document.getElementById('canvas').width; },  
 520928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 520996: () => { if (document.fullscreenElement) return 1; },  
 521042: () => { return document.getElementById('canvas').width; },  
 521094: () => { return screen.width; },  
 521119: () => { return window.innerWidth; },  
 521145: () => { return window.innerHeight; },  
 521172: () => { if (document.fullscreenElement) return 1; },  
 521218: () => { return document.getElementById('canvas').width; },  
 521270: () => { return screen.width; },  
 521295: () => { document.exitFullscreen(); },  
 521322: () => { if (document.fullscreenElement) return 1; },  
 521368: () => { return document.getElementById('canvas').width; },  
 521420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 521488: () => { document.exitFullscreen(); },  
 521515: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 521573: () => { return screen.width; },  
 521598: () => { return screen.height; },  
 521624: () => { return window.screenX; },  
 521651: () => { return window.screenY; },  
 521678: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 521731: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 521802: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 521859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 522115: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 522186: () => { if (document.fullscreenElement) return 1; },  
 522232: () => { return window.innerWidth; },  
 522258: () => { return window.innerHeight; },  
 522285: () => { if (document.pointerLockElement) return 1; }
};
