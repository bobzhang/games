...
var ASM_CONSTS = {
  520260: () => { if (document.fullscreenElement) return 1; },  
 520306: () => { return document.getElementById('canvas').width; },  
 520358: () => { return parseInt(document.getElementById('canvas').style.width); },  
 520426: () => { document.exitFullscreen(); },  
 520453: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 520526: () => { if (document.fullscreenElement) return 1; },  
 520572: () => { return document.getElementById('canvas').width; },  
 520624: () => { return screen.width; },  
 520649: () => { document.exitFullscreen(); },  
 520676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 520809: () => { return window.innerWidth; },  
 520835: () => { return window.innerHeight; },  
 520862: () => { if (document.fullscreenElement) return 1; },  
 520908: () => { return document.getElementById('canvas').width; },  
 520960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 521028: () => { if (document.fullscreenElement) return 1; },  
 521074: () => { return document.getElementById('canvas').width; },  
 521126: () => { return screen.width; },  
 521151: () => { return window.innerWidth; },  
 521177: () => { return window.innerHeight; },  
 521204: () => { if (document.fullscreenElement) return 1; },  
 521250: () => { return document.getElementById('canvas').width; },  
 521302: () => { return screen.width; },  
 521327: () => { document.exitFullscreen(); },  
 521354: () => { if (document.fullscreenElement) return 1; },  
 521400: () => { return document.getElementById('canvas').width; },  
 521452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 521520: () => { document.exitFullscreen(); },  
 521547: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 521605: () => { return screen.width; },  
 521630: () => { return screen.height; },  
 521656: () => { return window.screenX; },  
 521683: () => { return window.screenY; },  
 521710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 521763: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 521834: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 521891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 522147: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 522218: () => { if (document.fullscreenElement) return 1; },  
 522264: () => { return window.innerWidth; },  
 522290: () => { return window.innerHeight; },  
 522317: () => { if (document.pointerLockElement) return 1; }
};
