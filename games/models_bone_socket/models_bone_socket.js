...
var ASM_CONSTS = {
  520068: () => { if (document.fullscreenElement) return 1; },  
 520114: () => { return document.getElementById('canvas').width; },  
 520166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 520234: () => { document.exitFullscreen(); },  
 520261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 520334: () => { if (document.fullscreenElement) return 1; },  
 520380: () => { return document.getElementById('canvas').width; },  
 520432: () => { return screen.width; },  
 520457: () => { document.exitFullscreen(); },  
 520484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 520617: () => { return window.innerWidth; },  
 520643: () => { return window.innerHeight; },  
 520670: () => { if (document.fullscreenElement) return 1; },  
 520716: () => { return document.getElementById('canvas').width; },  
 520768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 520836: () => { if (document.fullscreenElement) return 1; },  
 520882: () => { return document.getElementById('canvas').width; },  
 520934: () => { return screen.width; },  
 520959: () => { return window.innerWidth; },  
 520985: () => { return window.innerHeight; },  
 521012: () => { if (document.fullscreenElement) return 1; },  
 521058: () => { return document.getElementById('canvas').width; },  
 521110: () => { return screen.width; },  
 521135: () => { document.exitFullscreen(); },  
 521162: () => { if (document.fullscreenElement) return 1; },  
 521208: () => { return document.getElementById('canvas').width; },  
 521260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 521328: () => { document.exitFullscreen(); },  
 521355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 521413: () => { return screen.width; },  
 521438: () => { return screen.height; },  
 521464: () => { return window.screenX; },  
 521491: () => { return window.screenY; },  
 521518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 521571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 521642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 521699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 521955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 522026: () => { if (document.fullscreenElement) return 1; },  
 522072: () => { return window.innerWidth; },  
 522098: () => { return window.innerHeight; },  
 522125: () => { if (document.pointerLockElement) return 1; }
};
