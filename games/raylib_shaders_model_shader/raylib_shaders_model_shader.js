...
function findWasmBinary() {
  return locateFile('raylib_shaders_model_shader.wasm');
}
...
var ASM_CONSTS = {
  109696: () => { if (document.fullscreenElement) return 1; },  
 109742: () => { return document.getElementById('canvas').width; },  
 109794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109862: () => { document.exitFullscreen(); },  
 109889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109962: () => { if (document.fullscreenElement) return 1; },  
 110008: () => { return document.getElementById('canvas').width; },  
 110060: () => { return screen.width; },  
 110085: () => { document.exitFullscreen(); },  
 110112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 110245: () => { return window.innerWidth; },  
 110271: () => { return window.innerHeight; },  
 110298: () => { if (document.fullscreenElement) return 1; },  
 110344: () => { return document.getElementById('canvas').width; },  
 110396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110464: () => { if (document.fullscreenElement) return 1; },  
 110510: () => { return document.getElementById('canvas').width; },  
 110562: () => { return screen.width; },  
 110587: () => { return window.innerWidth; },  
 110613: () => { return window.innerHeight; },  
 110640: () => { if (document.fullscreenElement) return 1; },  
 110686: () => { return document.getElementById('canvas').width; },  
 110738: () => { return screen.width; },  
 110763: () => { document.exitFullscreen(); },  
 110790: () => { if (document.fullscreenElement) return 1; },  
 110836: () => { return document.getElementById('canvas').width; },  
 110888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110956: () => { document.exitFullscreen(); },  
 110983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 111041: () => { return screen.width; },  
 111066: () => { return screen.height; },  
 111092: () => { return window.screenX; },  
 111119: () => { return window.screenY; },  
 111146: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 111199: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 111270: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 111327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 111583: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111654: () => { if (document.fullscreenElement) return 1; },  
 111700: () => { return window.innerWidth; },  
 111726: () => { return window.innerHeight; },  
 111753: () => { if (document.pointerLockElement) return 1; }
};
