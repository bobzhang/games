...
var ASM_CONSTS = {
 ...
 108214: () => { return document.getElementById('canvas').width; },  
 108266: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108334: () => { document.exitFullscreen(); },  
 108361: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108434: () => { if (document.fullscreenElement) return 1; },  
 108480: () => { return document.getElementById('canvas').width; },  
 108532: () => { return screen.width; },  
 108557: () => { document.exitFullscreen(); },  
 108584: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 108717: () => { return window.innerWidth; },  
 108743: () => { return window.innerHeight; },  
 108770: () => { if (document.fullscreenElement) return 1; },  
 108816: () => { return document.getElementById('canvas').width; },  
 108868: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108936: () => { if (document.fullscreenElement) return 1; },  
 108982: () => { return document.getElementById('canvas').width; },  
 109034: () => { return screen.width; },  
 109059: () => { return window.innerWidth; },  
 109085: () => { return window.innerHeight; },  
