...
var ASM_CONSTS = {
  362972: () => { if (document.fullscreenElement) return 1; },  
 363018: () => { return document.getElementById('canvas').width; },  
 363070: () => { return parseInt(document.getElementById('canvas').style.width); },  
 363138: () => { document.exitFullscreen(); },  
 363165: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 363238: () => { if (document.fullscreenElement) return 1; },  
 363284: () => { return document.getElementById('canvas').width; },  
 363336: () => { return screen.width; },  
 363361: () => { document.exitFullscreen(); },  
 363388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 363521: () => { return window.innerWidth; },  
 363547: () => { return window.innerHeight; },  
 363574: () => { if (document.fullscreenElement) return 1; },  
 363620: () => { return document.getElementById('canvas').width; },  
 363672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 363740: () => { if (document.fullscreenElement) return 1; },  
 363786: () => { return document.getElementById('canvas').width; },  
 363838: () => { return screen.width; },  
 363863: () => { return window.innerWidth; },  
 363889: () => { return window.innerHeight; },  
 363916: () => { if (document.fullscreenElement) return 1; },  
 363962: () => { return document.getElementById('canvas').width; },  
 364014: () => { return screen.width; },  
 364039: () => { document.exitFullscreen(); },  
 364066: () => { if (document.fullscreenElement) return 1; },  
 364112: () => { return document.getElementById('canvas').width; },  
 364164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 364232: () => { document.exitFullscreen(); },  
 364259: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 364317: () => { return screen.width; },  
 364342: () => { return screen.height; },  
 364368: () => { return window.screenX; },  
 364395: () => { return window.screenY; },  
 364422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 364475: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 364546: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 364603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 364859: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 364930: () => { if (document.fullscreenElement) return 1; },  
 364976: () => { return window.innerWidth; },  
 365002: () => { return window.innerHeight; },  
 365029: () => { if (document.pointerLockElement) return 1; }
};
