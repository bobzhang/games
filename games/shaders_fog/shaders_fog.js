...
var ASM_CONSTS = {
  363196: () => { if (document.fullscreenElement) return 1; },  
 363242: () => { return document.getElementById('canvas').width; },  
 363294: () => { return parseInt(document.getElementById('canvas').style.width); },  
 363362: () => { document.exitFullscreen(); },  
 363389: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 363462: () => { if (document.fullscreenElement) return 1; },  
 363508: () => { return document.getElementById('canvas').width; },  
 363560: () => { return screen.width; },  
 363585: () => { document.exitFullscreen(); },  
 363612: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 363745: () => { return window.innerWidth; },  
 363771: () => { return window.innerHeight; },  
 363798: () => { if (document.fullscreenElement) return 1; },  
 363844: () => { return document.getElementById('canvas').width; },  
 363896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 363964: () => { if (document.fullscreenElement) return 1; },  
 364010: () => { return document.getElementById('canvas').width; },  
 364062: () => { return screen.width; },  
 364087: () => { return window.innerWidth; },  
 364113: () => { return window.innerHeight; },  
 364140: () => { if (document.fullscreenElement) return 1; },  
 364186: () => { return document.getElementById('canvas').width; },  
 364238: () => { return screen.width; },  
 364263: () => { document.exitFullscreen(); },  
 364290: () => { if (document.fullscreenElement) return 1; },  
 364336: () => { return document.getElementById('canvas').width; },  
 364388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 364456: () => { document.exitFullscreen(); },  
 364483: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 364541: () => { return screen.width; },  
 364566: () => { return screen.height; },  
 364592: () => { return window.screenX; },  
 364619: () => { return window.screenY; },  
 364646: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 364699: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 364770: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 364827: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 365083: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 365154: () => { if (document.fullscreenElement) return 1; },  
 365200: () => { return window.innerWidth; },  
 365226: () => { return window.innerHeight; },  
 365253: () => { if (document.pointerLockElement) return 1; }
};
