...
function findWasmBinary() {
  return locateFile('raylib_textures_image_text.wasm');
}
...
var ASM_CONSTS = {
  489968: () => { if (document.fullscreenElement) return 1; },  
 490014: () => { return document.getElementById('canvas').width; },  
 490066: () => { return parseInt(document.getElementById('canvas').style.width); },  
 490134: () => { document.exitFullscreen(); },  
 490161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 490234: () => { if (document.fullscreenElement) return 1; },  
 490280: () => { return document.getElementById('canvas').width; },  
 490332: () => { return screen.width; },  
 490357: () => { document.exitFullscreen(); },  
 490384: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 490517: () => { return window.innerWidth; },  
 490543: () => { return window.innerHeight; },  
 490570: () => { if (document.fullscreenElement) return 1; },  
 490616: () => { return document.getElementById('canvas').width; },  
 490668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 490736: () => { if (document.fullscreenElement) return 1; },  
 490782: () => { return document.getElementById('canvas').width; },  
 490834: () => { return screen.width; },  
 490859: () => { return window.innerWidth; },  
 490885: () => { return window.innerHeight; },  
 490912: () => { if (document.fullscreenElement) return 1; },  
 490958: () => { return document.getElementById('canvas').width; },  
 491010: () => { return screen.width; },  
 491035: () => { document.exitFullscreen(); },  
 491062: () => { if (document.fullscreenElement) return 1; },  
 491108: () => { return document.getElementById('canvas').width; },  
 491160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 491228: () => { document.exitFullscreen(); },  
 491255: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 491313: () => { return screen.width; },  
 491338: () => { return screen.height; },  
 491364: () => { return window.screenX; },  
 491391: () => { return window.screenY; },  
 491418: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 491471: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 491542: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 491599: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 491855: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 491926: () => { if (document.fullscreenElement) return 1; },  
 491972: () => { return window.innerWidth; },  
 491998: () => { return window.innerHeight; },  
 492025: () => { if (document.pointerLockElement) return 1; }
};
