...
var ASM_CONSTS = {
  268076: () => { if (document.fullscreenElement) return 1; },  
 268122: () => { return document.getElementById('canvas').width; },  
 268174: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268242: () => { document.exitFullscreen(); },  
 268269: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268342: () => { if (document.fullscreenElement) return 1; },  
 268388: () => { return document.getElementById('canvas').width; },  
 268440: () => { return screen.width; },  
 268465: () => { document.exitFullscreen(); },  
 268492: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268625: () => { return window.innerWidth; },  
 268651: () => { return window.innerHeight; },  
 268678: () => { if (document.fullscreenElement) return 1; },  
 268724: () => { return document.getElementById('canvas').width; },  
 268776: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268844: () => { if (document.fullscreenElement) return 1; },  
 268890: () => { return document.getElementById('canvas').width; },  
 268942: () => { return screen.width; },  
 268967: () => { return window.innerWidth; },  
 268993: () => { return window.innerHeight; },  
 269020: () => { if (document.fullscreenElement) return 1; },  
 269066: () => { return document.getElementById('canvas').width; },  
 269118: () => { return screen.width; },  
 269143: () => { document.exitFullscreen(); },  
 269170: () => { if (document.fullscreenElement) return 1; },  
 269216: () => { return document.getElementById('canvas').width; },  
 269268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269336: () => { document.exitFullscreen(); },  
 269363: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269421: () => { return screen.width; },  
 269446: () => { return screen.height; },  
 269472: () => { return window.screenX; },  
 269499: () => { return window.screenY; },  
 269526: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269579: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269650: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269707: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269963: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270034: () => { if (document.fullscreenElement) return 1; },  
 270080: () => { return window.innerWidth; },  
 270106: () => { return window.innerHeight; },  
 270133: () => { if (document.pointerLockElement) return 1; },  
