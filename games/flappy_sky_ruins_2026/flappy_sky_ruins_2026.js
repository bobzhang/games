...
function findWasmBinary() {
  return locateFile('flappy_sky_ruins_2026.wasm');
}
...
var ASM_CONSTS = {
  268296: () => { if (document.fullscreenElement) return 1; },  
 268342: () => { return document.getElementById('canvas').width; },  
 268394: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268462: () => { document.exitFullscreen(); },  
 268489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268562: () => { if (document.fullscreenElement) return 1; },  
 268608: () => { return document.getElementById('canvas').width; },  
 268660: () => { return screen.width; },  
 268685: () => { document.exitFullscreen(); },  
 268712: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268845: () => { return window.innerWidth; },  
 268871: () => { return window.innerHeight; },  
 268898: () => { if (document.fullscreenElement) return 1; },  
 268944: () => { return document.getElementById('canvas').width; },  
 268996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269064: () => { if (document.fullscreenElement) return 1; },  
 269110: () => { return document.getElementById('canvas').width; },  
 269162: () => { return screen.width; },  
 269187: () => { return window.innerWidth; },  
 269213: () => { return window.innerHeight; },  
