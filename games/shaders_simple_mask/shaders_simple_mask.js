...
var ASM_CONSTS = {
  921556: () => { if (document.fullscreenElement) return 1; },  
 921602: () => { return document.getElementById('canvas').width; },  
 921654: () => { return parseInt(document.getElementById('canvas').style.width); },  
 921722: () => { document.exitFullscreen(); },  
 921749: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 921822: () => { if (document.fullscreenElement) return 1; },  
 921868: () => { return document.getElementById('canvas').width; },  
 921920: () => { return screen.width; },  
 921945: () => { document.exitFullscreen(); },  
 921972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 922105: () => { return window.innerWidth; },  
 922131: () => { return window.innerHeight; },  
 922158: () => { if (document.fullscreenElement) return 1; },  
 922204: () => { return document.getElementById('canvas').width; },  
 922256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 922324: () => { if (document.fullscreenElement) return 1; },  
 922370: () => { return document.getElementById('canvas').width; },  
 922422: () => { return screen.width; },  
 922447: () => { return window.innerWidth; },  
 922473: () => { return window.innerHeight; },  
 922500: () => { if (document.fullscreenElement) return 1; },  
 922546: () => { return document.getElementById('canvas').width; },  
 922598: () => { return screen.width; },  
 922623: () => { document.exitFullscreen(); },  
 922650: () => { if (document.fullscreenElement) return 1; },  
 922696: () => { return document.getElementById('canvas').width; },  
 922748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 922816: () => { document.exitFullscreen(); },  
 922843: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 922901: () => { return screen.width; },  
 922926: () => { return screen.height; },  
 922952: () => { return window.screenX; },  
 922979: () => { return window.screenY; },  
 923006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 923059: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 923130: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 923187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 923443: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 923514: () => { if (document.fullscreenElement) return 1; },  
 923560: () => { return window.innerWidth; },  
 923586: () => { return window.innerHeight; },  
 923613: () => { if (document.pointerLockElement) return 1; }
};
