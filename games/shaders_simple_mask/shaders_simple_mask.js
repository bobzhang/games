...
var ASM_CONSTS = {
  921748: () => { if (document.fullscreenElement) return 1; },  
 921794: () => { return document.getElementById('canvas').width; },  
 921846: () => { return parseInt(document.getElementById('canvas').style.width); },  
 921914: () => { document.exitFullscreen(); },  
 921941: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 922014: () => { if (document.fullscreenElement) return 1; },  
 922060: () => { return document.getElementById('canvas').width; },  
 922112: () => { return screen.width; },  
 922137: () => { document.exitFullscreen(); },  
 922164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 922297: () => { return window.innerWidth; },  
 922323: () => { return window.innerHeight; },  
 922350: () => { if (document.fullscreenElement) return 1; },  
 922396: () => { return document.getElementById('canvas').width; },  
 922448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 922516: () => { if (document.fullscreenElement) return 1; },  
 922562: () => { return document.getElementById('canvas').width; },  
 922614: () => { return screen.width; },  
 922639: () => { return window.innerWidth; },  
 922665: () => { return window.innerHeight; },  
 922692: () => { if (document.fullscreenElement) return 1; },  
 922738: () => { return document.getElementById('canvas').width; },  
 922790: () => { return screen.width; },  
 922815: () => { document.exitFullscreen(); },  
 922842: () => { if (document.fullscreenElement) return 1; },  
 922888: () => { return document.getElementById('canvas').width; },  
 922940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 923008: () => { document.exitFullscreen(); },  
 923035: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 923093: () => { return screen.width; },  
 923118: () => { return screen.height; },  
 923144: () => { return window.screenX; },  
 923171: () => { return window.screenY; },  
 923198: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 923251: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 923322: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 923379: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 923635: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 923706: () => { if (document.fullscreenElement) return 1; },  
 923752: () => { return window.innerWidth; },  
 923778: () => { return window.innerHeight; },  
 923805: () => { if (document.pointerLockElement) return 1; }
};
