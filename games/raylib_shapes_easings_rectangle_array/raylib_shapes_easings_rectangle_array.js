...
function findWasmBinary() {
  return locateFile('raylib_shapes_easings_rectangle_array.wasm');
}
...
var ASM_CONSTS = {
  96864: () => { if (document.fullscreenElement) return 1; },  
 96910: () => { return document.getElementById('canvas').width; },  
 96962: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97030: () => { document.exitFullscreen(); },  
 97057: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97130: () => { if (document.fullscreenElement) return 1; },  
 97176: () => { return document.getElementById('canvas').width; },  
 97228: () => { return screen.width; },  
 97253: () => { document.exitFullscreen(); },  
 97280: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97413: () => { return window.innerWidth; },  
 97439: () => { return window.innerHeight; },  
 97466: () => { if (document.fullscreenElement) return 1; },  
 97512: () => { return document.getElementById('canvas').width; },  
 97564: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97632: () => { if (document.fullscreenElement) return 1; },  
 97678: () => { return document.getElementById('canvas').width; },  
 97730: () => { return screen.width; },  
 97755: () => { return window.innerWidth; },  
 97781: () => { return window.innerHeight; },  
 97808: () => { if (document.fullscreenElement) return 1; },  
 97854: () => { return document.getElementById('canvas').width; },  
 97906: () => { return screen.width; },  
 97931: () => { document.exitFullscreen(); },  
 97958: () => { if (document.fullscreenElement) return 1; },  
 98004: () => { return document.getElementById('canvas').width; },  
 98056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98124: () => { document.exitFullscreen(); },  
 98151: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98209: () => { return screen.width; },  
 98234: () => { return screen.height; },  
 98260: () => { return window.screenX; },  
 98287: () => { return window.screenY; },  
 98314: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98367: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98438: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98495: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98751: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98822: () => { if (document.fullscreenElement) return 1; },  
 98868: () => { return window.innerWidth; },  
 98894: () => { return window.innerHeight; },  
 98921: () => { if (document.pointerLockElement) return 1; }
};
