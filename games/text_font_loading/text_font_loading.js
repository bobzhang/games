...
var ASM_CONSTS = {
  333024: () => { if (document.fullscreenElement) return 1; },  
 333070: () => { return document.getElementById('canvas').width; },  
 333122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333190: () => { document.exitFullscreen(); },  
 333217: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 333290: () => { if (document.fullscreenElement) return 1; },  
 333336: () => { return document.getElementById('canvas').width; },  
 333388: () => { return screen.width; },  
 333413: () => { document.exitFullscreen(); },  
 333440: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 333573: () => { return window.innerWidth; },  
 333599: () => { return window.innerHeight; },  
 333626: () => { if (document.fullscreenElement) return 1; },  
 333672: () => { return document.getElementById('canvas').width; },  
 333724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333792: () => { if (document.fullscreenElement) return 1; },  
 333838: () => { return document.getElementById('canvas').width; },  
 333890: () => { return screen.width; },  
 333915: () => { return window.innerWidth; },  
 333941: () => { return window.innerHeight; },  
 333968: () => { if (document.fullscreenElement) return 1; },  
 334014: () => { return document.getElementById('canvas').width; },  
 334066: () => { return screen.width; },  
 334091: () => { document.exitFullscreen(); },  
 334118: () => { if (document.fullscreenElement) return 1; },  
 334164: () => { return document.getElementById('canvas').width; },  
 334216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 334284: () => { document.exitFullscreen(); },  
 334311: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 334369: () => { return screen.width; },  
 334394: () => { return screen.height; },  
 334420: () => { return window.screenX; },  
 334447: () => { return window.screenY; },  
 334474: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 334527: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 334598: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 334655: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 334911: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 334982: () => { if (document.fullscreenElement) return 1; },  
 335028: () => { return window.innerWidth; },  
 335054: () => { return window.innerHeight; },  
 335081: () => { if (document.pointerLockElement) return 1; }
};
