...
var ASM_CONSTS = {
  333012: () => { if (document.fullscreenElement) return 1; },  
 333058: () => { return document.getElementById('canvas').width; },  
 333110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333178: () => { document.exitFullscreen(); },  
 333205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 333278: () => { if (document.fullscreenElement) return 1; },  
 333324: () => { return document.getElementById('canvas').width; },  
 333376: () => { return screen.width; },  
 333401: () => { document.exitFullscreen(); },  
 333428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 333561: () => { return window.innerWidth; },  
 333587: () => { return window.innerHeight; },  
 333614: () => { if (document.fullscreenElement) return 1; },  
 333660: () => { return document.getElementById('canvas').width; },  
 333712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333780: () => { if (document.fullscreenElement) return 1; },  
 333826: () => { return document.getElementById('canvas').width; },  
 333878: () => { return screen.width; },  
 333903: () => { return window.innerWidth; },  
 333929: () => { return window.innerHeight; },  
 333956: () => { if (document.fullscreenElement) return 1; },  
 334002: () => { return document.getElementById('canvas').width; },  
 334054: () => { return screen.width; },  
 334079: () => { document.exitFullscreen(); },  
 334106: () => { if (document.fullscreenElement) return 1; },  
 334152: () => { return document.getElementById('canvas').width; },  
 334204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 334272: () => { document.exitFullscreen(); },  
 334299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 334357: () => { return screen.width; },  
 334382: () => { return screen.height; },  
 334408: () => { return window.screenX; },  
 334435: () => { return window.screenY; },  
 334462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 334515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 334586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 334643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 334899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 334970: () => { if (document.fullscreenElement) return 1; },  
 335016: () => { return window.innerWidth; },  
 335042: () => { return window.innerHeight; },  
 335069: () => { if (document.pointerLockElement) return 1; }
};
