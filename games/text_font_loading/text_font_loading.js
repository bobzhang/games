...
var ASM_CONSTS = {
  333028: () => { if (document.fullscreenElement) return 1; },  
 333074: () => { return document.getElementById('canvas').width; },  
 333126: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333194: () => { document.exitFullscreen(); },  
 333221: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 333294: () => { if (document.fullscreenElement) return 1; },  
 333340: () => { return document.getElementById('canvas').width; },  
 333392: () => { return screen.width; },  
 333417: () => { document.exitFullscreen(); },  
 333444: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 333577: () => { return window.innerWidth; },  
 333603: () => { return window.innerHeight; },  
 333630: () => { if (document.fullscreenElement) return 1; },  
 333676: () => { return document.getElementById('canvas').width; },  
 333728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333796: () => { if (document.fullscreenElement) return 1; },  
 333842: () => { return document.getElementById('canvas').width; },  
 333894: () => { return screen.width; },  
 333919: () => { return window.innerWidth; },  
 333945: () => { return window.innerHeight; },  
 333972: () => { if (document.fullscreenElement) return 1; },  
 334018: () => { return document.getElementById('canvas').width; },  
 334070: () => { return screen.width; },  
 334095: () => { document.exitFullscreen(); },  
 334122: () => { if (document.fullscreenElement) return 1; },  
 334168: () => { return document.getElementById('canvas').width; },  
 334220: () => { return parseInt(document.getElementById('canvas').style.width); },  
 334288: () => { document.exitFullscreen(); },  
 334315: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 334373: () => { return screen.width; },  
 334398: () => { return screen.height; },  
 334424: () => { return window.screenX; },  
 334451: () => { return window.screenY; },  
 334478: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 334531: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 334602: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 334659: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 334915: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 334986: () => { if (document.fullscreenElement) return 1; },  
 335032: () => { return window.innerWidth; },  
 335058: () => { return window.innerHeight; },  
 335085: () => { if (document.pointerLockElement) return 1; }
};
