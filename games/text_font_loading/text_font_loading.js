...
var ASM_CONSTS = {
  332804: () => { if (document.fullscreenElement) return 1; },  
 332850: () => { return document.getElementById('canvas').width; },  
 332902: () => { return parseInt(document.getElementById('canvas').style.width); },  
 332970: () => { document.exitFullscreen(); },  
 332997: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 333070: () => { if (document.fullscreenElement) return 1; },  
 333116: () => { return document.getElementById('canvas').width; },  
 333168: () => { return screen.width; },  
 333193: () => { document.exitFullscreen(); },  
 333220: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 333353: () => { return window.innerWidth; },  
 333379: () => { return window.innerHeight; },  
 333406: () => { if (document.fullscreenElement) return 1; },  
 333452: () => { return document.getElementById('canvas').width; },  
 333504: () => { return parseInt(document.getElementById('canvas').style.width); },  
 333572: () => { if (document.fullscreenElement) return 1; },  
 333618: () => { return document.getElementById('canvas').width; },  
 333670: () => { return screen.width; },  
 333695: () => { return window.innerWidth; },  
 333721: () => { return window.innerHeight; },  
 333748: () => { if (document.fullscreenElement) return 1; },  
 333794: () => { return document.getElementById('canvas').width; },  
 333846: () => { return screen.width; },  
 333871: () => { document.exitFullscreen(); },  
 333898: () => { if (document.fullscreenElement) return 1; },  
 333944: () => { return document.getElementById('canvas').width; },  
 333996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 334064: () => { document.exitFullscreen(); },  
 334091: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 334149: () => { return screen.width; },  
 334174: () => { return screen.height; },  
 334200: () => { return window.screenX; },  
 334227: () => { return window.screenY; },  
 334254: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 334307: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 334378: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 334435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 334691: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 334762: () => { if (document.fullscreenElement) return 1; },  
 334808: () => { return window.innerWidth; },  
 334834: () => { return window.innerHeight; },  
 334861: () => { if (document.pointerLockElement) return 1; }
};
