...
var ASM_CONSTS = {
  260516: () => { if (document.fullscreenElement) return 1; },  
 260562: () => { return document.getElementById('canvas').width; },  
 260614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260682: () => { document.exitFullscreen(); },  
 260709: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260782: () => { if (document.fullscreenElement) return 1; },  
 260828: () => { return document.getElementById('canvas').width; },  
 260880: () => { return screen.width; },  
 260905: () => { document.exitFullscreen(); },  
 260932: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261065: () => { return window.innerWidth; },  
 261091: () => { return window.innerHeight; },  
 261118: () => { if (document.fullscreenElement) return 1; },  
 261164: () => { return document.getElementById('canvas').width; },  
 261216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261284: () => { if (document.fullscreenElement) return 1; },  
 261330: () => { return document.getElementById('canvas').width; },  
 261382: () => { return screen.width; },  
 261407: () => { return window.innerWidth; },  
 261433: () => { return window.innerHeight; },  
 ...
 261583: () => { document.exitFullscreen(); },  
 ...
 261776: () => { document.exitFullscreen(); },  
 261803: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261861: () => { return screen.width; },  
 261886: () => { return screen.height; },  
 261912: () => { return window.screenX; },  
 261939: () => { return window.screenY; },  
 261966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262019: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262090: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262403: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262474: () => { if (document.fullscreenElement) return 1; },  
 262520: () => { return window.innerWidth; },  
 262546: () => { return window.innerHeight; },  
 262573: () => { if (document.pointerLockElement) return 1; }
};
