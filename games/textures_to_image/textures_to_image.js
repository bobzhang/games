...
var ASM_CONSTS = {
  268292: () => { if (document.fullscreenElement) return 1; },  
 268338: () => { return document.getElementById('canvas').width; },  
 268390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268458: () => { document.exitFullscreen(); },  
 268485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268558: () => { if (document.fullscreenElement) return 1; },  
 268604: () => { return document.getElementById('canvas').width; },  
 268656: () => { return screen.width; },  
 268681: () => { document.exitFullscreen(); },  
 268708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268841: () => { return window.innerWidth; },  
 268867: () => { return window.innerHeight; },  
 268894: () => { if (document.fullscreenElement) return 1; },  
 268940: () => { return document.getElementById('canvas').width; },  
 268992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 269183: () => { return window.innerWidth; },  
 269209: () => { return window.innerHeight; },  
 269236: () => { if (document.fullscreenElement) return 1; },  
 269282: () => { return document.getElementById('canvas').width; },  
 269334: () => { return screen.width; },  
 269359: () => { document.exitFullscreen(); },  
 269386: () => { if (document.fullscreenElement) return 1; },  
 269432: () => { return document.getElementById('canvas').width; },  
 269484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269552: () => { document.exitFullscreen(); },  
 269579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269637: () => { return screen.width; },  
 269662: () => { return screen.height; },  
 269688: () => { return window.screenX; },  
 269715: () => { return window.screenY; },  
 269742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270250: () => { if (document.fullscreenElement) return 1; },  
 270296: () => { return window.innerWidth; },  
 270322: () => { return window.innerHeight; },  
 270349: () => { if (document.pointerLockElement) return 1; }
};
