...
var ASM_CONSTS = {
  309764: () => { if (document.fullscreenElement) return 1; },  
 309810: () => { return document.getElementById('canvas').width; },  
 309862: () => { return parseInt(document.getElementById('canvas').style.width); },  
 309930: () => { document.exitFullscreen(); },  
 309957: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 310030: () => { if (document.fullscreenElement) return 1; },  
 310076: () => { return document.getElementById('canvas').width; },  
 310128: () => { return screen.width; },  
 310153: () => { document.exitFullscreen(); },  
 310180: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 310313: () => { return window.innerWidth; },  
 310339: () => { return window.innerHeight; },  
 310366: () => { if (document.fullscreenElement) return 1; },  
 310412: () => { return document.getElementById('canvas').width; },  
 310464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310532: () => { if (document.fullscreenElement) return 1; },  
 310578: () => { return document.getElementById('canvas').width; },  
 310630: () => { return screen.width; },  
 310655: () => { return window.innerWidth; },  
 310681: () => { return window.innerHeight; },  
 310708: () => { if (document.fullscreenElement) return 1; },  
 310754: () => { return document.getElementById('canvas').width; },  
 310806: () => { return screen.width; },  
 310831: () => { document.exitFullscreen(); },  
 310858: () => { if (document.fullscreenElement) return 1; },  
 310904: () => { return document.getElementById('canvas').width; },  
 310956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 311024: () => { document.exitFullscreen(); },  
 311051: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 311109: () => { return screen.width; },  
 311134: () => { return screen.height; },  
 311160: () => { return window.screenX; },  
 311187: () => { return window.screenY; },  
 311214: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 311267: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 311338: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 311395: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 311651: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 311722: () => { if (document.fullscreenElement) return 1; },  
 311768: () => { return window.innerWidth; },  
 311794: () => { return window.innerHeight; },  
 311821: () => { if (document.pointerLockElement) return 1; }
};
