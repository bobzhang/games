...
var ASM_CONSTS = {
  309780: () => { if (document.fullscreenElement) return 1; },  
 309826: () => { return document.getElementById('canvas').width; },  
 309878: () => { return parseInt(document.getElementById('canvas').style.width); },  
 309946: () => { document.exitFullscreen(); },  
 309973: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 310046: () => { if (document.fullscreenElement) return 1; },  
 310092: () => { return document.getElementById('canvas').width; },  
 310144: () => { return screen.width; },  
 310169: () => { document.exitFullscreen(); },  
 310196: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 310329: () => { return window.innerWidth; },  
 310355: () => { return window.innerHeight; },  
 310382: () => { if (document.fullscreenElement) return 1; },  
 310428: () => { return document.getElementById('canvas').width; },  
 310480: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310548: () => { if (document.fullscreenElement) return 1; },  
 310594: () => { return document.getElementById('canvas').width; },  
 310646: () => { return screen.width; },  
 310671: () => { return window.innerWidth; },  
 310697: () => { return window.innerHeight; },  
 310724: () => { if (document.fullscreenElement) return 1; },  
 310770: () => { return document.getElementById('canvas').width; },  
 310822: () => { return screen.width; },  
 310847: () => { document.exitFullscreen(); },  
 310874: () => { if (document.fullscreenElement) return 1; },  
 310920: () => { return document.getElementById('canvas').width; },  
 310972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 311040: () => { document.exitFullscreen(); },  
 311067: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 311125: () => { return screen.width; },  
 311150: () => { return screen.height; },  
 311176: () => { return window.screenX; },  
 311203: () => { return window.screenY; },  
 311230: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 311283: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 311354: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 311411: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 311667: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 311738: () => { if (document.fullscreenElement) return 1; },  
 311784: () => { return window.innerWidth; },  
 311810: () => { return window.innerHeight; },  
 311837: () => { if (document.pointerLockElement) return 1; }
};
