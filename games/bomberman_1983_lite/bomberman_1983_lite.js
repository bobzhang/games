...
var ASM_CONSTS = {
  309572: () => { if (document.fullscreenElement) return 1; },  
 309618: () => { return document.getElementById('canvas').width; },  
 309670: () => { return parseInt(document.getElementById('canvas').style.width); },  
 309738: () => { document.exitFullscreen(); },  
 309765: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 309838: () => { if (document.fullscreenElement) return 1; },  
 309884: () => { return document.getElementById('canvas').width; },  
 309936: () => { return screen.width; },  
 309961: () => { document.exitFullscreen(); },  
 309988: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 310121: () => { return window.innerWidth; },  
 310147: () => { return window.innerHeight; },  
 310174: () => { if (document.fullscreenElement) return 1; },  
 310220: () => { return document.getElementById('canvas').width; },  
 310272: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310340: () => { if (document.fullscreenElement) return 1; },  
 310386: () => { return document.getElementById('canvas').width; },  
 310438: () => { return screen.width; },  
 310463: () => { return window.innerWidth; },  
 310489: () => { return window.innerHeight; },  
 310516: () => { if (document.fullscreenElement) return 1; },  
 310562: () => { return document.getElementById('canvas').width; },  
 310614: () => { return screen.width; },  
 310639: () => { document.exitFullscreen(); },  
 310666: () => { if (document.fullscreenElement) return 1; },  
 310712: () => { return document.getElementById('canvas').width; },  
 310764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310832: () => { document.exitFullscreen(); },  
 310859: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 310917: () => { return screen.width; },  
 310942: () => { return screen.height; },  
 310968: () => { return window.screenX; },  
 310995: () => { return window.screenY; },  
 311022: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 311075: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 311146: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 311203: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 311459: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 311530: () => { if (document.fullscreenElement) return 1; },  
 311576: () => { return window.innerWidth; },  
 311602: () => { return window.innerHeight; },  
 311629: () => { if (document.pointerLockElement) return 1; }
};
