...
function findWasmBinary() {
  return locateFile('raylib_shaders_color_correction.wasm');
}
...
var ASM_CONSTS = {
  1206736: () => { if (document.fullscreenElement) return 1; },  
 1206782: () => { return document.getElementById('canvas').width; },  
 1206834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1206902: () => { document.exitFullscreen(); },  
 1206929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1207002: () => { if (document.fullscreenElement) return 1; },  
 1207048: () => { return document.getElementById('canvas').width; },  
 1207100: () => { return screen.width; },  
 1207125: () => { document.exitFullscreen(); },  
 1207152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1207285: () => { return window.innerWidth; },  
 1207311: () => { return window.innerHeight; },  
 1207338: () => { if (document.fullscreenElement) return 1; },  
 1207384: () => { return document.getElementById('canvas').width; },  
 1207436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1207504: () => { if (document.fullscreenElement) return 1; },  
 1207550: () => { return document.getElementById('canvas').width; },  
 1207602: () => { return screen.width; },  
 1207627: () => { return window.innerWidth; },  
 1207653: () => { return window.innerHeight; },  
 1207680: () => { if (document.fullscreenElement) return 1; },  
 1207726: () => { return document.getElementById('canvas').width; },  
 1207778: () => { return screen.width; },  
 1207803: () => { document.exitFullscreen(); },  
 1207830: () => { if (document.fullscreenElement) return 1; },  
 1207876: () => { return document.getElementById('canvas').width; },  
 1207928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1207996: () => { document.exitFullscreen(); },  
 1208023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1208081: () => { return screen.width; },  
 1208106: () => { return screen.height; },  
 1208132: () => { return window.screenX; },  
 1208159: () => { return window.screenY; },  
 1208186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1208239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1208310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1208367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1208623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1208694: () => { if (document.fullscreenElement) return 1; },  
 1208740: () => { return window.innerWidth; },  
 1208766: () => { return window.innerHeight; },  
 1208793: () => { if (document.pointerLockElement) return 1; }
};
