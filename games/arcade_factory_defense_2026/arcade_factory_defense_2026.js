...
var ASM_CONSTS = {
  262676: () => { if (document.fullscreenElement) return 1; },  
 262722: () => { return document.getElementById('canvas').width; },  
 262774: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262842: () => { document.exitFullscreen(); },  
 262869: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262942: () => { if (document.fullscreenElement) return 1; },  
 262988: () => { return document.getElementById('canvas').width; },  
 263040: () => { return screen.width; },  
 263065: () => { document.exitFullscreen(); },  
 263092: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263225: () => { return window.innerWidth; },  
 263251: () => { return window.innerHeight; },  
 263278: () => { if (document.fullscreenElement) return 1; },  
 263324: () => { return document.getElementById('canvas').width; },  
 263376: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263444: () => { if (document.fullscreenElement) return 1; },  
 263490: () => { return document.getElementById('canvas').width; },  
 263542: () => { return screen.width; },  
 263567: () => { return window.innerWidth; },  
 263593: () => { return window.innerHeight; },  
 ...
 263743: () => { document.exitFullscreen(); },  
 263770: () => { if (document.fullscreenElement) return 1; },  
 263816: () => { return document.getElementById('canvas').width; },  
 263868: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263936: () => { document.exitFullscreen(); },  
 263963: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264021: () => { return screen.width; },  
 264046: () => { return screen.height; },  
 264072: () => { return window.screenX; },  
 264099: () => { return window.screenY; },  
 264126: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264179: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264250: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264307: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264563: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264634: () => { if (document.fullscreenElement) return 1; },  
 264680: () => { return window.innerWidth; },  
 264706: () => { return window.innerHeight; },  
 264733: () => { if (document.pointerLockElement) return 1; }
};
