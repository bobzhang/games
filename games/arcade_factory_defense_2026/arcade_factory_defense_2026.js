...
var ASM_CONSTS = {
  262900: () => { if (document.fullscreenElement) return 1; },  
 262946: () => { return document.getElementById('canvas').width; },  
 262998: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263066: () => { document.exitFullscreen(); },  
 263093: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263166: () => { if (document.fullscreenElement) return 1; },  
 263212: () => { return document.getElementById('canvas').width; },  
 263264: () => { return screen.width; },  
 263289: () => { document.exitFullscreen(); },  
 263316: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263449: () => { return window.innerWidth; },  
 263475: () => { return window.innerHeight; },  
 263502: () => { if (document.fullscreenElement) return 1; },  
 263548: () => { return document.getElementById('canvas').width; },  
 263600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263668: () => { if (document.fullscreenElement) return 1; },  
 263714: () => { return document.getElementById('canvas').width; },  
 263766: () => { return screen.width; },  
 263791: () => { return window.innerWidth; },  
 263817: () => { return window.innerHeight; },  
 263844: () => { if (document.fullscreenElement) return 1; },  
 263890: () => { return document.getElementById('canvas').width; },  
 263942: () => { return screen.width; },  
 263967: () => { document.exitFullscreen(); },  
 263994: () => { if (document.fullscreenElement) return 1; },  
 264040: () => { return document.getElementById('canvas').width; },  
 264092: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264160: () => { document.exitFullscreen(); },  
 264187: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264245: () => { return screen.width; },  
 264270: () => { return screen.height; },  
 264296: () => { return window.screenX; },  
 264323: () => { return window.screenY; },  
 264350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264403: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264474: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264531: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264787: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264858: () => { if (document.fullscreenElement) return 1; },  
 264904: () => { return window.innerWidth; },  
 264930: () => { return window.innerHeight; },  
 264957: () => { if (document.pointerLockElement) return 1; }
};
