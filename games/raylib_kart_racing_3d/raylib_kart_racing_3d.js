...
function findWasmBinary() {
  return locateFile('raylib_kart_racing_3d.wasm');
}
...
var ASM_CONSTS = {
  103520: () => { if (document.fullscreenElement) return 1; },  
 103566: () => { return document.getElementById('canvas').width; },  
 103618: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103686: () => { document.exitFullscreen(); },  
 103713: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103786: () => { if (document.fullscreenElement) return 1; },  
 103832: () => { return document.getElementById('canvas').width; },  
 103884: () => { return screen.width; },  
 103909: () => { document.exitFullscreen(); },  
 103936: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104069: () => { return window.innerWidth; },  
 104095: () => { return window.innerHeight; },  
 104122: () => { if (document.fullscreenElement) return 1; },  
 104168: () => { return document.getElementById('canvas').width; },  
 104220: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104288: () => { if (document.fullscreenElement) return 1; },  
 104334: () => { return document.getElementById('canvas').width; },  
 104386: () => { return screen.width; },  
 104411: () => { return window.innerWidth; },  
 104437: () => { return window.innerHeight; },  
 ...
 104587: () => { document.exitFullscreen(); },  
 104614: () => { if (document.fullscreenElement) return 1; },  
 104660: () => { return document.getElementById('canvas').width; },  
 104712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104780: () => { document.exitFullscreen(); },  
 104807: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104865: () => { return screen.width; },  
 104890: () => { return screen.height; },  
 104916: () => { return window.screenX; },  
 104943: () => { return window.screenY; },  
 104970: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105023: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105094: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105151: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105407: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105478: () => { if (document.fullscreenElement) return 1; },  
 105524: () => { return window.innerWidth; },  
 105550: () => { return window.innerHeight; },  
 105577: () => { if (document.pointerLockElement) return 1; }
};
