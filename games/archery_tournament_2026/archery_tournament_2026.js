...
var ASM_CONSTS = {
 ...
 261526: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261594: () => { document.exitFullscreen(); },  
 261621: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261694: () => { if (document.fullscreenElement) return 1; },  
 261740: () => { return document.getElementById('canvas').width; },  
 261792: () => { return screen.width; },  
 261817: () => { document.exitFullscreen(); },  
 261844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261977: () => { return window.innerWidth; },  
 262003: () => { return window.innerHeight; },  
 262030: () => { if (document.fullscreenElement) return 1; },  
 262076: () => { return document.getElementById('canvas').width; },  
 262128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262319: () => { return window.innerWidth; },  
 262345: () => { return window.innerHeight; },  
 ...
 262495: () => { document.exitFullscreen(); },  
 ...
 262688: () => { document.exitFullscreen(); },  
 262715: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262773: () => { return screen.width; },  
 262798: () => { return screen.height; },  
 262824: () => { return window.screenX; },  
 262851: () => { return window.screenY; },  
 262878: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262931: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263002: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263059: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263315: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263386: () => { if (document.fullscreenElement) return 1; },  
 263432: () => { return window.innerWidth; },  
 263458: () => { return window.innerHeight; },  
 263485: () => { if (document.pointerLockElement) return 1; }
};
