...
var ASM_CONSTS = {
  261204: () => { if (document.fullscreenElement) return 1; },  
 261250: () => { return document.getElementById('canvas').width; },  
 261302: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261370: () => { document.exitFullscreen(); },  
 261397: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261470: () => { if (document.fullscreenElement) return 1; },  
 261516: () => { return document.getElementById('canvas').width; },  
 261568: () => { return screen.width; },  
 261593: () => { document.exitFullscreen(); },  
 261620: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261753: () => { return window.innerWidth; },  
 261779: () => { return window.innerHeight; },  
 261806: () => { if (document.fullscreenElement) return 1; },  
 261852: () => { return document.getElementById('canvas').width; },  
 261904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261972: () => { if (document.fullscreenElement) return 1; },  
 262018: () => { return document.getElementById('canvas').width; },  
 262070: () => { return screen.width; },  
 262095: () => { return window.innerWidth; },  
 262121: () => { return window.innerHeight; },  
 262148: () => { if (document.fullscreenElement) return 1; },  
 262194: () => { return document.getElementById('canvas').width; },  
 262246: () => { return screen.width; },  
 262271: () => { document.exitFullscreen(); },  
 ...
 262464: () => { document.exitFullscreen(); },  
 262491: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262549: () => { return screen.width; },  
 262574: () => { return screen.height; },  
 262600: () => { return window.screenX; },  
 262627: () => { return window.screenY; },  
 262654: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262707: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262778: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262835: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263091: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263162: () => { if (document.fullscreenElement) return 1; },  
 263208: () => { return window.innerWidth; },  
 263234: () => { return window.innerHeight; },  
 263261: () => { if (document.pointerLockElement) return 1; }
};
