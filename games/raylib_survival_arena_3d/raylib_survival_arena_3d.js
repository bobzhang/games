...
function findWasmBinary() {
  return locateFile('raylib_survival_arena_3d.wasm');
}
...
var ASM_CONSTS = {
  101232: () => { if (document.fullscreenElement) return 1; },  
 101278: () => { return document.getElementById('canvas').width; },  
 101330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101398: () => { document.exitFullscreen(); },  
 101425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101498: () => { if (document.fullscreenElement) return 1; },  
 101544: () => { return document.getElementById('canvas').width; },  
 101596: () => { return screen.width; },  
 101621: () => { document.exitFullscreen(); },  
 101648: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101781: () => { return window.innerWidth; },  
 101807: () => { return window.innerHeight; },  
 101834: () => { if (document.fullscreenElement) return 1; },  
 101880: () => { return document.getElementById('canvas').width; },  
 101932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 102299: () => { document.exitFullscreen(); },  
 102326: () => { if (document.fullscreenElement) return 1; },  
 102372: () => { return document.getElementById('canvas').width; },  
 102424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102492: () => { document.exitFullscreen(); },  
 102519: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102577: () => { return screen.width; },  
 102602: () => { return screen.height; },  
 102628: () => { return window.screenX; },  
 102655: () => { return window.screenY; },  
 102682: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102735: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102806: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102863: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103119: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103190: () => { if (document.fullscreenElement) return 1; },  
 103236: () => { return window.innerWidth; },  
 103262: () => { return window.innerHeight; },  
 103289: () => { if (document.pointerLockElement) return 1; }
};
