...
var ASM_CONSTS = {
  269388: () => { if (document.fullscreenElement) return 1; },  
 269434: () => { return document.getElementById('canvas').width; },  
 269486: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269554: () => { document.exitFullscreen(); },  
 269581: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269654: () => { if (document.fullscreenElement) return 1; },  
 269700: () => { return document.getElementById('canvas').width; },  
 269752: () => { return screen.width; },  
 269777: () => { document.exitFullscreen(); },  
 269804: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269937: () => { return window.innerWidth; },  
 269963: () => { return window.innerHeight; },  
 269990: () => { if (document.fullscreenElement) return 1; },  
 270036: () => { return document.getElementById('canvas').width; },  
 270088: () => { return parseInt(document.getElementById('canvas').style.width); },  
