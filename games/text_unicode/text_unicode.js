...
var ASM_CONSTS = {
  931492: () => { if (document.fullscreenElement) return 1; },  
 931538: () => { return document.getElementById('canvas').width; },  
 931590: () => { return parseInt(document.getElementById('canvas').style.width); },  
 931658: () => { document.exitFullscreen(); },  
 931685: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 931758: () => { if (document.fullscreenElement) return 1; },  
 931804: () => { return document.getElementById('canvas').width; },  
 931856: () => { return screen.width; },  
 931881: () => { document.exitFullscreen(); },  
 931908: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 932041: () => { return window.innerWidth; },  
 932067: () => { return window.innerHeight; },  
 932094: () => { if (document.fullscreenElement) return 1; },  
 932140: () => { return document.getElementById('canvas').width; },  
 932192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932260: () => { if (document.fullscreenElement) return 1; },  
 932306: () => { return document.getElementById('canvas').width; },  
 932358: () => { return screen.width; },  
 932383: () => { return window.innerWidth; },  
 932409: () => { return window.innerHeight; },  
 932436: () => { if (document.fullscreenElement) return 1; },  
 932482: () => { return document.getElementById('canvas').width; },  
 932534: () => { return screen.width; },  
 932559: () => { document.exitFullscreen(); },  
 932586: () => { if (document.fullscreenElement) return 1; },  
 932632: () => { return document.getElementById('canvas').width; },  
 932684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932752: () => { document.exitFullscreen(); },  
 932779: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 932837: () => { return screen.width; },  
 932862: () => { return screen.height; },  
 932888: () => { return window.screenX; },  
 932915: () => { return window.screenY; },  
 932942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 932995: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 933066: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 933123: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 933379: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 933450: () => { if (document.fullscreenElement) return 1; },  
 933496: () => { return window.innerWidth; },  
 933522: () => { return window.innerHeight; },  
 933549: () => { if (document.pointerLockElement) return 1; }
};
