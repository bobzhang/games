...
var ASM_CONSTS = {
  931684: () => { if (document.fullscreenElement) return 1; },  
 931730: () => { return document.getElementById('canvas').width; },  
 931782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 931850: () => { document.exitFullscreen(); },  
 931877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 931950: () => { if (document.fullscreenElement) return 1; },  
 931996: () => { return document.getElementById('canvas').width; },  
 932048: () => { return screen.width; },  
 932073: () => { document.exitFullscreen(); },  
 932100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 932233: () => { return window.innerWidth; },  
 932259: () => { return window.innerHeight; },  
 932286: () => { if (document.fullscreenElement) return 1; },  
 932332: () => { return document.getElementById('canvas').width; },  
 932384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932452: () => { if (document.fullscreenElement) return 1; },  
 932498: () => { return document.getElementById('canvas').width; },  
 932550: () => { return screen.width; },  
 932575: () => { return window.innerWidth; },  
 932601: () => { return window.innerHeight; },  
 932628: () => { if (document.fullscreenElement) return 1; },  
 932674: () => { return document.getElementById('canvas').width; },  
 932726: () => { return screen.width; },  
 932751: () => { document.exitFullscreen(); },  
 932778: () => { if (document.fullscreenElement) return 1; },  
 932824: () => { return document.getElementById('canvas').width; },  
 932876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932944: () => { document.exitFullscreen(); },  
 932971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 933029: () => { return screen.width; },  
 933054: () => { return screen.height; },  
 933080: () => { return window.screenX; },  
 933107: () => { return window.screenY; },  
 933134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 933187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 933258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 933315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 933571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 933642: () => { if (document.fullscreenElement) return 1; },  
 933688: () => { return window.innerWidth; },  
 933714: () => { return window.innerHeight; },  
 933741: () => { if (document.pointerLockElement) return 1; }
};
