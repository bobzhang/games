...
var ASM_CONSTS = {
  931700: () => { if (document.fullscreenElement) return 1; },  
 931746: () => { return document.getElementById('canvas').width; },  
 931798: () => { return parseInt(document.getElementById('canvas').style.width); },  
 931866: () => { document.exitFullscreen(); },  
 931893: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 931966: () => { if (document.fullscreenElement) return 1; },  
 932012: () => { return document.getElementById('canvas').width; },  
 932064: () => { return screen.width; },  
 932089: () => { document.exitFullscreen(); },  
 932116: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 932249: () => { return window.innerWidth; },  
 932275: () => { return window.innerHeight; },  
 932302: () => { if (document.fullscreenElement) return 1; },  
 932348: () => { return document.getElementById('canvas').width; },  
 932400: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932468: () => { if (document.fullscreenElement) return 1; },  
 932514: () => { return document.getElementById('canvas').width; },  
 932566: () => { return screen.width; },  
 932591: () => { return window.innerWidth; },  
 932617: () => { return window.innerHeight; },  
 932644: () => { if (document.fullscreenElement) return 1; },  
 932690: () => { return document.getElementById('canvas').width; },  
 932742: () => { return screen.width; },  
 932767: () => { document.exitFullscreen(); },  
 932794: () => { if (document.fullscreenElement) return 1; },  
 932840: () => { return document.getElementById('canvas').width; },  
 932892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932960: () => { document.exitFullscreen(); },  
 932987: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 933045: () => { return screen.width; },  
 933070: () => { return screen.height; },  
 933096: () => { return window.screenX; },  
 933123: () => { return window.screenY; },  
 933150: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 933203: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 933274: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 933331: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 933587: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 933658: () => { if (document.fullscreenElement) return 1; },  
 933704: () => { return window.innerWidth; },  
 933730: () => { return window.innerHeight; },  
 933757: () => { if (document.pointerLockElement) return 1; }
};
