...
var ASM_CONSTS = {
  931696: () => { if (document.fullscreenElement) return 1; },  
 931742: () => { return document.getElementById('canvas').width; },  
 931794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 931862: () => { document.exitFullscreen(); },  
 931889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 931962: () => { if (document.fullscreenElement) return 1; },  
 932008: () => { return document.getElementById('canvas').width; },  
 932060: () => { return screen.width; },  
 932085: () => { document.exitFullscreen(); },  
 932112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 932245: () => { return window.innerWidth; },  
 932271: () => { return window.innerHeight; },  
 932298: () => { if (document.fullscreenElement) return 1; },  
 932344: () => { return document.getElementById('canvas').width; },  
 932396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932464: () => { if (document.fullscreenElement) return 1; },  
 932510: () => { return document.getElementById('canvas').width; },  
 932562: () => { return screen.width; },  
 932587: () => { return window.innerWidth; },  
 932613: () => { return window.innerHeight; },  
 932640: () => { if (document.fullscreenElement) return 1; },  
 932686: () => { return document.getElementById('canvas').width; },  
 932738: () => { return screen.width; },  
 932763: () => { document.exitFullscreen(); },  
 932790: () => { if (document.fullscreenElement) return 1; },  
 932836: () => { return document.getElementById('canvas').width; },  
 932888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 932956: () => { document.exitFullscreen(); },  
 932983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 933041: () => { return screen.width; },  
 933066: () => { return screen.height; },  
 933092: () => { return window.screenX; },  
 933119: () => { return window.screenY; },  
 933146: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 933199: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 933270: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 933327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 933583: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 933654: () => { if (document.fullscreenElement) return 1; },  
 933700: () => { return window.innerWidth; },  
 933726: () => { return window.innerHeight; },  
 933753: () => { if (document.pointerLockElement) return 1; }
};
