...
var ASM_CONSTS = {
 ...
 262630: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262698: () => { document.exitFullscreen(); },  
 262725: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262798: () => { if (document.fullscreenElement) return 1; },  
 262844: () => { return document.getElementById('canvas').width; },  
 262896: () => { return screen.width; },  
 262921: () => { document.exitFullscreen(); },  
 262948: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263081: () => { return window.innerWidth; },  
 263107: () => { return window.innerHeight; },  
 263134: () => { if (document.fullscreenElement) return 1; },  
 263180: () => { return document.getElementById('canvas').width; },  
 263232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263423: () => { return window.innerWidth; },  
 263449: () => { return window.innerHeight; },  
 ...
 263599: () => { document.exitFullscreen(); },  
 ...
 263792: () => { document.exitFullscreen(); },  
 263819: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263877: () => { return screen.width; },  
 263902: () => { return screen.height; },  
 263928: () => { return window.screenX; },  
 263955: () => { return window.screenY; },  
 263982: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264035: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264106: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264163: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264419: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264490: () => { if (document.fullscreenElement) return 1; },  
 264536: () => { return window.innerWidth; },  
 264562: () => { return window.innerHeight; },  
 264589: () => { if (document.pointerLockElement) return 1; }
};
