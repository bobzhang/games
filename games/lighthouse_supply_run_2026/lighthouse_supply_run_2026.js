...
var ASM_CONSTS = {
 ...
 263494: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263562: () => { document.exitFullscreen(); },  
 263589: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263662: () => { if (document.fullscreenElement) return 1; },  
 263708: () => { return document.getElementById('canvas').width; },  
 263760: () => { return screen.width; },  
 263785: () => { document.exitFullscreen(); },  
 263812: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263945: () => { return window.innerWidth; },  
 263971: () => { return window.innerHeight; },  
 263998: () => { if (document.fullscreenElement) return 1; },  
 264044: () => { return document.getElementById('canvas').width; },  
 264096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264287: () => { return window.innerWidth; },  
 264313: () => { return window.innerHeight; },  
 ...
 264463: () => { document.exitFullscreen(); },  
 264490: () => { if (document.fullscreenElement) return 1; },  
 264536: () => { return document.getElementById('canvas').width; },  
 264588: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264656: () => { document.exitFullscreen(); },  
 264683: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264741: () => { return screen.width; },  
 264766: () => { return screen.height; },  
 264792: () => { return window.screenX; },  
 264819: () => { return window.screenY; },  
 264846: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264899: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264970: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265027: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265283: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265354: () => { if (document.fullscreenElement) return 1; },  
 265400: () => { return window.innerWidth; },  
 265426: () => { return window.innerHeight; },  
 265453: () => { if (document.pointerLockElement) return 1; }
};
