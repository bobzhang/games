...
var ASM_CONSTS = {
 ...
 263286: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263354: () => { document.exitFullscreen(); },  
 263381: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263454: () => { if (document.fullscreenElement) return 1; },  
 263500: () => { return document.getElementById('canvas').width; },  
 263552: () => { return screen.width; },  
 263577: () => { document.exitFullscreen(); },  
 263604: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263737: () => { return window.innerWidth; },  
 263763: () => { return window.innerHeight; },  
 263790: () => { if (document.fullscreenElement) return 1; },  
 263836: () => { return document.getElementById('canvas').width; },  
 263888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264079: () => { return window.innerWidth; },  
 264105: () => { return window.innerHeight; },  
 ...
 264255: () => { document.exitFullscreen(); },  
 264282: () => { if (document.fullscreenElement) return 1; },  
 264328: () => { return document.getElementById('canvas').width; },  
 264380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264448: () => { document.exitFullscreen(); },  
 264475: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264533: () => { return screen.width; },  
 264558: () => { return screen.height; },  
 264584: () => { return window.screenX; },  
 264611: () => { return window.screenY; },  
 264638: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264691: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264762: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264819: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265075: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265146: () => { if (document.fullscreenElement) return 1; },  
 265192: () => { return window.innerWidth; },  
 265218: () => { return window.innerHeight; },  
 265245: () => { if (document.pointerLockElement) return 1; }
};
