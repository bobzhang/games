...
function findWasmBinary() {
  return locateFile('raylib_textures_image_drawing.wasm');
}
...
var ASM_CONSTS = {
  829408: () => { if (document.fullscreenElement) return 1; },  
 829454: () => { return document.getElementById('canvas').width; },  
 829506: () => { return parseInt(document.getElementById('canvas').style.width); },  
 829574: () => { document.exitFullscreen(); },  
 829601: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 829674: () => { if (document.fullscreenElement) return 1; },  
 829720: () => { return document.getElementById('canvas').width; },  
 829772: () => { return screen.width; },  
 829797: () => { document.exitFullscreen(); },  
 829824: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 829957: () => { return window.innerWidth; },  
 829983: () => { return window.innerHeight; },  
 830010: () => { if (document.fullscreenElement) return 1; },  
 830056: () => { return document.getElementById('canvas').width; },  
 830108: () => { return parseInt(document.getElementById('canvas').style.width); },  
 830176: () => { if (document.fullscreenElement) return 1; },  
 830222: () => { return document.getElementById('canvas').width; },  
 830274: () => { return screen.width; },  
 830299: () => { return window.innerWidth; },  
 830325: () => { return window.innerHeight; },  
 830352: () => { if (document.fullscreenElement) return 1; },  
 830398: () => { return document.getElementById('canvas').width; },  
 830450: () => { return screen.width; },  
 830475: () => { document.exitFullscreen(); },  
 830502: () => { if (document.fullscreenElement) return 1; },  
 830548: () => { return document.getElementById('canvas').width; },  
 830600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 830668: () => { document.exitFullscreen(); },  
 830695: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 830753: () => { return screen.width; },  
 830778: () => { return screen.height; },  
 830804: () => { return window.screenX; },  
 830831: () => { return window.screenY; },  
 830858: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 830911: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 830982: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 831039: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 831295: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 831366: () => { if (document.fullscreenElement) return 1; },  
 831412: () => { return window.innerWidth; },  
 831438: () => { return window.innerHeight; },  
 831465: () => { if (document.pointerLockElement) return 1; }
};
