...
var ASM_CONSTS = {
 ...
 97890: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97958: () => { document.exitFullscreen(); },  
 97985: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98058: () => { if (document.fullscreenElement) return 1; },  
 98104: () => { return document.getElementById('canvas').width; },  
 98156: () => { return screen.width; },  
 98181: () => { document.exitFullscreen(); },  
 98208: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98341: () => { return window.innerWidth; },  
 98367: () => { return window.innerHeight; },  
 98394: () => { if (document.fullscreenElement) return 1; },  
 98440: () => { return document.getElementById('canvas').width; },  
 98492: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98560: () => { if (document.fullscreenElement) return 1; },  
 98606: () => { return document.getElementById('canvas').width; },  
 98658: () => { return screen.width; },  
 98683: () => { return window.innerWidth; },  
 98709: () => { return window.innerHeight; },  
 98736: () => { if (document.fullscreenElement) return 1; },  
 98782: () => { return document.getElementById('canvas').width; },  
 98834: () => { return screen.width; },  
 98859: () => { document.exitFullscreen(); },  
 98886: () => { if (document.fullscreenElement) return 1; },  
 98932: () => { return document.getElementById('canvas').width; },  
 98984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99052: () => { document.exitFullscreen(); },  
 99079: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99137: () => { return screen.width; },  
 99162: () => { return screen.height; },  
 99188: () => { return window.screenX; },  
 99215: () => { return window.screenY; },  
 99242: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99295: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99366: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99423: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99679: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99750: () => { if (document.fullscreenElement) return 1; },  
 99796: () => { return window.innerWidth; },  
 99822: () => { return window.innerHeight; },  
 99849: () => { if (document.pointerLockElement) return 1; }
};
