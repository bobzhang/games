...
var ASM_CONSTS = {
  272964: () => { if (document.fullscreenElement) return 1; },  
 273010: () => { return document.getElementById('canvas').width; },  
 273062: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273130: () => { document.exitFullscreen(); },  
 273157: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273230: () => { if (document.fullscreenElement) return 1; },  
 273276: () => { return document.getElementById('canvas').width; },  
 273328: () => { return screen.width; },  
 273353: () => { document.exitFullscreen(); },  
 273380: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273513: () => { return window.innerWidth; },  
 273539: () => { return window.innerHeight; },  
 273566: () => { if (document.fullscreenElement) return 1; },  
 273612: () => { return document.getElementById('canvas').width; },  
 273664: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273732: () => { if (document.fullscreenElement) return 1; },  
 273778: () => { return document.getElementById('canvas').width; },  
 273830: () => { return screen.width; },  
 273855: () => { return window.innerWidth; },  
 273881: () => { return window.innerHeight; },  
 273908: () => { if (document.fullscreenElement) return 1; },  
 273954: () => { return document.getElementById('canvas').width; },  
 274006: () => { return screen.width; },  
 274031: () => { document.exitFullscreen(); },  
 274058: () => { if (document.fullscreenElement) return 1; },  
 274104: () => { return document.getElementById('canvas').width; },  
 274156: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274224: () => { document.exitFullscreen(); },  
 274251: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274309: () => { return screen.width; },  
 274334: () => { return screen.height; },  
 274360: () => { return window.screenX; },  
 274387: () => { return window.screenY; },  
 274414: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274467: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274538: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274595: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274851: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274922: () => { if (document.fullscreenElement) return 1; },  
 274968: () => { return window.innerWidth; },  
 274994: () => { return window.innerHeight; },  
 275021: () => { if (document.pointerLockElement) return 1; }
};
