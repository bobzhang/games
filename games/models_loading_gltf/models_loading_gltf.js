...
var ASM_CONSTS = {
  272740: () => { if (document.fullscreenElement) return 1; },  
 272786: () => { return document.getElementById('canvas').width; },  
 272838: () => { return parseInt(document.getElementById('canvas').style.width); },  
 272906: () => { document.exitFullscreen(); },  
 272933: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273006: () => { if (document.fullscreenElement) return 1; },  
 273052: () => { return document.getElementById('canvas').width; },  
 273104: () => { return screen.width; },  
 273129: () => { document.exitFullscreen(); },  
 273156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273289: () => { return window.innerWidth; },  
 273315: () => { return window.innerHeight; },  
 273342: () => { if (document.fullscreenElement) return 1; },  
 273388: () => { return document.getElementById('canvas').width; },  
 273440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 273631: () => { return window.innerWidth; },  
 273657: () => { return window.innerHeight; },  
 273684: () => { if (document.fullscreenElement) return 1; },  
 273730: () => { return document.getElementById('canvas').width; },  
 273782: () => { return screen.width; },  
 273807: () => { document.exitFullscreen(); },  
 273834: () => { if (document.fullscreenElement) return 1; },  
 273880: () => { return document.getElementById('canvas').width; },  
 273932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274000: () => { document.exitFullscreen(); },  
 274027: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274085: () => { return screen.width; },  
 274110: () => { return screen.height; },  
 274136: () => { return window.screenX; },  
 274163: () => { return window.screenY; },  
 274190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274371: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274627: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274698: () => { if (document.fullscreenElement) return 1; },  
 274744: () => { return window.innerWidth; },  
 274770: () => { return window.innerHeight; },  
 274797: () => { if (document.pointerLockElement) return 1; }
};
