...
var ASM_CONSTS = {
  261108: () => { if (document.fullscreenElement) return 1; },  
 261154: () => { return document.getElementById('canvas').width; },  
 261206: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261274: () => { document.exitFullscreen(); },  
 261301: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261374: () => { if (document.fullscreenElement) return 1; },  
 261420: () => { return document.getElementById('canvas').width; },  
 261472: () => { return screen.width; },  
 261497: () => { document.exitFullscreen(); },  
 261524: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261657: () => { return window.innerWidth; },  
 261683: () => { return window.innerHeight; },  
 261710: () => { if (document.fullscreenElement) return 1; },  
 261756: () => { return document.getElementById('canvas').width; },  
 261808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261876: () => { if (document.fullscreenElement) return 1; },  
 261922: () => { return document.getElementById('canvas').width; },  
 261974: () => { return screen.width; },  
 261999: () => { return window.innerWidth; },  
 262025: () => { return window.innerHeight; },  
 ...
 262175: () => { document.exitFullscreen(); },  
 ...
 262368: () => { document.exitFullscreen(); },  
 262395: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262453: () => { return screen.width; },  
 262478: () => { return screen.height; },  
 262504: () => { return window.screenX; },  
 262531: () => { return window.screenY; },  
 262558: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262611: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262682: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262739: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262995: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263066: () => { if (document.fullscreenElement) return 1; },  
 263112: () => { return window.innerWidth; },  
 263138: () => { return window.innerHeight; },  
 263165: () => { if (document.pointerLockElement) return 1; }
};
