...
var ASM_CONSTS = {
  261120: () => { if (document.fullscreenElement) return 1; },  
 261166: () => { return document.getElementById('canvas').width; },  
 261218: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261286: () => { document.exitFullscreen(); },  
 261313: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261386: () => { if (document.fullscreenElement) return 1; },  
 261432: () => { return document.getElementById('canvas').width; },  
 261484: () => { return screen.width; },  
 261509: () => { document.exitFullscreen(); },  
 261536: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261669: () => { return window.innerWidth; },  
 261695: () => { return window.innerHeight; },  
 ...
 262011: () => { return window.innerWidth; },  
 262037: () => { return window.innerHeight; },  
 ...
 262187: () => { document.exitFullscreen(); },  
 262214: () => { if (document.fullscreenElement) return 1; },  
 262260: () => { return document.getElementById('canvas').width; },  
 262312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262380: () => { document.exitFullscreen(); },  
 262407: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262465: () => { return screen.width; },  
 262490: () => { return screen.height; },  
 262516: () => { return window.screenX; },  
 262543: () => { return window.screenY; },  
 262570: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262623: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262694: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263007: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263078: () => { if (document.fullscreenElement) return 1; },  
 263124: () => { return window.innerWidth; },  
 263150: () => { return window.innerHeight; },  
 263177: () => { if (document.pointerLockElement) return 1; }
};
