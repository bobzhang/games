...
function findWasmBinary() {
  return locateFile('raylib_textures_to_image.wasm');
}
...
var ASM_CONSTS = {
  104832: () => { if (document.fullscreenElement) return 1; },  
 104878: () => { return document.getElementById('canvas').width; },  
 104930: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104998: () => { document.exitFullscreen(); },  
 105025: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 105098: () => { if (document.fullscreenElement) return 1; },  
 105144: () => { return document.getElementById('canvas').width; },  
 105196: () => { return screen.width; },  
 105221: () => { document.exitFullscreen(); },  
 105248: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 105381: () => { return window.innerWidth; },  
 105407: () => { return window.innerHeight; },  
 105434: () => { if (document.fullscreenElement) return 1; },  
 105480: () => { return document.getElementById('canvas').width; },  
 105532: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105600: () => { if (document.fullscreenElement) return 1; },  
 105646: () => { return document.getElementById('canvas').width; },  
 105698: () => { return screen.width; },  
 105723: () => { return window.innerWidth; },  
 105749: () => { return window.innerHeight; },  
 105776: () => { if (document.fullscreenElement) return 1; },  
 105822: () => { return document.getElementById('canvas').width; },  
 105874: () => { return screen.width; },  
 105899: () => { document.exitFullscreen(); },  
 105926: () => { if (document.fullscreenElement) return 1; },  
 105972: () => { return document.getElementById('canvas').width; },  
 106024: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106092: () => { document.exitFullscreen(); },  
 106119: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 106177: () => { return screen.width; },  
 106202: () => { return screen.height; },  
 106228: () => { return window.screenX; },  
 106255: () => { return window.screenY; },  
 106282: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 106335: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106406: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106463: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106719: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106790: () => { if (document.fullscreenElement) return 1; },  
 106836: () => { return window.innerWidth; },  
 106862: () => { return window.innerHeight; },  
 106889: () => { if (document.pointerLockElement) return 1; }
};
