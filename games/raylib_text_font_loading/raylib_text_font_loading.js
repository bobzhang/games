...
function findWasmBinary() {
  return locateFile('raylib_text_font_loading.wasm');
}
...
var ASM_CONSTS = {
  177952: () => { if (document.fullscreenElement) return 1; },  
 177998: () => { return document.getElementById('canvas').width; },  
 178050: () => { return parseInt(document.getElementById('canvas').style.width); },  
 178118: () => { document.exitFullscreen(); },  
 178145: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 178218: () => { if (document.fullscreenElement) return 1; },  
 178264: () => { return document.getElementById('canvas').width; },  
 178316: () => { return screen.width; },  
 178341: () => { document.exitFullscreen(); },  
 178368: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 178501: () => { return window.innerWidth; },  
 178527: () => { return window.innerHeight; },  
 178554: () => { if (document.fullscreenElement) return 1; },  
 178600: () => { return document.getElementById('canvas').width; },  
 178652: () => { return parseInt(document.getElementById('canvas').style.width); },  
 178720: () => { if (document.fullscreenElement) return 1; },  
 178766: () => { return document.getElementById('canvas').width; },  
 178818: () => { return screen.width; },  
 178843: () => { return window.innerWidth; },  
 178869: () => { return window.innerHeight; },  
 178896: () => { if (document.fullscreenElement) return 1; },  
 178942: () => { return document.getElementById('canvas').width; },  
 178994: () => { return screen.width; },  
 179019: () => { document.exitFullscreen(); },  
 179046: () => { if (document.fullscreenElement) return 1; },  
 179092: () => { return document.getElementById('canvas').width; },  
 179144: () => { return parseInt(document.getElementById('canvas').style.width); },  
 179212: () => { document.exitFullscreen(); },  
 179239: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 179297: () => { return screen.width; },  
 179322: () => { return screen.height; },  
 179348: () => { return window.screenX; },  
 179375: () => { return window.screenY; },  
 179402: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 179455: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 179526: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 179583: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 179839: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 179910: () => { if (document.fullscreenElement) return 1; },  
 179956: () => { return window.innerWidth; },  
 179982: () => { return window.innerHeight; },  
 180009: () => { if (document.pointerLockElement) return 1; }
};
