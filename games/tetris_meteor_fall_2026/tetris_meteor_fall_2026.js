...
function findWasmBinary() {
  return locateFile('tetris_meteor_fall_2026.wasm');
}
...
var ASM_CONSTS = {
  260976: () => { if (document.fullscreenElement) return 1; },  
 261022: () => { return document.getElementById('canvas').width; },  
 261074: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261142: () => { document.exitFullscreen(); },  
 261169: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261242: () => { if (document.fullscreenElement) return 1; },  
 261288: () => { return document.getElementById('canvas').width; },  
 261340: () => { return screen.width; },  
 261365: () => { document.exitFullscreen(); },  
 261392: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261525: () => { return window.innerWidth; },  
 261551: () => { return window.innerHeight; },  
 261578: () => { if (document.fullscreenElement) return 1; },  
 261624: () => { return document.getElementById('canvas').width; },  
 261676: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261744: () => { if (document.fullscreenElement) return 1; },  
 261790: () => { return document.getElementById('canvas').width; },  
 261842: () => { return screen.width; },  
 261867: () => { return window.innerWidth; },  
 261893: () => { return window.innerHeight; },  
 261920: () => { if (document.fullscreenElement) return 1; },  
 261966: () => { return document.getElementById('canvas').width; },  
 262018: () => { return screen.width; },  
 262043: () => { document.exitFullscreen(); },  
 262070: () => { if (document.fullscreenElement) return 1; },  
 262116: () => { return document.getElementById('canvas').width; },  
 262168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262236: () => { document.exitFullscreen(); },  
 262263: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262321: () => { return screen.width; },  
 262346: () => { return screen.height; },  
 262372: () => { return window.screenX; },  
 262399: () => { return window.screenY; },  
 262426: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262479: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262550: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262607: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262863: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262934: () => { if (document.fullscreenElement) return 1; },  
 262980: () => { return window.innerWidth; },  
 263006: () => { return window.innerHeight; },  
 263033: () => { if (document.pointerLockElement) return 1; }
};
