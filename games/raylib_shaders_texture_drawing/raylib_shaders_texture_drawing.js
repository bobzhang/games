...
function findWasmBinary() {
  return locateFile('raylib_shaders_texture_drawing.wasm');
}
...
var ASM_CONSTS = {
 ...
 99346: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99414: () => { document.exitFullscreen(); },  
 99441: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99514: () => { if (document.fullscreenElement) return 1; },  
 99560: () => { return document.getElementById('canvas').width; },  
 99612: () => { return screen.width; },  
 99637: () => { document.exitFullscreen(); },  
 99664: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99797: () => { return window.innerWidth; },  
 99823: () => { return window.innerHeight; },  
 99850: () => { if (document.fullscreenElement) return 1; },  
 99896: () => { return document.getElementById('canvas').width; },  
 99948: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100139: () => { return window.innerWidth; },  
 100165: () => { return window.innerHeight; },  
 ...
 100315: () => { document.exitFullscreen(); },  
 100342: () => { if (document.fullscreenElement) return 1; },  
 100388: () => { return document.getElementById('canvas').width; },  
 100440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100508: () => { document.exitFullscreen(); },  
 100535: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100593: () => { return screen.width; },  
 100618: () => { return screen.height; },  
 100644: () => { return window.screenX; },  
 100671: () => { return window.screenY; },  
 100698: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100751: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100822: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100879: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101135: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101206: () => { if (document.fullscreenElement) return 1; },  
 101252: () => { return window.innerWidth; },  
 101278: () => { return window.innerHeight; },  
 101305: () => { if (document.pointerLockElement) return 1; }
};
