...
var ASM_CONSTS = {
 ...
 100098: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100166: () => { document.exitFullscreen(); },  
 100193: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100266: () => { if (document.fullscreenElement) return 1; },  
 100312: () => { return document.getElementById('canvas').width; },  
 100364: () => { return screen.width; },  
 100389: () => { document.exitFullscreen(); },  
 100416: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100549: () => { return window.innerWidth; },  
 100575: () => { return window.innerHeight; },  
 100602: () => { if (document.fullscreenElement) return 1; },  
 100648: () => { return document.getElementById('canvas').width; },  
 100700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100891: () => { return window.innerWidth; },  
 100917: () => { return window.innerHeight; },  
 ...
 101067: () => { document.exitFullscreen(); },  
 101094: () => { if (document.fullscreenElement) return 1; },  
 101140: () => { return document.getElementById('canvas').width; },  
 101192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101260: () => { document.exitFullscreen(); },  
 101287: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101345: () => { return screen.width; },  
 101370: () => { return screen.height; },  
 101396: () => { return window.screenX; },  
 101423: () => { return window.screenY; },  
 101450: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101503: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101574: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101631: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101887: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101958: () => { if (document.fullscreenElement) return 1; },  
 102004: () => { return window.innerWidth; },  
 102030: () => { return window.innerHeight; },  
 102057: () => { if (document.pointerLockElement) return 1; }
};
