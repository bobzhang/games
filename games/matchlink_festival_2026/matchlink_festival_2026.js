...
var ASM_CONSTS = {
 ...
 263238: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263306: () => { document.exitFullscreen(); },  
 263333: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263406: () => { if (document.fullscreenElement) return 1; },  
 263452: () => { return document.getElementById('canvas').width; },  
 263504: () => { return screen.width; },  
 263529: () => { document.exitFullscreen(); },  
 263556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263689: () => { return window.innerWidth; },  
 263715: () => { return window.innerHeight; },  
 263742: () => { if (document.fullscreenElement) return 1; },  
 263788: () => { return document.getElementById('canvas').width; },  
 263840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263908: () => { if (document.fullscreenElement) return 1; },  
 263954: () => { return document.getElementById('canvas').width; },  
 264006: () => { return screen.width; },  
 264031: () => { return window.innerWidth; },  
 264057: () => { return window.innerHeight; },  
 ...
 264207: () => { document.exitFullscreen(); },  
 264234: () => { if (document.fullscreenElement) return 1; },  
 264280: () => { return document.getElementById('canvas').width; },  
 264332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264400: () => { document.exitFullscreen(); },  
 264427: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264485: () => { return screen.width; },  
 264510: () => { return screen.height; },  
 264536: () => { return window.screenX; },  
 264563: () => { return window.screenY; },  
 264590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264643: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264714: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265027: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265098: () => { if (document.fullscreenElement) return 1; },  
 265144: () => { return window.innerWidth; },  
 265170: () => { return window.innerHeight; },  
 265197: () => { if (document.pointerLockElement) return 1; }
};
