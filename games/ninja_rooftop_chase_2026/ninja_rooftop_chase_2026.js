...
var ASM_CONSTS = {
 ...
 262326: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262394: () => { document.exitFullscreen(); },  
 262421: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262494: () => { if (document.fullscreenElement) return 1; },  
 262540: () => { return document.getElementById('canvas').width; },  
 262592: () => { return screen.width; },  
 262617: () => { document.exitFullscreen(); },  
 262644: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262777: () => { return window.innerWidth; },  
 262803: () => { return window.innerHeight; },  
 262830: () => { if (document.fullscreenElement) return 1; },  
 262876: () => { return document.getElementById('canvas').width; },  
 262928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262996: () => { if (document.fullscreenElement) return 1; },  
 263042: () => { return document.getElementById('canvas').width; },  
 263094: () => { return screen.width; },  
 263119: () => { return window.innerWidth; },  
 263145: () => { return window.innerHeight; },  
 263172: () => { if (document.fullscreenElement) return 1; },  
 263218: () => { return document.getElementById('canvas').width; },  
 263270: () => { return screen.width; },  
 263295: () => { document.exitFullscreen(); },  
 ...
 263488: () => { document.exitFullscreen(); },  
 263515: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263573: () => { return screen.width; },  
 263598: () => { return screen.height; },  
 263624: () => { return window.screenX; },  
 263651: () => { return window.screenY; },  
 263678: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263731: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263802: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263859: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264115: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264186: () => { if (document.fullscreenElement) return 1; },  
 264232: () => { return window.innerWidth; },  
 264258: () => { return window.innerHeight; },  
 264285: () => { if (document.pointerLockElement) return 1; }
};
