...
function findWasmBinary() {
  return locateFile('raylib_models_mesh_picking.wasm');
}
...
var ASM_CONSTS = {
 ...
 109426: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109494: () => { document.exitFullscreen(); },  
 109521: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 109594: () => { if (document.fullscreenElement) return 1; },  
 109640: () => { return document.getElementById('canvas').width; },  
 109692: () => { return screen.width; },  
 109717: () => { document.exitFullscreen(); },  
 109744: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 109877: () => { return window.innerWidth; },  
 109903: () => { return window.innerHeight; },  
 109930: () => { if (document.fullscreenElement) return 1; },  
 109976: () => { return document.getElementById('canvas').width; },  
 110028: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110096: () => { if (document.fullscreenElement) return 1; },  
 110142: () => { return document.getElementById('canvas').width; },  
 110194: () => { return screen.width; },  
 110219: () => { return window.innerWidth; },  
 110245: () => { return window.innerHeight; },  
 110272: () => { if (document.fullscreenElement) return 1; },  
 110318: () => { return document.getElementById('canvas').width; },  
 110370: () => { return screen.width; },  
 110395: () => { document.exitFullscreen(); },  
 110422: () => { if (document.fullscreenElement) return 1; },  
 110468: () => { return document.getElementById('canvas').width; },  
 110520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 110588: () => { document.exitFullscreen(); },  
 110615: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 110673: () => { return screen.width; },  
 110698: () => { return screen.height; },  
 110724: () => { return window.screenX; },  
 110751: () => { return window.screenY; },  
 110778: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110831: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 110902: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 110959: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 111215: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 111286: () => { if (document.fullscreenElement) return 1; },  
 111332: () => { return window.innerWidth; },  
 111358: () => { return window.innerHeight; },  
 111385: () => { if (document.pointerLockElement) return 1; }
};
