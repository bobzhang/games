...
var ASM_CONSTS = {
  267684: () => { if (document.fullscreenElement) return 1; },  
 267730: () => { return document.getElementById('canvas').width; },  
 267782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267850: () => { document.exitFullscreen(); },  
 267877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267950: () => { if (document.fullscreenElement) return 1; },  
 267996: () => { return document.getElementById('canvas').width; },  
 268048: () => { return screen.width; },  
 268073: () => { document.exitFullscreen(); },  
 268100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268233: () => { return window.innerWidth; },  
 268259: () => { return window.innerHeight; },  
 268286: () => { if (document.fullscreenElement) return 1; },  
 268332: () => { return document.getElementById('canvas').width; },  
 268384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268452: () => { if (document.fullscreenElement) return 1; },  
 268498: () => { return document.getElementById('canvas').width; },  
 268550: () => { return screen.width; },  
 268575: () => { return window.innerWidth; },  
 268601: () => { return window.innerHeight; },  
 268628: () => { if (document.fullscreenElement) return 1; },  
 268674: () => { return document.getElementById('canvas').width; },  
 268726: () => { return screen.width; },  
 268751: () => { document.exitFullscreen(); },  
 268778: () => { if (document.fullscreenElement) return 1; },  
 268824: () => { return document.getElementById('canvas').width; },  
 268876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268944: () => { document.exitFullscreen(); },  
 268971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269029: () => { return screen.width; },  
 269054: () => { return screen.height; },  
 269080: () => { return window.screenX; },  
 269107: () => { return window.screenY; },  
 269134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269642: () => { if (document.fullscreenElement) return 1; },  
 269688: () => { return window.innerWidth; },  
 269714: () => { return window.innerHeight; },  
 269741: () => { if (document.pointerLockElement) return 1; }
};
