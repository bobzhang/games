...
var ASM_CONSTS = {
  267876: () => { if (document.fullscreenElement) return 1; },  
 267922: () => { return document.getElementById('canvas').width; },  
 267974: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268042: () => { document.exitFullscreen(); },  
 268069: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268142: () => { if (document.fullscreenElement) return 1; },  
 268188: () => { return document.getElementById('canvas').width; },  
 268240: () => { return screen.width; },  
 268265: () => { document.exitFullscreen(); },  
 268292: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268425: () => { return window.innerWidth; },  
 268451: () => { return window.innerHeight; },  
 268478: () => { if (document.fullscreenElement) return 1; },  
 268524: () => { return document.getElementById('canvas').width; },  
 268576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268644: () => { if (document.fullscreenElement) return 1; },  
 268690: () => { return document.getElementById('canvas').width; },  
 268742: () => { return screen.width; },  
 268767: () => { return window.innerWidth; },  
 268793: () => { return window.innerHeight; },  
 268820: () => { if (document.fullscreenElement) return 1; },  
 268866: () => { return document.getElementById('canvas').width; },  
 268918: () => { return screen.width; },  
 268943: () => { document.exitFullscreen(); },  
 268970: () => { if (document.fullscreenElement) return 1; },  
 269016: () => { return document.getElementById('canvas').width; },  
 269068: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269136: () => { document.exitFullscreen(); },  
 269163: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269221: () => { return screen.width; },  
 269246: () => { return screen.height; },  
 269272: () => { return window.screenX; },  
 269299: () => { return window.screenY; },  
 269326: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269379: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269450: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269507: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269763: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269834: () => { if (document.fullscreenElement) return 1; },  
 269880: () => { return window.innerWidth; },  
 269906: () => { return window.innerHeight; },  
 269933: () => { if (document.pointerLockElement) return 1; }
};
