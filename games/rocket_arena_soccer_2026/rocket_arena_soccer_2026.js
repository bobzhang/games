...
var ASM_CONSTS = {
  261780: () => { if (document.fullscreenElement) return 1; },  
 261826: () => { return document.getElementById('canvas').width; },  
 261878: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261946: () => { document.exitFullscreen(); },  
 261973: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262046: () => { if (document.fullscreenElement) return 1; },  
 262092: () => { return document.getElementById('canvas').width; },  
 262144: () => { return screen.width; },  
 262169: () => { document.exitFullscreen(); },  
 262196: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262329: () => { return window.innerWidth; },  
 262355: () => { return window.innerHeight; },  
 262382: () => { if (document.fullscreenElement) return 1; },  
 262428: () => { return document.getElementById('canvas').width; },  
 262480: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262548: () => { if (document.fullscreenElement) return 1; },  
 262594: () => { return document.getElementById('canvas').width; },  
 262646: () => { return screen.width; },  
 262671: () => { return window.innerWidth; },  
 262697: () => { return window.innerHeight; },  
 ...
 262847: () => { document.exitFullscreen(); },  
 262874: () => { if (document.fullscreenElement) return 1; },  
 262920: () => { return document.getElementById('canvas').width; },  
 262972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263040: () => { document.exitFullscreen(); },  
 263067: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263125: () => { return screen.width; },  
 263150: () => { return screen.height; },  
 263176: () => { return window.screenX; },  
 263203: () => { return window.screenY; },  
 263230: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263283: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263354: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263411: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263667: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263738: () => { if (document.fullscreenElement) return 1; },  
 263784: () => { return window.innerWidth; },  
 263810: () => { return window.innerHeight; },  
 263837: () => { if (document.pointerLockElement) return 1; }
};
