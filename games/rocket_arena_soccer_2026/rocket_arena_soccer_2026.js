...
var ASM_CONSTS = {
  262004: () => { if (document.fullscreenElement) return 1; },  
 262050: () => { return document.getElementById('canvas').width; },  
 262102: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262170: () => { document.exitFullscreen(); },  
 262197: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262270: () => { if (document.fullscreenElement) return 1; },  
 262316: () => { return document.getElementById('canvas').width; },  
 262368: () => { return screen.width; },  
 262393: () => { document.exitFullscreen(); },  
 262420: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262553: () => { return window.innerWidth; },  
 262579: () => { return window.innerHeight; },  
 262606: () => { if (document.fullscreenElement) return 1; },  
 262652: () => { return document.getElementById('canvas').width; },  
 262704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262772: () => { if (document.fullscreenElement) return 1; },  
 262818: () => { return document.getElementById('canvas').width; },  
 262870: () => { return screen.width; },  
 262895: () => { return window.innerWidth; },  
 262921: () => { return window.innerHeight; },  
 262948: () => { if (document.fullscreenElement) return 1; },  
 262994: () => { return document.getElementById('canvas').width; },  
 263046: () => { return screen.width; },  
 263071: () => { document.exitFullscreen(); },  
 263098: () => { if (document.fullscreenElement) return 1; },  
 263144: () => { return document.getElementById('canvas').width; },  
 263196: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263264: () => { document.exitFullscreen(); },  
 263291: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263349: () => { return screen.width; },  
 263374: () => { return screen.height; },  
 263400: () => { return window.screenX; },  
 263427: () => { return window.screenY; },  
 263454: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263507: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263578: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263635: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263891: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263962: () => { if (document.fullscreenElement) return 1; },  
 264008: () => { return window.innerWidth; },  
 264034: () => { return window.innerHeight; },  
 264061: () => { if (document.pointerLockElement) return 1; }
};
