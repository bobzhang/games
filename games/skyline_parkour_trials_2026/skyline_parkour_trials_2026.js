...
var ASM_CONSTS = {
  262260: () => { if (document.fullscreenElement) return 1; },  
 262306: () => { return document.getElementById('canvas').width; },  
 262358: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262426: () => { document.exitFullscreen(); },  
 262453: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262526: () => { if (document.fullscreenElement) return 1; },  
 262572: () => { return document.getElementById('canvas').width; },  
 262624: () => { return screen.width; },  
 262649: () => { document.exitFullscreen(); },  
 262676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262809: () => { return window.innerWidth; },  
 262835: () => { return window.innerHeight; },  
 262862: () => { if (document.fullscreenElement) return 1; },  
 262908: () => { return document.getElementById('canvas').width; },  
 262960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263028: () => { if (document.fullscreenElement) return 1; },  
 263074: () => { return document.getElementById('canvas').width; },  
 263126: () => { return screen.width; },  
 263151: () => { return window.innerWidth; },  
 263177: () => { return window.innerHeight; },  
 ...
 263327: () => { document.exitFullscreen(); },  
 263354: () => { if (document.fullscreenElement) return 1; },  
 263400: () => { return document.getElementById('canvas').width; },  
 263452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263520: () => { document.exitFullscreen(); },  
 263547: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263605: () => { return screen.width; },  
 263630: () => { return screen.height; },  
 263656: () => { return window.screenX; },  
 263683: () => { return window.screenY; },  
 263710: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263763: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263834: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263891: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264147: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264218: () => { if (document.fullscreenElement) return 1; },  
 264264: () => { return window.innerWidth; },  
 264290: () => { return window.innerHeight; },  
 264317: () => { if (document.pointerLockElement) return 1; }
};
