...
var ASM_CONSTS = {
  262244: () => { if (document.fullscreenElement) return 1; },  
 262290: () => { return document.getElementById('canvas').width; },  
 262342: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262410: () => { document.exitFullscreen(); },  
 262437: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262510: () => { if (document.fullscreenElement) return 1; },  
 262556: () => { return document.getElementById('canvas').width; },  
 262608: () => { return screen.width; },  
 262633: () => { document.exitFullscreen(); },  
 262660: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262793: () => { return window.innerWidth; },  
 262819: () => { return window.innerHeight; },  
 262846: () => { if (document.fullscreenElement) return 1; },  
 262892: () => { return document.getElementById('canvas').width; },  
 262944: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263135: () => { return window.innerWidth; },  
 263161: () => { return window.innerHeight; },  
 263188: () => { if (document.fullscreenElement) return 1; },  
 263234: () => { return document.getElementById('canvas').width; },  
 263286: () => { return screen.width; },  
 263311: () => { document.exitFullscreen(); },  
 263338: () => { if (document.fullscreenElement) return 1; },  
 263384: () => { return document.getElementById('canvas').width; },  
 263436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263504: () => { document.exitFullscreen(); },  
 263531: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263589: () => { return screen.width; },  
 263614: () => { return screen.height; },  
 263640: () => { return window.screenX; },  
 263667: () => { return window.screenY; },  
 263694: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263747: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263818: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263875: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264131: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264202: () => { if (document.fullscreenElement) return 1; },  
 264248: () => { return window.innerWidth; },  
 264274: () => { return window.innerHeight; },  
 264301: () => { if (document.pointerLockElement) return 1; }
};
