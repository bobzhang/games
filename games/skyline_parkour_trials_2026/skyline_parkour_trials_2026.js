...
var ASM_CONSTS = {
  262036: () => { if (document.fullscreenElement) return 1; },  
 262082: () => { return document.getElementById('canvas').width; },  
 262134: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262202: () => { document.exitFullscreen(); },  
 262229: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262302: () => { if (document.fullscreenElement) return 1; },  
 262348: () => { return document.getElementById('canvas').width; },  
 262400: () => { return screen.width; },  
 262425: () => { document.exitFullscreen(); },  
 262452: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262585: () => { return window.innerWidth; },  
 262611: () => { return window.innerHeight; },  
 262638: () => { if (document.fullscreenElement) return 1; },  
 262684: () => { return document.getElementById('canvas').width; },  
 262736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262804: () => { if (document.fullscreenElement) return 1; },  
 262850: () => { return document.getElementById('canvas').width; },  
 262902: () => { return screen.width; },  
 262927: () => { return window.innerWidth; },  
 262953: () => { return window.innerHeight; },  
 262980: () => { if (document.fullscreenElement) return 1; },  
 263026: () => { return document.getElementById('canvas').width; },  
 263078: () => { return screen.width; },  
 263103: () => { document.exitFullscreen(); },  
 263130: () => { if (document.fullscreenElement) return 1; },  
 263176: () => { return document.getElementById('canvas').width; },  
 263228: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263296: () => { document.exitFullscreen(); },  
 263323: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263381: () => { return screen.width; },  
 263406: () => { return screen.height; },  
 263432: () => { return window.screenX; },  
 263459: () => { return window.screenY; },  
 263486: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263539: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263610: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263667: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263923: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263994: () => { if (document.fullscreenElement) return 1; },  
 264040: () => { return window.innerWidth; },  
 264066: () => { return window.innerHeight; },  
 264093: () => { if (document.pointerLockElement) return 1; }
};
