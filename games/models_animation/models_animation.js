...
var ASM_CONSTS = {
  273108: () => { if (document.fullscreenElement) return 1; },  
 273154: () => { return document.getElementById('canvas').width; },  
 273206: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273274: () => { document.exitFullscreen(); },  
 273301: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273374: () => { if (document.fullscreenElement) return 1; },  
 273420: () => { return document.getElementById('canvas').width; },  
 273472: () => { return screen.width; },  
 273497: () => { document.exitFullscreen(); },  
 273524: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273657: () => { return window.innerWidth; },  
 273683: () => { return window.innerHeight; },  
 273710: () => { if (document.fullscreenElement) return 1; },  
 273756: () => { return document.getElementById('canvas').width; },  
 273808: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273876: () => { if (document.fullscreenElement) return 1; },  
 273922: () => { return document.getElementById('canvas').width; },  
 273974: () => { return screen.width; },  
 273999: () => { return window.innerWidth; },  
 274025: () => { return window.innerHeight; },  
 274052: () => { if (document.fullscreenElement) return 1; },  
 274098: () => { return document.getElementById('canvas').width; },  
 274150: () => { return screen.width; },  
 274175: () => { document.exitFullscreen(); },  
 274202: () => { if (document.fullscreenElement) return 1; },  
 274248: () => { return document.getElementById('canvas').width; },  
 274300: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274368: () => { document.exitFullscreen(); },  
 274395: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274453: () => { return screen.width; },  
 274478: () => { return screen.height; },  
 274504: () => { return window.screenX; },  
 274531: () => { return window.screenY; },  
 274558: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274611: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274682: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274739: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274995: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 275066: () => { if (document.fullscreenElement) return 1; },  
 275112: () => { return window.innerWidth; },  
 275138: () => { return window.innerHeight; },  
 275165: () => { if (document.pointerLockElement) return 1; }
};
