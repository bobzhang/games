...
var ASM_CONSTS = {
  272884: () => { if (document.fullscreenElement) return 1; },  
 272930: () => { return document.getElementById('canvas').width; },  
 272982: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273050: () => { document.exitFullscreen(); },  
 273077: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273150: () => { if (document.fullscreenElement) return 1; },  
 273196: () => { return document.getElementById('canvas').width; },  
 273248: () => { return screen.width; },  
 273273: () => { document.exitFullscreen(); },  
 273300: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273433: () => { return window.innerWidth; },  
 273459: () => { return window.innerHeight; },  
 273486: () => { if (document.fullscreenElement) return 1; },  
 273532: () => { return document.getElementById('canvas').width; },  
 273584: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 273775: () => { return window.innerWidth; },  
 273801: () => { return window.innerHeight; },  
 273828: () => { if (document.fullscreenElement) return 1; },  
 273874: () => { return document.getElementById('canvas').width; },  
 273926: () => { return screen.width; },  
 273951: () => { document.exitFullscreen(); },  
 273978: () => { if (document.fullscreenElement) return 1; },  
 274024: () => { return document.getElementById('canvas').width; },  
 274076: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274144: () => { document.exitFullscreen(); },  
 274171: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274229: () => { return screen.width; },  
 274254: () => { return screen.height; },  
 274280: () => { return window.screenX; },  
 274307: () => { return window.screenY; },  
 274334: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274387: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274458: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274515: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 274771: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 274842: () => { if (document.fullscreenElement) return 1; },  
 274888: () => { return window.innerWidth; },  
 274914: () => { return window.innerHeight; },  
 274941: () => { if (document.pointerLockElement) return 1; }
};
