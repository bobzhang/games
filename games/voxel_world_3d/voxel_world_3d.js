...
var ASM_CONSTS = {
  267428: () => { if (document.fullscreenElement) return 1; },  
 267474: () => { return document.getElementById('canvas').width; },  
 267526: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267594: () => { document.exitFullscreen(); },  
 267621: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267694: () => { if (document.fullscreenElement) return 1; },  
 267740: () => { return document.getElementById('canvas').width; },  
 267792: () => { return screen.width; },  
 267817: () => { document.exitFullscreen(); },  
 267844: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267977: () => { return window.innerWidth; },  
 268003: () => { return window.innerHeight; },  
 268030: () => { if (document.fullscreenElement) return 1; },  
 268076: () => { return document.getElementById('canvas').width; },  
 268128: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268196: () => { if (document.fullscreenElement) return 1; },  
 268242: () => { return document.getElementById('canvas').width; },  
 268294: () => { return screen.width; },  
 268319: () => { return window.innerWidth; },  
 268345: () => { return window.innerHeight; },  
 268372: () => { if (document.fullscreenElement) return 1; },  
 268418: () => { return document.getElementById('canvas').width; },  
 268470: () => { return screen.width; },  
 268495: () => { document.exitFullscreen(); },  
 268522: () => { if (document.fullscreenElement) return 1; },  
 268568: () => { return document.getElementById('canvas').width; },  
 268620: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268688: () => { document.exitFullscreen(); },  
 268715: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268773: () => { return screen.width; },  
 268798: () => { return screen.height; },  
 268824: () => { return window.screenX; },  
 268851: () => { return window.screenY; },  
 268878: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268931: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269002: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269059: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269315: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269386: () => { if (document.fullscreenElement) return 1; },  
 269432: () => { return window.innerWidth; },  
 269458: () => { return window.innerHeight; },  
 269485: () => { if (document.pointerLockElement) return 1; }
};
