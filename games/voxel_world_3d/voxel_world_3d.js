...
var ASM_CONSTS = {
  269780: () => { if (document.fullscreenElement) return 1; },  
 269826: () => { return document.getElementById('canvas').width; },  
 269878: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269946: () => { document.exitFullscreen(); },  
 269973: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 270046: () => { if (document.fullscreenElement) return 1; },  
 270092: () => { return document.getElementById('canvas').width; },  
 270144: () => { return screen.width; },  
 270169: () => { document.exitFullscreen(); },  
 270196: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 270329: () => { return window.innerWidth; },  
 270355: () => { return window.innerHeight; },  
 ...
 270548: () => { if (document.fullscreenElement) return 1; },  
 270594: () => { return document.getElementById('canvas').width; },  
 270646: () => { return screen.width; },  
 270671: () => { return window.innerWidth; },  
 270697: () => { return window.innerHeight; },  
 270724: () => { if (document.fullscreenElement) return 1; },  
 270770: () => { return document.getElementById('canvas').width; },  
 270822: () => { return screen.width; },  
 270847: () => { document.exitFullscreen(); },  
 270874: () => { if (document.fullscreenElement) return 1; },  
 270920: () => { return document.getElementById('canvas').width; },  
 270972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271040: () => { document.exitFullscreen(); },  
 271067: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 271125: () => { return screen.width; },  
 271150: () => { return screen.height; },  
 271176: () => { return window.screenX; },  
 271203: () => { return window.screenY; },  
 271230: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 271283: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 271354: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 271411: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271667: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271738: () => { if (document.fullscreenElement) return 1; },  
 271784: () => { return window.innerWidth; },  
 271810: () => { return window.innerHeight; },  
 271837: () => { if (document.pointerLockElement) return 1; }
};
