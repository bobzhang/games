...
var ASM_CONSTS = {
  267076: () => { if (document.fullscreenElement) return 1; },  
 267122: () => { return document.getElementById('canvas').width; },  
 267174: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267242: () => { document.exitFullscreen(); },  
 267269: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267342: () => { if (document.fullscreenElement) return 1; },  
 267388: () => { return document.getElementById('canvas').width; },  
 267440: () => { return screen.width; },  
 267465: () => { document.exitFullscreen(); },  
 267492: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267625: () => { return window.innerWidth; },  
 267651: () => { return window.innerHeight; },  
 267678: () => { if (document.fullscreenElement) return 1; },  
 267724: () => { return document.getElementById('canvas').width; },  
 267776: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267844: () => { if (document.fullscreenElement) return 1; },  
 267890: () => { return document.getElementById('canvas').width; },  
 267942: () => { return screen.width; },  
 267967: () => { return window.innerWidth; },  
 267993: () => { return window.innerHeight; },  
 268020: () => { if (document.fullscreenElement) return 1; },  
 268066: () => { return document.getElementById('canvas').width; },  
 268118: () => { return screen.width; },  
 268143: () => { document.exitFullscreen(); },  
 268170: () => { if (document.fullscreenElement) return 1; },  
 268216: () => { return document.getElementById('canvas').width; },  
 268268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268336: () => { document.exitFullscreen(); },  
 268363: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268421: () => { return screen.width; },  
 268446: () => { return screen.height; },  
 268472: () => { return window.screenX; },  
 268499: () => { return window.screenY; },  
 268526: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268579: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268650: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268707: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268963: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269034: () => { if (document.fullscreenElement) return 1; },  
 269080: () => { return window.innerWidth; },  
 269106: () => { return window.innerHeight; },  
 269133: () => { if (document.pointerLockElement) return 1; }
};
