...
var ASM_CONSTS = {
  266852: () => { if (document.fullscreenElement) return 1; },  
 266898: () => { return document.getElementById('canvas').width; },  
 266950: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267018: () => { document.exitFullscreen(); },  
 267045: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267118: () => { if (document.fullscreenElement) return 1; },  
 267164: () => { return document.getElementById('canvas').width; },  
 267216: () => { return screen.width; },  
 267241: () => { document.exitFullscreen(); },  
 267268: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267401: () => { return window.innerWidth; },  
 267427: () => { return window.innerHeight; },  
 267454: () => { if (document.fullscreenElement) return 1; },  
 267500: () => { return document.getElementById('canvas').width; },  
 267552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267620: () => { if (document.fullscreenElement) return 1; },  
 267666: () => { return document.getElementById('canvas').width; },  
 267718: () => { return screen.width; },  
 267743: () => { return window.innerWidth; },  
 267769: () => { return window.innerHeight; },  
 267796: () => { if (document.fullscreenElement) return 1; },  
 267842: () => { return document.getElementById('canvas').width; },  
 267894: () => { return screen.width; },  
 267919: () => { document.exitFullscreen(); },  
 267946: () => { if (document.fullscreenElement) return 1; },  
 267992: () => { return document.getElementById('canvas').width; },  
 268044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268112: () => { document.exitFullscreen(); },  
 268139: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268197: () => { return screen.width; },  
 268222: () => { return screen.height; },  
 268248: () => { return window.screenX; },  
 268275: () => { return window.screenY; },  
 268302: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268355: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268426: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268483: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268739: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268810: () => { if (document.fullscreenElement) return 1; },  
 268856: () => { return window.innerWidth; },  
 268882: () => { return window.innerHeight; },  
 268909: () => { if (document.pointerLockElement) return 1; }
};
