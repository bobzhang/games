...
var ASM_CONSTS = {
  263348: () => { if (document.fullscreenElement) return 1; },  
 263394: () => { return document.getElementById('canvas').width; },  
 263446: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263514: () => { document.exitFullscreen(); },  
 263541: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263614: () => { if (document.fullscreenElement) return 1; },  
 263660: () => { return document.getElementById('canvas').width; },  
 263712: () => { return screen.width; },  
 263737: () => { document.exitFullscreen(); },  
 263764: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263897: () => { return window.innerWidth; },  
 263923: () => { return window.innerHeight; },  
 263950: () => { if (document.fullscreenElement) return 1; },  
 263996: () => { return document.getElementById('canvas').width; },  
 264048: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264239: () => { return window.innerWidth; },  
 264265: () => { return window.innerHeight; },  
 ...
 264415: () => { document.exitFullscreen(); },  
 264442: () => { if (document.fullscreenElement) return 1; },  
 264488: () => { return document.getElementById('canvas').width; },  
 264540: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264608: () => { document.exitFullscreen(); },  
 264635: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264693: () => { return screen.width; },  
 264718: () => { return screen.height; },  
 264744: () => { return window.screenX; },  
 264771: () => { return window.screenY; },  
 264798: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264851: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264922: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264979: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265235: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265306: () => { if (document.fullscreenElement) return 1; },  
 265352: () => { return window.innerWidth; },  
 265378: () => { return window.innerHeight; },  
 265405: () => { if (document.pointerLockElement) return 1; }
};
