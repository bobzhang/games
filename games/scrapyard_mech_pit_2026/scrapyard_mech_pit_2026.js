...
var ASM_CONSTS = {
 ...
 263654: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263722: () => { document.exitFullscreen(); },  
 263749: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263822: () => { if (document.fullscreenElement) return 1; },  
 263868: () => { return document.getElementById('canvas').width; },  
 263920: () => { return screen.width; },  
 263945: () => { document.exitFullscreen(); },  
 263972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264105: () => { return window.innerWidth; },  
 264131: () => { return window.innerHeight; },  
 264158: () => { if (document.fullscreenElement) return 1; },  
 264204: () => { return document.getElementById('canvas').width; },  
 264256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264447: () => { return window.innerWidth; },  
 264473: () => { return window.innerHeight; },  
 264500: () => { if (document.fullscreenElement) return 1; },  
 264546: () => { return document.getElementById('canvas').width; },  
 264598: () => { return screen.width; },  
 264623: () => { document.exitFullscreen(); },  
 264650: () => { if (document.fullscreenElement) return 1; },  
 264696: () => { return document.getElementById('canvas').width; },  
 264748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264816: () => { document.exitFullscreen(); },  
 264843: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264901: () => { return screen.width; },  
 264926: () => { return screen.height; },  
 264952: () => { return window.screenX; },  
 264979: () => { return window.screenY; },  
 265006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265059: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265130: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265443: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265514: () => { if (document.fullscreenElement) return 1; },  
 265560: () => { return window.innerWidth; },  
 265586: () => { return window.innerHeight; },  
 265613: () => { if (document.pointerLockElement) return 1; }
};
