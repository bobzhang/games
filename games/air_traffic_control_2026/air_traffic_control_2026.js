...
var ASM_CONSTS = {
  261268: () => { if (document.fullscreenElement) return 1; },  
 261314: () => { return document.getElementById('canvas').width; },  
 261366: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261434: () => { document.exitFullscreen(); },  
 261461: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261534: () => { if (document.fullscreenElement) return 1; },  
 261580: () => { return document.getElementById('canvas').width; },  
 261632: () => { return screen.width; },  
 261657: () => { document.exitFullscreen(); },  
 261684: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261817: () => { return window.innerWidth; },  
 261843: () => { return window.innerHeight; },  
 261870: () => { if (document.fullscreenElement) return 1; },  
 261916: () => { return document.getElementById('canvas').width; },  
 261968: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262036: () => { if (document.fullscreenElement) return 1; },  
 262082: () => { return document.getElementById('canvas').width; },  
 262134: () => { return screen.width; },  
 262159: () => { return window.innerWidth; },  
 262185: () => { return window.innerHeight; },  
 262212: () => { if (document.fullscreenElement) return 1; },  
 262258: () => { return document.getElementById('canvas').width; },  
 262310: () => { return screen.width; },  
 262335: () => { document.exitFullscreen(); },  
 ...
 262528: () => { document.exitFullscreen(); },  
 262555: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262613: () => { return screen.width; },  
 262638: () => { return screen.height; },  
 262664: () => { return window.screenX; },  
 262691: () => { return window.screenY; },  
 262718: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262771: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262842: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262899: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263155: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263226: () => { if (document.fullscreenElement) return 1; },  
 263272: () => { return window.innerWidth; },  
 263298: () => { return window.innerHeight; },  
 263325: () => { if (document.pointerLockElement) return 1; }
};
