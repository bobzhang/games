...
var ASM_CONSTS = {
 ...
 262454: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262522: () => { document.exitFullscreen(); },  
 262549: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262622: () => { if (document.fullscreenElement) return 1; },  
 262668: () => { return document.getElementById('canvas').width; },  
 262720: () => { return screen.width; },  
 262745: () => { document.exitFullscreen(); },  
 262772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262905: () => { return window.innerWidth; },  
 262931: () => { return window.innerHeight; },  
 262958: () => { if (document.fullscreenElement) return 1; },  
 263004: () => { return document.getElementById('canvas').width; },  
 263056: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263124: () => { if (document.fullscreenElement) return 1; },  
 263170: () => { return document.getElementById('canvas').width; },  
 263222: () => { return screen.width; },  
 263247: () => { return window.innerWidth; },  
 263273: () => { return window.innerHeight; },  
 263300: () => { if (document.fullscreenElement) return 1; },  
 263346: () => { return document.getElementById('canvas').width; },  
 263398: () => { return screen.width; },  
 263423: () => { document.exitFullscreen(); },  
 ...
 263616: () => { document.exitFullscreen(); },  
 263643: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263701: () => { return screen.width; },  
 263726: () => { return screen.height; },  
 263752: () => { return window.screenX; },  
 263779: () => { return window.screenY; },  
 263806: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263859: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263930: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263987: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264243: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264314: () => { if (document.fullscreenElement) return 1; },  
 264360: () => { return window.innerWidth; },  
 264386: () => { return window.innerHeight; },  
 264413: () => { if (document.pointerLockElement) return 1; }
};
