...
var ASM_CONSTS = {
 ...
 262262: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262330: () => { document.exitFullscreen(); },  
 262357: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262430: () => { if (document.fullscreenElement) return 1; },  
 262476: () => { return document.getElementById('canvas').width; },  
 262528: () => { return screen.width; },  
 262553: () => { document.exitFullscreen(); },  
 262580: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262713: () => { return window.innerWidth; },  
 262739: () => { return window.innerHeight; },  
 262766: () => { if (document.fullscreenElement) return 1; },  
 262812: () => { return document.getElementById('canvas').width; },  
 262864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263055: () => { return window.innerWidth; },  
 263081: () => { return window.innerHeight; },  
 ...
 263231: () => { document.exitFullscreen(); },  
 ...
 263424: () => { document.exitFullscreen(); },  
 263451: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263509: () => { return screen.width; },  
 263534: () => { return screen.height; },  
 263560: () => { return window.screenX; },  
 263587: () => { return window.screenY; },  
 263614: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263667: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263738: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263795: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264051: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264122: () => { if (document.fullscreenElement) return 1; },  
 264168: () => { return window.innerWidth; },  
 264194: () => { return window.innerHeight; },  
 264221: () => { if (document.pointerLockElement) return 1; }
};
