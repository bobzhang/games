...
var ASM_CONSTS = {
 ...
 262470: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262538: () => { document.exitFullscreen(); },  
 262565: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262638: () => { if (document.fullscreenElement) return 1; },  
 262684: () => { return document.getElementById('canvas').width; },  
 262736: () => { return screen.width; },  
 262761: () => { document.exitFullscreen(); },  
 262788: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262921: () => { return window.innerWidth; },  
 262947: () => { return window.innerHeight; },  
 262974: () => { if (document.fullscreenElement) return 1; },  
 263020: () => { return document.getElementById('canvas').width; },  
 263072: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263263: () => { return window.innerWidth; },  
 263289: () => { return window.innerHeight; },  
 ...
 263439: () => { document.exitFullscreen(); },  
 ...
 263632: () => { document.exitFullscreen(); },  
 263659: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263717: () => { return screen.width; },  
 263742: () => { return screen.height; },  
 263768: () => { return window.screenX; },  
 263795: () => { return window.screenY; },  
 263822: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263875: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263946: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264003: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264259: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264330: () => { if (document.fullscreenElement) return 1; },  
 264376: () => { return window.innerWidth; },  
 264402: () => { return window.innerHeight; },  
 264429: () => { if (document.pointerLockElement) return 1; }
};
