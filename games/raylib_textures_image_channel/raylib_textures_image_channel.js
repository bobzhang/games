...
function findWasmBinary() {
  return locateFile('raylib_textures_image_channel.wasm');
}
...
var ASM_CONSTS = {
  329712: () => { if (document.fullscreenElement) return 1; },  
 329758: () => { return document.getElementById('canvas').width; },  
 329810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 329878: () => { document.exitFullscreen(); },  
 329905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 329978: () => { if (document.fullscreenElement) return 1; },  
 330024: () => { return document.getElementById('canvas').width; },  
 330076: () => { return screen.width; },  
 330101: () => { document.exitFullscreen(); },  
 330128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 330261: () => { return window.innerWidth; },  
 330287: () => { return window.innerHeight; },  
 330314: () => { if (document.fullscreenElement) return 1; },  
 330360: () => { return document.getElementById('canvas').width; },  
 330412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 330480: () => { if (document.fullscreenElement) return 1; },  
 330526: () => { return document.getElementById('canvas').width; },  
 330578: () => { return screen.width; },  
 330603: () => { return window.innerWidth; },  
 330629: () => { return window.innerHeight; },  
 330656: () => { if (document.fullscreenElement) return 1; },  
 330702: () => { return document.getElementById('canvas').width; },  
 330754: () => { return screen.width; },  
 330779: () => { document.exitFullscreen(); },  
 330806: () => { if (document.fullscreenElement) return 1; },  
 330852: () => { return document.getElementById('canvas').width; },  
 330904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 330972: () => { document.exitFullscreen(); },  
 330999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 331057: () => { return screen.width; },  
 331082: () => { return screen.height; },  
 331108: () => { return window.screenX; },  
 331135: () => { return window.screenY; },  
 331162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 331215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 331286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 331343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 331599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 331670: () => { if (document.fullscreenElement) return 1; },  
 331716: () => { return window.innerWidth; },  
 331742: () => { return window.innerHeight; },  
 331769: () => { if (document.pointerLockElement) return 1; }
};
