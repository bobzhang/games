...
var ASM_CONSTS = {
 ...
 99042: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99110: () => { document.exitFullscreen(); },  
 99137: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99210: () => { if (document.fullscreenElement) return 1; },  
 99256: () => { return document.getElementById('canvas').width; },  
 99308: () => { return screen.width; },  
 99333: () => { document.exitFullscreen(); },  
 99360: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99493: () => { return window.innerWidth; },  
 99519: () => { return window.innerHeight; },  
 99546: () => { if (document.fullscreenElement) return 1; },  
 99592: () => { return document.getElementById('canvas').width; },  
 99644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99712: () => { if (document.fullscreenElement) return 1; },  
 99758: () => { return document.getElementById('canvas').width; },  
 99810: () => { return screen.width; },  
 99835: () => { return window.innerWidth; },  
 99861: () => { return window.innerHeight; },  
 99888: () => { if (document.fullscreenElement) return 1; },  
 99934: () => { return document.getElementById('canvas').width; },  
 99986: () => { return screen.width; },  
 100011: () => { document.exitFullscreen(); },  
 100038: () => { if (document.fullscreenElement) return 1; },  
 100084: () => { return document.getElementById('canvas').width; },  
 100136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100204: () => { document.exitFullscreen(); },  
 100231: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100289: () => { return screen.width; },  
 100314: () => { return screen.height; },  
 100340: () => { return window.screenX; },  
 100367: () => { return window.screenY; },  
 100394: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100447: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100518: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100575: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100831: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100902: () => { if (document.fullscreenElement) return 1; },  
 100948: () => { return window.innerWidth; },  
 100974: () => { return window.innerHeight; },  
 101001: () => { if (document.pointerLockElement) return 1; }
};
