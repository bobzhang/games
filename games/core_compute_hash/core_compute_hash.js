...
var ASM_CONSTS = {
 ...
 262886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262954: () => { document.exitFullscreen(); },  
 262981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263054: () => { if (document.fullscreenElement) return 1; },  
 263100: () => { return document.getElementById('canvas').width; },  
 263152: () => { return screen.width; },  
 263177: () => { document.exitFullscreen(); },  
 263204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263337: () => { return window.innerWidth; },  
 263363: () => { return window.innerHeight; },  
 263390: () => { if (document.fullscreenElement) return 1; },  
 263436: () => { return document.getElementById('canvas').width; },  
 263488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263679: () => { return window.innerWidth; },  
 263705: () => { return window.innerHeight; },  
 263732: () => { if (document.fullscreenElement) return 1; },  
 263778: () => { return document.getElementById('canvas').width; },  
 263830: () => { return screen.width; },  
 263855: () => { document.exitFullscreen(); },  
 263882: () => { if (document.fullscreenElement) return 1; },  
 263928: () => { return document.getElementById('canvas').width; },  
 263980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264048: () => { document.exitFullscreen(); },  
 264075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264133: () => { return screen.width; },  
 264158: () => { return screen.height; },  
 264184: () => { return window.screenX; },  
 264211: () => { return window.screenY; },  
 264238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264746: () => { if (document.fullscreenElement) return 1; },  
 264792: () => { return window.innerWidth; },  
 264818: () => { return window.innerHeight; },  
 264845: () => { if (document.pointerLockElement) return 1; }
};
