...
var ASM_CONSTS = {
  267892: () => { if (document.fullscreenElement) return 1; },  
 267938: () => { return document.getElementById('canvas').width; },  
 267990: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268058: () => { document.exitFullscreen(); },  
 268085: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268158: () => { if (document.fullscreenElement) return 1; },  
 268204: () => { return document.getElementById('canvas').width; },  
 268256: () => { return screen.width; },  
 268281: () => { document.exitFullscreen(); },  
 268308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268441: () => { return window.innerWidth; },  
 268467: () => { return window.innerHeight; },  
 268494: () => { if (document.fullscreenElement) return 1; },  
 268540: () => { return document.getElementById('canvas').width; },  
 268592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268660: () => { if (document.fullscreenElement) return 1; },  
 268706: () => { return document.getElementById('canvas').width; },  
 268758: () => { return screen.width; },  
 268783: () => { return window.innerWidth; },  
 268809: () => { return window.innerHeight; },  
 268836: () => { if (document.fullscreenElement) return 1; },  
 268882: () => { return document.getElementById('canvas').width; },  
 268934: () => { return screen.width; },  
 268959: () => { document.exitFullscreen(); },  
 268986: () => { if (document.fullscreenElement) return 1; },  
 269032: () => { return document.getElementById('canvas').width; },  
 269084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269152: () => { document.exitFullscreen(); },  
 269179: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269237: () => { return screen.width; },  
 269262: () => { return screen.height; },  
 269288: () => { return window.screenX; },  
 269315: () => { return window.screenY; },  
 269342: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269395: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269466: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269523: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269779: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269850: () => { if (document.fullscreenElement) return 1; },  
 269896: () => { return window.innerWidth; },  
 269922: () => { return window.innerHeight; },  
 269949: () => { if (document.pointerLockElement) return 1; }
};
