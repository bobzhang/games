...
var ASM_CONSTS = {
  268788: () => { if (document.fullscreenElement) return 1; },  
 268834: () => { return document.getElementById('canvas').width; },  
 268886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268954: () => { document.exitFullscreen(); },  
 268981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269054: () => { if (document.fullscreenElement) return 1; },  
 269100: () => { return document.getElementById('canvas').width; },  
 269152: () => { return screen.width; },  
 269177: () => { document.exitFullscreen(); },  
 269204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269337: () => { return window.innerWidth; },  
 269363: () => { return window.innerHeight; },  
 ...
 269556: () => { if (document.fullscreenElement) return 1; },  
 269602: () => { return document.getElementById('canvas').width; },  
 269654: () => { return screen.width; },  
 269679: () => { return window.innerWidth; },  
 269705: () => { return window.innerHeight; },  
 269732: () => { if (document.fullscreenElement) return 1; },  
 269778: () => { return document.getElementById('canvas').width; },  
 269830: () => { return screen.width; },  
 269855: () => { document.exitFullscreen(); },  
 269882: () => { if (document.fullscreenElement) return 1; },  
 269928: () => { return document.getElementById('canvas').width; },  
 269980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 270048: () => { document.exitFullscreen(); },  
 270075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270133: () => { return screen.width; },  
 270158: () => { return screen.height; },  
 270184: () => { return window.screenX; },  
 270211: () => { return window.screenY; },  
 270238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270746: () => { if (document.fullscreenElement) return 1; },  
 270792: () => { return window.innerWidth; },  
 270818: () => { return window.innerHeight; },  
 270845: () => { if (document.pointerLockElement) return 1; }
};
