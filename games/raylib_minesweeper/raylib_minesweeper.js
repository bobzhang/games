...
function findWasmBinary() {
  return locateFile('raylib_minesweeper.wasm');
}
...
var ASM_CONSTS = {
  96896: () => { if (document.fullscreenElement) return 1; },  
 96942: () => { return document.getElementById('canvas').width; },  
 96994: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97062: () => { document.exitFullscreen(); },  
 97089: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97162: () => { if (document.fullscreenElement) return 1; },  
 97208: () => { return document.getElementById('canvas').width; },  
 97260: () => { return screen.width; },  
 97285: () => { document.exitFullscreen(); },  
 97312: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97445: () => { return window.innerWidth; },  
 97471: () => { return window.innerHeight; },  
 97498: () => { if (document.fullscreenElement) return 1; },  
 97544: () => { return document.getElementById('canvas').width; },  
 97596: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97664: () => { if (document.fullscreenElement) return 1; },  
 97710: () => { return document.getElementById('canvas').width; },  
 97762: () => { return screen.width; },  
 97787: () => { return window.innerWidth; },  
 97813: () => { return window.innerHeight; },  
 97840: () => { if (document.fullscreenElement) return 1; },  
 97886: () => { return document.getElementById('canvas').width; },  
 97938: () => { return screen.width; },  
 97963: () => { document.exitFullscreen(); },  
 97990: () => { if (document.fullscreenElement) return 1; },  
 98036: () => { return document.getElementById('canvas').width; },  
 98088: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98156: () => { document.exitFullscreen(); },  
 98183: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98241: () => { return screen.width; },  
 98266: () => { return screen.height; },  
 98292: () => { return window.screenX; },  
 98319: () => { return window.screenY; },  
 98346: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98399: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98470: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98527: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98783: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98854: () => { if (document.fullscreenElement) return 1; },  
 98900: () => { return window.innerWidth; },  
 98926: () => { return window.innerHeight; },  
 98953: () => { if (document.pointerLockElement) return 1; }
};
