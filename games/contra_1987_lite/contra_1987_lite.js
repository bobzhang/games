...
var ASM_CONSTS = {
  309556: () => { if (document.fullscreenElement) return 1; },  
 309602: () => { return document.getElementById('canvas').width; },  
 309654: () => { return parseInt(document.getElementById('canvas').style.width); },  
 309722: () => { document.exitFullscreen(); },  
 309749: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 309822: () => { if (document.fullscreenElement) return 1; },  
 309868: () => { return document.getElementById('canvas').width; },  
 309920: () => { return screen.width; },  
 309945: () => { document.exitFullscreen(); },  
 309972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 310105: () => { return window.innerWidth; },  
 310131: () => { return window.innerHeight; },  
 310158: () => { if (document.fullscreenElement) return 1; },  
 310204: () => { return document.getElementById('canvas').width; },  
 310256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310324: () => { if (document.fullscreenElement) return 1; },  
 310370: () => { return document.getElementById('canvas').width; },  
 310422: () => { return screen.width; },  
 310447: () => { return window.innerWidth; },  
 310473: () => { return window.innerHeight; },  
 310500: () => { if (document.fullscreenElement) return 1; },  
 310546: () => { return document.getElementById('canvas').width; },  
 310598: () => { return screen.width; },  
 310623: () => { document.exitFullscreen(); },  
 310650: () => { if (document.fullscreenElement) return 1; },  
 310696: () => { return document.getElementById('canvas').width; },  
 310748: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310816: () => { document.exitFullscreen(); },  
 310843: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 310901: () => { return screen.width; },  
 310926: () => { return screen.height; },  
 310952: () => { return window.screenX; },  
 310979: () => { return window.screenY; },  
 311006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 311059: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 311130: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 311187: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 311443: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 311514: () => { if (document.fullscreenElement) return 1; },  
 311560: () => { return window.innerWidth; },  
 311586: () => { return window.innerHeight; },  
 311613: () => { if (document.pointerLockElement) return 1; }
};
