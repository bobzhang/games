...
function findWasmBinary() {
  return locateFile('raylib_textures_bunnymark.wasm');
}
...
var ASM_CONSTS = {
 ...
 101586: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101654: () => { document.exitFullscreen(); },  
 101681: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101754: () => { if (document.fullscreenElement) return 1; },  
 101800: () => { return document.getElementById('canvas').width; },  
 101852: () => { return screen.width; },  
 101877: () => { document.exitFullscreen(); },  
 101904: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102037: () => { return window.innerWidth; },  
 102063: () => { return window.innerHeight; },  
 102090: () => { if (document.fullscreenElement) return 1; },  
 102136: () => { return document.getElementById('canvas').width; },  
 102188: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102256: () => { if (document.fullscreenElement) return 1; },  
 102302: () => { return document.getElementById('canvas').width; },  
 102354: () => { return screen.width; },  
 102379: () => { return window.innerWidth; },  
 102405: () => { return window.innerHeight; },  
 102432: () => { if (document.fullscreenElement) return 1; },  
 102478: () => { return document.getElementById('canvas').width; },  
 102530: () => { return screen.width; },  
 102555: () => { document.exitFullscreen(); },  
 102582: () => { if (document.fullscreenElement) return 1; },  
 102628: () => { return document.getElementById('canvas').width; },  
 102680: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102748: () => { document.exitFullscreen(); },  
 102775: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102833: () => { return screen.width; },  
 102858: () => { return screen.height; },  
 102884: () => { return window.screenX; },  
 102911: () => { return window.screenY; },  
 102938: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102991: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103062: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103119: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103375: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103446: () => { if (document.fullscreenElement) return 1; },  
 103492: () => { return window.innerWidth; },  
 103518: () => { return window.innerHeight; },  
 103545: () => { if (document.pointerLockElement) return 1; }
};
