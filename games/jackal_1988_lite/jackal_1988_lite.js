...
var ASM_CONSTS = {
  309812: () => { if (document.fullscreenElement) return 1; },  
 309858: () => { return document.getElementById('canvas').width; },  
 309910: () => { return parseInt(document.getElementById('canvas').style.width); },  
 309978: () => { document.exitFullscreen(); },  
 310005: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 310078: () => { if (document.fullscreenElement) return 1; },  
 310124: () => { return document.getElementById('canvas').width; },  
 310176: () => { return screen.width; },  
 310201: () => { document.exitFullscreen(); },  
 310228: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 310361: () => { return window.innerWidth; },  
 310387: () => { return window.innerHeight; },  
 310414: () => { if (document.fullscreenElement) return 1; },  
 310460: () => { return document.getElementById('canvas').width; },  
 310512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310580: () => { if (document.fullscreenElement) return 1; },  
 310626: () => { return document.getElementById('canvas').width; },  
 310678: () => { return screen.width; },  
 310703: () => { return window.innerWidth; },  
 310729: () => { return window.innerHeight; },  
 310756: () => { if (document.fullscreenElement) return 1; },  
 310802: () => { return document.getElementById('canvas').width; },  
 310854: () => { return screen.width; },  
 310879: () => { document.exitFullscreen(); },  
 310906: () => { if (document.fullscreenElement) return 1; },  
 310952: () => { return document.getElementById('canvas').width; },  
 311004: () => { return parseInt(document.getElementById('canvas').style.width); },  
 311072: () => { document.exitFullscreen(); },  
 311099: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 311157: () => { return screen.width; },  
 311182: () => { return screen.height; },  
 311208: () => { return window.screenX; },  
 311235: () => { return window.screenY; },  
 311262: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 311315: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 311386: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 311443: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 311699: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 311770: () => { if (document.fullscreenElement) return 1; },  
 311816: () => { return window.innerWidth; },  
 311842: () => { return window.innerHeight; },  
 311869: () => { if (document.pointerLockElement) return 1; }
};
