...
var ASM_CONSTS = {
  309588: () => { if (document.fullscreenElement) return 1; },  
 309634: () => { return document.getElementById('canvas').width; },  
 309686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 309754: () => { document.exitFullscreen(); },  
 309781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 309854: () => { if (document.fullscreenElement) return 1; },  
 309900: () => { return document.getElementById('canvas').width; },  
 309952: () => { return screen.width; },  
 309977: () => { document.exitFullscreen(); },  
 310004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 310137: () => { return window.innerWidth; },  
 310163: () => { return window.innerHeight; },  
 310190: () => { if (document.fullscreenElement) return 1; },  
 310236: () => { return document.getElementById('canvas').width; },  
 310288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310356: () => { if (document.fullscreenElement) return 1; },  
 310402: () => { return document.getElementById('canvas').width; },  
 310454: () => { return screen.width; },  
 310479: () => { return window.innerWidth; },  
 310505: () => { return window.innerHeight; },  
 ...
 310655: () => { document.exitFullscreen(); },  
 310682: () => { if (document.fullscreenElement) return 1; },  
 310728: () => { return document.getElementById('canvas').width; },  
 310780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 310848: () => { document.exitFullscreen(); },  
 310875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 310933: () => { return screen.width; },  
 310958: () => { return screen.height; },  
 310984: () => { return window.screenX; },  
 311011: () => { return window.screenY; },  
 311038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 311091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 311162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 311219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 311475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 311546: () => { if (document.fullscreenElement) return 1; },  
 311592: () => { return window.innerWidth; },  
 311618: () => { return window.innerHeight; },  
 311645: () => { if (document.pointerLockElement) return 1; }
};
