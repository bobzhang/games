...
var ASM_CONSTS = {
  268168: () => { if (document.fullscreenElement) return 1; },  
 268214: () => { return document.getElementById('canvas').width; },  
 268266: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268334: () => { document.exitFullscreen(); },  
 268361: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268434: () => { if (document.fullscreenElement) return 1; },  
 268480: () => { return document.getElementById('canvas').width; },  
 268532: () => { return screen.width; },  
 268557: () => { document.exitFullscreen(); },  
 268584: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268717: () => { return window.innerWidth; },  
 268743: () => { return window.innerHeight; },  
 268770: () => { if (document.fullscreenElement) return 1; },  
 268816: () => { return document.getElementById('canvas').width; },  
 268868: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268936: () => { if (document.fullscreenElement) return 1; },  
 268982: () => { return document.getElementById('canvas').width; },  
 269034: () => { return screen.width; },  
 269059: () => { return window.innerWidth; },  
 269085: () => { return window.innerHeight; },  
 269112: () => { if (document.fullscreenElement) return 1; },  
 269158: () => { return document.getElementById('canvas').width; },  
 269210: () => { return screen.width; },  
 269235: () => { document.exitFullscreen(); },  
 269262: () => { if (document.fullscreenElement) return 1; },  
 269308: () => { return document.getElementById('canvas').width; },  
 269360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269428: () => { document.exitFullscreen(); },  
 269455: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269513: () => { return screen.width; },  
 269538: () => { return screen.height; },  
 269564: () => { return window.screenX; },  
 269591: () => { return window.screenY; },  
 269618: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269671: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269742: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269799: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270055: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270126: () => { if (document.fullscreenElement) return 1; },  
 270172: () => { return window.innerWidth; },  
 270198: () => { return window.innerHeight; },  
 270225: () => { if (document.pointerLockElement) return 1; },  
