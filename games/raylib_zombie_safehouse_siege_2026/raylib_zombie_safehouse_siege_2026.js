...
var ASM_CONSTS = {
 ...
 98786: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98854: () => { document.exitFullscreen(); },  
 98881: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98954: () => { if (document.fullscreenElement) return 1; },  
 99000: () => { return document.getElementById('canvas').width; },  
 99052: () => { return screen.width; },  
 99077: () => { document.exitFullscreen(); },  
 99104: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99237: () => { return window.innerWidth; },  
 99263: () => { return window.innerHeight; },  
 99290: () => { if (document.fullscreenElement) return 1; },  
 99336: () => { return document.getElementById('canvas').width; },  
 99388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99456: () => { if (document.fullscreenElement) return 1; },  
 99502: () => { return document.getElementById('canvas').width; },  
 99554: () => { return screen.width; },  
 99579: () => { return window.innerWidth; },  
 99605: () => { return window.innerHeight; },  
 99632: () => { if (document.fullscreenElement) return 1; },  
 99678: () => { return document.getElementById('canvas').width; },  
 99730: () => { return screen.width; },  
 99755: () => { document.exitFullscreen(); },  
 99782: () => { if (document.fullscreenElement) return 1; },  
 99828: () => { return document.getElementById('canvas').width; },  
 99880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99948: () => { document.exitFullscreen(); },  
 99975: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100033: () => { return screen.width; },  
 100058: () => { return screen.height; },  
 100084: () => { return window.screenX; },  
 100111: () => { return window.screenY; },  
 100138: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100191: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100262: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100319: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100575: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100646: () => { if (document.fullscreenElement) return 1; },  
 100692: () => { return window.innerWidth; },  
 100718: () => { return window.innerHeight; },  
 100745: () => { if (document.pointerLockElement) return 1; }
};
