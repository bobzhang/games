...
function findWasmBinary() {
  return locateFile('raylib_easings_testbed.wasm');
}
...
var ASM_CONSTS = {
 ...
 99938: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100006: () => { document.exitFullscreen(); },  
 100033: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100106: () => { if (document.fullscreenElement) return 1; },  
 100152: () => { return document.getElementById('canvas').width; },  
 100204: () => { return screen.width; },  
 100229: () => { document.exitFullscreen(); },  
 100256: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100389: () => { return window.innerWidth; },  
 100415: () => { return window.innerHeight; },  
 100442: () => { if (document.fullscreenElement) return 1; },  
 100488: () => { return document.getElementById('canvas').width; },  
 100540: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100731: () => { return window.innerWidth; },  
 100757: () => { return window.innerHeight; },  
 100784: () => { if (document.fullscreenElement) return 1; },  
 100830: () => { return document.getElementById('canvas').width; },  
 100882: () => { return screen.width; },  
 100907: () => { document.exitFullscreen(); },  
 100934: () => { if (document.fullscreenElement) return 1; },  
 100980: () => { return document.getElementById('canvas').width; },  
 101032: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101100: () => { document.exitFullscreen(); },  
 101127: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101185: () => { return screen.width; },  
 101210: () => { return screen.height; },  
 101236: () => { return window.screenX; },  
 101263: () => { return window.screenY; },  
 101290: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101343: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101414: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101471: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101727: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101798: () => { if (document.fullscreenElement) return 1; },  
 101844: () => { return window.innerWidth; },  
 101870: () => { return window.innerHeight; },  
 101897: () => { if (document.pointerLockElement) return 1; }
};
