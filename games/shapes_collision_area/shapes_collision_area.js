...
var ASM_CONSTS = {
  260580: () => { if (document.fullscreenElement) return 1; },  
 260626: () => { return document.getElementById('canvas').width; },  
 260678: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260746: () => { document.exitFullscreen(); },  
 260773: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260846: () => { if (document.fullscreenElement) return 1; },  
 260892: () => { return document.getElementById('canvas').width; },  
 260944: () => { return screen.width; },  
 260969: () => { document.exitFullscreen(); },  
 260996: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261129: () => { return window.innerWidth; },  
 261155: () => { return window.innerHeight; },  
 261182: () => { if (document.fullscreenElement) return 1; },  
 261228: () => { return document.getElementById('canvas').width; },  
 261280: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261348: () => { if (document.fullscreenElement) return 1; },  
 261394: () => { return document.getElementById('canvas').width; },  
 261446: () => { return screen.width; },  
 261471: () => { return window.innerWidth; },  
 261497: () => { return window.innerHeight; },  
 ...
 261647: () => { document.exitFullscreen(); },  
 ...
 261840: () => { document.exitFullscreen(); },  
 261867: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261925: () => { return screen.width; },  
 261950: () => { return screen.height; },  
 261976: () => { return window.screenX; },  
 262003: () => { return window.screenY; },  
 262030: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262083: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262154: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262211: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262467: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262538: () => { if (document.fullscreenElement) return 1; },  
 262584: () => { return window.innerWidth; },  
 262610: () => { return window.innerHeight; },  
 262637: () => { if (document.pointerLockElement) return 1; }
};
