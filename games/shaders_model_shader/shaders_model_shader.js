...
var ASM_CONSTS = {
 ...
 273238: () => { return parseInt(document.getElementById('canvas').style.width); },  
 273306: () => { document.exitFullscreen(); },  
 273333: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 273406: () => { if (document.fullscreenElement) return 1; },  
 273452: () => { return document.getElementById('canvas').width; },  
 273504: () => { return screen.width; },  
 273529: () => { document.exitFullscreen(); },  
 273556: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 273689: () => { return window.innerWidth; },  
 273715: () => { return window.innerHeight; },  
 273742: () => { if (document.fullscreenElement) return 1; },  
 273788: () => { return document.getElementById('canvas').width; },  
 273840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 274031: () => { return window.innerWidth; },  
 274057: () => { return window.innerHeight; },  
 274084: () => { if (document.fullscreenElement) return 1; },  
 274130: () => { return document.getElementById('canvas').width; },  
 274182: () => { return screen.width; },  
 274207: () => { document.exitFullscreen(); },  
 274234: () => { if (document.fullscreenElement) return 1; },  
 274280: () => { return document.getElementById('canvas').width; },  
 274332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274400: () => { document.exitFullscreen(); },  
 274427: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 274485: () => { return screen.width; },  
 274510: () => { return screen.height; },  
 274536: () => { return window.screenX; },  
 274563: () => { return window.screenY; },  
 274590: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 274643: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 274714: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 274771: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 275027: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 275098: () => { if (document.fullscreenElement) return 1; },  
 275144: () => { return window.innerWidth; },  
 275170: () => { return window.innerHeight; },  
 275197: () => { if (document.pointerLockElement) return 1; }
};
