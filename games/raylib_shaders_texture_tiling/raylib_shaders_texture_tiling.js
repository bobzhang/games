...
function findWasmBinary() {
  return locateFile('raylib_shaders_texture_tiling.wasm');
}
...
var ASM_CONSTS = {
  102624: () => { if (document.fullscreenElement) return 1; },  
 102670: () => { return document.getElementById('canvas').width; },  
 102722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102790: () => { document.exitFullscreen(); },  
 102817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 102890: () => { if (document.fullscreenElement) return 1; },  
 102936: () => { return document.getElementById('canvas').width; },  
 102988: () => { return screen.width; },  
 103013: () => { document.exitFullscreen(); },  
 103040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103173: () => { return window.innerWidth; },  
 103199: () => { return window.innerHeight; },  
 103226: () => { if (document.fullscreenElement) return 1; },  
 103272: () => { return document.getElementById('canvas').width; },  
 103324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103392: () => { if (document.fullscreenElement) return 1; },  
 103438: () => { return document.getElementById('canvas').width; },  
 103490: () => { return screen.width; },  
 103515: () => { return window.innerWidth; },  
 103541: () => { return window.innerHeight; },  
 103568: () => { if (document.fullscreenElement) return 1; },  
 103614: () => { return document.getElementById('canvas').width; },  
 103666: () => { return screen.width; },  
 103691: () => { document.exitFullscreen(); },  
 103718: () => { if (document.fullscreenElement) return 1; },  
 103764: () => { return document.getElementById('canvas').width; },  
 103816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103884: () => { document.exitFullscreen(); },  
 103911: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 103969: () => { return screen.width; },  
 103994: () => { return screen.height; },  
 104020: () => { return window.screenX; },  
 104047: () => { return window.screenY; },  
 104074: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104127: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104198: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 104255: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104511: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104582: () => { if (document.fullscreenElement) return 1; },  
 104628: () => { return window.innerWidth; },  
 104654: () => { return window.innerHeight; },  
 104681: () => { if (document.pointerLockElement) return 1; }
};
