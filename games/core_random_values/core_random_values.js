...
var ASM_CONSTS = {
  260644: () => { if (document.fullscreenElement) return 1; },  
 260690: () => { return document.getElementById('canvas').width; },  
 260742: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260810: () => { document.exitFullscreen(); },  
 260837: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260910: () => { if (document.fullscreenElement) return 1; },  
 260956: () => { return document.getElementById('canvas').width; },  
 261008: () => { return screen.width; },  
 261033: () => { document.exitFullscreen(); },  
 261060: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261193: () => { return window.innerWidth; },  
 261219: () => { return window.innerHeight; },  
 261246: () => { if (document.fullscreenElement) return 1; },  
 261292: () => { return document.getElementById('canvas').width; },  
 261344: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261412: () => { if (document.fullscreenElement) return 1; },  
 261458: () => { return document.getElementById('canvas').width; },  
 261510: () => { return screen.width; },  
 261535: () => { return window.innerWidth; },  
 261561: () => { return window.innerHeight; },  
 ...
 261711: () => { document.exitFullscreen(); },  
 ...
 261904: () => { document.exitFullscreen(); },  
 261931: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261989: () => { return screen.width; },  
 262014: () => { return screen.height; },  
 262040: () => { return window.screenX; },  
 262067: () => { return window.screenY; },  
 262094: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262147: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262218: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262275: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262531: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262602: () => { if (document.fullscreenElement) return 1; },  
 262648: () => { return window.innerWidth; },  
 262674: () => { return window.innerHeight; },  
 262701: () => { if (document.pointerLockElement) return 1; }
};
