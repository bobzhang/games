...
var ASM_CONSTS = {
  256740: () => { if (document.fullscreenElement) return 1; },  
 256786: () => { return document.getElementById('canvas').width; },  
 256838: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256906: () => { document.exitFullscreen(); },  
 256933: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 257006: () => { if (document.fullscreenElement) return 1; },  
 257052: () => { return document.getElementById('canvas').width; },  
 257104: () => { return screen.width; },  
 257129: () => { document.exitFullscreen(); },  
 257156: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 257289: () => { return window.innerWidth; },  
 257315: () => { return window.innerHeight; },  
 257342: () => { if (document.fullscreenElement) return 1; },  
 257388: () => { return document.getElementById('canvas').width; },  
 257440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257508: () => { if (document.fullscreenElement) return 1; },  
 257554: () => { return document.getElementById('canvas').width; },  
 257606: () => { return screen.width; },  
 257631: () => { return window.innerWidth; },  
 257657: () => { return window.innerHeight; },  
 257684: () => { if (document.fullscreenElement) return 1; },  
 257730: () => { return document.getElementById('canvas').width; },  
 257782: () => { return screen.width; },  
 257807: () => { document.exitFullscreen(); },  
 257834: () => { if (document.fullscreenElement) return 1; },  
 257880: () => { return document.getElementById('canvas').width; },  
 257932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 258000: () => { document.exitFullscreen(); },  
 258027: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 258085: () => { return screen.width; },  
 258110: () => { return screen.height; },  
 258136: () => { return window.screenX; },  
 258163: () => { return window.screenY; },  
 258190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 258243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 258314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 258371: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 258627: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 258698: () => { if (document.fullscreenElement) return 1; },  
 258744: () => { return window.innerWidth; },  
 258770: () => { return window.innerHeight; },  
 258797: () => { if (document.pointerLockElement) return 1; }
};
