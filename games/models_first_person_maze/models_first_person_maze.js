...
var ASM_CONSTS = {
  256516: () => { if (document.fullscreenElement) return 1; },  
 256562: () => { return document.getElementById('canvas').width; },  
 256614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256682: () => { document.exitFullscreen(); },  
 256709: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 256782: () => { if (document.fullscreenElement) return 1; },  
 256828: () => { return document.getElementById('canvas').width; },  
 256880: () => { return screen.width; },  
 256905: () => { document.exitFullscreen(); },  
 256932: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 257065: () => { return window.innerWidth; },  
 257091: () => { return window.innerHeight; },  
 257118: () => { if (document.fullscreenElement) return 1; },  
 257164: () => { return document.getElementById('canvas').width; },  
 257216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257284: () => { if (document.fullscreenElement) return 1; },  
 257330: () => { return document.getElementById('canvas').width; },  
 257382: () => { return screen.width; },  
 257407: () => { return window.innerWidth; },  
 257433: () => { return window.innerHeight; },  
 ...
 257583: () => { document.exitFullscreen(); },  
 257610: () => { if (document.fullscreenElement) return 1; },  
 257656: () => { return document.getElementById('canvas').width; },  
 257708: () => { return parseInt(document.getElementById('canvas').style.width); },  
 257776: () => { document.exitFullscreen(); },  
 257803: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 257861: () => { return screen.width; },  
 257886: () => { return screen.height; },  
 257912: () => { return window.screenX; },  
 257939: () => { return window.screenY; },  
 257966: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 258019: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 258090: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 258147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 258403: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 258474: () => { if (document.fullscreenElement) return 1; },  
 258520: () => { return window.innerWidth; },  
 258546: () => { return window.innerHeight; },  
 258573: () => { if (document.pointerLockElement) return 1; }
};
