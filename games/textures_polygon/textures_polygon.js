...
var ASM_CONSTS = {
  652772: () => { if (document.fullscreenElement) return 1; },  
 652818: () => { return document.getElementById('canvas').width; },  
 652870: () => { return parseInt(document.getElementById('canvas').style.width); },  
 652938: () => { document.exitFullscreen(); },  
 652965: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 653038: () => { if (document.fullscreenElement) return 1; },  
 653084: () => { return document.getElementById('canvas').width; },  
 653136: () => { return screen.width; },  
 653161: () => { document.exitFullscreen(); },  
 653188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 653321: () => { return window.innerWidth; },  
 653347: () => { return window.innerHeight; },  
 653374: () => { if (document.fullscreenElement) return 1; },  
 653420: () => { return document.getElementById('canvas').width; },  
 653472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 653540: () => { if (document.fullscreenElement) return 1; },  
 653586: () => { return document.getElementById('canvas').width; },  
 653638: () => { return screen.width; },  
 653663: () => { return window.innerWidth; },  
 653689: () => { return window.innerHeight; },  
 653716: () => { if (document.fullscreenElement) return 1; },  
 653762: () => { return document.getElementById('canvas').width; },  
 653814: () => { return screen.width; },  
 653839: () => { document.exitFullscreen(); },  
 653866: () => { if (document.fullscreenElement) return 1; },  
 653912: () => { return document.getElementById('canvas').width; },  
 653964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 654032: () => { document.exitFullscreen(); },  
 654059: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 654117: () => { return screen.width; },  
 654142: () => { return screen.height; },  
 654168: () => { return window.screenX; },  
 654195: () => { return window.screenY; },  
 654222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 654275: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 654346: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 654403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 654659: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 654730: () => { if (document.fullscreenElement) return 1; },  
 654776: () => { return window.innerWidth; },  
 654802: () => { return window.innerHeight; },  
 654829: () => { if (document.pointerLockElement) return 1; }
};
