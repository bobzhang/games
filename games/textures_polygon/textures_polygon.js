...
var ASM_CONSTS = {
  652788: () => { if (document.fullscreenElement) return 1; },  
 652834: () => { return document.getElementById('canvas').width; },  
 652886: () => { return parseInt(document.getElementById('canvas').style.width); },  
 652954: () => { document.exitFullscreen(); },  
 652981: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 653054: () => { if (document.fullscreenElement) return 1; },  
 653100: () => { return document.getElementById('canvas').width; },  
 653152: () => { return screen.width; },  
 653177: () => { document.exitFullscreen(); },  
 653204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 653337: () => { return window.innerWidth; },  
 653363: () => { return window.innerHeight; },  
 653390: () => { if (document.fullscreenElement) return 1; },  
 653436: () => { return document.getElementById('canvas').width; },  
 653488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 653556: () => { if (document.fullscreenElement) return 1; },  
 653602: () => { return document.getElementById('canvas').width; },  
 653654: () => { return screen.width; },  
 653679: () => { return window.innerWidth; },  
 653705: () => { return window.innerHeight; },  
 653732: () => { if (document.fullscreenElement) return 1; },  
 653778: () => { return document.getElementById('canvas').width; },  
 653830: () => { return screen.width; },  
 653855: () => { document.exitFullscreen(); },  
 653882: () => { if (document.fullscreenElement) return 1; },  
 653928: () => { return document.getElementById('canvas').width; },  
 653980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 654048: () => { document.exitFullscreen(); },  
 654075: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 654133: () => { return screen.width; },  
 654158: () => { return screen.height; },  
 654184: () => { return window.screenX; },  
 654211: () => { return window.screenY; },  
 654238: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 654291: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 654362: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 654419: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 654675: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 654746: () => { if (document.fullscreenElement) return 1; },  
 654792: () => { return window.innerWidth; },  
 654818: () => { return window.innerHeight; },  
 654845: () => { if (document.pointerLockElement) return 1; }
};
