...
var ASM_CONSTS = {
  652564: () => { if (document.fullscreenElement) return 1; },  
 652610: () => { return document.getElementById('canvas').width; },  
 652662: () => { return parseInt(document.getElementById('canvas').style.width); },  
 652730: () => { document.exitFullscreen(); },  
 652757: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 652830: () => { if (document.fullscreenElement) return 1; },  
 652876: () => { return document.getElementById('canvas').width; },  
 652928: () => { return screen.width; },  
 652953: () => { document.exitFullscreen(); },  
 652980: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 653113: () => { return window.innerWidth; },  
 653139: () => { return window.innerHeight; },  
 653166: () => { if (document.fullscreenElement) return 1; },  
 653212: () => { return document.getElementById('canvas').width; },  
 653264: () => { return parseInt(document.getElementById('canvas').style.width); },  
 653332: () => { if (document.fullscreenElement) return 1; },  
 653378: () => { return document.getElementById('canvas').width; },  
 653430: () => { return screen.width; },  
 653455: () => { return window.innerWidth; },  
 653481: () => { return window.innerHeight; },  
 653508: () => { if (document.fullscreenElement) return 1; },  
 653554: () => { return document.getElementById('canvas').width; },  
 653606: () => { return screen.width; },  
 653631: () => { document.exitFullscreen(); },  
 653658: () => { if (document.fullscreenElement) return 1; },  
 653704: () => { return document.getElementById('canvas').width; },  
 653756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 653824: () => { document.exitFullscreen(); },  
 653851: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 653909: () => { return screen.width; },  
 653934: () => { return screen.height; },  
 653960: () => { return window.screenX; },  
 653987: () => { return window.screenY; },  
 654014: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 654067: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 654138: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 654195: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 654451: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 654522: () => { if (document.fullscreenElement) return 1; },  
 654568: () => { return window.innerWidth; },  
 654594: () => { return window.innerHeight; },  
 654621: () => { if (document.pointerLockElement) return 1; }
};
