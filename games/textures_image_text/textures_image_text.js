...
var ASM_CONSTS = {
  645284: () => { if (document.fullscreenElement) return 1; },  
 645330: () => { return document.getElementById('canvas').width; },  
 645382: () => { return parseInt(document.getElementById('canvas').style.width); },  
 645450: () => { document.exitFullscreen(); },  
 645477: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 645550: () => { if (document.fullscreenElement) return 1; },  
 645596: () => { return document.getElementById('canvas').width; },  
 645648: () => { return screen.width; },  
 645673: () => { document.exitFullscreen(); },  
 645700: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 645833: () => { return window.innerWidth; },  
 645859: () => { return window.innerHeight; },  
 645886: () => { if (document.fullscreenElement) return 1; },  
 645932: () => { return document.getElementById('canvas').width; },  
 645984: () => { return parseInt(document.getElementById('canvas').style.width); },  
 646052: () => { if (document.fullscreenElement) return 1; },  
 646098: () => { return document.getElementById('canvas').width; },  
 646150: () => { return screen.width; },  
 646175: () => { return window.innerWidth; },  
 646201: () => { return window.innerHeight; },  
 646228: () => { if (document.fullscreenElement) return 1; },  
 646274: () => { return document.getElementById('canvas').width; },  
 646326: () => { return screen.width; },  
 646351: () => { document.exitFullscreen(); },  
 646378: () => { if (document.fullscreenElement) return 1; },  
 646424: () => { return document.getElementById('canvas').width; },  
 646476: () => { return parseInt(document.getElementById('canvas').style.width); },  
 646544: () => { document.exitFullscreen(); },  
 646571: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 646629: () => { return screen.width; },  
 646654: () => { return screen.height; },  
 646680: () => { return window.screenX; },  
 646707: () => { return window.screenY; },  
 646734: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 646787: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 646858: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 646915: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 647171: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 647242: () => { if (document.fullscreenElement) return 1; },  
 647288: () => { return window.innerWidth; },  
 647314: () => { return window.innerHeight; },  
 647341: () => { if (document.pointerLockElement) return 1; }
};
