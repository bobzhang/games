...
var ASM_CONSTS = {
  645060: () => { if (document.fullscreenElement) return 1; },  
 645106: () => { return document.getElementById('canvas').width; },  
 645158: () => { return parseInt(document.getElementById('canvas').style.width); },  
 645226: () => { document.exitFullscreen(); },  
 645253: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 645326: () => { if (document.fullscreenElement) return 1; },  
 645372: () => { return document.getElementById('canvas').width; },  
 645424: () => { return screen.width; },  
 645449: () => { document.exitFullscreen(); },  
 645476: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 645609: () => { return window.innerWidth; },  
 645635: () => { return window.innerHeight; },  
 645662: () => { if (document.fullscreenElement) return 1; },  
 645708: () => { return document.getElementById('canvas').width; },  
 645760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 645828: () => { if (document.fullscreenElement) return 1; },  
 645874: () => { return document.getElementById('canvas').width; },  
 645926: () => { return screen.width; },  
 645951: () => { return window.innerWidth; },  
 645977: () => { return window.innerHeight; },  
 646004: () => { if (document.fullscreenElement) return 1; },  
 646050: () => { return document.getElementById('canvas').width; },  
 646102: () => { return screen.width; },  
 646127: () => { document.exitFullscreen(); },  
 646154: () => { if (document.fullscreenElement) return 1; },  
 646200: () => { return document.getElementById('canvas').width; },  
 646252: () => { return parseInt(document.getElementById('canvas').style.width); },  
 646320: () => { document.exitFullscreen(); },  
 646347: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 646405: () => { return screen.width; },  
 646430: () => { return screen.height; },  
 646456: () => { return window.screenX; },  
 646483: () => { return window.screenY; },  
 646510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 646563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 646634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 646691: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 646947: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 647018: () => { if (document.fullscreenElement) return 1; },  
 647064: () => { return window.innerWidth; },  
 647090: () => { return window.innerHeight; },  
 647117: () => { if (document.pointerLockElement) return 1; }
};
