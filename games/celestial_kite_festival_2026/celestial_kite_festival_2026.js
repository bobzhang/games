...
var ASM_CONSTS = {
  268696: () => { if (document.fullscreenElement) return 1; },  
 268742: () => { return document.getElementById('canvas').width; },  
 268794: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268862: () => { document.exitFullscreen(); },  
 268889: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268962: () => { if (document.fullscreenElement) return 1; },  
 269008: () => { return document.getElementById('canvas').width; },  
 269060: () => { return screen.width; },  
 269085: () => { document.exitFullscreen(); },  
 269112: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269245: () => { return window.innerWidth; },  
 269271: () => { return window.innerHeight; },  
 269298: () => { if (document.fullscreenElement) return 1; },  
 269344: () => { return document.getElementById('canvas').width; },  
 269396: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269464: () => { if (document.fullscreenElement) return 1; },  
 269510: () => { return document.getElementById('canvas').width; },  
 269562: () => { return screen.width; },  
 269587: () => { return window.innerWidth; },  
 269613: () => { return window.innerHeight; },  
 269640: () => { if (document.fullscreenElement) return 1; },  
 269686: () => { return document.getElementById('canvas').width; },  
 269738: () => { return screen.width; },  
 269763: () => { document.exitFullscreen(); },  
 269790: () => { if (document.fullscreenElement) return 1; },  
 269836: () => { return document.getElementById('canvas').width; },  
 269888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269956: () => { document.exitFullscreen(); },  
 269983: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 270041: () => { return screen.width; },  
 270066: () => { return screen.height; },  
 270092: () => { return window.screenX; },  
 270119: () => { return window.screenY; },  
 270146: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 270199: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 270270: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 270327: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270583: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270654: () => { if (document.fullscreenElement) return 1; },  
 270700: () => { return window.innerWidth; },  
 270726: () => { return window.innerHeight; },  
 270753: () => { if (document.pointerLockElement) return 1; },  
