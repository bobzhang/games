...
function findWasmBinary() {
  return locateFile('raylib_textures_image_kernel.wasm');
}
...
var ASM_CONSTS = {
  495248: () => { if (document.fullscreenElement) return 1; },  
 495294: () => { return document.getElementById('canvas').width; },  
 495346: () => { return parseInt(document.getElementById('canvas').style.width); },  
 495414: () => { document.exitFullscreen(); },  
 495441: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 495514: () => { if (document.fullscreenElement) return 1; },  
 495560: () => { return document.getElementById('canvas').width; },  
 495612: () => { return screen.width; },  
 495637: () => { document.exitFullscreen(); },  
 495664: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 495797: () => { return window.innerWidth; },  
 495823: () => { return window.innerHeight; },  
 495850: () => { if (document.fullscreenElement) return 1; },  
 495896: () => { return document.getElementById('canvas').width; },  
 495948: () => { return parseInt(document.getElementById('canvas').style.width); },  
 496016: () => { if (document.fullscreenElement) return 1; },  
 496062: () => { return document.getElementById('canvas').width; },  
 496114: () => { return screen.width; },  
 496139: () => { return window.innerWidth; },  
 496165: () => { return window.innerHeight; },  
 496192: () => { if (document.fullscreenElement) return 1; },  
 496238: () => { return document.getElementById('canvas').width; },  
 496290: () => { return screen.width; },  
 496315: () => { document.exitFullscreen(); },  
 496342: () => { if (document.fullscreenElement) return 1; },  
 496388: () => { return document.getElementById('canvas').width; },  
 496440: () => { return parseInt(document.getElementById('canvas').style.width); },  
 496508: () => { document.exitFullscreen(); },  
 496535: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 496593: () => { return screen.width; },  
 496618: () => { return screen.height; },  
 496644: () => { return window.screenX; },  
 496671: () => { return window.screenY; },  
 496698: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 496751: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 496822: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 496879: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 497135: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 497206: () => { if (document.fullscreenElement) return 1; },  
 497252: () => { return window.innerWidth; },  
 497278: () => { return window.innerHeight; },  
 497305: () => { if (document.pointerLockElement) return 1; }
};
