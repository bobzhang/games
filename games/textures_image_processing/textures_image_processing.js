...
var ASM_CONSTS = {
  565780: () => { if (document.fullscreenElement) return 1; },  
 565826: () => { return document.getElementById('canvas').width; },  
 565878: () => { return parseInt(document.getElementById('canvas').style.width); },  
 565946: () => { document.exitFullscreen(); },  
 565973: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 566046: () => { if (document.fullscreenElement) return 1; },  
 566092: () => { return document.getElementById('canvas').width; },  
 566144: () => { return screen.width; },  
 566169: () => { document.exitFullscreen(); },  
 566196: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 566329: () => { return window.innerWidth; },  
 566355: () => { return window.innerHeight; },  
 566382: () => { if (document.fullscreenElement) return 1; },  
 566428: () => { return document.getElementById('canvas').width; },  
 566480: () => { return parseInt(document.getElementById('canvas').style.width); },  
 566548: () => { if (document.fullscreenElement) return 1; },  
 566594: () => { return document.getElementById('canvas').width; },  
 566646: () => { return screen.width; },  
 566671: () => { return window.innerWidth; },  
 566697: () => { return window.innerHeight; },  
 566724: () => { if (document.fullscreenElement) return 1; },  
 566770: () => { return document.getElementById('canvas').width; },  
 566822: () => { return screen.width; },  
 566847: () => { document.exitFullscreen(); },  
 566874: () => { if (document.fullscreenElement) return 1; },  
 566920: () => { return document.getElementById('canvas').width; },  
 566972: () => { return parseInt(document.getElementById('canvas').style.width); },  
 567040: () => { document.exitFullscreen(); },  
 567067: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 567125: () => { return screen.width; },  
 567150: () => { return screen.height; },  
 567176: () => { return window.screenX; },  
 567203: () => { return window.screenY; },  
 567230: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 567283: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 567354: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 567411: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 567667: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 567738: () => { if (document.fullscreenElement) return 1; },  
 567784: () => { return window.innerWidth; },  
 567810: () => { return window.innerHeight; },  
 567837: () => { if (document.pointerLockElement) return 1; }
};
