...
var ASM_CONSTS = {
  565796: () => { if (document.fullscreenElement) return 1; },  
 565842: () => { return document.getElementById('canvas').width; },  
 565894: () => { return parseInt(document.getElementById('canvas').style.width); },  
 565962: () => { document.exitFullscreen(); },  
 565989: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 566062: () => { if (document.fullscreenElement) return 1; },  
 566108: () => { return document.getElementById('canvas').width; },  
 566160: () => { return screen.width; },  
 566185: () => { document.exitFullscreen(); },  
 566212: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 566345: () => { return window.innerWidth; },  
 566371: () => { return window.innerHeight; },  
 566398: () => { if (document.fullscreenElement) return 1; },  
 566444: () => { return document.getElementById('canvas').width; },  
 566496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 566564: () => { if (document.fullscreenElement) return 1; },  
 566610: () => { return document.getElementById('canvas').width; },  
 566662: () => { return screen.width; },  
 566687: () => { return window.innerWidth; },  
 566713: () => { return window.innerHeight; },  
 566740: () => { if (document.fullscreenElement) return 1; },  
 566786: () => { return document.getElementById('canvas').width; },  
 566838: () => { return screen.width; },  
 566863: () => { document.exitFullscreen(); },  
 566890: () => { if (document.fullscreenElement) return 1; },  
 566936: () => { return document.getElementById('canvas').width; },  
 566988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 567056: () => { document.exitFullscreen(); },  
 567083: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 567141: () => { return screen.width; },  
 567166: () => { return screen.height; },  
 567192: () => { return window.screenX; },  
 567219: () => { return window.screenY; },  
 567246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 567299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 567370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 567427: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 567683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 567754: () => { if (document.fullscreenElement) return 1; },  
 567800: () => { return window.innerWidth; },  
 567826: () => { return window.innerHeight; },  
 567853: () => { if (document.pointerLockElement) return 1; }
};
