...
var ASM_CONSTS = {
  565588: () => { if (document.fullscreenElement) return 1; },  
 565634: () => { return document.getElementById('canvas').width; },  
 565686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 565754: () => { document.exitFullscreen(); },  
 565781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 565854: () => { if (document.fullscreenElement) return 1; },  
 565900: () => { return document.getElementById('canvas').width; },  
 565952: () => { return screen.width; },  
 565977: () => { document.exitFullscreen(); },  
 566004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 566137: () => { return window.innerWidth; },  
 566163: () => { return window.innerHeight; },  
 566190: () => { if (document.fullscreenElement) return 1; },  
 566236: () => { return document.getElementById('canvas').width; },  
 566288: () => { return parseInt(document.getElementById('canvas').style.width); },  
 566356: () => { if (document.fullscreenElement) return 1; },  
 566402: () => { return document.getElementById('canvas').width; },  
 566454: () => { return screen.width; },  
 566479: () => { return window.innerWidth; },  
 566505: () => { return window.innerHeight; },  
 566532: () => { if (document.fullscreenElement) return 1; },  
 566578: () => { return document.getElementById('canvas').width; },  
 566630: () => { return screen.width; },  
 566655: () => { document.exitFullscreen(); },  
 566682: () => { if (document.fullscreenElement) return 1; },  
 566728: () => { return document.getElementById('canvas').width; },  
 566780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 566848: () => { document.exitFullscreen(); },  
 566875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 566933: () => { return screen.width; },  
 566958: () => { return screen.height; },  
 566984: () => { return window.screenX; },  
 567011: () => { return window.screenY; },  
 567038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 567091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 567162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 567219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 567475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 567546: () => { if (document.fullscreenElement) return 1; },  
 567592: () => { return window.innerWidth; },  
 567618: () => { return window.innerHeight; },  
 567645: () => { if (document.pointerLockElement) return 1; }
};
