...
var ASM_CONSTS = {
  103728: () => { if (document.fullscreenElement) return 1; },  
 103774: () => { return document.getElementById('canvas').width; },  
 103826: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103894: () => { document.exitFullscreen(); },  
 103921: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103994: () => { if (document.fullscreenElement) return 1; },  
 104040: () => { return document.getElementById('canvas').width; },  
 104092: () => { return screen.width; },  
 104117: () => { document.exitFullscreen(); },  
 104144: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 104277: () => { return window.innerWidth; },  
 104303: () => { return window.innerHeight; },  
 104330: () => { if (document.fullscreenElement) return 1; },  
 104376: () => { return document.getElementById('canvas').width; },  
 104428: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104496: () => { if (document.fullscreenElement) return 1; },  
 104542: () => { return document.getElementById('canvas').width; },  
 104594: () => { return screen.width; },  
 104619: () => { return window.innerWidth; },  
 104645: () => { return window.innerHeight; },  
 104672: () => { if (document.fullscreenElement) return 1; },  
 104718: () => { return document.getElementById('canvas').width; },  
 104770: () => { return screen.width; },  
 104795: () => { document.exitFullscreen(); },  
 104822: () => { if (document.fullscreenElement) return 1; },  
 104868: () => { return document.getElementById('canvas').width; },  
 104920: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104988: () => { document.exitFullscreen(); },  
 105015: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105073: () => { return screen.width; },  
 105098: () => { return screen.height; },  
 105124: () => { return window.screenX; },  
 105151: () => { return window.screenY; },  
 105178: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 105231: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 105302: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 105359: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 105615: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 105686: () => { if (document.fullscreenElement) return 1; },  
 105732: () => { return window.innerWidth; },  
 105758: () => { return window.innerHeight; },  
 105785: () => { if (document.pointerLockElement) return 1; }
};
