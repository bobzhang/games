...
var ASM_CONSTS = {
  261060: () => { if (document.fullscreenElement) return 1; },  
 261106: () => { return document.getElementById('canvas').width; },  
 261158: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261226: () => { document.exitFullscreen(); },  
 261253: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261326: () => { if (document.fullscreenElement) return 1; },  
 261372: () => { return document.getElementById('canvas').width; },  
 261424: () => { return screen.width; },  
 261449: () => { document.exitFullscreen(); },  
 261476: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261609: () => { return window.innerWidth; },  
 261635: () => { return window.innerHeight; },  
 261662: () => { if (document.fullscreenElement) return 1; },  
 261708: () => { return document.getElementById('canvas').width; },  
 261760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261828: () => { if (document.fullscreenElement) return 1; },  
 261874: () => { return document.getElementById('canvas').width; },  
 261926: () => { return screen.width; },  
 261951: () => { return window.innerWidth; },  
 261977: () => { return window.innerHeight; },  
 262004: () => { if (document.fullscreenElement) return 1; },  
 262050: () => { return document.getElementById('canvas').width; },  
 262102: () => { return screen.width; },  
 262127: () => { document.exitFullscreen(); },  
 ...
 262320: () => { document.exitFullscreen(); },  
 262347: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262405: () => { return screen.width; },  
 262430: () => { return screen.height; },  
 262456: () => { return window.screenX; },  
 262483: () => { return window.screenY; },  
 262510: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262563: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262634: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262691: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262947: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263018: () => { if (document.fullscreenElement) return 1; },  
 263064: () => { return window.innerWidth; },  
 263090: () => { return window.innerHeight; },  
 263117: () => { if (document.pointerLockElement) return 1; }
};
