...
var ASM_CONSTS = {
  266836: () => { if (document.fullscreenElement) return 1; },  
 266882: () => { return document.getElementById('canvas').width; },  
 266934: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267002: () => { document.exitFullscreen(); },  
 267029: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 267102: () => { if (document.fullscreenElement) return 1; },  
 267148: () => { return document.getElementById('canvas').width; },  
 267200: () => { return screen.width; },  
 267225: () => { document.exitFullscreen(); },  
 267252: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267385: () => { return window.innerWidth; },  
 267411: () => { return window.innerHeight; },  
 267438: () => { if (document.fullscreenElement) return 1; },  
 267484: () => { return document.getElementById('canvas').width; },  
 267536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267604: () => { if (document.fullscreenElement) return 1; },  
 267650: () => { return document.getElementById('canvas').width; },  
 267702: () => { return screen.width; },  
 267727: () => { return window.innerWidth; },  
 267753: () => { return window.innerHeight; },  
 267780: () => { if (document.fullscreenElement) return 1; },  
 267826: () => { return document.getElementById('canvas').width; },  
 267878: () => { return screen.width; },  
 267903: () => { document.exitFullscreen(); },  
 267930: () => { if (document.fullscreenElement) return 1; },  
 267976: () => { return document.getElementById('canvas').width; },  
 268028: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268096: () => { document.exitFullscreen(); },  
 268123: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 268181: () => { return screen.width; },  
 268206: () => { return screen.height; },  
 268232: () => { return window.screenX; },  
 268259: () => { return window.screenY; },  
 268286: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268339: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268410: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268467: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268723: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268794: () => { if (document.fullscreenElement) return 1; },  
 268840: () => { return window.innerWidth; },  
 268866: () => { return window.innerHeight; },  
 268893: () => { if (document.pointerLockElement) return 1; }
};
