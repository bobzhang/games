...
function findWasmBinary() {
  return locateFile('abyssal_rift.wasm');
}
...
var ASM_CONSTS = {
  266628: () => { if (document.fullscreenElement) return 1; },  
 266674: () => { return document.getElementById('canvas').width; },  
 266726: () => { return parseInt(document.getElementById('canvas').style.width); },  
 266794: () => { document.exitFullscreen(); },  
 266821: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 266894: () => { if (document.fullscreenElement) return 1; },  
 266940: () => { return document.getElementById('canvas').width; },  
 266992: () => { return screen.width; },  
 267017: () => { document.exitFullscreen(); },  
 267044: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 267177: () => { return window.innerWidth; },  
 267203: () => { return window.innerHeight; },  
 267230: () => { if (document.fullscreenElement) return 1; },  
 267276: () => { return document.getElementById('canvas').width; },  
 267328: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267396: () => { if (document.fullscreenElement) return 1; },  
 267442: () => { return document.getElementById('canvas').width; },  
 267494: () => { return screen.width; },  
 267519: () => { return window.innerWidth; },  
 267545: () => { return window.innerHeight; },  
 267572: () => { if (document.fullscreenElement) return 1; },  
 267618: () => { return document.getElementById('canvas').width; },  
 267670: () => { return screen.width; },  
 267695: () => { document.exitFullscreen(); },  
 267722: () => { if (document.fullscreenElement) return 1; },  
 267768: () => { return document.getElementById('canvas').width; },  
 267820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 267888: () => { document.exitFullscreen(); },  
 267915: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 267973: () => { return screen.width; },  
 267998: () => { return screen.height; },  
 268024: () => { return window.screenX; },  
 268051: () => { return window.screenY; },  
 268078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 268131: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 268202: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 268259: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 268515: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 268586: () => { if (document.fullscreenElement) return 1; },  
 268632: () => { return window.innerWidth; },  
 268658: () => { return window.innerHeight; },  
 268685: () => { if (document.pointerLockElement) return 1; }
};
