...
var ASM_CONSTS = {
  269764: () => { if (document.fullscreenElement) return 1; },  
 269810: () => { return document.getElementById('canvas').width; },  
 269862: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269930: () => { document.exitFullscreen(); },  
 269957: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 270030: () => { if (document.fullscreenElement) return 1; },  
 270076: () => { return document.getElementById('canvas').width; },  
 270128: () => { return screen.width; },  
 270153: () => { document.exitFullscreen(); },  
 270180: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 270313: () => { return window.innerWidth; },  
 270339: () => { return window.innerHeight; },  
 270366: () => { if (document.fullscreenElement) return 1; },  
 270412: () => { return document.getElementById('canvas').width; },  
 270464: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 270655: () => { return window.innerWidth; },  
 270681: () => { return window.innerHeight; },  
 270708: () => { if (document.fullscreenElement) return 1; },  
 270754: () => { return document.getElementById('canvas').width; },  
 270806: () => { return screen.width; },  
 270831: () => { document.exitFullscreen(); },  
 270858: () => { if (document.fullscreenElement) return 1; },  
 270904: () => { return document.getElementById('canvas').width; },  
 270956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 271024: () => { document.exitFullscreen(); },  
 271051: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 271109: () => { return screen.width; },  
 271134: () => { return screen.height; },  
 271160: () => { return window.screenX; },  
 271187: () => { return window.screenY; },  
 271214: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 271267: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 271338: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 271395: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 271651: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 271722: () => { if (document.fullscreenElement) return 1; },  
 271768: () => { return window.innerWidth; },  
 271794: () => { return window.innerHeight; },  
 271821: () => { if (document.pointerLockElement) return 1; }
};
