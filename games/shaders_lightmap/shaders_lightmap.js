...
var ASM_CONSTS = {
  317636: () => { if (document.fullscreenElement) return 1; },  
 317682: () => { return document.getElementById('canvas').width; },  
 317734: () => { return parseInt(document.getElementById('canvas').style.width); },  
 317802: () => { document.exitFullscreen(); },  
 317829: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 317902: () => { if (document.fullscreenElement) return 1; },  
 317948: () => { return document.getElementById('canvas').width; },  
 318000: () => { return screen.width; },  
 318025: () => { document.exitFullscreen(); },  
 318052: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 318185: () => { return window.innerWidth; },  
 318211: () => { return window.innerHeight; },  
 318238: () => { if (document.fullscreenElement) return 1; },  
 318284: () => { return document.getElementById('canvas').width; },  
 318336: () => { return parseInt(document.getElementById('canvas').style.width); },  
 318404: () => { if (document.fullscreenElement) return 1; },  
 318450: () => { return document.getElementById('canvas').width; },  
 318502: () => { return screen.width; },  
 318527: () => { return window.innerWidth; },  
 318553: () => { return window.innerHeight; },  
 318580: () => { if (document.fullscreenElement) return 1; },  
 318626: () => { return document.getElementById('canvas').width; },  
 318678: () => { return screen.width; },  
 318703: () => { document.exitFullscreen(); },  
 318730: () => { if (document.fullscreenElement) return 1; },  
 318776: () => { return document.getElementById('canvas').width; },  
 318828: () => { return parseInt(document.getElementById('canvas').style.width); },  
 318896: () => { document.exitFullscreen(); },  
 318923: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 318981: () => { return screen.width; },  
 319006: () => { return screen.height; },  
 319032: () => { return window.screenX; },  
 319059: () => { return window.screenY; },  
 319086: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 319139: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 319210: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 319267: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 319523: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 319594: () => { if (document.fullscreenElement) return 1; },  
 319640: () => { return window.innerWidth; },  
 319666: () => { return window.innerHeight; },  
 319693: () => { if (document.pointerLockElement) return 1; }
};
