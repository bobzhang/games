...
var ASM_CONSTS = {
  316256: () => { if (document.fullscreenElement) return 1; },  
 316302: () => { return document.getElementById('canvas').width; },  
 316354: () => { return parseInt(document.getElementById('canvas').style.width); },  
 316422: () => { document.exitFullscreen(); },  
 316449: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 316522: () => { if (document.fullscreenElement) return 1; },  
 316568: () => { return document.getElementById('canvas').width; },  
 316620: () => { return screen.width; },  
 316645: () => { document.exitFullscreen(); },  
 316672: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 316805: () => { return window.innerWidth; },  
 316831: () => { return window.innerHeight; },  
 316858: () => { if (document.fullscreenElement) return 1; },  
 316904: () => { return document.getElementById('canvas').width; },  
 316956: () => { return parseInt(document.getElementById('canvas').style.width); },  
 317024: () => { if (document.fullscreenElement) return 1; },  
 317070: () => { return document.getElementById('canvas').width; },  
 317122: () => { return screen.width; },  
 317147: () => { return window.innerWidth; },  
 317173: () => { return window.innerHeight; },  
 317200: () => { if (document.fullscreenElement) return 1; },  
 317246: () => { return document.getElementById('canvas').width; },  
 317298: () => { return screen.width; },  
 317323: () => { document.exitFullscreen(); },  
 317350: () => { if (document.fullscreenElement) return 1; },  
 317396: () => { return document.getElementById('canvas').width; },  
 317448: () => { return parseInt(document.getElementById('canvas').style.width); },  
 317516: () => { document.exitFullscreen(); },  
 317543: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 317601: () => { return screen.width; },  
 317626: () => { return screen.height; },  
 317652: () => { return window.screenX; },  
 317679: () => { return window.screenY; },  
 317706: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 317759: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 317830: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 317887: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 318143: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 318214: () => { if (document.fullscreenElement) return 1; },  
 318260: () => { return window.innerWidth; },  
 318286: () => { return window.innerHeight; },  
 318313: () => { if (document.pointerLockElement) return 1; }
};
