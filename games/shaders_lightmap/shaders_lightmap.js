...
var ASM_CONSTS = {
  317412: () => { if (document.fullscreenElement) return 1; },  
 317458: () => { return document.getElementById('canvas').width; },  
 317510: () => { return parseInt(document.getElementById('canvas').style.width); },  
 317578: () => { document.exitFullscreen(); },  
 317605: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 317678: () => { if (document.fullscreenElement) return 1; },  
 317724: () => { return document.getElementById('canvas').width; },  
 317776: () => { return screen.width; },  
 317801: () => { document.exitFullscreen(); },  
 317828: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 317961: () => { return window.innerWidth; },  
 317987: () => { return window.innerHeight; },  
 318014: () => { if (document.fullscreenElement) return 1; },  
 318060: () => { return document.getElementById('canvas').width; },  
 318112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 318180: () => { if (document.fullscreenElement) return 1; },  
 318226: () => { return document.getElementById('canvas').width; },  
 318278: () => { return screen.width; },  
 318303: () => { return window.innerWidth; },  
 318329: () => { return window.innerHeight; },  
 318356: () => { if (document.fullscreenElement) return 1; },  
 318402: () => { return document.getElementById('canvas').width; },  
 318454: () => { return screen.width; },  
 318479: () => { document.exitFullscreen(); },  
 318506: () => { if (document.fullscreenElement) return 1; },  
 318552: () => { return document.getElementById('canvas').width; },  
 318604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 318672: () => { document.exitFullscreen(); },  
 318699: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 318757: () => { return screen.width; },  
 318782: () => { return screen.height; },  
 318808: () => { return window.screenX; },  
 318835: () => { return window.screenY; },  
 318862: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 318915: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 318986: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 319043: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 319299: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 319370: () => { if (document.fullscreenElement) return 1; },  
 319416: () => { return window.innerWidth; },  
 319442: () => { return window.innerHeight; },  
 319469: () => { if (document.pointerLockElement) return 1; }
};
