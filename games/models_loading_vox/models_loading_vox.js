...
var ASM_CONSTS = {
  1624068: () => { if (document.fullscreenElement) return 1; },  
 1624114: () => { return document.getElementById('canvas').width; },  
 1624166: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1624234: () => { document.exitFullscreen(); },  
 1624261: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1624334: () => { if (document.fullscreenElement) return 1; },  
 1624380: () => { return document.getElementById('canvas').width; },  
 1624432: () => { return screen.width; },  
 1624457: () => { document.exitFullscreen(); },  
 1624484: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1624617: () => { return window.innerWidth; },  
 1624643: () => { return window.innerHeight; },  
 1624670: () => { if (document.fullscreenElement) return 1; },  
 1624716: () => { return document.getElementById('canvas').width; },  
 1624768: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1624836: () => { if (document.fullscreenElement) return 1; },  
 1624882: () => { return document.getElementById('canvas').width; },  
 1624934: () => { return screen.width; },  
 1624959: () => { return window.innerWidth; },  
 1624985: () => { return window.innerHeight; },  
 1625012: () => { if (document.fullscreenElement) return 1; },  
 1625058: () => { return document.getElementById('canvas').width; },  
 1625110: () => { return screen.width; },  
 1625135: () => { document.exitFullscreen(); },  
 1625162: () => { if (document.fullscreenElement) return 1; },  
 1625208: () => { return document.getElementById('canvas').width; },  
 1625260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1625328: () => { document.exitFullscreen(); },  
 1625355: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1625413: () => { return screen.width; },  
 1625438: () => { return screen.height; },  
 1625464: () => { return window.screenX; },  
 1625491: () => { return window.screenY; },  
 1625518: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1625571: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1625642: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1625699: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1625955: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1626026: () => { if (document.fullscreenElement) return 1; },  
 1626072: () => { return window.innerWidth; },  
 1626098: () => { return window.innerHeight; },  
 1626125: () => { if (document.pointerLockElement) return 1; }
};
