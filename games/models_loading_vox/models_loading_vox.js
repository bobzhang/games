...
var ASM_CONSTS = {
  1624276: () => { if (document.fullscreenElement) return 1; },  
 1624322: () => { return document.getElementById('canvas').width; },  
 1624374: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1624442: () => { document.exitFullscreen(); },  
 1624469: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1624542: () => { if (document.fullscreenElement) return 1; },  
 1624588: () => { return document.getElementById('canvas').width; },  
 1624640: () => { return screen.width; },  
 1624665: () => { document.exitFullscreen(); },  
 1624692: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1624825: () => { return window.innerWidth; },  
 1624851: () => { return window.innerHeight; },  
 1624878: () => { if (document.fullscreenElement) return 1; },  
 1624924: () => { return document.getElementById('canvas').width; },  
 1624976: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1625044: () => { if (document.fullscreenElement) return 1; },  
 1625090: () => { return document.getElementById('canvas').width; },  
 1625142: () => { return screen.width; },  
 1625167: () => { return window.innerWidth; },  
 1625193: () => { return window.innerHeight; },  
 1625220: () => { if (document.fullscreenElement) return 1; },  
 1625266: () => { return document.getElementById('canvas').width; },  
 1625318: () => { return screen.width; },  
 1625343: () => { document.exitFullscreen(); },  
 1625370: () => { if (document.fullscreenElement) return 1; },  
 1625416: () => { return document.getElementById('canvas').width; },  
 1625468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1625536: () => { document.exitFullscreen(); },  
 1625563: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1625621: () => { return screen.width; },  
 1625646: () => { return screen.height; },  
 1625672: () => { return window.screenX; },  
 1625699: () => { return window.screenY; },  
 1625726: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1625779: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1625850: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1625907: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1626163: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1626234: () => { if (document.fullscreenElement) return 1; },  
 1626280: () => { return window.innerWidth; },  
 1626306: () => { return window.innerHeight; },  
 1626333: () => { if (document.pointerLockElement) return 1; }
};
