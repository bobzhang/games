...
var ASM_CONSTS = {
  1624292: () => { if (document.fullscreenElement) return 1; },  
 1624338: () => { return document.getElementById('canvas').width; },  
 1624390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1624458: () => { document.exitFullscreen(); },  
 1624485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1624558: () => { if (document.fullscreenElement) return 1; },  
 1624604: () => { return document.getElementById('canvas').width; },  
 1624656: () => { return screen.width; },  
 1624681: () => { document.exitFullscreen(); },  
 1624708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1624841: () => { return window.innerWidth; },  
 1624867: () => { return window.innerHeight; },  
 1624894: () => { if (document.fullscreenElement) return 1; },  
 1624940: () => { return document.getElementById('canvas').width; },  
 1624992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1625060: () => { if (document.fullscreenElement) return 1; },  
 1625106: () => { return document.getElementById('canvas').width; },  
 1625158: () => { return screen.width; },  
 1625183: () => { return window.innerWidth; },  
 1625209: () => { return window.innerHeight; },  
 1625236: () => { if (document.fullscreenElement) return 1; },  
 1625282: () => { return document.getElementById('canvas').width; },  
 1625334: () => { return screen.width; },  
 1625359: () => { document.exitFullscreen(); },  
 1625386: () => { if (document.fullscreenElement) return 1; },  
 1625432: () => { return document.getElementById('canvas').width; },  
 1625484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1625552: () => { document.exitFullscreen(); },  
 1625579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1625637: () => { return screen.width; },  
 1625662: () => { return screen.height; },  
 1625688: () => { return window.screenX; },  
 1625715: () => { return window.screenY; },  
 1625742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1625795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1625866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1625923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1626179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1626250: () => { if (document.fullscreenElement) return 1; },  
 1626296: () => { return window.innerWidth; },  
 1626322: () => { return window.innerHeight; },  
 1626349: () => { if (document.pointerLockElement) return 1; }
};
