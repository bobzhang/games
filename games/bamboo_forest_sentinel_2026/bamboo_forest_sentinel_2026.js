...
var ASM_CONSTS = {
 ...
 263110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263178: () => { document.exitFullscreen(); },  
 263205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263278: () => { if (document.fullscreenElement) return 1; },  
 263324: () => { return document.getElementById('canvas').width; },  
 263376: () => { return screen.width; },  
 263401: () => { document.exitFullscreen(); },  
 263428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263561: () => { return window.innerWidth; },  
 263587: () => { return window.innerHeight; },  
 263614: () => { if (document.fullscreenElement) return 1; },  
 263660: () => { return document.getElementById('canvas').width; },  
 263712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263780: () => { if (document.fullscreenElement) return 1; },  
 263826: () => { return document.getElementById('canvas').width; },  
 263878: () => { return screen.width; },  
 263903: () => { return window.innerWidth; },  
 263929: () => { return window.innerHeight; },  
 263956: () => { if (document.fullscreenElement) return 1; },  
 264002: () => { return document.getElementById('canvas').width; },  
 264054: () => { return screen.width; },  
 264079: () => { document.exitFullscreen(); },  
 264106: () => { if (document.fullscreenElement) return 1; },  
 264152: () => { return document.getElementById('canvas').width; },  
 264204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264272: () => { document.exitFullscreen(); },  
 264299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264357: () => { return screen.width; },  
 264382: () => { return screen.height; },  
 264408: () => { return window.screenX; },  
 264435: () => { return window.screenY; },  
 264462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264970: () => { if (document.fullscreenElement) return 1; },  
 265016: () => { return window.innerWidth; },  
 265042: () => { return window.innerHeight; },  
 265069: () => { if (document.pointerLockElement) return 1; }
};
