...
var ASM_CONSTS = {
  263220: () => { if (document.fullscreenElement) return 1; },  
 263266: () => { return document.getElementById('canvas').width; },  
 263318: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263386: () => { document.exitFullscreen(); },  
 263413: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263486: () => { if (document.fullscreenElement) return 1; },  
 263532: () => { return document.getElementById('canvas').width; },  
 263584: () => { return screen.width; },  
 263609: () => { document.exitFullscreen(); },  
 263636: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263769: () => { return window.innerWidth; },  
 263795: () => { return window.innerHeight; },  
 263822: () => { if (document.fullscreenElement) return 1; },  
 263868: () => { return document.getElementById('canvas').width; },  
 263920: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264111: () => { return window.innerWidth; },  
 264137: () => { return window.innerHeight; },  
 264164: () => { if (document.fullscreenElement) return 1; },  
 264210: () => { return document.getElementById('canvas').width; },  
 264262: () => { return screen.width; },  
 264287: () => { document.exitFullscreen(); },  
 264314: () => { if (document.fullscreenElement) return 1; },  
 264360: () => { return document.getElementById('canvas').width; },  
 264412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264480: () => { document.exitFullscreen(); },  
 264507: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264565: () => { return screen.width; },  
 264590: () => { return screen.height; },  
 264616: () => { return window.screenX; },  
 264643: () => { return window.screenY; },  
 264670: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264723: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264794: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264851: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265107: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265178: () => { if (document.fullscreenElement) return 1; },  
 265224: () => { return window.innerWidth; },  
 265250: () => { return window.innerHeight; },  
 265277: () => { if (document.pointerLockElement) return 1; }
};
