...
var ASM_CONSTS = {
  263236: () => { if (document.fullscreenElement) return 1; },  
 263282: () => { return document.getElementById('canvas').width; },  
 263334: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263402: () => { document.exitFullscreen(); },  
 263429: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263502: () => { if (document.fullscreenElement) return 1; },  
 263548: () => { return document.getElementById('canvas').width; },  
 263600: () => { return screen.width; },  
 263625: () => { document.exitFullscreen(); },  
 263652: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263785: () => { return window.innerWidth; },  
 263811: () => { return window.innerHeight; },  
 263838: () => { if (document.fullscreenElement) return 1; },  
 263884: () => { return document.getElementById('canvas').width; },  
 263936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264004: () => { if (document.fullscreenElement) return 1; },  
 264050: () => { return document.getElementById('canvas').width; },  
 264102: () => { return screen.width; },  
 264127: () => { return window.innerWidth; },  
 264153: () => { return window.innerHeight; },  
 ...
 264303: () => { document.exitFullscreen(); },  
 264330: () => { if (document.fullscreenElement) return 1; },  
 264376: () => { return document.getElementById('canvas').width; },  
 264428: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264496: () => { document.exitFullscreen(); },  
 264523: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264581: () => { return screen.width; },  
 264606: () => { return screen.height; },  
 264632: () => { return window.screenX; },  
 264659: () => { return window.screenY; },  
 264686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264739: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264810: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264867: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265123: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265194: () => { if (document.fullscreenElement) return 1; },  
 265240: () => { return window.innerWidth; },  
 265266: () => { return window.innerHeight; },  
 265293: () => { if (document.pointerLockElement) return 1; }
};
