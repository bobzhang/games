...
var ASM_CONSTS = {
  260500: () => { if (document.fullscreenElement) return 1; },  
 260546: () => { return document.getElementById('canvas').width; },  
 260598: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260666: () => { document.exitFullscreen(); },  
 260693: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260766: () => { if (document.fullscreenElement) return 1; },  
 260812: () => { return document.getElementById('canvas').width; },  
 260864: () => { return screen.width; },  
 260889: () => { document.exitFullscreen(); },  
 260916: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261049: () => { return window.innerWidth; },  
 261075: () => { return window.innerHeight; },  
 261102: () => { if (document.fullscreenElement) return 1; },  
 261148: () => { return document.getElementById('canvas').width; },  
 261200: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261268: () => { if (document.fullscreenElement) return 1; },  
 261314: () => { return document.getElementById('canvas').width; },  
 261366: () => { return screen.width; },  
 261391: () => { return window.innerWidth; },  
 261417: () => { return window.innerHeight; },  
 ...
 261567: () => { document.exitFullscreen(); },  
 ...
 261760: () => { document.exitFullscreen(); },  
 261787: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261845: () => { return screen.width; },  
 261870: () => { return screen.height; },  
 261896: () => { return window.screenX; },  
 261923: () => { return window.screenY; },  
 261950: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262003: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262074: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262131: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262387: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262458: () => { if (document.fullscreenElement) return 1; },  
 262504: () => { return window.innerWidth; },  
 262530: () => { return window.innerHeight; },  
 262557: () => { if (document.pointerLockElement) return 1; }
};
