...
var ASM_CONSTS = {
  260724: () => { if (document.fullscreenElement) return 1; },  
 260770: () => { return document.getElementById('canvas').width; },  
 260822: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260890: () => { document.exitFullscreen(); },  
 260917: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260990: () => { if (document.fullscreenElement) return 1; },  
 261036: () => { return document.getElementById('canvas').width; },  
 261088: () => { return screen.width; },  
 261113: () => { document.exitFullscreen(); },  
 261140: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261273: () => { return window.innerWidth; },  
 261299: () => { return window.innerHeight; },  
 261326: () => { if (document.fullscreenElement) return 1; },  
 261372: () => { return document.getElementById('canvas').width; },  
 261424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261492: () => { if (document.fullscreenElement) return 1; },  
 261538: () => { return document.getElementById('canvas').width; },  
 261590: () => { return screen.width; },  
 261615: () => { return window.innerWidth; },  
 261641: () => { return window.innerHeight; },  
 261668: () => { if (document.fullscreenElement) return 1; },  
 261714: () => { return document.getElementById('canvas').width; },  
 261766: () => { return screen.width; },  
 261791: () => { document.exitFullscreen(); },  
 ...
 261984: () => { document.exitFullscreen(); },  
 262011: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262069: () => { return screen.width; },  
 262094: () => { return screen.height; },  
 262120: () => { return window.screenX; },  
 262147: () => { return window.screenY; },  
 262174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262227: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262298: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262355: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262611: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262682: () => { if (document.fullscreenElement) return 1; },  
 262728: () => { return window.innerWidth; },  
 262754: () => { return window.innerHeight; },  
 262781: () => { if (document.pointerLockElement) return 1; }
};
