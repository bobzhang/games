...
function findWasmBinary() {
  return locateFile('raylib_core_input_mouse_wheel.wasm');
}
...
var ASM_CONSTS = {
  96944: () => { if (document.fullscreenElement) return 1; },  
 96990: () => { return document.getElementById('canvas').width; },  
 97042: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97110: () => { document.exitFullscreen(); },  
 97137: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97210: () => { if (document.fullscreenElement) return 1; },  
 97256: () => { return document.getElementById('canvas').width; },  
 97308: () => { return screen.width; },  
 97333: () => { document.exitFullscreen(); },  
 97360: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97493: () => { return window.innerWidth; },  
 97519: () => { return window.innerHeight; },  
 97546: () => { if (document.fullscreenElement) return 1; },  
 97592: () => { return document.getElementById('canvas').width; },  
 97644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97712: () => { if (document.fullscreenElement) return 1; },  
 97758: () => { return document.getElementById('canvas').width; },  
 97810: () => { return screen.width; },  
 97835: () => { return window.innerWidth; },  
 97861: () => { return window.innerHeight; },  
 97888: () => { if (document.fullscreenElement) return 1; },  
 97934: () => { return document.getElementById('canvas').width; },  
 97986: () => { return screen.width; },  
 98011: () => { document.exitFullscreen(); },  
 98038: () => { if (document.fullscreenElement) return 1; },  
 98084: () => { return document.getElementById('canvas').width; },  
 98136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98204: () => { document.exitFullscreen(); },  
 98231: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98289: () => { return screen.width; },  
 98314: () => { return screen.height; },  
 98340: () => { return window.screenX; },  
 98367: () => { return window.screenY; },  
 98394: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98447: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98518: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98575: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98831: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98902: () => { if (document.fullscreenElement) return 1; },  
 98948: () => { return window.innerWidth; },  
 98974: () => { return window.innerHeight; },  
 99001: () => { if (document.pointerLockElement) return 1; }
};
