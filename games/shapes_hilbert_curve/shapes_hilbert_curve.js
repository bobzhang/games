...
function findWasmBinary() {
  return locateFile('shapes_hilbert_curve.wasm');
}
...
var ASM_CONSTS = {
  252016: () => { if (document.fullscreenElement) return 1; },  
 252062: () => { return document.getElementById('canvas').width; },  
 252114: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252182: () => { document.exitFullscreen(); },  
 252209: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252282: () => { if (document.fullscreenElement) return 1; },  
 252328: () => { return document.getElementById('canvas').width; },  
 252380: () => { return screen.width; },  
 252405: () => { document.exitFullscreen(); },  
 252432: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252565: () => { return window.innerWidth; },  
 252591: () => { return window.innerHeight; },  
 252618: () => { if (document.fullscreenElement) return 1; },  
 252664: () => { return document.getElementById('canvas').width; },  
 252716: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252784: () => { if (document.fullscreenElement) return 1; },  
 252830: () => { return document.getElementById('canvas').width; },  
 252882: () => { return screen.width; },  
 252907: () => { return window.innerWidth; },  
 252933: () => { return window.innerHeight; },  
 252960: () => { if (document.fullscreenElement) return 1; },  
 253006: () => { return document.getElementById('canvas').width; },  
 253058: () => { return screen.width; },  
 253083: () => { document.exitFullscreen(); },  
 253110: () => { if (document.fullscreenElement) return 1; },  
 253156: () => { return document.getElementById('canvas').width; },  
 253208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253276: () => { document.exitFullscreen(); },  
 253303: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253361: () => { return screen.width; },  
 253386: () => { return screen.height; },  
 253412: () => { return window.screenX; },  
 253439: () => { return window.screenY; },  
 253466: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253519: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253590: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253647: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253903: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253974: () => { if (document.fullscreenElement) return 1; },  
 254020: () => { return window.innerWidth; },  
 254046: () => { return window.innerHeight; },  
 254073: () => { if (document.pointerLockElement) return 1; }
};
