...
var ASM_CONSTS = {
  252020: () => { if (document.fullscreenElement) return 1; },  
 252066: () => { return document.getElementById('canvas').width; },  
 252118: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252186: () => { document.exitFullscreen(); },  
 252213: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252286: () => { if (document.fullscreenElement) return 1; },  
 252332: () => { return document.getElementById('canvas').width; },  
 252384: () => { return screen.width; },  
 252409: () => { document.exitFullscreen(); },  
 252436: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252569: () => { return window.innerWidth; },  
 252595: () => { return window.innerHeight; },  
 252622: () => { if (document.fullscreenElement) return 1; },  
 252668: () => { return document.getElementById('canvas').width; },  
 252720: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252788: () => { if (document.fullscreenElement) return 1; },  
 252834: () => { return document.getElementById('canvas').width; },  
 252886: () => { return screen.width; },  
 252911: () => { return window.innerWidth; },  
 252937: () => { return window.innerHeight; },  
 252964: () => { if (document.fullscreenElement) return 1; },  
 253010: () => { return document.getElementById('canvas').width; },  
 253062: () => { return screen.width; },  
 253087: () => { document.exitFullscreen(); },  
 253114: () => { if (document.fullscreenElement) return 1; },  
 253160: () => { return document.getElementById('canvas').width; },  
 253212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253280: () => { document.exitFullscreen(); },  
 253307: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253365: () => { return screen.width; },  
 253390: () => { return screen.height; },  
 253416: () => { return window.screenX; },  
 253443: () => { return window.screenY; },  
 253470: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253523: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253594: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253651: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253907: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253978: () => { if (document.fullscreenElement) return 1; },  
 254024: () => { return window.innerWidth; },  
 254050: () => { return window.innerHeight; },  
 254077: () => { if (document.pointerLockElement) return 1; }
};
