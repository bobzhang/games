...
var ASM_CONSTS = {
  251796: () => { if (document.fullscreenElement) return 1; },  
 251842: () => { return document.getElementById('canvas').width; },  
 251894: () => { return parseInt(document.getElementById('canvas').style.width); },  
 251962: () => { document.exitFullscreen(); },  
 251989: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 252062: () => { if (document.fullscreenElement) return 1; },  
 252108: () => { return document.getElementById('canvas').width; },  
 252160: () => { return screen.width; },  
 252185: () => { document.exitFullscreen(); },  
 252212: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 252345: () => { return window.innerWidth; },  
 252371: () => { return window.innerHeight; },  
 252398: () => { if (document.fullscreenElement) return 1; },  
 252444: () => { return document.getElementById('canvas').width; },  
 252496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 252564: () => { if (document.fullscreenElement) return 1; },  
 252610: () => { return document.getElementById('canvas').width; },  
 252662: () => { return screen.width; },  
 252687: () => { return window.innerWidth; },  
 252713: () => { return window.innerHeight; },  
 ...
 252863: () => { document.exitFullscreen(); },  
 252890: () => { if (document.fullscreenElement) return 1; },  
 252936: () => { return document.getElementById('canvas').width; },  
 252988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 253056: () => { document.exitFullscreen(); },  
 253083: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 253141: () => { return screen.width; },  
 253166: () => { return screen.height; },  
 253192: () => { return window.screenX; },  
 253219: () => { return window.screenY; },  
 253246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 253299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 253370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 253427: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 253683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 253754: () => { if (document.fullscreenElement) return 1; },  
 253800: () => { return window.innerWidth; },  
 253826: () => { return window.innerHeight; },  
 253853: () => { if (document.pointerLockElement) return 1; }
};
