...
var ASM_CONSTS = {
  263300: () => { if (document.fullscreenElement) return 1; },  
 263346: () => { return document.getElementById('canvas').width; },  
 263398: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263466: () => { document.exitFullscreen(); },  
 263493: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263566: () => { if (document.fullscreenElement) return 1; },  
 263612: () => { return document.getElementById('canvas').width; },  
 263664: () => { return screen.width; },  
 263689: () => { document.exitFullscreen(); },  
 263716: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263849: () => { return window.innerWidth; },  
 263875: () => { return window.innerHeight; },  
 263902: () => { if (document.fullscreenElement) return 1; },  
 263948: () => { return document.getElementById('canvas').width; },  
 264000: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264191: () => { return window.innerWidth; },  
 264217: () => { return window.innerHeight; },  
 264244: () => { if (document.fullscreenElement) return 1; },  
 264290: () => { return document.getElementById('canvas').width; },  
 264342: () => { return screen.width; },  
 264367: () => { document.exitFullscreen(); },  
 ...
 264560: () => { document.exitFullscreen(); },  
 264587: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264645: () => { return screen.width; },  
 264670: () => { return screen.height; },  
 264696: () => { return window.screenX; },  
 264723: () => { return window.screenY; },  
 264750: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264803: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264874: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264931: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265187: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265258: () => { if (document.fullscreenElement) return 1; },  
 265304: () => { return window.innerWidth; },  
 265330: () => { return window.innerHeight; },  
 265357: () => { if (document.pointerLockElement) return 1; }
};
