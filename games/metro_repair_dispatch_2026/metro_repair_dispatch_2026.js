...
var ASM_CONSTS = {
 ...
 263430: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263498: () => { document.exitFullscreen(); },  
 263525: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263598: () => { if (document.fullscreenElement) return 1; },  
 263644: () => { return document.getElementById('canvas').width; },  
 263696: () => { return screen.width; },  
 263721: () => { document.exitFullscreen(); },  
 263748: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263881: () => { return window.innerWidth; },  
 263907: () => { return window.innerHeight; },  
 263934: () => { if (document.fullscreenElement) return 1; },  
 263980: () => { return document.getElementById('canvas').width; },  
 264032: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264100: () => { if (document.fullscreenElement) return 1; },  
 264146: () => { return document.getElementById('canvas').width; },  
 264198: () => { return screen.width; },  
 264223: () => { return window.innerWidth; },  
 264249: () => { return window.innerHeight; },  
 264276: () => { if (document.fullscreenElement) return 1; },  
 264322: () => { return document.getElementById('canvas').width; },  
 264374: () => { return screen.width; },  
 264399: () => { document.exitFullscreen(); },  
 264426: () => { if (document.fullscreenElement) return 1; },  
 264472: () => { return document.getElementById('canvas').width; },  
 264524: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264592: () => { document.exitFullscreen(); },  
 264619: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264677: () => { return screen.width; },  
 264702: () => { return screen.height; },  
 264728: () => { return window.screenX; },  
 264755: () => { return window.screenY; },  
 264782: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264835: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264906: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264963: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265219: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265290: () => { if (document.fullscreenElement) return 1; },  
 265336: () => { return window.innerWidth; },  
 265362: () => { return window.innerHeight; },  
 265389: () => { if (document.pointerLockElement) return 1; }
};
