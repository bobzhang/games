...
function findWasmBinary() {
  return locateFile('raylib_core_basic_window.wasm');
}
...
var ASM_CONSTS = {
  96816: () => { if (document.fullscreenElement) return 1; },  
 96862: () => { return document.getElementById('canvas').width; },  
 96914: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96982: () => { document.exitFullscreen(); },  
 97009: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97082: () => { if (document.fullscreenElement) return 1; },  
 97128: () => { return document.getElementById('canvas').width; },  
 97180: () => { return screen.width; },  
 97205: () => { document.exitFullscreen(); },  
 97232: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97365: () => { return window.innerWidth; },  
 97391: () => { return window.innerHeight; },  
 97418: () => { if (document.fullscreenElement) return 1; },  
 97464: () => { return document.getElementById('canvas').width; },  
 97516: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97584: () => { if (document.fullscreenElement) return 1; },  
 97630: () => { return document.getElementById('canvas').width; },  
 97682: () => { return screen.width; },  
 97707: () => { return window.innerWidth; },  
 97733: () => { return window.innerHeight; },  
 97760: () => { if (document.fullscreenElement) return 1; },  
 97806: () => { return document.getElementById('canvas').width; },  
 97858: () => { return screen.width; },  
 97883: () => { document.exitFullscreen(); },  
 97910: () => { if (document.fullscreenElement) return 1; },  
 97956: () => { return document.getElementById('canvas').width; },  
 98008: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98076: () => { document.exitFullscreen(); },  
 98103: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98161: () => { return screen.width; },  
 98186: () => { return screen.height; },  
 98212: () => { return window.screenX; },  
 98239: () => { return window.screenY; },  
 98266: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98319: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98390: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98447: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98703: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98774: () => { if (document.fullscreenElement) return 1; },  
 98820: () => { return window.innerWidth; },  
 98846: () => { return window.innerHeight; },  
 98873: () => { if (document.pointerLockElement) return 1; }
};
