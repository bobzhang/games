...
var ASM_CONSTS = {
  260404: () => { if (document.fullscreenElement) return 1; },  
 260450: () => { return document.getElementById('canvas').width; },  
 260502: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260570: () => { document.exitFullscreen(); },  
 260597: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260670: () => { if (document.fullscreenElement) return 1; },  
 260716: () => { return document.getElementById('canvas').width; },  
 260768: () => { return screen.width; },  
 260793: () => { document.exitFullscreen(); },  
 260820: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 260953: () => { return window.innerWidth; },  
 260979: () => { return window.innerHeight; },  
 261006: () => { if (document.fullscreenElement) return 1; },  
 261052: () => { return document.getElementById('canvas').width; },  
 261104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261172: () => { if (document.fullscreenElement) return 1; },  
 261218: () => { return document.getElementById('canvas').width; },  
 261270: () => { return screen.width; },  
 261295: () => { return window.innerWidth; },  
 261321: () => { return window.innerHeight; },  
 ...
 261471: () => { document.exitFullscreen(); },  
 ...
 261664: () => { document.exitFullscreen(); },  
 261691: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261749: () => { return screen.width; },  
 261774: () => { return screen.height; },  
 261800: () => { return window.screenX; },  
 261827: () => { return window.screenY; },  
 261854: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261907: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 261978: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262035: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262291: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262362: () => { if (document.fullscreenElement) return 1; },  
 262408: () => { return window.innerWidth; },  
 262434: () => { return window.innerHeight; },  
 262461: () => { if (document.pointerLockElement) return 1; }
};
