...
var ASM_CONSTS = {
  260612: () => { if (document.fullscreenElement) return 1; },  
 260658: () => { return document.getElementById('canvas').width; },  
 260710: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260778: () => { document.exitFullscreen(); },  
 260805: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260878: () => { if (document.fullscreenElement) return 1; },  
 260924: () => { return document.getElementById('canvas').width; },  
 260976: () => { return screen.width; },  
 261001: () => { document.exitFullscreen(); },  
 261028: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261161: () => { return window.innerWidth; },  
 261187: () => { return window.innerHeight; },  
 261214: () => { if (document.fullscreenElement) return 1; },  
 261260: () => { return document.getElementById('canvas').width; },  
 261312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261380: () => { if (document.fullscreenElement) return 1; },  
 261426: () => { return document.getElementById('canvas').width; },  
 261478: () => { return screen.width; },  
 261503: () => { return window.innerWidth; },  
 261529: () => { return window.innerHeight; },  
 ...
 261679: () => { document.exitFullscreen(); },  
 ...
 261872: () => { document.exitFullscreen(); },  
 261899: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261957: () => { return screen.width; },  
 261982: () => { return screen.height; },  
 262008: () => { return window.screenX; },  
 262035: () => { return window.screenY; },  
 262062: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262115: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262186: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262243: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262499: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262570: () => { if (document.fullscreenElement) return 1; },  
 262616: () => { return window.innerWidth; },  
 262642: () => { return window.innerHeight; },  
 262669: () => { if (document.pointerLockElement) return 1; }
};
