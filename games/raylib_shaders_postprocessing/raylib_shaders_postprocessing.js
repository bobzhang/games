...
function findWasmBinary() {
  return locateFile('raylib_shaders_postprocessing.wasm');
}
...
var ASM_CONSTS = {
  101056: () => { if (document.fullscreenElement) return 1; },  
 101102: () => { return document.getElementById('canvas').width; },  
 101154: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101222: () => { document.exitFullscreen(); },  
 101249: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101322: () => { if (document.fullscreenElement) return 1; },  
 101368: () => { return document.getElementById('canvas').width; },  
 101420: () => { return screen.width; },  
 101445: () => { document.exitFullscreen(); },  
 101472: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101605: () => { return window.innerWidth; },  
 101631: () => { return window.innerHeight; },  
 101658: () => { if (document.fullscreenElement) return 1; },  
 101704: () => { return document.getElementById('canvas').width; },  
 101756: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101824: () => { if (document.fullscreenElement) return 1; },  
 101870: () => { return document.getElementById('canvas').width; },  
 101922: () => { return screen.width; },  
 101947: () => { return window.innerWidth; },  
 101973: () => { return window.innerHeight; },  
 102000: () => { if (document.fullscreenElement) return 1; },  
 102046: () => { return document.getElementById('canvas').width; },  
 102098: () => { return screen.width; },  
 102123: () => { document.exitFullscreen(); },  
 102150: () => { if (document.fullscreenElement) return 1; },  
 102196: () => { return document.getElementById('canvas').width; },  
 102248: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102316: () => { document.exitFullscreen(); },  
 102343: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102401: () => { return screen.width; },  
 102426: () => { return screen.height; },  
 102452: () => { return window.screenX; },  
 102479: () => { return window.screenY; },  
 102506: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102559: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102630: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102687: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102943: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103014: () => { if (document.fullscreenElement) return 1; },  
 103060: () => { return window.innerWidth; },  
 103086: () => { return window.innerHeight; },  
 103113: () => { if (document.pointerLockElement) return 1; }
};
