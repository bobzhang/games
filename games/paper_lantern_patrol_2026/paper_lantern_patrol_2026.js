...
function findWasmBinary() {
  return locateFile('paper_lantern_patrol_2026.wasm');
}
...
var ASM_CONSTS = {
 ...
 263922: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263990: () => { document.exitFullscreen(); },  
 264017: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264090: () => { if (document.fullscreenElement) return 1; },  
 264136: () => { return document.getElementById('canvas').width; },  
 264188: () => { return screen.width; },  
 264213: () => { document.exitFullscreen(); },  
 264240: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264373: () => { return window.innerWidth; },  
 264399: () => { return window.innerHeight; },  
 ...
 264592: () => { if (document.fullscreenElement) return 1; },  
 264638: () => { return document.getElementById('canvas').width; },  
 264690: () => { return screen.width; },  
 264715: () => { return window.innerWidth; },  
 264741: () => { return window.innerHeight; },  
 264768: () => { if (document.fullscreenElement) return 1; },  
 264814: () => { return document.getElementById('canvas').width; },  
 264866: () => { return screen.width; },  
 264891: () => { document.exitFullscreen(); },  
 264918: () => { if (document.fullscreenElement) return 1; },  
 264964: () => { return document.getElementById('canvas').width; },  
 265016: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265084: () => { document.exitFullscreen(); },  
 265111: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265169: () => { return screen.width; },  
 265194: () => { return screen.height; },  
 265220: () => { return window.screenX; },  
 265247: () => { return window.screenY; },  
 265274: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265327: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265398: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265455: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265711: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265782: () => { if (document.fullscreenElement) return 1; },  
 265828: () => { return window.innerWidth; },  
 265854: () => { return window.innerHeight; },  
 265881: () => { if (document.pointerLockElement) return 1; }
};
