...
var ASM_CONSTS = {
 ...
 263718: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263786: () => { document.exitFullscreen(); },  
 263813: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263886: () => { if (document.fullscreenElement) return 1; },  
 263932: () => { return document.getElementById('canvas').width; },  
 263984: () => { return screen.width; },  
 264009: () => { document.exitFullscreen(); },  
 264036: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264169: () => { return window.innerWidth; },  
 264195: () => { return window.innerHeight; },  
 264222: () => { if (document.fullscreenElement) return 1; },  
 264268: () => { return document.getElementById('canvas').width; },  
 264320: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264388: () => { if (document.fullscreenElement) return 1; },  
 264434: () => { return document.getElementById('canvas').width; },  
 264486: () => { return screen.width; },  
 264511: () => { return window.innerWidth; },  
 264537: () => { return window.innerHeight; },  
 ...
 264687: () => { document.exitFullscreen(); },  
 264714: () => { if (document.fullscreenElement) return 1; },  
 264760: () => { return document.getElementById('canvas').width; },  
 264812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264880: () => { document.exitFullscreen(); },  
 264907: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264965: () => { return screen.width; },  
 264990: () => { return screen.height; },  
 265016: () => { return window.screenX; },  
 265043: () => { return window.screenY; },  
 265070: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265123: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265194: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265251: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265507: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265578: () => { if (document.fullscreenElement) return 1; },  
 265624: () => { return window.innerWidth; },  
 265650: () => { return window.innerHeight; },  
 265677: () => { if (document.pointerLockElement) return 1; }
};
