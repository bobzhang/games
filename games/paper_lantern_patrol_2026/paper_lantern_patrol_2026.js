...
var ASM_CONSTS = {
 ...
 263926: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263994: () => { document.exitFullscreen(); },  
 264021: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264094: () => { if (document.fullscreenElement) return 1; },  
 264140: () => { return document.getElementById('canvas').width; },  
 264192: () => { return screen.width; },  
 264217: () => { document.exitFullscreen(); },  
 264244: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264377: () => { return window.innerWidth; },  
 264403: () => { return window.innerHeight; },  
 264430: () => { if (document.fullscreenElement) return 1; },  
 264476: () => { return document.getElementById('canvas').width; },  
 264528: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264596: () => { if (document.fullscreenElement) return 1; },  
 264642: () => { return document.getElementById('canvas').width; },  
 264694: () => { return screen.width; },  
 264719: () => { return window.innerWidth; },  
 264745: () => { return window.innerHeight; },  
 ...
 264895: () => { document.exitFullscreen(); },  
 264922: () => { if (document.fullscreenElement) return 1; },  
 264968: () => { return document.getElementById('canvas').width; },  
 265020: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265088: () => { document.exitFullscreen(); },  
 265115: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265173: () => { return screen.width; },  
 265198: () => { return screen.height; },  
 265224: () => { return window.screenX; },  
 265251: () => { return window.screenY; },  
 265278: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265331: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265402: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265459: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265715: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265786: () => { if (document.fullscreenElement) return 1; },  
 265832: () => { return window.innerWidth; },  
 265858: () => { return window.innerHeight; },  
 265885: () => { if (document.pointerLockElement) return 1; }
};
