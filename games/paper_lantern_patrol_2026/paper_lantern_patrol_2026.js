...
var ASM_CONSTS = {
 ...
 263910: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263978: () => { document.exitFullscreen(); },  
 264005: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264078: () => { if (document.fullscreenElement) return 1; },  
 264124: () => { return document.getElementById('canvas').width; },  
 264176: () => { return screen.width; },  
 264201: () => { document.exitFullscreen(); },  
 264228: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264361: () => { return window.innerWidth; },  
 264387: () => { return window.innerHeight; },  
 264414: () => { if (document.fullscreenElement) return 1; },  
 264460: () => { return document.getElementById('canvas').width; },  
 264512: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264580: () => { if (document.fullscreenElement) return 1; },  
 264626: () => { return document.getElementById('canvas').width; },  
 264678: () => { return screen.width; },  
 264703: () => { return window.innerWidth; },  
 264729: () => { return window.innerHeight; },  
 264756: () => { if (document.fullscreenElement) return 1; },  
 264802: () => { return document.getElementById('canvas').width; },  
 264854: () => { return screen.width; },  
 264879: () => { document.exitFullscreen(); },  
 264906: () => { if (document.fullscreenElement) return 1; },  
 264952: () => { return document.getElementById('canvas').width; },  
 265004: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265072: () => { document.exitFullscreen(); },  
 265099: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265157: () => { return screen.width; },  
 265182: () => { return screen.height; },  
 265208: () => { return window.screenX; },  
 265235: () => { return window.screenY; },  
 265262: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265315: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265386: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265443: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265699: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265770: () => { if (document.fullscreenElement) return 1; },  
 265816: () => { return window.innerWidth; },  
 265842: () => { return window.innerHeight; },  
 265869: () => { if (document.pointerLockElement) return 1; }
};
