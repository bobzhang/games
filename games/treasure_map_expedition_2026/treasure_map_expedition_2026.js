...
var ASM_CONSTS = {
  261620: () => { if (document.fullscreenElement) return 1; },  
 261666: () => { return document.getElementById('canvas').width; },  
 261718: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261786: () => { document.exitFullscreen(); },  
 261813: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261886: () => { if (document.fullscreenElement) return 1; },  
 261932: () => { return document.getElementById('canvas').width; },  
 261984: () => { return screen.width; },  
 262009: () => { document.exitFullscreen(); },  
 262036: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262169: () => { return window.innerWidth; },  
 262195: () => { return window.innerHeight; },  
 262222: () => { if (document.fullscreenElement) return 1; },  
 262268: () => { return document.getElementById('canvas').width; },  
 262320: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262388: () => { if (document.fullscreenElement) return 1; },  
 262434: () => { return document.getElementById('canvas').width; },  
 262486: () => { return screen.width; },  
 262511: () => { return window.innerWidth; },  
 262537: () => { return window.innerHeight; },  
 262564: () => { if (document.fullscreenElement) return 1; },  
 262610: () => { return document.getElementById('canvas').width; },  
 262662: () => { return screen.width; },  
 262687: () => { document.exitFullscreen(); },  
 262714: () => { if (document.fullscreenElement) return 1; },  
 262760: () => { return document.getElementById('canvas').width; },  
 262812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262880: () => { document.exitFullscreen(); },  
 262907: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262965: () => { return screen.width; },  
 262990: () => { return screen.height; },  
 263016: () => { return window.screenX; },  
 263043: () => { return window.screenY; },  
 263070: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263123: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263194: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263251: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263507: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263578: () => { if (document.fullscreenElement) return 1; },  
 263624: () => { return window.innerWidth; },  
 263650: () => { return window.innerHeight; },  
 263677: () => { if (document.pointerLockElement) return 1; }
};
