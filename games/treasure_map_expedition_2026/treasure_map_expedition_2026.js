...
var ASM_CONSTS = {
  261412: () => { if (document.fullscreenElement) return 1; },  
 261458: () => { return document.getElementById('canvas').width; },  
 261510: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261578: () => { document.exitFullscreen(); },  
 261605: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261678: () => { if (document.fullscreenElement) return 1; },  
 261724: () => { return document.getElementById('canvas').width; },  
 261776: () => { return screen.width; },  
 261801: () => { document.exitFullscreen(); },  
 261828: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261961: () => { return window.innerWidth; },  
 261987: () => { return window.innerHeight; },  
 262014: () => { if (document.fullscreenElement) return 1; },  
 262060: () => { return document.getElementById('canvas').width; },  
 262112: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262180: () => { if (document.fullscreenElement) return 1; },  
 262226: () => { return document.getElementById('canvas').width; },  
 262278: () => { return screen.width; },  
 262303: () => { return window.innerWidth; },  
 262329: () => { return window.innerHeight; },  
 262356: () => { if (document.fullscreenElement) return 1; },  
 262402: () => { return document.getElementById('canvas').width; },  
 262454: () => { return screen.width; },  
 262479: () => { document.exitFullscreen(); },  
 262506: () => { if (document.fullscreenElement) return 1; },  
 262552: () => { return document.getElementById('canvas').width; },  
 262604: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262672: () => { document.exitFullscreen(); },  
 262699: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262757: () => { return screen.width; },  
 262782: () => { return screen.height; },  
 262808: () => { return window.screenX; },  
 262835: () => { return window.screenY; },  
 262862: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262915: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262986: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263043: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263299: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263370: () => { if (document.fullscreenElement) return 1; },  
 263416: () => { return window.innerWidth; },  
 263442: () => { return window.innerHeight; },  
 263469: () => { if (document.pointerLockElement) return 1; }
};
