...
var ASM_CONSTS = {
  261636: () => { if (document.fullscreenElement) return 1; },  
 261682: () => { return document.getElementById('canvas').width; },  
 261734: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261802: () => { document.exitFullscreen(); },  
 261829: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261902: () => { if (document.fullscreenElement) return 1; },  
 261948: () => { return document.getElementById('canvas').width; },  
 262000: () => { return screen.width; },  
 262025: () => { document.exitFullscreen(); },  
 262052: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262185: () => { return window.innerWidth; },  
 262211: () => { return window.innerHeight; },  
 262238: () => { if (document.fullscreenElement) return 1; },  
 262284: () => { return document.getElementById('canvas').width; },  
 262336: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262404: () => { if (document.fullscreenElement) return 1; },  
 262450: () => { return document.getElementById('canvas').width; },  
 262502: () => { return screen.width; },  
 262527: () => { return window.innerWidth; },  
 262553: () => { return window.innerHeight; },  
 262580: () => { if (document.fullscreenElement) return 1; },  
 262626: () => { return document.getElementById('canvas').width; },  
 262678: () => { return screen.width; },  
 262703: () => { document.exitFullscreen(); },  
 262730: () => { if (document.fullscreenElement) return 1; },  
 262776: () => { return document.getElementById('canvas').width; },  
 262828: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262896: () => { document.exitFullscreen(); },  
 262923: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262981: () => { return screen.width; },  
 263006: () => { return screen.height; },  
 263032: () => { return window.screenX; },  
 263059: () => { return window.screenY; },  
 263086: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263139: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263210: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263267: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263523: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263594: () => { if (document.fullscreenElement) return 1; },  
 263640: () => { return window.innerWidth; },  
 263666: () => { return window.innerHeight; },  
 263693: () => { if (document.pointerLockElement) return 1; }
};
