...
function findWasmBinary() {
  return locateFile('raylib_text_font_filters.wasm');
}
...
var ASM_CONSTS = {
  187232: () => { if (document.fullscreenElement) return 1; },  
 187278: () => { return document.getElementById('canvas').width; },  
 187330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 187398: () => { document.exitFullscreen(); },  
 187425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 187498: () => { if (document.fullscreenElement) return 1; },  
 187544: () => { return document.getElementById('canvas').width; },  
 187596: () => { return screen.width; },  
 187621: () => { document.exitFullscreen(); },  
 187648: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 187781: () => { return window.innerWidth; },  
 187807: () => { return window.innerHeight; },  
 187834: () => { if (document.fullscreenElement) return 1; },  
 187880: () => { return document.getElementById('canvas').width; },  
 187932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 188000: () => { if (document.fullscreenElement) return 1; },  
 188046: () => { return document.getElementById('canvas').width; },  
 188098: () => { return screen.width; },  
 188123: () => { return window.innerWidth; },  
 188149: () => { return window.innerHeight; },  
 188176: () => { if (document.fullscreenElement) return 1; },  
 188222: () => { return document.getElementById('canvas').width; },  
 188274: () => { return screen.width; },  
 188299: () => { document.exitFullscreen(); },  
 188326: () => { if (document.fullscreenElement) return 1; },  
 188372: () => { return document.getElementById('canvas').width; },  
 188424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 188492: () => { document.exitFullscreen(); },  
 188519: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 188577: () => { return screen.width; },  
 188602: () => { return screen.height; },  
 188628: () => { return window.screenX; },  
 188655: () => { return window.screenY; },  
 188682: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 188735: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 188806: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 188863: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 189119: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 189190: () => { if (document.fullscreenElement) return 1; },  
 189236: () => { return window.innerWidth; },  
 189262: () => { return window.innerHeight; },  
 189289: () => { if (document.pointerLockElement) return 1; }
};
