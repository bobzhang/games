...
function findWasmBinary() {
  return locateFile('raylib_textures_image_rotate.wasm');
}
...
var ASM_CONSTS = {
  104800: () => { if (document.fullscreenElement) return 1; },  
 104846: () => { return document.getElementById('canvas').width; },  
 104898: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104966: () => { document.exitFullscreen(); },  
 104993: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 105066: () => { if (document.fullscreenElement) return 1; },  
 105112: () => { return document.getElementById('canvas').width; },  
 105164: () => { return screen.width; },  
 105189: () => { document.exitFullscreen(); },  
 105216: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 105349: () => { return window.innerWidth; },  
 105375: () => { return window.innerHeight; },  
 105402: () => { if (document.fullscreenElement) return 1; },  
 105448: () => { return document.getElementById('canvas').width; },  
 105500: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105568: () => { if (document.fullscreenElement) return 1; },  
 105614: () => { return document.getElementById('canvas').width; },  
 105666: () => { return screen.width; },  
 105691: () => { return window.innerWidth; },  
 105717: () => { return window.innerHeight; },  
 105744: () => { if (document.fullscreenElement) return 1; },  
 105790: () => { return document.getElementById('canvas').width; },  
 105842: () => { return screen.width; },  
 105867: () => { document.exitFullscreen(); },  
 105894: () => { if (document.fullscreenElement) return 1; },  
 105940: () => { return document.getElementById('canvas').width; },  
 105992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106060: () => { document.exitFullscreen(); },  
 106087: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 106145: () => { return screen.width; },  
 106170: () => { return screen.height; },  
 106196: () => { return window.screenX; },  
 106223: () => { return window.screenY; },  
 106250: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 106303: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106374: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106431: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106687: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106758: () => { if (document.fullscreenElement) return 1; },  
 106804: () => { return window.innerWidth; },  
 106830: () => { return window.innerHeight; },  
 106857: () => { if (document.pointerLockElement) return 1; }
};
