...
var ASM_CONSTS = {
  261188: () => { if (document.fullscreenElement) return 1; },  
 261234: () => { return document.getElementById('canvas').width; },  
 261286: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261354: () => { document.exitFullscreen(); },  
 261381: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261454: () => { if (document.fullscreenElement) return 1; },  
 261500: () => { return document.getElementById('canvas').width; },  
 261552: () => { return screen.width; },  
 261577: () => { document.exitFullscreen(); },  
 261604: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261737: () => { return window.innerWidth; },  
 261763: () => { return window.innerHeight; },  
 261790: () => { if (document.fullscreenElement) return 1; },  
 261836: () => { return document.getElementById('canvas').width; },  
 261888: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261956: () => { if (document.fullscreenElement) return 1; },  
 262002: () => { return document.getElementById('canvas').width; },  
 262054: () => { return screen.width; },  
 262079: () => { return window.innerWidth; },  
 262105: () => { return window.innerHeight; },  
 262132: () => { if (document.fullscreenElement) return 1; },  
 262178: () => { return document.getElementById('canvas').width; },  
 262230: () => { return screen.width; },  
 262255: () => { document.exitFullscreen(); },  
 262282: () => { if (document.fullscreenElement) return 1; },  
 262328: () => { return document.getElementById('canvas').width; },  
 262380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262448: () => { document.exitFullscreen(); },  
 262475: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262533: () => { return screen.width; },  
 262558: () => { return screen.height; },  
 262584: () => { return window.screenX; },  
 262611: () => { return window.screenY; },  
 262638: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262691: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262762: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262819: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263075: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263146: () => { if (document.fullscreenElement) return 1; },  
 263192: () => { return window.innerWidth; },  
 263218: () => { return window.innerHeight; },  
 263245: () => { if (document.pointerLockElement) return 1; }
};
