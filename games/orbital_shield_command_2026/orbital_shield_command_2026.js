...
var ASM_CONSTS = {
 ...
 261494: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261562: () => { document.exitFullscreen(); },  
 261589: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261662: () => { if (document.fullscreenElement) return 1; },  
 261708: () => { return document.getElementById('canvas').width; },  
 261760: () => { return screen.width; },  
 261785: () => { document.exitFullscreen(); },  
 261812: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261945: () => { return window.innerWidth; },  
 261971: () => { return window.innerHeight; },  
 261998: () => { if (document.fullscreenElement) return 1; },  
 262044: () => { return document.getElementById('canvas').width; },  
 262096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262287: () => { return window.innerWidth; },  
 262313: () => { return window.innerHeight; },  
 ...
 262463: () => { document.exitFullscreen(); },  
 ...
 262656: () => { document.exitFullscreen(); },  
 262683: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262741: () => { return screen.width; },  
 262766: () => { return screen.height; },  
 262792: () => { return window.screenX; },  
 262819: () => { return window.screenY; },  
 262846: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262899: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262970: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263027: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263283: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263354: () => { if (document.fullscreenElement) return 1; },  
 263400: () => { return window.innerWidth; },  
 263426: () => { return window.innerHeight; },  
 263453: () => { if (document.pointerLockElement) return 1; }
};
