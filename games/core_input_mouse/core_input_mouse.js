...
var ASM_CONSTS = {
  260804: () => { if (document.fullscreenElement) return 1; },  
 260850: () => { return document.getElementById('canvas').width; },  
 260902: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260970: () => { document.exitFullscreen(); },  
 260997: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261070: () => { if (document.fullscreenElement) return 1; },  
 261116: () => { return document.getElementById('canvas').width; },  
 261168: () => { return screen.width; },  
 261193: () => { document.exitFullscreen(); },  
 261220: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261353: () => { return window.innerWidth; },  
 261379: () => { return window.innerHeight; },  
 261406: () => { if (document.fullscreenElement) return 1; },  
 261452: () => { return document.getElementById('canvas').width; },  
 261504: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261695: () => { return window.innerWidth; },  
 261721: () => { return window.innerHeight; },  
 ...
 261871: () => { document.exitFullscreen(); },  
 ...
 262064: () => { document.exitFullscreen(); },  
 262091: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262149: () => { return screen.width; },  
 262174: () => { return screen.height; },  
 262200: () => { return window.screenX; },  
 262227: () => { return window.screenY; },  
 262254: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262307: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262378: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262691: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262762: () => { if (document.fullscreenElement) return 1; },  
 262808: () => { return window.innerWidth; },  
 262834: () => { return window.innerHeight; },  
 262861: () => { if (document.pointerLockElement) return 1; }
};
