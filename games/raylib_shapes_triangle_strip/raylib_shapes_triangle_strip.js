...
function findWasmBinary() {
  return locateFile('raylib_shapes_triangle_strip.wasm');
}
...
var ASM_CONSTS = {
  96912: () => { if (document.fullscreenElement) return 1; },  
 96958: () => { return document.getElementById('canvas').width; },  
 97010: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97078: () => { document.exitFullscreen(); },  
 97105: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97178: () => { if (document.fullscreenElement) return 1; },  
 97224: () => { return document.getElementById('canvas').width; },  
 97276: () => { return screen.width; },  
 97301: () => { document.exitFullscreen(); },  
 97328: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97461: () => { return window.innerWidth; },  
 97487: () => { return window.innerHeight; },  
 97514: () => { if (document.fullscreenElement) return 1; },  
 97560: () => { return document.getElementById('canvas').width; },  
 97612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97680: () => { if (document.fullscreenElement) return 1; },  
 97726: () => { return document.getElementById('canvas').width; },  
 97778: () => { return screen.width; },  
 97803: () => { return window.innerWidth; },  
 97829: () => { return window.innerHeight; },  
 97856: () => { if (document.fullscreenElement) return 1; },  
 97902: () => { return document.getElementById('canvas').width; },  
 97954: () => { return screen.width; },  
 97979: () => { document.exitFullscreen(); },  
 98006: () => { if (document.fullscreenElement) return 1; },  
 98052: () => { return document.getElementById('canvas').width; },  
 98104: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98172: () => { document.exitFullscreen(); },  
 98199: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98257: () => { return screen.width; },  
 98282: () => { return screen.height; },  
 98308: () => { return window.screenX; },  
 98335: () => { return window.screenY; },  
 98362: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98415: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98486: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98543: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98799: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98870: () => { if (document.fullscreenElement) return 1; },  
 98916: () => { return window.innerWidth; },  
 98942: () => { return window.innerHeight; },  
 98969: () => { if (document.pointerLockElement) return 1; }
};
