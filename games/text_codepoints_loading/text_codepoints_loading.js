...
var ASM_CONSTS = {
  2292532: () => { if (document.fullscreenElement) return 1; },  
 2292578: () => { return document.getElementById('canvas').width; },  
 2292630: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2292698: () => { document.exitFullscreen(); },  
 2292725: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2292798: () => { if (document.fullscreenElement) return 1; },  
 2292844: () => { return document.getElementById('canvas').width; },  
 2292896: () => { return screen.width; },  
 2292921: () => { document.exitFullscreen(); },  
 2292948: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2293081: () => { return window.innerWidth; },  
 2293107: () => { return window.innerHeight; },  
 2293134: () => { if (document.fullscreenElement) return 1; },  
 2293180: () => { return document.getElementById('canvas').width; },  
 2293232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2293300: () => { if (document.fullscreenElement) return 1; },  
 2293346: () => { return document.getElementById('canvas').width; },  
 2293398: () => { return screen.width; },  
 2293423: () => { return window.innerWidth; },  
 2293449: () => { return window.innerHeight; },  
 2293476: () => { if (document.fullscreenElement) return 1; },  
 2293522: () => { return document.getElementById('canvas').width; },  
 2293574: () => { return screen.width; },  
 2293599: () => { document.exitFullscreen(); },  
 2293626: () => { if (document.fullscreenElement) return 1; },  
 2293672: () => { return document.getElementById('canvas').width; },  
 2293724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2293792: () => { document.exitFullscreen(); },  
 2293819: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2293877: () => { return screen.width; },  
 2293902: () => { return screen.height; },  
 2293928: () => { return window.screenX; },  
 2293955: () => { return window.screenY; },  
 2293982: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2294035: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2294106: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2294163: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2294419: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2294490: () => { if (document.fullscreenElement) return 1; },  
 2294536: () => { return window.innerWidth; },  
 2294562: () => { return window.innerHeight; },  
 2294589: () => { if (document.pointerLockElement) return 1; }
};
