...
var ASM_CONSTS = {
  2292340: () => { if (document.fullscreenElement) return 1; },  
 2292386: () => { return document.getElementById('canvas').width; },  
 2292438: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2292506: () => { document.exitFullscreen(); },  
 2292533: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2292606: () => { if (document.fullscreenElement) return 1; },  
 2292652: () => { return document.getElementById('canvas').width; },  
 2292704: () => { return screen.width; },  
 2292729: () => { document.exitFullscreen(); },  
 2292756: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2292889: () => { return window.innerWidth; },  
 2292915: () => { return window.innerHeight; },  
 2292942: () => { if (document.fullscreenElement) return 1; },  
 2292988: () => { return document.getElementById('canvas').width; },  
 2293040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2293108: () => { if (document.fullscreenElement) return 1; },  
 2293154: () => { return document.getElementById('canvas').width; },  
 2293206: () => { return screen.width; },  
 2293231: () => { return window.innerWidth; },  
 2293257: () => { return window.innerHeight; },  
 2293284: () => { if (document.fullscreenElement) return 1; },  
 2293330: () => { return document.getElementById('canvas').width; },  
 2293382: () => { return screen.width; },  
 2293407: () => { document.exitFullscreen(); },  
 2293434: () => { if (document.fullscreenElement) return 1; },  
 2293480: () => { return document.getElementById('canvas').width; },  
 2293532: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2293600: () => { document.exitFullscreen(); },  
 2293627: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2293685: () => { return screen.width; },  
 2293710: () => { return screen.height; },  
 2293736: () => { return window.screenX; },  
 2293763: () => { return window.screenY; },  
 2293790: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2293843: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2293914: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2293971: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2294227: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2294298: () => { if (document.fullscreenElement) return 1; },  
 2294344: () => { return window.innerWidth; },  
 2294370: () => { return window.innerHeight; },  
 2294397: () => { if (document.pointerLockElement) return 1; }
};
