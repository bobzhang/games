...
function findWasmBinary() {
  return locateFile('raylib_shaders_hybrid_render.wasm');
}
...
var ASM_CONSTS = {
 ...
 106526: () => { return document.getElementById('canvas').width; },  
 106578: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106646: () => { document.exitFullscreen(); },  
 106673: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106746: () => { if (document.fullscreenElement) return 1; },  
 106792: () => { return document.getElementById('canvas').width; },  
 106844: () => { return screen.width; },  
 106869: () => { document.exitFullscreen(); },  
 106896: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107029: () => { return window.innerWidth; },  
 107055: () => { return window.innerHeight; },  
 107082: () => { if (document.fullscreenElement) return 1; },  
 107128: () => { return document.getElementById('canvas').width; },  
 107180: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107248: () => { if (document.fullscreenElement) return 1; },  
 107294: () => { return document.getElementById('canvas').width; },  
 107346: () => { return screen.width; },  
 107371: () => { return window.innerWidth; },  
 107397: () => { return window.innerHeight; },  
 107424: () => { if (document.fullscreenElement) return 1; },  
 107470: () => { return document.getElementById('canvas').width; },  
 107522: () => { return screen.width; },  
 107547: () => { document.exitFullscreen(); },  
 107574: () => { if (document.fullscreenElement) return 1; },  
 107620: () => { return document.getElementById('canvas').width; },  
 107672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107740: () => { document.exitFullscreen(); },  
 107767: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 107825: () => { return screen.width; },  
 107850: () => { return screen.height; },  
 107876: () => { return window.screenX; },  
 107903: () => { return window.screenY; },  
 107930: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 107983: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108054: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108111: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108367: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108438: () => { if (document.fullscreenElement) return 1; },  
 108484: () => { return window.innerWidth; },  
 108510: () => { return window.innerHeight; },  
 108537: () => { if (document.pointerLockElement) return 1; }
};
