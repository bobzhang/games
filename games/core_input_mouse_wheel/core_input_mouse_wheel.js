...
var ASM_CONSTS = {
  260468: () => { if (document.fullscreenElement) return 1; },  
 260514: () => { return document.getElementById('canvas').width; },  
 260566: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260634: () => { document.exitFullscreen(); },  
 260661: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260734: () => { if (document.fullscreenElement) return 1; },  
 260780: () => { return document.getElementById('canvas').width; },  
 260832: () => { return screen.width; },  
 260857: () => { document.exitFullscreen(); },  
 260884: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261017: () => { return window.innerWidth; },  
 261043: () => { return window.innerHeight; },  
 261070: () => { if (document.fullscreenElement) return 1; },  
 261116: () => { return document.getElementById('canvas').width; },  
 261168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261236: () => { if (document.fullscreenElement) return 1; },  
 261282: () => { return document.getElementById('canvas').width; },  
 261334: () => { return screen.width; },  
 261359: () => { return window.innerWidth; },  
 261385: () => { return window.innerHeight; },  
 ...
 261535: () => { document.exitFullscreen(); },  
 ...
 261728: () => { document.exitFullscreen(); },  
 261755: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 261813: () => { return screen.width; },  
 261838: () => { return screen.height; },  
 261864: () => { return window.screenX; },  
 261891: () => { return window.screenY; },  
 261918: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 261971: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262042: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262099: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262355: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262426: () => { if (document.fullscreenElement) return 1; },  
 262472: () => { return window.innerWidth; },  
 262498: () => { return window.innerHeight; },  
 262525: () => { if (document.pointerLockElement) return 1; }
};
