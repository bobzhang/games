...
function findWasmBinary() {
  return locateFile('neon_rooftop_rush_2026.wasm');
}
...
var ASM_CONSTS = {
  268236: () => { if (document.fullscreenElement) return 1; },  
 268282: () => { return document.getElementById('canvas').width; },  
 268334: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268402: () => { document.exitFullscreen(); },  
 268429: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268502: () => { if (document.fullscreenElement) return 1; },  
 268548: () => { return document.getElementById('canvas').width; },  
 268600: () => { return screen.width; },  
 268625: () => { document.exitFullscreen(); },  
 268652: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268785: () => { return window.innerWidth; },  
 268811: () => { return window.innerHeight; },  
 268838: () => { if (document.fullscreenElement) return 1; },  
 268884: () => { return document.getElementById('canvas').width; },  
 268936: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269004: () => { if (document.fullscreenElement) return 1; },  
 269050: () => { return document.getElementById('canvas').width; },  
 269102: () => { return screen.width; },  
 269127: () => { return window.innerWidth; },  
 269153: () => { return window.innerHeight; },  
 269180: () => { if (document.fullscreenElement) return 1; },  
 269226: () => { return document.getElementById('canvas').width; },  
 269278: () => { return screen.width; },  
 269303: () => { document.exitFullscreen(); },  
