...
var ASM_CONSTS = {
 ...
 268110: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268178: () => { document.exitFullscreen(); },  
 268205: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268278: () => { if (document.fullscreenElement) return 1; },  
 268324: () => { return document.getElementById('canvas').width; },  
 268376: () => { return screen.width; },  
 268401: () => { document.exitFullscreen(); },  
 268428: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268561: () => { return window.innerWidth; },  
 268587: () => { return window.innerHeight; },  
 268614: () => { if (document.fullscreenElement) return 1; },  
 268660: () => { return document.getElementById('canvas').width; },  
 268712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268780: () => { if (document.fullscreenElement) return 1; },  
 268826: () => { return document.getElementById('canvas').width; },  
 268878: () => { return screen.width; },  
 268903: () => { return window.innerWidth; },  
 268929: () => { return window.innerHeight; },  
 ...
 269079: () => { document.exitFullscreen(); },  
 ...
 269272: () => { document.exitFullscreen(); },  
 269299: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269357: () => { return screen.width; },  
 269382: () => { return screen.height; },  
 269408: () => { return window.screenX; },  
 269435: () => { return window.screenY; },  
 269462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269515: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269586: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269643: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269899: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269970: () => { if (document.fullscreenElement) return 1; },  
 270016: () => { return window.innerWidth; },  
 270042: () => { return window.innerHeight; },  
 270069: () => { if (document.pointerLockElement) return 1; },  
 270116: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 272274: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 272438: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 272542: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 275541: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 ...
 276000: ($0) => { miniaudio.untrack_device_by_index($0); },  
 276043: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 276168: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
