...
function findWasmBinary() {
  return locateFile('raylib_text_unicode.wasm');
}
...
var ASM_CONSTS = {
  776640: () => { if (document.fullscreenElement) return 1; },  
 776686: () => { return document.getElementById('canvas').width; },  
 776738: () => { return parseInt(document.getElementById('canvas').style.width); },  
 776806: () => { document.exitFullscreen(); },  
 776833: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 776906: () => { if (document.fullscreenElement) return 1; },  
 776952: () => { return document.getElementById('canvas').width; },  
 777004: () => { return screen.width; },  
 777029: () => { document.exitFullscreen(); },  
 777056: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 777189: () => { return window.innerWidth; },  
 777215: () => { return window.innerHeight; },  
 777242: () => { if (document.fullscreenElement) return 1; },  
 777288: () => { return document.getElementById('canvas').width; },  
 777340: () => { return parseInt(document.getElementById('canvas').style.width); },  
 777408: () => { if (document.fullscreenElement) return 1; },  
 777454: () => { return document.getElementById('canvas').width; },  
 777506: () => { return screen.width; },  
 777531: () => { return window.innerWidth; },  
 777557: () => { return window.innerHeight; },  
 777584: () => { if (document.fullscreenElement) return 1; },  
 777630: () => { return document.getElementById('canvas').width; },  
 777682: () => { return screen.width; },  
 777707: () => { document.exitFullscreen(); },  
 777734: () => { if (document.fullscreenElement) return 1; },  
 777780: () => { return document.getElementById('canvas').width; },  
 777832: () => { return parseInt(document.getElementById('canvas').style.width); },  
 777900: () => { document.exitFullscreen(); },  
 777927: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 777985: () => { return screen.width; },  
 778010: () => { return screen.height; },  
 778036: () => { return window.screenX; },  
 778063: () => { return window.screenY; },  
 778090: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 778143: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 778214: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 778271: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 778527: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 778598: () => { if (document.fullscreenElement) return 1; },  
 778644: () => { return window.innerWidth; },  
 778670: () => { return window.innerHeight; },  
 778697: () => { if (document.pointerLockElement) return 1; }
};
