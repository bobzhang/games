...
var ASM_CONSTS = {
  260692: () => { if (document.fullscreenElement) return 1; },  
 260738: () => { return document.getElementById('canvas').width; },  
 260790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 260858: () => { document.exitFullscreen(); },  
 260885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 260958: () => { if (document.fullscreenElement) return 1; },  
 261004: () => { return document.getElementById('canvas').width; },  
 261056: () => { return screen.width; },  
 261081: () => { document.exitFullscreen(); },  
 261108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261241: () => { return window.innerWidth; },  
 261267: () => { return window.innerHeight; },  
 261294: () => { if (document.fullscreenElement) return 1; },  
 261340: () => { return document.getElementById('canvas').width; },  
 261392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261460: () => { if (document.fullscreenElement) return 1; },  
 261506: () => { return document.getElementById('canvas').width; },  
 261558: () => { return screen.width; },  
 261583: () => { return window.innerWidth; },  
 261609: () => { return window.innerHeight; },  
 ...
 261759: () => { document.exitFullscreen(); },  
 261786: () => { if (document.fullscreenElement) return 1; },  
 261832: () => { return document.getElementById('canvas').width; },  
 261884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261952: () => { document.exitFullscreen(); },  
 261979: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262037: () => { return screen.width; },  
 262062: () => { return screen.height; },  
 262088: () => { return window.screenX; },  
 262115: () => { return window.screenY; },  
 262142: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262195: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262266: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262579: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 262650: () => { if (document.fullscreenElement) return 1; },  
 262696: () => { return window.innerWidth; },  
 262722: () => { return window.innerHeight; },  
 262749: () => { if (document.pointerLockElement) return 1; }
};
