...
var ASM_CONSTS = {
  275044: () => { if (document.fullscreenElement) return 1; },  
 275090: () => { return document.getElementById('canvas').width; },  
 275142: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275210: () => { document.exitFullscreen(); },  
 275237: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 275310: () => { if (document.fullscreenElement) return 1; },  
 275356: () => { return document.getElementById('canvas').width; },  
 275408: () => { return screen.width; },  
 275433: () => { document.exitFullscreen(); },  
 275460: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 275593: () => { return window.innerWidth; },  
 275619: () => { return window.innerHeight; },  
 275646: () => { if (document.fullscreenElement) return 1; },  
 275692: () => { return document.getElementById('canvas').width; },  
 275744: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275812: () => { if (document.fullscreenElement) return 1; },  
 275858: () => { return document.getElementById('canvas').width; },  
 275910: () => { return screen.width; },  
 275935: () => { return window.innerWidth; },  
 275961: () => { return window.innerHeight; },  
 275988: () => { if (document.fullscreenElement) return 1; },  
 276034: () => { return document.getElementById('canvas').width; },  
 276086: () => { return screen.width; },  
 276111: () => { document.exitFullscreen(); },  
 276138: () => { if (document.fullscreenElement) return 1; },  
 276184: () => { return document.getElementById('canvas').width; },  
 276236: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276304: () => { document.exitFullscreen(); },  
 276331: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 276389: () => { return screen.width; },  
 276414: () => { return screen.height; },  
 276440: () => { return window.screenX; },  
 276467: () => { return window.screenY; },  
 276494: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 276547: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 276618: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 276675: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 276931: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 277002: () => { if (document.fullscreenElement) return 1; },  
 277048: () => { return window.innerWidth; },  
 277074: () => { return window.innerHeight; },  
 277101: () => { if (document.pointerLockElement) return 1; }
};
