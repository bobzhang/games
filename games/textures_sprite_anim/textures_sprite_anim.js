...
var ASM_CONSTS = {
  274820: () => { if (document.fullscreenElement) return 1; },  
 274866: () => { return document.getElementById('canvas').width; },  
 274918: () => { return parseInt(document.getElementById('canvas').style.width); },  
 274986: () => { document.exitFullscreen(); },  
 275013: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 275086: () => { if (document.fullscreenElement) return 1; },  
 275132: () => { return document.getElementById('canvas').width; },  
 275184: () => { return screen.width; },  
 275209: () => { document.exitFullscreen(); },  
 275236: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 275369: () => { return window.innerWidth; },  
 275395: () => { return window.innerHeight; },  
 275422: () => { if (document.fullscreenElement) return 1; },  
 275468: () => { return document.getElementById('canvas').width; },  
 275520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275588: () => { if (document.fullscreenElement) return 1; },  
 275634: () => { return document.getElementById('canvas').width; },  
 275686: () => { return screen.width; },  
 275711: () => { return window.innerWidth; },  
 275737: () => { return window.innerHeight; },  
 275764: () => { if (document.fullscreenElement) return 1; },  
 275810: () => { return document.getElementById('canvas').width; },  
 275862: () => { return screen.width; },  
 275887: () => { document.exitFullscreen(); },  
 275914: () => { if (document.fullscreenElement) return 1; },  
 275960: () => { return document.getElementById('canvas').width; },  
 276012: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276080: () => { document.exitFullscreen(); },  
 276107: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 276165: () => { return screen.width; },  
 276190: () => { return screen.height; },  
 276216: () => { return window.screenX; },  
 276243: () => { return window.screenY; },  
 276270: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 276323: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 276394: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 276451: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 276707: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 276778: () => { if (document.fullscreenElement) return 1; },  
 276824: () => { return window.innerWidth; },  
 276850: () => { return window.innerHeight; },  
 276877: () => { if (document.pointerLockElement) return 1; }
};
