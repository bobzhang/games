...
var ASM_CONSTS = {
  261876: () => { if (document.fullscreenElement) return 1; },  
 261922: () => { return document.getElementById('canvas').width; },  
 261974: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262042: () => { document.exitFullscreen(); },  
 262069: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262142: () => { if (document.fullscreenElement) return 1; },  
 262188: () => { return document.getElementById('canvas').width; },  
 262240: () => { return screen.width; },  
 262265: () => { document.exitFullscreen(); },  
 262292: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262425: () => { return window.innerWidth; },  
 262451: () => { return window.innerHeight; },  
 262478: () => { if (document.fullscreenElement) return 1; },  
 262524: () => { return document.getElementById('canvas').width; },  
 262576: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262644: () => { if (document.fullscreenElement) return 1; },  
 262690: () => { return document.getElementById('canvas').width; },  
 262742: () => { return screen.width; },  
 262767: () => { return window.innerWidth; },  
 262793: () => { return window.innerHeight; },  
 ...
 262943: () => { document.exitFullscreen(); },  
 262970: () => { if (document.fullscreenElement) return 1; },  
 263016: () => { return document.getElementById('canvas').width; },  
 263068: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263136: () => { document.exitFullscreen(); },  
 263163: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263221: () => { return screen.width; },  
 263246: () => { return screen.height; },  
 263272: () => { return window.screenX; },  
 263299: () => { return window.screenY; },  
 263326: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263379: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263450: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263507: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263763: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263834: () => { if (document.fullscreenElement) return 1; },  
 263880: () => { return window.innerWidth; },  
 263906: () => { return window.innerHeight; },  
 263933: () => { if (document.pointerLockElement) return 1; }
};
