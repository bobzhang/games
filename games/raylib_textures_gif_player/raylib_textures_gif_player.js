...
function findWasmBinary() {
  return locateFile('raylib_textures_gif_player.wasm');
}
...
var ASM_CONSTS = {
  122608: () => { if (document.fullscreenElement) return 1; },  
 122654: () => { return document.getElementById('canvas').width; },  
 122706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122774: () => { document.exitFullscreen(); },  
 122801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 122874: () => { if (document.fullscreenElement) return 1; },  
 122920: () => { return document.getElementById('canvas').width; },  
 122972: () => { return screen.width; },  
 122997: () => { document.exitFullscreen(); },  
 123024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 123157: () => { return window.innerWidth; },  
 123183: () => { return window.innerHeight; },  
 123210: () => { if (document.fullscreenElement) return 1; },  
 123256: () => { return document.getElementById('canvas').width; },  
 123308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123376: () => { if (document.fullscreenElement) return 1; },  
 123422: () => { return document.getElementById('canvas').width; },  
 123474: () => { return screen.width; },  
 123499: () => { return window.innerWidth; },  
 123525: () => { return window.innerHeight; },  
 123552: () => { if (document.fullscreenElement) return 1; },  
 123598: () => { return document.getElementById('canvas').width; },  
 123650: () => { return screen.width; },  
 123675: () => { document.exitFullscreen(); },  
 123702: () => { if (document.fullscreenElement) return 1; },  
 123748: () => { return document.getElementById('canvas').width; },  
 123800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123868: () => { document.exitFullscreen(); },  
 123895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 123953: () => { return screen.width; },  
 123978: () => { return screen.height; },  
 124004: () => { return window.screenX; },  
 124031: () => { return window.screenY; },  
 124058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 124111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 124182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 124239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 124495: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 124566: () => { if (document.fullscreenElement) return 1; },  
 124612: () => { return window.innerWidth; },  
 124638: () => { return window.innerHeight; },  
 124665: () => { if (document.pointerLockElement) return 1; }
};
