...
function findWasmBinary() {
  return locateFile('raylib_shaders_eratosthenes.wasm');
}
...
var ASM_CONSTS = {
 ...
 100066: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100134: () => { document.exitFullscreen(); },  
 100161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 100234: () => { if (document.fullscreenElement) return 1; },  
 100280: () => { return document.getElementById('canvas').width; },  
 100332: () => { return screen.width; },  
 100357: () => { document.exitFullscreen(); },  
 100384: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100517: () => { return window.innerWidth; },  
 100543: () => { return window.innerHeight; },  
 100570: () => { if (document.fullscreenElement) return 1; },  
 100616: () => { return document.getElementById('canvas').width; },  
 100668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 100859: () => { return window.innerWidth; },  
 100885: () => { return window.innerHeight; },  
 100912: () => { if (document.fullscreenElement) return 1; },  
 100958: () => { return document.getElementById('canvas').width; },  
 101010: () => { return screen.width; },  
 101035: () => { document.exitFullscreen(); },  
 101062: () => { if (document.fullscreenElement) return 1; },  
 101108: () => { return document.getElementById('canvas').width; },  
 101160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101228: () => { document.exitFullscreen(); },  
 101255: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 101313: () => { return screen.width; },  
 101338: () => { return screen.height; },  
 101364: () => { return window.screenX; },  
 101391: () => { return window.screenY; },  
 101418: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101471: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101542: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101599: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101855: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101926: () => { if (document.fullscreenElement) return 1; },  
 101972: () => { return window.innerWidth; },  
 101998: () => { return window.innerHeight; },  
 102025: () => { if (document.pointerLockElement) return 1; }
};
