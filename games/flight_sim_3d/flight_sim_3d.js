...
var ASM_CONSTS = {
  276772: () => { if (document.fullscreenElement) return 1; },  
 276818: () => { return document.getElementById('canvas').width; },  
 276870: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276938: () => { document.exitFullscreen(); },  
 276965: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 277038: () => { if (document.fullscreenElement) return 1; },  
 277084: () => { return document.getElementById('canvas').width; },  
 277136: () => { return screen.width; },  
 277161: () => { document.exitFullscreen(); },  
 277188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 277321: () => { return window.innerWidth; },  
 277347: () => { return window.innerHeight; },  
 277374: () => { if (document.fullscreenElement) return 1; },  
 277420: () => { return document.getElementById('canvas').width; },  
 277472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 277540: () => { if (document.fullscreenElement) return 1; },  
 277586: () => { return document.getElementById('canvas').width; },  
 277638: () => { return screen.width; },  
 277663: () => { return window.innerWidth; },  
 277689: () => { return window.innerHeight; },  
 277716: () => { if (document.fullscreenElement) return 1; },  
 277762: () => { return document.getElementById('canvas').width; },  
 277814: () => { return screen.width; },  
 277839: () => { document.exitFullscreen(); },  
 277866: () => { if (document.fullscreenElement) return 1; },  
 277912: () => { return document.getElementById('canvas').width; },  
 277964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 278032: () => { document.exitFullscreen(); },  
 278059: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 278117: () => { return screen.width; },  
 278142: () => { return screen.height; },  
 278168: () => { return window.screenX; },  
 278195: () => { return window.screenY; },  
 278222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 278275: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 278346: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 278403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 278659: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 278730: () => { if (document.fullscreenElement) return 1; },  
 278776: () => { return window.innerWidth; },  
 278802: () => { return window.innerHeight; },  
 278829: () => { if (document.pointerLockElement) return 1; }
};
