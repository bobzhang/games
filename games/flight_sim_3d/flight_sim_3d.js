...
var ASM_CONSTS = {
  276180: () => { if (document.fullscreenElement) return 1; },  
 276226: () => { return document.getElementById('canvas').width; },  
 276278: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276346: () => { document.exitFullscreen(); },  
 276373: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 276446: () => { if (document.fullscreenElement) return 1; },  
 276492: () => { return document.getElementById('canvas').width; },  
 276544: () => { return screen.width; },  
 276569: () => { document.exitFullscreen(); },  
 276596: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 276729: () => { return window.innerWidth; },  
 276755: () => { return window.innerHeight; },  
 276782: () => { if (document.fullscreenElement) return 1; },  
 276828: () => { return document.getElementById('canvas').width; },  
 276880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276948: () => { if (document.fullscreenElement) return 1; },  
 276994: () => { return document.getElementById('canvas').width; },  
 277046: () => { return screen.width; },  
 277071: () => { return window.innerWidth; },  
 277097: () => { return window.innerHeight; },  
 277124: () => { if (document.fullscreenElement) return 1; },  
 277170: () => { return document.getElementById('canvas').width; },  
 277222: () => { return screen.width; },  
 277247: () => { document.exitFullscreen(); },  
 277274: () => { if (document.fullscreenElement) return 1; },  
 277320: () => { return document.getElementById('canvas').width; },  
 277372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 277440: () => { document.exitFullscreen(); },  
 277467: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 277525: () => { return screen.width; },  
 277550: () => { return screen.height; },  
 277576: () => { return window.screenX; },  
 277603: () => { return window.screenY; },  
 277630: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 277683: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 277754: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 277811: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 278067: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 278138: () => { if (document.fullscreenElement) return 1; },  
 278184: () => { return window.innerWidth; },  
 278210: () => { return window.innerHeight; },  
 278237: () => { if (document.pointerLockElement) return 1; }
};
