...
var ASM_CONSTS = {
  275972: () => { if (document.fullscreenElement) return 1; },  
 276018: () => { return document.getElementById('canvas').width; },  
 276070: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276138: () => { document.exitFullscreen(); },  
 276165: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 276238: () => { if (document.fullscreenElement) return 1; },  
 276284: () => { return document.getElementById('canvas').width; },  
 276336: () => { return screen.width; },  
 276361: () => { document.exitFullscreen(); },  
 276388: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 276521: () => { return window.innerWidth; },  
 276547: () => { return window.innerHeight; },  
 276574: () => { if (document.fullscreenElement) return 1; },  
 276620: () => { return document.getElementById('canvas').width; },  
 276672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276740: () => { if (document.fullscreenElement) return 1; },  
 276786: () => { return document.getElementById('canvas').width; },  
 276838: () => { return screen.width; },  
 276863: () => { return window.innerWidth; },  
 276889: () => { return window.innerHeight; },  
 276916: () => { if (document.fullscreenElement) return 1; },  
 276962: () => { return document.getElementById('canvas').width; },  
 277014: () => { return screen.width; },  
 277039: () => { document.exitFullscreen(); },  
 277066: () => { if (document.fullscreenElement) return 1; },  
 277112: () => { return document.getElementById('canvas').width; },  
 277164: () => { return parseInt(document.getElementById('canvas').style.width); },  
 277232: () => { document.exitFullscreen(); },  
 277259: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 277317: () => { return screen.width; },  
 277342: () => { return screen.height; },  
 277368: () => { return window.screenX; },  
 277395: () => { return window.screenY; },  
 277422: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 277475: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 277546: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 277603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 277859: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 277930: () => { if (document.fullscreenElement) return 1; },  
 277976: () => { return window.innerWidth; },  
 278002: () => { return window.innerHeight; },  
 278029: () => { if (document.pointerLockElement) return 1; }
};
