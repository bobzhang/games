...
function findWasmBinary() {
  return locateFile('raylib_models_gpu_skinning.wasm');
}
...
var ASM_CONSTS = {
  275168: () => { if (document.fullscreenElement) return 1; },  
 275214: () => { return document.getElementById('canvas').width; },  
 275266: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275334: () => { document.exitFullscreen(); },  
 275361: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 275434: () => { if (document.fullscreenElement) return 1; },  
 275480: () => { return document.getElementById('canvas').width; },  
 275532: () => { return screen.width; },  
 275557: () => { document.exitFullscreen(); },  
 275584: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 275717: () => { return window.innerWidth; },  
 275743: () => { return window.innerHeight; },  
 275770: () => { if (document.fullscreenElement) return 1; },  
 275816: () => { return document.getElementById('canvas').width; },  
 275868: () => { return parseInt(document.getElementById('canvas').style.width); },  
 275936: () => { if (document.fullscreenElement) return 1; },  
 275982: () => { return document.getElementById('canvas').width; },  
 276034: () => { return screen.width; },  
 276059: () => { return window.innerWidth; },  
 276085: () => { return window.innerHeight; },  
 276112: () => { if (document.fullscreenElement) return 1; },  
 276158: () => { return document.getElementById('canvas').width; },  
 276210: () => { return screen.width; },  
 276235: () => { document.exitFullscreen(); },  
 276262: () => { if (document.fullscreenElement) return 1; },  
 276308: () => { return document.getElementById('canvas').width; },  
 276360: () => { return parseInt(document.getElementById('canvas').style.width); },  
 276428: () => { document.exitFullscreen(); },  
 276455: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 276513: () => { return screen.width; },  
 276538: () => { return screen.height; },  
 276564: () => { return window.screenX; },  
 276591: () => { return window.screenY; },  
 276618: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 276671: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 276742: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 276799: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 277055: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 277126: () => { if (document.fullscreenElement) return 1; },  
 277172: () => { return window.innerWidth; },  
 277198: () => { return window.innerHeight; },  
 277225: () => { if (document.pointerLockElement) return 1; }
};
