...
function findWasmBinary() {
  return locateFile('raylib_dungeon_crawler_3d.wasm');
}
...
var ASM_CONSTS = {
  102944: () => { if (document.fullscreenElement) return 1; },  
 102990: () => { return document.getElementById('canvas').width; },  
 103042: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103110: () => { document.exitFullscreen(); },  
 103137: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103210: () => { if (document.fullscreenElement) return 1; },  
 103256: () => { return document.getElementById('canvas').width; },  
 103308: () => { return screen.width; },  
 103333: () => { document.exitFullscreen(); },  
 103360: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103493: () => { return window.innerWidth; },  
 103519: () => { return window.innerHeight; },  
 103546: () => { if (document.fullscreenElement) return 1; },  
 103592: () => { return document.getElementById('canvas').width; },  
 103644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103712: () => { if (document.fullscreenElement) return 1; },  
 103758: () => { return document.getElementById('canvas').width; },  
 103810: () => { return screen.width; },  
 103835: () => { return window.innerWidth; },  
 103861: () => { return window.innerHeight; },  
 103888: () => { if (document.fullscreenElement) return 1; },  
 103934: () => { return document.getElementById('canvas').width; },  
 103986: () => { return screen.width; },  
 104011: () => { document.exitFullscreen(); },  
 104038: () => { if (document.fullscreenElement) return 1; },  
 104084: () => { return document.getElementById('canvas').width; },  
 104136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104204: () => { document.exitFullscreen(); },  
 104231: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104289: () => { return screen.width; },  
 104314: () => { return screen.height; },  
 104340: () => { return window.screenX; },  
 104367: () => { return window.screenY; },  
 104394: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104447: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104518: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 104575: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104831: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104902: () => { if (document.fullscreenElement) return 1; },  
 104948: () => { return window.innerWidth; },  
 104974: () => { return window.innerHeight; },  
 105001: () => { if (document.pointerLockElement) return 1; }
};
