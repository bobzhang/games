...
function findWasmBinary() {
  return locateFile('raylib_text_font_sdf.wasm');
}
...
var ASM_CONSTS = {
 ...
 262002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262070: () => { document.exitFullscreen(); },  
 262097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262170: () => { if (document.fullscreenElement) return 1; },  
 262216: () => { return document.getElementById('canvas').width; },  
 262268: () => { return screen.width; },  
 262293: () => { document.exitFullscreen(); },  
 262320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262453: () => { return window.innerWidth; },  
 262479: () => { return window.innerHeight; },  
 ...
 262795: () => { return window.innerWidth; },  
 262821: () => { return window.innerHeight; },  
 ...
 262971: () => { document.exitFullscreen(); },  
 262998: () => { if (document.fullscreenElement) return 1; },  
 263044: () => { return document.getElementById('canvas').width; },  
 263096: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263164: () => { document.exitFullscreen(); },  
 263191: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263249: () => { return screen.width; },  
 263274: () => { return screen.height; },  
 263300: () => { return window.screenX; },  
 263327: () => { return window.screenY; },  
 263354: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263407: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263478: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263535: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263791: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263862: () => { if (document.fullscreenElement) return 1; },  
 263908: () => { return window.innerWidth; },  
 263934: () => { return window.innerHeight; },  
 263961: () => { if (document.pointerLockElement) return 1; }
};
