...
var ASM_CONSTS = {
  261492: () => { if (document.fullscreenElement) return 1; },  
 261538: () => { return document.getElementById('canvas').width; },  
 261590: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261658: () => { document.exitFullscreen(); },  
 261685: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261758: () => { if (document.fullscreenElement) return 1; },  
 261804: () => { return document.getElementById('canvas').width; },  
 261856: () => { return screen.width; },  
 261881: () => { document.exitFullscreen(); },  
 261908: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262041: () => { return window.innerWidth; },  
 262067: () => { return window.innerHeight; },  
 262094: () => { if (document.fullscreenElement) return 1; },  
 262140: () => { return document.getElementById('canvas').width; },  
 262192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262383: () => { return window.innerWidth; },  
 262409: () => { return window.innerHeight; },  
 262436: () => { if (document.fullscreenElement) return 1; },  
 262482: () => { return document.getElementById('canvas').width; },  
 262534: () => { return screen.width; },  
 262559: () => { document.exitFullscreen(); },  
 ...
 262752: () => { document.exitFullscreen(); },  
 262779: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262837: () => { return screen.width; },  
 262862: () => { return screen.height; },  
 262888: () => { return window.screenX; },  
 262915: () => { return window.screenY; },  
 262942: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262995: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263066: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263123: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263379: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263450: () => { if (document.fullscreenElement) return 1; },  
 263496: () => { return window.innerWidth; },  
 263522: () => { return window.innerHeight; },  
 263549: () => { if (document.pointerLockElement) return 1; }
};
