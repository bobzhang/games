...
var ASM_CONSTS = {
  261684: () => { if (document.fullscreenElement) return 1; },  
 261730: () => { return document.getElementById('canvas').width; },  
 261782: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261850: () => { document.exitFullscreen(); },  
 261877: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261950: () => { if (document.fullscreenElement) return 1; },  
 261996: () => { return document.getElementById('canvas').width; },  
 262048: () => { return screen.width; },  
 262073: () => { document.exitFullscreen(); },  
 262100: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262233: () => { return window.innerWidth; },  
 262259: () => { return window.innerHeight; },  
 262286: () => { if (document.fullscreenElement) return 1; },  
 262332: () => { return document.getElementById('canvas').width; },  
 262384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262575: () => { return window.innerWidth; },  
 262601: () => { return window.innerHeight; },  
 262628: () => { if (document.fullscreenElement) return 1; },  
 262674: () => { return document.getElementById('canvas').width; },  
 262726: () => { return screen.width; },  
 262751: () => { document.exitFullscreen(); },  
 262778: () => { if (document.fullscreenElement) return 1; },  
 262824: () => { return document.getElementById('canvas').width; },  
 262876: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262944: () => { document.exitFullscreen(); },  
 262971: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263029: () => { return screen.width; },  
 263054: () => { return screen.height; },  
 263080: () => { return window.screenX; },  
 263107: () => { return window.screenY; },  
 263134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263187: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263258: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263315: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263571: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263642: () => { if (document.fullscreenElement) return 1; },  
 263688: () => { return window.innerWidth; },  
 263714: () => { return window.innerHeight; },  
 263741: () => { if (document.pointerLockElement) return 1; }
};
