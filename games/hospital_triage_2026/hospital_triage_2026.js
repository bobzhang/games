...
var ASM_CONSTS = {
  261668: () => { if (document.fullscreenElement) return 1; },  
 261714: () => { return document.getElementById('canvas').width; },  
 261766: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261834: () => { document.exitFullscreen(); },  
 261861: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261934: () => { if (document.fullscreenElement) return 1; },  
 261980: () => { return document.getElementById('canvas').width; },  
 262032: () => { return screen.width; },  
 262057: () => { document.exitFullscreen(); },  
 262084: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262217: () => { return window.innerWidth; },  
 262243: () => { return window.innerHeight; },  
 262270: () => { if (document.fullscreenElement) return 1; },  
 262316: () => { return document.getElementById('canvas').width; },  
 262368: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262559: () => { return window.innerWidth; },  
 262585: () => { return window.innerHeight; },  
 ...
 262735: () => { document.exitFullscreen(); },  
 262762: () => { if (document.fullscreenElement) return 1; },  
 262808: () => { return document.getElementById('canvas').width; },  
 262860: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262928: () => { document.exitFullscreen(); },  
 262955: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263013: () => { return screen.width; },  
 263038: () => { return screen.height; },  
 263064: () => { return window.screenX; },  
 263091: () => { return window.screenY; },  
 263118: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263171: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263242: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263299: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263555: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263626: () => { if (document.fullscreenElement) return 1; },  
 263672: () => { return window.innerWidth; },  
 263698: () => { return window.innerHeight; },  
 263725: () => { if (document.pointerLockElement) return 1; }
};
