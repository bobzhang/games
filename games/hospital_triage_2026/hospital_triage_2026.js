...
var ASM_CONSTS = {
 ...
 261990: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262058: () => { document.exitFullscreen(); },  
 262085: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262158: () => { if (document.fullscreenElement) return 1; },  
 262204: () => { return document.getElementById('canvas').width; },  
 262256: () => { return screen.width; },  
 262281: () => { document.exitFullscreen(); },  
 262308: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262441: () => { return window.innerWidth; },  
 262467: () => { return window.innerHeight; },  
 262494: () => { if (document.fullscreenElement) return 1; },  
 262540: () => { return document.getElementById('canvas').width; },  
 262592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262783: () => { return window.innerWidth; },  
 262809: () => { return window.innerHeight; },  
 ...
 262959: () => { document.exitFullscreen(); },  
 262986: () => { if (document.fullscreenElement) return 1; },  
 263032: () => { return document.getElementById('canvas').width; },  
 263084: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263152: () => { document.exitFullscreen(); },  
 263179: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263237: () => { return screen.width; },  
 263262: () => { return screen.height; },  
 263288: () => { return window.screenX; },  
 263315: () => { return window.screenY; },  
 263342: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263395: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263466: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263523: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263779: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263850: () => { if (document.fullscreenElement) return 1; },  
 263896: () => { return window.innerWidth; },  
 263922: () => { return window.innerHeight; },  
 263949: () => { if (document.pointerLockElement) return 1; }
};
