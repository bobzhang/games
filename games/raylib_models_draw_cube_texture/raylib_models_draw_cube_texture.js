...
function findWasmBinary() {
  return locateFile('raylib_models_draw_cube_texture.wasm');
}
...
var ASM_CONSTS = {
 ...
 100918: () => { document.exitFullscreen(); },  
 100945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101018: () => { if (document.fullscreenElement) return 1; },  
 101064: () => { return document.getElementById('canvas').width; },  
 101116: () => { return screen.width; },  
 101141: () => { document.exitFullscreen(); },  
 101168: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 101301: () => { return window.innerWidth; },  
 101327: () => { return window.innerHeight; },  
 101354: () => { if (document.fullscreenElement) return 1; },  
 101400: () => { return document.getElementById('canvas').width; },  
 101452: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101520: () => { if (document.fullscreenElement) return 1; },  
 101566: () => { return document.getElementById('canvas').width; },  
 101618: () => { return screen.width; },  
 101643: () => { return window.innerWidth; },  
 101669: () => { return window.innerHeight; },  
 101696: () => { if (document.fullscreenElement) return 1; },  
 101742: () => { return document.getElementById('canvas').width; },  
 101794: () => { return screen.width; },  
 101819: () => { document.exitFullscreen(); },  
 101846: () => { if (document.fullscreenElement) return 1; },  
 101892: () => { return document.getElementById('canvas').width; },  
 101944: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102012: () => { document.exitFullscreen(); },  
 102039: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102097: () => { return screen.width; },  
 102122: () => { return screen.height; },  
 102148: () => { return window.screenX; },  
 102175: () => { return window.screenY; },  
 102202: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102255: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102326: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102383: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102639: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 102710: () => { if (document.fullscreenElement) return 1; },  
 102756: () => { return window.innerWidth; },  
 102782: () => { return window.innerHeight; },  
 102809: () => { if (document.pointerLockElement) return 1; }
};
