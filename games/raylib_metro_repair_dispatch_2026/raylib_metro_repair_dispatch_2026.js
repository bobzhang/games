...
var ASM_CONSTS = {
 ...
 99618: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99686: () => { document.exitFullscreen(); },  
 99713: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99786: () => { if (document.fullscreenElement) return 1; },  
 99832: () => { return document.getElementById('canvas').width; },  
 99884: () => { return screen.width; },  
 99909: () => { document.exitFullscreen(); },  
 99936: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 100069: () => { return window.innerWidth; },  
 100095: () => { return window.innerHeight; },  
 100122: () => { if (document.fullscreenElement) return 1; },  
 100168: () => { return document.getElementById('canvas').width; },  
 100220: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100288: () => { if (document.fullscreenElement) return 1; },  
 100334: () => { return document.getElementById('canvas').width; },  
 100386: () => { return screen.width; },  
 100411: () => { return window.innerWidth; },  
 100437: () => { return window.innerHeight; },  
 100464: () => { if (document.fullscreenElement) return 1; },  
 100510: () => { return document.getElementById('canvas').width; },  
 100562: () => { return screen.width; },  
 100587: () => { document.exitFullscreen(); },  
 100614: () => { if (document.fullscreenElement) return 1; },  
 100660: () => { return document.getElementById('canvas').width; },  
 100712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100780: () => { document.exitFullscreen(); },  
 100807: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100865: () => { return screen.width; },  
 100890: () => { return screen.height; },  
 100916: () => { return window.screenX; },  
 100943: () => { return window.screenY; },  
 100970: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 101023: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 101094: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 101151: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 101407: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 101478: () => { if (document.fullscreenElement) return 1; },  
 101524: () => { return window.innerWidth; },  
 101550: () => { return window.innerHeight; },  
 101577: () => { if (document.pointerLockElement) return 1; }
};
