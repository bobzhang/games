...
function findWasmBinary() {
  return locateFile('raylib_text_codepoints_loading.wasm');
}
...
var ASM_CONSTS = {
  2137216: () => { if (document.fullscreenElement) return 1; },  
 2137262: () => { return document.getElementById('canvas').width; },  
 2137314: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2137382: () => { document.exitFullscreen(); },  
 2137409: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 2137482: () => { if (document.fullscreenElement) return 1; },  
 2137528: () => { return document.getElementById('canvas').width; },  
 2137580: () => { return screen.width; },  
 2137605: () => { document.exitFullscreen(); },  
 2137632: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 2137765: () => { return window.innerWidth; },  
 2137791: () => { return window.innerHeight; },  
 2137818: () => { if (document.fullscreenElement) return 1; },  
 2137864: () => { return document.getElementById('canvas').width; },  
 2137916: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2137984: () => { if (document.fullscreenElement) return 1; },  
 2138030: () => { return document.getElementById('canvas').width; },  
 2138082: () => { return screen.width; },  
 2138107: () => { return window.innerWidth; },  
 2138133: () => { return window.innerHeight; },  
 2138160: () => { if (document.fullscreenElement) return 1; },  
 2138206: () => { return document.getElementById('canvas').width; },  
 2138258: () => { return screen.width; },  
 2138283: () => { document.exitFullscreen(); },  
 2138310: () => { if (document.fullscreenElement) return 1; },  
 2138356: () => { return document.getElementById('canvas').width; },  
 2138408: () => { return parseInt(document.getElementById('canvas').style.width); },  
 2138476: () => { document.exitFullscreen(); },  
 2138503: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 2138561: () => { return screen.width; },  
 2138586: () => { return screen.height; },  
 2138612: () => { return window.screenX; },  
 2138639: () => { return window.screenY; },  
 2138666: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2138719: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 2138790: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 2138847: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2139103: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 2139174: () => { if (document.fullscreenElement) return 1; },  
 2139220: () => { return window.innerWidth; },  
 2139246: () => { return window.innerHeight; },  
 2139273: () => { if (document.pointerLockElement) return 1; }
};
