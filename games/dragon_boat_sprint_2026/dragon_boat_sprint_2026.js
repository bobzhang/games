...
var ASM_CONSTS = {
 ...
 263606: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263674: () => { document.exitFullscreen(); },  
 263701: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263774: () => { if (document.fullscreenElement) return 1; },  
 263820: () => { return document.getElementById('canvas').width; },  
 263872: () => { return screen.width; },  
 263897: () => { document.exitFullscreen(); },  
 263924: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264057: () => { return window.innerWidth; },  
 264083: () => { return window.innerHeight; },  
 264110: () => { if (document.fullscreenElement) return 1; },  
 264156: () => { return document.getElementById('canvas').width; },  
 264208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264399: () => { return window.innerWidth; },  
 264425: () => { return window.innerHeight; },  
 ...
 264575: () => { document.exitFullscreen(); },  
 264602: () => { if (document.fullscreenElement) return 1; },  
 264648: () => { return document.getElementById('canvas').width; },  
 264700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264768: () => { document.exitFullscreen(); },  
 264795: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264853: () => { return screen.width; },  
 264878: () => { return screen.height; },  
 264904: () => { return window.screenX; },  
 264931: () => { return window.screenY; },  
 264958: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265011: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265082: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265139: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265395: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265466: () => { if (document.fullscreenElement) return 1; },  
 265512: () => { return window.innerWidth; },  
 265538: () => { return window.innerHeight; },  
 265565: () => { if (document.pointerLockElement) return 1; }
};
