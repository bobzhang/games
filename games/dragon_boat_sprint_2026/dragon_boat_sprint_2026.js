...
var ASM_CONSTS = {
 ...
 263814: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263882: () => { document.exitFullscreen(); },  
 263909: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 263982: () => { if (document.fullscreenElement) return 1; },  
 264028: () => { return document.getElementById('canvas').width; },  
 264080: () => { return screen.width; },  
 264105: () => { document.exitFullscreen(); },  
 264132: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264265: () => { return window.innerWidth; },  
 264291: () => { return window.innerHeight; },  
 264318: () => { if (document.fullscreenElement) return 1; },  
 264364: () => { return document.getElementById('canvas').width; },  
 264416: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 264607: () => { return window.innerWidth; },  
 264633: () => { return window.innerHeight; },  
 ...
 264783: () => { document.exitFullscreen(); },  
 264810: () => { if (document.fullscreenElement) return 1; },  
 264856: () => { return document.getElementById('canvas').width; },  
 264908: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264976: () => { document.exitFullscreen(); },  
 265003: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265061: () => { return screen.width; },  
 265086: () => { return screen.height; },  
 265112: () => { return window.screenX; },  
 265139: () => { return window.screenY; },  
 265166: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265219: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265290: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265347: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265603: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265674: () => { if (document.fullscreenElement) return 1; },  
 265720: () => { return window.innerWidth; },  
 265746: () => { return window.innerHeight; },  
 265773: () => { if (document.pointerLockElement) return 1; }
};
