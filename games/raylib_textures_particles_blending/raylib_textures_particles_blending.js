...
function findWasmBinary() {
  return locateFile('raylib_textures_particles_blending.wasm');
}
...
var ASM_CONSTS = {
  108624: () => { if (document.fullscreenElement) return 1; },  
 108670: () => { return document.getElementById('canvas').width; },  
 108722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108790: () => { document.exitFullscreen(); },  
 108817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108890: () => { if (document.fullscreenElement) return 1; },  
 108936: () => { return document.getElementById('canvas').width; },  
 108988: () => { return screen.width; },  
 109013: () => { document.exitFullscreen(); },  
 109040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 109173: () => { return window.innerWidth; },  
 109199: () => { return window.innerHeight; },  
 109226: () => { if (document.fullscreenElement) return 1; },  
 109272: () => { return document.getElementById('canvas').width; },  
 109324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109392: () => { if (document.fullscreenElement) return 1; },  
 109438: () => { return document.getElementById('canvas').width; },  
 109490: () => { return screen.width; },  
 109515: () => { return window.innerWidth; },  
 109541: () => { return window.innerHeight; },  
 109568: () => { if (document.fullscreenElement) return 1; },  
 109614: () => { return document.getElementById('canvas').width; },  
 109666: () => { return screen.width; },  
 109691: () => { document.exitFullscreen(); },  
 109718: () => { if (document.fullscreenElement) return 1; },  
 109764: () => { return document.getElementById('canvas').width; },  
 109816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109884: () => { document.exitFullscreen(); },  
 109911: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 109969: () => { return screen.width; },  
 109994: () => { return screen.height; },  
 110020: () => { return window.screenX; },  
 110047: () => { return window.screenY; },  
 110074: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110127: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 110198: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 110255: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110511: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 110582: () => { if (document.fullscreenElement) return 1; },  
 110628: () => { return window.innerWidth; },  
 110654: () => { return window.innerHeight; },  
 110681: () => { if (document.pointerLockElement) return 1; }
};
