...
var ASM_CONSTS = {
 ...
 262518: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262586: () => { document.exitFullscreen(); },  
 262613: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262686: () => { if (document.fullscreenElement) return 1; },  
 262732: () => { return document.getElementById('canvas').width; },  
 262784: () => { return screen.width; },  
 262809: () => { document.exitFullscreen(); },  
 262836: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262969: () => { return window.innerWidth; },  
 262995: () => { return window.innerHeight; },  
 263022: () => { if (document.fullscreenElement) return 1; },  
 263068: () => { return document.getElementById('canvas').width; },  
 263120: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 263311: () => { return window.innerWidth; },  
 263337: () => { return window.innerHeight; },  
 263364: () => { if (document.fullscreenElement) return 1; },  
 263410: () => { return document.getElementById('canvas').width; },  
 263462: () => { return screen.width; },  
 263487: () => { document.exitFullscreen(); },  
 263514: () => { if (document.fullscreenElement) return 1; },  
 263560: () => { return document.getElementById('canvas').width; },  
 263612: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263680: () => { document.exitFullscreen(); },  
 263707: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263765: () => { return screen.width; },  
 263790: () => { return screen.height; },  
 263816: () => { return window.screenX; },  
 263843: () => { return window.screenY; },  
 263870: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263923: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263994: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264051: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264307: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264378: () => { if (document.fullscreenElement) return 1; },  
 264424: () => { return window.innerWidth; },  
 264450: () => { return window.innerHeight; },  
 264477: () => { if (document.pointerLockElement) return 1; }
};
