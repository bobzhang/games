...
function findWasmBinary() {
  return locateFile('raylib_shapes_draw_rectangle_rounded.wasm');
}
...
var ASM_CONSTS = {
 ...
 98866: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98934: () => { document.exitFullscreen(); },  
 98961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 99034: () => { if (document.fullscreenElement) return 1; },  
 99080: () => { return document.getElementById('canvas').width; },  
 99132: () => { return screen.width; },  
 99157: () => { document.exitFullscreen(); },  
 99184: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99317: () => { return window.innerWidth; },  
 99343: () => { return window.innerHeight; },  
 99370: () => { if (document.fullscreenElement) return 1; },  
 99416: () => { return document.getElementById('canvas').width; },  
 99468: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99536: () => { if (document.fullscreenElement) return 1; },  
 99582: () => { return document.getElementById('canvas').width; },  
 99634: () => { return screen.width; },  
 99659: () => { return window.innerWidth; },  
 99685: () => { return window.innerHeight; },  
 99712: () => { if (document.fullscreenElement) return 1; },  
 99758: () => { return document.getElementById('canvas').width; },  
 99810: () => { return screen.width; },  
 99835: () => { document.exitFullscreen(); },  
 99862: () => { if (document.fullscreenElement) return 1; },  
 99908: () => { return document.getElementById('canvas').width; },  
 99960: () => { return parseInt(document.getElementById('canvas').style.width); },  
 100028: () => { document.exitFullscreen(); },  
 100055: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 100113: () => { return screen.width; },  
 100138: () => { return screen.height; },  
 100164: () => { return window.screenX; },  
 100191: () => { return window.screenY; },  
 100218: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100271: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100342: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100399: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100655: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100726: () => { if (document.fullscreenElement) return 1; },  
 100772: () => { return window.innerWidth; },  
 100798: () => { return window.innerHeight; },  
 100825: () => { if (document.pointerLockElement) return 1; }
};
