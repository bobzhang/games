...
var ASM_CONSTS = {
 ...
 261138: () => { return document.getElementById('canvas').width; },  
 261190: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261258: () => { document.exitFullscreen(); },  
 261285: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261358: () => { if (document.fullscreenElement) return 1; },  
 261404: () => { return document.getElementById('canvas').width; },  
 261456: () => { return screen.width; },  
 261481: () => { document.exitFullscreen(); },  
 261508: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261641: () => { return window.innerWidth; },  
 261667: () => { return window.innerHeight; },  
 261694: () => { if (document.fullscreenElement) return 1; },  
 261740: () => { return document.getElementById('canvas').width; },  
 261792: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 261983: () => { return window.innerWidth; },  
 262009: () => { return window.innerHeight; },  
 ...
 262159: () => { document.exitFullscreen(); },  
 ...
 262352: () => { document.exitFullscreen(); },  
 262379: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262437: () => { return screen.width; },  
 262462: () => { return screen.height; },  
 262488: () => { return window.screenX; },  
 262515: () => { return window.screenY; },  
 262542: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262595: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262666: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262723: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262979: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263050: () => { if (document.fullscreenElement) return 1; },  
 263096: () => { return window.innerWidth; },  
 263122: () => { return window.innerHeight; },  
 263149: () => { if (document.pointerLockElement) return 1; }
};
