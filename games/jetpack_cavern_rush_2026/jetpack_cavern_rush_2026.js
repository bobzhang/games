...
var ASM_CONSTS = {
 ...
 261830: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261898: () => { document.exitFullscreen(); },  
 261925: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261998: () => { if (document.fullscreenElement) return 1; },  
 262044: () => { return document.getElementById('canvas').width; },  
 262096: () => { return screen.width; },  
 262121: () => { document.exitFullscreen(); },  
 262148: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 262281: () => { return window.innerWidth; },  
 262307: () => { return window.innerHeight; },  
 262334: () => { if (document.fullscreenElement) return 1; },  
 262380: () => { return document.getElementById('canvas').width; },  
 262432: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 262623: () => { return window.innerWidth; },  
 262649: () => { return window.innerHeight; },  
 262676: () => { if (document.fullscreenElement) return 1; },  
 262722: () => { return document.getElementById('canvas').width; },  
 262774: () => { return screen.width; },  
 262799: () => { document.exitFullscreen(); },  
 ...
 262992: () => { document.exitFullscreen(); },  
 263019: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 263077: () => { return screen.width; },  
 263102: () => { return screen.height; },  
 263128: () => { return window.screenX; },  
 263155: () => { return window.screenY; },  
 263182: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 263235: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 263306: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 263363: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 263619: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263690: () => { if (document.fullscreenElement) return 1; },  
 263736: () => { return window.innerWidth; },  
 263762: () => { return window.innerHeight; },  
 263789: () => { if (document.pointerLockElement) return 1; }
};
