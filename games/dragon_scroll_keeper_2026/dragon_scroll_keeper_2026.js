...
var ASM_CONSTS = {
  263908: () => { if (document.fullscreenElement) return 1; },  
 263954: () => { return document.getElementById('canvas').width; },  
 264006: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264074: () => { document.exitFullscreen(); },  
 264101: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264174: () => { if (document.fullscreenElement) return 1; },  
 264220: () => { return document.getElementById('canvas').width; },  
 264272: () => { return screen.width; },  
 264297: () => { document.exitFullscreen(); },  
 264324: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264457: () => { return window.innerWidth; },  
 264483: () => { return window.innerHeight; },  
 264510: () => { if (document.fullscreenElement) return 1; },  
 264556: () => { return document.getElementById('canvas').width; },  
 264608: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264676: () => { if (document.fullscreenElement) return 1; },  
 264722: () => { return document.getElementById('canvas').width; },  
 264774: () => { return screen.width; },  
 264799: () => { return window.innerWidth; },  
 264825: () => { return window.innerHeight; },  
 ...
 264975: () => { document.exitFullscreen(); },  
 265002: () => { if (document.fullscreenElement) return 1; },  
 265048: () => { return document.getElementById('canvas').width; },  
 265100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265168: () => { document.exitFullscreen(); },  
 265195: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265253: () => { return screen.width; },  
 265278: () => { return screen.height; },  
 265304: () => { return window.screenX; },  
 265331: () => { return window.screenY; },  
 265358: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265411: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265482: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265539: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265795: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 265866: () => { if (document.fullscreenElement) return 1; },  
 265912: () => { return window.innerWidth; },  
 265938: () => { return window.innerHeight; },  
 265965: () => { if (document.pointerLockElement) return 1; }
};
