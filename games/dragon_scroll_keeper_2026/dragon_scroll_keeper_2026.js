...
var ASM_CONSTS = {
  264116: () => { if (document.fullscreenElement) return 1; },  
 264162: () => { return document.getElementById('canvas').width; },  
 264214: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264282: () => { document.exitFullscreen(); },  
 264309: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264382: () => { if (document.fullscreenElement) return 1; },  
 264428: () => { return document.getElementById('canvas').width; },  
 264480: () => { return screen.width; },  
 264505: () => { document.exitFullscreen(); },  
 264532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264665: () => { return window.innerWidth; },  
 264691: () => { return window.innerHeight; },  
 264718: () => { if (document.fullscreenElement) return 1; },  
 264764: () => { return document.getElementById('canvas').width; },  
 264816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 265007: () => { return window.innerWidth; },  
 265033: () => { return window.innerHeight; },  
 ...
 265183: () => { document.exitFullscreen(); },  
 265210: () => { if (document.fullscreenElement) return 1; },  
 265256: () => { return document.getElementById('canvas').width; },  
 265308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265376: () => { document.exitFullscreen(); },  
 265403: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265461: () => { return screen.width; },  
 265486: () => { return screen.height; },  
 265512: () => { return window.screenX; },  
 265539: () => { return window.screenY; },  
 265566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265619: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265690: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266003: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266074: () => { if (document.fullscreenElement) return 1; },  
 266120: () => { return window.innerWidth; },  
 266146: () => { return window.innerHeight; },  
 266173: () => { if (document.pointerLockElement) return 1; }
};
