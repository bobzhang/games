...
var ASM_CONSTS = {
  267908: () => { if (document.fullscreenElement) return 1; },  
 267954: () => { return document.getElementById('canvas').width; },  
 268006: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268074: () => { document.exitFullscreen(); },  
 268101: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268174: () => { if (document.fullscreenElement) return 1; },  
 268220: () => { return document.getElementById('canvas').width; },  
 268272: () => { return screen.width; },  
 268297: () => { document.exitFullscreen(); },  
 268324: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268457: () => { return window.innerWidth; },  
 268483: () => { return window.innerHeight; },  
 268510: () => { if (document.fullscreenElement) return 1; },  
 268556: () => { return document.getElementById('canvas').width; },  
 268608: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268676: () => { if (document.fullscreenElement) return 1; },  
 268722: () => { return document.getElementById('canvas').width; },  
 268774: () => { return screen.width; },  
 268799: () => { return window.innerWidth; },  
 268825: () => { return window.innerHeight; },  
 268852: () => { if (document.fullscreenElement) return 1; },  
 268898: () => { return document.getElementById('canvas').width; },  
 268950: () => { return screen.width; },  
 268975: () => { document.exitFullscreen(); },  
 269002: () => { if (document.fullscreenElement) return 1; },  
 269048: () => { return document.getElementById('canvas').width; },  
 269100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269168: () => { document.exitFullscreen(); },  
 269195: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269253: () => { return screen.width; },  
 269278: () => { return screen.height; },  
 269304: () => { return window.screenX; },  
 269331: () => { return window.screenY; },  
 269358: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269411: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269482: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269539: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269795: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 269866: () => { if (document.fullscreenElement) return 1; },  
 269912: () => { return window.innerWidth; },  
 269938: () => { return window.innerHeight; },  
 269965: () => { if (document.pointerLockElement) return 1; }
};
