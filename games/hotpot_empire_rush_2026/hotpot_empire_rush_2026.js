...
var ASM_CONSTS = {
  268116: () => { if (document.fullscreenElement) return 1; },  
 268162: () => { return document.getElementById('canvas').width; },  
 268214: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268282: () => { document.exitFullscreen(); },  
 268309: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268382: () => { if (document.fullscreenElement) return 1; },  
 268428: () => { return document.getElementById('canvas').width; },  
 268480: () => { return screen.width; },  
 268505: () => { document.exitFullscreen(); },  
 268532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268665: () => { return window.innerWidth; },  
 268691: () => { return window.innerHeight; },  
 268718: () => { if (document.fullscreenElement) return 1; },  
 268764: () => { return document.getElementById('canvas').width; },  
 268816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268884: () => { if (document.fullscreenElement) return 1; },  
 268930: () => { return document.getElementById('canvas').width; },  
 268982: () => { return screen.width; },  
 269007: () => { return window.innerWidth; },  
 269033: () => { return window.innerHeight; },  
 269060: () => { if (document.fullscreenElement) return 1; },  
 269106: () => { return document.getElementById('canvas').width; },  
 269158: () => { return screen.width; },  
 269183: () => { document.exitFullscreen(); },  
 269210: () => { if (document.fullscreenElement) return 1; },  
 269256: () => { return document.getElementById('canvas').width; },  
 269308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269376: () => { document.exitFullscreen(); },  
 269403: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269461: () => { return screen.width; },  
 269486: () => { return screen.height; },  
 269512: () => { return window.screenX; },  
 269539: () => { return window.screenY; },  
 269566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269619: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269690: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 270003: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270074: () => { if (document.fullscreenElement) return 1; },  
 270120: () => { return window.innerWidth; },  
 270146: () => { return window.innerHeight; },  
 270173: () => { if (document.pointerLockElement) return 1; }
};
