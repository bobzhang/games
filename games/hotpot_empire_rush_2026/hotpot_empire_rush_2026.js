...
var ASM_CONSTS = {
  268100: () => { if (document.fullscreenElement) return 1; },  
 268146: () => { return document.getElementById('canvas').width; },  
 268198: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268266: () => { document.exitFullscreen(); },  
 268293: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268366: () => { if (document.fullscreenElement) return 1; },  
 268412: () => { return document.getElementById('canvas').width; },  
 268464: () => { return screen.width; },  
 268489: () => { document.exitFullscreen(); },  
 268516: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 268649: () => { return window.innerWidth; },  
 268675: () => { return window.innerHeight; },  
 268702: () => { if (document.fullscreenElement) return 1; },  
 268748: () => { return document.getElementById('canvas').width; },  
 268800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268868: () => { if (document.fullscreenElement) return 1; },  
 268914: () => { return document.getElementById('canvas').width; },  
 268966: () => { return screen.width; },  
 268991: () => { return window.innerWidth; },  
 269017: () => { return window.innerHeight; },  
 269044: () => { if (document.fullscreenElement) return 1; },  
 269090: () => { return document.getElementById('canvas').width; },  
 269142: () => { return screen.width; },  
 269167: () => { document.exitFullscreen(); },  
 269194: () => { if (document.fullscreenElement) return 1; },  
 269240: () => { return document.getElementById('canvas').width; },  
 269292: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269360: () => { document.exitFullscreen(); },  
 269387: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 269445: () => { return screen.width; },  
 269470: () => { return screen.height; },  
 269496: () => { return window.screenX; },  
 269523: () => { return window.screenY; },  
 269550: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 269603: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 269674: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 269731: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 269987: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 270058: () => { if (document.fullscreenElement) return 1; },  
 270104: () => { return window.innerWidth; },  
 270130: () => { return window.innerHeight; },  
 270157: () => { if (document.pointerLockElement) return 1; }
};
