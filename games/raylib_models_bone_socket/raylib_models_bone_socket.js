...
function findWasmBinary() {
  return locateFile('raylib_models_bone_socket.wasm');
}
...
var ASM_CONSTS = {
  356512: () => { if (document.fullscreenElement) return 1; },  
 356558: () => { return document.getElementById('canvas').width; },  
 356610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 356678: () => { document.exitFullscreen(); },  
 356705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 356778: () => { if (document.fullscreenElement) return 1; },  
 356824: () => { return document.getElementById('canvas').width; },  
 356876: () => { return screen.width; },  
 356901: () => { document.exitFullscreen(); },  
 356928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 357061: () => { return window.innerWidth; },  
 357087: () => { return window.innerHeight; },  
 357114: () => { if (document.fullscreenElement) return 1; },  
 357160: () => { return document.getElementById('canvas').width; },  
 357212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 357280: () => { if (document.fullscreenElement) return 1; },  
 357326: () => { return document.getElementById('canvas').width; },  
 357378: () => { return screen.width; },  
 357403: () => { return window.innerWidth; },  
 357429: () => { return window.innerHeight; },  
 357456: () => { if (document.fullscreenElement) return 1; },  
 357502: () => { return document.getElementById('canvas').width; },  
 357554: () => { return screen.width; },  
 357579: () => { document.exitFullscreen(); },  
 357606: () => { if (document.fullscreenElement) return 1; },  
 357652: () => { return document.getElementById('canvas').width; },  
 357704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 357772: () => { document.exitFullscreen(); },  
 357799: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 357857: () => { return screen.width; },  
 357882: () => { return screen.height; },  
 357908: () => { return window.screenX; },  
 357935: () => { return window.screenY; },  
 357962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 358015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 358086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 358143: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 358399: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 358470: () => { if (document.fullscreenElement) return 1; },  
 358516: () => { return window.innerWidth; },  
 358542: () => { return window.innerHeight; },  
 358569: () => { if (document.pointerLockElement) return 1; }
};
