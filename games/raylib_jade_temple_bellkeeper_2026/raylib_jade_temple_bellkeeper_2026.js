...
var ASM_CONSTS = {
 ...
 107066: () => { return parseInt(document.getElementById('canvas').style.width); },  
 107134: () => { document.exitFullscreen(); },  
 107161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107234: () => { if (document.fullscreenElement) return 1; },  
 107280: () => { return document.getElementById('canvas').width; },  
 107332: () => { return screen.width; },  
 107357: () => { document.exitFullscreen(); },  
 107384: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107517: () => { return window.innerWidth; },  
 107543: () => { return window.innerHeight; },  
 107570: () => { if (document.fullscreenElement) return 1; },  
 107616: () => { return document.getElementById('canvas').width; },  
 107668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 107859: () => { return window.innerWidth; },  
 107885: () => { return window.innerHeight; },  
 107912: () => { if (document.fullscreenElement) return 1; },  
 107958: () => { return document.getElementById('canvas').width; },  
 108010: () => { return screen.width; },  
 108035: () => { document.exitFullscreen(); },  
 108062: () => { if (document.fullscreenElement) return 1; },  
 108108: () => { return document.getElementById('canvas').width; },  
 108160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108228: () => { document.exitFullscreen(); },  
 108255: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 108313: () => { return screen.width; },  
 108338: () => { return screen.height; },  
 108364: () => { return window.screenX; },  
 108391: () => { return window.screenY; },  
 108418: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108471: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 108542: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 108599: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108855: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 108926: () => { if (document.fullscreenElement) return 1; },  
 108972: () => { return window.innerWidth; },  
 108998: () => { return window.innerHeight; },  
 109025: () => { if (document.pointerLockElement) return 1; },  
