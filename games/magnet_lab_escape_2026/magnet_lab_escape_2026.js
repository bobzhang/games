...
var ASM_CONSTS = {
 ...
 262790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262858: () => { document.exitFullscreen(); },  
 262885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 262958: () => { if (document.fullscreenElement) return 1; },  
 263004: () => { return document.getElementById('canvas').width; },  
 263056: () => { return screen.width; },  
 263081: () => { document.exitFullscreen(); },  
 263108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 263241: () => { return window.innerWidth; },  
 263267: () => { return window.innerHeight; },  
 263294: () => { if (document.fullscreenElement) return 1; },  
 263340: () => { return document.getElementById('canvas').width; },  
 263392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 263460: () => { if (document.fullscreenElement) return 1; },  
 263506: () => { return document.getElementById('canvas').width; },  
 263558: () => { return screen.width; },  
 263583: () => { return window.innerWidth; },  
 263609: () => { return window.innerHeight; },  
 ...
 263759: () => { document.exitFullscreen(); },  
 ...
 263952: () => { document.exitFullscreen(); },  
 263979: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 264037: () => { return screen.width; },  
 264062: () => { return screen.height; },  
 264088: () => { return window.screenX; },  
 264115: () => { return window.screenY; },  
 264142: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 264195: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 264266: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 264323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 264579: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 264650: () => { if (document.fullscreenElement) return 1; },  
 264696: () => { return window.innerWidth; },  
 264722: () => { return window.innerHeight; },  
 264749: () => { if (document.pointerLockElement) return 1; }
};
