...
function findWasmBinary() {
  return locateFile('raylib_textures_image_loading.wasm');
}
...
var ASM_CONSTS = {
 ...
 104722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104790: () => { document.exitFullscreen(); },  
 104817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 104890: () => { if (document.fullscreenElement) return 1; },  
 104936: () => { return document.getElementById('canvas').width; },  
 104988: () => { return screen.width; },  
 105013: () => { document.exitFullscreen(); },  
 105040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 105173: () => { return window.innerWidth; },  
 105199: () => { return window.innerHeight; },  
 105226: () => { if (document.fullscreenElement) return 1; },  
 105272: () => { return document.getElementById('canvas').width; },  
 105324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105392: () => { if (document.fullscreenElement) return 1; },  
 105438: () => { return document.getElementById('canvas').width; },  
 105490: () => { return screen.width; },  
 105515: () => { return window.innerWidth; },  
 105541: () => { return window.innerHeight; },  
 ...
 105691: () => { document.exitFullscreen(); },  
 105718: () => { if (document.fullscreenElement) return 1; },  
 105764: () => { return document.getElementById('canvas').width; },  
 105816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105884: () => { document.exitFullscreen(); },  
 105911: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 105969: () => { return screen.width; },  
 105994: () => { return screen.height; },  
 106020: () => { return window.screenX; },  
 106047: () => { return window.screenY; },  
 106074: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 106127: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106198: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106255: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106511: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106582: () => { if (document.fullscreenElement) return 1; },  
 106628: () => { return window.innerWidth; },  
 106654: () => { return window.innerHeight; },  
 106681: () => { if (document.pointerLockElement) return 1; }
};
