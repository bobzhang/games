...
var ASM_CONSTS = {
  106824: () => { if (document.fullscreenElement) return 1; },  
 106870: () => { return document.getElementById('canvas').width; },  
 106922: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106990: () => { document.exitFullscreen(); },  
 107017: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 107090: () => { if (document.fullscreenElement) return 1; },  
 107136: () => { return document.getElementById('canvas').width; },  
 107188: () => { return screen.width; },  
 107213: () => { document.exitFullscreen(); },  
 107240: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107373: () => { return window.innerWidth; },  
 107399: () => { return window.innerHeight; },  
 107426: () => { if (document.fullscreenElement) return 1; },  
 107472: () => { return document.getElementById('canvas').width; },  
 107524: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 107715: () => { return window.innerWidth; },  
 107741: () => { return window.innerHeight; },  
 ...
 114812: ($0) => { miniaudio.untrack_device_by_index($0); },  
 114855: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 114980: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
