...
var ASM_CONSTS = {
  106712: () => { if (document.fullscreenElement) return 1; },  
 106758: () => { return document.getElementById('canvas').width; },  
 106810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106878: () => { document.exitFullscreen(); },  
 106905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 106978: () => { if (document.fullscreenElement) return 1; },  
 107024: () => { return document.getElementById('canvas').width; },  
 107076: () => { return screen.width; },  
 107101: () => { document.exitFullscreen(); },  
 107128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 107261: () => { return window.innerWidth; },  
 107287: () => { return window.innerHeight; },  
 107314: () => { if (document.fullscreenElement) return 1; },  
 107360: () => { return document.getElementById('canvas').width; },  
 107412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 107603: () => { return window.innerWidth; },  
 107629: () => { return window.innerHeight; },  
