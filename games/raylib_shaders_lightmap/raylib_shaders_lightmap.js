...
function findWasmBinary() {
  return locateFile('raylib_shaders_lightmap.wasm');
}
...
var ASM_CONSTS = {
  153040: () => { if (document.fullscreenElement) return 1; },  
 153086: () => { return document.getElementById('canvas').width; },  
 153138: () => { return parseInt(document.getElementById('canvas').style.width); },  
 153206: () => { document.exitFullscreen(); },  
 153233: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 153306: () => { if (document.fullscreenElement) return 1; },  
 153352: () => { return document.getElementById('canvas').width; },  
 153404: () => { return screen.width; },  
 153429: () => { document.exitFullscreen(); },  
 153456: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 153589: () => { return window.innerWidth; },  
 153615: () => { return window.innerHeight; },  
 153642: () => { if (document.fullscreenElement) return 1; },  
 153688: () => { return document.getElementById('canvas').width; },  
 153740: () => { return parseInt(document.getElementById('canvas').style.width); },  
 153808: () => { if (document.fullscreenElement) return 1; },  
 153854: () => { return document.getElementById('canvas').width; },  
 153906: () => { return screen.width; },  
 153931: () => { return window.innerWidth; },  
 153957: () => { return window.innerHeight; },  
 153984: () => { if (document.fullscreenElement) return 1; },  
 154030: () => { return document.getElementById('canvas').width; },  
 154082: () => { return screen.width; },  
 154107: () => { document.exitFullscreen(); },  
 154134: () => { if (document.fullscreenElement) return 1; },  
 154180: () => { return document.getElementById('canvas').width; },  
 154232: () => { return parseInt(document.getElementById('canvas').style.width); },  
 154300: () => { document.exitFullscreen(); },  
 154327: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 154385: () => { return screen.width; },  
 154410: () => { return screen.height; },  
 154436: () => { return window.screenX; },  
 154463: () => { return window.screenY; },  
 154490: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 154543: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 154614: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 154671: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 154927: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 154998: () => { if (document.fullscreenElement) return 1; },  
 155044: () => { return window.innerWidth; },  
 155070: () => { return window.innerHeight; },  
 155097: () => { if (document.pointerLockElement) return 1; }
};
