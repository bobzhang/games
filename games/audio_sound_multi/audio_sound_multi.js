...
var ASM_CONSTS = {
  384000: () => { if (document.fullscreenElement) return 1; },  
 384046: () => { return document.getElementById('canvas').width; },  
 384098: () => { return parseInt(document.getElementById('canvas').style.width); },  
 384166: () => { document.exitFullscreen(); },  
 384193: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 384266: () => { if (document.fullscreenElement) return 1; },  
 384312: () => { return document.getElementById('canvas').width; },  
 384364: () => { return screen.width; },  
 384389: () => { document.exitFullscreen(); },  
 384416: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 384549: () => { return window.innerWidth; },  
 384575: () => { return window.innerHeight; },  
 384602: () => { if (document.fullscreenElement) return 1; },  
 384648: () => { return document.getElementById('canvas').width; },  
 384700: () => { return parseInt(document.getElementById('canvas').style.width); },  
 384768: () => { if (document.fullscreenElement) return 1; },  
 384814: () => { return document.getElementById('canvas').width; },  
 384866: () => { return screen.width; },  
 384891: () => { return window.innerWidth; },  
 384917: () => { return window.innerHeight; },  
 384944: () => { if (document.fullscreenElement) return 1; },  
 384990: () => { return document.getElementById('canvas').width; },  
 385042: () => { return screen.width; },  
 385067: () => { document.exitFullscreen(); },  
 385094: () => { if (document.fullscreenElement) return 1; },  
 385140: () => { return document.getElementById('canvas').width; },  
 385192: () => { return parseInt(document.getElementById('canvas').style.width); },  
 385260: () => { document.exitFullscreen(); },  
 385287: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 385345: () => { return screen.width; },  
 385370: () => { return screen.height; },  
 385396: () => { return window.screenX; },  
 385423: () => { return window.screenY; },  
 385450: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 385503: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 385574: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 385631: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 385887: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 385958: () => { if (document.fullscreenElement) return 1; },  
 386004: () => { return window.innerWidth; },  
 386030: () => { return window.innerHeight; },  
 386057: () => { if (document.pointerLockElement) return 1; },  
