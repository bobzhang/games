...
var ASM_CONSTS = {
  261044: () => { if (document.fullscreenElement) return 1; },  
 261090: () => { return document.getElementById('canvas').width; },  
 261142: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261210: () => { document.exitFullscreen(); },  
 261237: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 261310: () => { if (document.fullscreenElement) return 1; },  
 261356: () => { return document.getElementById('canvas').width; },  
 261408: () => { return screen.width; },  
 261433: () => { document.exitFullscreen(); },  
 261460: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 261593: () => { return window.innerWidth; },  
 261619: () => { return window.innerHeight; },  
 261646: () => { if (document.fullscreenElement) return 1; },  
 261692: () => { return document.getElementById('canvas').width; },  
 261744: () => { return parseInt(document.getElementById('canvas').style.width); },  
 261812: () => { if (document.fullscreenElement) return 1; },  
 261858: () => { return document.getElementById('canvas').width; },  
 261910: () => { return screen.width; },  
 261935: () => { return window.innerWidth; },  
 261961: () => { return window.innerHeight; },  
 ...
 262111: () => { document.exitFullscreen(); },  
 262138: () => { if (document.fullscreenElement) return 1; },  
 262184: () => { return document.getElementById('canvas').width; },  
 262236: () => { return parseInt(document.getElementById('canvas').style.width); },  
 262304: () => { document.exitFullscreen(); },  
 262331: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 262389: () => { return screen.width; },  
 262414: () => { return screen.height; },  
 262440: () => { return window.screenX; },  
 262467: () => { return window.screenY; },  
 262494: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 262547: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 262618: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 262675: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 262931: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 263002: () => { if (document.fullscreenElement) return 1; },  
 263048: () => { return window.innerWidth; },  
 263074: () => { return window.innerHeight; },  
 263101: () => { if (document.pointerLockElement) return 1; }
};
