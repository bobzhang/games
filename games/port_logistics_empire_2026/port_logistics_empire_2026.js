...
var ASM_CONSTS = {
 ...
 264390: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264458: () => { document.exitFullscreen(); },  
 264485: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264558: () => { if (document.fullscreenElement) return 1; },  
 264604: () => { return document.getElementById('canvas').width; },  
 264656: () => { return screen.width; },  
 264681: () => { document.exitFullscreen(); },  
 264708: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264841: () => { return window.innerWidth; },  
 264867: () => { return window.innerHeight; },  
 264894: () => { if (document.fullscreenElement) return 1; },  
 264940: () => { return document.getElementById('canvas').width; },  
 264992: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265060: () => { if (document.fullscreenElement) return 1; },  
 265106: () => { return document.getElementById('canvas').width; },  
 265158: () => { return screen.width; },  
 265183: () => { return window.innerWidth; },  
 265209: () => { return window.innerHeight; },  
 265236: () => { if (document.fullscreenElement) return 1; },  
 265282: () => { return document.getElementById('canvas').width; },  
 265334: () => { return screen.width; },  
 265359: () => { document.exitFullscreen(); },  
 265386: () => { if (document.fullscreenElement) return 1; },  
 265432: () => { return document.getElementById('canvas').width; },  
 265484: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265552: () => { document.exitFullscreen(); },  
 265579: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265637: () => { return screen.width; },  
 265662: () => { return screen.height; },  
 265688: () => { return window.screenX; },  
 265715: () => { return window.screenY; },  
 265742: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265795: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265866: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265923: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 266179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266250: () => { if (document.fullscreenElement) return 1; },  
 266296: () => { return window.innerWidth; },  
 266322: () => { return window.innerHeight; },  
 266349: () => { if (document.pointerLockElement) return 1; }
};
