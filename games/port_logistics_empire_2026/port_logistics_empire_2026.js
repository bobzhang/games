...
var ASM_CONSTS = {
 ...
 264182: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264250: () => { document.exitFullscreen(); },  
 264277: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 264350: () => { if (document.fullscreenElement) return 1; },  
 264396: () => { return document.getElementById('canvas').width; },  
 264448: () => { return screen.width; },  
 264473: () => { document.exitFullscreen(); },  
 264500: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 264633: () => { return window.innerWidth; },  
 264659: () => { return window.innerHeight; },  
 264686: () => { if (document.fullscreenElement) return 1; },  
 264732: () => { return document.getElementById('canvas').width; },  
 264784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 264852: () => { if (document.fullscreenElement) return 1; },  
 264898: () => { return document.getElementById('canvas').width; },  
 264950: () => { return screen.width; },  
 264975: () => { return window.innerWidth; },  
 265001: () => { return window.innerHeight; },  
 265028: () => { if (document.fullscreenElement) return 1; },  
 265074: () => { return document.getElementById('canvas').width; },  
 265126: () => { return screen.width; },  
 265151: () => { document.exitFullscreen(); },  
 265178: () => { if (document.fullscreenElement) return 1; },  
 265224: () => { return document.getElementById('canvas').width; },  
 265276: () => { return parseInt(document.getElementById('canvas').style.width); },  
 265344: () => { document.exitFullscreen(); },  
 265371: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 265429: () => { return screen.width; },  
 265454: () => { return screen.height; },  
 265480: () => { return window.screenX; },  
 265507: () => { return window.screenY; },  
 265534: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 265587: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 265658: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 265715: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 265971: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 266042: () => { if (document.fullscreenElement) return 1; },  
 266088: () => { return window.innerWidth; },  
 266114: () => { return window.innerHeight; },  
 266141: () => { if (document.pointerLockElement) return 1; }
};
