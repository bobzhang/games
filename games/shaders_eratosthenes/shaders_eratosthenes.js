...
var ASM_CONSTS = {
  254960: () => { if (document.fullscreenElement) return 1; },  
 255006: () => { return document.getElementById('canvas').width; },  
 255058: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255126: () => { document.exitFullscreen(); },  
 255153: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255226: () => { if (document.fullscreenElement) return 1; },  
 255272: () => { return document.getElementById('canvas').width; },  
 255324: () => { return screen.width; },  
 255349: () => { document.exitFullscreen(); },  
 255376: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255509: () => { return window.innerWidth; },  
 255535: () => { return window.innerHeight; },  
 255562: () => { if (document.fullscreenElement) return 1; },  
 255608: () => { return document.getElementById('canvas').width; },  
 255660: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255728: () => { if (document.fullscreenElement) return 1; },  
 255774: () => { return document.getElementById('canvas').width; },  
 255826: () => { return screen.width; },  
 255851: () => { return window.innerWidth; },  
 255877: () => { return window.innerHeight; },  
 255904: () => { if (document.fullscreenElement) return 1; },  
 255950: () => { return document.getElementById('canvas').width; },  
 256002: () => { return screen.width; },  
 256027: () => { document.exitFullscreen(); },  
 256054: () => { if (document.fullscreenElement) return 1; },  
 256100: () => { return document.getElementById('canvas').width; },  
 256152: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256220: () => { document.exitFullscreen(); },  
 256247: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256305: () => { return screen.width; },  
 256330: () => { return screen.height; },  
 256356: () => { return window.screenX; },  
 256383: () => { return window.screenY; },  
 256410: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256463: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 256534: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 256591: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 256847: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 256918: () => { if (document.fullscreenElement) return 1; },  
 256964: () => { return window.innerWidth; },  
 256990: () => { return window.innerHeight; },  
 257017: () => { if (document.pointerLockElement) return 1; }
};
