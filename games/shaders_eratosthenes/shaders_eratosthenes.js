...
var ASM_CONSTS = {
  254964: () => { if (document.fullscreenElement) return 1; },  
 255010: () => { return document.getElementById('canvas').width; },  
 255062: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255130: () => { document.exitFullscreen(); },  
 255157: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255230: () => { if (document.fullscreenElement) return 1; },  
 255276: () => { return document.getElementById('canvas').width; },  
 255328: () => { return screen.width; },  
 255353: () => { document.exitFullscreen(); },  
 255380: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255513: () => { return window.innerWidth; },  
 255539: () => { return window.innerHeight; },  
 255566: () => { if (document.fullscreenElement) return 1; },  
 255612: () => { return document.getElementById('canvas').width; },  
 255664: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255732: () => { if (document.fullscreenElement) return 1; },  
 255778: () => { return document.getElementById('canvas').width; },  
 255830: () => { return screen.width; },  
 255855: () => { return window.innerWidth; },  
 255881: () => { return window.innerHeight; },  
 255908: () => { if (document.fullscreenElement) return 1; },  
 255954: () => { return document.getElementById('canvas').width; },  
 256006: () => { return screen.width; },  
 256031: () => { document.exitFullscreen(); },  
 256058: () => { if (document.fullscreenElement) return 1; },  
 256104: () => { return document.getElementById('canvas').width; },  
 256156: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256224: () => { document.exitFullscreen(); },  
 256251: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256309: () => { return screen.width; },  
 256334: () => { return screen.height; },  
 256360: () => { return window.screenX; },  
 256387: () => { return window.screenY; },  
 256414: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256467: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 256538: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 256595: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 256851: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 256922: () => { if (document.fullscreenElement) return 1; },  
 256968: () => { return window.innerWidth; },  
 256994: () => { return window.innerHeight; },  
 257021: () => { if (document.pointerLockElement) return 1; }
};
