...
var ASM_CONSTS = {
  254756: () => { if (document.fullscreenElement) return 1; },  
 254802: () => { return document.getElementById('canvas').width; },  
 254854: () => { return parseInt(document.getElementById('canvas').style.width); },  
 254922: () => { document.exitFullscreen(); },  
 254949: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 255022: () => { if (document.fullscreenElement) return 1; },  
 255068: () => { return document.getElementById('canvas').width; },  
 255120: () => { return screen.width; },  
 255145: () => { document.exitFullscreen(); },  
 255172: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 255305: () => { return window.innerWidth; },  
 255331: () => { return window.innerHeight; },  
 255358: () => { if (document.fullscreenElement) return 1; },  
 255404: () => { return document.getElementById('canvas').width; },  
 255456: () => { return parseInt(document.getElementById('canvas').style.width); },  
 255524: () => { if (document.fullscreenElement) return 1; },  
 255570: () => { return document.getElementById('canvas').width; },  
 255622: () => { return screen.width; },  
 255647: () => { return window.innerWidth; },  
 255673: () => { return window.innerHeight; },  
 255700: () => { if (document.fullscreenElement) return 1; },  
 255746: () => { return document.getElementById('canvas').width; },  
 255798: () => { return screen.width; },  
 255823: () => { document.exitFullscreen(); },  
 255850: () => { if (document.fullscreenElement) return 1; },  
 255896: () => { return document.getElementById('canvas').width; },  
 255948: () => { return parseInt(document.getElementById('canvas').style.width); },  
 256016: () => { document.exitFullscreen(); },  
 256043: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 256101: () => { return screen.width; },  
 256126: () => { return screen.height; },  
 256152: () => { return window.screenX; },  
 256179: () => { return window.screenY; },  
 256206: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 256259: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 256330: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 256387: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 256643: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 256714: () => { if (document.fullscreenElement) return 1; },  
 256760: () => { return window.innerWidth; },  
 256786: () => { return window.innerHeight; },  
 256813: () => { if (document.pointerLockElement) return 1; }
};
