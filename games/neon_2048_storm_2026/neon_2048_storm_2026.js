...
var ASM_CONSTS = {
 ...
 268730: () => { return parseInt(document.getElementById('canvas').style.width); },  
 268798: () => { document.exitFullscreen(); },  
 268825: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 268898: () => { if (document.fullscreenElement) return 1; },  
 268944: () => { return document.getElementById('canvas').width; },  
 268996: () => { return screen.width; },  
 269021: () => { document.exitFullscreen(); },  
 269048: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269181: () => { return window.innerWidth; },  
 269207: () => { return window.innerHeight; },  
 269234: () => { if (document.fullscreenElement) return 1; },  
 269280: () => { return document.getElementById('canvas').width; },  
 269332: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269400: () => { if (document.fullscreenElement) return 1; },  
 269446: () => { return document.getElementById('canvas').width; },  
 269498: () => { return screen.width; },  
 269523: () => { return window.innerWidth; },  
 269549: () => { return window.innerHeight; },  
