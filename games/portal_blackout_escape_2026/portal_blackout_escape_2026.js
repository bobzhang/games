...
var ASM_CONSTS = {
 ...
 269358: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269426: () => { document.exitFullscreen(); },  
 269453: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269526: () => { if (document.fullscreenElement) return 1; },  
 269572: () => { return document.getElementById('canvas').width; },  
 269624: () => { return screen.width; },  
 269649: () => { document.exitFullscreen(); },  
 269676: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 269809: () => { return window.innerWidth; },  
 269835: () => { return window.innerHeight; },  
 269862: () => { if (document.fullscreenElement) return 1; },  
 269908: () => { return document.getElementById('canvas').width; },  
 269960: () => { return parseInt(document.getElementById('canvas').style.width); },  
