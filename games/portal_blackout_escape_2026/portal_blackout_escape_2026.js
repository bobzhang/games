...
var ASM_CONSTS = {
 ...
 269566: () => { return parseInt(document.getElementById('canvas').style.width); },  
 269634: () => { document.exitFullscreen(); },  
 269661: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 269734: () => { if (document.fullscreenElement) return 1; },  
 269780: () => { return document.getElementById('canvas').width; },  
 269832: () => { return screen.width; },  
 269857: () => { document.exitFullscreen(); },  
 269884: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 270017: () => { return window.innerWidth; },  
 270043: () => { return window.innerHeight; },  
 270070: () => { if (document.fullscreenElement) return 1; },  
 270116: () => { return document.getElementById('canvas').width; },  
 270168: () => { return parseInt(document.getElementById('canvas').style.width); },  
 ...
 277456: ($0) => { miniaudio.untrack_device_by_index($0); },  
 277499: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 277624: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
