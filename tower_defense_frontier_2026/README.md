...
```bash
moon build --target native tower_defense_frontier_2026/
./_build/native/debug/build/tower_defense_frontier_2026/tower_defense_frontier_2026.exe
```
...
### Package `tower_defense_frontier_2026`
