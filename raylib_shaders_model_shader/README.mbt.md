...
```bash
moon build --target native raylib_shaders_model_shader/
./_build/native/debug/build/raylib_shaders_model_shader/raylib_shaders_model_shader.exe
```
...
### Package `raylib_shaders_model_shader`
