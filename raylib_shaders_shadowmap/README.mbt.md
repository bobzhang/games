...
```bash
moon build --target native raylib_shaders_shadowmap/
./_build/native/debug/build/raylib_shaders_shadowmap/raylib_shaders_shadowmap.exe
```
...
### Package `raylib_shaders_shadowmap`
