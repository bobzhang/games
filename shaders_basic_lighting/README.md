...
```bash
moon build --target native shaders_basic_lighting/
./_build/native/debug/build/shaders_basic_lighting/shaders_basic_lighting.exe
```
...
### Package `shaders_basic_lighting`
