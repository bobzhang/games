...
```bash
moon build --target native magnet_lab_escape_2026/
./_build/native/debug/build/magnet_lab_escape_2026/magnet_lab_escape_2026.exe
```
...
### Package `magnet_lab_escape_2026`
