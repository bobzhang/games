...
```bash
moon build --target native raylib_shapes_bouncing_ball/
./_build/native/debug/build/raylib_shapes_bouncing_ball/raylib_shapes_bouncing_ball.exe
```
...
### Package `raylib_shapes_bouncing_ball`
