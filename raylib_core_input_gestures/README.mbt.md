...
```bash
moon build --target native raylib_core_input_gestures/
./_build/native/debug/build/raylib_core_input_gestures/raylib_core_input_gestures.exe
```
...
### Package `raylib_core_input_gestures`
