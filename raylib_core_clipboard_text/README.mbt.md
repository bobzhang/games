...
```bash
moon build --target native raylib_core_clipboard_text/
./_build/native/debug/build/raylib_core_clipboard_text/raylib_core_clipboard_text.exe
```
...
### Package `raylib_core_clipboard_text`
