...
```bash
moon build --target native clockwork_train_heist_2026/
./_build/native/debug/build/clockwork_train_heist_2026/clockwork_train_heist_2026.exe
```
...
### Package `tonyfettes/raylib-examples/clockwork_train_heist_2026`
...
### Package `tonyfettes/raylib-examples/clockwork_train_heist_2026/internal/types`
...
### Package `tonyfettes/raylib-examples/clockwork_train_heist_2026/internal/game`
...
### Package `tonyfettes/raylib-examples/clockwork_train_heist_2026/internal/render`
