...
```bash
cd examples && moon build --target native polar_train_heist_2026/
cd examples && ./_build/native/debug/build/polar_train_heist_2026/polar_train_heist_2026.exe
```
...
### Package `polar_train_heist_2026`
...
### Package `polar_train_heist_2026/internal/types`
...
### Package `polar_train_heist_2026/internal/game`
...
### Package `polar_train_heist_2026/internal/render`
