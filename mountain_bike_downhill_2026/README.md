...
```bash
moon build --target native mountain_bike_downhill_2026/
./_build/native/debug/build/mountain_bike_downhill_2026/mountain_bike_downhill_2026.exe
```
...
### Package `mountain_bike_downhill_2026`
