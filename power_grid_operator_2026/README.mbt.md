...
```bash
moon build --target native power_grid_operator_2026/
./_build/native/debug/build/power_grid_operator_2026/power_grid_operator_2026.exe
```
...
### Package `power_grid_operator_2026`
