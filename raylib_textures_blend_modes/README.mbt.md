...
```bash
moon build --target native raylib_textures_blend_modes/
./_build/native/debug/build/raylib_textures_blend_modes/raylib_textures_blend_modes.exe
```
...
### Package `raylib_textures_blend_modes`
