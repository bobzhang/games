...
```bash
moon build --target native raylib_models_first_person_maze/
./_build/native/debug/build/raylib_models_first_person_maze/raylib_models_first_person_maze.exe
```
...
### Package `raylib_models_first_person_maze`
