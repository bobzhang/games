...
```bash
moon build --target native textures_image_channel/
./_build/native/debug/build/textures_image_channel/textures_image_channel.exe
```
...
### Package `textures_image_channel`
