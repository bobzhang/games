...
```bash
moon build --target native raylib_textures_sprite_explosion/
./_build/native/debug/build/raylib_textures_sprite_explosion/raylib_textures_sprite_explosion.exe
```
...
### Package `raylib_textures_sprite_explosion`
