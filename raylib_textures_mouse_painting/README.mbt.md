...
```bash
moon build --target native raylib_textures_mouse_painting/
./_build/native/debug/build/raylib_textures_mouse_painting/raylib_textures_mouse_painting.exe
```
...
### Package `raylib_textures_mouse_painting`
