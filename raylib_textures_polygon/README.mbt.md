...
```bash
moon build --target native raylib_textures_polygon/
./_build/native/debug/build/raylib_textures_polygon/raylib_textures_polygon.exe
```
...
### Package `raylib_textures_polygon`
