...
```bash
moon build --target native shapes_draw_rectangle_rounded/
./_build/native/debug/build/shapes_draw_rectangle_rounded/shapes_draw_rectangle_rounded.exe
```
...
### Package `shapes_draw_rectangle_rounded`
