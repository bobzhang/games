...
```bash
moon build --target native raylib_core_smooth_pixelperfect/
./_build/native/debug/build/raylib_core_smooth_pixelperfect/raylib_core_smooth_pixelperfect.exe
```
...
### Package `raylib_core_smooth_pixelperfect`
