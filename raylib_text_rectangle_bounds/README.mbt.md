...
```bash
moon build --target native raylib_text_rectangle_bounds/
./_build/native/debug/build/raylib_text_rectangle_bounds/raylib_text_rectangle_bounds.exe
```
...
### Package `raylib_text_rectangle_bounds`
