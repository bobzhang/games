...
```bash
moon build --target native raylib_text_font_spritefont/
./_build/native/debug/build/raylib_text_font_spritefont/raylib_text_font_spritefont.exe
```
...
### Package `raylib_text_font_spritefont`
