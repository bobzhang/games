...
```bash
moon build --target native raylib_air_traffic_control_2026/
./_build/native/debug/build/raylib_air_traffic_control_2026/raylib_air_traffic_control_2026.exe
```
...
### Package `raylib_air_traffic_control_2026`
...
```
raylib_air_traffic_control_2026/
