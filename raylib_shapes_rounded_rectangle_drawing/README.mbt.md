...
```bash
moon build --target native raylib_shapes_rounded_rectangle_drawing/
./_build/native/debug/build/raylib_shapes_rounded_rectangle_drawing/raylib_shapes_rounded_rectangle_drawing.exe
```
...
### Package `raylib_shapes_rounded_rectangle_drawing`
...
- This example serves as a raygui-enhanced version of `raylib_shapes_draw_rectangle_rounded`, replacing keyboard controls with intuitive sliders and checkboxes.
