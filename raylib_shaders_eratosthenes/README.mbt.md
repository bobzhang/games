...
```bash
moon build --target native raylib_shaders_eratosthenes/
./_build/native/debug/build/raylib_shaders_eratosthenes/raylib_shaders_eratosthenes.exe
```
...
### Package `raylib_shaders_eratosthenes`
