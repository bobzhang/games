...
```bash
moon build --target native shaders_palette_switch/
./_build/native/debug/build/shaders_palette_switch/shaders_palette_switch.exe
```
...
### Package `shaders_palette_switch`
