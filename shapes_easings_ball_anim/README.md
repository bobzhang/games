...
```bash
moon build --target native shapes_easings_ball_anim/
./_build/native/debug/build/shapes_easings_ball_anim/shapes_easings_ball_anim.exe
```
...
### Package `shapes_easings_ball_anim`
