...
```bash
moon build --target native raylib_core_2d_camera_mouse_zoom/
./_build/native/debug/build/raylib_core_2d_camera_mouse_zoom/raylib_core_2d_camera_mouse_zoom.exe
```
...
### Package `raylib_core_2d_camera_mouse_zoom`
