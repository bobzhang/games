...
```bash
moon build --target native raylib_textures_image_drawing/
./_build/native/debug/build/raylib_textures_image_drawing/raylib_textures_image_drawing.exe
```
...
### Package `raylib_textures_image_drawing`
