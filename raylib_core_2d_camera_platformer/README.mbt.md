...
```bash
moon build --target native raylib_core_2d_camera_platformer/
./_build/native/debug/build/raylib_core_2d_camera_platformer/raylib_core_2d_camera_platformer.exe
```
...
### Package `raylib_core_2d_camera_platformer`
