...
```bash
moon build --target native raylib_post_office_sorter_2026/
./_build/native/debug/build/raylib_post_office_sorter_2026/raylib_post_office_sorter_2026.exe
```
...
### Package `raylib_post_office_sorter_2026`
...
```
raylib_post_office_sorter_2026/
