...
```bash
moon build --target native raylib_core_scissor_test/
./_build/native/debug/build/raylib_core_scissor_test/raylib_core_scissor_test.exe
```
...
### Package `raylib_core_scissor_test`
