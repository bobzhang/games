...
```bash
moon build --target native raylib_clocktower_heist_2026/
./_build/native/debug/build/raylib_clocktower_heist_2026/raylib_clocktower_heist_2026.exe
```
...
### Package `raylib_clocktower_heist_2026`
