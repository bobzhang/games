...
```bash
moon build --target native raylib_neon_taxi_rush_2026/
./_build/native/debug/build/raylib_neon_taxi_rush_2026/raylib_neon_taxi_rush_2026.exe
```
...
### Package `raylib_neon_taxi_rush_2026`
