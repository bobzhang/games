...
```bash
moon build --target native core_input_mouse_wheel/
./_build/native/debug/build/core_input_mouse_wheel/core_input_mouse_wheel.exe
```
...
### Package `core_input_mouse_wheel`
