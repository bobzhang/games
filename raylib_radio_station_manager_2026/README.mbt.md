...
```bash
moon build --target native raylib_radio_station_manager_2026/
./_build/native/debug/build/raylib_radio_station_manager_2026/raylib_radio_station_manager_2026.exe
```
...
### Package `raylib_radio_station_manager_2026`
