...
```bash
moon build --target native raylib_text_raylib_fonts/
./_build/native/debug/build/raylib_text_raylib_fonts/raylib_text_raylib_fonts.exe
```
...
### Package `raylib_text_raylib_fonts`
