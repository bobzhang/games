...
```bash
cd examples && moon build --target native ink_scroll_detective_2026/
cd examples && ./_build/native/debug/build/ink_scroll_detective_2026/ink_scroll_detective_2026.exe
```
...
### Package `ink_scroll_detective_2026` (main)
...
### Package `ink_scroll_detective_2026/internal/types`
...
### Package `ink_scroll_detective_2026/internal/game`
...
### Package `ink_scroll_detective_2026/internal/render`
