...
```bash
moon build --target native raylib_monsoon_bridge_rescue_2026/
./_build/native/debug/build/raylib_monsoon_bridge_rescue_2026/raylib_monsoon_bridge_rescue_2026.exe
```
...
### Package `raylib_monsoon_bridge_rescue_2026`
...
```
raylib_monsoon_bridge_rescue_2026/
