...
```bash
moon build --target native raylib_core_input_gamepad_info/
./_build/native/debug/build/raylib_core_input_gamepad_info/raylib_core_input_gamepad_info.exe
```
...
### Package `raylib_core_input_gamepad_info`
