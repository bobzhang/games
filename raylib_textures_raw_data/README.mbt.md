...
```bash
moon build --target native raylib_textures_raw_data/
./_build/native/debug/build/raylib_textures_raw_data/raylib_textures_raw_data.exe
```
...
### Package `raylib_textures_raw_data`
