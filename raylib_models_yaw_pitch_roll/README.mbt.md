...
```bash
moon build --target native raylib_models_yaw_pitch_roll/
./_build/native/debug/build/raylib_models_yaw_pitch_roll/raylib_models_yaw_pitch_roll.exe
```
...
### Package `raylib_models_yaw_pitch_roll`
