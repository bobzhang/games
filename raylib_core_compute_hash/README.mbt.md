...
```bash
moon build --target native raylib_core_compute_hash/
./_build/native/debug/build/raylib_core_compute_hash/raylib_core_compute_hash.exe
```
...
### Package `raylib_core_compute_hash`
