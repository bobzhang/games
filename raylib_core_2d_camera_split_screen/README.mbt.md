...
```bash
moon build --target native raylib_core_2d_camera_split_screen/
./_build/native/debug/build/raylib_core_2d_camera_split_screen/raylib_core_2d_camera_split_screen.exe
```
...
### Package `raylib_core_2d_camera_split_screen`
