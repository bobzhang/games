...
```bash
moon build --target native raylib_text_format_text/
./_build/native/debug/build/raylib_text_format_text/raylib_text_format_text.exe
```
...
### Package `raylib_text_format_text`
