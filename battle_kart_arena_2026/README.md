...
```bash
moon build --target native battle_kart_arena_2026/
./_build/native/debug/build/battle_kart_arena_2026/battle_kart_arena_2026.exe
```
...
### Package `battle_kart_arena_2026`
