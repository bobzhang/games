...
```bash
moon build --target native city_builder_mini_2026/
./_build/native/debug/build/city_builder_mini_2026/city_builder_mini_2026.exe
```
...
### Package `city_builder_mini_2026`
