...
```bash
moon build --target native castle_siege_artillery_2026/
./_build/native/debug/build/castle_siege_artillery_2026/castle_siege_artillery_2026.exe
```
...
### Package `castle_siege_artillery_2026`
