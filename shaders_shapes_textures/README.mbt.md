...
```bash
moon build --target native shaders_shapes_textures/
./_build/native/debug/build/shaders_shapes_textures/shaders_shapes_textures.exe
```
...
### Package `shaders_shapes_textures`
