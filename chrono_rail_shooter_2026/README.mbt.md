...
```bash
moon build --target native chrono_rail_shooter_2026/
./_build/native/debug/build/chrono_rail_shooter_2026/chrono_rail_shooter_2026.exe
```
...
### Package `chrono_rail_shooter_2026`
