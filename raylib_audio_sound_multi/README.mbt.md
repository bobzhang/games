...
```bash
moon build --target native raylib_audio_sound_multi/
./_build/native/debug/build/raylib_audio_sound_multi/raylib_audio_sound_multi.exe
```
...
### Package `raylib_audio_sound_multi`
