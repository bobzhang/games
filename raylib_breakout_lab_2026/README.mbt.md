...
```bash
moon build --target native raylib_breakout_lab_2026/
./_build/native/debug/build/raylib_breakout_lab_2026/raylib_breakout_lab_2026.exe
```
...
### Package `raylib_breakout_lab_2026`
