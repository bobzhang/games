...
```bash
moon build --target native raylib_rts_skirmish_2026/
./_build/native/debug/build/raylib_rts_skirmish_2026/raylib_rts_skirmish_2026.exe
```
...
### Package `raylib_rts_skirmish_2026`
