...
```bash
moon build --target native raylib_shaders_color_correction/
./_build/native/debug/build/raylib_shaders_color_correction/raylib_shaders_color_correction.exe
```
...
### Package `raylib_shaders_color_correction`
