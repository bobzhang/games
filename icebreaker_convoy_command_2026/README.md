...
```bash
moon build --target native icebreaker_convoy_command_2026/
./_build/native/debug/build/icebreaker_convoy_command_2026/icebreaker_convoy_command_2026.exe
```
...
### Package `icebreaker_convoy_command_2026`
