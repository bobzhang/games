...
```bash
cd examples && moon build --target native zombie_safehouse_siege_2026/
cd examples && ./_build/native/debug/build/zombie_safehouse_siege_2026/zombie_safehouse_siege_2026.exe
```
