...
```bash
moon build --target native shapes_top_down_lights/
./_build/native/debug/build/shapes_top_down_lights/shapes_top_down_lights.exe
```
...
### Package `shapes_top_down_lights`
