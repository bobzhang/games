...
```bash
moon build --target native raylib_shaders_mesh_instancing/
./_build/native/debug/build/raylib_shaders_mesh_instancing/raylib_shaders_mesh_instancing.exe
```
...
### Package `raylib_shaders_mesh_instancing`
