...
```bash
moon build --target native survival_arena_3d/
./_build/native/debug/build/survival_arena_3d/survival_arena_3d.exe
```
...
### Package `survival_arena_3d/internal/levels`
...
### Package `survival_arena_3d/internal/game`
...
### Package `survival_arena_3d/internal/render`
