...
```bash
moon build --target native raylib_aftershock_rescue_convoy_2026/
./_build/native/debug/build/raylib_aftershock_rescue_convoy_2026/raylib_aftershock_rescue_convoy_2026.exe
```
...
### Package `raylib_aftershock_rescue_convoy_2026`
...
```
raylib_aftershock_rescue_convoy_2026/
