...
```bash
moon build --target native raylib_deep_sea_salvage_2026/
./_build/native/debug/build/raylib_deep_sea_salvage_2026/raylib_deep_sea_salvage_2026.exe
```
...
### Package `raylib_deep_sea_salvage_2026`
