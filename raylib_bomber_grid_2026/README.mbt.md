...
```bash
moon build --target native raylib_bomber_grid_2026/
./_build/native/debug/build/raylib_bomber_grid_2026/raylib_bomber_grid_2026.exe
```
...
### Package `raylib_bomber_grid_2026`
