...
```bash
cd examples && moon build --target native orbital_shield_command_2026/
cd examples && ./_build/native/debug/build/orbital_shield_command_2026/orbital_shield_command_2026.exe
```
...
### Package `orbital_shield_command_2026`
