...
```bash
moon build --target native raylib_mine_cart_mayhem_2026/
./_build/native/debug/build/raylib_mine_cart_mayhem_2026/raylib_mine_cart_mayhem_2026.exe
```
...
### Package `raylib_mine_cart_mayhem_2026`
