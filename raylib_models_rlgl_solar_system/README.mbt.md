...
```bash
moon build --target native raylib_models_rlgl_solar_system/
./_build/native/debug/build/raylib_models_rlgl_solar_system/raylib_models_rlgl_solar_system.exe
```
...
### Package `raylib_models_rlgl_solar_system`
