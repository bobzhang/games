...
```bash
moon build --target native raylib_drone_show_director_2026/
./_build/native/debug/build/raylib_drone_show_director_2026/raylib_drone_show_director_2026.exe
```
...
### Package `raylib_drone_show_director_2026`
...
```
raylib_drone_show_director_2026/
