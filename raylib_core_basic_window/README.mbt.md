...
```bash
moon build --target native raylib_core_basic_window/
./_build/native/debug/build/raylib_core_basic_window/raylib_core_basic_window.exe
```
...
### Package `raylib_core_basic_window`
