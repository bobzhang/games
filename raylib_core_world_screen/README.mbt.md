...
```bash
moon build --target native raylib_core_world_screen/
./_build/native/debug/build/raylib_core_world_screen/raylib_core_world_screen.exe
```
...
### Package `raylib_core_world_screen`
