...
```bash
moon build --target native textures_npatch_drawing/
./_build/native/debug/build/textures_npatch_drawing/textures_npatch_drawing.exe
```
...
### Package `textures_npatch_drawing`
