...
```bash
moon build --target native raylib_time_loop_arena_2026/
./_build/native/debug/build/raylib_time_loop_arena_2026/raylib_time_loop_arena_2026.exe
```
...
### Package `raylib_time_loop_arena_2026`
