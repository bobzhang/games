...
```bash
moon build --target native raylib_platformer_precision_2026/
./_build/native/debug/build/raylib_platformer_precision_2026/raylib_platformer_precision_2026.exe
```
...
### Package `raylib_platformer_precision_2026`
...
```
raylib_platformer_precision_2026/
