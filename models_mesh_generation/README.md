...
```bash
moon build --target native models_mesh_generation/
./_build/native/debug/build/models_mesh_generation/models_mesh_generation.exe
```
...
### Package `models_mesh_generation`
