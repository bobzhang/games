...
```bash
moon build --target native archery_tournament_2026/
./_build/native/debug/build/archery_tournament_2026/archery_tournament_2026.exe
```
...
### Package `archery_tournament_2026`
