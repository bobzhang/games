...
```bash
cd examples && moon build --target native paper_lantern_patrol_2026/
cd examples && ./_build/native/debug/build/paper_lantern_patrol_2026/paper_lantern_patrol_2026.exe
```
...
### Package `paper_lantern_patrol_2026`
...
### Package `paper_lantern_patrol_2026/internal/types`
...
### Package `paper_lantern_patrol_2026/internal/game`
...
### Package `paper_lantern_patrol_2026/internal/render`
