...
```bash
moon build --target native raylib_spellforge_arena_2026/
./_build/native/debug/build/raylib_spellforge_arena_2026/raylib_spellforge_arena_2026.exe
```
...
### Package `raylib_spellforge_arena_2026`
