...
```bash
moon build --target native fishing_tycoon_2026/
./_build/native/debug/build/fishing_tycoon_2026/fishing_tycoon_2026.exe
```
...
### Package `tonyfettes/raylib-examples/fishing_tycoon_2026`
