...
```bash
moon build --target native raylib_ghost_mansion_investigation_2026/
./_build/native/debug/build/raylib_ghost_mansion_investigation_2026/raylib_ghost_mansion_investigation_2026.exe
```
...
### Package `raylib_ghost_mansion_investigation_2026`
