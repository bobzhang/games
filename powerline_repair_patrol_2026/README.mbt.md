...
```bash
moon build --target native powerline_repair_patrol_2026/
./_build/native/debug/build/powerline_repair_patrol_2026/powerline_repair_patrol_2026.exe
```
...
### Package `powerline_repair_patrol_2026`
