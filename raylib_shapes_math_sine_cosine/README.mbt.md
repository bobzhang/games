...
```bash
moon build --target native raylib_shapes_math_sine_cosine/
./_build/native/debug/build/raylib_shapes_math_sine_cosine/raylib_shapes_math_sine_cosine.exe
```
...
### Package `raylib_shapes_math_sine_cosine`
