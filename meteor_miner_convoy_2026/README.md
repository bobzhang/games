...
```bash
moon build --target native meteor_miner_convoy_2026/
./_build/native/debug/build/meteor_miner_convoy_2026/meteor_miner_convoy_2026.exe
```
...
### Package `meteor_miner_convoy_2026`
