...
```bash
cd examples && moon build --target native pac_dash_2026/
cd examples && ./_build/native/debug/build/pac_dash_2026/pac_dash_2026.exe
```
...
### Package `pac_dash_2026/internal/types`
...
### Package `pac_dash_2026/internal/game`
...
### Package `pac_dash_2026/internal/render`
