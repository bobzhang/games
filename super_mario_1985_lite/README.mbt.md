...
```bash
moon build --target native super_mario_1985_lite/
./_build/native/debug/build/super_mario_1985_lite/super_mario_1985_lite.exe
```
...
### Package `super_mario_1985_lite/internal/types`
...
### Package `super_mario_1985_lite/internal/game`
...
### Package `super_mario_1985_lite/internal/particles`
...
### Package `super_mario_1985_lite/internal/render`
