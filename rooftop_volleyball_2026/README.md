...
```bash
moon build --target native rooftop_volleyball_2026/
./_build/native/debug/build/rooftop_volleyball_2026/rooftop_volleyball_2026.exe
```
...
### Package `rooftop_volleyball_2026`
