...
```bash
moon build --target native textures_srcrec_dstrec/
./_build/native/debug/build/textures_srcrec_dstrec/textures_srcrec_dstrec.exe
```
...
### Package `textures_srcrec_dstrec`
