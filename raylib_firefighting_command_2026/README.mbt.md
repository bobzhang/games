...
```bash
moon build --target native raylib_firefighting_command_2026/
./_build/native/debug/build/raylib_firefighting_command_2026/raylib_firefighting_command_2026.exe
```
...
### Package `tonyfettes/raylib-examples/raylib_firefighting_command_2026`
