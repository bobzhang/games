...
```bash
moon build --target native raylib_models_geometric_shapes/
./_build/native/debug/build/raylib_models_geometric_shapes/raylib_models_geometric_shapes.exe
```
...
### Package `raylib_models_geometric_shapes`
