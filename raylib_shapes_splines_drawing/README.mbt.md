...
```bash
moon build --target native raylib_shapes_splines_drawing/
./_build/native/debug/build/raylib_shapes_splines_drawing/raylib_shapes_splines_drawing.exe
```
...
### Package `raylib_shapes_splines_drawing`
