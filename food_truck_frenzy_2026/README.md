...
```bash
moon build --target native food_truck_frenzy_2026/
./_build/native/debug/build/food_truck_frenzy_2026/food_truck_frenzy_2026.exe
```
...
### Package `food_truck_frenzy_2026`
