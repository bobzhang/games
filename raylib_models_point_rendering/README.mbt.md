...
```bash
moon build --target native raylib_models_point_rendering/
./_build/native/debug/build/raylib_models_point_rendering/raylib_models_point_rendering.exe
```
...
### Package `raylib_models_point_rendering`
